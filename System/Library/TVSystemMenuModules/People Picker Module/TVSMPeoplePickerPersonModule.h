...
+ (id)availableStyles;	// IMP=0x0010000000002ba0
...
- (void)_updateContentViewControllerForUser:(id)arg1;	// IMP=0x0000000000003230
- (void)contentModuleViewControllerDidTriggerAction:(id)arg1;	// IMP=0x0000000000003160
...
- (void)handleAction;	// IMP=0x0000000000002d50
- (_Bool)dismissAfterAction;	// IMP=0x0000000000002d30
- (id)initWithUser:(id)arg1;	// IMP=0x0000000000002bc0
