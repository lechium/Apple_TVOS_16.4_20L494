...
- (void).cxx_destruct;	// IMP=0x0000000000008180
...
- (void)setPlatterColor:(id)arg1 forControlState:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000007b40
- (void)setSecondaryContentColor:(id)arg1 forControlState:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x00000000000079c0
- (void)setPrimaryContentColor:(id)arg1 forControlState:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000007840
- (void)setAccessoryText:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007770
- (void)setSubtitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007640
- (void)setSystemImageName:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007510
- (void)setTitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000073e0
- (void)updateStateAnimated:(_Bool)arg1;	// IMP=0x0000000000006bf0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000006a70
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000006950
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000006860
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000006710
- (_Bool)canBecomeFocused;	// IMP=0x00000000000066f0
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 systemImageName:(id)arg3 subtitle:(id)arg4 accessoryText:(id)arg5;	// IMP=0x00000000000051e0
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 systemImageName:(id)arg3;	// IMP=0x0000000000005100
