...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0010000000029030
- (void).cxx_destruct;	// IMP=0x000000000002d6b0
...
- (id)_preloadArtwork;	// IMP=0x000000000002d1f0
- (id)_placeholderArtwork;	// IMP=0x000000000002d0f0
- (void)_updateState;	// IMP=0x000000000002ce90
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000000002cda0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000000002c6f0
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000000002c530
- (void)_updateMetadata;	// IMP=0x000000000002a3b0
- (void)_createRequestController;	// IMP=0x0000000000029d20
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000029a50
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000000000297a0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00000000000292b0
- (void)playPause;	// IMP=0x0000000000029280
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x00000000000291f0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000029110
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000028f90
- (id)playerPath;	// IMP=0x0000000000028ea0
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000028cb0
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000028910
