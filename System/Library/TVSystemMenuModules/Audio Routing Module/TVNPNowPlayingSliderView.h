...
- (void).cxx_destruct;	// IMP=0x000000000003c360
...
- (id)_unfocusedProgressColor;	// IMP=0x000000000003c080
- (id)_focusedProgressColor;	// IMP=0x000000000003bfa0
- (void)_rightPressed:(id)arg1;	// IMP=0x000000000003beb0
- (void)_leftPressed:(id)arg1;	// IMP=0x000000000003bdd0
- (void)_panUpdated:(id)arg1;	// IMP=0x000000000003b830
- (void)_menuPressed;	// IMP=0x000000000003b820
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003b7b0
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003b740
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003b6d0
- (_Bool)shouldTrack;	// IMP=0x000000000003b6b0
- (double)maxBarWidth;	// IMP=0x000000000003b690
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x000000000003b620
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x000000000003b330
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000003b250
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000003b210
- (void)layoutSubviews;	// IMP=0x000000000003abd0
- (_Bool)canBecomeFocused;	// IMP=0x000000000003abb0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003a1e0
