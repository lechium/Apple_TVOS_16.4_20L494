...
- (void)_pickRoute:(id)arg1;	// IMP=0x0000000000036280
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x00000000000361d0
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0000000000036060
- (void)_calculateVisibleVolumeCells;	// IMP=0x0000000000035b10
- (void)_cleanupRouteForVolumeIfNeeded;	// IMP=0x00000000000359c0
- (id)_gradientMask;	// IMP=0x0000000000035350
- (void)routeCellDidSelectAccessoryView:(id)arg1;	// IMP=0x0000000000035240
- (void)routeCellDidSelectRouteView:(id)arg1;	// IMP=0x0000000000034950
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x00000000000348e0
- (void)shareAudioSelected;	// IMP=0x0000000000034840
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x0000000000034530
- (void)longPressSelect:(id)arg1;	// IMP=0x0000000000034430
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x00000000000342d0
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0000000000034100
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0000000000033f30
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x0000000000033e90
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000033b00
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x00000000000338c0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000033790
- (void)handleVolumeDown;	// IMP=0x0000000000033160
- (void)handleVolumeUp;	// IMP=0x0000000000032ad0
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x0000000000031820
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000031490
- (void)viewDidLoad;	// IMP=0x0000000000030550
- (void)dealloc;	// IMP=0x0000000000030500
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x00000000000303b0
