...
- (void).cxx_destruct;	// IMP=0x0000000000024020
...
- (void)_updateVolume;	// IMP=0x0000000000023a80
- (id)_imageForAVRoute:(id)arg1 destination:(id)arg2;	// IMP=0x0000000000023910
- (id)overrideTitle;	// IMP=0x00000000000238e0
- (void)setOverrideTitle:(id)arg1;	// IMP=0x0000000000023850
- (void)volumeController:(id)arg1 mutedStateDidChange:(_Bool)arg2;	// IMP=0x0000000000023750
- (void)volumeController:(id)arg1 volumeValueDidChange:(float)arg2;	// IMP=0x0000000000023640
- (void)volumeController:(id)arg1 volumeControlAvailableDidChange:(_Bool)arg2;	// IMP=0x0000000000023540
- (id)deviceTypeDescription;	// IMP=0x00000000000233b0
- (void)setMuted:(_Bool)arg1;	// IMP=0x0000000000023330
- (void)setVolumeLevel:(id)arg1;	// IMP=0x0000000000023260
- (id)deviceImage;	// IMP=0x00000000000231c0
- (void)updateWithOutputDevice:(id)arg1 selectionState:(unsigned long long)arg2 destination:(id)arg3 wantsVolumeUpdates:(_Bool)arg4;	// IMP=0x00000000000227b0
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0000000000022690
