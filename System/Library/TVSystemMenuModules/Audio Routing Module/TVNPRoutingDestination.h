...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000000002f890
- (void)connectAndPair;	// IMP=0x000000000002f880
- (void)togglePlayPause;	// IMP=0x000000000002f870
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000000002f7d0
