...
- (void).cxx_destruct;	// IMP=0x0000000000037190
...
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0000000000037020
- (id)preferredFocusEnvironments;	// IMP=0x0000000000036fa0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000036e00
- (void)viewDidLoad;	// IMP=0x0000000000036c90
- (id)initWithRoutingController:(id)arg1;	// IMP=0x0000000000036b60
