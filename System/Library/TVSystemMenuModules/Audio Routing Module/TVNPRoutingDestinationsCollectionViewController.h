...
- (void).cxx_destruct;	// IMP=0x00000000000198d0
...
- (id)_indexPathForCurrentDestination;	// IMP=0x00000000000193a0
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x0000000000019200
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x0000000000019090
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x0000000000019020
...
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000015e90
- (void)viewDidLoad;	// IMP=0x00000000000158f0
- (void)dealloc;	// IMP=0x0000000000015820
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x00000000000155a0
