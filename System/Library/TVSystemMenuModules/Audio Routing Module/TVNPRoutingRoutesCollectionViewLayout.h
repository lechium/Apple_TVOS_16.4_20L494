...
+ (Class)layoutAttributesClass;	// IMP=0x0060000000024c30
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x00000000000250e0
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000024dc0
- (void)prepareLayout;	// IMP=0x0000000000024c60
