...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x004000000001ff00
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x004000000001da60
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x00400000000199f0
+ (_Bool)allowsSelection;	// IMP=0x00400000000199d0
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x000000000001fcf0
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001ee50
- (unsigned long long)_controlStateForCell;	// IMP=0x000000000001ed80
- (void)_addInitialConstraints;	// IMP=0x000000000001dc10
- (void)accessoryViewSelected;	// IMP=0x000000000001da50
- (void)routeViewSelected;	// IMP=0x000000000001da40
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x000000000001da00
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000001cfe0
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x000000000001ceb0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000001cda0
- (void)updateConstraints;	// IMP=0x000000000001af60
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000001ae30
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000001ae10
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001acd0
- (void)prepareForReuse;	// IMP=0x000000000001ac30
- (id)preferredFocusEnvironments;	// IMP=0x000000000001aab0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019a10
