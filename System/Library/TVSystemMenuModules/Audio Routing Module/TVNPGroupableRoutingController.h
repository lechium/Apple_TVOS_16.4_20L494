...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0010000000001350
- (void).cxx_destruct;	// IMP=0x000000000000c210
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x000000000000bb50
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000b730
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000000a180
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0000000000006100
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0000000000005c70
- (void)_updateAvailableRoutes;	// IMP=0x0000000000005120
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000004f10
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000000004e90
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000004e40
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000004c40
- (void)presentEARCUpsell;	// IMP=0x00000000000047c0
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0000000000004160
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000003c90
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000002710
- (void)_updateAllowsDestinationSelection;	// IMP=0x0000000000002630
- (void)dealloc;	// IMP=0x0000000000002080
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000001500
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x0000000000001460
- (id)init;	// IMP=0x0000000000001400
