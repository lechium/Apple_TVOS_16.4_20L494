...
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0060000000004240
...
- (void)_updateColors;	// IMP=0x0000000000004750
- (void)_updateVisibleAccessoryView;	// IMP=0x0000000000004660
- (unsigned long long)_floatingContentViewControlState;	// IMP=0x0000000000004590
- (void)_updateFloatingContentViewControlState;	// IMP=0x00000000000044f0
- (_Bool)_canHandlePresses:(id)arg1;	// IMP=0x00000000000043f0
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000004170
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000040a0
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000003fd0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000003e10
- (void)prepareForReuse;	// IMP=0x0000000000003d90
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000003ca0
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000003c80
- (void)updateConstraints;	// IMP=0x0000000000003a10
@property(copy, nonatomic) NSString *subtitle;
@property(copy, nonatomic) NSString *title;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000016e0
