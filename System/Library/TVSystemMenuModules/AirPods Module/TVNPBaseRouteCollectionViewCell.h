...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x00400000000423c0
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x004000000003ff20
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x004000000003beb0
+ (_Bool)allowsSelection;	// IMP=0x004000000003be90
- (void).cxx_destruct;	// IMP=0x00000000000428a0
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x00000000000421b0
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000041310
- (unsigned long long)_controlStateForCell;	// IMP=0x0000000000041240
- (void)_addInitialConstraints;	// IMP=0x00000000000400d0
- (void)accessoryViewSelected;	// IMP=0x000000000003ff10
- (void)routeViewSelected;	// IMP=0x000000000003ff00
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x000000000003fec0
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000003f4a0
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x000000000003f370
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000003f260
- (void)updateConstraints;	// IMP=0x000000000003d420
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000003d2f0
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000003d2d0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000003d190
- (void)prepareForReuse;	// IMP=0x000000000003d0f0
- (id)preferredFocusEnvironments;	// IMP=0x000000000003cf70
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003bed0
