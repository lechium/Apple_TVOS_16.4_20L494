...
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0000000000032880
- (id)preferredFocusEnvironments;	// IMP=0x0000000000032800
- (void)viewDidLoad;	// IMP=0x00000000000323d0
- (id)initWithRouteController:(id)arg1;	// IMP=0x0000000000032250
