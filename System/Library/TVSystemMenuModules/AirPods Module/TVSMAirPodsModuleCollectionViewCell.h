...
- (void).cxx_destruct;	// IMP=0x0000000000005b50
...
- (unsigned long long)_controlStateForCell;	// IMP=0x0000000000005800
- (void)_updatePackageRasterizationScale;	// IMP=0x0000000000005730
- (void)_updatePackageViewVisibility;	// IMP=0x0000000000005560
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000004f50
- (void)_setupPackageViews;	// IMP=0x00000000000046f0
- (void)_setupConstraints;	// IMP=0x0000000000003c70
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000003b60
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000003ae0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000030b0
