...
+ (Class)layoutAttributesClass;	// IMP=0x0060000000032ae0
- (void).cxx_destruct;	// IMP=0x00000000000331e0
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000032f90
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000032c70
- (void)prepareLayout;	// IMP=0x0000000000032b10
