...
- (void)_calculateAndSetRasterizationScaleForLayer:(id)arg1;	// IMP=0x0000000000002ae0
- (void)_updateRasterizationScale;	// IMP=0x0000000000002a60
- (void)_setPackage:(id)arg1;	// IMP=0x0000000000002870
- (void)setStateName:(id)arg1;	// IMP=0x00000000000027c0
- (void)layoutSubviews;	// IMP=0x00000000000023f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000022d0
