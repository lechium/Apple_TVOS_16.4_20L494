...
- (void).cxx_destruct;	// IMP=0x000000000000aef0
...
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x000000000000aad0
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x000000000000a960
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x000000000000a800
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x000000000000a630
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x000000000000a460
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x000000000000a3c0
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000000000a010
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0000000000009dc0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000009be0
- (void)handleVolumeDown;	// IMP=0x00000000000095b0
- (void)handleVolumeUp;	// IMP=0x0000000000008f00
- (void)_adjustVolume;	// IMP=0x0000000000008e40
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x0000000000008b20
- (void)_handleTapSelect:(id)arg1;	// IMP=0x0000000000008ad0
- (void)_handleLongPressSelect:(id)arg1;	// IMP=0x0000000000008a60
- (void)updateSnapshot;	// IMP=0x00000000000084d0
- (void)dealloc;	// IMP=0x00000000000083f0
- (void)viewDidLoad;	// IMP=0x0000000000007ae0
- (id)initWithCollectionViewLayout:(id)arg1 routeController:(id)arg2;	// IMP=0x0000000000007920
