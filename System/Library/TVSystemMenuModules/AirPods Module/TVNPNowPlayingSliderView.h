...
- (void).cxx_destruct;	// IMP=0x0000000000014070
...
- (id)_unfocusedProgressColor;	// IMP=0x0000000000013d90
- (id)_focusedProgressColor;	// IMP=0x0000000000013cb0
- (void)_rightPressed:(id)arg1;	// IMP=0x0000000000013bc0
- (void)_leftPressed:(id)arg1;	// IMP=0x0000000000013ae0
- (void)_panUpdated:(id)arg1;	// IMP=0x0000000000013540
- (void)_menuPressed;	// IMP=0x0000000000013530
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000134c0
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000013450
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000133e0
- (_Bool)shouldTrack;	// IMP=0x00000000000133c0
- (double)maxBarWidth;	// IMP=0x00000000000133a0
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x0000000000013330
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000013040
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000012f60
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000012f20
- (void)layoutSubviews;	// IMP=0x00000000000128e0
- (_Bool)canBecomeFocused;	// IMP=0x00000000000128c0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000011ef0
