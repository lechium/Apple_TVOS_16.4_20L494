...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0010000000014120
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x000000000001e800
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001e3e0
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000001ce30
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0000000000018db0
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0000000000018920
- (void)_updateAvailableRoutes;	// IMP=0x0000000000017dd0
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000017c10
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000000017b90
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000017b40
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000017940
- (void)presentEARCUpsell;	// IMP=0x00000000000174e0
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0000000000016e80
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x00000000000169b0
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x00000000000154a0
- (void)_updateAllowsDestinationSelection;	// IMP=0x00000000000153c0
- (void)dealloc;	// IMP=0x0000000000014e10
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000142d0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x0000000000014230
- (id)init;	// IMP=0x00000000000141d0
