...
- (void).cxx_destruct;	// IMP=0x0000000000032180
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0000000000031c80
- (void)connectAndPair;	// IMP=0x0000000000031c70
- (void)togglePlayPause;	// IMP=0x0000000000031c60
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0000000000031bc0
- (id)init;	// IMP=0x0000000000031b90
