...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001642
...
- (id)description;	// IMP=0x0000000000001508
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001319
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001286
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x000000000000109c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000177c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000164a
