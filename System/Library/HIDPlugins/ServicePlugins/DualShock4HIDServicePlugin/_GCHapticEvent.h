...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001712
...
- (id)description;	// IMP=0x00000000000015d8
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x00000000000013e9
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001356
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x000000000000116c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000184c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000171a
