...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x0010000000002352
...
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005f26
- (void)updateSensorsActive:(_Bool)arg1;	// IMP=0x0000000000005dd6
- (void)readSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000005dbd
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005cd8
- (void)updateLightWithRed:(float)arg1 green:(float)arg2 blue:(float)arg3;	// IMP=0x0000000000005add
- (void)readLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000059f9
- (id)defaultHapticMotors;	// IMP=0x0000000000005918
- (float)defaultHapticDispatchFrequency;	// IMP=0x000000000000590a
- (void)dispatchHapticEvent;	// IMP=0x00000000000058c9
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x00000000000058b7
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x00000000000057a0
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x000000000000543e
@property(readonly, copy) NSString *description;
- (void)updateBatteryLevel:(unsigned char)arg1 isPowerSupplyConnected:(_Bool)arg2;	// IMP=0x0000000000005275
- (void)dispatchOutputReport;	// IMP=0x0000000000004e6f
- (void)setupRawReportHandling;	// IMP=0x00000000000041d1
- (void)requestPairingInfo;	// IMP=0x0000000000003eba
- (void)requestSensorCalibrationInfo;	// IMP=0x0000000000002fdc
- (void)requestFirmwareInfo;	// IMP=0x0000000000002986
- (void)determineSupportMode;	// IMP=0x0000000000002680
- (id)initWithService:(unsigned int)arg1;	// IMP=0x000000000000240c
