...
- (id)managedObjectContext;	// IMP=0x000000000028cc73
- (void)dealloc;	// IMP=0x000000000028cc12
- (id)initForStore:(id)arg1 request:(id)arg2 metadata:(id)arg3 forceInsertsToUpdates:(_Bool)arg4 context:(id)arg5;	// IMP=0x000000000028cb24
