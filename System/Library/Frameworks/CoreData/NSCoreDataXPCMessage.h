...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000003149f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003166e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000031521
- (void)dealloc;	// IMP=0x00000000000314a7
