...
- (void)executeEpilogue;	// IMP=0x000000000029668c
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000002965be
- (void)executePrologue;	// IMP=0x0000000000296442
- (void)visitPredicateExpression:(id)arg1;	// IMP=0x00000000002962d2
- (void)visitPredicate:(id)arg1;	// IMP=0x00000000002962cc
- (id)_createStatement;	// IMP=0x000000000029617e
@property(retain, nonatomic) NSSQLiteStatement *fetchStatement;
- (id)manyToManyPrefetchRequestsForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x0000000000295351
- (id)manyToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x0000000000295318
- (id)inverseIsToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002952df
@property(readonly, nonatomic) NSFetchRequest *request;
- (id)createChildContextForNestedFetchRequest:(id)arg1;	// IMP=0x0000000000295207
- (void)dealloc;	// IMP=0x00000000002950ab
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x0000000000294801
