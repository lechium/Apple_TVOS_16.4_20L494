...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000ab57
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000af1c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000ab5f
- (void)dealloc;	// IMP=0x000000000000aaf3
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000aa45
