...
- (id)fetchIntermediateForKeypathExpression:(id)arg1;	// IMP=0x000000000018af05
- (id)generateSQLStringInContext:(id)arg1;	// IMP=0x000000000018a8cf
- (id)selectIntermediate;	// IMP=0x0000000000189fcc
- (_Bool)isFunctionScoped;	// IMP=0x0000000000189f5c
- (id)fetchIntermediate;	// IMP=0x0000000000189f53
- (void)dealloc;	// IMP=0x0000000000189e8e
- (id)initWithScope:(id)arg1;	// IMP=0x0000000000189e24
