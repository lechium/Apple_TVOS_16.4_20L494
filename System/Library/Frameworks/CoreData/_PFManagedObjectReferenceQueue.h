...
- (void)dealloc;	// IMP=0x00000000000e5535
- (_Bool)_isDeallocating;	// IMP=0x00000000000e550c
- (_Bool)_tryRetain;	// IMP=0x00000000000e5504
- (unsigned long long)retainCount;	// IMP=0x00000000000e54f7
- (oneway void)release;	// IMP=0x00000000000e54c9
- (id)retain;	// IMP=0x00000000000e54bc
