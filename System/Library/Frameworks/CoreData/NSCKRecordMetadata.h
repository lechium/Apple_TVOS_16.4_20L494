...
+ (id)recordFromEncodedData:(id)arg1 error:(id *)arg2;	// IMP=0x004000000004c1e4
+ (id)encodeRecord:(id)arg1 error:(id *)arg2;	// IMP=0x004000000004c058
+ (id)insertMetadataForObject:(id)arg1 setRecordName:(_Bool)arg2 inZoneWithID:(id)arg3 recordNamePrefix:(id)arg4 error:(id *)arg5;	// IMP=0x004000000004a1ab
+ (id)entityPath;	// IMP=0x0040000000046f5f
- (_Bool)mergeMoveReceiptsWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004b9d7
- (id)createEncodedMoveReceiptData:(id *)arg1;	// IMP=0x000000000004b817
- (id)createRecordFromSystemFields;	// IMP=0x000000000004713a
