...
- (void).cxx_destruct;	// IMP=0x000000000027be1c
- (void)applicationWillDeactivate:(id)arg1;	// IMP=0x000000000027bdba
- (void)applicationDidActivate:(id)arg1;	// IMP=0x000000000027bdac
- (void)dealloc;	// IMP=0x000000000027bd2b
- (id)init;	// IMP=0x000000000027b5c9
