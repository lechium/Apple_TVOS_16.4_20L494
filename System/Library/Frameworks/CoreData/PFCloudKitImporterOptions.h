...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000214765
- (id)copy;	// IMP=0x0000000000214721
- (void)dealloc;	// IMP=0x00000000002146b8
- (id)initWithOptions:(id)arg1 monitor:(id)arg2 assetStorageURL:(id)arg3 workQueue:(id)arg4 andDatabase:(id)arg5;	// IMP=0x0000000000214614
