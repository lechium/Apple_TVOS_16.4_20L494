...
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x0000000000248efb
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000246a7d
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000024695d
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x00000000002468a8
