...
+ (id)migrationStoreOptionsFromStoreOptions:(id)arg1;	// IMP=0x00600000001ff342
+ (id)destinationURLForMigrationSourceURL:(id)arg1 createDocumentReplacementDirectory:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0060000000200710
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x00600000002005ec
+ (int)migrationDebugLevel;	// IMP=0x00600000002005d3
- (id)migrateStoreAtURL:(id)arg1 withManager:(id)arg2 metadata:(id)arg3 options:(id)arg4 error:(id *)arg5;	// IMP=0x0000000000200492
- (id)createMigrationManagerForSourceModel:(id)arg1 destinationModel:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000200310
- (id)sourceModelForStoreAtURL:(id)arg1 metadata:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001ffacb
- (void)dealloc;	// IMP=0x00000000001ff4a3
