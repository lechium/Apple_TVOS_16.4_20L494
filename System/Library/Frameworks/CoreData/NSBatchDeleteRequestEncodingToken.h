...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000c0f5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c1e4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c0fd
- (void)dealloc;	// IMP=0x000000000000c0b2
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000c025
