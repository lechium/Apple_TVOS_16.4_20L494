...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000b5fc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b835
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b604
- (void)dealloc;	// IMP=0x000000000000b598
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000b2b1
