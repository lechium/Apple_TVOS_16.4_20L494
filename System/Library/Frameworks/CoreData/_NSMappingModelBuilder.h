...
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x006000000005cd8a
+ (int)migrationDebugLevel;	// IMP=0x006000000005cd71
- (void)dealloc;	// IMP=0x000000000005ce0c
- (id)initWithSourceModel:(id)arg1 destinationModel:(id)arg2;	// IMP=0x000000000005cda3
