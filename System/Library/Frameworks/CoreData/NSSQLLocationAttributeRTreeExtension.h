...
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000243b24
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x0000000000243932
...
- (void)dealloc;	// IMP=0x0000000000243858
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x00000000002435e8
