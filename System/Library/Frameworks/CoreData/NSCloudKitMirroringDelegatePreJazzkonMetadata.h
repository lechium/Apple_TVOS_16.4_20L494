...
- (void).cxx_destruct;	// IMP=0x00000000002c2da9
- (id)description;	// IMP=0x00000000002c1c98
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002c1aca
- (void)dealloc;	// IMP=0x00000000002c1a5b
- (id)initWithStore:(id)arg1;	// IMP=0x00000000002c1a09
