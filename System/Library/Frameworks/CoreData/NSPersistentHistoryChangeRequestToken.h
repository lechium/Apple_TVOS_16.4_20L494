...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000c66f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c88e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c677
- (void)dealloc;	// IMP=0x000000000000c60b
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000c4e0
