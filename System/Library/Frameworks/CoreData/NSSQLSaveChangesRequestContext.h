...
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x0000000000297fd0
- (void)executeEpilogue;	// IMP=0x0000000000296f58
- (void)executePrologue;	// IMP=0x0000000000296f00
- (_Bool)isWritingRequest;	// IMP=0x0000000000296ef8
- (id)rowCache;	// IMP=0x0000000000296ee6
- (void)dealloc;	// IMP=0x0000000000296d82
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x0000000000296bc8
