...
- (id)description;	// IMP=0x000000000013504d
- (void)updateWithChange:(id)arg1;	// IMP=0x0000000000134f79
- (void)dealloc;	// IMP=0x0000000000134f07
- (id)initWithOriginalChange:(id)arg1;	// IMP=0x0000000000134df9
