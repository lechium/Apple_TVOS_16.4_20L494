...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001978bb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000197797
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001975df
- (void)dealloc;	// IMP=0x0000000000197541
