...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000145f8b
- (void)dealloc;	// IMP=0x0000000000145f41
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x0000000000145ed8
