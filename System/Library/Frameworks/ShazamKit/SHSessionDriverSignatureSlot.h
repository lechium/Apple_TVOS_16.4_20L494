...
- (long long)appendBuffer:(id)arg1 atTime:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000004aba
...
- (void)reset;	// IMP=0x00000000000048bb
- (id)initWithMaximumSignatureDuration:(double)arg1;	// IMP=0x0000000000004816
