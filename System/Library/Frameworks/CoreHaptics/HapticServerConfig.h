...
- (id).cxx_construct;	// IMP=0x0000000000007cd1
- (void).cxx_destruct;	// IMP=0x0000000000007c7e
...
- (id)initWithHapticPlayer:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000005742
