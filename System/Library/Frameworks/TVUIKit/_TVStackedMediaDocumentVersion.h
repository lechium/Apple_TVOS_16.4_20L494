...
+ (id)v1_0_1;	// IMP=0x0060000000006855
+ (id)v1_0_0;	// IMP=0x00600000000067e9
...
- (long long)compare:(id)arg1;	// IMP=0x0000000000006ac6
- (_Bool)isEqualToVersion:(id)arg1;	// IMP=0x0000000000006aad
- (_Bool)isLessThanVersion:(id)arg1;	// IMP=0x0000000000006a93
- (_Bool)isGreaterThanVersion:(id)arg1;	// IMP=0x0000000000006a79
- (id)initWithVersionString:(id)arg1;	// IMP=0x00000000000068c1
