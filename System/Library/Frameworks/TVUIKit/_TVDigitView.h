...
- (void).cxx_destruct;	// IMP=0x0000000000003da8
...
- (void)reset;	// IMP=0x0000000000003d0e
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000003c84
- (void)layoutSubviews;	// IMP=0x0000000000003c0f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000003839
