...
+ (Class)layoutAttributesClass;	// IMP=0x00600000000020a1
- (void).cxx_destruct;	// IMP=0x00000000000037e8
...
- (void)_evaluateCenterCellIndexTransitionCheck;	// IMP=0x0000000000003482
- (void)_enumerateVisibleCellIndexesInRect:(struct CGRect)arg1 withBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000000338d
- (long long)_currentCenterCellIndexWithTransitionState:(_Bool *)arg1;	// IMP=0x0000000000003216
- (long long)_cellIndexForIndexPath:(id)arg1;	// IMP=0x00000000000031ad
- (id)_indexPathForCellIndex:(long long)arg1;	// IMP=0x0000000000003138
- (struct CGPoint)_targetContentOffsetForCellIndex:(long long)arg1;	// IMP=0x000000000000308b
- (_Bool)flipsHorizontallyInOppositeLayoutDirection;	// IMP=0x0000000000003083
- (struct CGPoint)targetContentOffsetForProposedContentOffset:(struct CGPoint)arg1 withScrollingVelocity:(struct CGPoint)arg2;	// IMP=0x0000000000002f91
- (struct CGPoint)targetContentOffsetForProposedContentOffset:(struct CGPoint)arg1;	// IMP=0x0000000000002e7f
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x00000000000029fd
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x00000000000028aa
- (void)invalidateLayoutWithContext:(id)arg1;	// IMP=0x0000000000002770
- (id)invalidationContextForBoundsChange:(struct CGRect)arg1;	// IMP=0x00000000000025b4
- (_Bool)shouldInvalidateLayoutForBoundsChange:(struct CGRect)arg1;	// IMP=0x00000000000025ac
- (struct CGSize)collectionViewContentSize;	// IMP=0x000000000000259a
- (void)prepareLayout;	// IMP=0x00000000000020b2
@property(readonly, nonatomic) NSIndexPath *centerIndexPath;
- (void)dealloc;	// IMP=0x0000000000001dff
- (id)init;	// IMP=0x0000000000001da1
