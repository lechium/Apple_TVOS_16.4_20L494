...
- (void).cxx_destruct;	// IMP=0x0000000000002cf0
- (void)removeItemWithIdentifier:(id)arg1;	// IMP=0x0000000000002cda
- (void)insertQueueDescriptor:(id)arg1 afterItemWithIdentifier:(id)arg2;	// IMP=0x0000000000002c61
@property(readonly, nonatomic) MPMusicPlayerControllerMutableQueue *_underlyingMutableQueue;
- (id)_initWithUnderlyingMutableQueue:(id)arg1;	// IMP=0x0000000000002be8
