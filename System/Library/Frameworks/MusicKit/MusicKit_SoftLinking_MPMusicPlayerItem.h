...
+ (id)playerItemForMediaItem:(id)arg1;	// IMP=0x0060000000008181
- (void).cxx_destruct;	// IMP=0x000000000000a2c4
...
- (id)description;	// IMP=0x0000000000009ee6
- (void)_initializeAdditionalAttributesWithMediaItem:(id)arg1;	// IMP=0x00000000000087e8
- (void)_initializeArtworkCatalogWithMediaItem:(id)arg1;	// IMP=0x0000000000008403
- (void)_initializeBasicPropertiesWithMediaItem:(id)arg1;	// IMP=0x0000000000008263
- (id)_initWithMediaItem:(id)arg1;	// IMP=0x00000000000081d3
