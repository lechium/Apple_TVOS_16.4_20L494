...
- (void).cxx_destruct;	// IMP=0x0000000000003b17
...
- (void)performWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000003919
- (id)initWithSearchTerm:(id)arg1 scopes:(id)arg2 limit:(long long)arg3;	// IMP=0x0000000000003724
