...
- (id).cxx_construct;	// IMP=0x00000000000174e2
- (void).cxx_destruct;	// IMP=0x00000000000174b1
- (_Bool)adaptToSystemConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000169be
- (id)resultsFromBox:(void *)arg1 renderedWithFrameCount:(int)arg2;	// IMP=0x0000000000016521
- (id)sharedProcessorConfiguration;	// IMP=0x0000000000016519
