...
- (void).cxx_destruct;	// IMP=0x0000000000075120
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000074f76
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000074e9f
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000074e88
