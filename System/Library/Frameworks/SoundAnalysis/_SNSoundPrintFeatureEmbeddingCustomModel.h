...
- (void).cxx_destruct;	// IMP=0x000000000006a4f5
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000006a40f
- (id)initWithModel:(id)arg1 modelDescription:(id)arg2;	// IMP=0x000000000006a257
