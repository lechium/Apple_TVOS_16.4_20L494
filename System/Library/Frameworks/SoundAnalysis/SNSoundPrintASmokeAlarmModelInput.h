...
- (void).cxx_destruct;	// IMP=0x000000000007bc7e
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000007ba38
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 thresholdedHistoryIn:(id)arg3 detectedHistoryIn:(id)arg4;	// IMP=0x000000000007b936
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000007b91c
