...
- (void).cxx_destruct;	// IMP=0x000000000007866a
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000784c0
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x00000000000783e9
- (id)initWithInput1:(id)arg1;	// IMP=0x00000000000783d2
