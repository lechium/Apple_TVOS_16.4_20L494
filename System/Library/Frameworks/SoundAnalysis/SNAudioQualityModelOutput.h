...
- (void).cxx_destruct;	// IMP=0x00000000000818e2
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000817aa
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFinal_output:(id)arg1 classLabel:(id)arg2;	// IMP=0x00000000000816f1
