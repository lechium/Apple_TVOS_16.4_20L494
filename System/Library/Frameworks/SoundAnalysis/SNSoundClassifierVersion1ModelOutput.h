...
- (void).cxx_destruct;	// IMP=0x000000000007cf4d
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000007ce15
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWith_9:(id)arg1 classLabel:(id)arg2;	// IMP=0x000000000007cd5c
