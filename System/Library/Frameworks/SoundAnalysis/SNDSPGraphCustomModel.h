...
- (id).cxx_construct;	// IMP=0x00000000000526e9
- (void).cxx_destruct;	// IMP=0x0000000000052677
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000051d93
