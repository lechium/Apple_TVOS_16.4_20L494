...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000005619
- (unsigned long long)hash;	// IMP=0x00000000000053ef
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000005159
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004f6a
- (void)copyTo:(id)arg1;	// IMP=0x0000000000004de9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000004c6d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000004c60
- (id)dictionaryRepresentation;	// IMP=0x00000000000043fc
- (id)description;	// IMP=0x000000000000434d
...
- (_Bool)_setObject:(id)arg1;	// IMP=0x000000000004f85f
- (id)initWithObjectValue:(id)arg1;	// IMP=0x000000000004f7e6
