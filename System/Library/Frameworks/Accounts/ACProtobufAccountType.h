...
- (void).cxx_destruct;	// IMP=0x0000000000053f40
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000053cab
- (unsigned long long)hash;	// IMP=0x0000000000053b48
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000538df
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000053724
- (void)copyTo:(id)arg1;	// IMP=0x00000000000535d0
- (void)writeTo:(id)arg1;	// IMP=0x000000000005347d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000053470
- (id)dictionaryRepresentation;	// IMP=0x0000000000052cd3
- (id)description;	// IMP=0x0000000000052c24
