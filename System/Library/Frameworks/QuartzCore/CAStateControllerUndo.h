...
- (void)dealloc;	// IMP=0x0000000000024b34
- (void)addTransition:(id)arg1;	// IMP=0x0000000000024af7
- (void)willAddLayer:(id)arg1;	// IMP=0x0000000000024af1
- (void)addElement:(id)arg1;	// IMP=0x0000000000024ab4
