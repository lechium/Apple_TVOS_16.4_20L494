...
- (_Bool)CAMLWriter:(id)arg1 shouldEncodeObject:(id)arg2;	// IMP=0x000000000002100b
- (id)CAMLWriter:(id)arg1 URLForResource:(id)arg2;	// IMP=0x0000000000020cbb
- (id)CAMLWriter:(id)arg1 typeForObject:(id)arg2;	// IMP=0x0000000000020bcf
- (id)initWithResourceDir:(id)arg1;	// IMP=0x0000000000020b6d
- (void)dealloc;	// IMP=0x0000000000020b00
