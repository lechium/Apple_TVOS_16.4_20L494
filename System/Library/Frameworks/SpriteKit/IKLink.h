...
- (void).cxx_destruct;	// IMP=0x000000000002d9e0
...
- (void)rotateByAngle:(float)arg1;	// IMP=0x000000000002d6ca
- (double)normalizeAngle:(double)arg1;	// IMP=0x000000000002d66b
- (id)initWithNode:(id)arg1;	// IMP=0x000000000002d596
