...
- (void).cxx_destruct;	// IMP=0x00000000000f2835
...
- (void)_showSpinner;	// IMP=0x00000000000f25e9
- (_Bool)canBecomeFocused;	// IMP=0x00000000000f25e1
- (void)layoutSubviews;	// IMP=0x00000000000f2125
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000f1eae
