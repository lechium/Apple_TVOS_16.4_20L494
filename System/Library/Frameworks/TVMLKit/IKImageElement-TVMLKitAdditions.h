...
- (id)tv_urlWithLayout:(id)arg1;	// IMP=0x0030000000062e3f
- (id)tv_urlWithSize:(struct CGSize)arg1 focusSizeIncrease:(double)arg2;	// IMP=0x0030000000062d89
- (id)tv_urlWithSize:(struct CGSize)arg1 focusSizeIncrease:(double)arg2 centerGrowth:(_Bool)arg3 cropCode:(id)arg4;	// IMP=0x0030000000062b5c
...
- (id)tv_imageProxyWithLayout:(id)arg1;	// IMP=0x00300000000626c8
...
- (id)tv_associatedViewElement;	// IMP=0x00300000000d1f08
@end
