...
+ (id)productInfoViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000a9bba
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000ab950
- (void)layoutSubviews;	// IMP=0x00000000000aae2e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000aa700
- (id)preferredFocusEnvironments;	// IMP=0x00000000000aa600
- (_Bool)canBecomeFocused;	// IMP=0x00000000000aa557
