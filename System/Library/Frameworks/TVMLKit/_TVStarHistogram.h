...
+ (id)_histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000014eda7
+ (id)histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000014eabf
- (void).cxx_destruct;	// IMP=0x000000000015011b
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000014f6e7
- (_Bool)canBecomeFocused;	// IMP=0x000000000014f6df
