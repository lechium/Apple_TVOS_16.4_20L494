...
- (void).cxx_destruct;	// IMP=0x000000000016ffef
...
- (void)_updateWithShowcaseElement:(id)arg1 update:(_Bool)arg2;	// IMP=0x000000000016f2d3
- (void)_updateDisabledFocusView;	// IMP=0x000000000016f19d
- (void)_transitionControllersWithMenuAction:(_Bool)arg1;	// IMP=0x000000000016edb4
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000016ecbe
- (void)_menuAction:(id)arg1;	// IMP=0x000000000016ec27
- (void)_configureWithBgImage:(id)arg1 backdropImage:(id)arg2;	// IMP=0x000000000016eb84
- (id)_backgroundImageProxy;	// IMP=0x000000000016ea4f
- (struct CGSize)_backgroundImageProxySize;	// IMP=0x000000000016e9a2
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000016e89a
- (void)loadView;	// IMP=0x000000000016e46f
- (id)preferredFocusEnvironments;	// IMP=0x000000000016e33c
- (void)updateWithViewElement:(id)arg1;	// IMP=0x000000000016e2c9
- (void)updateWithShowcaseElement:(id)arg1;	// IMP=0x000000000016e2b7
- (id)initWithShowcaseElement:(id)arg1;	// IMP=0x000000000016df22
