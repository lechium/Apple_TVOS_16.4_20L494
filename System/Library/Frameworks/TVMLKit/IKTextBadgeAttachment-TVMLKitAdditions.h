...
- (void)tv_resolveWithTextLayoutDirection:(long long)arg1 layoutObserver:(CDUnknownBlockType)arg2;	// IMP=0x003000000009ef2d
- (void)tv_setImage:(id)arg1;	// IMP=0x003000000009ec5d
...
- (void)tv_setResolving:(_Bool)arg1;	// IMP=0x003000000009eaf1
@property(readonly, nonatomic, getter=tv_isResolving) _Bool tv_resolving;
- (void)tv_setImageProxy:(id)arg1;	// IMP=0x003000000009ea45
- (id)tv_imageProxy;	// IMP=0x003000000009ea34
@end
