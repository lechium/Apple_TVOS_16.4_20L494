...
- (void).cxx_destruct;	// IMP=0x00000000000dd590
...
- (_Bool)_isSearchFieldVisible;	// IMP=0x00000000000dd4aa
- (void)_transitionKeyboardOut;	// IMP=0x00000000000dd0a9
- (void)_transitionKeyboardInAnimated:(_Bool)arg1;	// IMP=0x00000000000dcbee
- (void)_addKeyboard;	// IMP=0x00000000000dcab4
- (void)_pushKeyboardTowardsStableState:(unsigned long long)arg1;	// IMP=0x00000000000dc898
- (void)_adjustKeyboardContainerPositionForContentOffset:(struct CGPoint)arg1;	// IMP=0x00000000000dc747
- (void)_handleMenuAction:(id)arg1;	// IMP=0x00000000000dc70f
- (void)layoutSubviews;	// IMP=0x00000000000dc049
- (void)updateConstraints;	// IMP=0x00000000000db8f8
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000db6c8
- (_Bool)shouldUpdateFocusInContext:(id)arg1;	// IMP=0x00000000000db5ed
- (id)preferredFocusEnvironments;	// IMP=0x00000000000db508
- (void)willMoveToWindow:(id)arg1;	// IMP=0x00000000000db493
- (void)stopEditing;	// IMP=0x00000000000db45a
- (void)adjustScrollForContentOffset:(struct CGPoint)arg1;	// IMP=0x00000000000db448
- (id)initWithCollectionView:(id)arg1 searchBar:(id)arg2 keyboard:(id)arg3 touchEnabled:(_Bool)arg4;	// IMP=0x00000000000dab10
