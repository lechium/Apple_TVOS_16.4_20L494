...
- (void).cxx_destruct;	// IMP=0x00000000000294f4
...
- (void)reset;	// IMP=0x0000000000029498
- (void)evaluateForState:(long long)arg1;	// IMP=0x00000000000291da
- (id)initWithScrollView:(id)arg1 axis:(long long)arg2;	// IMP=0x0000000000029087
- (id)init;	// IMP=0x0000000000029079
