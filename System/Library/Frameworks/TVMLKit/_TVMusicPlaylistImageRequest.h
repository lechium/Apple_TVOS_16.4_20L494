...
- (void).cxx_destruct;	// IMP=0x00000000000d8a9e
...
- (void)loadImagesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d812f
- (id)identifier;	// IMP=0x00000000000d7bb5
- (id)initWithImageProxies:(id)arg1 playlistStyle:(id)arg2;	// IMP=0x00000000000d7afc
