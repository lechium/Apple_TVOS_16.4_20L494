...
+ (id)infoCellViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000e4136
- (void).cxx_destruct;	// IMP=0x00000000000e624f
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000e5e2f
- (void)layoutSubviews;	// IMP=0x00000000000e5620
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 withHeaderWidth:(double)arg2;	// IMP=0x00000000000e505f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000e5012
- (double)minimumHeaderWidth;	// IMP=0x00000000000e4cc8
