...
- (void).cxx_destruct;	// IMP=0x00000000000a109a
...
- (id)preferredFocusEnvironments;	// IMP=0x00000000000a0fe3
- (void)viewDidLayoutSubviews;	// IMP=0x00000000000a0c11
- (void)viewDidLoad;	// IMP=0x00000000000a0a91
- (id)initWithStackCollectionViewController:(id)arg1;	// IMP=0x00000000000a08df
