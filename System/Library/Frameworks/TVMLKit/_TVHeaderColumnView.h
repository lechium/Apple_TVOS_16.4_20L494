...
- (void).cxx_destruct;	// IMP=0x000000000016c46b
@property(nonatomic) double lineSpacing; // @synthesize lineSpacing=_lineSpacing;
@property(copy, nonatomic) NSArray *labelViews; // @synthesize labelViews=_labelViews;
- (void)layoutSubviews;	// IMP=0x000000000016c1b0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000016bfac
