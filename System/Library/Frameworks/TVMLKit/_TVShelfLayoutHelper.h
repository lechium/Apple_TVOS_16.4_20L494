...
- (void).cxx_destruct;	// IMP=0x000000000009a291
...
- (void)_freeBuffers;	// IMP=0x000000000009a1dd
- (void)_compute;	// IMP=0x000000000009947c
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x00000000000993de
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x00000000000993a3
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000099368
- (void)dealloc;	// IMP=0x000000000009932a
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x00000000000992b6
