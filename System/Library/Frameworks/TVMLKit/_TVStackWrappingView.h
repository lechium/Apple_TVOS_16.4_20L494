...
- (void).cxx_destruct;	// IMP=0x00000000000c229f
...
- (id)preferredFocusEnvironments;	// IMP=0x00000000000c20e1
- (void)configureSupplementaryCellLayoutAttributesWithAutomaticInsets:(struct UIEdgeInsets)arg1 sectionIndex:(long long)arg2;	// IMP=0x00000000000c1831
- (void)layoutSubviews;	// IMP=0x00000000000c0f87
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000c0d04
