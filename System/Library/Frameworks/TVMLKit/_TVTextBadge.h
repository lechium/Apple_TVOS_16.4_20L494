...
+ (id)textBadgeViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x0060000000050a74
- (void).cxx_destruct;	// IMP=0x00000000000511ce
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000050f0f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000050e0d
