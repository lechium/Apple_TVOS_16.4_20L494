...
- (void)dealloc;	// IMP=0x000000000027fa3b
- (_Bool)isOpaque;	// IMP=0x000000000027fa2b
- (id)textureSource;	// IMP=0x000000000027f93c
- (id)prepareWindowIfNeeded;	// IMP=0x000000000027f6e7
- (_Bool)supportsMetal;	// IMP=0x000000000027f6df
- (id)init;	// IMP=0x000000000027f6b0
