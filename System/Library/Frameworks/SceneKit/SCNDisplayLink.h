...
- (_Bool)_isInvalidated;	// IMP=0x00000000002038b3
- (void)setNeedsDisplay;	// IMP=0x000000000020389f
- (void)invalidate;	// IMP=0x000000000020383d
- (void)_caDisplayLinkCallback;	// IMP=0x000000000020380b
- (void)_callbackWithTime:(double)arg1;	// IMP=0x000000000020366d
- (int)queuedFrameCount;	// IMP=0x0000000000203664
@property(nonatomic) float preferredFrameRate;
@property(copy, nonatomic) CDUnknownBlockType adaptativeFrameRate;
- (_Bool)setPaused:(_Bool)arg1 nextFrameTimeHint:(double)arg2 lastUpdate:(double)arg3;	// IMP=0x00000000002034a4
@property(nonatomic, getter=isPaused) _Bool paused;
- (void)dealloc;	// IMP=0x0000000000203353
- (id)initWithQueue:(id)arg1 screen:(id)arg2 policy:(unsigned long long)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00000000002030d5
- (id)init;	// IMP=0x00000000002030c7
