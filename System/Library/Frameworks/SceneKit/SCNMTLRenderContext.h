...
+ (void)registerBindings;	// IMP=0x00100000000cd484
- (id).cxx_construct;	// IMP=0x00000000000d3cec
- (void).cxx_destruct;	// IMP=0x00000000000d3caa
...
- (void)addDrawablePresentedHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d3a21
- (void)addCommandBufferCompletedHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d390e
- (void)addCommandBufferScheduledHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d37fb
- (unsigned long long)cubeArrayTypeIfSupported;	// IMP=0x00000000000d37f0
- (struct __C3DMaterial *)getCurrentPassMaterial;	// IMP=0x00000000000d37e3
- (unsigned long long)getCurrentPassHash;	// IMP=0x00000000000d37d6
- (void)setCurrentPassMaterial:(struct __C3DMaterial *)arg1;	// IMP=0x00000000000d37c9
- (void)setCurrentPassHash:(unsigned long long)arg1;	// IMP=0x00000000000d37bc
- (void)writeBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x00000000000d373c
- (void)endRenderCommandEncoding;	// IMP=0x00000000000d371c
- (void)renderSKSceneWithRenderer:(id)arg1 overlay:(_Bool)arg2 atTime:(double)arg3;	// IMP=0x00000000000d30c3
- (MISSING_TYPE *)renderSize;	// IMP=0x00000000000d30b5
- (float)renderTime;	// IMP=0x00000000000d30a7
- (void)_drawFullScreenTexture:(id)arg1 over:(_Bool)arg2;	// IMP=0x00000000000d2d4d
- (void)_drawShadowMaps;	// IMP=0x00000000000d26c8
- (void)_drawPBRTextures;	// IMP=0x00000000000d1ce0
...
- (void)endDeferredLighting;	// IMP=0x00000000000d1c97
- (void)renderLight:(struct __C3DNode *)arg1 lightType:(int)arg2 lightData:(struct __C3DLightRuntimeData *)arg3;	// IMP=0x00000000000d1920
- (void)beginDeferredLighting;	// IMP=0x00000000000d1648
- (void)drawFullScreenQuadForPass:(struct __C3DFXPass *)arg1;	// IMP=0x00000000000d152b
- (void)resetVolatileMeshElements;	// IMP=0x00000000000d1331
- (void)unmapVolatileMeshElement:(struct __C3DMeshElement *)arg1;	// IMP=0x00000000000d12b9
- (struct __C3DMeshElement *)createVolatileMeshElementOfType:(BOOL)arg1 primitiveCount:(long long)arg2 bytesPerIndex:(long long)arg3;	// IMP=0x00000000000d10ce
- (void)_recycleMTLBufferToPool:(id)arg1;	// IMP=0x00000000000d1034
- (id)_newMTLBufferFromPoolWithLength:(unsigned long long)arg1;	// IMP=0x00000000000d0f6d
- (void)resetVolatileMeshes;	// IMP=0x00000000000d0e36
- (void)unmapVolatileMesh:(struct __C3DMesh *)arg1 modifiedVerticesCount:(long long)arg2;	// IMP=0x00000000000d0d1d
- (_Bool)mapVolatileMesh:(struct __C3DMesh *)arg1 verticesCount:(long long)arg2;	// IMP=0x00000000000d0b16
- (void)drawWireframeOverlayForElements:(CDStruct_d65e47c4 *)arg1 range:(CDStruct_912cb5d2)arg2 store:(struct __C3DRendererElementStore *)arg3 passInstance:(struct __C3DFXPassInstance *)arg4;	// IMP=0x00000000000cd1b7
...
- (void)drawRenderElement:(struct __C3DRendererElement *)arg1 withPass:(struct __C3DFXPass *)arg2;	// IMP=0x00000000000ca071
- (void)_prepareMaterialTextures:(struct __C3DMaterial *)arg1;	// IMP=0x00000000000c9fb2
- (void)stopProcessingRendererElements:(_Bool)arg1;	// IMP=0x00000000000c9e9f
- (void)startProcessingRendererElementsWithEngineIterationContext:(CDStruct_65434d98 *)arg1;	// IMP=0x00000000000c9247
- (void)processRendererElements:(CDStruct_d65e47c4 *)arg1 count:(unsigned int)arg2 engineIterationContext:(CDStruct_65434d98 *)arg3;	// IMP=0x00000000000c872f
- (void)renderMesh:(struct __C3DMesh *)arg1 meshElement:(struct __C3DMeshElement *)arg2 withProgram:(struct __C3DFXMetalProgram *)arg3 engineContext:(struct __C3DEngineContext *)arg4 transform:(union C3DMatrix4x4)arg5 color:(const struct C3DColor4 *)arg6 rasterizerStates:(struct __C3DRasterizerStates *)arg7 blendState:(struct __C3DBlendStates *)arg8 texture:(struct __C3DImage *)arg9 depthBias:(_Bool)arg10;	// IMP=0x00000000000c8377
- (void)renderVideoBackground:(struct __C3DImageProxy *)arg1 engineContext:(struct __C3DEngineContext *)arg2 slot:(struct __C3DEffectSlot *)arg3;	// IMP=0x00000000000c7da1
- (void)renderBackground:(struct __C3DEffectSlot *)arg1 engineContext:(struct __C3DEngineContext *)arg2 passInstance:(struct __C3DFXPassInstance *)arg3;	// IMP=0x00000000000c730a
- (float)_zFarForSkyboxRenderingProjectionMatrix:(const union C3DMatrix4x4 *)arg1 defaultZFar:(float)arg2;	// IMP=0x00000000000c72eb
- (void)_updateProjectionMatrixForOrthographicSkyboxRenderingIfNeeded:(union C3DMatrix4x4 *)arg1;	// IMP=0x00000000000c7032
- (void)_drawPatchForMeshElement:(id)arg1 instanceCount:(unsigned long long)arg2;	// IMP=0x00000000000c6e6c
- (void)_drawMeshElement:(id)arg1 instanceCount:(unsigned long long)arg2;	// IMP=0x00000000000c6c13
- (void)_setMeshBuffers:(id)arg1;	// IMP=0x00000000000c6960
- (void)_setSceneBufferAtVertexIndex:(long long)arg1 fragmentIndex:(long long)arg2;	// IMP=0x00000000000c6902
- (void)popDebugGroup;	// IMP=0x00000000000c68e2
- (void)pushDebugGroup:(id)arg1;	// IMP=0x00000000000c68c2
- (void)setRasterizerStates:(struct __C3DRasterizerStates *)arg1;	// IMP=0x00000000000c6731
- (void)_logLightingInformation;	// IMP=0x00000000000c66da
- (id)radianceTextureForEffectSlot:(struct __C3DEffectSlot *)arg1;	// IMP=0x00000000000c6610
- (id)irradianceTextureForEffectSlot:(struct __C3DEffectSlot *)arg1;	// IMP=0x00000000000c64db
- (id)textureForEffectSlot:(struct __C3DEffectSlot *)arg1;	// IMP=0x00000000000c64b8
- (id)newRenderTargetWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x00000000000c621d
- (void)endRenderPass;	// IMP=0x00000000000c616a
- (void)beginRenderPass:(id)arg1 renderEncoder:(void *)arg2 parameters:(CDStruct_365d5154)arg3;	// IMP=0x00000000000c603b
...
- (void)_createResourceCommandBufferIfNeeded;	// IMP=0x00000000000c5d23
- (void)_clearRenderCaches;	// IMP=0x00000000000c5ce2
- (void *)_clusterInfo;	// IMP=0x00000000000c5cd5
- (void)_setReflectionProbeArrayTexture:(id)arg1;	// IMP=0x00000000000c5cc8
- (id)_reflectionProbeArrayTexture;	// IMP=0x00000000000c5cbb
- (id)_finalRenderTexture;	// IMP=0x00000000000c5b2d
@property(readonly, nonatomic) CAMetalLayer *layerTarget;
@property(readonly, nonatomic) id <MTLTexture> textureTarget;
- (void)endFrameWaitingUntilCompleted:(_Bool)arg1 status:(unsigned long long *)arg2 error:(id *)arg3;	// IMP=0x00000000000c52dc
- (void)endFrameSceneSpecifics;	// IMP=0x00000000000c52ae
- (void)beginFrame:(id)arg1;	// IMP=0x00000000000c4f2e
...
- (struct __C3DEngineStats *)stats;	// IMP=0x00000000000c4f00
- (void)_clearUnusedBindingPoints;	// IMP=0x00000000000c4d37
...
- (_Bool)supportsMTLFeatureSet:(unsigned long long)arg1;	// IMP=0x00000000000c4ace
...
- (void)dealloc;	// IMP=0x00000000000c465b
- (id)initWithDevice:(id)arg1 engineContext:(struct __C3DEngineContext *)arg2;	// IMP=0x00000000000c408e
- (void)_reduceStatsOfConstantBuffer:(id)arg1;	// IMP=0x00000000000c405a
- (struct __C3DFXPass *)_createPassWithVertex:(id)arg1 fragment:(id)arg2;	// IMP=0x00000000000c3f8c
- (id)renderTargetInfo;	// IMP=0x0000000000057b76
- (void)viewports:(const void **)arg1:(long long *)arg2;	// IMP=0x0000000000057b46
- (_Bool)constantOffsetAndSize:(int)arg1:(id)arg2:(long long *)arg3:(long long *)arg4;	// IMP=0x0000000000057b14
- (const char *)constantData:(int)arg1;	// IMP=0x0000000000057ae2
- (id)sampler:(int)arg1:(id)arg2;	// IMP=0x0000000000057ab0
- (id)buffer:(int)arg1:(id)arg2:(long long *)arg3:(long long *)arg4;	// IMP=0x0000000000057a7e
- (id)texture:(int)arg1:(id)arg2;	// IMP=0x0000000000057a4c
- (unsigned long long)colorPixelFormatAtIndex:(long long)arg1;	// IMP=0x0000000000057bca
- (unsigned long long)depthStencilPixelFormat;	// IMP=0x0000000000057b87
- (_Bool)vrrEnabled;	// IMP=0x0000000000057b7f
