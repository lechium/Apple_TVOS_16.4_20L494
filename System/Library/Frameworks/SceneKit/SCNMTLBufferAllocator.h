...
- (id)newSubBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 renderContext:(id)arg3;	// IMP=0x0000000000103345
- (id)_newSubBuffer;	// IMP=0x0000000000103126
- (void)dealloc;	// IMP=0x00000000001030dc
- (id)initWithDevice:(id)arg1 fixedSizeElement:(unsigned long long)arg2 buffersize:(unsigned long long)arg3 name:(id)arg4;	// IMP=0x0000000000103016
