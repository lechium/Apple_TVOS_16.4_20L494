...
- (id)bufferForAttribute:(long long)arg1;	// IMP=0x000000000011ad77
- (void)dealloc;	// IMP=0x000000000011ad11
- (id)description;	// IMP=0x000000000011aaa7
...
- (void)buildTessellationVertexDescriptorIfNeeded;	// IMP=0x000000000011a6b1
