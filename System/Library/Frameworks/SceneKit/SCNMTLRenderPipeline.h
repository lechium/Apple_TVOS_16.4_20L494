...
- (void)_computeUsageForArguments:(id)arg1 function:(id)arg2;	// IMP=0x000000000011a1f1
- (_Bool)matchesRenderPassDescriptor:(id)arg1;	// IMP=0x000000000011a08e
- (id)description;	// IMP=0x00000000001199c1
- (void)dealloc;	// IMP=0x000000000011992b
- (id)init;	// IMP=0x00000000001198f1
