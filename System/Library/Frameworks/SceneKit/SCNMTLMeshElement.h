...
- (void)setPrimitiveRange:(CDStruct_912cb5d2)arg1;	// IMP=0x000000000011b15c
@property(readonly, nonatomic) long long effectivePrimitiveCount;
@property(readonly, nonatomic) long long primitiveCount;
- (void)setupWithElement:(struct __C3DMeshElement *)arg1;	// IMP=0x000000000011af74
- (id)description;	// IMP=0x000000000011aee8
- (void)dealloc;	// IMP=0x000000000011aea8
