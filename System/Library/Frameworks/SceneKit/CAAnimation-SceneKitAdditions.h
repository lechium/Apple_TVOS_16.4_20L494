...
+ (id)animationWithSCNAnimation:(id)arg1;	// IMP=0x00200000001c452b
@property(copy, nonatomic) NSArray *animationEvents;
- (void)setCommitsOnCompletion:(_Bool)arg1;	// IMP=0x00100000001c4485
- (_Bool)commitsOnCompletion;	// IMP=0x00100000001c4453
