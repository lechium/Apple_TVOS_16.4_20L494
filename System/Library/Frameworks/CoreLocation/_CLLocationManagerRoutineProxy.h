...
- (void)createConnection;	// IMP=0x000000000000bcfa
- (void)didUpdateLocations:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000ba74
- (void)didUpdateLocations:(id)arg1;	// IMP=0x000000000000b7d5
- (void)dealloc;	// IMP=0x000000000000b72c
- (id)initWithQueue:(id)arg1 locationManagerRoutine:(id)arg2;	// IMP=0x000000000000b56d
