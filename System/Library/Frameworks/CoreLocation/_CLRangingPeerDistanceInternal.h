...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008621d
- (void)dealloc;	// IMP=0x00000000000861ae
- (id)initWithPeer:(id)arg1 date:(id)arg2 distanceMeters:(id)arg3 accuracyMeters:(id)arg4 initiator:(_Bool)arg5 shouldUnlock:(_Bool)arg6;	// IMP=0x00000000000860b6
