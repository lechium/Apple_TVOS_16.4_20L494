...
- (void)createConnection;	// IMP=0x00000000000310f2
- (void)didSmoothLocations:(id)arg1 ofType:(id)arg2;	// IMP=0x000000000003102d
- (void)dealloc;	// IMP=0x0000000000030f9e
- (id)initWithCLLocationSmoother:(id)arg1;	// IMP=0x0000000000030e95
