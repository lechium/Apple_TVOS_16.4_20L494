...
+ (const char *)trackerStateTypeName;	// IMP=0x00600000000104a6
+ (unsigned long long)trackerStateSize;	// IMP=0x006000000001049b
- (void *)identifier;	// IMP=0x00000000000104b3
- (_Bool)dumpState:(void *)arg1 withSize:(unsigned long long)arg2 hints:(struct os_state_hints_s *)arg3;	// IMP=0x00000000000102e4
- (void)updateState:(CDUnknownBlockType)arg1;	// IMP=0x000000000000ff34
...
- (void)dealloc;	// IMP=0x000000000000d67d
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000d20b
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2;	// IMP=0x000000000000d1f6
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000d195
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2;	// IMP=0x000000000000d180
