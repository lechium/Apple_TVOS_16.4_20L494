...
- (void)dealloc;	// IMP=0x00000000001f4ed7
- (void)_syncCookies;	// IMP=0x00000000001f4e61
- (void)registerForPostingNotificationsWithContext:(id)arg1;	// IMP=0x00000000001f4cff
