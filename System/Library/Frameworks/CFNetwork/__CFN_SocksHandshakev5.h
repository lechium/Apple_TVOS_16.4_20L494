...
- (void).cxx_destruct;	// IMP=0x0000000000157dc0
- (id)finish:(int)arg1;	// IMP=0x0000000000157bf8
- (_Bool)parse:(const char *)arg1 len:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000157271
