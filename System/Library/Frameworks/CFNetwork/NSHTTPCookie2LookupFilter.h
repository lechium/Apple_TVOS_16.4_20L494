...
- (void).cxx_destruct;	// IMP=0x000000000012cb97
...
- (_Bool)matchCookie:(id)arg1;	// IMP=0x000000000012c1e1
- (long long)_flags;	// IMP=0x000000000012bcc6
- (id)initWithCookie:(id)arg1;	// IMP=0x000000000012bb34
