...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000164044
- (void).cxx_destruct;	// IMP=0x0000000000164006
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000163ef9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000163ca6
