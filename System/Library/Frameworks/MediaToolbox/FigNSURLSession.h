...
- (void)dealloc;	// IMP=0x00000000002c2c06
- (id)initWithClientBundleIdentifier:(id)arg1 clientPersonaIdentifier:(id)arg2 dispatchQueue:(id)arg3;	// IMP=0x00000000002c2a7d
- (void)debug;	// IMP=0x00000000002c2a1f
- (struct FigOpaqueAssertion *)acquireAssertion;	// IMP=0x00000000002c2909
