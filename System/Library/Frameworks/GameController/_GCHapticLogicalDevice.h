...
- (void).cxx_destruct;	// IMP=0x0000000000092d98
- (void)stopAllHaptics;	// IMP=0x0000000000092c7d
- (_Bool)hasClients;	// IMP=0x0000000000092c60
- (void)unregisterHapticClient:(id)arg1;	// IMP=0x0000000000092c4a
- (void)registerHapticClient:(id)arg1;	// IMP=0x0000000000092c34
- (id)initWithIdentifier:(id)arg1 clientConnection:(id)arg2;	// IMP=0x0000000000092a63
