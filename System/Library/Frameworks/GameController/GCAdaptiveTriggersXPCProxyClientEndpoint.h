...
- (void).cxx_destruct;	// IMP=0x00000000000937d9
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000009370f
- (void)invalidateConnection;	// IMP=0x000000000009366b
- (void)refreshStatuses;	// IMP=0x000000000009353e
- (void)newStatuses:(id)arg1;	// IMP=0x0000000000093420
- (void)_remoteEndpointHasSetStatuses:(id)arg1;	// IMP=0x00000000000932d2
- (void)setController:(id)arg1;	// IMP=0x000000000009322c
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x0000000000093004
- (id)init;	// IMP=0x0000000000092fd9
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x0000000000092dec
