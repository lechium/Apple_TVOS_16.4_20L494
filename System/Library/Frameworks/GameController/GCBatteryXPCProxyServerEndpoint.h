...
- (void).cxx_destruct;	// IMP=0x000000000000bb6f
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000baa3
- (void)invalidateConnection;	// IMP=0x000000000000b9f0
- (void)fetchBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b947
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000b537
- (void)invalidateClient;	// IMP=0x000000000000b476
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x000000000000b3ba
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x000000000000b314
