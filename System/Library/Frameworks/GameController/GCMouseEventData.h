...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000db613
...
- (id)debugDescription;	// IMP=0x00000000000db5bb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000db4eb
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000db3f5
