...
- (void).cxx_destruct;	// IMP=0x000000000003133b
...
- (void)playerIndicatorXPCProxyServerEndpoint:(id)arg1 didReceivePlayerIndexChange:(long long)arg2;	// IMP=0x0000000000031165
- (void)activateLogical;	// IMP=0x000000000003114e
@property(readonly) NSSet *underlyingDevices;
- (id)propertyForKey:(id)arg1;	// IMP=0x00000000000310dc
...
- (void)setDriverConnection:(id)arg1;	// IMP=0x00000000000307b5
- (id)init;	// IMP=0x000000000003078a
- (id)initWithHIDDevice:(id)arg1 manager:(id)arg2 type:(unsigned char)arg3;	// IMP=0x000000000003052c
- (id)makeControllerForClient:(id)arg1;	// IMP=0x0000000000031788
- (void)_removeClient:(id)arg1;	// IMP=0x0000000000031670
- (void)_addClient:(id)arg1;	// IMP=0x00000000000313d8
...
- (void)propagateBattery:(id)arg1;	// IMP=0x0000000000032518
- (id)readBattery;	// IMP=0x000000000003236e
...
- (void)homeButtonLongPressGesture:(_Bool)arg1;	// IMP=0x000000000003291c
- (void)updateBattery:(unsigned char)arg1 isCharging:(_Bool)arg2;	// IMP=0x00000000000329b2
- (id)hapticDriver;	// IMP=0x0000000000032a0e
