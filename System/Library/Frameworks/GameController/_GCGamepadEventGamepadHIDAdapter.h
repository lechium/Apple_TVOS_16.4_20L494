...
- (void).cxx_destruct;	// IMP=0x000000000006dd2e
...
- (id)observeGamepadEvents:(CDUnknownBlockType)arg1;	// IMP=0x000000000006d991
- (void)dealloc;	// IMP=0x000000000006d938
- (id)init;	// IMP=0x000000000006d90d
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x000000000006d637
