...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000245d9
- (void)invalidateConnection;	// IMP=0x0000000000024526
- (void)fetchSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000002447d
- (void)newSensorsActive:(_Bool)arg1;	// IMP=0x00000000000243d3
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000023fe3
- (void)invalidateClient;	// IMP=0x0000000000023f22
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(_Bool)arg1;	// IMP=0x0000000000023e88
- (id)initWithIdentifier:(id)arg1 initialValue:(_Bool)arg2;	// IMP=0x0000000000023e08
