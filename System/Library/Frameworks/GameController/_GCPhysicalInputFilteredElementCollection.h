...
- (void).cxx_destruct;	// IMP=0x000000000000a3a5
- (id)elementEnumerator;	// IMP=0x000000000000a383
- (id)elementForAlias:(id)arg1;	// IMP=0x000000000000a319
- (id)elementAtIndex:(unsigned long long)arg1;	// IMP=0x000000000000a2ea
- (unsigned long long)count;	// IMP=0x000000000000a2c8
