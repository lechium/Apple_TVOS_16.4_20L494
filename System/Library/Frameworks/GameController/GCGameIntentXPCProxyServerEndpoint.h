...
- (void).cxx_destruct;	// IMP=0x0000000000033a3a
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000033978
- (void)invalidateConnection;	// IMP=0x00000000000338c5
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000033656
- (void)invalidateClient;	// IMP=0x0000000000033595
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x0000000000033544
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)init;	// IMP=0x00000000000334b3
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000003343e
