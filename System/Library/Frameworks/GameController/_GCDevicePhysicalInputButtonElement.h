...
- (void)onCommitInvokeCallbacks:(unsigned long long)arg1;	// IMP=0x00000000000b4071
- (unsigned long long)handleGamepadEvent:(id)arg1 withTimestamp:(double)arg2;	// IMP=0x00000000000b3f8e
...
- (_Bool)isEqualToElement:(id)arg1;	// IMP=0x00000000000b3a3c
@property(readonly) id <GCTouchedStateInput> touchedInput;
@property(readonly) id <GCPressedStateInput><GCLinearInput> pressedInput;
- (id)initWith:(id)arg1 context:(id)arg2;	// IMP=0x00000000000b38d4
- (id)initWithIdentifier:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000000b3811
