...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000aaca0
- (void).cxx_destruct;	// IMP=0x00000000000aaf67
- (id)materializeWithContext:(id)arg1;	// IMP=0x00000000000aaebb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000aae4d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000aad64
- (id)init;	// IMP=0x00000000000aad41
- (id)initWithConfiguration:(id)arg1 source:(id)arg2;	// IMP=0x00000000000aaca8
