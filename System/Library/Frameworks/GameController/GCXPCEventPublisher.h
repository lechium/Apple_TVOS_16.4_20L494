...
- (void)sendEvent:(id)arg1 toSubscriber:(id)arg2;	// IMP=0x0000000000049f36
- (void)sendEvent:(id)arg1;	// IMP=0x0000000000049b09
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x00000000000496a3
- (id)initWithStreamName:(id)arg1 isStatefulEventPublisher:(_Bool)arg2;	// IMP=0x0000000000049363
- (id)initWithStreamName:(id)arg1;	// IMP=0x000000000004934f
