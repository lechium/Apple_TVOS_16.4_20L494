...
- (void).cxx_destruct;	// IMP=0x00000000000cb2f7
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000cb22b
- (void)invalidateConnection;	// IMP=0x00000000000cb178
- (void)fetchPlayerIndexWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000cb0cf
- (void)newPlayerIndex:(long long)arg1;	// IMP=0x00000000000cb021
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000cac30
- (void)invalidateClient;	// IMP=0x00000000000cab6f
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(long long)arg1;	// IMP=0x00000000000caad5
- (id)initWithIdentifier:(id)arg1 initialValue:(long long)arg2;	// IMP=0x00000000000caa55
