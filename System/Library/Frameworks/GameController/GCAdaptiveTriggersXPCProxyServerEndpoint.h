...
- (void).cxx_destruct;	// IMP=0x000000000009424b
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000094149
- (void)invalidateConnection;	// IMP=0x0000000000094096
- (void)newAdaptiveTriggerPayload:(id)arg1 index:(int)arg2;	// IMP=0x0000000000093f98
- (void)fetchStatusesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000093eef
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000093ac9
- (void)invalidateClient;	// IMP=0x0000000000093a08
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialStatuses:(id)arg1;	// IMP=0x000000000009394c
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x000000000009384c
