...
- (void)invokeCallbacksForInputChangedState:(unsigned char)arg1 withElement:(id)arg2;	// IMP=0x0000000000017318
...
- (id)initWith:(id)arg1 context:(id)arg2;	// IMP=0x0000000000016e65
- (id)initWithParams:(struct _GCDevicePhysicalInputButtonInputParams)arg1;	// IMP=0x0000000000016e0e
