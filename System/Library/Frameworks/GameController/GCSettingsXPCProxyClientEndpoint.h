...
- (void).cxx_destruct;	// IMP=0x000000000006c652
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000006c5af
- (void)invalidateConnection;	// IMP=0x000000000006c50b
- (void)refreshProfile;	// IMP=0x000000000006c3ec
- (void)newProfile:(id)arg1;	// IMP=0x000000000006c2d9
- (void)_remoteEndpointHasSetProfile:(id)arg1;	// IMP=0x000000000006c19d
- (void)setController:(id)arg1;	// IMP=0x000000000006c18c
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000006bf7d
- (id)init;	// IMP=0x000000000006bf52
- (id)initWithIdentifier:(id)arg1 initialValueForProfile:(id)arg2;	// IMP=0x000000000006be11
