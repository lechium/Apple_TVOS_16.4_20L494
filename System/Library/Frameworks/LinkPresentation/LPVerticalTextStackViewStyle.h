...
- (void).cxx_destruct;	// IMP=0x000000000004126d
...
- (void)applyToAllTextViewStyles:(CDUnknownBlockType)arg1;	// IMP=0x000000000004115e
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x0000000000040912
