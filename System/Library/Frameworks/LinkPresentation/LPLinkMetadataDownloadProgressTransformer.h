...
- (void).cxx_destruct;	// IMP=0x000000000006a26f
...
- (id)downloadProgressForTransformer:(id)arg1;	// IMP=0x000000000006a158
- (id)initWithBytesLoaded:(unsigned long long)arg1 downloadState:(long long)arg2 metadata:(id)arg3;	// IMP=0x000000000006a0c4
