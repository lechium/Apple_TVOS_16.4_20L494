...
+ (id)iconPlatterCornerRadius;	// IMP=0x0060000000052588
+ (id)iconPlatterPaddingForReason:(long long)arg1;	// IMP=0x0060000000052510
+ (void)removeClient:(id)arg1;	// IMP=0x0060000000052249
+ (void)addClient:(id)arg1;	// IMP=0x00600000000521d3
+ (id)themeWithStyle:(long long)arg1 icon:(id)arg2 platform:(long long)arg3 sizeClass:(unsigned long long)arg4 sizeClassParameters:(id)arg5 hasButton:(_Bool)arg6 preferredContentSizeCategory:(id)arg7;	// IMP=0x006000000004535f
+ (id)secondaryLabelColor;	// IMP=0x0060000000045346
+ (id)primaryLabelColor;	// IMP=0x006000000004532d
+ (double)largestIconSizeInPoints;	// IMP=0x006000000004531f
+ (double)badgeIconSizeInPoints;	// IMP=0x0060000000045311
+ (id)regularTheme;	// IMP=0x00600000000452df
+ (void)invalidateThemeCache;	// IMP=0x006000000005280b
- (void).cxx_destruct;	// IMP=0x00000000000526ff
...
- (id)CSSTextForProperty:(id)arg1 withValue:(id)arg2;	// IMP=0x00000000000523f2
- (id)CSSTextForThemeProperty:(id)arg1;	// IMP=0x000000000005236c
- (id)valueForThemeProperty:(id)arg1;	// IMP=0x00000000000522c7
- (id)valueForUndefinedKey:(id)arg1;	// IMP=0x00000000000522bf
- (void)adjustForStyle;	// IMP=0x0000000000045f87
- (id)initWithStyle:(long long)arg1 icon:(id)arg2 platform:(long long)arg3 sizeClass:(unsigned long long)arg4 sizeClassParameters:(id)arg5 hasButton:(_Bool)arg6 preferredContentSizeCategory:(id)arg7;	// IMP=0x00000000000455da
