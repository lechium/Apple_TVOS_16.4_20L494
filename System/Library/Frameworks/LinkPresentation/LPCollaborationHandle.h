...
- (void).cxx_destruct;	// IMP=0x0000000000058919
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005881c
- (id)stringValue;	// IMP=0x0000000000058764
- (id)initWithHandle:(id)arg1 nameComponents:(id)arg2;	// IMP=0x000000000005869c
