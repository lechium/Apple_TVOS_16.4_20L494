...
- (void).cxx_destruct;	// IMP=0x00000000001ba924
...
- (_Bool)isExecuting;	// IMP=0x00000000001ba8ae
- (_Bool)isFinished;	// IMP=0x00000000001ba89e
- (void)start;	// IMP=0x00000000001ba7a2
- (id)initWithResult:(id)arg1 intent:(id)arg2 intentSlotDescription:(id)arg3 optionsProvider:(id)arg4;	// IMP=0x00000000001ba6ab
