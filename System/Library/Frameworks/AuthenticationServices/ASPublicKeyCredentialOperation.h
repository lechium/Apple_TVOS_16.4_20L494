...
- (void)tearDownIfNecessary;	// IMP=0x000000000000d032
@property(readonly, nonatomic) _Bool hasTornDown; // @synthesize hasTornDown=_hasTornDown;
- (void)selectSecurityKeyAssertion:(id)arg1;	// IMP=0x000000000000cf9e
- (void)selectPlatformAssertion:(id)arg1;	// IMP=0x000000000000cf39
- (void)setSecurityKeyAssertionSelectionCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000000ced8
- (void)setPlatformAssertionSelectionCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000000ce77
- (void)mergeIdentifiersToAssertionResponses:(id)arg1;	// IMP=0x000000000000cc0b
@property(readonly, copy, nonatomic) NSDictionary *identifiersToAssertionResponses;
- (id)initWithRelyingPartyIdentifier:(id)arg1 delegate:(id)arg2 parentActivity:(id)arg3;	// IMP=0x000000000000cab9
