...
- (void).cxx_destruct;	// IMP=0x000000000018a2ba
...
- (id)description;	// IMP=0x000000000018a1ae
- (void)dealloc;	// IMP=0x000000000018a13b
- (void)free;	// IMP=0x000000000018a104
- (id)initWithModelName:(id)arg1 networkConfigurationName:(id)arg2 network:(CDStruct_2bc666a5)arg3 plan:(void *)arg4 context:(void *)arg5;	// IMP=0x0000000000189fef
