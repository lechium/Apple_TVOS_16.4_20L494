...
- (void)releaseAllocations;	// IMP=0x000000000020e6a1
- (_Bool)makeAllocationsForWidth:(unsigned long long)arg1;	// IMP=0x000000000020e5d5
- (void)dealloc;	// IMP=0x000000000020e562
- (void)resetBoxBounds;	// IMP=0x000000000020e551
- (void)copyFlagValue:(unsigned long long)arg1 toTarget:(unsigned long long)arg2 atIndex:(unsigned int)arg3;	// IMP=0x000000000020e520
- (unsigned int)checkFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000020e50b
- (void)clearFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000020e4f8
- (void)setFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000020e4e8
