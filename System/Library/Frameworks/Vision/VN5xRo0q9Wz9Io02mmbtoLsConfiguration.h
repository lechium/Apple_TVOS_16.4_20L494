...
- (void).cxx_destruct;	// IMP=0x00000000000378cb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000037792
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000037712
