...
- (void).cxx_destruct;	// IMP=0x00000000000d7f8b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d7d8b
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000d7cf4
