...
- (_Bool)_validateOutputImage:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000279558
- (_Bool)_validateInputImage:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000027949d
- (_Bool)estimateFlowStream:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000279458
- (_Bool)estimateFlowFromReference:(struct __CVBuffer *)arg1 target:(struct __CVBuffer *)arg2 error:(id *)arg3;	// IMP=0x0000000000279413
- (_Bool)setOutputUV:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x00000000002793ce
- (void)waitUntilCompleted;	// IMP=0x00000000002793c8
- (id)initWithWidth:(int)arg1 height:(int)arg2 numScales:(int)arg3;	// IMP=0x000000000027936f
