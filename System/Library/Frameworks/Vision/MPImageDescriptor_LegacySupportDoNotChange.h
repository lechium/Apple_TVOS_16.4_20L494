...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a7f11
- (void).cxx_destruct;	// IMP=0x00000000001a7ede
...
- (void)dealloc;	// IMP=0x00000000001a7d7d
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000001a7a9b
- (unsigned long long)serializedLength;	// IMP=0x00000000001a7a7b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a7a59
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a7598
