...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a6b1a
- (void).cxx_destruct;	// IMP=0x00000000001a6ae7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a6a38
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a67df
