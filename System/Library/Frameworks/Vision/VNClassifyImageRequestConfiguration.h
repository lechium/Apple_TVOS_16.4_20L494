...
- (void).cxx_destruct;	// IMP=0x00000000000e061e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e04d3
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000e0470
