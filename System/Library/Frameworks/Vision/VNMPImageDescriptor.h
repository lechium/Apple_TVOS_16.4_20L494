...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001dcd73
+ (unsigned long long)currentVersion;	// IMP=0x00100000001dcd68
- (void).cxx_destruct;	// IMP=0x00000000001dcd40
...
- (id)initWithRawColorGaborDescriptor:(id)arg1;	// IMP=0x00000000001dca45
@property(readonly) NSData *rawColorGaborDescriptor;
- (float)computeFinalDescriptorBasedDistanceForColorDistance:(float)arg1 andSceneClassifierDistance:(float)arg2;	// IMP=0x00000000001dc9db
- (float)distanceFromDescriptor:(id)arg1;	// IMP=0x00000000001dc958
- (_Bool)computeRegistrationFeaturesForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001dc950
- (_Bool)computeDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001dc698
- (_Bool)computeConvnetDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001dc690
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001dc4c6
- (unsigned long long)hash;	// IMP=0x00000000001dc3b2
- (void)dealloc;	// IMP=0x00000000001dc372
- (id)initWithState:(id)arg1 byteOffset:(unsigned long long *)arg2 error:(id *)arg3;	// IMP=0x00000000001dc02a
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000001dbdb8
@property(readonly, nonatomic) unsigned long long serializedLength;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001dbb01
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001db579
- (id)initWithImageData:(id)arg1 andCustomQualityScore:(float)arg2 context:(id)arg3 error:(id *)arg4;	// IMP=0x00000000001db54a
- (id)initWithImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001db319
