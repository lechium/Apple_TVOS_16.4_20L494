...
- (void).cxx_destruct;	// IMP=0x0000000000038edc
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000038de5
- (unsigned long long)hash;	// IMP=0x0000000000038d54
- (id)description;	// IMP=0x0000000000038cc1
- (id)initWithRequest:(id)arg1 observationsCacheKey:(id)arg2;	// IMP=0x0000000000038c19
