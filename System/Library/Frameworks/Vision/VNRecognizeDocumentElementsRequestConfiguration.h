...
- (void).cxx_destruct;	// IMP=0x000000000020b123
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020afe7
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000020aefa
