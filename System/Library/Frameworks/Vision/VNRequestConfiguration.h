...
- (void).cxx_destruct;	// IMP=0x0000000000096f49
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000096d8e
- (id)description;	// IMP=0x0000000000096abc
@property(readonly, copy, nonatomic) VNProcessingDevice *resolvedProcessingDevice;
- (id)_allPropertyNames;	// IMP=0x0000000000096902
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000009684f
