...
- (void).cxx_destruct;	// IMP=0x000000000024ed54
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024ec86
- (void)updateWithPropertiesOfModel:(id)arg1;	// IMP=0x000000000024ec23
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000024ebe0
