...
- (void).cxx_destruct;	// IMP=0x000000000004ddd2
...
- (id)description;	// IMP=0x000000000004dbbd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004dafd
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000004daae
