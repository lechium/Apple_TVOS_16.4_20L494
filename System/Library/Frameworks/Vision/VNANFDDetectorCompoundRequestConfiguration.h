...
- (void).cxx_destruct;	// IMP=0x000000000028e349
...
- (void)setDetectorConfigurationOption:(id)arg1 value:(id)arg2;	// IMP=0x000000000028e1db
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000028e0fc
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000028e035
