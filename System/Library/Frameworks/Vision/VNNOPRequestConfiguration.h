...
- (void).cxx_destruct;	// IMP=0x000000000012bb39
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012ba3a
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000012b947
