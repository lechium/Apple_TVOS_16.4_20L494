...
- (void).cxx_destruct;	// IMP=0x000000000015b023
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015aeec
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000015ae9a
