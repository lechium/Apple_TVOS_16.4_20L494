...
- (void).cxx_destruct;	// IMP=0x00000000002230aa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000222efd
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000222e09
