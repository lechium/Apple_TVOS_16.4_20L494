...
- (void).cxx_destruct;	// IMP=0x000000000013bc27
...
- (id)outputImage;	// IMP=0x000000000013ba7a
- (id)initWithInputParameters:(id)arg1;	// IMP=0x000000000013b9a9
- (id)init;	// IMP=0x000000000013b95e
