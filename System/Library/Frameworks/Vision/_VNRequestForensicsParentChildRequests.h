...
- (void).cxx_destruct;	// IMP=0x0000000000039388
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000039110
- (unsigned long long)hash;	// IMP=0x000000000003907f
- (id)description;	// IMP=0x0000000000038fbe
- (id)initWithParentRequest:(id)arg1 orderedChildRequests:(id)arg2;	// IMP=0x0000000000038f04
