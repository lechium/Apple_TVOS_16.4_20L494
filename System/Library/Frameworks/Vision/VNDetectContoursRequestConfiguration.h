...
- (void).cxx_destruct;	// IMP=0x0000000000208d13
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000208b49
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000208a83
