...
+ (_Bool)revision:(unsigned long long)arg1 supportsConstellation:(unsigned long long)arg2;	// IMP=0x006000000012d116
- (void).cxx_destruct;	// IMP=0x000000000012d103
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012cf3e
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000012ce84
