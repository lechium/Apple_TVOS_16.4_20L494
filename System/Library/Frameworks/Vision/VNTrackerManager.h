...
- (void).cxx_destruct;	// IMP=0x000000000010ed50
- (void)_releaseTracker_NO_LOCK_DO_NOT_EXECUTE_DIRECTLY:(id)arg1;	// IMP=0x000000000010ebdf
- (id)_createTracker:(id)arg1 type:(id)arg2 options:(id)arg3 error:(id *)arg4;	// IMP=0x000000000010ea39
- (id)_getTracker:(id)arg1;	// IMP=0x000000000010e93e
- (long long)_maximumTrackersOfType:(id)arg1;	// IMP=0x000000000010e8e2
- (id)init;	// IMP=0x000000000010e45a
