...
- (void).cxx_destruct;	// IMP=0x000000000023e2e5
...
- (void)main;	// IMP=0x000000000023dd59
- (id)initWithHomeManager:(id)arg1 timeout:(double)arg2;	// IMP=0x000000000023dce8
- (id)initWithHomeManager:(id)arg1;	// IMP=0x000000000023dcd3
