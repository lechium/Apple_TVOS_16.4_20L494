...
- (void)requestAccessWithQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000025e44
- (unsigned long long)queryAuthorizationStatus;	// IMP=0x0000000000025e1c
