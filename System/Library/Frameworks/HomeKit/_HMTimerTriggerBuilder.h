...
+ (void)initialize;	// IMP=0x00100000000ad55c
- (void).cxx_destruct;	// IMP=0x00000000000ad4e7
- (void)updateSignificantEventOffset:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ad300
- (void)_setSignificantEventOffset:(id)arg1;	// IMP=0x00000000000ad284
@property(copy, nonatomic) NSDateComponents *significantEventOffset;
- (void)updateSignificantEvent:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ace1f
@property(copy, nonatomic) NSString *significantEvent;
- (void)updateRecurrence:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000acb4f
@property(copy, nonatomic) NSDateComponents *recurrence;
- (void)updateTimeZone:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ac892
@property(copy, nonatomic) NSTimeZone *timeZone;
- (void)updateFireDate:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ac56a
@property(copy, nonatomic) NSDate *fireDate;
@property(readonly, copy, nonatomic) NSDate *fireDateIfSet;
- (Class)class;	// IMP=0x00000000000ac40e
- (id)recurrenceCalendar;	// IMP=0x00000000000ad5b6
