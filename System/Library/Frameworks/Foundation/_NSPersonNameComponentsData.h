...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000043368b
...
- (void)dealloc;	// IMP=0x0000000000433a4c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000043394f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000433693
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004335d1
- (id)init;	// IMP=0x0000000000433563
