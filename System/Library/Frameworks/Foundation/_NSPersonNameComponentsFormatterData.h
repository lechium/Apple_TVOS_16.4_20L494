...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000005d5e85
...
- (void)dealloc;	// IMP=0x00000000005d6105
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005d5f82
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005d5e8d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005d5d21
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005d5cb8
