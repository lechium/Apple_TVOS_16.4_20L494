...
+ (CDUnknownFunctionPointerType)recognizeFuncForCFStringEncoding:(unsigned int)arg1;	// IMP=0x00600000004bbf4f
+ (id)detectorForCFStringEncoding:(unsigned int)arg1 allowBackupDetectors:(_Bool)arg2;	// IMP=0x00600000004bbeb4
...
- (unsigned long long)recognizeString:(const char *)arg1 withDataLength:(unsigned long long)arg2 intoBuffer:(id)arg3;	// IMP=0x00000000004bbf3b
- (double)multiBytesRatio;	// IMP=0x00000000004bbe30
- (double)_singleByte_confidence;	// IMP=0x00000000004bbd5e
- (double)_ASCII_confidence;	// IMP=0x00000000004bbcd2
- (double)confidenceWith2Chars;	// IMP=0x00000000004bbc33
- (double)confidence;	// IMP=0x00000000004bbb20
- (id)initWithNSStringEncoding:(unsigned long long)arg1 CFStringEncoding:(unsigned int)arg2 recognizeFunc:(CDUnknownFunctionPointerType)arg3;	// IMP=0x00000000004bba90
- (unsigned long long)maxSkipBytes;	// IMP=0x00000000004bba4b
- (double)bytesRatio;	// IMP=0x00000000004bb9fe
- (void)softReset;	// IMP=0x00000000004bb9b2
- (void)reset;	// IMP=0x00000000004bb954
