...
- (void)dealloc;	// IMP=0x00000000005d7244
@property(readonly, copy) NSArray *fallbackDescriptor;
- (void)_releaseIvars;	// IMP=0x00000000005d70ba
- (id)annotatedStringFromPersonNameComponents:(id)arg1;	// IMP=0x00000000005d6f3b
- (id)_formattedStringFromOrderedKeys:(id)arg1 components:(id)arg2 attributesByRange:(id)arg3;	// IMP=0x00000000005d6a92
- (id)_delimiterBetweenString:(id)arg1 andString:(id)arg2 isPhonetic:(_Bool)arg3;	// IMP=0x00000000005d69ba
- (id)_orderedNonEmptyKeysFromComponents:(id)arg1;	// IMP=0x00000000005d6876
- (id)stringFromComponents:(id)arg1 attributesByRange:(id)arg2;	// IMP=0x00000000005d66c7
@property(readonly) NSArray *orderedTemplate;
@property long long ordering;
- (_Bool)fullComponentsAreValid:(id)arg1;	// IMP=0x00000000005d6646
...
- (id)initWithMasterFormatter:(id)arg1;	// IMP=0x00000000005d6304
