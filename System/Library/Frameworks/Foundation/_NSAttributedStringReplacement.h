...
+ (id)_replacementsFromMetadataArray:(id)arg1;	// IMP=0x006000000045d89a
...
- (void)dealloc;	// IMP=0x000000000045d83c
- (id)initWithIndex:(long long)arg1 specifierRangeInFormatString:(struct _NSRange)arg2 replacementRangeInResult:(struct _NSRange)arg3 replacementKind:(long long)arg4 argument:(id)arg5;	// IMP=0x000000000045d78f
- (id)_initWithMetadata:(id)arg1;	// IMP=0x000000000045d491
