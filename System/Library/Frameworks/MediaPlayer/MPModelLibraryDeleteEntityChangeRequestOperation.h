...
- (_Bool)_isCloudLibraryEnabled;	// IMP=0x00000000000137b3
- (void)_deleteItems:(id)arg1 withLibrary:(id)arg2;	// IMP=0x0000000000013170
- (void)_handlePersistentID:(long long)arg1 modelClass:(Class)arg2 mediaLibrary:(id)arg3;	// IMP=0x00000000000129a1
- (void)execute;	// IMP=0x00000000000125d8
