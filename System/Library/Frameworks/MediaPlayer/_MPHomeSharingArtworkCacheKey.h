...
- (unsigned long long)hash;	// IMP=0x000000000023e1eb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000023e105
- (id)initWithPersistentID:(unsigned long long)arg1 size:(struct CGSize)arg2;	// IMP=0x000000000023e0aa
