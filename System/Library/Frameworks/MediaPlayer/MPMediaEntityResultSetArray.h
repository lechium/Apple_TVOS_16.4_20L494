...
- (void).cxx_destruct;	// IMP=0x00000000001213fd
- (id)sectionInfo;	// IMP=0x00000000001213ec
@property(readonly, nonatomic) id <MPMediaLibraryResultSet> resultSet; // @synthesize resultSet=_resultSet;
- (id)objectAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000121310
- (_Bool)isQueryResultSetInvalidated;	// IMP=0x00000000001212be
- (unsigned long long)count;	// IMP=0x00000000001212a1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000121296
- (id)initWithResultSet:(id)arg1 queryCriteria:(id)arg2 entityType:(long long)arg3 library:(id)arg4;	// IMP=0x0000000000121021
