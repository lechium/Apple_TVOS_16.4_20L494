...
- (void).cxx_destruct;	// IMP=0x0000000000060064
...
- (id)_startEntryProxy;	// IMP=0x000000000005ff4c
- (id)nextObject;	// IMP=0x000000000005fe67
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x000000000005f497
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x000000000005f0c7
