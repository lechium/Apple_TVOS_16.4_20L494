...
+ (id)allSupportedItemProperties;	// IMP=0x00600000001d0456
+ (id)allSupportedGroupProperties;	// IMP=0x00600000001d035b
- (void).cxx_destruct;	// IMP=0x00000000001ce90f
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001ce572
- (id)modelObjectForItemsArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001ce44c
- (id)modelObjectForRecentlyPlayedArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001ce326
- (void)initializeRequestedGroupProperties;	// IMP=0x00000000001ce036
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4 storeURLBag:(id)arg5 isListenNow:(_Bool)arg6;	// IMP=0x00000000001cdeee
