...
+ (id)translatorForKeyPaths:(id)arg1 valueTransformFunction:(CDUnknownFunctionPointerType)arg2;	// IMP=0x0010000000179b1d
+ (id)translatorForKeyPaths:(id)arg1 valueTransformBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000179a8b
- (void).cxx_destruct;	// IMP=0x0000000000179a63
...
- (id)valueFromSource:(id)arg1 context:(id)arg2;	// IMP=0x0000000000179a11
