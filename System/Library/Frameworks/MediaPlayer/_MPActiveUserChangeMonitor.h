...
- (void).cxx_destruct;	// IMP=0x0000000000241786
...
- (void)_cancelNotificationTimerWithReason:(id)arg1;	// IMP=0x000000000024153f
- (void)_startNotificationTimerWithEventHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000002412ef
- (void)ingestNotificationName:(id)arg1;	// IMP=0x0000000000240f17
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000240db8
