...
+ (id)allSupportedProperties;	// IMP=0x006000000023855a
- (void).cxx_destruct;	// IMP=0x00000000002380c9
...
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x0000000000237462
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3;	// IMP=0x0000000000237383
