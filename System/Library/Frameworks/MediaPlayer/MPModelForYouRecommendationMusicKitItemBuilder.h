...
+ (id)allSupportedProperties;	// IMP=0x0060000000212041
- (void).cxx_destruct;	// IMP=0x0000000000211d92
...
- (id)convertToStoreItemMetadataDictionary:(id)arg1;	// IMP=0x0000000000211b7d
- (id)storeItemMetadataWithMusicAPIMetadataDictionary:(id)arg1;	// IMP=0x0000000000211aee
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x0000000000210f41
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3 storeURLBag:(id)arg4 isListenNow:(_Bool)arg5;	// IMP=0x0000000000210e3c
