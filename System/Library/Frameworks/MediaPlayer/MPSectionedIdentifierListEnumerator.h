...
- (id)nextObject;	// IMP=0x000000000005eb4e
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x000000000005e5f0
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x000000000005dc18
