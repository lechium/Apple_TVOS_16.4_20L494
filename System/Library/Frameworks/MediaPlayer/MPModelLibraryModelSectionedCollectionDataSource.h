...
- (id).cxx_construct;	// IMP=0x00000000001183a6
- (void).cxx_destruct;	// IMP=0x0000000000118320
...
- (_Bool)_allowedEntityIdentifiersContainsAllPersistentIDs;	// IMP=0x0000000000118121
- (unsigned long long)_adjustedIndexForSectionIndex:(long long)arg1;	// IMP=0x0000000000117e97
- (void)_populateIndexMap;	// IMP=0x0000000000117916
- (id)indexPathForItemWithIdentifiersIntersectingSet:(id)arg1;	// IMP=0x00000000001174c9
- (id)identifiersForSectionAtIndex:(long long)arg1;	// IMP=0x0000000000117142
- (id)identifiersForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000116c79
- (id)itemAtIndexPath:(id)arg1;	// IMP=0x00000000001167cf
- (_Bool)hasSameContentAsDataSource:(id)arg1;	// IMP=0x000000000011633b
- (unsigned long long)numberOfItemsInSection:(unsigned long long)arg1;	// IMP=0x0000000000116021
- (id)sectionAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000115c42
- (unsigned long long)numberOfSections;	// IMP=0x0000000000115c2b
- (id)initWithRequest:(id)arg1 sectionQueryResults:(shared_ptr_274c5e8b)arg2 itemQueryResults:(void *)arg3;	// IMP=0x000000000011583e
