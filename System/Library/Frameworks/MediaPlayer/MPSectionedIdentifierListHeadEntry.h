...
+ (id)headEntryWithSectionIdentifier:(id)arg1;	// IMP=0x001000000006c389
- (void).cxx_destruct;	// IMP=0x000000000006c336
...
- (void)setBranchDepth:(long long)arg1;	// IMP=0x000000000006c240
- (id)nextEntries;	// IMP=0x000000000006c199
@property(readonly, nonatomic) long long entryType;
@property(readonly, copy) NSString *description;
- (id)initWithPositionKey:(id)arg1 sectionIdentifier:(id)arg2;	// IMP=0x000000000006c02e
