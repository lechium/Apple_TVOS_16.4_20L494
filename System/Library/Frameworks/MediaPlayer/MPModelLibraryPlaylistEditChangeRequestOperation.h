...
+ (id)requiredPlaylistEntryProperties;	// IMP=0x0060000000194489
- (void).cxx_destruct;	// IMP=0x0000000000196222
...
- (_Bool)_isCloudLibraryEnabled;	// IMP=0x000000000019611f
- (void)execute;	// IMP=0x000000000019458c
