...
+ (id)allSupportedProperties;	// IMP=0x00600000001631ff
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x00000000001632d0
