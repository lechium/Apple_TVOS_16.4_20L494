...
- (id).cxx_construct;	// IMP=0x0000000000254e52
- (void).cxx_destruct;	// IMP=0x0000000000254e21
...
- (id)initWithEntityQueryResult:(shared_ptr_274c5e8b)arg1 forScope:(id)arg2 entityTranslationContext:(id)arg3;	// IMP=0x0000000000254d22
