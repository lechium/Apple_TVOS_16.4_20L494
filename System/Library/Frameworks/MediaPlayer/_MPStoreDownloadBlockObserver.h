...
- (void).cxx_destruct;	// IMP=0x00000000002f2895
...
- (void)downloadManager:(id)arg1 downloadPurchaseDidFinish:(id)arg2;	// IMP=0x00000000002f2702
- (void)downloadManager:(id)arg1 downloadDidFinish:(id)arg2;	// IMP=0x00000000002f258b
- (id)initWithDownload:(id)arg1;	// IMP=0x00000000002f247b
