...
- (id)queryItems;	// IMP=0x000000000000a2ba
- (long long)httpMethod;	// IMP=0x000000000000a2af
- (long long)httpBodyType;	// IMP=0x000000000000a2a4
- (id)httpBody;	// IMP=0x000000000000a17d
- (id)bagKey;	// IMP=0x000000000000a170
