...
+ (id)allSupportedItemProperties;	// IMP=0x0060000000223550
+ (id)allSupportedGroupProperties;	// IMP=0x0060000000223476
- (void).cxx_destruct;	// IMP=0x0000000000222a25
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x0000000000222541
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4;	// IMP=0x000000000022242c
