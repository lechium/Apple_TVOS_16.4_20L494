...
- (void).cxx_destruct;	// IMP=0x000000000018dcaf
- (id)_parsedContentNode:(id)arg1 additionalAttributesFromParent:(id)arg2;	// IMP=0x000000000018d9ed
- (id)_parsedElements:(id)arg1;	// IMP=0x000000000018d7c2
- (id)_parsedSectionedCollection;	// IMP=0x000000000018cff0
@property(readonly, nonatomic) MPSectionedCollection *results;
- (id)initWithRawResponseOutput:(id)arg1 sectionBuilder:(id)arg2 contentItemBuilder:(id)arg3 filteredFCKinds:(id)arg4 userIdentity:(id)arg5;	// IMP=0x000000000018ce8f
