...
- (void).cxx_destruct;	// IMP=0x00000000000bfd9a
...
- (id)stringRepresentation;	// IMP=0x00000000000bfca3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bfc50
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bfba3
