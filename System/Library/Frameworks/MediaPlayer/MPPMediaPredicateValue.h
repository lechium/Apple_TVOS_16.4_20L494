...
- (void).cxx_destruct;	// IMP=0x00000000002af9e4
...
- (unsigned long long)hash;	// IMP=0x00000000002af689
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002af516
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002af3e8
- (void)copyTo:(id)arg1;	// IMP=0x00000000002af255
- (void)writeTo:(id)arg1;	// IMP=0x00000000002af117
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002af10a
- (id)dictionaryRepresentation;	// IMP=0x00000000002aeee3
- (id)description;	// IMP=0x00000000002aee34
...
- (void)dealloc;	// IMP=0x00000000002aec8a
