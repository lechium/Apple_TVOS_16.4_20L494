...
- (void).cxx_destruct;	// IMP=0x000000000011a584
@property(readonly, nonatomic) MPArtworkCatalog *artworkCatalog;
- (struct CGRect)bounds;	// IMP=0x000000000011a41d
- (id)initWithArtworkCatalog:(id)arg1;	// IMP=0x000000000011a409
- (id)initWithArtworkCatalog:(id)arg1 allowsNetworking:(_Bool)arg2;	// IMP=0x000000000011a333
