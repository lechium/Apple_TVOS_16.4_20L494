...
- (void).cxx_destruct;	// IMP=0x000000000024e116
...
- (_Bool)_storeItemMetadataIsAvailableForContentIdentifier:(id)arg1;	// IMP=0x000000000024e026
- (id)_storeItemMetadataForContentIdentifier:(id)arg1;	// IMP=0x000000000024df35
- (void)_populateUnavailableContentIdentifiersFromPageDataDictionary:(id)arg1;	// IMP=0x000000000024dc1c
- (void)_populateStorePlatformDataResultsFromRawResponseOutputDictionary:(id)arg1;	// IMP=0x000000000024da2a
- (void)_parseUsingAdditionalContentIdentifiersFromPreviousParser;	// IMP=0x000000000024d710
- (void)_parseSingleContentListFromPageDataDictionary:(id)arg1 isMemberOfChartSet:(_Bool)arg2;	// IMP=0x000000000024cb44
- (_Bool)_parseFeaturedContentChild:(id)arg1 isMemberOfChartSet:(_Bool)arg2 insertingResultsToSectionedCollection:(id)arg3 atSectionIndex:(long long)arg4 additionalContentIdentifiers:(id)arg5 allAdditionalContentIdentifiersNeedingLookup:(id)arg6;	// IMP=0x000000000024be2b
- (void)_parseFeaturedContentStructureModelChildren:(id)arg1;	// IMP=0x000000000024b73a
- (void)_parse;	// IMP=0x000000000024b541
...
- (id)initWithPreviousParser:(id)arg1 additionalStoreItemMetadataResponse:(id)arg2 options:(CDStruct_d2d88407)arg3 sectionBuilder:(id)arg4 contentItemBuilder:(id)arg5 userIdentity:(id)arg6;	// IMP=0x000000000024b30b
- (id)initWithRawResponseOutput:(id)arg1 options:(CDStruct_d2d88407)arg2 sectionBuilder:(id)arg3 contentItemBuilder:(id)arg4 userIdentity:(id)arg5;	// IMP=0x000000000024b225
