...
- (void).cxx_destruct;	// IMP=0x0000000000239c90
...
- (void)resolveError:(id)arg1;	// IMP=0x0000000000239c6b
- (id)initWithStoreAccountIdentifier:(id)arg1;	// IMP=0x0000000000239bfd
