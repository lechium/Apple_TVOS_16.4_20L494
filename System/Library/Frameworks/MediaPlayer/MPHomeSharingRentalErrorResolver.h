...
- (void).cxx_destruct;	// IMP=0x00000000001d70c6
...
- (_Bool)_errorIsFairPlayError:(id)arg1;	// IMP=0x00000000001d7088
- (void)requestDidFinish:(id)arg1;	// IMP=0x00000000001d6eab
- (void)request:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000001d6c9d
- (void)resolveError:(id)arg1;	// IMP=0x00000000001d6abd
- (void)dealloc;	// IMP=0x00000000001d6a58
- (id)initWithItemID:(unsigned long long)arg1 homeSharingID:(unsigned long long)arg2 rentalID:(unsigned long long)arg3 accountID:(unsigned long long)arg4;	// IMP=0x00000000001d69de
