...
+ (void)enumerateExtensionsInDirectoryAtURL:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x006000000003f331
- (void).cxx_destruct;	// IMP=0x0000000000040045
...
- (id)nextObject;	// IMP=0x000000000003ffa9
- (id)initWithCacheURLs:(id)arg1 paths:(id)arg2;	// IMP=0x000000000003f926
- (id)initWithCacheURLs:(id)arg1;	// IMP=0x000000000003f90d
