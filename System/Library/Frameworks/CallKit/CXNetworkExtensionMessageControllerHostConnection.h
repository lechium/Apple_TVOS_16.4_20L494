...
- (void)sendNetworkExtensionMessage:(id)arg1 forBundleIdentifier:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000000004f11f
- (void)invalidate;	// IMP=0x000000000004f0bf
...
- (id)initWithConnection:(id)arg1;	// IMP=0x000000000004eba2
