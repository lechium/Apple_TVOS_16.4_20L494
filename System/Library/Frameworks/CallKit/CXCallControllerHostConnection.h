...
- (void).cxx_destruct;	// IMP=0x00000000000457a4
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000455a3
- (oneway void)requestCalls:(CDUnknownBlockType)arg1;	// IMP=0x000000000004549d
- (oneway void)removeCall:(id)arg1;	// IMP=0x000000000004542b
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x00000000000453b9
...
- (void)dealloc;	// IMP=0x0000000000045167
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x0000000000044b4e
- (id)init;	// IMP=0x0000000000044b40
