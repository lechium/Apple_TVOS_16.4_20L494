...
- (void).cxx_destruct;	// IMP=0x000000000001421a
@property(retain, nonatomic) CNTransportButton *transportIcon; // @synthesize transportIcon=_transportIcon;
@property(retain, nonatomic) UILabel *label; // @synthesize label=_label;
- (id)variableConstraints;	// IMP=0x0000000000013fd1
@property(readonly, nonatomic) CNContactAction *action;
@property(readonly, nonatomic) CNCardActionGroupItem *actionGroupItem;
- (void)setCardGroupItem:(id)arg1;	// IMP=0x0000000000013bed
- (void)setLabelTextAttributes:(id)arg1;	// IMP=0x00000000000139dc
- (_Bool)shouldPerformDefaultAction;	// IMP=0x00000000000139d4
- (double)minCellHeight;	// IMP=0x00000000000139c6
- (id)labelView;	// IMP=0x0000000000013979
