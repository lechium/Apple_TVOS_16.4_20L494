...
+ (_Bool)requiresConstraintBasedLayout;	// IMP=0x00100000000cc73a
- (void).cxx_destruct;	// IMP=0x00000000000ccbf9
...
- (void)didPressActionView:(id)arg1 longPress:(_Bool)arg2;	// IMP=0x00000000000cc92a
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000cc8c0
- (void)updateConstraints;	// IMP=0x00000000000cc742
- (void)resetActions;	// IMP=0x00000000000cc434
- (void)addActionItem:(id)arg1;	// IMP=0x00000000000cbe93
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000cbdea
