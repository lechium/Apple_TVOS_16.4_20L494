...
- (void).cxx_destruct;	// IMP=0x0000000000084308
...
- (void)reject;	// IMP=0x0000000000084283
- (void)confirm;	// IMP=0x0000000000084231
- (_Bool)_confirmOrReject:(_Bool)arg1;	// IMP=0x0000000000084229
- (void)performActionForItem:(id)arg1 sender:(id)arg2;	// IMP=0x0000000000083efc
