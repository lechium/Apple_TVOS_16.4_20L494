...
+ (id)fmfHandleFromContactProperty:(id)arg1;	// IMP=0x006000000009d50c
+ (id)fmfHandlesFromContact:(id)arg1;	// IMP=0x006000000009cf96
- (void).cxx_destruct;	// IMP=0x000000000009d6fa
...
- (void)notifySharingStatusDidChange;	// IMP=0x000000000009d42f
- (void)initiateIDSRequest;	// IMP=0x000000000009cf90
- (id)endOfDayDate;	// IMP=0x000000000009cef7
- (void)stopSharingLocation;	// IMP=0x000000000009ce0c
- (void)shareLocationUntilEndDate:(id)arg1;	// IMP=0x000000000009cc2a
- (void)perform:(id)arg1;	// IMP=0x000000000009c3aa
@property(readonly, nonatomic) _Bool isSharing;
@property(readonly, nonatomic) _Bool canShare;
- (id)initWithIDSAvailabilityProvider:(id)arg1;	// IMP=0x000000000009c05a
