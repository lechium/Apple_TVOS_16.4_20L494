...
- (void).cxx_destruct;	// IMP=0x0000000000095628
...
- (id)contacts;	// IMP=0x00000000000955b8
- (id)presentingViewControllerForAvatarView:(id)arg1;	// IMP=0x000000000009554a
- (void)setContacts:(id)arg1;	// IMP=0x00000000000954a8
- (void)loadView;	// IMP=0x0000000000095334
- (id)initWithSettings:(id)arg1;	// IMP=0x00000000000951fc
- (id)descriptorForRequiredKeys;	// IMP=0x00000000000951c7
