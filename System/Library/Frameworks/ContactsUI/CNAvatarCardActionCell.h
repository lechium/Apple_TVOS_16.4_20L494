...
+ (id)animatingCell;	// IMP=0x00600000000500bc
+ (id)cellNibForContacts;	// IMP=0x00600000000500b4
+ (id)cellNibForMode:(long long)arg1;	// IMP=0x00600000000500ac
- (void).cxx_destruct;	// IMP=0x00000000000531f6
...
- (void)trackHighlight:(id)arg1;	// IMP=0x0000000000052c6d
- (void)_animateActions:(id)arg1 fromIndex:(unsigned long long)arg2 withDelta:(long long)arg3 scrollDirection:(unsigned long long)arg4;	// IMP=0x0000000000052503
- (void)trackSwipe:(id)arg1;	// IMP=0x0000000000051fb5
- (void)stopTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x0000000000051ddf
- (void)startTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x0000000000051cdb
- (void)reloadData;	// IMP=0x0000000000050f69
- (void)_updateHighlightAnimated:(_Bool)arg1;	// IMP=0x0000000000050bf0
- (void)prepareForReuse;	// IMP=0x0000000000050b54
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000000005083a
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000050823
- (void)awakeFromNib;	// IMP=0x00000000000502ff
- (void)_updateFonts;	// IMP=0x00000000000501af
