...
+ (id)descriptorForRequiredKeys;	// IMP=0x0060000000053c15
- (void).cxx_destruct;	// IMP=0x00000000000557c5
...
- (void)cellWasSingleTapped:(id)arg1;	// IMP=0x0000000000055594
- (void)cellWasLongPressed:(id)arg1;	// IMP=0x0000000000055544
- (void)showMenu;	// IMP=0x000000000005545c
- (void)menuDidHide:(id)arg1;	// IMP=0x00000000000553ff
- (_Bool)canBecomeFirstResponder;	// IMP=0x00000000000553f7
- (void)copy:(id)arg1;	// IMP=0x0000000000055363
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x0000000000055327
- (void)setMeContact:(id)arg1 footnoteTitle:(id)arg2 footnoteValue:(id)arg3;	// IMP=0x0000000000054fab
- (id)footnoteTextColor;	// IMP=0x0000000000054dbe
- (id)footnoteFont;	// IMP=0x0000000000054d30
- (_Bool)displaysContactInfo;	// IMP=0x0000000000054cfd
- (void)updateFontRelatedConstraints;	// IMP=0x0000000000054a6e
- (void)dealloc;	// IMP=0x00000000000549f9
- (id)init;	// IMP=0x0000000000053d44
