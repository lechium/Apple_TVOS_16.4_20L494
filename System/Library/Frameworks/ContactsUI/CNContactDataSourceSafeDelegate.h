...
- (void).cxx_destruct;	// IMP=0x00000000000c96d0
@property(nonatomic) __weak id <CNContactDataSourceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)contactDataSourceDidChange:(id)arg1;	// IMP=0x00000000000c9602
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000c9587
