...
- (_Bool)isSyntheticGroup:(id)arg1;	// IMP=0x00000000000a2da7
- (id)peopleInGroup:(id)arg1 withKeysToFetch:(id)arg2;	// IMP=0x00000000000a2cc1
- (id)groupAtIndexPath:(id)arg1;	// IMP=0x00000000000a2c2e
- (unsigned long long)numberOfGroupsInSection:(unsigned long long)arg1;	// IMP=0x00000000000a2bea
- (unsigned long long)numberOfSections;	// IMP=0x00000000000a2bdf
- (id)buildGroupList;	// IMP=0x00000000000a2a29
- (void)sourceDidChange:(id)arg1;	// IMP=0x00000000000a29d0
- (void)reloadData;	// IMP=0x00000000000a2984
- (void)createSources;	// IMP=0x00000000000a26a5
- (void)dealloc;	// IMP=0x00000000000a2630
- (id)initWithEnvironment:(id)arg1 contactStore:(id)arg2;	// IMP=0x00000000000a2510
- (id)init;	// IMP=0x00000000000a2448
