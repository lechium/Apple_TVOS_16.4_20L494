...
- (void).cxx_destruct;	// IMP=0x00000000000ae9b2
...
- (long long)localizedCompare:(id)arg1;	// IMP=0x00000000000ae860
- (id)arrayForDisplay:(_Bool)arg1;	// IMP=0x00000000000ae563
- (void)_setSelected:(_Bool)arg1;	// IMP=0x00000000000ae0e2
- (id)initWithType:(long long)arg1;	// IMP=0x00000000000adebd
