...
+ (id)descriptorForContactPropertiesSupportingPredicateEvaluation;	// IMP=0x00100000000c4702
- (void).cxx_destruct;	// IMP=0x00000000000c77ff
...
- (void)_selectedProperties:(id)arg1;	// IMP=0x00000000000c718e
- (void)_selectedContacts:(id)arg1;	// IMP=0x00000000000c6ee3
- (void)_selectedProperty:(id)arg1;	// IMP=0x00000000000c6d50
- (void)_selectedContact:(id)arg1;	// IMP=0x00000000000c6c68
- (id)descriptorsForKeysRequiredByDelegate;	// IMP=0x00000000000c6bd6
- (void)contactNavigationControllerDidCancel:(id)arg1;	// IMP=0x00000000000c6b99
- (void)contactNavigationControllerDidComplete:(id)arg1;	// IMP=0x00000000000c6afd
- (_Bool)contactNavigationController:(id)arg1 presentContactViewController:(id)arg2 animated:(_Bool)arg3;	// IMP=0x00000000000c6a30
- (_Bool)contactNavigationController:(id)arg1 shouldPerformDefaultActionForContactProperty:(id)arg2;	// IMP=0x00000000000c6852
- (_Bool)contactNavigationControllerShouldShowContactsOnKeyCommands:(id)arg1;	// IMP=0x00000000000c684a
- (_Bool)contactNavigationController:(id)arg1 shouldShowCardForContact:(id)arg2;	// IMP=0x00000000000c664f
- (_Bool)contactNavigationController:(id)arg1 shouldSelectContact:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x00000000000c5b2e
- (_Bool)contactNavigationController:(id)arg1 canSelectContact:(id)arg2;	// IMP=0x00000000000c59dd
- (void)invalidate;	// IMP=0x00000000000c59d7
- (void)invalidateSelectionAnimated:(_Bool)arg1;	// IMP=0x00000000000c5826
@property(readonly, nonatomic) UINavigationController *navigationController;
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000000c5788
- (void)_updatePromptWithViewSize:(struct CGSize)arg1 transitionCoordinator:(id)arg2;	// IMP=0x00000000000c5579
- (id)_validatePredicatesWithError:(id *)arg1;	// IMP=0x00000000000c51d2
- (void)setupWithOptions:(id)arg1 readyBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c47b2
- (id)init;	// IMP=0x00000000000c471b
