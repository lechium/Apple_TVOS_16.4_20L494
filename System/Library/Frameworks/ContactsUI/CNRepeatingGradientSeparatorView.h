...
- (void).cxx_destruct;	// IMP=0x00000000000a2417
...
- (void)layoutSubviews;	// IMP=0x00000000000a1fe2
- (void)_updateGradients;	// IMP=0x00000000000a1e12
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000a1dcf
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a1cd2
