...
- (void)setServerFilterForItem:(id)arg1;	// IMP=0x00000000000b09f8
@property(copy, nonatomic) CNContactStoreFilter *filter;
- (void)_applyFilter;	// IMP=0x00000000000b0362
- (void)_reloadSections;	// IMP=0x00000000000aeaad
- (void)reload;	// IMP=0x00000000000aea99
- (id)initWithStore:(id)arg1;	// IMP=0x00000000000ae9f9
