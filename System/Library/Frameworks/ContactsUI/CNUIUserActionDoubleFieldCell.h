...
+ (id)subtitleTextColor;	// IMP=0x0060000000079932
- (void).cxx_destruct;	// IMP=0x000000000007a1f7
...
- (void)updateFonts;	// IMP=0x0000000000079f0c
- (void)viewWillMoveToSuperview:(id)arg1;	// IMP=0x0000000000079ebf
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000079966
