...
+ (double)actionsLeftMargin;	// IMP=0x00600000000a4b15
- (void).cxx_destruct;	// IMP=0x00000000000a65c4
...
- (_Bool)isHighlighted;	// IMP=0x00000000000a6320
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000a62d4
- (void)_updateActionsMask;	// IMP=0x00000000000a6207
- (CDUnknownBlockType)completionBlockForHidingActions;	// IMP=0x00000000000a612e
- (CDUnknownBlockType)animationBlockForPreparingToShowActions;	// IMP=0x00000000000a5b1d
@property(retain, nonatomic) CNContact *contact;
- (void)updateConstraints;	// IMP=0x00000000000a5028
- (void)_createViewsIfNeeded;	// IMP=0x00000000000a4cea
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x00000000000a4cd4
