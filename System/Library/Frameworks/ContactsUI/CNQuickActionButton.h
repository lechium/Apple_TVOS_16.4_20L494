...
- (void).cxx_destruct;	// IMP=0x000000000009e67e
...
- (void)onLongPress:(id)arg1;	// IMP=0x000000000009e2fc
- (void)performAction;	// IMP=0x000000000009e21f
- (void)updateConstraints;	// IMP=0x000000000009dde1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009d89d
