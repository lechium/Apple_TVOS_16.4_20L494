...
- (void).cxx_destruct;	// IMP=0x000000000008f2d9
...
- (void)setPreferredForName;	// IMP=0x000000000008f072
- (void)setPreferredForImage;	// IMP=0x000000000008ee86
- (void)performActionForItem:(id)arg1 sender:(id)arg2;	// IMP=0x000000000008e735
- (void)dealloc;	// IMP=0x000000000008e6f3
- (id)initWithContact:(id)arg1;	// IMP=0x000000000008e6c4
