...
- (void).cxx_destruct;	// IMP=0x00000000000ca7f3
...
- (void)invalidate;	// IMP=0x00000000000ca6ef
- (void)invalidateSearch;	// IMP=0x00000000000ca672
- (void)invalidateResults;	// IMP=0x00000000000ca5ec
- (void)reloadWithRequest:(id)arg1;	// IMP=0x00000000000ca078
- (void)reload;	// IMP=0x00000000000c9ee3
@property(readonly, nonatomic) CNContactFilter *effectiveFilter;
- (id)indexPathForContact:(id)arg1;	// IMP=0x00000000000c9d73
- (id)completeContactFromContact:(id)arg1 fromMainStoreOnly:(_Bool)arg2 keysToFetch:(id)arg3;	// IMP=0x00000000000c9bce
...
- (void)dealloc;	// IMP=0x00000000000c9a06
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c98c2
- (id)initWithStore:(id)arg1;	// IMP=0x00000000000c96de
