...
- (id)bestMoveForActivePlayer;	// IMP=0x0000000000032656
- (_Bool)validateRandomSource;	// IMP=0x00000000000325e1
- (_Bool)validateGameModel:(id)arg1;	// IMP=0x000000000003249a
- (void)dealloc;	// IMP=0x000000000003244c
- (id)init;	// IMP=0x00000000000323c1
