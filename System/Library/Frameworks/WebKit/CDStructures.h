...
struct FrameInfoData {
    ...
    optional_f32ed9ed frameID;
    optional_f32ed9ed parentFrameID;
};
...
struct ProcessQualified<WTF::ObjectIdentifier<WebCore::FrameIdentifierType>> {
    struct ObjectIdentifier<WebCore::FrameIdentifierType> m_object;
...
struct optional<WebCore::ProcessQualified<WTF::ObjectIdentifier<WebCore::FrameIdentifierType>>> {
    union {
        char __null_state_;
        struct ProcessQualified<WTF::ObjectIdentifier<WebCore::FrameIdentifierType>> __val_;
    } ;
    _Bool __engaged_;
};
