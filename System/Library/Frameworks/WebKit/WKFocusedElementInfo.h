...
- (id).cxx_construct;	// IMP=0x000000000072d91c
- (void).cxx_destruct;	// IMP=0x000000000072d8b2
...
- (id)initWithFocusedElementInformation:(const void *)arg1 isUserInitiated:(_Bool)arg2 userObject:(id)arg3;	// IMP=0x000000000072d6fa
