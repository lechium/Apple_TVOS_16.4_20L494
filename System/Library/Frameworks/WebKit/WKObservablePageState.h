...
- (id).cxx_construct;	// IMP=0x0000000000185604
- (void).cxx_destruct;	// IMP=0x00000000001855bd
...
- (void)dealloc;	// IMP=0x0000000000185355
- (id)initWithPage:(void *)arg1;	// IMP=0x0000000000185284
