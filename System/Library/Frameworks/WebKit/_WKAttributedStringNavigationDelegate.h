...
- (void)webView:(id)arg1 didFinishNavigation:(id)arg2;	// IMP=0x000000000018795d
- (void)webView:(id)arg1 didFailNavigation:(id)arg2 withError:(id)arg3;	// IMP=0x000000000018793e
- (void)webView:(id)arg1 didFailProvisionalNavigation:(id)arg2 withError:(id)arg3;	// IMP=0x000000000018791f
- (void)webView:(id)arg1 decidePolicyForNavigationAction:(id)arg2 decisionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001878f6
- (void)webViewWebContentProcessDidTerminate:(id)arg1;	// IMP=0x00000000001878dd
- (void)dealloc;	// IMP=0x0000000000187863
