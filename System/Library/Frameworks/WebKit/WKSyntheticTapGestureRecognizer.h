...
- (id).cxx_construct;	// IMP=0x0000000000376fa6
- (void).cxx_destruct;	// IMP=0x0000000000376f2f
...
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000376cf2
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000376b5c
- (void)reset;	// IMP=0x0000000000376ad0
- (void)setState:(long long)arg1;	// IMP=0x0000000000376a42
- (void)setResetTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000376a13
- (void)setGestureFailedTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000003769e4
- (void)setGestureIdentifiedTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000003769b5
