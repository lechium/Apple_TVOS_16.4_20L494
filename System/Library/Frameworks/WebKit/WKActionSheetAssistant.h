...
- (id).cxx_construct;	// IMP=0x0000000000369ca5
- (void).cxx_destruct;	// IMP=0x0000000000369c40
@property(nonatomic) _Bool needsLinkIndicator; // @synthesize needsLinkIndicator=_needsLinkIndicator;
- (id)currentlyAvailableActionTitles;	// IMP=0x0000000000369a85
- (void)cleanupSheet;	// IMP=0x0000000000369988
- (void)handleElementActionWithType:(long long)arg1 element:(id)arg2 needsInteraction:(_Bool)arg3;	// IMP=0x00000000003695d8
- (void)showDataDetectorsUIForPositionInformation:(const void *)arg1;	// IMP=0x00000000003695d2
- (void)showLinkSheet;	// IMP=0x0000000000369260
- (RetainPtr_c682c8da)defaultActionsForImageSheet:(id)arg1;	// IMP=0x0000000000369106
- (RetainPtr_c682c8da)defaultActionsForLinkSheet:(id)arg1;	// IMP=0x0000000000368f5f
- (void)_appendOpenActionsForURL:(id)arg1 actions:(id)arg2 elementInfo:(id)arg3;	// IMP=0x0000000000368f19
- (long long)_presentationStyleForPositionInfo:(const void *)arg1 elementInfo:(id)arg2;	// IMP=0x0000000000368b1d
- (void)showImageSheet;	// IMP=0x0000000000368416
- (void)_createSheetWithElementActions:(id)arg1 defaultTitle:(id)arg2 showLinkTitle:(_Bool)arg3;	// IMP=0x0000000000367ecc
...
- (void)interactionDidStartWithPositionInformation:(const void *)arg1;	// IMP=0x0000000000367e73
- (_Bool)isShowingSheet;	// IMP=0x0000000000367e65
- (void)updateSheetPosition;	// IMP=0x0000000000367e4f
- (_Bool)presentSheet;	// IMP=0x0000000000367d56
- (void)updatePositionInformation;	// IMP=0x0000000000367cde
- (struct CGRect)presentationRectInHostViewForSheet;	// IMP=0x0000000000367b7c
- (struct CGRect)initialPresentationRectInHostViewForSheet;	// IMP=0x0000000000367aa4
- (struct CGRect)presentationRectForIndicatedElement;	// IMP=0x0000000000367965
- (struct CGRect)presentationRectForElementUsingClosestIndicatedRect;	// IMP=0x0000000000367567
- (id)hostViewForSheet;	// IMP=0x0000000000367555
- (struct CGRect)_presentationRectForSheetGivenPoint:(struct CGPoint)arg1 inHostView:(id)arg2;	// IMP=0x00000000003674cc
- (id)superviewForSheet;	// IMP=0x0000000000367421
- (_Bool)synchronouslyRetrievePositionInformation;	// IMP=0x0000000000367317
- (void)dealloc;	// IMP=0x00000000003672d9
- (id)initWithView:(id)arg1;	// IMP=0x00000000003672b7
