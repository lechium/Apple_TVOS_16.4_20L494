...
- (void).cxx_destruct;	// IMP=0x0000000000379783
@property(nonatomic) __weak WKDataListSuggestionsControl *control; // @synthesize control=_control;
- (void)controlEndEditing;	// IMP=0x0000000000379712
- (void)controlBeginEditing;	// IMP=0x000000000037970c
- (id)controlView;	// IMP=0x0000000000379703
