...
- (void).cxx_destruct;	// IMP=0x000000000001c4c2
...
- (void)_addRemoteView;	// IMP=0x000000000001c2c2
- (void)_requestRemoteViewController;	// IMP=0x000000000001be8b
- (void)remoteReviewViewControllerTerminatedWithError:(id)arg1;	// IMP=0x000000000001be75
- (void)_didFinishWithResult:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x000000000001bd75
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000001bcd4
- (void)viewDidLoad;	// IMP=0x000000000001bc28
- (void)dealloc;	// IMP=0x000000000001bb8d
- (id)initWithReviewRequestToken:(id)arg1;	// IMP=0x000000000001baa5
