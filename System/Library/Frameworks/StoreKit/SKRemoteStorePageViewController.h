...
+ (id)serviceViewControllerInterface;	// IMP=0x0010000000036d37
+ (id)exportedInterface;	// IMP=0x0010000000036d17
- (void).cxx_destruct;	// IMP=0x0000000000036d84
...
- (void)showProductPageWithItemIdentifier:(id)arg1;	// IMP=0x0000000000036ca5
- (void)didFinishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000000036c1f
