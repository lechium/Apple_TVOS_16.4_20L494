...
- (void).cxx_destruct;	// IMP=0x00000000000270a6
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000026b8e
- (void)stopListeningForScrollingOfView:(id)arg1;	// IMP=0x00000000000268be
- (void)findAndListenForScrollingOfView:(id)arg1;	// IMP=0x00000000000265a9
- (void)dealloc;	// IMP=0x00000000000263b4
- (id)init;	// IMP=0x00000000000263a0
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000026322
