...
+ (id)serviceViewControllerInterface;	// IMP=0x0010000000036fc1
+ (id)exportedInterface;	// IMP=0x0010000000036fa1
...
- (void)didFinishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000000036f03
