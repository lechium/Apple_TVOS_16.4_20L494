...
- (unsigned long long)argumentIndex;	// IMP=0x00000000000e942b
...
- (unsigned long long)dataType;	// IMP=0x00000000000e93f8
- (unsigned long long)offset;	// IMP=0x00000000000e93e7
- (id)name;	// IMP=0x00000000000e93d6
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000e91e1
- (id)dataTypeDescription;	// IMP=0x00000000000e91d0
- (_Bool)isMemberLayoutThreadSafeWith:(id)arg1;	// IMP=0x00000000000e9057
- (id)indirectArgumentType;	// IMP=0x00000000000e9046
- (void)setOffset:(unsigned long long)arg1;	// IMP=0x00000000000e9035
- (id)pointerType;	// IMP=0x00000000000e8ffb
- (id)textureReferenceType;	// IMP=0x00000000000e8fc1
- (id)structType;	// IMP=0x00000000000e8f9e
- (id)arrayType;	// IMP=0x00000000000e8f7b
- (unsigned long long)indirectArgumentIndex;	// IMP=0x00000000000e8f6a
- (void)dealloc;	// IMP=0x00000000000e8f04
- (id)initWithName:(id)arg1 offset:(unsigned long long)arg2 dataType:(unsigned long long)arg3 pixelFormat:(unsigned long long)arg4 aluType:(unsigned long long)arg5 indirectArgumentIndex:(unsigned long long)arg6 render_target:(unsigned long long)arg7 raster_order_group:(unsigned long long)arg8 details:(id)arg9;	// IMP=0x00000000000e8de3
