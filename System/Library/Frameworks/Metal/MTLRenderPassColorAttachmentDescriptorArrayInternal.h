...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000dfb05
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x00000000000dfa42
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x00000000000df9c7
- (void)dealloc;	// IMP=0x00000000000df94b
