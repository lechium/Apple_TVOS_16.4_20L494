...
- (id)description;	// IMP=0x0000000000039127
- (void)dealloc;	// IMP=0x00000000000390c6
- (id)initWithData:(id)arg1 importedSymbols:(id)arg2 importedLibraries:(id)arg3;	// IMP=0x0000000000039046
