...
- (_Bool)serializeToURL:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0000000000062e2b
- (id)airData;	// IMP=0x0000000000062dfd
- (oneway void)release;	// IMP=0x0000000000062d4b
- (void)dealloc;	// IMP=0x0000000000062ca0
- (id)initWithURL:(id)arg1 device:(id)arg2 options:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x0000000000062367
- (id)initWithLibrary:(struct MTLLibraryData *)arg1 binaryData:(id)arg2 device:(id)arg3 error:(id *)arg4;	// IMP=0x000000000006213c
