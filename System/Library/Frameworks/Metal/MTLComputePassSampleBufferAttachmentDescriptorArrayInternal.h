...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x000000000007e1f6
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x000000000007e177
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x000000000007e0fc
- (void)dealloc;	// IMP=0x000000000007e09c
