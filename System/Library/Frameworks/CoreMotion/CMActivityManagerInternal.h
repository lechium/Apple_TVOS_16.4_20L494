...
- (void)simulateMotionStateYouthWithState:(long long)arg1;	// IMP=0x0000000000199d31
- (void)simulateMotionState:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x0000000000199b39
- (void)overrideOscarSideband:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x0000000000199941
- (void)stopActivityUpdatesPrivate;	// IMP=0x0000000000199799
- (void)startActivityUpdatesWithHandlerPrivate:(CDUnknownBlockType)arg1;	// IMP=0x000000000019961e
- (void)disconnect;	// IMP=0x00000000001995ee
- (void)connect;	// IMP=0x0000000000198c04
- (void)dealloc;	// IMP=0x0000000000198b82
- (id)init;	// IMP=0x0000000000198b34
