...
- (void).cxx_destruct;	// IMP=0x00000000001351cc
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000001351b4
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x00000000001351a0
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x0000000000134cea
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x0000000000134a9c
