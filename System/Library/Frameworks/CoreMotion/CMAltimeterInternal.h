...
- (id).cxx_construct;	// IMP=0x00000000001f5819
- (void).cxx_destruct;	// IMP=0x00000000001f580b
- (void)_stopRelativeAltitudeUpdates;	// IMP=0x00000000001f5663
- (void)_startRelativeAltitudeUpdates;	// IMP=0x00000000001f54ca
- (void)_querySignificantElevationChangeFromDate:(id)arg1 toDate:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001f4d9a
- (void)_stopSignificantElevationUpdates;	// IMP=0x00000000001f4bf9
- (void)_startSignificantElevationUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001f4a22
- (void)_stopElevationUpdates;	// IMP=0x00000000001f4861
- (void)_startElevationUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001f468a
- (void)_teardown;	// IMP=0x00000000001f45f8
- (void)dealloc;	// IMP=0x00000000001f4580
- (id)init;	// IMP=0x00000000001f357c
