...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000012a7b8
...
- (id)description;	// IMP=0x000000000012a8c6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000012a85b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000012a7c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012a765
- (void)dealloc;	// IMP=0x000000000012a736
- (id)initWithLowerBound:(double)arg1 upperBound:(double)arg2 classificationType:(long long)arg3;	// IMP=0x000000000012a6db
