...
- (void)_stopCyclingWorkoutDistanceUpdates;	// IMP=0x00000000001417d3
- (void)_startCyclingWorkoutDistanceUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000140fd1
- (void)_stopOdometerUpdates;	// IMP=0x0000000000140e48
- (void)_startOdometerUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001407a0
- (void)_startDaemonConnection;	// IMP=0x00000000001401c2
- (void)_teardown;	// IMP=0x0000000000140176
- (void)dealloc;	// IMP=0x000000000014012c
- (id)initWithOdometer:(id)arg1;	// IMP=0x000000000014004a
