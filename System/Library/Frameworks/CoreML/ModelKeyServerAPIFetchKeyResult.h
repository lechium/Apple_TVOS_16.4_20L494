...
- (void).cxx_destruct;	// IMP=0x000000000002333d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000023195
- (unsigned long long)hash;	// IMP=0x00000000000230c1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000022f29
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000022df7
- (void)copyTo:(id)arg1;	// IMP=0x0000000000022d14
- (void)writeTo:(id)arg1;	// IMP=0x0000000000022c60
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000022c53
- (id)dictionaryRepresentation;	// IMP=0x0000000000022a92
- (id)description;	// IMP=0x00000000000229e3
- (void)clearOneofValuesForKey;	// IMP=0x0000000000022983
- (int)StringAsKey:(id)arg1;	// IMP=0x00000000000228f1
- (id)keyAsString:(int)arg1;	// IMP=0x00000000000228a8
