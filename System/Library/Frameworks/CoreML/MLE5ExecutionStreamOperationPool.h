...
- (void).cxx_destruct;	// IMP=0x00000000000134b3
...
- (void)putBack:(id)arg1;	// IMP=0x000000000001338e
- (id)takeOut;	// IMP=0x000000000001328a
- (id)initWithE5BundleAtURL:(id)arg1 functionName:(id)arg2 outputDescriptionsByName:(id)arg3;	// IMP=0x00000000000130d3
