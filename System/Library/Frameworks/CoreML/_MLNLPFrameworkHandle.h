...
+ (id)sharedHandle;	// IMP=0x00600000001542e0
...
- (id)predictVectorForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001540a5
- (id)predictLabelForWordString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000153f56
- (id)predictLabelsForSentenceString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000153e0a
- (id)predictTokensLabelsLocationsLengthsForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000153cbe
- (const void *)initializeEmbeddingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000153c76
- (const void *)initializeGazetteerModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000153c31
- (const void *)initializeSentenceClassifierModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000153bec
- (const void *)initializeWordTaggingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000153ba7
- (id)init;	// IMP=0x00000000001538f7
