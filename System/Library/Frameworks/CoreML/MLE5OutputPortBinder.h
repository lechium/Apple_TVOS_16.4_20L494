...
- (void).cxx_destruct;	// IMP=0x00000000000fd389
...
- (id)_makeFeatureValueAndReturnError:(id *)arg1;	// IMP=0x00000000000fc9a2
@property(readonly) MLFeatureValue *featureValue;
- (_Bool)bindAndReturnError:(id *)arg1;	// IMP=0x00000000000fc4d4
- (id)initWithPort:(struct e5rt_io_port *)arg1 featureDescription:(id)arg2;	// IMP=0x00000000000fc42e
