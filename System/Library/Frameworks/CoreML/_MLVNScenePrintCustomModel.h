...
- (void).cxx_destruct;	// IMP=0x00000000000bbbd7
...
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000bb619
- (id)featureValueFromScenePrint:(id)arg1 elementSize:(unsigned long long)arg2;	// IMP=0x00000000000bb25b
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000baabc
