...
- (void).cxx_destruct;	// IMP=0x0000000000189c1a
@property(readonly, nonatomic) NSEnumerator *labelEnumerator;
- (id)labelAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000189bee
@property(readonly, nonatomic) unsigned long long uniqueLabelCount;
@property(readonly, nonatomic) unsigned long long count;
- (unsigned long long)indexOfLabel:(id)arg1;	// IMP=0x0000000000189b56
- (id)initWithLabels:(id)arg1;	// IMP=0x000000000018985e
