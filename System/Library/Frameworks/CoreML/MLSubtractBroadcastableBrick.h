...
- (void).cxx_destruct;	// IMP=0x000000000001fad8
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000001f0df
- (_Bool)hasGPUSupport;	// IMP=0x000000000001f0d7
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000001ee96
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000001eb75
