...
- (void).cxx_destruct;	// IMP=0x00000000000f109a
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000f06f7
- (_Bool)hasGPUSupport;	// IMP=0x00000000000f06ef
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000f0482
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000f015d
