...
- (void).cxx_destruct;	// IMP=0x0000000000021bed
...
- (_Bool)bindFeatureValue:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000021251
- (id)initWithPort:(struct e5rt_io_port *)arg1;	// IMP=0x0000000000021214
