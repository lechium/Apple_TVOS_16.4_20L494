...
- (void).cxx_destruct;	// IMP=0x0000000000150949
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000001506a2
- (_Bool)hasGPUSupport;	// IMP=0x000000000015069a
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000150561
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000001504b8
