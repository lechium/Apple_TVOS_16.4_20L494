...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004e55e
- (unsigned long long)hash;	// IMP=0x000000000004e4ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004e3c5
- (id)initWithSize:(struct CGSize)arg1 pixelFormatType:(unsigned int)arg2;	// IMP=0x000000000004e36c
