...
- (void).cxx_destruct;	// IMP=0x00000000000ef975
...
- (id)numberFromCString:(const char *)arg1;	// IMP=0x00000000000ef63a
- (void)extractAndSetModelDetailsFromArchive:(void *)arg1;	// IMP=0x00000000000eeb47
