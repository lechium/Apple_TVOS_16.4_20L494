...
- (void).cxx_destruct;	// IMP=0x000000000007cd3f
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000007cb1f
- (_Bool)hasGPUSupport;	// IMP=0x000000000007cb17
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000007c9de
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000007c9c8
