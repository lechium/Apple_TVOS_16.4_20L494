...
- (void).cxx_destruct;	// IMP=0x00000000000ab47f
...
- (id)unionFeatureProvider;	// IMP=0x00000000000ab16e
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000ab0e1
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFeaturesFrom:(id)arg1 addedToFeaturesFrom:(id)arg2;	// IMP=0x00000000000aaf81
