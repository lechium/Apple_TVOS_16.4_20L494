...
- (void).cxx_destruct;	// IMP=0x000000000015d3b0
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000015cc99
- (_Bool)hasGPUSupport;	// IMP=0x000000000015cc91
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000015ca24
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000015c673
