...
- (void).cxx_destruct;	// IMP=0x0000000000079b21
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000079179
- (_Bool)hasGPUSupport;	// IMP=0x0000000000079171
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000078f30
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000078c0f
