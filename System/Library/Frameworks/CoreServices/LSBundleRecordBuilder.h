...
- (void).cxx_destruct;	// IMP=0x000000000007c94a
...
- (unsigned int)registerBundleRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007b9a4
- (int)activateBindings:(id)arg1 unitID:(unsigned int)arg2 bundleData:(const struct LSBundleData *)arg3;	// IMP=0x000000000007b8cd
- (struct LSBundleData)buildBundleData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000790a4
- (void)parseNSExtensionSDKDefinitionsFromDictionary:(id)arg1;	// IMP=0x0000000000078bb2
- (void)parseActivityTypesFromDictionary:(id)arg1;	// IMP=0x000000000007895f
- (_Bool)parseInstallationInfo:(id)arg1;	// IMP=0x000000000007794e
- (_Bool)parseInfoPlist:(id)arg1;	// IMP=0x0000000000075ece
- (void)parseURLClaimsFromDict:(id)arg1;	// IMP=0x0000000000075c56
- (void)parseDocumentClaimsFromDict:(id)arg1;	// IMP=0x0000000000075960
- (void)parseDeviceFamilyFromDict:(id)arg1;	// IMP=0x00000000000757f5
- (void)parseIconFilenamesFromDict:(id)arg1;	// IMP=0x000000000007571b
- (id)iconsDictionaryFromDict:(id)arg1;	// IMP=0x0000000000075076
- (void)parseArchitecturesFromDict:(id)arg1;	// IMP=0x0000000000075009
- (void)setCommonInfoPlistKeysFromDictionary:(id)arg1;	// IMP=0x0000000000074ed6
- (void)setRaritiesFromDictionary:(id)arg1;	// IMP=0x0000000000074c49
- (void)setFlagsFromDictionary:(id)arg1;	// IMP=0x00000000000749a6
- (id)_LSKeyTypeMap;	// IMP=0x00000000000747b0
- (id)_LSPlistRaritiesMap;	// IMP=0x00000000000745a0
- (id)_LSBundleFlagMap;	// IMP=0x0000000000074092
- (id)truncate:(_Bool *)arg1 queriableSchemesIfNeeded:(id)arg2;	// IMP=0x0000000000073e4b
- (int)registerQueriableSchemes:(id)arg1 bundleData:(struct LSBundleData *)arg2;	// IMP=0x0000000000073a56
- (void)addItemInfoFlag:(unsigned int)arg1;	// IMP=0x0000000000073a46
- (void)addIconFlag:(unsigned char)arg1;	// IMP=0x0000000000073a36
- (void)addPlistFlag:(unsigned int)arg1;	// IMP=0x0000000000073a26
- (void)addBundleFlag:(unsigned long long)arg1;	// IMP=0x0000000000073a15
- (void)setRegistrationInfo:(id)arg1 alias:(id)arg2;	// IMP=0x0000000000073902
