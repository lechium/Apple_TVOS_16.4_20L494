...
- (void).cxx_destruct;	// IMP=0x00000000000196f9
- (id)nextObject;	// IMP=0x0000000000019546
- (id)initWithAppEnumerationOptions:(unsigned long long)arg1;	// IMP=0x0000000000019215
