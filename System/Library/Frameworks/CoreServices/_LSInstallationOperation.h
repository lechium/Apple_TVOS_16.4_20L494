...
- (void).cxx_destruct;	// IMP=0x00000000001549f2
...
- (id)redactedDescription;	// IMP=0x000000000015497f
- (id)description;	// IMP=0x0000000000154931
- (id)initWithBundleID:(id)arg1 installType:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000015487d
