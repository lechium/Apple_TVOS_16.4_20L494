...
- (void).cxx_destruct;	// IMP=0x000000000015652f
...
- (id)description;	// IMP=0x0000000000156436
- (void)sendMessage:(id)arg1;	// IMP=0x0000000000155f83
- (void)notifyObservers:(id)arg1 withApplications:(id)arg2;	// IMP=0x0000000000155b6e
- (void)clear;	// IMP=0x0000000000155b58
- (void)removeApplication:(id)arg1;	// IMP=0x00000000001559a8
- (void)addApplication:(id)arg1;	// IMP=0x0000000000155958
- (void)stopTimer;	// IMP=0x00000000001558a2
- (void)dealloc;	// IMP=0x0000000000155860
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000155790
