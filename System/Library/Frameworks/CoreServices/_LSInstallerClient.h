...
+ (id)revertInstallerWithBundleID:(id)arg1 options:(id)arg2 callbackBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000153c1e
+ (id)installerWithBundleID:(id)arg1 bundleURL:(id)arg2 options:(id)arg3 callbackBlock:(CDUnknownBlockType)arg4;	// IMP=0x0010000000153b3c
+ (id)unInstallerWithBundleID:(id)arg1 options:(id)arg2 callbackBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000153a7c
...
- (void)_invalidate;	// IMP=0x0000000000153ef8
- (void)_waitForAllCallbackMessagesToExecute;	// IMP=0x0000000000153ea2
- (void)_beginOperation;	// IMP=0x0000000000153e53
@property(readonly) _Bool allCallbacksDeleviered; // @synthesize allCallbacksDeleviered=_allCallbacksDeleviered;
- (void)callbackDeliveryComplete;	// IMP=0x0000000000153dbf
- (void)updateCallbackWithData:(id)arg1;	// IMP=0x0000000000153cde
- (id)initWithMICall:(id)arg1 options:(id)arg2 callbackBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001538d1
