...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002718a
- (void).cxx_destruct;	// IMP=0x0000000000027866
...
- (id)initWithContext:(struct LSContext *)arg1 unitID:(unsigned int)arg2;	// IMP=0x00000000000273f7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000027352
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000027192
