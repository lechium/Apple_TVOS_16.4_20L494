...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000007e5b6
- (void).cxx_destruct;	// IMP=0x000000000007e7f5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007e758
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007e66c
- (id)initWithPlugInUnits:(id)arg1 forDatabaseWithUUID:(id)arg2;	// IMP=0x000000000007e5be
