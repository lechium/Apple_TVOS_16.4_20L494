...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000049c5a
- (id).cxx_construct;	// IMP=0x000000000004a061
- (void).cxx_destruct;	// IMP=0x000000000004a018
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000049d92
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000049c62
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000049b69
- (id)debugDescription;	// IMP=0x0000000000049a0c
