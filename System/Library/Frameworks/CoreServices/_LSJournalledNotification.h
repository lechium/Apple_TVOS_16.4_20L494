...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016214b
- (void).cxx_destruct;	// IMP=0x000000000016241e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001622a2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000162201
- (id)initWithNotification:(int)arg1 bundleIDs:(id)arg2 plugins:(_Bool)arg3 options:(id)arg4;	// IMP=0x0000000000162153
