...
+ (_Bool)canHandleURLComponents:(id)arg1;	// IMP=0x006000000004be46
+ (id)plugInClasses;	// IMP=0x006000000004bdda
- (void).cxx_destruct;	// IMP=0x000000000004c0f0
...
- (id)appLinksWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x000000000004c047
