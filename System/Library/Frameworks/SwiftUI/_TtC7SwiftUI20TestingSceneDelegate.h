...
- (void).cxx_destruct;	// IMP=0x00000000007f351e
- (id)init;	// IMP=0x00000000007f34cf
- (void)scene:(id)arg1 willConnectToSession:(id)arg2 options:(id)arg3;	// IMP=0x00000000007f341b
