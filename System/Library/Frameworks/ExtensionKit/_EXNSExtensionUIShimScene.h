...
- (_Bool)shouldAcceptConnection:(id)arg1;	// IMP=0x0000000000007c52
- (void)connectToSession:(id)arg1;	// IMP=0x0000000000007ab0
- (id)makePrincipalObjectForExtension:(id)arg1;	// IMP=0x00000000000079b3
