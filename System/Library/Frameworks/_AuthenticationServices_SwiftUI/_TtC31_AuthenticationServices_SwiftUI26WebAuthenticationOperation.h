...
- (id)init;	// IMP=0x00000000000082c0
- (_Bool)isFinished;	// IMP=0x0000000000007e30
- (_Bool)isExecuting;	// IMP=0x0000000000007d80
- (_Bool)isAsynchronous;	// IMP=0x0000000000007d70
- (void)start;	// IMP=0x0000000000007d40
