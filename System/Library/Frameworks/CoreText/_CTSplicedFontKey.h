...
- (id)description;	// IMP=0x000000000008617c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000085f12
- (unsigned long long)hash;	// IMP=0x0000000000085f08
- (void)dealloc;	// IMP=0x0000000000085eb7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000085eac
