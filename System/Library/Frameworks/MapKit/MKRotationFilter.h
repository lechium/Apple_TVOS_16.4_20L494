...
- (void).cxx_destruct;	// IMP=0x00000000001c51cf
...
- (_Bool)hasAdditionalSnappingAngle;	// IMP=0x00000000001c50ea
- (void)updateSnappedToNorth;	// IMP=0x00000000001c4eef
- (void)snapToNorthAnimated:(_Bool)arg1 forceTrueNorth:(_Bool)arg2;	// IMP=0x00000000001c4d0c
- (void)stopRotatingWithFocusPoint:(struct CGPoint)arg1;	// IMP=0x00000000001c4cc4
- (void)updateRotationWithFocusPoint:(struct CGPoint)arg1 newValue:(double)arg2;	// IMP=0x00000000001c4a17
- (void)startRotatingWithFocusPoint:(struct CGPoint)arg1 withSnapping:(_Bool)arg2;	// IMP=0x00000000001c48fd
- (id)initWithMapLayer:(id)arg1;	// IMP=0x00000000001c4899
- (id)init;	// IMP=0x00000000001c486f
