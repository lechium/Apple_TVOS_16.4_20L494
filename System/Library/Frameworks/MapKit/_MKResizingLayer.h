...
- (void).cxx_destruct;	// IMP=0x00000000000699db
@property(nonatomic) _Bool needsLayoutOnBoundsChange; // @synthesize needsLayoutOnBoundsChange=_needsLayoutOnBoundsChange;
- (void)setContentsScale:(double)arg1;	// IMP=0x0000000000069827
- (void)setMask:(id)arg1;	// IMP=0x0000000000069706
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x0000000000069459
- (void)sizeSublayerToBounds:(id)arg1;	// IMP=0x0000000000069400
