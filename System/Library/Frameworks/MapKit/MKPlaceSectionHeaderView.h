...
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000005eae
@property(retain, nonatomic) UIImage *icon;
@property(retain, nonatomic) NSString *seeMoreButtonText; // @synthesize seeMoreButtonText=_seeMoreButtonText;
- (void)updateConstraints;	// IMP=0x000000000000597c
- (void)updateContent;	// IMP=0x00000000000058dc
- (void)createConstraints;	// IMP=0x0000000000004add
- (_Bool)shouldStack;	// IMP=0x000000000000477e
- (void)_updateConstraints;	// IMP=0x0000000000004443
- (void)contentSizeDidChange;	// IMP=0x0000000000004432
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000413f
