...
- (struct CGPoint)rightEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x00000000001f947c
- (struct CGPoint)leftEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x00000000001f9410
