...
- (void).cxx_destruct;	// IMP=0x0000000000091103
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
@property(nonatomic) double zoomFraction; // @synthesize zoomFraction=_zoomFraction;
- (void)updateConstraints;	// IMP=0x000000000009039b
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x0000000000090349
- (void)didMoveToWindow;	// IMP=0x0000000000090200
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000008f3a1
