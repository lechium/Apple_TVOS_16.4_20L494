...
- (void).cxx_destruct;	// IMP=0x000000000007e561
...
- (void)_buildRows;	// IMP=0x000000000007e4e3
- (void)_setNeedsBuildRows;	// IMP=0x000000000007e4d9
- (_Bool)_needsBuildRows;	// IMP=0x000000000007e4d0
- (id)linesToShow;	// IMP=0x000000000007e497
- (_Bool)hasFilteredLines;	// IMP=0x000000000007e45e
- (_Bool)hasFilteredRows;	// IMP=0x000000000007e41c
- (unsigned long long)numberOfRows;	// IMP=0x000000000007e3e7
- (void)incrementPagingFilter;	// IMP=0x000000000007e38d
- (id)initWithMapItem:(id)arg1 system:(id)arg2;	// IMP=0x000000000007e1b8
- (id)init;	// IMP=0x000000000007e18e
