...
- (void).cxx_destruct;	// IMP=0x00000000000d8175
- (_Bool)isHighlighted;	// IMP=0x00000000000d8165
@property(readonly, nonatomic) UIImageView *imageView; // @synthesize imageView=_imageView;
@property(readonly, nonatomic) _MKUILabel *titleLabel; // @synthesize titleLabel=_titleLabel;
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000d80a7
- (id)viewForLastBaselineLayout;	// IMP=0x00000000000d8092
@property(retain, nonatomic) UIImage *image;
@property(retain, nonatomic) NSString *title;
- (void)updateConstraints;	// IMP=0x00000000000d7d4f
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000d7ce0
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000d7c27
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000d781e
