...
- (void).cxx_destruct;	// IMP=0x0000000000172bb4
...
- (id)actionForKey:(id)arg1;	// IMP=0x0000000000172b89
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000172abe
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000001729cb
- (void)sizeToFit;	// IMP=0x00000000001728c3
- (void)dealloc;	// IMP=0x000000000017287d
- (id)init;	// IMP=0x00000000001727f3
