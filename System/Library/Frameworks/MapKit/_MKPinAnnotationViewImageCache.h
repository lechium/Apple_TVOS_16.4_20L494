...
- (id).cxx_construct;	// IMP=0x00000000001e5bcb
- (void).cxx_destruct;	// IMP=0x00000000001e5b43
- (void)flush;	// IMP=0x00000000001e5a51
- (void)setPins:(id)arg1 forMapType:(unsigned long long)arg2 pinColor:(id)arg3 traits:(id)arg4;	// IMP=0x00000000001e5623
- (id)pinsWithMapType:(unsigned long long)arg1 pinColor:(id)arg2 traits:(id)arg3;	// IMP=0x00000000001e53fb
- (id)init;	// IMP=0x00000000001e51ce
