...
- (id).cxx_construct;	// IMP=0x00000000001084ca
- (void).cxx_destruct;	// IMP=0x000000000010843e
...
- (void)_updateFromGameController:(id)arg1;	// IMP=0x00000000001081de
- (void)_handleGamepadDirectionalPress:(id)arg1;	// IMP=0x0000000000108078
- (void)_handleDirectionalPress:(id)arg1;	// IMP=0x0000000000107f30
- (void)_handlePan:(id)arg1;	// IMP=0x0000000000107df2
- (void)_considerChangingSelection;	// IMP=0x000000000010790d
- (void)_updateDebugView;	// IMP=0x0000000000107611
@property(readonly, nonatomic) UIView *debugView;
- (id)initWithGestureTargetView:(id)arg1 moreImportantGestureRecognizers:(id)arg2;	// IMP=0x0000000000106ef8
- (id)init;	// IMP=0x0000000000106eb4
