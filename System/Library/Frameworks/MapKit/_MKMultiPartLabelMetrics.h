...
- (void).cxx_destruct;	// IMP=0x000000000014feb1
...
- (void)reset;	// IMP=0x000000000014fb76
- (_Bool)_shiftLocationOfStrings:(id)arg1 startingAtIndex:(unsigned long long)arg2 shiftValue:(long long)arg3;	// IMP=0x000000000014fa99
- (_Bool)replaceSeparatorAtIndex:(unsigned long long)arg1 withString:(id)arg2;	// IMP=0x000000000014f760
- (id)initWithMultiPartString:(id)arg1;	// IMP=0x000000000014f221
