...
- (void).cxx_destruct;	// IMP=0x00000000000c24c1
@property(nonatomic, getter=isExpanded) _Bool expanded; // @synthesize expanded=_expanded;
@property(nonatomic) _Bool showDisclosureButton; // @synthesize showDisclosureButton=_showDisclosureButton;
- (struct CGAffineTransform)_transformForExpandedState:(_Bool)arg1 animating:(_Bool)arg2;	// IMP=0x00000000000c23ab
- (void)setExpanded:(_Bool)arg1 insideAnimation:(_Bool)arg2;	// IMP=0x00000000000c233b
- (id)_disclosureButton;	// IMP=0x00000000000c1d87
- (void)infoCardThemeChanged;	// IMP=0x00000000000c1bf2
- (void)prepareForReuse;	// IMP=0x00000000000c1b98
@property(copy, nonatomic) NSString *systemName;
@property(retain, nonatomic) UIImage *systemArtwork;
- (void)_contentSizeCategoryDidChange;	// IMP=0x00000000000c1a21
- (void)_updateConstraintValues;	// IMP=0x00000000000c1949
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x00000000000c110d
