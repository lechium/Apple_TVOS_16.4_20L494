...
- (void).cxx_destruct;	// IMP=0x000000000020c6be
...
- (_Bool)canDisplayCompleteTitleWhenExpanded;	// IMP=0x000000000020c695
- (void)setDetailView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000020bc30
@property(retain, nonatomic) UIView *detailView;
- (void)setRightView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000020aee5
- (void)setLeftView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000020a037
@property(retain, nonatomic) UIView *rightView;
@property(retain, nonatomic) UIView *leftView;
@property(copy, nonatomic) NSString *calloutSubtitle;
- (void)setCalloutSubtitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000209d01
@property(copy, nonatomic) NSString *calloutTitle;
- (id)_maskedContainerView;	// IMP=0x0000000000209b05
@property(readonly, nonatomic) struct CGSize preferredContentSize; // @synthesize preferredContentSize=_preferredContentSize;
- (void)_updatePreferredContentSize;	// IMP=0x0000000000209a66
- (void)_updatePreferredContentSizeIfNeeded;	// IMP=0x0000000000209a45
- (void)_setNeedsUpdatePreferredContentSize;	// IMP=0x0000000000209a34
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000209a05
- (void)beginMapsTransitionMovingSideways;	// IMP=0x0000000000209970
- (void)reset;	// IMP=0x00000000002097e3
- (void)_updateTransformForMotionEffectDirection:(struct CGPoint)arg1 forSubview:(id)arg2;	// IMP=0x00000000002093e5
- (_Bool)_applyKeyPathsAndRelativeValues:(id)arg1 forMotionEffect:(id)arg2;	// IMP=0x0000000000209283
- (void)dealloc;	// IMP=0x0000000000208eef
@property(nonatomic) double maximumWidth;
@property(nonatomic) double minimumWidth;
- (void)_contentSizeCategoryDidChange:(id)arg1;	// IMP=0x0000000000208c41
- (id)initWithFrame:(struct CGRect)arg1 metrics:(CDStruct_f381021a)arg2;	// IMP=0x00000000002078de
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020783c
