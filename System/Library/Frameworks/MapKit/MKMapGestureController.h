...
- (void).cxx_destruct;	// IMP=0x000000000009dce6
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x000000000009da4d
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000009d8b7
- (_Bool)tiltGestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000009d74a
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000009d725
- (void)handleArrowZoom:(id)arg1;	// IMP=0x000000000009c872
- (void)handleArrowRotate:(id)arg1;	// IMP=0x000000000009b953
- (void)handleArrowPan:(id)arg1;	// IMP=0x000000000009adaa
- (void)cancelZoomInOrOut;	// IMP=0x000000000009ad69
- (void)zoomOut;	// IMP=0x000000000009aca8
- (void)zoomIn;	// IMP=0x000000000009abe7
- (void)handleZoomArrowMask:(long long)arg1 speed:(double)arg2;	// IMP=0x000000000009aa89
- (double)variableDelayTapRecognizer:(id)arg1 shouldWaitForNextTapForDuration:(double)arg2 afterTouch:(id)arg3;	// IMP=0x000000000009a984
- (void)gestureRecognizerTouchesCanceled:(id)arg1;	// IMP=0x000000000009a972
- (void)gestureRecognizerTouchesEnded:(id)arg1;	// IMP=0x000000000009a960
- (void)gestureRecognizerTouchesBegan:(id)arg1;	// IMP=0x000000000009a94e
- (void)handleTouch:(id)arg1;	// IMP=0x000000000009a948
- (void)handlePan:(id)arg1;	// IMP=0x0000000000099d1f
- (struct CGPoint)_snapPointToDevicePixels:(struct CGPoint)arg1;	// IMP=0x0000000000099bd2
- (void)_updateZoomGestureForState:(long long)arg1 focusPoint:(struct CGPoint)arg2 scale:(double)arg3 velocity:(double)arg4 gestureType:(long long)arg5 configuration:(id)arg6;	// IMP=0x0000000000099822
- (void)handlePanZoom:(id)arg1;	// IMP=0x000000000009965c
- (void)_handleRightShoulder:(id)arg1;	// IMP=0x0000000000098f62
- (void)_handleArrowTap:(id)arg1;	// IMP=0x0000000000097f6c
- (void)handleTwoFingerLongPress:(id)arg1;	// IMP=0x0000000000097e6f
- (void)handleTwoFingerTap:(id)arg1;	// IMP=0x0000000000097bcf
- (void)handleDoubleTap:(id)arg1;	// IMP=0x00000000000978c6
- (void)_updateRotationGestureForState:(long long)arg1 focusPoint:(struct CGPoint)arg2 rotation:(double)arg3 velocity:(double)arg4;	// IMP=0x00000000000970d3
- (void)handleRotation:(id)arg1;	// IMP=0x0000000000096ebd
- (void)handleTilt:(id)arg1;	// IMP=0x0000000000096eab
- (void)_handleStandardTilt:(id)arg1;	// IMP=0x00000000000964d2
- (void)_setTraitCollection:(id)arg1;	// IMP=0x0000000000096462
- (void)clearGestureRecognizersInFlight;	// IMP=0x00000000000963d0
- (void)_clearGesture:(id)arg1;	// IMP=0x000000000009635b
- (void)stopUserInteractionFromExternalGesture;	// IMP=0x0000000000096349
- (void)startUserInteractionFromExternalGesture;	// IMP=0x0000000000096337
- (void)endGesturing;	// IMP=0x00000000000962c8
- (void)beginGesturing;	// IMP=0x0000000000096213
- (void)stopDynamicAnimations;	// IMP=0x0000000000096098
@property(nonatomic, getter=isScrollEnabled) _Bool scrollEnabled;
@property(nonatomic, getter=isZoomEnabled) _Bool zoomEnabled;
- (void)dealloc;	// IMP=0x0000000000095eb2
...
- (void)_setOneHandedZoomGestureConfiguration:(id)arg1;	// IMP=0x0000000000095e38
...
- (id)initWithMapView:(id)arg1 gestureTargetView:(id)arg2;	// IMP=0x0000000000095de2
- (id)initWithMapView:(id)arg1 gestureTargetView:(id)arg2 doubleTapTargetView:(id)arg3;	// IMP=0x00000000000956c0
