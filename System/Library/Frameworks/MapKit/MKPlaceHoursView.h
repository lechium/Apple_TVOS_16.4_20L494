...
- (void).cxx_destruct;	// IMP=0x00000000001dc534
...
- (_Bool)_shouldCollapseTopMessageLabel;	// IMP=0x00000000001dc44e
- (void)_collapseAllLabelsFromOptions;	// IMP=0x00000000001dc256
- (void)_updateHoursView;	// IMP=0x00000000001daa54
- (void)_updateOptionsForCollapsingToSingleLineAndColor;	// IMP=0x00000000001da9d4
- (id)_standardLabel;	// IMP=0x00000000001da8bd
- (void)infoCardThemeChanged;	// IMP=0x00000000001da7ec
- (_Bool)wantsDefaultClipping;	// IMP=0x00000000001da7e4
- (void)applyRulesForTopAndBottomLabel;	// IMP=0x00000000001da1ba
- (void)setTopLabel:(id)arg1;	// IMP=0x00000000001da060
@property(readonly, nonatomic) _MKUILabel *topLabel;
- (void)_contentSizeDidChange;	// IMP=0x00000000001d9cc5
- (id)hoursGrayColor;	// IMP=0x00000000001d9c87
- (void)_commonInit;	// IMP=0x00000000001d9637
- (id)initWithBusinessHours:(id)arg1;	// IMP=0x00000000001d956c
