...
- (void).cxx_destruct;	// IMP=0x00000000000b201d
- (void)submitWithHandler:(CDUnknownBlockType)arg1 queue:(id)arg2;	// IMP=0x00000000000b1d07
- (void)cancel;	// IMP=0x00000000000b1cf1
@property(readonly, nonatomic) GEOMapRegion *boundingRegion;
- (id)traits;	// IMP=0x00000000000b1ccd
- (id)initWithTicket:(id)arg1;	// IMP=0x00000000000b1c62
