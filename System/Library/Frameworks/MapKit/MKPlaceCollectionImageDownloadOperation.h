...
- (void).cxx_destruct;	// IMP=0x00000000000d49cb
...
- (void)cancel;	// IMP=0x00000000000d485c
- (_Bool)isFinished;	// IMP=0x00000000000d484c
- (_Bool)isExecuting;	// IMP=0x00000000000d483c
- (void)markOperationAsComplete;	// IMP=0x00000000000d4704
- (void)main;	// IMP=0x00000000000d3f48
- (void)start;	// IMP=0x00000000000d3e9a
- (id)initWithUrl:(id)arg1 downloadCache:(id)arg2 cacheId:(id)arg3;	// IMP=0x00000000000d3da6
