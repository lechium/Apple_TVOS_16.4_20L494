...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000c7947
- (void).cxx_destruct;	// IMP=0x00000000000c7e00
...
- (void)setCustomFeature:(id)arg1;	// IMP=0x00000000000c7ad6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c7a08
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c794f
