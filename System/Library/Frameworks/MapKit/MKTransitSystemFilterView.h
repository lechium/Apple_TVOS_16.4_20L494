...
- (void).cxx_destruct;	// IMP=0x0000000000157557
...
- (void)_contentSizeDidChange;	// IMP=0x0000000000157447
- (struct UIEdgeInsets)collectionView:(id)arg1 layout:(id)arg2 insetForSectionAtIndex:(long long)arg3;	// IMP=0x000000000015742d
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0000000000157250
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000000157154
- (void)_updateAppearance;	// IMP=0x00000000001570b4
- (void)_setupConstraints;	// IMP=0x0000000000156cf1
- (void)_setupCollectionView;	// IMP=0x0000000000156a2d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001569bb
