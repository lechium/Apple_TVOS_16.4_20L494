...
+ (id)typeForValue:(id)arg1;	// IMP=0x006000000003cba8
+ (id)typeForEncoding:(const char *)arg1;	// IMP=0x006000000003c63d
- (void).cxx_destruct;	// IMP=0x000000000003c60a
...
- (void)getBytes:(void *)arg1 forObject:(id)arg2;	// IMP=0x000000000003c544
- (id)objectWithBytes:(const void *)arg1;	// IMP=0x000000000003c35d
...
- (id)initWithCode:(long long)arg1 encoding:(id)arg2 name:(id)arg3 className:(id)arg4 size:(unsigned long long)arg5 flags:(unsigned long long)arg6;	// IMP=0x000000000003c257
