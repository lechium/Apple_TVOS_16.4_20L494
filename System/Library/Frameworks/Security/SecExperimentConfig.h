...
- (_Bool)shouldRunWithSamplingRate:(id)arg1;	// IMP=0x000000000001279f
- (unsigned int)hostHash;	// IMP=0x0000000000012774
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00000000000125c8
