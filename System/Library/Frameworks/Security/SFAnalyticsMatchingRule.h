...
- (void).cxx_destruct;	// IMP=0x00000000000407f5
...
- (unsigned int)doAction:(id)arg1 logger:(id)arg2;	// IMP=0x00000000000403a6
- (_Bool)shouldRatelimit:(id)arg1;	// IMP=0x00000000000401ff
- (_Bool)matchAttributes:(id)arg1 logger:(id)arg2;	// IMP=0x000000000003ff4c
- (id)lastMatchTimeKey;	// IMP=0x000000000003febf
- (_Bool)isSubsetMatch:(id)arg1 target:(id)arg2;	// IMP=0x000000000003fc60
- (_Bool)valueMatch:(id)arg1 target:(id)arg2;	// IMP=0x000000000003f8ae
- (id)initWithSFARule:(id)arg1 logger:(id)arg2;	// IMP=0x000000000003f774
