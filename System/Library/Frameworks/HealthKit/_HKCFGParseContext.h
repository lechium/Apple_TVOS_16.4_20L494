...
- (void).cxx_destruct;	// IMP=0x00000000000199c2
...
- (void)increaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x00000000000193e4
- (void)decreaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x0000000000018fe1
- (void)decrementRecursiveDepth;	// IMP=0x00000000000193ee
- (void)incrementRecursiveDepth;	// IMP=0x0000000000018feb
- (id)initWithScanner:(id)arg1 lengthAllowance:(unsigned long long)arg2;	// IMP=0x000000000001856c
