...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000006b5ab
- (void).cxx_destruct;	// IMP=0x000000000006b8ad
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006b700
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006b5b3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006b4eb
