...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001d77d2
- (void).cxx_destruct;	// IMP=0x00000000001d7b5b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d7979
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d77da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d76fc
