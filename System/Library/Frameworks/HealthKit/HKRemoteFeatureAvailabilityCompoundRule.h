...
+ (id)ruleIdentifier;	// IMP=0x00100000000866d2
- (void).cxx_destruct;	// IMP=0x0000000000086ca7
...
- (_Bool)evaluate;	// IMP=0x0000000000086a3c
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000000866df
