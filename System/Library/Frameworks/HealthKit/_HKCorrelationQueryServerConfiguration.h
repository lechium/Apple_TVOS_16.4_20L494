...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001e830e
- (void).cxx_destruct;	// IMP=0x00000000001e84c1
@property(copy, nonatomic) NSDictionary *filterDictionary; // @synthesize filterDictionary=_filterDictionary;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e8422
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e8316
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e82b8
