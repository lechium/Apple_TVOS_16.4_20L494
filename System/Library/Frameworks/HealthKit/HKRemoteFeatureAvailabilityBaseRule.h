...
+ (Class)ruleClassForRawValue:(id)arg1;	// IMP=0x00600000000fed11
- (void).cxx_destruct;	// IMP=0x00000000000ff551
@property(nonatomic) __weak id <HKRemoteFeatureAvailabilityDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (_Bool)evaluate;	// IMP=0x0000000000250212
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000002501ee
- (id)initWithRawValue:(id)arg1 dataSource:(id)arg2;	// IMP=0x00000000000ff457
