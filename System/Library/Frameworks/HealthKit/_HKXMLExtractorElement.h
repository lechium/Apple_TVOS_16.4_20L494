...
- (void).cxx_destruct;	// IMP=0x00000000001d925e
...
- (_Bool)matchesElement:(id)arg1;	// IMP=0x00000000001d8f4b
- (id)initWithElementName:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000001d8e92
- (id)initWithTagSpecification:(id)arg1;	// IMP=0x00000000001d8b53
