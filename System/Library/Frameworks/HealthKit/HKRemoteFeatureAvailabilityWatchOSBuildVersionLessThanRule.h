...
+ (id)ruleIdentifier;	// IMP=0x0010000000169272
- (void).cxx_destruct;	// IMP=0x0000000000169417
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x00000000001692d8
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000016927f
