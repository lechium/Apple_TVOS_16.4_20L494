...
- (void).cxx_destruct;	// IMP=0x000000000013cdaf
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)wristDetectionSettingManagerDidObserveWristDetectChange:(id)arg1;	// IMP=0x000000000013cc47
- (id)initWithHandle:(id)arg1;	// IMP=0x000000000013cbdc
