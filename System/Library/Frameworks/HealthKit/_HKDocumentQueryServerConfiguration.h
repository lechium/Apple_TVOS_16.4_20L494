...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000235523
- (void).cxx_destruct;	// IMP=0x000000000023577e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000023565a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000023552b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000235494
