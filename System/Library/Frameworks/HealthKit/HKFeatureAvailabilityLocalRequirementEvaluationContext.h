...
- (void).cxx_destruct;	// IMP=0x00000000001ef1d1
...
- (id)featureStatusForFeatureWithIdentifier:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001eefa0
- (id)isWatchAppInstalledWithBundleIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001eee6c
- (id)onboardingRecordForFeatureWithIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001eed38
- (id)onboardingEligibilityForFeatureWithIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001eec04
