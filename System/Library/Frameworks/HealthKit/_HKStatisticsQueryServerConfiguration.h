...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000b4c00
- (void).cxx_destruct;	// IMP=0x00000000000b4e14
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000b4cf0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000b4c08
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b4b72
