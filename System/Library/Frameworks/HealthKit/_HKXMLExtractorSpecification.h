...
- (void).cxx_destruct;	// IMP=0x00000000001d964b
...
- (_Bool)matchesElementStack:(id)arg1;	// IMP=0x00000000001d950c
- (id)initWithSpecificationString:(id)arg1;	// IMP=0x00000000001d9286
