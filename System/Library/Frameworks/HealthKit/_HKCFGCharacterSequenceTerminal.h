...
- (void).cxx_destruct;	// IMP=0x00000000000a357d
@property(copy, nonatomic) NSCharacterSet *characterSet; // @synthesize characterSet=_characterSet;
- (unsigned long long)_minimumLength;	// IMP=0x00000000000a354c
- (id)_label;	// IMP=0x00000000000a353f
- (_Bool)_scanValue:(id *)arg1 withScanner:(id)arg2;	// IMP=0x00000000000a34d3
