...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000d8291
- (void).cxx_destruct;	// IMP=0x00000000000d875b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d852a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d8299
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d8139
