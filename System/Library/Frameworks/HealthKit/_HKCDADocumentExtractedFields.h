...
- (void).cxx_destruct;	// IMP=0x00000000000ad431
...
- (id)_parseCDADate:(id)arg1;	// IMP=0x00000000000ad255
- (id)_personNameFrom:(id)arg1 familyTagRule:(id)arg2 givenTagRule:(id)arg3 nilOnFail:(_Bool)arg4;	// IMP=0x00000000000ad053
- (id)_firstFrom:(id)arg1 tagRule:(id)arg2 nilOnFail:(_Bool)arg3;	// IMP=0x00000000000acfb3
- (void)extractHeaderFieldsFromDocumentData:(id)arg1;	// IMP=0x00000000000accf3
- (id)initWithDocumentData:(id)arg1;	// IMP=0x00000000000acc8b
