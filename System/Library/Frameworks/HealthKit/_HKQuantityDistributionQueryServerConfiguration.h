...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000178ced
- (void).cxx_destruct;	// IMP=0x0000000000179162
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000178f06
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000178cf5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000178be7
