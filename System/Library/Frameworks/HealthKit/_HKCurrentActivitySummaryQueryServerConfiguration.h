...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000004f3c
- (void).cxx_destruct;	// IMP=0x00000000000179fc
@property(copy, nonatomic) NSDictionary *collectionIntervals; // @synthesize collectionIntervals=_collectionIntervals;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000013c84b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000025e3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013c7e6
