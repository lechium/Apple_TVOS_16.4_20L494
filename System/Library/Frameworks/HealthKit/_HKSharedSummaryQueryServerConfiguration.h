...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000177ebd
- (void).cxx_destruct;	// IMP=0x0000000000178097
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000177fb4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000177ec5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000177e47
