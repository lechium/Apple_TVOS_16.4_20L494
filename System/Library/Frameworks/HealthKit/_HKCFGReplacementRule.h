...
+ (id)ruleWithLHS:(id)arg1 RHS:(id)arg2 nodeEvaluator:(CDUnknownBlockType)arg3;	// IMP=0x00600000000a215b
- (void).cxx_destruct;	// IMP=0x00000000000a2795
...
- (id)description;	// IMP=0x00000000000a2778
