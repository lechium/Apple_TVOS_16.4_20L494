...
+ (id)nodeWithChildren:(id)arg1 rule:(id)arg2 rangeOfString:(struct _NSRange)arg3;	// IMP=0x006000000001987f
- (void).cxx_destruct;	// IMP=0x00000000000199fa
@property(readonly, nonatomic) _HKCFGReplacementRule *rule; // @synthesize rule=_rule;
- (id)evaluate;	// IMP=0x0000000000019a4f
