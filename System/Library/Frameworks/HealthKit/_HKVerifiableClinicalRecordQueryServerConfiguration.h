...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000014d590
- (void).cxx_destruct;	// IMP=0x000000000014d7f6
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000014d713
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014d598
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014d51a
