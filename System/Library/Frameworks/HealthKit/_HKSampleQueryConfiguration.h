...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000017acb
- (void).cxx_destruct;	// IMP=0x0000000000011323
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000090018
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001b34
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008ff58
