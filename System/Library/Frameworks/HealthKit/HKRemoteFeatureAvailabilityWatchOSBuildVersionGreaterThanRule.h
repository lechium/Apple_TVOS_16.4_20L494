...
+ (id)ruleIdentifier;	// IMP=0x0010000000116616
- (void).cxx_destruct;	// IMP=0x00000000001167bb
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x000000000011667c
- (void)processUserInfo:(id)arg1;	// IMP=0x0000000000116623
