...
- (void).cxx_destruct;	// IMP=0x0000000000246b8d
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)watchAppInstallationManagerDidObserveChange:(id)arg1;	// IMP=0x0000000000246957
- (id)initWithHandle:(id)arg1;	// IMP=0x00000000002468ec
