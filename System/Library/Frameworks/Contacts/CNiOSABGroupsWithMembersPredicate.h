...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000003cd1e
- (void).cxx_destruct;	// IMP=0x000000000003d004
...
- (struct __CFArray *)cn_copyGroupsInAddressBook:(void *)arg1 error:(struct __CFError **)arg2;	// IMP=0x000000000003cf53
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003ce93
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003cd26
- (id)initWithContact:(id)arg1 includeAllParentGroups:(_Bool)arg2;	// IMP=0x000000000003cba0
- (id)initWithGroup:(id)arg1 includeAllParentGroups:(_Bool)arg2;	// IMP=0x000000000003ca69
