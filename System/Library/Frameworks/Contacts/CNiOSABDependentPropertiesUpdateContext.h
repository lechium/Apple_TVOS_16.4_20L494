...
+ (_Bool)shouldSetWatchChanges;	// IMP=0x00600000000bb8e0
+ (id)os_log;	// IMP=0x00600000000ba9ff
- (void).cxx_destruct;	// IMP=0x00000000000bbae4
...
- (_Bool)setWatchChangesforThumbnailImageDataToPerson:(void *)arg1 error:(id *)arg2;	// IMP=0x00000000000bb8e8
- (_Bool)flushPendingImageChangesToPerson:(void *)arg1 logger:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000bac48
- (_Bool)logIfConditionFailed:(_Bool)arg1 message:(id)arg2 error:(struct __CFError **)arg3;	// IMP=0x00000000000bac40
- (void)resetAllData;	// IMP=0x00000000000bab98
