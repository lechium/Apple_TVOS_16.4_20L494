...
+ (id)descriptorForAllSupportedKeys;	// IMP=0x00100000000a1619
+ (id)adapterWithContact:(id)arg1 options:(id)arg2;	// IMP=0x00100000000a15ad
- (void).cxx_destruct;	// IMP=0x00000000000a2a0b
...
- (id)largeImageHashOfType:(id)arg1;	// IMP=0x00000000000a27d5
...
- (id)vCardPropertyItemsForProperty:(id)arg1 valueTransform:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a249e
- (id)vCardPropertyItemsForProperty:(id)arg1;	// IMP=0x00000000000a248a
...
- (id)initWithContact:(id)arg1 options:(id)arg2;	// IMP=0x00000000000a194c
