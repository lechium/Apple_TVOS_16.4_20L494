...
- (void).cxx_destruct;	// IMP=0x00000000000a981d
...
- (void)interpretUnknownsAsEmailAddresses;	// IMP=0x00000000000a9493
- (void)interpretPhoneNumbers;	// IMP=0x00000000000a9200
- (void)interpretEmailAddresses;	// IMP=0x00000000000a9069
- (void)interpretValues;	// IMP=0x00000000000a901c
- (id)description;	// IMP=0x00000000000a8f96
- (id)initWithHandleStringClassification:(id)arg1;	// IMP=0x00000000000a8ec8
- (id)init;	// IMP=0x00000000000a8e8b
