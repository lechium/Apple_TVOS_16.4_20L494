...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000fbd6
+ (id)contactChangeRequestWithKind:(long long)arg1 contacts:(id)arg2 linkIdentifier:(id)arg3;	// IMP=0x001000000000fa9c
- (void).cxx_destruct;	// IMP=0x0000000000010144
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000fd55
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000fbde
- (id)initWithKind:(long long)arg1 contacts:(id)arg2 linkIdentifier:(id)arg3;	// IMP=0x000000000000fb17
