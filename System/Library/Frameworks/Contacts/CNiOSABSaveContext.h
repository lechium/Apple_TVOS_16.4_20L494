...
- (void).cxx_destruct;	// IMP=0x000000000005585b
...
- (id)indexPathForContainerInstance:(id)arg1;	// IMP=0x000000000005578c
- (id)indexPathForGroupInstance:(id)arg1;	// IMP=0x0000000000055776
- (id)indexPathForContactInstance:(id)arg1;	// IMP=0x0000000000055760
- (void)_populateSaveRequestIndexTables;	// IMP=0x00000000000552f0
- (void)dealloc;	// IMP=0x00000000000552b1
@property(readonly, nonatomic) void *addressBook;
- (id)initWithSaveRequest:(id)arg1 response:(id)arg2 addressBook:(void *)arg3;	// IMP=0x00000000000550bd
