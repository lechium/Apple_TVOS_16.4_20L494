...
- (void).cxx_destruct;	// IMP=0x00000000000d1ea9
@property(readonly, nonatomic) CRRecentContactsLibrary *library; // @synthesize library=_library;
- (id)recentContactsForHandle:(id)arg1;	// IMP=0x00000000000d1967
- (id)initWithRecentContactsLibrary:(id)arg1;	// IMP=0x00000000000d18e9
- (id)init;	// IMP=0x00000000000d17f6
