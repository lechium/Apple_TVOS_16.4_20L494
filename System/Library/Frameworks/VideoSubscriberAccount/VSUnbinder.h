...
- (void).cxx_destruct;	// IMP=0x000000000002274e
...
- (void)binder:(id)arg1 didTearDownBinding:(id)arg2;	// IMP=0x00000000000225b8
- (void)binder:(id)arg1 didEstablishBinding:(id)arg2;	// IMP=0x0000000000022455
- (void)dealloc;	// IMP=0x0000000000022151
- (id)init;	// IMP=0x00000000000220eb
