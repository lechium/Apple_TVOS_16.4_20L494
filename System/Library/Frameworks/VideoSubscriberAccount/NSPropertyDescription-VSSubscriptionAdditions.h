...
- (id)vs_JSONValueTransformer;	// IMP=0x0030000000029b5d
...
- (id)vs_propertyListValueTransformer;	// IMP=0x00300000000294c2
...
- (_Bool)vs_isSuitableForPurpose:(long long)arg1;	// IMP=0x0030000000029355
...
- (void)vs_setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00300000000290c2
@end
