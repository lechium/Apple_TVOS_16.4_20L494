...
+ (id)directoryURL;	// IMP=0x006000000001874b
+ (id)legacyDirectoryURL;	// IMP=0x0060000000018654
- (void).cxx_destruct;	// IMP=0x00000000000193e3
...
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000192c4
- (id)developerIdentityProviderFetchRequest;	// IMP=0x00000000000192ab
- (id)insertDeveloperIdentityProviderInContext:(id)arg1;	// IMP=0x000000000001925e
- (id)init;	// IMP=0x0000000000019247
- (id)initWithModelVersion:(long long)arg1;	// IMP=0x0000000000018ec7
- (void)migrateContainerIfNecessary;	// IMP=0x0000000000018a4e
