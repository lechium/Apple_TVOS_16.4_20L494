...
- (void).cxx_destruct;	// IMP=0x000000000007c37e
...
- (void)transitionToDoneState;	// IMP=0x000000000007c1e9
- (void)transitionToFetchingScriptState;	// IMP=0x000000000007bc75
- (void)transitionToEnqueueingNextUrlState;	// IMP=0x000000000007ba66
- (void)start;	// IMP=0x000000000007b8d6
- (id)initWithApp:(id)arg1 urls:(id)arg2;	// IMP=0x000000000007b6d3
