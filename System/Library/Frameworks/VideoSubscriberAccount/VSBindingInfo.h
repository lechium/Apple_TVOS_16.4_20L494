...
- (void).cxx_destruct;	// IMP=0x000000000004f8b6
...
- (void)requireExpectedConcurrency;	// IMP=0x000000000004f5c1
@property(retain, nonatomic) id value;
- (id)initWithObservedObject:(id)arg1 keyPath:(id)arg2 options:(id)arg3;	// IMP=0x000000000004f03b
- (id)init;	// IMP=0x000000000004efcc
