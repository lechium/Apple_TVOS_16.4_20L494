...
- (void).cxx_destruct;	// IMP=0x0000000000069f74
...
- (void)performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x0000000000069ebb
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000069ea7
- (void)_performBlock:(CDUnknownBlockType)arg1 andWait:(_Bool)arg2;	// IMP=0x0000000000069b2c
- (_Bool)_setupPersistenceIfNeeded:(id *)arg1;	// IMP=0x0000000000069074
- (void)_removePersistentStore;	// IMP=0x0000000000068f5b
- (id)init;	// IMP=0x0000000000068bd9
