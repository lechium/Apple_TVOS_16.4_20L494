...
- (void).cxx_destruct;	// IMP=0x000000000006daf6
...
- (void)_notifyWithFunctionName:(id)arg1 eventName:(id)arg2 info:(id)arg3;	// IMP=0x000000000006d4c9
- (void)_cancelCurrentRequestAndNotify:(_Bool)arg1;	// IMP=0x000000000006d326
- (void)setRequestHeader:(id)arg1:(id)arg2;	// IMP=0x000000000006d116
- (id)getResponseHeader:(id)arg1;	// IMP=0x000000000006d027
- (id)getAllResponseHeaders;	// IMP=0x000000000006ce1e
- (void)abort;	// IMP=0x000000000006ce0a
- (void)send:(id)arg1;	// IMP=0x000000000006c709
- (void)open:(id)arg1:(id)arg2:(id)arg3:(id)arg4:(id)arg5;	// IMP=0x000000000006c568
- (id)initWithContext:(id)arg1;	// IMP=0x000000000006c524
- (id)init;	// IMP=0x000000000006c451
