...
- (void).cxx_destruct;	// IMP=0x000000000004bb95
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000004b663
- (void)setValue:(id)arg1 forBinding:(id)arg2;	// IMP=0x000000000004b4c8
- (id)valueForBinding:(id)arg1;	// IMP=0x000000000004b2ec
- (void)tearDownBinding:(id)arg1;	// IMP=0x000000000004ad5e
- (void)establishBinding:(id)arg1 withInfo:(id)arg2;	// IMP=0x000000000004aab9
- (id)_infoForBinding:(id)arg1;	// IMP=0x000000000004a9e5
- (void)dealloc;	// IMP=0x000000000004a7fd
- (id)initWithBoundObject:(id)arg1;	// IMP=0x000000000004a734
- (id)init;	// IMP=0x000000000004a6c5
