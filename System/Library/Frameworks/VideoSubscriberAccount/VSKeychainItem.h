...
- (void).cxx_destruct;	// IMP=0x0000000000046c7a
...
- (id)description;	// IMP=0x00000000000467a4
@property(copy, nonatomic) NSData *data;
- (void)didAccessValueForKey:(id)arg1;	// IMP=0x00000000000466ca
- (void)willAccessValueForKey:(id)arg1;	// IMP=0x000000000004663e
- (void)willChangeValueForKey:(id)arg1;	// IMP=0x0000000000046541
- (id)changedValues;	// IMP=0x0000000000046205
- (id)committedValueForKey:(id)arg1;	// IMP=0x0000000000046182
- (id)committedValuesForKeys:(id)arg1;	// IMP=0x0000000000046104
- (void)setPrimitiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000045eeb
- (id)primitiveValueForKey:(id)arg1;	// IMP=0x0000000000045dd7
@property(readonly, nonatomic) _Bool hasPersistentChangedValues;
@property(readonly, nonatomic) _Bool hasChanges;
- (void)_setCommittedValues:(id)arg1 registeringUndo:(_Bool)arg2;	// IMP=0x0000000000045c1e
- (id)initWithItemKind:(id)arg1 insertIntoEditingContext:(id)arg2;	// IMP=0x0000000000045900
- (id)init;	// IMP=0x0000000000045891
