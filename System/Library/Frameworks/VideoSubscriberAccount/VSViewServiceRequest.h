...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000210cd
- (void).cxx_destruct;	// IMP=0x00000000000215f5
...
- (id)description;	// IMP=0x000000000002120e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000211b4
- (unsigned long long)hash;	// IMP=0x000000000002117b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002112b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000210d5
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002104d
- (id)init;	// IMP=0x0000000000020fe9
