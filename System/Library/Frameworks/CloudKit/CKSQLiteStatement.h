...
- (void).cxx_destruct;	// IMP=0x00000000001b18aa
- (void)bindText:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x00000000001b0fbc
- (void)invalidate:(id)arg1;	// IMP=0x00000000001b0c41
