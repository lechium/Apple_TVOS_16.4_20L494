...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x006000000011fbac
...
- (Class)classForCoder;	// IMP=0x000000000011fb1a
- (void)setValueTiming:(id)arg1;	// IMP=0x0000000000120100
