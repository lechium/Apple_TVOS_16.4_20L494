...
+ (id)defaultScrubbingRates;	// IMP=0x006000000000ed01
- (void).cxx_destruct;	// IMP=0x000000000000eb79
...
- (void)stopDrivingScrubber;	// IMP=0x000000000000e887
- (void)startDrivingScrubberBackward;	// IMP=0x000000000000e7ca
- (void)startDrivingScrubberForward;	// IMP=0x000000000000e70d
- (void)advanceLeft;	// IMP=0x000000000000e66d
- (void)advanceRight;	// IMP=0x000000000000e5cd
- (void)skipBackward;	// IMP=0x000000000000e5b3
- (void)skipForward;	// IMP=0x000000000000e599
- (void)_skipBy:(double)arg1;	// IMP=0x000000000000e449
- (void)advanceToLowerRate;	// IMP=0x000000000000e29c
- (void)advanceToHigherRate;	// IMP=0x000000000000e13b
- (void)reset;	// IMP=0x000000000000e044
- (long long)_speedIndexOfRate:(double)arg1;	// IMP=0x000000000000de97
@property(readonly, nonatomic) _Bool isDrivingScrubber;
- (void)stop;	// IMP=0x000000000000dd7c
- (void)start;	// IMP=0x000000000000db1f
- (void)_updateDisplayTimeRangeForNavigation;	// IMP=0x000000000000da7f
- (void)_updateScrubDisplayTimeInitial;	// IMP=0x000000000000d9f9
- (void)invalidate;	// IMP=0x000000000000d942
- (void)dealloc;	// IMP=0x000000000000d904
- (id)initWithTransportBar:(id)arg1;	// IMP=0x000000000000d829
