...
- (void).cxx_destruct;	// IMP=0x000000000001786c
...
- (void)prefetchForTimes:(id)arg1;	// IMP=0x00000000000176be
- (void)prefetchForTime:(double)arg1;	// IMP=0x0000000000017607
- (void)setExactTimeInterval:(double)arg1;	// IMP=0x00000000000175f5
@property(readonly) UIImage *image;
- (long long)desiredFrameIndex;	// IMP=0x00000000000174b0
- (_Bool)isExact;	// IMP=0x0000000000017456
@property(readonly) double actualTimeInterval;
- (id)initWithFrameSet:(id)arg1;	// IMP=0x0000000000017284
- (id)init;	// IMP=0x0000000000017270
