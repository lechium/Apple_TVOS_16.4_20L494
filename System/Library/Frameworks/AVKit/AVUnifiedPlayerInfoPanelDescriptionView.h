...
+ (id)_spacerAction;	// IMP=0x001000000013bcd4
- (void).cxx_destruct;	// IMP=0x000000000013a5f7
...
- (void)_updateTitleStackViewState;	// IMP=0x000000000013a3ff
@property(copy, nonatomic) NSArray *actions;
- (id)preferredFocusEnvironments;	// IMP=0x000000000013a1a0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000013892f
- (void)setAudioFormatBadgeImage:(id)arg1 withAccessibilityValue:(id)arg2;	// IMP=0x000000000013c70d
- (void)setColorDepthBadgeImage:(id)arg1 withAccessibilityValue:(id)arg2;	// IMP=0x000000000013c676
- (void)setVideoResolutionBadgeImage:(id)arg1 withAccessibilityValue:(id)arg2;	// IMP=0x000000000013c5df
- (void)setContentMediaRatingText:(id)arg1 image:(id)arg2;	// IMP=0x000000000013c531
- (void)setTomatoFreshness:(unsigned long long)arg1 rating:(float)arg2 hidden:(_Bool)arg3;	// IMP=0x000000000013c4c9
- (void)setClosedCaptionBadgeHidden:(_Bool)arg1;	// IMP=0x000000000013c4ac
- (void)setPosterViewHidden:(_Bool)arg1;	// IMP=0x000000000013c48f
- (void)setProgramScheduledTimeText:(id)arg1;	// IMP=0x000000000013c3fd
- (void)setDateText:(id)arg1;	// IMP=0x000000000013c36b
- (void)setGenreText:(id)arg1;	// IMP=0x000000000013c2d9
- (void)setDurationText:(id)arg1;	// IMP=0x000000000013c247
- (void)setSeasonEpisodeText:(id)arg1;	// IMP=0x000000000013c1b5
- (void)setSecondaryTitleText:(id)arg1;	// IMP=0x000000000013c111
- (void)setTitleText:(id)arg1;	// IMP=0x000000000013c06d
