...
+ (double)estimatedWidthForAdornmentsForMediaOption:(id)arg1;	// IMP=0x006000000010e9d4
- (void).cxx_destruct;	// IMP=0x000000000010e76c
...
- (id)_checkmarkImageIfSelected;	// IMP=0x000000000010e6d8
- (void)_updateIconConstraint;	// IMP=0x000000000010e65d
- (_Bool)_haveImage;	// IMP=0x000000000010e61f
- (void)_updateAppearance;	// IMP=0x000000000010e3f5
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000010e3b4
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000010e30a
- (void)prepareForReuse;	// IMP=0x000000000010e280
- (void)constrainWidthTo:(double)arg1;	// IMP=0x000000000010e19e
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000010e153
@property(copy, nonatomic) NSString *title;
- (void)dealloc;	// IMP=0x000000000010dbb8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000010ce3e
- (long long)_textAlignmentForUserInterfaceLayout;	// IMP=0x000000000010ce1c
