...
- (void).cxx_destruct;	// IMP=0x000000000011e010
...
- (void)stopScanningPlayerViewController:(id)arg1;	// IMP=0x000000000011de41
- (void)_stopWaitingForPreroll;	// IMP=0x000000000011de2d
- (long long)playerViewController:(id)arg1 scanFromElapsedTime:(CDStruct_1b6d18a9)arg2 rate:(double)arg3 imageBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000011d868
- (void)_didFireDisplayLink:(id)arg1;	// IMP=0x000000000011d1d7
- (void)setElapsedTimeWhenScanStarted:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000011d122
@property(readonly, nonatomic) double _currentScanningTimeInterval;
- (void)_updateMinMaxTimes;	// IMP=0x000000000011cc96
@property(readonly, nonatomic) double _clockTimeElapsed;
- (void)startDisplayLink;	// IMP=0x000000000011ca22
- (void)invalidate;	// IMP=0x000000000011c8f4
- (void)dealloc;	// IMP=0x000000000011c899
- (id)init;	// IMP=0x000000000011c708
