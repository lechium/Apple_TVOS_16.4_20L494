...
- (void).cxx_destruct;	// IMP=0x00000000000e669e
...
- (void)rotaryGestureRecognizerFailedClassifyingMovement:(id)arg1;	// IMP=0x00000000000e64cf
- (void)rotaryGestureRecognizerUpdatedClassifyingMovement:(id)arg1;	// IMP=0x00000000000e644f
- (void)rotaryGestureRecognizerBeganClassifyingMovement:(id)arg1;	// IMP=0x00000000000e63cf
- (_Bool)rotaryGestureRecognizerMustBeginFromRest:(id)arg1;	// IMP=0x00000000000e6343
- (_Bool)rotaryGestureRecognizerCanBeginFromRest:(id)arg1;	// IMP=0x00000000000e62b7
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000000e6241
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x00000000000e6176
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000000e60c6
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000000e5f17
@property(readonly, nonatomic, getter=isUserInteractionAllowed) _Bool userInteractionAllowed;
- (id)init;	// IMP=0x00000000000e5e08
