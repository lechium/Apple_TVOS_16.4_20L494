...
- (void).cxx_destruct;	// IMP=0x0000000000076d11
...
- (id)_imageTintColor;	// IMP=0x0000000000076a52
- (void)_longPressAction:(id)arg1;	// IMP=0x00000000000769fb
- (void)updateFocusState:(id)arg1;	// IMP=0x0000000000076773
- (void)didHintFocusMovement:(id)arg1;	// IMP=0x0000000000076750
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000007664c
- (void)setSelected:(_Bool)arg1;	// IMP=0x00000000000765a1
- (_Bool)canBecomeFocused;	// IMP=0x00000000000764f9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000075108
