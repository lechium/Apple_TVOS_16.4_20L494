...
+ (id)repeatingRotationAnimation;	// IMP=0x006000000000d6fa
+ (id)spinnerAnimationGroup;	// IMP=0x006000000000d611
+ (struct CGImage *)spinnerImageWithSize:(struct CGSize)arg1 color:(id)arg2;	// IMP=0x006000000000d2fc
...
- (id)_animationToOpacity:(double)arg1;	// IMP=0x000000000000ce9b
- (void)_removeAnimations;	// IMP=0x000000000000cd2c
- (void)_addAnimations;	// IMP=0x000000000000cbd6
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000000cb8b
- (void)layoutSubviews;	// IMP=0x000000000000ca94
- (void)dealloc;	// IMP=0x000000000000c9fc
- (id)initWithSize:(struct CGSize)arg1;	// IMP=0x000000000000c5e7
