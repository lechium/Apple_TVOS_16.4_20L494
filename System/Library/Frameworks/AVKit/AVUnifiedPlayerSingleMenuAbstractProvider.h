...
+ (id)menuProviderWithTitle:(id)arg1 image:(id)arg2;	// IMP=0x00100000000fe7d4
+ (id)inlineMenuProviderWithTitle:(id)arg1;	// IMP=0x00100000000fe783
...
- (_Bool)matchesMenu:(id)arg1;	// IMP=0x00000000000fe504
@property(readonly, nonatomic) NSArray *children;
- (void)prepareForDisplay;	// IMP=0x00000000000fe4d1
@property(readonly, nonatomic) NSArray *menuElements;
- (id)initWithTitle:(id)arg1 image:(id)arg2 menuOptions:(unsigned long long)arg3;	// IMP=0x00000000000fe3ad
