...
- (void).cxx_destruct;	// IMP=0x00000000000eb19b
...
- (void)metadataCollector:(id)arg1 didCollectDateRangeMetadataGroups:(id)arg2 indexesOfNewGroups:(id)arg3 indexesOfModifiedGroups:(id)arg4;	// IMP=0x00000000000eb0ca
- (void)dealloc;	// IMP=0x00000000000eb06c
- (id)initWithPlayerItem:(id)arg1;	// IMP=0x00000000000eaf0a
