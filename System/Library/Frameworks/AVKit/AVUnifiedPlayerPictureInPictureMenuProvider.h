...
+ (id)_pipOptionsActionWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000043ed7
+ (id)_startActionWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000043dd5
- (void).cxx_destruct;	// IMP=0x00000000000443a3
...
- (void)_performStart:(id)arg1;	// IMP=0x0000000000044322
...
- (_Bool)isPiPOptionsMenuAction:(id)arg1;	// IMP=0x0000000000044191
@property(readonly, nonatomic) UIMenuElement *pipOptionsMenuElement;
- (void)prepareForDisplay;	// IMP=0x00000000000440c5
