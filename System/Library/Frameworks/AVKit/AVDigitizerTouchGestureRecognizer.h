...
+ (_Bool)_shouldDefaultToTouches;	// IMP=0x0060000000071501
- (void).cxx_destruct;	// IMP=0x00000000000714ee
...
- (void)_updateDigitizerLocationWithEvent:(id)arg1;	// IMP=0x00000000000713db
- (void)reset;	// IMP=0x000000000007126d
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000071199
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000071045
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000070efa
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000070ce3
- (void)_forwardToSelector:(SEL)arg1 touches:(id)arg2 event:(id)arg3;	// IMP=0x0000000000070b65
...
- (id)_viewForTouchEventForwarding;	// IMP=0x0000000000070964
@property(readonly, nonatomic) long long avTouchPosition; // @dynamic avTouchPosition;
- (void)removeTouchesTarget:(id)arg1;	// IMP=0x00000000000708b7
- (void)addTouchesTarget:(id)arg1;	// IMP=0x00000000000707bc
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000070756
