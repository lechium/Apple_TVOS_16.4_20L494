...
+ (Class)layerClass;	// IMP=0x00600000000a6491
- (void).cxx_destruct;	// IMP=0x00000000000a63e6
...
- (void)layoutSubviews;	// IMP=0x00000000000a62b5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a60fa
