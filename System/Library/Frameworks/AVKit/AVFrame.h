...
- (void).cxx_destruct;	// IMP=0x0000000000016ec5
...
- (unsigned long long)estimatedSizeOfImageInMemory;	// IMP=0x0000000000016e1f
- (id)description;	// IMP=0x0000000000016d70
- (id)initWithImage:(id)arg1 actualTime:(double)arg2 frameIndex:(long long)arg3;	// IMP=0x0000000000016ce7
