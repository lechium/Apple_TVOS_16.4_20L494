...
- (void).cxx_destruct;	// IMP=0x0000000000005674
...
- (id)init;	// IMP=0x00000000000054b1
- (void)layoutSublayers;	// IMP=0x000000000000521b
- (id)initWithDisplayScale:(double)arg1 placeholderImage:(struct CGImage *)arg2 opaque:(_Bool)arg3 videoRectWhenPIPBegan:(struct CGRect)arg4;	// IMP=0x000000000000515f
