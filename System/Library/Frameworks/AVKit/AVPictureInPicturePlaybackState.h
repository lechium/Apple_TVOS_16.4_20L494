...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000125fd7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000125fcc
- (id)initWithElapsedTime:(double)arg1 timelineDuration:(double)arg2 timelineRate:(double)arg3 paused:(_Bool)arg4;	// IMP=0x0000000000125edc
