...
+ (id)shared;	// IMP=0x0060000000121ab5
- (void).cxx_destruct;	// IMP=0x0000000000120de4
...
- (void)_updateProfileRestrictions;	// IMP=0x0000000000120c0b
@property(readonly, nonatomic) PBSRestrictionService *restrictionService;
- (void)cancelRequest:(id)arg1;	// IMP=0x0000000000120b6a
- (id)validateMediaContentRating:(id)arg1 allowInteraction:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000120980
- (_Bool)shouldRevalidateMediaContentRating:(id)arg1 validatedRating:(id)arg2 validatedDate:(id)arg3;	// IMP=0x000000000012079b
- (void)_presentDeniedByProfile:(CDUnknownBlockType)arg1;	// IMP=0x00000000001203c9
- (unsigned long long)_pbsRestrictedContentTypeFromDomain:(long long)arg1;	// IMP=0x00000000001203a8
- (long long)_restrictionValueFromPBSRestrictionValue:(unsigned long long)arg1;	// IMP=0x0000000000120304
- (id)init;	// IMP=0x00000000001202c9
- (id)_init;	// IMP=0x0000000000120261
