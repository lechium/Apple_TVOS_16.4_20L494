...
+ (void)setCornerRadius:(double)arg1;	// IMP=0x00400000000e8aee
+ (double)cornerRadius;	// IMP=0x00400000000e8ae0
- (void).cxx_destruct;	// IMP=0x00000000000e8aaf
...
- (struct CGSize)contentSizeForWidth:(double)arg1;	// IMP=0x00000000000e89f3
- (void)loadView;	// IMP=0x00000000000e82f7
