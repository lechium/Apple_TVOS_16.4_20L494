...
+ (id)avkit_autoOption;	// IMP=0x00200000000e8230
+ (id)avkit_offOption;	// IMP=0x00200000000e821f
@property(readonly, nonatomic) NSString *shortLocalizedDisplayName;
@property(readonly, nonatomic) NSString *localizedDisplayName;
- (id)avkit_title;	// IMP=0x00100000000f8726
- (id)avkit_mediaRemoteIdentifier;	// IMP=0x00100000000f85fc
- (long long)languageCompare:(id)arg1 currentLanguageCode:(id)arg2 currentLanguageIdentifier:(id)arg3;	// IMP=0x001000000013731c
