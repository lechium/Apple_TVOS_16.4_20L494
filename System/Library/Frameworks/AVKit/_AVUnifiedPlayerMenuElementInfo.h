...
+ (_Bool)_isMenuEmpty:(id)arg1;	// IMP=0x0010000000077139
+ (unsigned long long)_typeForMenuElement:(id)arg1;	// IMP=0x00100000000770bc
- (void).cxx_destruct;	// IMP=0x00000000000770ac
