...
- (void).cxx_destruct;	// IMP=0x000000000010f7fe
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000010f745
- (id)preferredFocusEnvironments;	// IMP=0x000000000010f6cc
- (void)viewDidLayoutSubviews;	// IMP=0x000000000010f656
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000010f54f
- (void)loadView;	// IMP=0x000000000010ea29
