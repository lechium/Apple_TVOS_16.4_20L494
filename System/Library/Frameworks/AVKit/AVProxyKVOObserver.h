...
- (void).cxx_destruct;	// IMP=0x000000000011c5fa
...
- (void)_handleValueChangeForKeyPath:(id)arg1 ofObject:(id)arg2 oldValue:(id)arg3 newValue:(id)arg4 context:(void *)arg5;	// IMP=0x000000000011c4e9
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000011c3ca
- (void)stopObserving;	// IMP=0x000000000011c267
- (void)startObserving:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000011bec4
- (id)initWithObservedObject:(id)arg1 observer:(id)arg2 keyPaths:(id)arg3 retainingObservedObject:(_Bool)arg4 includeInitialValue:(_Bool)arg5 includeChanges:(_Bool)arg6 changesBlock:(CDUnknownBlockType)arg7;	// IMP=0x000000000011bd65
