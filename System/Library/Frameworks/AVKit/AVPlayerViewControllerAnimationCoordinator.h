...
- (void).cxx_destruct;	// IMP=0x0000000000061dbd
...
- (void)didFinishAnimations:(_Bool)arg1;	// IMP=0x0000000000061bff
- (void)performCoordinatedAnimations;	// IMP=0x0000000000061a63
- (void)addCoordinatedAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000006192b
- (id)init;	// IMP=0x000000000006188e
