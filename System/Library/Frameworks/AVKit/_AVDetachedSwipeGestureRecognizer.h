...
- (void).cxx_destruct;	// IMP=0x00000000000749b0
...
- (void)setState:(long long)arg1;	// IMP=0x00000000000748b0
- (id)view;	// IMP=0x000000000007489e
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x000000000007481f
