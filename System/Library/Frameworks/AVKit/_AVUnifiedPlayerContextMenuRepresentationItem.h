...
- (void).cxx_destruct;	// IMP=0x000000000012b7e5
...
- (id)initWithAction:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x000000000012b597
- (id)initWithTitle:(id)arg1 image:(id)arg2 attributes:(unsigned long long)arg3 state:(long long)arg4 actionIndexPath:(id)arg5;	// IMP=0x000000000012b4b9
