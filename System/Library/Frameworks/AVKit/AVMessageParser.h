...
+ (id)airMessageParser;	// IMP=0x0040000000081e06
- (void).cxx_destruct;	// IMP=0x000000000008093b
...
- (id)partsWithData:(id)arg1;	// IMP=0x000000000008068d
- (id)init;	// IMP=0x00000000000804ce
- (id)initWithLineSeparator:(id)arg1 headerBodySeparator:(id)arg2 bodyLengthKey:(id)arg3 compressionMethodKey:(id)arg4;	// IMP=0x00000000000803dd
