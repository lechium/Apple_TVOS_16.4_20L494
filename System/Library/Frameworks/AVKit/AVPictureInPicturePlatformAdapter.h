...
+ (id)stopPictureInPictureButtonImageName;	// IMP=0x001000000012621c
+ (id)startPictureInPictureButtonImageName;	// IMP=0x001000000012620f
+ (_Bool)isPictureInPictureSupported;	// IMP=0x0010000000126207
+ (id)imageSymbolConfiguration;	// IMP=0x00100000001261ff
- (void).cxx_destruct;	// IMP=0x00000000001263d7
...
- (void)updateLayoutDependentBehaviors;	// IMP=0x000000000012624b
- (void)stopPictureInPictureAndRestoreUserInterface:(_Bool)arg1;	// IMP=0x0000000000126245
- (void)startPictureInPicture;	// IMP=0x000000000012623f
- (id)initWithSource:(id)arg1;	// IMP=0x0000000000126231
- (_Bool)isPictureInPicturePossible;	// IMP=0x0000000000126229
- (void)_setRoutingVideoToHostedWindow:(_Bool)arg1 pictureInPictureViewController:(id)arg2 source:(id)arg3;	// IMP=0x0000000000079c5f
- (void)_updateStatusUsingProposedStatus:(long long)arg1;	// IMP=0x0000000000079452
- (void)_updateStatus;	// IMP=0x0000000000079421
- (void)_setStatusAndNotifyDelegateIfNeeded:(long long)arg1;	// IMP=0x00000000000792ff
