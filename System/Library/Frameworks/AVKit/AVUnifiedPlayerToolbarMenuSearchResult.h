...
+ (id)searchResultForMenu:(id)arg1 atIndex:(long long)arg2;	// IMP=0x0060000000009362
+ (id)searchResultForPiPMenuAtIndex:(unsigned long long)arg1;	// IMP=0x0060000000009331
- (void).cxx_destruct;	// IMP=0x0000000000009321
...
- (id)initWithMenu:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0000000000009287
