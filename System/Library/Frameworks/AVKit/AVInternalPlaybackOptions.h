...
- (void).cxx_destruct;	// IMP=0x00000000000303b4
...
- (id)debugDescription;	// IMP=0x000000000002ffaf
- (id)_descriptionOfBooleanProperty:(id)arg1;	// IMP=0x000000000002ff0b
- (id)_descriptionOfTrueBooleanProperty:(id)arg1;	// IMP=0x000000000002fe6c
@property(readonly, getter=isOffOptionAvailableForSubtitles) _Bool offOptionAvailableForSubtitles;
- (id)init;	// IMP=0x000000000002fd44
