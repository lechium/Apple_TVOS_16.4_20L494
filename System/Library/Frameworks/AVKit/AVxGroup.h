...
- (void).cxx_destruct;	// IMP=0x000000000012ba43
...
- (double)offsetForItem:(unsigned long long)arg1;	// IMP=0x000000000012b94e
- (void)setItemWidth:(double)arg1;	// IMP=0x000000000012b8ad
- (void)addItem:(id)arg1;	// IMP=0x000000000012b897
@property(readonly, nonatomic) unsigned long long count;
- (id)init;	// IMP=0x000000000012b823
