...
- (void).cxx_destruct;	// IMP=0x000000000000e7de
@property(readonly, nonatomic) __weak id <LANotificationObserverXPC> target; // @synthesize target=_target;
- (void)newValue:(id)arg1 oldValue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000000e733
- (id)initWithTarget:(id)arg1;	// IMP=0x000000000000e6cf
