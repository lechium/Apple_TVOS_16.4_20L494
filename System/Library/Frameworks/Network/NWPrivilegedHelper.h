...
- (void).cxx_destruct;	// IMP=0x000000000044b7e0
...
- (void)handleRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x000000000044b070
- (id)initWithQueue:(id)arg1;	// IMP=0x000000000044aa20
- (void)startThrottlePolicyEventListener;	// IMP=0x000000000044a9d0
- (_Bool)startXPCListener;	// IMP=0x000000000044a450
- (void)registerHelperFunctions;	// IMP=0x00000000004498c0
- (void)registerHandlerFunction:(CDUnknownFunctionPointerType)arg1 type:(int)arg2 allowedEntitlementGroup:(id)arg3;	// IMP=0x0000000000448a40
