...
- (id)snapshot;	// IMP=0x0000000000045950
- (void)reset;	// IMP=0x00000000000458f0
- (void)updateWithState:(id)arg1 atTime:(double)arg2;	// IMP=0x0000000000045500
- (id)description;	// IMP=0x0000000000045460
- (void)dealloc;	// IMP=0x00000000000453d0
- (id)initWithName:(id)arg1;	// IMP=0x0000000000045200
