...
- (void).cxx_destruct;	// IMP=0x00000000002faf00
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000002fa820
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000002fa300
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000002f9d10
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000002f92e0
- (void)dealloc;	// IMP=0x00000000002f92b0
- (id)init;	// IMP=0x00000000002f9030
