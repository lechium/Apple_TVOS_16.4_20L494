...
- (void)dealloc;	// IMP=0x00000000000306ff
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000000003066a
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000003060b
- (void)dismiss;	// IMP=0x00000000000305cd
- (void)show;	// IMP=0x000000000003047b
