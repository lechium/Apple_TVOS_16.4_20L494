...
- (float *)colorHistogram;	// IMP=0x0000000000038680
- (long long)compareImageOrder:(id)arg1;	// IMP=0x000000000003861f
- (long long)compareImageStats:(id)arg1;	// IMP=0x0000000000038617
- (float)computeScore:(float)arg1;	// IMP=0x00000000000384e3
- (unsigned short *)aeMatrix;	// IMP=0x00000000000384d6
- (void)computeAEMatrix:(id)arg1;	// IMP=0x00000000000382f9
- (int)setAEMatrix:(id)arg1;	// IMP=0x0000000000038283
- (float)computeAEMatrixDifference:(id)arg1;	// IMP=0x0000000000038249
- (float)computeImageDistance:(id)arg1;	// IMP=0x00000000000381fa
- (float)computeSmilePercentage;	// IMP=0x00000000000380eb
- (float)computeRuleOfThreeDistance;	// IMP=0x0000000000037e55
- (float)computeFacialFocusScoreSum;	// IMP=0x00000000000378d7
- (void)collapseSharpnessGrid;	// IMP=0x00000000000375f3
- (void)computeImageData:(id)arg1 faceIDCounts:(id)arg2;	// IMP=0x00000000000373c7
- (void)writeGridROI:(id)arg1;	// IMP=0x00000000000372f6
- (int)canRegister;	// IMP=0x00000000000372d5
- (void)computeImageProjections:(id)arg1;	// IMP=0x000000000003722c
- (void)performRegistration:(id)arg1 deltaCol:(float *)arg2 deltaRow:(float *)arg3;	// IMP=0x0000000000036558
- (void)flagAsGarbage;	// IMP=0x0000000000036536
- (void)updateROI:(struct GridROI_t)arg1;	// IMP=0x000000000003641c
- (float)computeSmoothedGridROI:(id)arg1 nextStat:(id)arg2;	// IMP=0x00000000000361e6
- (void)computeBlurStatsOnGrid:(id)arg1;	// IMP=0x0000000000035ef4
- (void)computeImageSharpnessOnGrid:(id)arg1;	// IMP=0x0000000000035d7f
- (struct GridROI_t)getSharpnessAndBlurLimits;	// IMP=0x0000000000035d70
- (void)computeImageColorHistogram:(id)arg1;	// IMP=0x0000000000035bf9
- (void)dealloc;	// IMP=0x0000000000035b6c
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000035aa6
- (void)assignMeanStdBuffers:(float *)arg1;	// IMP=0x00000000000359fb
- (void)allocateMeanStdPingPongBuffers:(float **)arg1:(float **)arg2:(float **)arg3:(float **)arg4;	// IMP=0x0000000000035945
