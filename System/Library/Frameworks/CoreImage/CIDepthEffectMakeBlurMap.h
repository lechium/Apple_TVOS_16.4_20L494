...
+ (id)customAttributes;	// IMP=0x00600000001b02a0
...
- (id)outputImage;	// IMP=0x00000000001b4c85
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001b411e
- (id)blurMapV4:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3 hairImage:(id)arg4;	// IMP=0x00000000001b2ba9
- (id)blurMapV3:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3;	// IMP=0x00000000001b2803
- (id)refineShiftMapV3WithMainImage:(id)arg1 shiftmap:(id)arg2 lensModel:(id)arg3;	// IMP=0x00000000001b2056
- (id)blurMapV2:(id)arg1;	// IMP=0x00000000001b1f84
- (id)smoothShiftMapV2:(id)arg1;	// IMP=0x00000000001b1ec4
- (id)faceMaskDelta:(id)arg1 extent:(struct CGRect)arg2 parameters:(id)arg3 distanceToAdd:(float *)arg4;	// IMP=0x00000000001b1ab4
- (id)faceMaskApply:(id)arg1 blurMap:(id)arg2;	// IMP=0x00000000001b18c4
- (id)faceMaskParams:(id)arg1 useNormalizedCoords:(_Bool)arg2;	// IMP=0x00000000001b12f5
- (_Bool)needToRunFaceMask;	// IMP=0x00000000001b11e8
- (id)lensModelApply:(id)arg1 shiftMap:(id)arg2;	// IMP=0x00000000001b1080
- (id)lensModelParams:(id)arg1;	// IMP=0x00000000001b0e4c
- (id)upsampledShiftMap:(id)arg1;	// IMP=0x00000000001b0bf9
- (float)intrinsicMatrixFocalLength;	// IMP=0x00000000001b0bba
- (struct CGSize)originalShiftMapSize;	// IMP=0x00000000001b0ae1
- (id)calibrationData;	// IMP=0x00000000001b0aaa
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x00000000001b0a4a
