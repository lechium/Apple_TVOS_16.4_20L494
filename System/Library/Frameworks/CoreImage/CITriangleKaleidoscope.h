...
+ (id)customAttributes;	// IMP=0x006000000017544c
...
- (id)outputImage;	// IMP=0x00000000001757b5
- (id)_geomKernel;	// IMP=0x0000000000175795
- (id)_colorKernel;	// IMP=0x0000000000175775
