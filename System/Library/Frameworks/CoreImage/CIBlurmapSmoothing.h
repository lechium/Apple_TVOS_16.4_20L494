...
+ (id)customAttributes;	// IMP=0x000000000010a598
...
- (id)outputImage;	// IMP=0x000000000010ac27
- (id)performPass:(id)arg1 reference:(id)arg2 values:(id)arg3 rect:(struct CGRect)arg4;	// IMP=0x000000000010a7f8
- (id)_kernelV;	// IMP=0x000000000010a79b
- (id)_kernelH;	// IMP=0x000000000010a73e
