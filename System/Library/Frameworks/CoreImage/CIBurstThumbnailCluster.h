...
- (float)computeMergeCost:(id)arg1:(int *)arg2:(int)arg3;	// IMP=0x0000000000039157
- (void)addItemsFromCluster:(id)arg1;	// IMP=0x000000000003913d
- (void)releaseImage;	// IMP=0x00000000000390ff
- (void)dealloc;	// IMP=0x00000000000390a7
- (id)initWithImageData:(id)arg1 dict:(id)arg2 identifier:(id)arg3 imageProps:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x0000000000038cf0
- (id)init;	// IMP=0x0000000000038c94
