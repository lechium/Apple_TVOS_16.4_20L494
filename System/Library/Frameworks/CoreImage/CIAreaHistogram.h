...
+ (id)customAttributes;	// IMP=0x006000000000eed4
...
- (id)outputImage;	// IMP=0x000000000001050f
- (id)outputImageNonMPS;	// IMP=0x000000000000f866
- (id)outputData;	// IMP=0x000000000000f38e
- (_Bool)_inputsAreOK;	// IMP=0x000000000000f2ed
- (struct IRect)_netExtent;	// IMP=0x000000000000f138
