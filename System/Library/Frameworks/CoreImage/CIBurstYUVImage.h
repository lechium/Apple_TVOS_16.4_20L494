...
- (struct __CVBuffer *)pixelBuffer;	// IMP=0x0000000000039e0b
- (void)dealloc;	// IMP=0x0000000000039d9b
- (id)initWithIOSurface:(struct __IOSurface *)arg1 maxDimension:(int)arg2;	// IMP=0x0000000000039aed
- (id)initWithCGImage:(struct CGImage *)arg1 maxDimension:(int)arg2;	// IMP=0x000000000003992e
- (void)convertRGBAToYUV420:(char *)arg1 rgbaBytesPerRow:(int)arg2;	// IMP=0x00000000000394e2
