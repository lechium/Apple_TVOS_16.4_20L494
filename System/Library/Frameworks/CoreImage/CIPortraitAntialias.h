...
- (id)outputImage;	// IMP=0x0000000000111107
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2;	// IMP=0x000000000011077a
- (id)noiseColorKernel;	// IMP=0x00000000001106fc
- (id)_noiseGeneratorKernel;	// IMP=0x000000000011068f
- (id)_kernel:(_Bool)arg1 withAddedNoise:(_Bool)arg2;	// IMP=0x000000000011058b
