...
+ (id)customAttributes;	// IMP=0x006000000003a75c
...
- (id)outputImage;	// IMP=0x0000000000039f33
- (id)_CICMYK_black;	// IMP=0x0000000000039f13
- (id)_CICMYK_yellow;	// IMP=0x0000000000039ef3
- (id)_CICMYK_magenta;	// IMP=0x0000000000039ed3
- (id)_CICMYK_cyan;	// IMP=0x0000000000039eb3
- (id)_CICMYK_convert;	// IMP=0x0000000000039e93
- (id)_CIWhite;	// IMP=0x0000000000039e73
