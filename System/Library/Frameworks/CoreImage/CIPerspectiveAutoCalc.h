...
- (_Bool)compute;	// IMP=0x00000000001256eb
- (void)dealloc;	// IMP=0x00000000001256b0
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x000000000012555e
