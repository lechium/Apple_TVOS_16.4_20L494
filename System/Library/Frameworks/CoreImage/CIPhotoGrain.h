...
+ (id)customAttributes;	// IMP=0x0060000000107097
...
- (id)outputImage;	// IMP=0x000000000010739a
- (id)_paddedTileKernel;	// IMP=0x0000000000107077
- (id)_grainBlendAndMixKernel;	// IMP=0x0000000000107057
- (id)_interpolateGrainKernel;	// IMP=0x0000000000107037
