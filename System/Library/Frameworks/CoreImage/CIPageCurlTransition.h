...
+ (id)customAttributes;	// IMP=0x00600000000ffa21
...
- (id)outputImage;	// IMP=0x00000000000fdcf4
- (id)_CIPageCurlTransNoEmap;	// IMP=0x00000000000fdcd4
- (id)_CIPageCurlTransition;	// IMP=0x00000000000fdcb4
