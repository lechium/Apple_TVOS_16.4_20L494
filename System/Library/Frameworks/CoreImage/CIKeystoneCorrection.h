...
+ (id)customAttributes;	// IMP=0x0060000000281b2d
- (id).cxx_construct;	// IMP=0x0000000000282389
...
- (id)outputImage;	// IMP=0x000000000028221b
@property(readonly, nonatomic) CIFilter *outputRotationFilter;
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeRotation;	// IMP=0x0000000000281eee
- (void)computeCameraIntrinsics;	// IMP=0x0000000000281db3
