...
+ (id)customAttributes;	// IMP=0x00600000001137f2
...
- (id)outputImage;	// IMP=0x0000000000113cff
- (double)effectiveScale;	// IMP=0x0000000000113c6b
- (id)sensorSize;	// IMP=0x0000000000113b47
