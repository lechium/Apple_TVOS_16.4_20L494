...
+ (id)customAttributes;	// IMP=0x00600000000e7725
...
- (id)outputImage;	// IMP=0x00000000000e7aad
- (id)cpuParams;	// IMP=0x00000000000e78ed
- (id)kernel;	// IMP=0x00000000000e7890
- (id)mtlKernel;	// IMP=0x00000000000e7823
