...
+ (id)customAttributes;	// IMP=0x006000000016077a
...
- (id)outputImage;	// IMP=0x0000000000161223
- (void)setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000161182
- (id)_kernelRH;	// IMP=0x0000000000161162
- (id)_kernelH;	// IMP=0x0000000000161142
- (id)_kernelC;	// IMP=0x0000000000161122
- (id)_kernelBpos;	// IMP=0x0000000000161102
- (id)_kernelBneg;	// IMP=0x00000000001610e2
- (void)dealloc;	// IMP=0x0000000000161065
- (_Bool)_isIdentity;	// IMP=0x0000000000160f2f
