...
+ (id)customAttributes;	// IMP=0x00600000001445e2
...
- (id)outputImage;	// IMP=0x0000000000145029
- (id)defuse:(id)arg1 seed:(int)arg2;	// IMP=0x0000000000144dbc
- (id)_kernelKmeans;	// IMP=0x0000000000144d9c
- (id)_combine:(id)arg1;	// IMP=0x00000000001448c3
