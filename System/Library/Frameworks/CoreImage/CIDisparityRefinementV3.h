...
+ (id)customAttributes;	// IMP=0x00600000001af94d
...
- (id)outputImage;	// IMP=0x00000000001afdc5
- (id)alphaImageForMainImage:(id)arg1 disparity:(id)arg2;	// IMP=0x00000000001afabe
