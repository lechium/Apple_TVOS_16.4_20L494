...
+ (id)customAttributes;	// IMP=0x006000000004887c
- (id)outputImage;	// IMP=0x00000000000489a8
- (_Bool)_isIdentity;	// IMP=0x000000000004894e
- (id)kernel;	// IMP=0x000000000004885c
