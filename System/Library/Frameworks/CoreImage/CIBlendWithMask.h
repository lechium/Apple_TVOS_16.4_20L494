...
+ (id)customAttributes;	// IMP=0x0060000000018b10
...
- (id)outputImage;	// IMP=0x0000000000018cd3
- (float)_maskFillColorValue;	// IMP=0x0000000000018c51
- (id)_kernelB0;	// IMP=0x0000000000018c31
- (id)_kernel;	// IMP=0x0000000000018c11
