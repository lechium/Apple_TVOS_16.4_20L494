...
- (_Bool)isBurstAction;	// IMP=0x000000000001da91
- (float)predictResult;	// IMP=0x000000000001d9bf
- (double)computeKernelValueWithSupportVector:(const struct CIBurstSupportVector *)arg1;	// IMP=0x000000000001d947
- (void)scaleVector;	// IMP=0x000000000001d7f3
- (id)initWithVersion:(int)arg1;	// IMP=0x000000000001d78a
- (id)init;	// IMP=0x000000000001d73f
