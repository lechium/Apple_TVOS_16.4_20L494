...
- (id)parameterNamesForChannel:(int)arg1;	// IMP=0x00000000001dcceb
- (id)filterNameForChannel:(int)arg1;	// IMP=0x00000000001dccc8
- (id)outputImage;	// IMP=0x00000000001dc981
