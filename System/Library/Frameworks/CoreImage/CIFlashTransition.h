...
+ (id)customAttributes;	// IMP=0x00600000000a3d2f
...
- (id)outputImage;	// IMP=0x00000000000a4337
- (id)_geomKernel;	// IMP=0x00000000000a4317
- (id)_colorKernel;	// IMP=0x00000000000a42f7
