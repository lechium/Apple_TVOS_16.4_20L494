...
+ (id)customAttributes;	// IMP=0x00600000000faacf
...
- (id)outputImage;	// IMP=0x00000000000fada1
- (_Bool)_doMinimum;	// IMP=0x00000000000fad99
- (_Bool)_isIdentity;	// IMP=0x00000000000fad4c
