...
+ (id)customAttributes;	// IMP=0x006000000008b125
...
- (id)outputImage;	// IMP=0x000000000008b45e
- (id)_kernelGuideMono;	// IMP=0x000000000008b43e
- (id)_kernelGuideCombine4;	// IMP=0x000000000008b41e
- (id)_kernelGuideCombine;	// IMP=0x000000000008b3fe
- (id)_kernelJointUpsampRG;	// IMP=0x000000000008b3de
- (id)_kernelJointUpsamp;	// IMP=0x000000000008b3be
