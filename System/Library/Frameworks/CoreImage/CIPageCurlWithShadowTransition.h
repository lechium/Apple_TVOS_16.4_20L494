...
+ (id)customAttributes;	// IMP=0x00600000001017e8
...
- (id)outputImage;	// IMP=0x00000000000ffd23
- (id)_CIPageCurlNoShadowTransition;	// IMP=0x00000000000ffd03
- (id)_CIPageCurlWithShadowTransition;	// IMP=0x00000000000ffce3
