...
- (long long)compareActionAmounts:(id)arg1;	// IMP=0x000000000001dda9
- (long long)compareIndices:(id)arg1;	// IMP=0x000000000001dd3a
- (long long)compareDividers:(id)arg1;	// IMP=0x000000000001dcc1
