...
+ (id)customAttributes;	// IMP=0x0060000000047968
...
- (id)outputImage;	// IMP=0x0000000000047cee
- (_Bool)_isIdentity;	// IMP=0x0000000000047ce6
- (id)_kernel;	// IMP=0x0000000000047948
