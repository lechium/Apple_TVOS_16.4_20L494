...
+ (id)customAttributes;	// IMP=0x00600000001658de
...
- (id)outputImage;	// IMP=0x0000000000165f22
- (_Bool)_isIdentity;	// IMP=0x0000000000165dae
- (struct vec2)_scale;	// IMP=0x0000000000165d33
