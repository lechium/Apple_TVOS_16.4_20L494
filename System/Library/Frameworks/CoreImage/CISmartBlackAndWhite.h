...
+ (id)customAttributes;	// IMP=0x006000000015d9e2
...
- (id)outputImage;	// IMP=0x000000000015df54
- (id)_kernel;	// IMP=0x000000000015df34
- (id)hueArrayImage:(float *)arg1;	// IMP=0x000000000015d82f
- (float *)createHueArray;	// IMP=0x000000000015d6db
- (void)getNonNormalizedSettings:(CDStruct_31328b19 *)arg1;	// IMP=0x000000000015d39e
