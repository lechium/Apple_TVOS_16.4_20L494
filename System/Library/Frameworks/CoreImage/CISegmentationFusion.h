...
+ (id)customAttributes;	// IMP=0x00600000001ad437
- (id)outputImage;	// IMP=0x00000000001ad801
- (_Bool)_isIdentity;	// IMP=0x00000000001ad7a7
- (id)kernel;	// IMP=0x00000000001ad417
