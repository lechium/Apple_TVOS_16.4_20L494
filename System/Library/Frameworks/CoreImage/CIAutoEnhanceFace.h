...
- (struct CGRect)faceRect;	// IMP=0x00000000001c6ae5
- (id)description;	// IMP=0x00000000001c6aa7
- (id)initWithBounds:(struct CGRect)arg1 andImage:(id)arg2 usingContext:(id)arg3;	// IMP=0x00000000001c670f
