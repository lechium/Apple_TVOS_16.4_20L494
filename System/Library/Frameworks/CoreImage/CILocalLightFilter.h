...
+ (id)customAttributes;	// IMP=0x00600000000ec341
- (id)outputImage;	// IMP=0x00000000000ec6ec
- (id)_polyKernel;	// IMP=0x00000000000ec6cc
- (id)_shadowKernel;	// IMP=0x00000000000ec6ac
