...
+ (id)customAttributes;	// IMP=0x006000000010b7b9
...
- (id)outputImage;	// IMP=0x000000000010d8fe
- (id)outputImageV3;	// IMP=0x000000000010d756
- (id)outputImageV2;	// IMP=0x000000000010d693
- (id)outputImage:(_Bool)arg1;	// IMP=0x000000000010bd3c
- (id)_ourBlendKernelMetal;	// IMP=0x000000000010bcdf
- (id)_ourBlendKernel;	// IMP=0x000000000010bc82
- (id)_kernelsWithShapes;	// IMP=0x000000000010bc25
- (id)_kernelWithShapesMetal;	// IMP=0x000000000010bbc8
- (id)_kernelMetal;	// IMP=0x000000000010bb6b
- (id)_kernel;	// IMP=0x000000000010bb0e
