...
+ (id)customAttributes;	// IMP=0x0060000000111c39
...
- (id)outputImage;	// IMP=0x0000000000112cb2
- (id)_kernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x0000000000112b7c
- (id)_lutKernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x0000000000112a46
- (id)baseVecsLUT:(unsigned int)arg1;	// IMP=0x000000000011295a
- (id)stepsLUT:(unsigned int)arg1;	// IMP=0x000000000011283e
- (id)baseVecsLUTGenerator;	// IMP=0x00000000001127d1
- (id)stepsLUTGenerator;	// IMP=0x0000000000112764
- (_Bool)_useD2XRenderer;	// IMP=0x0000000000112643
- (id)_packageParams:(_Bool)arg1 extent:(struct CGRect)arg2 image:(id)arg3 haveAlpha:(_Bool)arg4;	// IMP=0x0000000000111dad
