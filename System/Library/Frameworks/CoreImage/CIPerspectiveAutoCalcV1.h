...
- (id).cxx_construct;	// IMP=0x0000000000185705
- (void).cxx_destruct;	// IMP=0x0000000000185687
...
- (void)computeTransform;	// IMP=0x00000000001845f6
- (void)computeGuides;	// IMP=0x0000000000183a91
- (void)clusterLineSegments;	// IMP=0x00000000001820bd
- (void)extractLineSegments;	// IMP=0x0000000000181a0a
- (void)rangeLimitGradientMap;	// IMP=0x0000000000181765
- (void)thresholdGradientMap;	// IMP=0x000000000018158a
- (void)normalizeGradientMap;	// IMP=0x0000000000181239
- (void)createGradientMap;	// IMP=0x0000000000180f07
- (void)standardizeImage;	// IMP=0x0000000000180ceb
- (double)confidence;	// IMP=0x0000000000180c66
- (_Bool)compute;	// IMP=0x00000000001803ff
- (void)dealloc;	// IMP=0x00000000001803be
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x000000000018024a
