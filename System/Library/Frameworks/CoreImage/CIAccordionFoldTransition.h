...
+ (id)customAttributes;	// IMP=0x006000000000a868
...
- (id)outputImage;	// IMP=0x000000000000ac73
- (id)_kernel;	// IMP=0x000000000000ac53
- (id)_kernelMix;	// IMP=0x000000000000ac33
- (id)_kernelWarpT;	// IMP=0x000000000000ac13
- (id)_kernelWarpS;	// IMP=0x000000000000abf3
