...
- (float)overlapWithSwRect:(struct CGRect)arg1;	// IMP=0x000000000001e36e
- (float)overlapWithHwRect:(struct CGRect)arg1;	// IMP=0x000000000001e2a9
- (struct CGRect)swFaceRect;	// IMP=0x000000000001e1ea
- (struct CGRect)hwFaceRect;	// IMP=0x000000000001e12b
