...
+ (id)customAttributes;	// IMP=0x00600000001b8143
...
- (id)outputImage;	// IMP=0x00000000001b89e4
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001b8551
