...
- (id)outputImage;	// IMP=0x0000000000114df9
- (id)_ourBlendKernelMetal;	// IMP=0x0000000000114d9c
- (id)nonMetalKernelYCC;	// IMP=0x0000000000114d3f
- (id)nonMetalKernel;	// IMP=0x0000000000114ce2
- (id)_blendKernel:(_Bool)arg1;	// IMP=0x0000000000114c19
