...
+ (id)customAttributes;	// IMP=0x00600000000d4828
...
- (id)outputImage;	// IMP=0x00000000000d3fe3
- (struct CGRect)_outputExtent;	// IMP=0x00000000000d38fc
- (id)_kernel;	// IMP=0x00000000000d38dc
