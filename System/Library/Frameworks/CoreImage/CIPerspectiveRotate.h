...
+ (id)customAttributes;	// IMP=0x006000000028105c
- (id).cxx_construct;	// IMP=0x0000000000281af7
...
- (id)outputImage;	// IMP=0x000000000028166f
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeCameraIntrinsics;	// IMP=0x00000000002812fb
