...
- (id)featuresInImage:(id)arg1;	// IMP=0x00000000000138eb
- (id)featuresInImage:(id)arg1 options:(id)arg2;	// IMP=0x0000000000012cdd
- (void)dealloc;	// IMP=0x0000000000012c87
- (id)initWithContext:(id)arg1 options:(id)arg2;	// IMP=0x0000000000012b40
