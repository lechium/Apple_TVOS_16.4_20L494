...
+ (id)customAttributes;	// IMP=0x006000000017db0b
...
- (id)outputImage;	// IMP=0x000000000017dee0
- (id)_negkernel;	// IMP=0x000000000017dec0
- (id)_poskernel;	// IMP=0x000000000017dea0
- (_Bool)_isIdentity;	// IMP=0x000000000017de6b
