...
+ (id)customAttributes;	// IMP=0x0060000000046626
...
- (id)outputImage;	// IMP=0x0000000000046d96
- (_Bool)_isIdentityAlpha;	// IMP=0x0000000000046cd1
- (_Bool)_isIdentity;	// IMP=0x00000000000469e7
- (id)_kernelRGB;	// IMP=0x00000000000465e3
- (id)_kernel;	// IMP=0x00000000000465c3
