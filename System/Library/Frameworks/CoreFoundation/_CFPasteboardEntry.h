...
- (CDUnknownBlockType)requestDataForPasteboard:(struct __CFPasteboard *)arg1 generation:(long long)arg2 immediatelyAvailableResult:(CDStruct_55991ab6 *)arg3;	// IMP=0x000000000006b795
- (void)resolveClientPromisedDataWithQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000006b46c
- (unsigned char)resolveLocalPromisedData;	// IMP=0x000000000006b3c1
- (void)promiseDataWithBlock:(CDUnknownBlockType)arg1 forPasteboard:(struct __CFPasteboard *)arg2 generation:(long long)arg3;	// IMP=0x000000000006b298
- (id)createXPCObjectWithMetadataOnly:(unsigned char)arg1;	// IMP=0x000000000006b160
- (id)initFromXPCObject:(id)arg1 fromConnection:(id)arg2;	// IMP=0x000000000006adae
@property(readonly) unsigned char promisorExistsInCurrentProcess;
- (void)_setLocalPromiseState:(unsigned char)arg1;	// IMP=0x000000000006ac53
@property(readonly) unsigned char hasLocalPromise;
- (const struct __CFData *)createDataAndReturnError:(int *)arg1;	// IMP=0x000000000006ab02
- (id)_createXPCData;	// IMP=0x000000000006aaad
- (void)setData:(struct __CFData *)arg1;	// IMP=0x000000000006aa17
@property(readonly) unsigned char hasData;
- (id)description;	// IMP=0x000000000006a86d
- (void)dealloc;	// IMP=0x000000000006a79d
- (id)initWithFlavorName:(const struct __CFString *)arg1 itemIdentifier:(int)arg2;	// IMP=0x000000000006a701
- (void)promiseDataWithFetchOperation:(id)arg1;	// IMP=0x000000000009195a
