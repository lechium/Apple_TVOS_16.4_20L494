...
- (void).cxx_destruct;	// IMP=0x00000000000adce3
...
- (void)faultIfNeededForObject:(id)arg1;	// IMP=0x00000000000adc2a
- (id)initWithRootObject:(id)arg1;	// IMP=0x00000000000adbbf
