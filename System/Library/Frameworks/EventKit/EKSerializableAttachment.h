...
+ (id)classesForKey;	// IMP=0x00600000000e39ec
- (void).cxx_destruct;	// IMP=0x00000000000e3aa1
...
- (id)createAttachment;	// IMP=0x00000000000e3a28
- (id)initWithAttachment:(id)arg1;	// IMP=0x00000000000e39f9
