...
- (void).cxx_destruct;	// IMP=0x000000000001a83e
@property(readonly, nonatomic) __weak EKReminderStore *reminderStore; // @synthesize reminderStore=_reminderStore;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001a81d
- (void)cancel;	// IMP=0x000000000001a7c4
- (id)initWithReminderStore:(id)arg1;	// IMP=0x000000000001a760
