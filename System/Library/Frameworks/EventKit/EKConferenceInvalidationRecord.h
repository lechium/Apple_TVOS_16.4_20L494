...
- (void).cxx_destruct;	// IMP=0x00000000001148bf
...
- (void)finishWithURL:(id)arg1 error:(id)arg2;	// IMP=0x00000000001146a8
- (void)generateNewValidURLForOriginalURL:(id)arg1;	// IMP=0x0000000000114356
