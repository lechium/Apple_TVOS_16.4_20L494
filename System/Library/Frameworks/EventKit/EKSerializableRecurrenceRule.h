...
+ (id)classesForKey;	// IMP=0x0060000000079a88
- (void).cxx_destruct;	// IMP=0x000000000007a44d
...
- (id)createRecurrenceRule:(id *)arg1;	// IMP=0x000000000007a1d5
- (id)initWithRecurrenceRule:(id)arg1;	// IMP=0x0000000000079eb5
