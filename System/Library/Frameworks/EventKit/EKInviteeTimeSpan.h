...
- (void).cxx_destruct;	// IMP=0x000000000011dec5
...
- (id)description;	// IMP=0x000000000011dcc5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011dba8
- (id)init;	// IMP=0x000000000011db3d
