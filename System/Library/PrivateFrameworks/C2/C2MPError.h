...
- (void).cxx_destruct;	// IMP=0x0000000000019c8b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000019b4d
- (unsigned long long)hash;	// IMP=0x0000000000019ab9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000019990
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000198a8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000019804
- (void)writeTo:(id)arg1;	// IMP=0x0000000000019765
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000019758
- (id)dictionaryRepresentation;	// IMP=0x0000000000019344
- (id)description;	// IMP=0x0000000000019295
