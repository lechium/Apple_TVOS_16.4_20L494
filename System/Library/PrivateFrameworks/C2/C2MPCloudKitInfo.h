...
+ (Class)clientOperationType;	// IMP=0x0010000000011e47
+ (Class)operationGroupType;	// IMP=0x0010000000011cdd
- (void).cxx_destruct;	// IMP=0x00000000000144dc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000013eee
- (unsigned long long)hash;	// IMP=0x0000000000013ceb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001395f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001345f
- (void)copyTo:(id)arg1;	// IMP=0x0000000000013151
- (void)writeTo:(id)arg1;	// IMP=0x0000000000012d7d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000012d70
- (id)dictionaryRepresentation;	// IMP=0x0000000000011f97
- (id)description;	// IMP=0x0000000000011ee8
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000011e2a
- (unsigned long long)clientOperationsCount;	// IMP=0x0000000000011e0d
- (void)addClientOperation:(id)arg1;	// IMP=0x0000000000011da3
- (void)clearClientOperations;	// IMP=0x0000000000011d86
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000011cc0
- (unsigned long long)operationGroupsCount;	// IMP=0x0000000000011ca3
- (void)addOperationGroup:(id)arg1;	// IMP=0x0000000000011c39
- (void)clearOperationGroups;	// IMP=0x0000000000011c1c
