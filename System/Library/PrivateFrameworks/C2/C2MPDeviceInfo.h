...
+ (Class)internalTestConfigType;	// IMP=0x001000000002cf6e
- (void).cxx_destruct;	// IMP=0x000000000002e6ac
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002e2d8
- (unsigned long long)hash;	// IMP=0x000000000002e197
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002df21
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002dc05
- (void)copyTo:(id)arg1;	// IMP=0x000000000002da23
- (void)writeTo:(id)arg1;	// IMP=0x000000000002d7e5
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002d7d8
- (id)dictionaryRepresentation;	// IMP=0x000000000002d02e
- (id)description;	// IMP=0x000000000002cf7f
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x000000000002cf51
- (unsigned long long)internalTestConfigsCount;	// IMP=0x000000000002cf34
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x000000000002ceca
- (void)clearInternalTestConfigs;	// IMP=0x000000000002cead
