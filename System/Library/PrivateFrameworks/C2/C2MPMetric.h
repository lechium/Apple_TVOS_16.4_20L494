...
- (void).cxx_destruct;	// IMP=0x0000000000029938
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000295a9
- (unsigned long long)hash;	// IMP=0x0000000000029400
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000029105
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000028ed8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000028d21
- (void)writeTo:(id)arg1;	// IMP=0x0000000000028b65
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000028b58
- (id)dictionaryRepresentation;	// IMP=0x0000000000027fe3
- (id)description;	// IMP=0x0000000000027f34
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x0000000000027c96
- (id)metricTypeAsString:(int)arg1;	// IMP=0x0000000000027c2a
