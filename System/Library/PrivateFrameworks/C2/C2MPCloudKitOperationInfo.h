...
- (void).cxx_destruct;	// IMP=0x000000000000682c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000006722
- (unsigned long long)hash;	// IMP=0x0000000000006687
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006561
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000006486
- (void)copyTo:(id)arg1;	// IMP=0x00000000000063e6
- (void)writeTo:(id)arg1;	// IMP=0x000000000000633a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000632d
- (id)dictionaryRepresentation;	// IMP=0x0000000000005f06
- (id)description;	// IMP=0x0000000000005e57
