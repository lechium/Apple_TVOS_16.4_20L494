...
+ (id)_profilesWithNonStandardTileUI;	// IMP=0x001000000006f125
- (id)hf_setTileSize:(id)arg1;	// IMP=0x0010000000063e85
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x0010000000063e0b
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x0010000000063daf
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0010000000063c54
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00100000000a9476
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00100000001be418
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00100000001be33b
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001be2a5
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00100000001be252
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001be1ff
- (_Bool)hf_isValidObject;	// IMP=0x00100000001fb7be
