...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00200000000a84b2
- (id)hf_updateWallpaperImage:(id)arg1;	// IMP=0x002000000015f5f3
@property(readonly, nonatomic) UIImage *hf_wallpaperImage;
- (id)hf_accessoryRepresentableUsageCountsWithFilter:(CDUnknownBlockType)arg1;	// IMP=0x002000000016ebc4
- (id)hf_allNonEmptyActionSets;	// IMP=0x002000000016e9de
- (id)hf_roomsSortDescriptorUsingDashboardSectionOrder;	// IMP=0x002000000016e948
- (CDUnknownBlockType)hf_dashboardSectionReorderableUUIDStringComparator;	// IMP=0x002000000016e817
- (id)hf_reorderableDashboardSectionList;	// IMP=0x002000000016e7da
- (id)hf_reorderableServicesList;	// IMP=0x002000000016e79d
@property(readonly, nonatomic) _Bool hf_hasAtleastOneReachableHomePod;
- (_Bool)hf_atleastOneMediaAccessorySupportsAndHasAnnounceEnabled;	// IMP=0x002000000016e3c5
- (_Bool)hf_atleastOneHomePodSupportsAnnounce;	// IMP=0x002000000016e32a
...
- (id)availableHomePodsSupportingStereoPairingVersions:(unsigned long long)arg1;	// IMP=0x002000000016e008
- (id)availableHomeTheaterMediaPartnerFor:(id)arg1;	// IMP=0x002000000016dbd1
...
- (void)hf_updateApplicationData:(id)arg1 handleError:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0020000000242e7d
- (void)_hf_updateApplicationData:(id)arg1;	// IMP=0x0020000000242d2d
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x002000000030c38c
