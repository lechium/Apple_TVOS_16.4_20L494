...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00200000000aaaa7
- (_Bool)hf_isResidentAppleTV;	// IMP=0x00200000001148d9
- (_Bool)hf_isResidentiPad;	// IMP=0x0020000000114866
- (_Bool)hf_isReachable;	// IMP=0x0020000000114771
