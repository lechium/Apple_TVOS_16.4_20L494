...
- (_Bool)hf_fake8021xNetworkSymptom;	// IMP=0x0020000000087df6
...
- (id)hf_roleForAccessory:(id)arg1;	// IMP=0x0020000000166d43
- (id)hf_accessoryForRole:(id)arg1;	// IMP=0x0020000000166b3c
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00200000001bf008
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bef42
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001beeac
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bee0c
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bed6c
- (_Bool)hf_isValidObject;	// IMP=0x00200000001fb501
- (unsigned long long)hf_preferredUserSelectionType;	// IMP=0x00200000002319bf
- (id)hf_preferredMediaUser;	// IMP=0x0020000000231929
@property(readonly, nonatomic) _Bool hf_supportsPreferredMediaUser;
@property(readonly, nonatomic) _Bool hf_supportsHomeTheater;
- (id)hf_destination;	// IMP=0x002000000023177c
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x002000000023176f
@property(readonly, copy, nonatomic) NSDate *hf_dateAdded;
@property(readonly, copy, nonatomic) NSString *hf_displayName;
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00200000002316a4
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x0020000000231571
@property(readonly, nonatomic) _Bool hf_canSpanMultipleRooms;
@property(readonly, nonatomic) HMRoom *hf_safeRoom;
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x0020000000231359
...
- (id)hf_setTileSize:(id)arg1;	// IMP=0x002000000023107c
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x0020000000230f0e
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x0020000000230eb2
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0020000000230dcc
...
- (id)hf_idsDeviceIdentifierWithError:(id *)arg1;	// IMP=0x0020000000230d25
- (id)hf_fetchLog:(id)arg1 timeout:(double)arg2;	// IMP=0x0020000000230c25
- (id)hf_fetchLogListWithTimeout:(double)arg1;	// IMP=0x0020000000230b25
- (id)hf_siriLanguageOptionsManager;	// IMP=0x00200000002308b2
@property(readonly, nonatomic) HFHomeKitSettingsValueManager *hf_settingsValueManager;
- (id)hf_isEitherHomePodMediaAccountOrHomeMediaAccountPresent;	// IMP=0x002000000023071b
- (id)hf_homePodMediaAccountIsMismatchedWithHomeMediaAccount;	// IMP=0x002000000023067a
- (id)hf_homePodSupportsMultiUserLanguage;	// IMP=0x0020000000230672
- (id)hf_appleMusicCurrentLoggedInAccount;	// IMP=0x0020000000230594
- (id)hf_appleMusicCurrentLoggedInAccountDSID;	// IMP=0x00200000002304a1
