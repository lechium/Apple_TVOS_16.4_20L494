...
- (void)hf_updateWithDiscoveredAccessory:(id)arg1;	// IMP=0x00300000000d9927
...
- (_Bool)hf_isLogitechCircleViewDoorbell;	// IMP=0x00300000000d95a4
- (id)hf_home;	// IMP=0x00300000000d944a
@end
