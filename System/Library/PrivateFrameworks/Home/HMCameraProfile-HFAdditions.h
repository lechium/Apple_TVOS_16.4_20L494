...
+ (unsigned long long)hf_cameraAccessModeSelectedOptionForCameraProfiles:(id)arg1 presenceType:(unsigned long long)arg2;	// IMP=0x001000000014516d
- (id)hf_faceCropImageForSignificantEvent:(id)arg1;	// IMP=0x001000000014588b
- (id)hf_significantEventWithIdentifier:(id)arg1;	// IMP=0x00100000001454a4
- (void)hf_updateDoorbellChime:(_Bool)arg1;	// IMP=0x0010000000144f1c
...
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x0010000000229474
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)hf_bulletinNotifications;	// IMP=0x001000000022933d
- (id)_hf_smartDetectionBulletinNotification;	// IMP=0x00100000002292ed
- (id)_hf_legacyMotionSensorBulletinNotification;	// IMP=0x0010000000229269
- (id)_hf_doorbellBulletinNotification;	// IMP=0x00100000002291e5
