...
- (id)hf_setTileSize:(id)arg1;	// IMP=0x00200000000637f4
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x00200000000637c1
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x0020000000063765
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x002000000006367f
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00200000000a7968
...
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00200000001bdf44
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bdea1
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bde0b
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bdd6b
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bdccb
- (_Bool)hf_isValidObject;	// IMP=0x00200000001fb141
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x002000000022910a
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)_hf_allBulletinBoardNotifications;	// IMP=0x0020000000229035
- (void)hf_updateApplicationData:(id)arg1 handleError:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00200000002437ec
- (void)_hf_didUpdateApplicationData:(id)arg1;	// IMP=0x0020000000243654
...
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x002000000030c0a0
