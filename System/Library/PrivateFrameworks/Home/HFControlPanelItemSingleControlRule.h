...
- (void).cxx_destruct;	// IMP=0x000000000020d92e
...
- (id)controlPanelItemForControlItems:(id)arg1;	// IMP=0x000000000020d7ea
- (id)initWithFilter:(CDUnknownBlockType)arg1 displayResultsGenerator:(CDUnknownBlockType)arg2;	// IMP=0x000000000020d731
