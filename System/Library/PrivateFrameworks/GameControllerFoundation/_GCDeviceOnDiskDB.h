...
- (void).cxx_destruct;	// IMP=0x0000000000026629
@property(readonly, copy) NSArray *configurationBundles; // @synthesize configurationBundles=_configurationBundles;
- (id)bestModelMatchingDevice:(id)arg1;	// IMP=0x0000000000025b94
- (id)init;	// IMP=0x0000000000025b7b
- (id)initWithBundles:(id)arg1;	// IMP=0x000000000002595e
