...
- (id)gc_snapshot;	// IMP=0x0020000000019f27
- (id)debugDescription;	// IMP=0x0020000000023643
- (id)valueForKey:(id)arg1;	// IMP=0x0020000000023520
- (id)valueForElementKey:(id)arg1;	// IMP=0x00200000000233f3
