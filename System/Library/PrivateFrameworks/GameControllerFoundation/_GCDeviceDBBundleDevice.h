...
- (id)personalities;	// IMP=0x00000000000316de
- (id)init;	// IMP=0x00000000000316b3
- (id)initWithBundle:(id)arg1 dictionary:(id)arg2 error:(out id *)arg3;	// IMP=0x00000000000305e1
