...
- (void).cxx_destruct;	// IMP=0x0000000000023133
@property(readonly) NSString *configurationType; // @synthesize configurationType=_configurationType;
- (void)_assetDidChange:(id)arg1;	// IMP=0x000000000002310c
- (void)_filesystemDidChange:(id)arg1;	// IMP=0x0000000000022e47
- (id)fetchBundles;	// IMP=0x00000000000228e2
- (void)dealloc;	// IMP=0x0000000000022827
- (id)init;	// IMP=0x00000000000227fc
- (id)initWithConfigurationType:(id)arg1 provider:(id)arg2;	// IMP=0x0000000000021b3c
