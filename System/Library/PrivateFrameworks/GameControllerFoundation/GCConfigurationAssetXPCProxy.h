...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000020dce
- (void).cxx_destruct;	// IMP=0x000000000002129a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000021104
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000020fb0
- (id)init;	// IMP=0x0000000000020f85
- (id)initWithAsset:(id)arg1;	// IMP=0x0000000000020dd6
