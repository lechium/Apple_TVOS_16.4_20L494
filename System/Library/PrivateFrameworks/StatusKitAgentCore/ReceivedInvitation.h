...
+ (id)statusTypeIdentifierKeyPath;	// IMP=0x0040000000051687
+ (id)senderHandleKeyPath;	// IMP=0x004000000005167a
+ (id)dateInvitationCreatedKeyPath;	// IMP=0x004000000005166d
+ (id)predicateForStatusTypeIdentifier:(id)arg1;	// IMP=0x0040000000051790
+ (id)predicateForSenderHandleString:(id)arg1;	// IMP=0x00400000000516f6
+ (id)predicateForSenderHandle:(id)arg1;	// IMP=0x0040000000051694
+ (id)sortDescriptorForSenderHandleOrderedAscending:(_Bool)arg1;	// IMP=0x0040000000051899
+ (id)sortDescriptorForDateInvitationCreatedOrderedAscending:(_Bool)arg1;	// IMP=0x004000000005182a
+ (id)fetchRequest;	// IMP=0x0040000000073506
