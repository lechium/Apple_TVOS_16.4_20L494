...
- (void).cxx_destruct;	// IMP=0x0000000000055a52
...
- (id)description;	// IMP=0x0000000000055988
- (id)initWithStatusPayload:(id)arg1 invitation:(id)arg2;	// IMP=0x00000000000558ef
