...
- (void).cxx_destruct;	// IMP=0x000000000005589c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000556db
- (unsigned long long)hash;	// IMP=0x0000000000055604
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000055470
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000055341
- (void)copyTo:(id)arg1;	// IMP=0x0000000000055259
- (void)writeTo:(id)arg1;	// IMP=0x0000000000055175
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000055168
- (id)dictionaryRepresentation;	// IMP=0x0000000000054bd4
- (id)description;	// IMP=0x0000000000054b25
...
- (int)StringAsRequestFlag:(id)arg1;	// IMP=0x0000000000054a23
- (id)requestFlagAsString:(int)arg1;	// IMP=0x00000000000549da
