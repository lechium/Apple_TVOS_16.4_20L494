...
- (void).cxx_destruct;	// IMP=0x0000000000010178
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000001000f
- (unsigned long long)hash;	// IMP=0x000000000000ff65
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000fe08
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000fcf9
- (void)copyTo:(id)arg1;	// IMP=0x000000000000fc35
- (void)writeTo:(id)arg1;	// IMP=0x000000000000fb79
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000fb6c
- (id)dictionaryRepresentation;	// IMP=0x000000000000f7b5
- (id)description;	// IMP=0x000000000000f706
