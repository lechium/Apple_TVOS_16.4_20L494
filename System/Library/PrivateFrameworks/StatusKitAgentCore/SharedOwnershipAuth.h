...
- (void).cxx_destruct;	// IMP=0x000000000006f8a7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000006f72b
- (unsigned long long)hash;	// IMP=0x000000000006f688
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006f528
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006f410
- (void)copyTo:(id)arg1;	// IMP=0x000000000006f34d
- (void)writeTo:(id)arg1;	// IMP=0x000000000006f299
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006f28c
- (id)dictionaryRepresentation;	// IMP=0x000000000006ef90
- (id)description;	// IMP=0x000000000006eee1
