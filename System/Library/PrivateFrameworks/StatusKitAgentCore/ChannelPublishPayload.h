...
- (void).cxx_destruct;	// IMP=0x000000000004a641
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000004a475
- (unsigned long long)hash;	// IMP=0x000000000004a355
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004a17d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004a031
- (void)copyTo:(id)arg1;	// IMP=0x0000000000049f1b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000049df1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000049de4
- (id)dictionaryRepresentation;	// IMP=0x000000000004957b
- (id)description;	// IMP=0x00000000000494cc
...
- (int)StringAsPushPriority:(id)arg1;	// IMP=0x0000000000049359
- (id)pushPriorityAsString:(int)arg1;	// IMP=0x0000000000049310
