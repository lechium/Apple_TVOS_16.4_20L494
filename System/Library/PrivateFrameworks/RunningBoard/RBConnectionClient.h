...
- (void).cxx_destruct;	// IMP=0x000000000003d116
- (id)captureState;	// IMP=0x000000000003d0da
@property(readonly, copy, nonatomic) NSString *stateCaptureTitle;
- (void)inheritanceManager:(id)arg1 didChangeInheritances:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000003bfc1
@property(readonly, copy) NSString *description;
- (_Bool)hasEntitlementDomain:(unsigned long long)arg1;	// IMP=0x0000000000039202
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x00000000000391e9
- (id)init;	// IMP=0x0000000000030747
