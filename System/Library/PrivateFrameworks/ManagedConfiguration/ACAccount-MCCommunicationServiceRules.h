...
- (id)mcBackingPayload;	// IMP=0x00300000000902f9
- (id)mcBackingProfile;	// IMP=0x003000000009007b
...
- (_Bool)MCIsManaged;	// IMP=0x003000000008f287
- (void)unenrollAccountWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00300000000bf385
- (_Bool)mc_isUserEnrollmentAccount;	// IMP=0x00300000000bf1ce
@end
