...
- (void).cxx_destruct;	// IMP=0x0000000000006295
...
- (id)calculateDuration:(id)arg1 and:(id)arg2;	// IMP=0x0000000000006160
- (void)setAbsintheConnectionMethodWith:(id)arg1;	// IMP=0x0000000000006119
- (void)setAbsintheAuthenticationTimestampForKey:(id)arg1;	// IMP=0x0000000000006009
- (void)reportAbsintheAuthenticationDurations;	// IMP=0x0000000000005c65
- (id)init;	// IMP=0x0000000000005bf0
