...
+ (id)extensionInfoForCurrentProcess;	// IMP=0x001000000001a459
+ (void)notifyExtensionMainCalled;	// IMP=0x001000000001a428
- (void).cxx_destruct;	// IMP=0x000000000001a75b
...
- (id)initForCurrentProcess;	// IMP=0x000000000001a4d4
