...
+ (id)translateAppexptDictionary:(id)arg1 definitionURL:(id)arg2 isCatalyst:(_Bool)arg3;	// IMP=0x006000000003da8a
+ (void)enumerateExtensionPointsInDirectoryAtURL:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x006000000003c982
- (void).cxx_destruct;	// IMP=0x000000000003f2bc
...
- (id)nextObject;	// IMP=0x000000000003e6cf
- (_Bool)validateExtensionPointIdentifier:(id)arg1 sdkDictionary:(id)arg2;	// IMP=0x000000000003e3fa
- (id)flattenEXExtensionPointConfigurationInDictionary:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000003e2b6
- (id)synthesizeNSExtensionKeysInDictionary:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000003dff6
- (id)translateXPCCacheDictionary:(id)arg1;	// IMP=0x000000000003dbfc
- (id)initWithSDKDictionary:(id)arg1 urls:(id)arg2 config:(id)arg3;	// IMP=0x000000000003ce5d
- (id)initWithSDKDictionary:(id)arg1 config:(id)arg2;	// IMP=0x000000000003ce30
- (id)initWithCacheURLs:(id)arg1 config:(id)arg2;	// IMP=0x000000000003ce11
