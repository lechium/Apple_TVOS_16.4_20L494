...
- (void).cxx_destruct;	// IMP=0x000000000003ca1c
...
- (id)_fetchedObjectDictionaryForEntity:(void *)arg1;	// IMP=0x000000000003c796
- (id)_properties:(id)arg1 forEntityIfNotSeen:(void *)arg2 objectExists:(_Bool *)arg3;	// IMP=0x000000000003c073
@property(readonly, nonatomic) NSArray *fetchedObjectWrappers;
- (id)addEntity:(void *)arg1;	// IMP=0x000000000003bcf4
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2 relatedObjectPropertiesToLoad:(id)arg3;	// IMP=0x000000000003bbc7
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2;	// IMP=0x000000000003bbb2
