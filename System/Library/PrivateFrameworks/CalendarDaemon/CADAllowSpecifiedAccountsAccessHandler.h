...
- (void).cxx_destruct;	// IMP=0x0000000000004e94
@property(readonly, nonatomic) NSSet *allowedSourceIdentifiers; // @synthesize allowedSourceIdentifiers=_allowedSourceIdentifiers;
- (_Bool)isActionAllowed:(unsigned long long)arg1 forStore:(const void *)arg2 inDatabase:(struct CalDatabase *)arg3;	// IMP=0x0000000000004ddb
- (id)initWithAllowedSourceIdentifiers:(id)arg1 databaseDataProvider:(id)arg2;	// IMP=0x0000000000004d48
