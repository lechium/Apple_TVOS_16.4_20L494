...
- (void).cxx_destruct;	// IMP=0x000000000003225d
...
- (id)shortDescription;	// IMP=0x0000000000031f40
- (_Bool)isExpiredAtTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000031eca
- (float)similarityToPersonBlob:(id)arg1;	// IMP=0x00000000000316e7
- (void)trackPersonBlob:(id)arg1;	// IMP=0x0000000000031698
- (id)initWithNewPersonEvent:(id)arg1 timeStamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000031463
