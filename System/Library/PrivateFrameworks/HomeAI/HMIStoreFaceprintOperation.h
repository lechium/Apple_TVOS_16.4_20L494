...
+ (id)logCategory;	// IMP=0x006000000000fbe8
- (void).cxx_destruct;	// IMP=0x000000000000fc1e
...
- (void)main;	// IMP=0x000000000000f8b3
- (id)initWithDataSource:(id)arg1 faceprint:(id)arg2;	// IMP=0x000000000000f809
