...
+ (id)logCategory;	// IMP=0x006000000000f7a2
- (void).cxx_destruct;	// IMP=0x000000000000f7d8
...
- (void)main;	// IMP=0x000000000000f46d
- (id)initWithDataSource:(id)arg1 faceCrop:(id)arg2;	// IMP=0x000000000000f3c3
