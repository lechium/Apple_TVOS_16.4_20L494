...
- (void).cxx_destruct;	// IMP=0x000000000001be60
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000001bd63
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput:(id)arg1 inputName:(id)arg2;	// IMP=0x000000000001bc0b
