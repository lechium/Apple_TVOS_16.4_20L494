...
+ (id)logCategory;	// IMP=0x0010000000057c4d
- (void).cxx_destruct;	// IMP=0x0000000000057d0c
...
- (void)URLSession:(id)arg1 didReceiveChallenge:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000057591
- (id)init;	// IMP=0x00000000000573b4
