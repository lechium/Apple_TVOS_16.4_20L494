...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000016d2d
- (void).cxx_destruct;	// IMP=0x0000000000016f3a
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000016dd2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000016d35
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016c57
