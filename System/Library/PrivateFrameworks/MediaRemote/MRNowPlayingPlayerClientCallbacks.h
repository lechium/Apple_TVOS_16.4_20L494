...
- (void).cxx_destruct;	// IMP=0x00000000001dde17
...
- (_Bool)removePlaybackQueueDataSourceCallback:(id)arg1;	// IMP=0x00000000001ddb81
- (void)registerNowPlayingInfoArtworkAssetCallback:(id)arg1;	// IMP=0x00000000001dd794
- (void)registerNowPlayingInfoAssetCallbacks:(id)arg1;	// IMP=0x00000000001dd3fa
- (void)registerNowPlayingInfoCallbacks:(id)arg1;	// IMP=0x00000000001dcf61
- (void)registerNowPlayingInfoBackedPlaybackQueueDataSourceCallbacks;	// IMP=0x00000000001dcef9
@property(readonly, copy, nonatomic) NSArray *commandHandlerBlocks;
- (void)removeCommandHandlerBlockForKey:(id)arg1;	// IMP=0x00000000001dcd00
- (void)addCommandHandlerBlock:(CDUnknownBlockType)arg1 forKey:(id)arg2;	// IMP=0x00000000001dcbf2
- (unsigned long long)_onQueue_capabilities;	// IMP=0x00000000001dcb1f
...
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2;	// IMP=0x00000000001db69a
