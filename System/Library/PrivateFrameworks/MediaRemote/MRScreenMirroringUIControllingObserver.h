...
- (void).cxx_destruct;	// IMP=0x000000000002d414
...
- (void)_mirrorStateChanged:(_Bool)arg1 screenType:(unsigned int)arg2;	// IMP=0x000000000002d240
- (id)init;	// IMP=0x000000000002d04f
