...
- (void).cxx_destruct;	// IMP=0x000000000014533e
...
- (id)debugDescription;	// IMP=0x000000000014510e
- (void)_maybeAttemptToDiscoverAndConnectToCompanionWithReason:(id)arg1;	// IMP=0x0000000000144a3b
- (_Bool)_shouldAttemptToDiscoverAndConnectToCompanion;	// IMP=0x000000000014493c
- (void)_handleExternalDeviceConnectionStateDidChangeNotification:(id)arg1;	// IMP=0x000000000014473e
- (void)_handleCompanionDeviceConnectedNotification:(id)arg1;	// IMP=0x0000000000144725
- (id)init;	// IMP=0x0000000000144169
