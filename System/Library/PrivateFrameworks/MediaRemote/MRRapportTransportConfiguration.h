...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000022029
- (void).cxx_destruct;	// IMP=0x0000000000022254
...
- (id)description;	// IMP=0x00000000000221bb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002209f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000022031
