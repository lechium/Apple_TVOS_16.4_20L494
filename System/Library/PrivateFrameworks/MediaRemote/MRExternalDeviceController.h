...
+ (Class)externalDeviceClass;	// IMP=0x00100000001702ae
- (void).cxx_destruct;	// IMP=0x00000000001712a0
...
- (_Bool)_isManagedConfigIDAllowed:(id)arg1;	// IMP=0x0000000000170f3e
- (void)netService:(id)arg1 didUpdateTXTRecordData:(id)arg2;	// IMP=0x0000000000170e94
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x0000000000170b94
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x0000000000170825
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x0000000000170715
- (void)endDiscovery;	// IMP=0x0000000000170663
- (void)beginDiscovery;	// IMP=0x00000000001705a2
- (void)dealloc;	// IMP=0x000000000017054c
- (id)initWithBonjourServiceType:(id)arg1;	// IMP=0x00000000001702bf
