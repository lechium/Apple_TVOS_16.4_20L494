...
- (void).cxx_destruct;	// IMP=0x000000000011c0d7
...
- (id)description;	// IMP=0x000000000011c02a
- (void)updateWithValue:(unsigned long long)arg1;	// IMP=0x000000000011bf8b
- (id)init;	// IMP=0x000000000011bf2d
