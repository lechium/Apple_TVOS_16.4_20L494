...
- (void).cxx_destruct;	// IMP=0x000000000022b8af
...
- (void)restoreNowPlayingClientState;	// IMP=0x000000000022b7a4
- (void)handlePlayerPropertiesRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000022b3ef
- (void)handlePlaybackStateRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000022b058
- (void)handleSupportedCommandsRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000022aca3
- (void)enqueuePlaybackQueueRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000022a590
- (void)updateContentItemArtwork:(id)arg1;	// IMP=0x000000000022a08d
- (void)updateContentItems:(id)arg1;	// IMP=0x0000000000229d85
...
- (id)debugDescription;	// IMP=0x00000000002294a2
- (void)dealloc;	// IMP=0x000000000022942d
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0000000000229288
