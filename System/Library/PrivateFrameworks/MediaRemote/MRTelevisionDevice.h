...
- (void).cxx_destruct;	// IMP=0x00000000000f2998
...
- (void)handleTextActionPayload:(id)arg1;	// IMP=0x00000000000f27a3
- (void)wake;	// IMP=0x00000000000f279d
- (void)exitHiliteMode;	// IMP=0x00000000000f2797
- (void)processVoiceInputAudioDataForDeviceID:(unsigned int)arg1 withBuffer:(id)arg2 time:(CDStruct_ace97b7a)arg3 gain:(float)arg4;	// IMP=0x00000000000f2791
- (void)registerVoiceInputDeviceWithDescriptor:(id)arg1 replyQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000f278b
- (void)sendGameControllerEvent:(id)arg1 controllerID:(unsigned long long)arg2;	// IMP=0x00000000000f2785
- (void)unregisterGameController:(unsigned long long)arg1;	// IMP=0x00000000000f277f
- (void)registerGameControllerWithProperties:(id)arg1 queue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000f2779
- (void)getRTISessionWithReplyQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f2773
- (void)clearActiveTextEditingSessionData;	// IMP=0x00000000000f276d
- (void)deleteBackwardInActiveTextEditingSession;	// IMP=0x00000000000f2767
- (void)setTextOnActiveTextEditingSessionWithText:(id)arg1;	// IMP=0x00000000000f2761
- (void)insertTextIntoActiveTextEditingSessionWithText:(id)arg1;	// IMP=0x00000000000f275b
- (void)getTextEditingSessionWithReplyQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f2755
- (void)sendTouchEvent:(struct _MRHIDTouchEvent)arg1 toVirtualDeviceWithID:(unsigned long long)arg2;	// IMP=0x00000000000f274f
- (void)registerTouchDeviceWithDescriptor:(id)arg1 replyQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000f2749
- (id)currentClientUpdatesConfigMessage;	// IMP=0x00000000000f2634
- (void)setHiliteModeCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000f262e
- (void)setVoiceRecordingStateCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000f2628
- (void)setRTICallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000f2622
- (void)setTextEditingCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000f261c
- (void)setGameControllerPropertiesCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000f2616
- (void)setGameControllerInputModeCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000f2610
