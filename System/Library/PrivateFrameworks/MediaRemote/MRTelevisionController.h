...
+ (Class)externalDeviceClass;	// IMP=0x001000000017a04e
- (void).cxx_destruct;	// IMP=0x000000000017a3db
...
- (void)externalDeviceController:(id)arg1 didRemoveDevice:(id)arg2;	// IMP=0x000000000017a1f8
- (void)externalDeviceController:(id)arg1 didDiscoverDevice:(id)arg2;	// IMP=0x000000000017a05f
- (id)init;	// IMP=0x0000000000179ff5
