...
- (void).cxx_destruct;	// IMP=0x0000000000039f34
@property(readonly, nonatomic) _Bool faceIsFullyVisible;
@property(nonatomic) float fadeFactor;
- (void)didSnapshot;	// IMP=0x0000000000039e93
- (void)willSnapshot;	// IMP=0x0000000000039e7a
- (void)updateWithPresentationConfiguration:(id)arg1;	// IMP=0x0000000000039ae7
- (void)updatePointOfViewFromFramingMode;	// IMP=0x0000000000039a2f
- (id)pointOfViewForFramingMode:(id)arg1;	// IMP=0x000000000003996c
- (void)setFramingModeForcingPointOfViewUpdate:(id)arg1;	// IMP=0x000000000003992d
@property(retain, nonatomic) NSString *framingMode;
- (void)updateSpecializedLighting;	// IMP=0x00000000000397b5
- (void)updateCustomCameras;	// IMP=0x0000000000039710
- (void)avatarDidChange:(id)arg1 presentationConfiguration:(id)arg2;	// IMP=0x0000000000039657
...
- (id)initAndInstallInScene:(id)arg1 renderer:(id)arg2;	// IMP=0x0000000000039287
- (id)defaultEnvironmentNode;	// IMP=0x0000000000038f7d
