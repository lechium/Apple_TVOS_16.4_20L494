...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000dd8e
- (void).cxx_destruct;	// IMP=0x000000000000dfd2
...
- (id)initWithConnectionIdentifier:(id)arg1 receivedSequenceNumber:(id)arg2 content:(id)arg3;	// IMP=0x000000000000dafa
