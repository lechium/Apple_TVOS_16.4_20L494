...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000d1d7
...
- (id)messageContent;	// IMP=0x000000000000d3a4
@property(readonly, copy, nonatomic) NSDictionary *dictionaryValue;
- (id)initWithMetadata:(id)arg1 message:(id)arg2;	// IMP=0x000000000000d03a
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000000cfa9
