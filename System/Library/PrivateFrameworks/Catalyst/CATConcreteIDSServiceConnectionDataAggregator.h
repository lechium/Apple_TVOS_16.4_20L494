...
+ (id)missingContentTimerIdentifier;	// IMP=0x001000000000bfca
...
- (id)description;	// IMP=0x000000000000c024
- (void)dataAggregationCompleted:(id)arg1;	// IMP=0x000000000000be38
- (void)missingContentTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x000000000000bd68
- (void)updateMissingContentTrackingForDataContent:(id)arg1;	// IMP=0x000000000000ba02
- (void)updateExistingDataWindowWithContent:(id)arg1;	// IMP=0x000000000000b8cc
- (void)processNewDataWindowWithContent:(id)arg1;	// IMP=0x000000000000b7dd
- (void)receiveExpectedSequenceNumber:(unsigned long long)arg1;	// IMP=0x000000000000b701
- (void)receiveDataContent:(id)arg1;	// IMP=0x000000000000b5dd
@property(readonly, nonatomic) unsigned long long receivedSequenceNumber;
- (id)missingSequenceNumbers;	// IMP=0x000000000000b534
- (id)initWithWorkQueue:(id)arg1 timerSource:(id)arg2 missingItemInterval:(double)arg3 supportsSequenceCorrection:(_Bool)arg4;	// IMP=0x000000000000b44e
