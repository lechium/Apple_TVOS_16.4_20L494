...
- (void).cxx_destruct;	// IMP=0x000000000001f34f
...
- (void)didFailWithError:(id)arg1;	// IMP=0x000000000001f2eb
- (void)didSendData;	// IMP=0x000000000001f2d7
- (void)didEncodeData:(id)arg1;	// IMP=0x000000000001f201
- (void)main;	// IMP=0x000000000001ef37
- (_Bool)isAsynchronous;	// IMP=0x000000000001ef2f
