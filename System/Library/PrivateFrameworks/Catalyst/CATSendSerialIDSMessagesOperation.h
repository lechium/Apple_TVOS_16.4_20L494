...
- (void)didSendMessagesWithError:(id)arg1;	// IMP=0x0000000000022a6d
- (void)sendMessages;	// IMP=0x0000000000022598
- (void)main;	// IMP=0x0000000000022586
- (_Bool)isAsynchronous;	// IMP=0x000000000002257e
- (id)initWithIDSPrimitives:(id)arg1 workQueue:(id)arg2 messages:(id)arg3 destinationAddress:(id)arg4 sourceAppleID:(id)arg5 options:(id)arg6;	// IMP=0x00000000000223ee
