...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000041e8e
- (void).cxx_destruct;	// IMP=0x0000000000041f04
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x0000000000041d51
