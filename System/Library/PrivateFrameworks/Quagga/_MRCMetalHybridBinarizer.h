...
- (void).cxx_destruct;	// IMP=0x000000000004d472
- (id)newTextureByBinarizingPixelBuffer:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000004cc80
- (id)initWithMetalContext:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004cb0e
- (id)init;	// IMP=0x000000000004caf8
