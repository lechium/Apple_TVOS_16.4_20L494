...
- (id)correctedString;	// IMP=0x000000000002d6df
- (id)correctionResult;	// IMP=0x000000000002d6d5
- (id)description;	// IMP=0x000000000002d66e
- (void)dealloc;	// IMP=0x000000000002d624
- (id)initWithCorrectionResult:(id)arg1 correctedString:(id)arg2;	// IMP=0x000000000002d5a6
