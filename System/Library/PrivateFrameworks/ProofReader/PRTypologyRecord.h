...
+ (void)setTypologyRecordsLimit:(unsigned long long)arg1;	// IMP=0x006000000001b2ff
+ (void)resetTypologyRecords;	// IMP=0x006000000001b265
+ (void)writeTypologyRecords;	// IMP=0x006000000001aff3
+ (id)currentTypologyRecord;	// IMP=0x006000000001a8fb
+ (id)openTypologyRecordWithString:(id)arg1 range:(struct _NSRange)arg2 languageObject:(id)arg3 languages:(id)arg4 topLanguages:(id)arg5 autocorrect:(_Bool)arg6 initialCapitalize:(_Bool)arg7 autocapitalize:(_Bool)arg8 keyEventArray:(id)arg9 appIdentifier:(id)arg10 selectedRangeValue:(id)arg11;	// IMP=0x006000000001a66b
- (void)closeTypologyRecordWithResults:(id)arg1;	// IMP=0x000000000001b39e
- (id)dictionaryRepresentation;	// IMP=0x000000000001aaa2
- (void)addCandidate:(id)arg1;	// IMP=0x000000000001aa81
- (void)addCorrection:(id)arg1;	// IMP=0x000000000001aa60
- (void)dealloc;	// IMP=0x000000000001a5e9
- (id)initWithString:(id)arg1 offset:(unsigned long long)arg2 range:(struct _NSRange)arg3 languageObject:(id)arg4 languages:(id)arg5 topLanguages:(id)arg6 autocorrect:(_Bool)arg7 initialCapitalize:(_Bool)arg8 autocapitalize:(_Bool)arg9 keyEventArray:(id)arg10 appIdentifier:(id)arg11 selectedRangeValue:(id)arg12;	// IMP=0x000000000001a4be
