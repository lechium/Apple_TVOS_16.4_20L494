...
- (void).cxx_destruct;	// IMP=0x00000000000112d3
...
- (id)urlToAudioForSegment:(id)arg1;	// IMP=0x0000000000011172
- (id)urlToAudioContainerForSegmentType:(unsigned long long)arg1;	// IMP=0x000000000001110f
- (id)urlToRoot;	// IMP=0x00000000000110ac
- (id)initWithFolderPath:(id)arg1;	// IMP=0x000000000001102c
