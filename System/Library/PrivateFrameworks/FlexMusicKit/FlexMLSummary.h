...
+ (id)summaryFromSummaries:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x006000000001459f
...
- (id)initWithDictionary:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x0000000000015dae
