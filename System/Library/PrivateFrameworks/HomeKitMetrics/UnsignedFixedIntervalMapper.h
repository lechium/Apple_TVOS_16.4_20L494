...
- (void).cxx_destruct;	// IMP=0x000000000000209f
...
- (id)intervalForValue:(unsigned long long)arg1;	// IMP=0x0000000000001fcb
- (id)intervalIndexForValue:(unsigned long long)arg1;	// IMP=0x0000000000001e3f
- (id)initWithBins:(id)arg1 intervalCreationBlock:(CDUnknownBlockType)arg2 valueComparisonBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000001b68
