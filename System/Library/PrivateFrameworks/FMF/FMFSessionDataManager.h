...
+ (id)sharedInstance;	// IMP=0x006000000000cf35
- (void).cxx_destruct;	// IMP=0x000000000000dcd5
...
- (id)favoritesOrdered;	// IMP=0x000000000000db6d
- (void)abPreferencesDidChange;	// IMP=0x000000000000daae
- (void)abDidChange;	// IMP=0x000000000000d9ef
- (id)offerExpirationForHandle:(id)arg1 groupId:(id)arg2;	// IMP=0x000000000000d893
- (id)locationForHandle:(id)arg1;	// IMP=0x000000000000d653
- (id)followingForHandle:(id)arg1;	// IMP=0x000000000000d5d0
- (id)followerForHandle:(id)arg1;	// IMP=0x000000000000d54d
