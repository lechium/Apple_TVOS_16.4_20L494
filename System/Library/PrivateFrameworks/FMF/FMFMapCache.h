...
- (void).cxx_destruct;	// IMP=0x000000000001b2af
...
- (double)pruneIntervalInSeconds;	// IMP=0x000000000001b034
- (double)cacheExpiryInSeconds;	// IMP=0x000000000001af40
- (id)noLocationKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ae3e
- (id)gridKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ad3c
- (void)pruneCacheIfNeeded;	// IMP=0x000000000001a6a4
- (void)flushCache;	// IMP=0x000000000001a43a
- (void)saveMetaData;	// IMP=0x0000000000019e3f
- (void)readMetaData;	// IMP=0x00000000000198c7
- (_Bool)pendingMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x0000000000019819
- (_Bool)pendingMapImageForRequest:(id)arg1;	// IMP=0x00000000000194df
- (void)cacheMapImage:(id)arg1 forLocation:(id)arg2 altitude:(double)arg3 pitch:(double)arg4 width:(double)arg5 andHeight:(double)arg6;	// IMP=0x000000000001941e
- (void)cacheMapImage:(id)arg1 forRequest:(id)arg2;	// IMP=0x0000000000018dac
- (id)cachedMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x0000000000018cf2
- (id)cachedMapImageForRequest:(id)arg1;	// IMP=0x0000000000018b7a
- (void)cacheNoLocationImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x000000000001871b
- (id)cachedNoLocationImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x00000000000185c0
- (void)cacheGridImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x0000000000018161
- (id)cachedGridImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x0000000000018006
- (id)init;	// IMP=0x0000000000017aff
