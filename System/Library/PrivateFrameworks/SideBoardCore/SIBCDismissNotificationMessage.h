...
+ (id)messageId;	// IMP=0x001000000000cdbb
- (void).cxx_destruct;	// IMP=0x000000000000ce99
...
- (id)initWithEncodedDictionary:(id)arg1;	// IMP=0x000000000000ca4a
- (id)dictionaryEncoding;	// IMP=0x000000000000ca42
