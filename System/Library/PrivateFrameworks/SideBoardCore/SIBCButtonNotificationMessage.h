...
+ (id)messageId;	// IMP=0x00100000000089dd
- (void).cxx_destruct;	// IMP=0x0000000000008ac3
...
- (id)initWithEncodedDictionary:(id)arg1;	// IMP=0x000000000000854a
- (id)dictionaryEncoding;	// IMP=0x0000000000008542
