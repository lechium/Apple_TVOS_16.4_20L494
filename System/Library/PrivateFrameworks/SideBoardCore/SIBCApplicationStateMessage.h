...
+ (id)messageId;	// IMP=0x001000000000c872
...
- (id)initWithEncodedDictionary:(id)arg1;	// IMP=0x000000000000c864
- (id)dictionaryEncoding;	// IMP=0x000000000000c785
- (id)initWithApplication:(id)arg1 state:(id)arg2;	// IMP=0x000000000000c6bc
