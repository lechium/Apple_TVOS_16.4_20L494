...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006f4a5
- (unsigned long long)hash;	// IMP=0x000000000006f466
- (id)description;	// IMP=0x000000000006f418
- (void)dealloc;	// IMP=0x000000000006f3ce
