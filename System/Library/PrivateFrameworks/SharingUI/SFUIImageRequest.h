...
- (void).cxx_destruct;	// IMP=0x00000000000094b3
...
- (id)initWithRequestID:(int)arg1 identifier:(id)arg2 synchronous:(_Bool)arg3 resultHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000093c3
