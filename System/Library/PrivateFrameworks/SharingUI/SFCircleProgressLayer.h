...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x006000000000a343
- (void).cxx_destruct;	// IMP=0x000000000000a72f
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000000a404
- (id)initWithLayer:(id)arg1;	// IMP=0x000000000000a156
- (id)init;	// IMP=0x000000000000a021
