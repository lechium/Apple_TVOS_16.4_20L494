...
- (void).cxx_destruct;	// IMP=0x00000000000e9919
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000e97be
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x00000000000e975f
- (id)initWithDaemonController:(id)arg1 synchronousReplies:(_Bool)arg2;	// IMP=0x00000000000e9728
