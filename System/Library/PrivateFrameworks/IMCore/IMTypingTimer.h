...
+ (_Bool)shouldAdjustTimeoutIntervalForBeginDate;	// IMP=0x00600000000678df
- (void).cxx_destruct;	// IMP=0x0000000000067ce1
...
- (void)invalidate;	// IMP=0x0000000000067be2
- (void)triggerTimeout;	// IMP=0x0000000000067b45
- (void)timerCallback;	// IMP=0x0000000000067ab0
- (id)initWithHandle:(id)arg1 beginDate:(id)arg2 timeoutInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x00000000000678e7
