...
- (void).cxx_destruct;	// IMP=0x000000000001a123
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0000000000019d7d
- (id)initWithURL:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x0000000000019d0f
