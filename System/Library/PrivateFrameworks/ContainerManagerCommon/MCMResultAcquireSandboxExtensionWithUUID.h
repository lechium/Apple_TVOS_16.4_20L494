...
- (void).cxx_destruct;	// IMP=0x000000000006f06b
...
- (void)dealloc;	// IMP=0x000000000006ef33
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000006ede1
- (id)initWithSandboxToken:(const char *)arg1 personaUniqueString:(id)arg2 url:(id)arg3;	// IMP=0x000000000006ece3
