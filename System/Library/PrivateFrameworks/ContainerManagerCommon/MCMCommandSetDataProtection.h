...
+ (Class)incomingMessageClass;	// IMP=0x001000000009d908
+ (unsigned long long)command;	// IMP=0x001000000009d8d2
- (void).cxx_destruct;	// IMP=0x000000000009d697
...
- (void)execute;	// IMP=0x000000000009ce63
- (_Bool)preflightClientAllowed;	// IMP=0x000000000009cdca
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000009ccc5
