...
+ (Class)incomingMessageClass;	// IMP=0x0010000000073ab7
+ (unsigned long long)command;	// IMP=0x0010000000073a81
- (void).cxx_destruct;	// IMP=0x0000000000073a43
...
- (void)execute;	// IMP=0x00000000000734da
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000073441
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000007334f
