...
- (void).cxx_destruct;	// IMP=0x000000000003978c
...
- (unsigned int)disposition;	// IMP=0x000000000003964f
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x00000000000390d7
