...
- (void).cxx_destruct;	// IMP=0x000000000008e8ae
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008e618
- (id)clientConnectionContextForCurrentThread;	// IMP=0x000000000008e57b
- (id)initForCurrentThreadContextWithXPCConnection:(id)arg1 userIdentityCache:(id)arg2;	// IMP=0x000000000008e499
