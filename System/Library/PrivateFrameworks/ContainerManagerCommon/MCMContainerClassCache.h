...
- (void).cxx_destruct;	// IMP=0x000000000004194d
...
- (void)_handleUnrecoverableCorruptContainerPath:(id)arg1;	// IMP=0x0000000000041440
- (id)_setEntry:(id)arg1 forIdentifier:(id)arg2 writeThrough:(_Bool)arg3;	// IMP=0x00000000000411f5
- (id)_concurrent_generateCacheEntryWithURL:(id)arg1 identifier:(id)arg2 containerPath:(id)arg3 schemaVersion:(id)arg4 uuid:(id)arg5 metadata:(id)arg6;	// IMP=0x00000000000410cb
- (id)_concurrent_slowGenerateCacheEntryWithFD:(int)arg1 URL:(id)arg2 identifier:(id)arg3 uuid:(id)arg4 schemaVersion:(id)arg5 containerPath:(id)arg6;	// IMP=0x0000000000040c60
- (void)_concurrent_processCorruptEntry:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000408cb
- (void)_concurrent_processURL:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000004054e
- (void)_processCorruptEntries:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000004048b
- (void)_processURLs:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000403c8
- (void)_queue_syncWithDisk;	// IMP=0x000000000003f785
- (_Bool)_checkExistanceOfCacheEntry:(id)arg1 libraryRepair:(id)arg2;	// IMP=0x000000000003f60e
- (void)forceWriteThrough;	// IMP=0x000000000003f4cf
- (void)asyncStartSynchronization;	// IMP=0x000000000003f3f0
- (void)flush;	// IMP=0x000000000003f32c
- (void)waitForSynchronizationToComplete;	// IMP=0x000000000003f2dd
- (_Bool)enumerateCacheEntriesWithEnumerator:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f059
- (id)setCacheEntry:(id)arg1 forIdentifier:(id)arg2 writeThrough:(_Bool)arg3;	// IMP=0x000000000003eec1
- (id)setCacheEntry:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x000000000003ee7e
- (id)cacheEntryForIdentifier:(id)arg1;	// IMP=0x000000000003ed03
- (id)initWithContainerClassPath:(id)arg1 cacheEntryClass:(Class)arg2 targetQueue:(id)arg3 userIdentityCache:(id)arg4;	// IMP=0x000000000003ea72
