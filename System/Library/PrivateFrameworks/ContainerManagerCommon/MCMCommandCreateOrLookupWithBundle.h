...
+ (Class)incomingMessageClass;	// IMP=0x00100000000947a3
+ (unsigned long long)command;	// IMP=0x001000000009476d
...
- (void)execute;	// IMP=0x0000000000093d75
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000093d42
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000093bd1
