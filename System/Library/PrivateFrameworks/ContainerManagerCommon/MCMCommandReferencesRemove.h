...
+ (Class)incomingMessageClass;	// IMP=0x00100000000366e2
+ (unsigned long long)command;	// IMP=0x00100000000366ac
- (void).cxx_destruct;	// IMP=0x0000000000036603
...
- (void)execute;	// IMP=0x0000000000035b21
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000035a88
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000035953
