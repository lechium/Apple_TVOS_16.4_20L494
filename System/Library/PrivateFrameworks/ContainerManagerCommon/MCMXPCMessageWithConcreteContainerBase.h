...
- (void).cxx_destruct;	// IMP=0x000000000007205a
...
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000071d84
- (id)initWithConcreteContainer:(id)arg1 context:(id)arg2;	// IMP=0x0000000000071ce9
