...
- (void).cxx_destruct;	// IMP=0x00000000000c015b
...
- (id)description;	// IMP=0x00000000000bfd7d
- (unsigned long long)hash;	// IMP=0x00000000000bfc2a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bf924
- (id)serialize;	// IMP=0x00000000000bf663
- (id)initWithSerializedDictionary:(id)arg1;	// IMP=0x00000000000bf438
- (id)initWithCodeSigningInfo:(id)arg1;	// IMP=0x00000000000bf3f9
- (id)initWithCodeSigningInfo:(id)arg1 andDataContainerClass:(unsigned long long)arg2;	// IMP=0x00000000000bf343
