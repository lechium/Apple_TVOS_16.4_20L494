...
+ (Class)incomingMessageClass;	// IMP=0x001000000004c76a
+ (unsigned long long)command;	// IMP=0x001000000004c734
- (void).cxx_destruct;	// IMP=0x000000000004c6cf
...
- (void)execute;	// IMP=0x000000000004b441
- (_Bool)preflightClientAllowed;	// IMP=0x000000000004b3a8
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000004b292
