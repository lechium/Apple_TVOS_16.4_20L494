...
- (void).cxx_destruct;	// IMP=0x00000000000728f9
- (id)init;	// IMP=0x0000000000072835
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000724e0
- (void)addOwner:(id)arg1 group:(id)arg2;	// IMP=0x0000000000072359
