...
- (void).cxx_destruct;	// IMP=0x000000000009e752
@property(retain, nonatomic) RBSTerminationAssertion *termAssertion; // @synthesize termAssertion=_termAssertion;
- (void)dealloc;	// IMP=0x000000000009e654
- (void)invalidate;	// IMP=0x000000000009e58b
- (id)initWithBundleIdentifier:(id)arg1 reason:(id)arg2;	// IMP=0x000000000009ded0
