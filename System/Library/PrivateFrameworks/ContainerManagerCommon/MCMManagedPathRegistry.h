...
- (void).cxx_destruct;	// IMP=0x00000000000389a7
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x000000000003816f
- (void)_addPaths:(id)arg1;	// IMP=0x0000000000038116
- (id)managedPathForURL:(id)arg1;	// IMP=0x0000000000037f3d
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x0000000000037bab
- (id)initWithDaemonUser:(id)arg1 privileged:(_Bool)arg2;	// IMP=0x0000000000037a14
