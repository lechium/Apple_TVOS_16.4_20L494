...
- (void).cxx_destruct;	// IMP=0x000000000008e214
...
- (unsigned int)disposition;	// IMP=0x000000000008dcd7
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000008d2d5
