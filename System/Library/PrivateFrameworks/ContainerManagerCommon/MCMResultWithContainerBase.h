...
- (void).cxx_destruct;	// IMP=0x0000000000093b17
...
- (void)dealloc;	// IMP=0x00000000000937c5
- (id)initWithMetadata:(id)arg1 sandboxToken:(const char *)arg2 includePath:(_Bool)arg3 includeInfo:(_Bool)arg4 resolvedLinks:(id)arg5;	// IMP=0x00000000000934e0
- (id)initWithContainerPath:(id)arg1 containerIdentity:(id)arg2 uuid:(id)arg3 sandboxToken:(const char *)arg4 includePath:(_Bool)arg5;	// IMP=0x00000000000932c1
- (id)initWithUUID:(id)arg1 containerPathIdentifier:(id)arg2 identifier:(id)arg3 containerClass:(unsigned long long)arg4 POSIXUser:(id)arg5 personaUniqueString:(id)arg6 sandboxToken:(const char *)arg7 existed:(_Bool)arg8 url:(id)arg9 info:(id)arg10 resolvedLinks:(id)arg11 transient:(_Bool)arg12;	// IMP=0x00000000000930a3
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x0000000000092b31
