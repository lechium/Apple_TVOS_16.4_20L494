...
+ (Class)incomingMessageClass;	// IMP=0x0010000000013f38
+ (unsigned long long)command;	// IMP=0x0010000000013f02
- (void).cxx_destruct;	// IMP=0x0000000000013cc4
...
- (id)_resolveUserIdentity;	// IMP=0x000000000001394e
- (void)execute;	// IMP=0x0000000000012def
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000012d56
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000012c11
