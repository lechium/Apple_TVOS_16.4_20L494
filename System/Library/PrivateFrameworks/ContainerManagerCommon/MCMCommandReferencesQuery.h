...
+ (Class)incomingMessageClass;	// IMP=0x00100000000689ed
+ (unsigned long long)command;	// IMP=0x00100000000689b7
- (void).cxx_destruct;	// IMP=0x000000000006878b
...
- (void)execute;	// IMP=0x0000000000068248
- (_Bool)preflightClientAllowed;	// IMP=0x00000000000681af
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000068091
