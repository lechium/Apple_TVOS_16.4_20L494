...
+ (Class)incomingMessageClass;	// IMP=0x0010000000069ee2
+ (unsigned long long)command;	// IMP=0x0010000000069eac
...
- (void)execute;	// IMP=0x0000000000069c8f
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000069c20
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000069a8f
