...
- (void).cxx_destruct;	// IMP=0x0000000000073027
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000072cb1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000072c21
- (_Bool)isEqualToManagedPath:(id)arg1;	// IMP=0x0000000000072bdc
@property(readonly) unsigned long long hash;
- (id)managedPathByAppendingPathComponent:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6;	// IMP=0x0000000000072a78
- (id)initWithURL:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6 parent:(id)arg7;	// IMP=0x000000000007295e
