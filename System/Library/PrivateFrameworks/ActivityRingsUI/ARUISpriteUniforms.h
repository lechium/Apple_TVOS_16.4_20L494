...
- (void)_updateUniformsWithSprite:(id)arg1;	// IMP=0x000000000000f0d8
- (void)_updateVertexAttributesWithSprite:(id)arg1 inContet:(id)arg2;	// IMP=0x000000000000ee53
- (void *)uniformsBytes;	// IMP=0x000000000000ee49
- (void *)vertexAttributesBytes;	// IMP=0x000000000000ee3f
- (id)initWithSprite:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000000ed9e
