...
- (void)_updateUniformsWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001e357
- (void)_updateVertexAttributesWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001df4b
- (void *)uniformsBytes;	// IMP=0x000000000001df3e
- (void *)vertexAttributesBytes;	// IMP=0x000000000001df34
- (id)initWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001de90
