...
+ (id)animationWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x001000000000f185
- (void).cxx_destruct;	// IMP=0x000000000000f506
...
- (void)completeAnimation;	// IMP=0x000000000000f433
- (_Bool)isAnimating;	// IMP=0x000000000000f41c
- (void)update:(double)arg1;	// IMP=0x000000000000f35a
- (void)dealloc;	// IMP=0x000000000000f2fc
- (id)initWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x000000000000f21b
