...
+ (id)animationWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x0010000000013eca
- (void).cxx_destruct;	// IMP=0x0000000000014222
...
- (void)completeAnimation;	// IMP=0x000000000001414f
- (_Bool)isAnimating;	// IMP=0x0000000000014138
- (void)update:(double)arg1;	// IMP=0x000000000001409f
- (void)dealloc;	// IMP=0x0000000000014041
- (id)initWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x0000000000013f60
