...
- (void).cxx_destruct;	// IMP=0x00000000000698b6
...
- (id)bundleAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000693a1
- (id)bundleURLFromAssetURL:(id)arg1;	// IMP=0x00000000000690e2
- (void)completeWithBundle:(id)arg1 isFallback:(_Bool)arg2 isCached:(_Bool)arg3;	// IMP=0x0000000000068953
- (_Bool)completeIfPossible;	// IMP=0x0000000000068421
- (void)cancelTimeout;	// IMP=0x00000000000683d7
- (_Bool)updateTaskWithBundle:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x00000000000681e0
- (_Bool)updateTaskWithAssetBundleURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006812a
- (_Bool)updateTaskWithAssetURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x0000000000068097
- (void)createQueryParameters;	// IMP=0x0000000000067d6f
- (id)initWithDeviceQuery:(id)arg1 requestConfiguration:(id)arg2 dispatchQueue:(id)arg3 useProcessLocalCache:(_Bool)arg4;	// IMP=0x0000000000067a2a
