...
- (void)_addCollaborationItem:(id)arg1;	// IMP=0x00000000000f2060
- (void)_processRemainingActivityItems;	// IMP=0x00000000000f1c2e
- (id)collaborationService;	// IMP=0x00000000000f1bcf
- (void)cancel;	// IMP=0x00000000000f1bbb
- (void)perform;	// IMP=0x00000000000f1ba9
- (id)initWithActivityItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f1a30
