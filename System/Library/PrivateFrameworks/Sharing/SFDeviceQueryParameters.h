...
- (void).cxx_destruct;	// IMP=0x0000000000067a1a
...
- (unsigned long long)hash;	// IMP=0x000000000006794b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000067790
- (id)description;	// IMP=0x0000000000067663
- (id)maAssetQueryDescription;	// IMP=0x00000000000674ba
- (id)initWithDeviceAssetQuery:(id)arg1 installedOnly:(_Bool)arg2 imperfectMatch:(_Bool)arg3 fallback:(_Bool)arg4;	// IMP=0x0000000000067374
