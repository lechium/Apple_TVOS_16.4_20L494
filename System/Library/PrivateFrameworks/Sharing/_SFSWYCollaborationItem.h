...
- (void).cxx_destruct;	// IMP=0x000000000005503b
...
- (void)_loadOptionsIfNeeded;	// IMP=0x0000000000054fce
- (id)initWithItemProvider:(id)arg1 activityItem:(id)arg2;	// IMP=0x0000000000054dc5
