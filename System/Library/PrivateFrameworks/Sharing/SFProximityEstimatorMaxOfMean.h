...
- (int)_estimateRSSIForSFBLEDevice:(id)arg1;	// IMP=0x00000000000eb5b3
- (id)description;	// IMP=0x00000000000eb4c4
- (void)dealloc;	// IMP=0x00000000000eb455
- (id)initWithProximityInfo:(id)arg1;	// IMP=0x00000000000eb341
