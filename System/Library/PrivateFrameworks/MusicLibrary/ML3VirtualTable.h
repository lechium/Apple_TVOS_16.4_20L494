...
- (id).cxx_construct;	// IMP=0x000000000014cd03
- (void).cxx_destruct;	// IMP=0x000000000014ccb3
...
- (_Bool)unregister;	// IMP=0x000000000014ca54
- (_Bool)registerWithConnection:(id)arg1;	// IMP=0x000000000014c77d
@property(readonly, nonatomic) NSString *name;
- (void)dealloc;	// IMP=0x000000000014c6fc
- (id)initWithDatabaseTable:(id)arg1;	// IMP=0x000000000014c57a
