...
- (void).cxx_destruct;	// IMP=0x0000000000150364
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001501e7
- (unsigned long long)hash;	// IMP=0x0000000000150182
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014ffe3
- (id)description;	// IMP=0x000000000014ff2c
- (id)initWithAlbumArtistPersistentID:(long long)arg1 groupingKey:(id)arg2 feedURL:(id)arg3 seasonNumber:(long long)arg4 compilation:(_Bool)arg5;	// IMP=0x000000000014fe55
