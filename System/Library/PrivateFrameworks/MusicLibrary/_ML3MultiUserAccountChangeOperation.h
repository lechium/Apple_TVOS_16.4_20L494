...
- (void).cxx_destruct;	// IMP=0x00000000000bc61f
...
- (void)execute;	// IMP=0x00000000000bc4b9
- (id)initWithDatabasePath:(id)arg1 accountChangeObserver:(id)arg2;	// IMP=0x00000000000bc40b
