...
- (void).cxx_destruct;	// IMP=0x0000000000094c41
- (id)nextObject;	// IMP=0x0000000000094a42
- (id)initWithDirtyInsertsEnumerator:(id)arg1 connection:(id)arg2;	// IMP=0x00000000000949a0
