...
- (void).cxx_destruct;	// IMP=0x00000000004ab1b0
@property(readonly) NSObject<OS_nw_path_flow> *internalPathFlow; // @synthesize internalPathFlow=_internalPathFlow;
- (id)privateDescription;	// IMP=0x00000000004ab160
- (id)description;	// IMP=0x00000000004ab140
- (id)descriptionWithIndent:(int)arg1 showFullContent:(_Bool)arg2;	// IMP=0x00000000004aad50
...
- (id)initWithPathFlow:(id)arg1;	// IMP=0x00000000004aa3a0
