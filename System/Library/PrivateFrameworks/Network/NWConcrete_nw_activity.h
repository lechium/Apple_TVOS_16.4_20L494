...
- (id).cxx_construct;	// IMP=0x0000000000580f20
- (void).cxx_destruct;	// IMP=0x0000000000580ed0
- (id)redactedDescription;	// IMP=0x0000000000580be0
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000580a70
