...
- (void).cxx_destruct;	// IMP=0x00000000002b58b0
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b51d0
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000002b42f0
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000002b3a10
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000002b2a80
- (void)dealloc;	// IMP=0x00000000002b2a50
- (id)init;	// IMP=0x00000000002b27d0
