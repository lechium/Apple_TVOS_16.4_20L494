...
- (void).cxx_destruct;	// IMP=0x00000000006e3080
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000006e29a0
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000006e2490
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000006e1ed0
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000006e1650
- (void)dealloc;	// IMP=0x00000000006e1620
- (id)init;	// IMP=0x00000000006e13a0
