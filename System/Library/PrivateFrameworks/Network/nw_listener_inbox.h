...
- (void).cxx_destruct;	// IMP=0x000000000064d7f0
...
- (_Bool)cancel;	// IMP=0x000000000064d550
- (_Bool)resume;	// IMP=0x000000000064d420
- (_Bool)isSuspended;	// IMP=0x000000000064d410
- (_Bool)suspend;	// IMP=0x000000000064d2e0
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000064d030
- (id)start;	// IMP=0x000000000064d020
