...
- (void).cxx_destruct;	// IMP=0x0000000000005f78
@property(retain, nonatomic) BRLTSLoopbackTranslationService *loopbackService; // @synthesize loopbackService=_loopbackService;
- (_Bool)isLoopback;	// IMP=0x0000000000005f4b
- (id)initWithServiceIdentifier:(id)arg1 connection:(id)arg2 loopbackService:(id)arg3;	// IMP=0x0000000000005ec9
