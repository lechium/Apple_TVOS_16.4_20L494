...
+ (id)sharedResource;	// IMP=0x0060000000036f04
...
- (void)purge;	// IMP=0x0000000000037042
- (long long)inactiveCost;	// IMP=0x0000000000037009
- (long long)activeCost;	// IMP=0x0000000000036fcf
