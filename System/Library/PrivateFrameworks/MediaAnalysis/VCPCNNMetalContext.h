...
+ (_Bool)supportVectorForward;	// IMP=0x006000000024215f
+ (_Bool)supportGPU;	// IMP=0x0060000000242157
- (void).cxx_destruct;	// IMP=0x00000000002421e9
...
- (int)execute;	// IMP=0x0000000000242175
- (id)initNewContext:(_Bool)arg1;	// IMP=0x0000000000242167
