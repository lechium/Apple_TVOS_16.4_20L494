...
+ (_Bool)isLivePhotoKeyFrameEnabled;	// IMP=0x00600000000a93fc
- (void).cxx_destruct;	// IMP=0x00000000000ab6be
...
- (void)printStats;	// IMP=0x00000000000ab361
- (_Bool)hasGoodSubjectAction;	// IMP=0x00000000000ab335
- (float)computeScoreFromExposure;	// IMP=0x00000000000ab302
- (float)computeScoreFromColorfulness;	// IMP=0x00000000000ab2d8
- (float)computeExpressionScore;	// IMP=0x00000000000aafd4
- (float)computeScoreFromAction;	// IMP=0x00000000000aaf8d
- (void)computeCurationScore;	// IMP=0x00000000000aaefc
- (void)computeCurationScoreComponents;	// IMP=0x00000000000aae72
- (void)storeFrameResults;	// IMP=0x00000000000aa57f
- (float)computePenaltyScore;	// IMP=0x00000000000aa1f9
- (float)computeContentScore;	// IMP=0x00000000000aa191
- (float)computeVisualPleasingScore;	// IMP=0x00000000000aa127
- (float)computeGlobalQuality;	// IMP=0x00000000000aa0b0
- (void)computeGlobalQualityForLivePhoto;	// IMP=0x00000000000aa062
- (void)setMotionStatsFlag:(_Bool)arg1 cameraMotion:(float)arg2 subjectAction:(float)arg3 interestingness:(float)arg4 obstruction:(float)arg5 colorfulness:(float)arg6 exposureScore:(float)arg7 humanActionStatsFlag:(_Bool)arg8 humanPoseScore:(float)arg9 humanActionScore:(float)arg10 subMb:(_Bool)arg11;	// IMP=0x00000000000aa001
- (void)setFaceStatsFlag:(_Bool)arg1 detectedFaces:(id)arg2;	// IMP=0x00000000000a9e5c
- (void)resetStatsFlag;	// IMP=0x00000000000a9e4e
- (int)loadKeyFrameResult:(id)arg1 timestamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000000a95e7
- (void)copyFrom:(id)arg1;	// IMP=0x00000000000a9404
- (id)initWithLivePhoto:(_Bool)arg1;	// IMP=0x00000000000a929f
