...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x00100000001aa775
- (void).cxx_destruct;	// IMP=0x000000000000cb88
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000ca36
- (unsigned long long)hash;	// IMP=0x000000000000c666
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c52e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c440
- (void)copyTo:(id)arg1;	// IMP=0x000000000000c38c
- (void)writeTo:(id)arg1;	// IMP=0x000000000000c2c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000c2b8
- (id)dictionaryRepresentation;	// IMP=0x000000000000bd5e
- (id)description;	// IMP=0x000000000000bcaf
...
- (id)exportToLegacyDictionary;	// IMP=0x00000000001aaa43
