...
- (void).cxx_destruct;	// IMP=0x00000000002193ba
...
- (int)analyzeFrame:(struct __CVBuffer *)arg1 withFaceRect:(struct CGRect)arg2 withRotation:(int)arg3 withTimestamp:(CDStruct_1b6d18a9)arg4;	// IMP=0x0000000000219356
- (_Bool)isTracked;	// IMP=0x000000000021934e
- (_Bool)updateFocalLengthInPixels:(float)arg1;	// IMP=0x0000000000219346
- (id)initWithFocalLengthInPixels:(float)arg1 offline:(_Bool)arg2 isFastMode:(_Bool)arg3;	// IMP=0x0000000000219338
