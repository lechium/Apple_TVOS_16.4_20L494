...
- (void).cxx_destruct;	// IMP=0x000000000022463c
@property(readonly, retain, nonatomic) NSArray *results;
- (int)finalizeAnalysis;	// IMP=0x0000000000224597
- (void)addSegmentToResults;	// IMP=0x000000000022436a
- (int)processFrameMetadata:(id)arg1;	// IMP=0x0000000000224160
- (id)init;	// IMP=0x000000000022407a
