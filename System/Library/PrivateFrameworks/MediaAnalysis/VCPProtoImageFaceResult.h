...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x00100000000227d2
- (void).cxx_destruct;	// IMP=0x0000000000073b08
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000007396a
- (unsigned long long)hash;	// IMP=0x00000000000737ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000073694
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000735b2
- (void)copyTo:(id)arg1;	// IMP=0x000000000007350a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000073435
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000073428
- (id)dictionaryRepresentation;	// IMP=0x0000000000072d12
- (id)description;	// IMP=0x0000000000072c63
@property(nonatomic) _Bool hasFaceQuality;
- (id)exportToLegacyDictionary;	// IMP=0x0000000000022b39
