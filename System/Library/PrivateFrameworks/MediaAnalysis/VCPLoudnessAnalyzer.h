...
- (id).cxx_construct;	// IMP=0x00000000000f01f3
- (void).cxx_destruct;	// IMP=0x00000000000f0195
- (id)results;	// IMP=0x00000000000f011f
- (int)finalizeAnalysisAtTime:(const CDStruct_1b6d18a9 *)arg1;	// IMP=0x00000000000efa1e
- (int)processAudioSamples:(struct AudioBufferList *)arg1 timestamp:(struct AudioTimeStamp)arg2;	// IMP=0x00000000000ef4d4
- (void)dealloc;	// IMP=0x00000000000ef45c
- (int)setupWithSample:(struct opaqueCMSampleBuffer *)arg1 andSampleBatchSize:(int)arg2;	// IMP=0x00000000000ef2ef
- (id)init;	// IMP=0x00000000000ef24a
