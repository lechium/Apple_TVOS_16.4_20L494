...
+ (unsigned long long)flagsFromKeypoints:(id)arg1 withMinConfidence:(float)arg2;	// IMP=0x00600000000f6a0d
- (void).cxx_destruct;	// IMP=0x00000000000f6cc3
...
- (id)init;	// IMP=0x00000000000f69a0
