...
- (void).cxx_destruct;	// IMP=0x00000000000a0fdc
...
- (void)checkAutoPlayable;	// IMP=0x00000000000a0d42
- (void)copyScoresFrom:(id)arg1;	// IMP=0x00000000000a0bdb
- (_Bool)isShort;	// IMP=0x00000000000a0b90
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000a0691
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1;	// IMP=0x00000000000a060c
