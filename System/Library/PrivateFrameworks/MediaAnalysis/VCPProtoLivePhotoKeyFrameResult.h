...
+ (Class)faceResultsType;	// IMP=0x001000000001fdc9
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x001000000001c81a
- (void).cxx_destruct;	// IMP=0x0000000000022056
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000021c8b
- (unsigned long long)hash;	// IMP=0x00000000000212d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000210d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020e2b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000020c92
- (void)writeTo:(id)arg1;	// IMP=0x0000000000020a25
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000020a18
- (id)dictionaryRepresentation;	// IMP=0x000000000001ff1b
- (id)description;	// IMP=0x000000000001fe6c
@property(nonatomic) _Bool hasContentScore;
@property(nonatomic) _Bool hasGlobalQualityScore;
- (id)faceResultsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000001fdac
- (unsigned long long)faceResultsCount;	// IMP=0x000000000001fd8f
- (void)addFaceResults:(id)arg1;	// IMP=0x000000000001fd25
- (void)clearFaceResults;	// IMP=0x000000000001fd08
- (id)exportToLegacyDictionary;	// IMP=0x000000000001cf8c
