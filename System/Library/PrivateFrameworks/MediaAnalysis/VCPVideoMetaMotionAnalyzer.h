...
- (id).cxx_construct;	// IMP=0x0000000000074ae6
- (void).cxx_destruct;	// IMP=0x0000000000074aaa
@property(readonly, retain, nonatomic) NSArray *results;
- (int)finalizeAnalysis;	// IMP=0x000000000007463b
- (void)mergeSimilarSegments;	// IMP=0x00000000000744c5
- (int)processFrameMetadata:(id)arg1;	// IMP=0x0000000000074230
- (_Bool)decideSegmentPointBasedOn:(float)arg1;	// IMP=0x000000000007419a
- (id)init;	// IMP=0x0000000000074063
