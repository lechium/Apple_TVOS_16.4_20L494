...
+ (void)unimplementedExceptionForMethodName:(id)arg1;	// IMP=0x0080000000261d6c
- (id)typeDescription;	// IMP=0x0000000000261eef
...
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1 orientation:(unsigned int *)arg2;	// IMP=0x00000000002620d3
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1;	// IMP=0x00000000002620af
...
- (struct CGSize)originalMovieSize;	// IMP=0x0000000000262309
- (id)originalMovie;	// IMP=0x00000000002622e5
- (id)streamedMovie;	// IMP=0x00000000002622dd
- (_Bool)isMovieResourceLocalAvailable;	// IMP=0x00000000002622b9
- (id)movie;	// IMP=0x0000000000262295
