...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000252d08
- (void)mergeSegment:(id)arg1;	// IMP=0x0000000000252c09
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000252b85
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000252b1b
- (id)init;	// IMP=0x0000000000252aa7
