...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000084e6e
- (void)mergeSegment:(id)arg1;	// IMP=0x0000000000084d6f
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000084ceb
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000084c81
- (id)init;	// IMP=0x0000000000084c0d
