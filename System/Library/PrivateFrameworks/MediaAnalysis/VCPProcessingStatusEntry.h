...
+ (id)entryWithLocalIdentifier:(id)arg1 andTaskID:(unsigned long long)arg2 andStatus:(unsigned long long)arg3 andAttempts:(unsigned long long)arg4 andLastRetryDate:(id)arg5;	// IMP=0x00600000000b9dc2
- (void).cxx_destruct;	// IMP=0x00000000000b9e8e
...
- (id)initWithLocalIdentifier:(id)arg1 andTaskID:(unsigned long long)arg2 andStatus:(unsigned long long)arg3 andAttempts:(unsigned long long)arg4 andLastRetryDate:(id)arg5;	// IMP=0x00000000000b9d01
