...
- (id).cxx_construct;	// IMP=0x00000000000765d8
- (void).cxx_destruct;	// IMP=0x000000000007656b
...
- (void)dealloc;	// IMP=0x00000000000763fc
- (int)getPlanPhase;	// IMP=0x00000000000763ee
- (void *)getEspressoContext;	// IMP=0x00000000000763d8
- (int)softmax;	// IMP=0x0000000000076319
- (void)normalization:(float *)arg1;	// IMP=0x00000000000760fa
- (int)espressoForwardInputs:(vector_aebc2d99)arg1;	// IMP=0x000000000007607f
- (int)espressoForward:(float *)arg1;	// IMP=0x000000000007604f
- (int)prepareModelInputs:(vector_aebc2d99)arg1;	// IMP=0x0000000000075f9e
- (int)prepareModelInput:(float *)arg1;	// IMP=0x0000000000075f48
- (int)prepareModelWithConfig:(id)arg1;	// IMP=0x0000000000075b7c
- (id)initWithParameters:(id)arg1 inputNames:(id)arg2 outputNames:(id)arg3 properties:(id)arg4;	// IMP=0x00000000000756d0
