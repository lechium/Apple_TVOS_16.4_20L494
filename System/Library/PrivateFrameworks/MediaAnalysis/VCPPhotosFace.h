...
+ (_Bool)_isColocatingAnimalObservation:(id)arg1 withFaceObservations:(id)arg2 orTorsoObservations:(id)arg3;	// IMP=0x001000000005ad8f
+ (double)_calculateIoUBetweenObservation:(id)arg1 andObservation:(id)arg2;	// IMP=0x001000000005ac3a
+ (double)_calculateOverlappingBetweenFaceObservation:(id)arg1 andHumanObservation:(id)arg2;	// IMP=0x001000000005ab30
+ (id)facesFromPHFetchResult:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000005a250
+ (id)faceFromPHFace:(id)arg1 copyOption:(long long)arg2;	// IMP=0x0010000000059624
+ (id)facesFromFaceObservations:(id)arg1 humanObservations:(id)arg2 animalObservations:(id)arg3 sourceWidth:(unsigned long long)arg4 sourceHeight:(unsigned long long)arg5 visionRequests:(id)arg6 blurScorePerFace:(id)arg7 exposureScorePerFace:(id)arg8 tooSmallFaceObservations:(id)arg9 processingVersion:(int)arg10;	// IMP=0x0010000000056e8d
+ (id)faceFromFaceObservation:(id)arg1 humanObservation:(id)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6 force:(_Bool)arg7 andError:(id *)arg8;	// IMP=0x001000000005485f
+ (id)faceWithLocalIdentifier:(id)arg1;	// IMP=0x00100000000547fa
- (void).cxx_destruct;	// IMP=0x000000000005b8a3
...
- (double)photosFaceRepresentationQuality;	// IMP=0x000000000005b44d
- (double)photosFaceRepresentationRoll;	// IMP=0x000000000005b43b
- (id)photosFaceRepresentationLocalIdentifier;	// IMP=0x000000000005b429
- (long long)photosFaceRepresentationClusterSequenceNumber;	// IMP=0x000000000005b417
- (long long)photosFaceRepresentationQualityMeasure;	// IMP=0x000000000005b405
- (_Bool)photosFaceRepresentationIsRightEyeClosed;	// IMP=0x000000000005b3f3
- (_Bool)photosFaceRepresentationIsLeftEyeClosed;	// IMP=0x000000000005b3e1
- (_Bool)photosFaceRepresentationHasSmile;	// IMP=0x000000000005b3cf
- (double)photosFaceRepresentationBlurScore;	// IMP=0x000000000005b3bd
- (double)photosFaceRepresentationSize;	// IMP=0x000000000005b3ab
- (double)photosFaceRepresentationCenterY;	// IMP=0x000000000005b399
- (double)photosFaceRepresentationCenterX;	// IMP=0x000000000005b387
- (long long)photosFaceRepresentationSourceHeight;	// IMP=0x000000000005b375
- (long long)photosFaceRepresentationSourceWidth;	// IMP=0x000000000005b363
- (long long)qualityMeasureWithCountOfFacesOnAsset:(unsigned long long)arg1;	// IMP=0x000000000005b207
- (id)gist;	// IMP=0x000000000005a92e
- (struct CGRect)normalizedFaceRect;	// IMP=0x000000000005a8ae
- (_Bool)setCenterAndSizeFromNormalizedFaceRect:(struct CGRect)arg1;	// IMP=0x000000000005a80f
- (void)replaceCoordinatesAndFeaturesFromDetectedFace:(id)arg1;	// IMP=0x000000000005a48a
- (id)initWithLocalIdentifier:(id)arg1;	// IMP=0x00000000000546d0
