...
- (void)serviceProxyDidDisconnect:(id)arg1;	// IMP=0x000000000001d587
- (void)serviceProxyDidConnect:(id)arg1;	// IMP=0x000000000001d4e7
- (void)remoteContentIsLoadedValueChanged;	// IMP=0x000000000001d4e1
- (CDUnknownBlockType)_contentProviderForCurrentConfiguration;	// IMP=0x000000000001d076
- (id)_finalSlotStyleForStyle:(id)arg1;	// IMP=0x000000000001d060
- (void)renderRemoteContentForLayerContextID:(unsigned long long)arg1 style:(id)arg2 yield:(CDUnknownBlockType)arg3;	// IMP=0x000000000001d05a
- (id)makePlaceholderSlotContentForStyle:(id)arg1;	// IMP=0x000000000001d052
- (_Bool)shouldInvalidatePreviousPlaceHolderSlotContent:(id)arg1 forStyle:(id)arg2;	// IMP=0x000000000001d04a
- (id)initWithServiceProxyClass:(Class)arg1 maxWidth:(double)arg2;	// IMP=0x000000000001c90e
