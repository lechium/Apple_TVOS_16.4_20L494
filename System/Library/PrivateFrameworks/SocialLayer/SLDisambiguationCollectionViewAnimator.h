...
+ (id)springAnimation;	// IMP=0x0010000000019f7b
+ (id)init;	// IMP=0x0010000000019e0e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000019f75
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000019e7b
- (id)commonInit;	// IMP=0x0000000000019e4d
