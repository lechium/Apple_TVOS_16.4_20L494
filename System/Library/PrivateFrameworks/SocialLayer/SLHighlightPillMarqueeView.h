...
- (void).cxx_destruct;	// IMP=0x0000000000012ce5
...
- (void)_deactivateMarqueeAnimationIfNecessary;	// IMP=0x0000000000012ad2
- (void)_activateMarqueeAnimationIfNecessary;	// IMP=0x0000000000012805
- (void)updateConstraints;	// IMP=0x0000000000011db7
- (void)layoutSubviews;	// IMP=0x0000000000011ac2
- (id)initWithFrame:(struct CGRect)arg1 pillView:(id)arg2;	// IMP=0x0000000000011718
