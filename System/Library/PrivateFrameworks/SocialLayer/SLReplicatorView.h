...
+ (Class)layerClass;	// IMP=0x0060000000010ac2
- (void).cxx_destruct;	// IMP=0x00000000000116b4
...
- (void)updateConstraints;	// IMP=0x0000000000010e35
- (void)_updateReplicatorLayer;	// IMP=0x0000000000010ccf
- (void)updateInstanceCount:(unsigned long long)arg1 replicationPaddingX:(double)arg2;	// IMP=0x0000000000010bcb
- (id)initWithFrame:(struct CGRect)arg1 targetView:(id)arg2;	// IMP=0x0000000000010ad3
