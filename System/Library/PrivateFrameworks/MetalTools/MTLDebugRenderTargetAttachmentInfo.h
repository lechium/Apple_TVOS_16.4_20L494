...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000089ab5
- (unsigned long long)hash;	// IMP=0x0000000000089aa7
- (unsigned long long)intersectsTexture:(id)arg1;	// IMP=0x0000000000089911
- (id)initWithDesc:(const struct MTLRenderPassAttachmentDescriptorPrivate *)arg1 renderTargetArrayLength:(unsigned long long)arg2;	// IMP=0x000000000008977c
