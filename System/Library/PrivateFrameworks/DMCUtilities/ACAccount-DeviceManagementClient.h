...
+ (id)dmc_createManagementAccountWithStore:(id)arg1;	// IMP=0x0020000000001425
- (_Bool)dmc_isAccountSchemeSharediPad;	// IMP=0x001000000000224c
- (id)dmc_accountQuotaString;	// IMP=0x0010000000001ccc
- (_Bool)dmc_isPrimaryAccount;	// IMP=0x0010000000001c81
- (_Bool)dmc_isVisibleRemoteManagementAccount;	// IMP=0x0010000000001bf7
