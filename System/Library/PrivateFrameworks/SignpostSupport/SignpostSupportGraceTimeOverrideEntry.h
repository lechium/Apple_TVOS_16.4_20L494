...
- (void).cxx_destruct;	// IMP=0x0000000000004222
...
- (id)debugDescriptionWithWhitespacePrefix:(id)arg1;	// IMP=0x0000000000003e94
- (id)debugDescription;	// IMP=0x0000000000003e7b
- (id)initWithEntryLevel:(unsigned long long)arg1;	// IMP=0x0000000000003e1a
