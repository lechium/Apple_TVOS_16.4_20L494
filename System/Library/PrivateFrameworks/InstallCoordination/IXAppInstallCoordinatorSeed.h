...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005aca4
- (void).cxx_destruct;	// IMP=0x000000000005b38b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005b1df
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005b004
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005acac
