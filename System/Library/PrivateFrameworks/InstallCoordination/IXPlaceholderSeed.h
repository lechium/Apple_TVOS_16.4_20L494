...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000031156
- (void).cxx_destruct;	// IMP=0x00000000000312fc
...
- (Class)clientPromiseClass;	// IMP=0x0000000000031249
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003115e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000030fea
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000030e1b
