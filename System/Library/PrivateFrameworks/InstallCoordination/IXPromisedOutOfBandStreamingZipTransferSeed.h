...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004421c
- (void).cxx_destruct;	// IMP=0x00000000000443ab
...
- (Class)clientPromiseClass;	// IMP=0x000000000004430f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000044224
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000440a8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000043f29
