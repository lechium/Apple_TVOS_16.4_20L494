...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000322e3
- (void).cxx_destruct;	// IMP=0x000000000003246f
...
- (Class)clientPromiseClass;	// IMP=0x00000000000323d6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000322eb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003216f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000031ff0
