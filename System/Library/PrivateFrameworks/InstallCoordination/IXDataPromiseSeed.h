...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000048b27
- (void).cxx_destruct;	// IMP=0x0000000000048c8b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000048b2f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000489e1
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000048877
