...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000059e67
- (void).cxx_destruct;	// IMP=0x0000000000059f9a
...
- (Class)clientPromiseClass;	// IMP=0x0000000000059f24
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000059e6f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000059d81
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000059c9b
