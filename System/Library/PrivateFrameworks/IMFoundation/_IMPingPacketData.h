...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000044be2
- (void)_returnPacketArrived;	// IMP=0x0000000000044bc4
- (void)_markPacketAsTimedOut:(double)arg1;	// IMP=0x0000000000044b38
- (id)initWithSequeneceNumber:(int)arg1 timesent:(struct timeval *)arg2 error:(int)arg3;	// IMP=0x0000000000044ae3
