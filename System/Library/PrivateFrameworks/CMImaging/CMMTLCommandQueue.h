...
- (void).cxx_destruct;	// IMP=0x000000000000844d
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000083bc
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000000836c
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000008337
@property(readonly) id <MTLDevice> device;
- (id)commandBuffer;	// IMP=0x00000000000082f1
- (id)commandBufferWithUnretainedReferences;	// IMP=0x00000000000082b6
- (id)initWithCMMTLDevice:(id)arg1 descriptor:(id)arg2;	// IMP=0x0000000000008192
- (id)initWithCMMTLDevice:(id)arg1 maxCommandBufferCount:(unsigned long long)arg2;	// IMP=0x0000000000008085
- (id)initWithCMMTLDevice:(id)arg1;	// IMP=0x0000000000007f7e
