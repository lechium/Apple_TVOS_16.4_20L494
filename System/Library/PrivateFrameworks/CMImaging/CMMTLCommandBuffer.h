...
- (void).cxx_destruct;	// IMP=0x0000000000008b9d
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000008af1
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000000008aa1
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000008a6c
- (void)commit;	// IMP=0x00000000000085e3
- (id)initWithCMMTLCommandQueue:(id)arg1 unretained:(_Bool)arg2;	// IMP=0x00000000000084ba
- (void)waitUntilScheduled;	// IMP=0x00000000000084a4
- (void)waitUntilCompleted;	// IMP=0x000000000000848e
