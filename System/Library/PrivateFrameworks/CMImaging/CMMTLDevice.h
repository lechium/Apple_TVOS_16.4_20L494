...
- (void).cxx_destruct;	// IMP=0x0000000000007f56
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000007eaa
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000000007e5a
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000007e25
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x0000000000007dcd
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x0000000000007d9a
- (id)newCommandQueue;	// IMP=0x0000000000007d6c
@property(retain, nonatomic) FigMetalExecutionStatus *executionStatus;
- (id)initWithLevel:(int)arg1;	// IMP=0x0000000000007c6b
