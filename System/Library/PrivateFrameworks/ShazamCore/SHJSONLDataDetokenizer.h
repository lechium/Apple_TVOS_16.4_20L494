...
- (void).cxx_destruct;	// IMP=0x00000000000056a0
...
- (_Bool)closeWithError:(id *)arg1;	// IMP=0x0000000000005567
- (_Bool)processData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000052db
- (_Bool)writeDataToDelegate:(id)arg1 withError:(id *)arg2;	// IMP=0x00000000000050a5
- (id)init;	// IMP=0x000000000000503f
