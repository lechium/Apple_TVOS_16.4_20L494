...
- (void).cxx_destruct;	// IMP=0x000000000005d4cc
- (void)requestDatesOperation:(id)arg1 didTimeoutPendingEnvironments:(id)arg2;	// IMP=0x000000000005d45b
- (void)requestDatesOperation:(id)arg1 environment:(id)arg2 didProvideSpecifiers:(id)arg3 forPresentationInterval:(id)arg4 isComplete:(_Bool)arg5;	// IMP=0x000000000005d1cf
- (void)lock_completeAllTimelineEntries;	// IMP=0x000000000005cfe3
- (void)callCompletionIfDone;	// IMP=0x000000000005cf2b
- (void)calculateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000005c9f8
