...
- (void).cxx_destruct;	// IMP=0x000000000001dfaa
@property(readonly, nonatomic) BLSHBacklightEnvironmentPresentation *presentation; // @synthesize presentation=_presentation;
- (id)telemetryDataWithEndTime:(double)arg1 reasonEnded:(id)arg2 preventedSleepDuration:(double)arg3;	// IMP=0x000000000001ca4a
- (void)prepareAndRenderFrameSpecifier:(id)arg1;	// IMP=0x000000000001be78
- (void)invalidate;	// IMP=0x000000000001bca0
...
- (void)dealloc;	// IMP=0x000000000001b61e
- (id)initWithDelegate:(id)arg1 flipbook:(id)arg2 presentation:(id)arg3 osInterfaceProvider:(id)arg4;	// IMP=0x000000000001b258
