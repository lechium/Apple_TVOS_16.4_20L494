...
+ (id)serviceForService:(id)arg1 withOSInterfaceProvider:(id)arg2;	// IMP=0x006000000007324e
- (void).cxx_destruct;	// IMP=0x00000000000737bf
...
- (id)initWithService:(id)arg1 osInterfaceProvider:(id)arg2;	// IMP=0x00000000000732ba
