...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0010000000035e62
- (void).cxx_destruct;	// IMP=0x0000000000036338
...
- (void)invalidate;	// IMP=0x0000000000036103
- (_Bool)reactivateIfPossible;	// IMP=0x00000000000360d2
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0000000000035ff5
