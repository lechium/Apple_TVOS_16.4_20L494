...
- (void).cxx_destruct;	// IMP=0x000000000003c92d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003c8be
- (double)timeIntervalFromLastEntryToDate:(id)arg1;	// IMP=0x000000000003c8a2
- (_Bool)countSpecifier:(id)arg1 hasSecondsBudget:(_Bool)arg2 isCoalesceAllowed:(_Bool)arg3;	// IMP=0x000000000003c6ca
- (id)description;	// IMP=0x000000000003c58e
- (id)init;	// IMP=0x000000000003c512
