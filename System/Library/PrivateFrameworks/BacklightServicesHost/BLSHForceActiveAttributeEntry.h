...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x001000000004dee7
- (void).cxx_destruct;	// IMP=0x000000000004e1bc
...
- (void)invalidate;	// IMP=0x000000000004e174
- (_Bool)reactivateIfPossible;	// IMP=0x000000000004e16c
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x000000000004e0b5
