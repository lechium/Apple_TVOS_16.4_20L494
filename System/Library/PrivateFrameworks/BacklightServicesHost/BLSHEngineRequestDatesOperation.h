...
- (void).cxx_destruct;	// IMP=0x00000000000454d2
@property(readonly, nonatomic) NSDateInterval *requestInterval; // @synthesize requestInterval=_requestInterval;
- (id)telemetryDataWithEndTime:(double)arg1;	// IMP=0x00000000000451e2
- (void)beginOperationWithIntervals:(id)arg1 shouldReset:(_Bool)arg2;	// IMP=0x0000000000044230
...
- (void)invalidate;	// IMP=0x000000000004400b
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000000438c4
- (id)initWithRequestInterval:(id)arg1 delegate:(id)arg2 osTimerProvider:(id)arg3;	// IMP=0x00000000000437fc
