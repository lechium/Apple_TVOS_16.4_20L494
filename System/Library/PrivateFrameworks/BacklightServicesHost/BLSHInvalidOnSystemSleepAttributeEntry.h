...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x001000000000a958
- (void).cxx_destruct;	// IMP=0x000000000000aec2
...
- (void)systemSleepMonitor:(id)arg1 prepareForSleepWithCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000ae4f
- (void)systemSleepMonitor:(id)arg1 sleepRequestedWithResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000000ae0c
- (void)invalidate;	// IMP=0x000000000000ad4e
- (_Bool)reactivateIfPossible;	// IMP=0x000000000000ad46
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x000000000000a9ed
