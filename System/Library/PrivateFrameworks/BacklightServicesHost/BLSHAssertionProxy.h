...
- (void).cxx_destruct;	// IMP=0x00000000000346cf
...
- (oneway void)serviceDidResume;	// IMP=0x000000000003458b
- (oneway void)serviceDidPause;	// IMP=0x0000000000034557
- (oneway void)serviceDidCancelWithError:(id)arg1;	// IMP=0x00000000000344ea
- (oneway void)serviceWillCancel;	// IMP=0x00000000000344b6
- (oneway void)serviceFailedToAcquireWithError:(id)arg1;	// IMP=0x000000000003446f
- (oneway void)serviceDidAcquire;	// IMP=0x0000000000034421
...
- (void)invalidate;	// IMP=0x00000000000343ba
- (id)initWithIdentifier:(id)arg1 descriptor:(id)arg2 remoteTarget:(id)arg3;	// IMP=0x00000000000342c1
