...
- (_Bool)isEqualToVisualState:(id)arg1 presentationDate:(id)arg2;	// IMP=0x000000000000e33d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000e11a
- (unsigned long long)hash;	// IMP=0x000000000000e07a
- (id)debugDescription;	// IMP=0x000000000000df1a
- (id)description;	// IMP=0x000000000000de35
- (_Bool)setAndTestDidPerformBacklightRamp;	// IMP=0x000000000000ddfe
- (id)initWithSequenceID:(unsigned long long)arg1 backlightState:(long long)arg2 visualState:(id)arg3 presentationDate:(id)arg4;	// IMP=0x000000000000dd45
- (id)initWithTarget:(id)arg1 visualState:(id)arg2 presentationDate:(id)arg3;	// IMP=0x000000000000dc8e
- (id)initWithSequenceID:(unsigned long long)arg1 backlightState:(long long)arg2;	// IMP=0x000000000000dc76
