...
+ (id)readOpaqueTokenFromBuffer:(const char *)arg1;	// IMP=0x00600000000f5fa2
+ (id)readTokenFromBuffer:(const char *)arg1;	// IMP=0x00600000000f5f87
+ (id)readTokenFromBuffer:(const char *)arg1 opaque:(_Bool)arg2;	// IMP=0x00600000000f5e3b
...
- (id)description;	// IMP=0x00000000000f5fc0
- (id)_initWithID:(unsigned long long)arg1 class:(unsigned char)arg2 length:(unsigned long long)arg3 content:(const char *)arg4 opaque:(_Bool)arg5;	// IMP=0x00000000000f5ddd
