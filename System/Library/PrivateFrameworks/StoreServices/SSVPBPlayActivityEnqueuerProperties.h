...
- (void).cxx_destruct;	// IMP=0x0000000000030ee1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000030cb8
- (unsigned long long)hash;	// IMP=0x0000000000030b78
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000030948
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000307c2
- (void)copyTo:(id)arg1;	// IMP=0x0000000000030683
- (void)writeTo:(id)arg1;	// IMP=0x0000000000030541
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000030534
- (id)dictionaryRepresentation;	// IMP=0x000000000002fe48
- (id)description;	// IMP=0x000000000002fd99
...
- (int)StringAsSystemReleaseType:(id)arg1;	// IMP=0x000000000002fbdd
- (id)systemReleaseTypeAsString:(int)arg1;	// IMP=0x000000000002fb94
