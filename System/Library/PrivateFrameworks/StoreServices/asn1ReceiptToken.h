...
+ (id)readFromBuffer:(const char *)arg1;	// IMP=0x006000000016e784
...
- (id)description;	// IMP=0x000000000016e950
- (void)dealloc;	// IMP=0x000000000016e749
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x000000000016e6e3
