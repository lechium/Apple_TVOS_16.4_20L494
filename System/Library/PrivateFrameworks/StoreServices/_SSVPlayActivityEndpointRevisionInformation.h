...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000127d81
- (void).cxx_destruct;	// IMP=0x0000000000127dcf
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000127d0d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000127c88
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000127b39
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000127a9c
- (unsigned long long)hash;	// IMP=0x0000000000127a59
