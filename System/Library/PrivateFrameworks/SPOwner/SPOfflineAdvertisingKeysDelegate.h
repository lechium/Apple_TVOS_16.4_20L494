...
- (void).cxx_destruct;	// IMP=0x000000000002aed3
...
- (void)peripheralManager:(id)arg1 offlineAdvPayloadRequestedWithReason:(long long)arg2;	// IMP=0x000000000002acaa
- (void)processKeyResponse:(id)arg1;	// IMP=0x000000000002a7c3
- (long long)transformReason:(long long)arg1;	// IMP=0x000000000002a772
- (void)enterLowPowerMode;	// IMP=0x000000000002a665
- (void)peripheralManagerDidUpdateState:(id)arg1;	// IMP=0x000000000002a475
- (id)userAgentSyncProxy;	// IMP=0x000000000002a463
- (id)syncProxy;	// IMP=0x000000000002a1f8
- (id)userAgentProxy;	// IMP=0x000000000002a1e6
- (id)proxy;	// IMP=0x0000000000029fe4
- (id)remoteInterface;	// IMP=0x0000000000029ec4
- (id)initWithBeaconManager:(id)arg1;	// IMP=0x0000000000029c9c
