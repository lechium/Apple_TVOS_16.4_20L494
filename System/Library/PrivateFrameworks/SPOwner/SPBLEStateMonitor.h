...
- (void).cxx_destruct;	// IMP=0x0000000000043186
...
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x000000000004301f
- (void)notifyDelegate:(unsigned long long)arg1;	// IMP=0x0000000000042fa4
- (void)startMonitoring;	// IMP=0x0000000000042e93
- (id)init;	// IMP=0x0000000000042e57
