...
- (id)headerString;	// IMP=0x0000000000038de7
- (id)initWithBeaconIdentifier:(id)arg1 keySequence:(unsigned char)arg2 mapHandle:(CDStruct_e66c82b6 *)arg3;	// IMP=0x0000000000038d66
- (void)dealloc;	// IMP=0x0000000000038d2c
- (id)init;	// IMP=0x0000000000038d01
