...
+ (id)remoteInterface;	// IMP=0x001000000001f0cc
- (void).cxx_destruct;	// IMP=0x000000000001f3f1
...
- (void)centralManager:(id)arg1 didDiscoverPeripheral:(id)arg2 advertisementData:(id)arg3 RSSI:(id)arg4;	// IMP=0x000000000001f179
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x000000000001f138
- (void)invalidationHandler:(id)arg1;	// IMP=0x000000000001ece6
- (void)interruptionHandler:(id)arg1;	// IMP=0x000000000001ec41
- (void)stopScanning;	// IMP=0x000000000001eb65
- (void)startScanning;	// IMP=0x000000000001e9af
- (void)handleStateChange:(unsigned long long)arg1;	// IMP=0x000000000001e51d
- (id)init;	// IMP=0x000000000001e1ed
