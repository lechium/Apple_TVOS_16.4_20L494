...
- (id)uniqueVideoPreviewLayers:(id)arg1;	// IMP=0x000000000007800d
- (id)uniqueConnections:(id)arg1;	// IMP=0x0000000000077f95
- (id)uniqueOutputs:(id)arg1;	// IMP=0x0000000000077f1d
- (id)uniqueInputs:(id)arg1;	// IMP=0x0000000000077ea5
- (void)dealloc;	// IMP=0x0000000000077e4d
- (id)initWithConfigurationID:(long long)arg1 inputs:(id)arg2 outputs:(id)arg3 videoPreviewLayers:(id)arg4 connections:(id)arg5;	// IMP=0x0000000000077da9
