...
+ (id)requestWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0060000000036b3f
+ (void)initialize;	// IMP=0x0060000000036b2e
...
- (void)_resolveExpectedPhotoManifest;	// IMP=0x0000000000036d77
...
- (void)dealloc;	// IMP=0x0000000000036c59
- (id)initWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0000000000036b8a
