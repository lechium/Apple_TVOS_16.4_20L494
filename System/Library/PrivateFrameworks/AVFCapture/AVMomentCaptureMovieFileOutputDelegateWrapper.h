...
+ (id)wrapperWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x0060000000003103
...
- (void)dealloc;	// IMP=0x00000000000032a9
- (id)initWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x000000000000314e
