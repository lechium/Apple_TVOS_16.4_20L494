...
+ (id)preparedPhotoSettingsArrayRequestWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00600000000274f1
...
- (void)_setRequestID:(unsigned long long)arg1;	// IMP=0x0000000000027621
@property(readonly) unsigned long long requestID;
- (void)dealloc;	// IMP=0x00000000000275cd
- (id)_initWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000002752d
