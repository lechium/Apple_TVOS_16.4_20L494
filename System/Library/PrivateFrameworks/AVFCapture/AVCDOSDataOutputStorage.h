...
- (_Bool)hasAllExpectedSynchronizedDataForLeaderTimestamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000702f2
@property(readonly, nonatomic, getter=isLive) _Bool live;
- (void)dealloc;	// IMP=0x000000000007025f
- (id)initWithDataOutput:(id)arg1;	// IMP=0x0000000000070183
