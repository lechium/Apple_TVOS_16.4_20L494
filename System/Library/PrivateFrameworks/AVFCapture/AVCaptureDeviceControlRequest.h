...
+ (id)deviceControlRequestWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x006000000007928c
...
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000792c3
