...
- (id)newAccelerationStructureWithBuffer:(id)arg1 offset:(unsigned long long)arg2 resourceIndex:(unsigned long long)arg3;	// IMP=0x000000000002949e
- (id)newAccelerationStructureWithBuffer:(id)arg1 offset:(unsigned long long)arg2;	// IMP=0x0000000000029273
- (id)newHeapWithDescriptor:(id)arg1;	// IMP=0x0000000000029032
- (id)newSamplerStateWithDescriptor:(id)arg1;	// IMP=0x0000000000028e54
- (id)newDepthStencilStateWithDescriptor:(id)arg1;	// IMP=0x0000000000028ca5
- (void)reserveResourceIndicesForResourceType:(unsigned long long)arg1 indices:(unsigned long long *)arg2 indexCount:(unsigned long long)arg3;	// IMP=0x0000000000028c8f
- (id)vendorName;	// IMP=0x0000000000028c79
- (_Bool)validateDynamicLibraryURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000028c63
- (_Bool)validateDynamicLibraryDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000028c4d
- (_Bool)validateDynamicLibrary:(id)arg1 state:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0000000000028be2
- (void)unmapShaderSampleBuffer;	// IMP=0x0000000000028b0e
- (void)unloadShaderCaches;	// IMP=0x0000000000028af8
- (CDStruct_14f26992)tileSizeWithSparsePageSize:(long long)arg1 textureType:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 sampleCount:(unsigned long long)arg4;	// IMP=0x00000000000289b1
- (_Bool)supportsVertexAmplificationCount:(unsigned long long)arg1;	// IMP=0x000000000002899b
- (_Bool)supportsTextureWriteRoundingMode:(long long)arg1;	// IMP=0x0000000000028985
- (_Bool)supportsTextureSampleCount:(unsigned long long)arg1;	// IMP=0x000000000002887e
- (_Bool)supportsSampleCount:(unsigned long long)arg1;	// IMP=0x0000000000028777
- (_Bool)supportsRasterizationRateMapWithLayerCount:(unsigned long long)arg1;	// IMP=0x0000000000028670
- (_Bool)supportsFeatureSet:(unsigned long long)arg1;	// IMP=0x000000000002865a
- (_Bool)supportsFamily:(long long)arg1;	// IMP=0x0000000000028644
- (_Bool)supportsCounterSampling:(unsigned long long)arg1;	// IMP=0x000000000002862e
- (void)startCollectingPipelineDescriptorsUsingPrefixForNames:(id)arg1;	// IMP=0x0000000000028618
- (void)startCollectingPipelineDescriptors;	// IMP=0x0000000000028602
- (CDStruct_14f26992)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3 sparsePageSize:(long long)arg4;	// IMP=0x00000000000284bb
- (unsigned long long)sparseTileSizeInBytesForSparsePageSize:(long long)arg1;	// IMP=0x00000000000283be
- (void)setupMPSFunctionTable:(struct MPSFunctionTable *)arg1;	// IMP=0x00000000000283a8
- (void)setRawBVHBuilderPtr:(id)arg1;	// IMP=0x0000000000028392
- (void)setIndirectArgumentBufferDecodingData:(id)arg1;	// IMP=0x000000000002837c
@property(getter=areGPUAssertionsEnabled, setter=setGPUAssertionsEnabled:) _Bool gpuAssertionsEnabled;
- (void)sampleTimestamps:(unsigned long long *)arg1 gpuTimestamp:(unsigned long long *)arg2;	// IMP=0x0000000000028350
- (unsigned long long)resourcePatchingTypeForResourceType:(unsigned long long)arg1;	// IMP=0x000000000002833a
- (_Bool)reserveGPUAddressRange:(struct _NSRange)arg1;	// IMP=0x0000000000028324
- (id)productName;	// IMP=0x000000000002830e
- (CDStruct_c0454aff)pipelineCacheStats;	// IMP=0x00000000000282f8
- (id)newVisibleFunctionTableWithDescriptor:(id)arg1;	// IMP=0x00000000000282a9
- (id)newTextureWithDescriptor:(id)arg1 iosurface:(struct __IOSurface *)arg2 plane:(unsigned long long)arg3;	// IMP=0x0000000000028051
- (id)newTextureWithDescriptor:(id)arg1;	// IMP=0x0000000000027e3d
- (id)newTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 descriptor:(id)arg3 deallocator:(CDUnknownBlockType)arg4;	// IMP=0x0000000000027ba4
- (id)newTextureLayoutWithDescriptor:(id)arg1 isHeapOrBufferBacked:(_Bool)arg2;	// IMP=0x00000000000279af
- (id)newProfileWithExecutionSize:(unsigned long long)arg1;	// IMP=0x0000000000027803
- (id)newLibraryWithStitchedDescriptorSPI:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000275dc
- (id)newLibraryWithDescriptorSPI:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000273b5
- (id)newLibraryWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002718e
- (id)newLibraryWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000026f6e
- (id)newLateEvalEvent;	// IMP=0x0000000000026dd8
- (id)newIndirectRenderCommandEncoderWithBuffer:(id)arg1;	// IMP=0x0000000000026d81
- (id)newIndirectComputeCommandEncoderWithBuffer:(id)arg1;	// IMP=0x0000000000026d2a
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000026b19
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCommandCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x00000000000268e3
- (id)newIndirectArgumentEncoderWithLayout:(id)arg1;	// IMP=0x00000000000268cd
- (id)newIndirectArgumentEncoderWithArguments:(id)arg1;	// IMP=0x00000000000268b7
- (id)newIndirectArgumentBufferLayoutWithStructType:(id)arg1;	// IMP=0x00000000000268a1
- (id)newFence;	// IMP=0x000000000002670b
- (id)newEvent;	// IMP=0x0000000000026575
- (id)newDynamicLibraryWithURL:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0000000000026358
- (id)newDynamicLibraryWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000026154
- (id)newDynamicLibraryWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000260f6
- (id)newDynamicLibraryFromURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002605e
- (id)newDynamicLibrary:(id)arg1 computeDescriptor:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000025f52
- (id)newDagStringWithGraphs:(id)arg1;	// IMP=0x0000000000025f3c
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x0000000000025d91
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x0000000000025bb5
- (id)newCommandQueue;	// IMP=0x0000000000025a1f
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 gpuAddress:(unsigned long long)arg3;	// IMP=0x000000000002584e
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000025681
- (id)newBufferWithIOSurface:(struct __IOSurface *)arg1;	// IMP=0x00000000000254af
- (id)newBufferWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 gpuAddress:(unsigned long long)arg4 deallocator:(CDUnknownBlockType)arg5;	// IMP=0x0000000000025441
- (id)newBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 gpuAddress:(unsigned long long)arg4;	// IMP=0x0000000000025239
- (id)newBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000025048
- (id)newBinaryLibraryWithOptions:(unsigned long long)arg1 url:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000024fab
- (id)newBinaryArchiveWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000024dd2
- (id)newArgumentEncoderWithLayout:(id)arg1;	// IMP=0x0000000000024d74
- (id)newAccelerationStructureWithSize:(unsigned long long)arg1 withDescriptor:(id)arg2;	// IMP=0x0000000000024b80
- (id)newAccelerationStructureWithSize:(unsigned long long)arg1 resourceIndex:(unsigned long long)arg2;	// IMP=0x00000000000249c0
- (id)newAccelerationStructureWithSize:(unsigned long long)arg1;	// IMP=0x0000000000024809
- (id)newAccelerationStructureWithDescriptor:(id)arg1;	// IMP=0x0000000000024601
- (unsigned long long)minimumTextureBufferAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x00000000000245eb
- (unsigned long long)minimumLinearTextureAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x00000000000245d5
- (unsigned long long)minLinearTextureAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x00000000000244d8
- (_Bool)mapShaderSampleBufferWithBuffer:(CDStruct_32a7f38a *)arg1 capacity:(unsigned long long)arg2 size:(unsigned long long)arg3;	// IMP=0x00000000000244c2
- (CDStruct_c0454aff)libraryCacheStats;	// IMP=0x00000000000244ac
- (_Bool)isCompatibleWithAccelerationStructure:(CDStruct_c0454aff)arg1;	// IMP=0x0000000000024496
- (id)indirectArgumentBufferDecodingData;	// IMP=0x0000000000024480
- (CDStruct_4bcfbbae)heapTextureSizeAndAlignWithDescriptor:(id)arg1;	// IMP=0x000000000002434c
- (CDStruct_4bcfbbae)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000024230
- (CDStruct_4bcfbbae)heapAccelerationStructureSizeAndAlignWithSize:(unsigned long long)arg1;	// IMP=0x000000000002421a
- (CDStruct_4bcfbbae)heapAccelerationStructureSizeAndAlignWithDescriptor:(id)arg1;	// IMP=0x00000000000241c6
- (void *)getShaderCacheKeys;	// IMP=0x00000000000241b0
- (id)getRawBVHBuilderPtr;	// IMP=0x000000000002419a
- (void)getDefaultSamplePositions:(CDStruct_b2fbf00d *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000024184
- (struct os_unfair_lock_s *)getBVHBuilderLock;	// IMP=0x000000000002416e
- (id)familyName;	// IMP=0x0000000000024158
- (id)endCollectingPipelineDescriptors;	// IMP=0x0000000000024142
- (_Bool)deviceSupportsFeatureSet:(unsigned long long)arg1;	// IMP=0x000000000002412c
- (_Bool)deviceOrFeatureProfileSupportsFeatureSet:(unsigned long long)arg1;	// IMP=0x0000000000024116
- (id)deserializePrimitiveAccelerationStructureFromBytes:(void *)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000002407c
- (id)deserializeInstanceAccelerationStructureFromBytes:(void *)arg1 primitiveAccelerationStructures:(id)arg2 withDescriptor:(id)arg3;	// IMP=0x0000000000023f9d
- (void)deserializeCompileTimeStats:(id)arg1 addToDictionary:(id)arg2;	// IMP=0x0000000000023f87
- (_Bool)copyShaderCacheToPath:(id)arg1;	// IMP=0x0000000000023e01
- (void)convertSparseTileRegions:(const CDStruct_4c83c94d *)arg1 toPixelRegions:(CDStruct_4c83c94d *)arg2 withTileSize:(CDStruct_14f26992)arg3 numRegions:(unsigned long long)arg4;	// IMP=0x0000000000023deb
- (void)convertSparsePixelRegions:(const CDStruct_4c83c94d *)arg1 toTileRegions:(CDStruct_4c83c94d *)arg2 withTileSize:(CDStruct_14f26992)arg3 alignmentMode:(unsigned long long)arg4 numRegions:(unsigned long long)arg5;	// IMP=0x0000000000023dd5
- (void)compilerPropagatesThreadPriority:(_Bool)arg1;	// IMP=0x0000000000023dbf
- (void)compileVisibleFunction:(id)arg1 withDescriptor:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000023cfc
- (CDStruct_14f26992)accelerationStructureSizesWithDescriptor:(id)arg1;	// IMP=0x0000000000023c96
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000023117
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x00000000000230b7
- (id)originalObject;	// IMP=0x00000000000230a9
- (void)deserializeInstanceAccelerationStructure:(id)arg1 fromBytes:(const void *)arg2 primitiveAccelerationStructures:(id)arg3 withDescriptor:(id)arg4;	// IMP=0x0000000000022df3
- (void)deserializePrimitiveAccelerationStructure:(id)arg1 fromBytes:(const void *)arg2 withDescriptor:(id)arg3;	// IMP=0x0000000000022bbc
- (void)compileVisibleFunction:(id)arg1 withDescriptor:(id)arg2 destinationBinaryArchive:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000022937
- (void)newLibraryWithStitchedDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000022820
- (id)newLibraryWithStitchedDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000225b3
- (void)newLibraryWithDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000002249c
- (id)newDynamicLibrary:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002225e
- (id)newBufferWithDescriptor:(id)arg1;	// IMP=0x000000000002202b
@property(readonly) unsigned long long maxPredicatedNestingDepth;
- (id)newIntersectionFunctionTableWithDescriptor:(id)arg1;	// IMP=0x0000000000021f80
- (id)loadDynamicLibrariesForFunction:(id)arg1 insertLibraries:(id)arg2 options:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x0000000000021d9d
- (id)loadDynamicLibrariesForFunction:(id)arg1 insertLibraries:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000021bc1
- (id)loadDynamicLibrariesForComputeDescriptor:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0000000000021a0f
- (id)loadDynamicLibrariesForComputeDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000021864
- (id)newLibraryWithDAG:(id)arg1 functions:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002158d
- (id)newBufferWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 deallocator:(CDUnknownBlockType)arg4;	// IMP=0x0000000000021335
@property(readonly) unsigned long long sparseTileSizeInBytes;
- (CDStruct_14f26992)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3;	// IMP=0x00000000000211da
- (id)newRasterizationRateMapWithDescriptor:(id)arg1;	// IMP=0x0000000000020ffe
- (id)newFunctionWithGLIR:(void *)arg1 inputsDescription:(id)arg2 functionType:(unsigned long long)arg3;	// IMP=0x0000000000020dd7
- (id)newFunctionWithGLIR:(void *)arg1 functionType:(unsigned long long)arg2;	// IMP=0x0000000000020c29
- (id)newFunctionWithGLESIR:(void *)arg1 inputsDescription:(id)arg2 functionType:(unsigned long long)arg3;	// IMP=0x0000000000020a02
- (id)newFunctionWithGLESIR:(void *)arg1 functionType:(unsigned long long)arg2;	// IMP=0x0000000000020854
- (id)newFunctionWithGLCoreIR:(void *)arg1 inputsDescription:(id)arg2 functionType:(unsigned long long)arg3;	// IMP=0x000000000002062d
- (id)newFunctionWithGLCoreIR:(void *)arg1 functionType:(unsigned long long)arg2;	// IMP=0x000000000002047f
...
- (id)newPipelineLibraryWithFilePath:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000020174
- (void)_setDeviceWrapper:(id)arg1;	// IMP=0x000000000002016e
- (id)_deviceWrapper;	// IMP=0x0000000000020165
- (id)newResourceGroupFromResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x000000000001ff05
- (id)newCounterSampleBufferWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001fd0e
- (_Bool)supportsPrimitiveType:(unsigned long long)arg1;	// IMP=0x000000000001fbf2
- (id)newDefaultLibraryWithBundle:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001f925
- (id)newDefaultLibrary;	// IMP=0x000000000001f673
- (id)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x000000000001f2b2
- (id)newRenderPipelineStateWithTileDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001f01f
- (id)newRenderPipelineStateWithDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x000000000001ec05
- (id)newRenderPipelineStateWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001e8ec
- (id)newComputePipelineStateWithFunction:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x000000000001e51b
- (id)newComputePipelineStateWithFunction:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001e27b
- (id)newComputePipelineStateWithDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x000000000001de84
- (id)newComputePipelineStateWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001db8a
- (void)newComputePipelineStateWithDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000001d9ee
- (void)newComputePipelineStateWithFunction:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000001d8b0
- (void)newComputePipelineStateWithFunction:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001d781
- (void)newRenderPipelineStateWithDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000001d5fe
- (void)newRenderPipelineStateWithDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001d490
- (id)newLibraryWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001d1f6
- (void)newLibraryWithSource:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000001d08b
- (id)newLibraryWithSource:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001cd4c
- (id)newLibraryWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const CDStruct_dbc1e4aa *)arg2 error:(id *)arg3;	// IMP=0x000000000001ca5d
- (id)newLibraryWithFile:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001c7c3
- (id)newLibraryWithCIFiltersForComputePipeline:(id)arg1 imageFilterFunctionInfo:(const CDStruct_dbc1e4aa *)arg2 error:(id *)arg3;	// IMP=0x000000000001c551
- (id)newLibraryWithCIFilters:(id)arg1 imageFilterFunctionInfo:(const CDStruct_dbc1e4aa *)arg2 error:(id *)arg3;	// IMP=0x000000000001c2df
- (id)newSharedEventWithMachPort:(unsigned int)arg1;	// IMP=0x000000000001c02f
- (id)newSharedEventWithHandle:(id)arg1;	// IMP=0x000000000001be29
- (id)newSharedEvent;	// IMP=0x000000000001bc55
- (id)newComputePipelineStateWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const CDStruct_dbc1e4aa *)arg2 error:(id *)arg3;	// IMP=0x000000000001b94f
- (id)newArgumentEncoderWithArguments:(id)arg1;	// IMP=0x000000000001b790
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000001b623
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000000001b4c3
- (void)dealloc;	// IMP=0x000000000001b3b8
@property(readonly, nonatomic) MTLSharedEventListener *captureEventListener;
- (_Bool)captureRaytracingEnabled;	// IMP=0x000000000001b39b
- (_Bool)bufferPinningEnabled;	// IMP=0x000000000001b38f
- (void)purgeDeallocatedObjects;	// IMP=0x000000000001b356
- (void)deallocateResource:(id)arg1;	// IMP=0x000000000001b1c9
- (void)invalidateHarvester;	// IMP=0x000000000001b167
- (_Bool)disableHeapTextureCompression;	// IMP=0x000000000001b15b
- (void)updateAssociatedFunction:(id)arg1;	// IMP=0x000000000001b0cd
- (_Bool)newCaptureSamplerState:(out id *)arg1 associatedWithBaseSamplerState:(id)arg2;	// IMP=0x000000000001aff8
- (_Bool)newCaptureDepthStencilState:(out id *)arg1 associatedWithBaseDepthStencilState:(id)arg2;	// IMP=0x000000000001af23
- (_Bool)newCaptureFunction:(out id *)arg1 associatedWithBaseFunction:(id)arg2 captureLibrary:(id)arg3;	// IMP=0x000000000001ae34
- (id)initWithBaseObject:(id)arg1 captureContext:(struct GTTraceContext *)arg2;	// IMP=0x000000000001aa45
...
- (id)dummyEncodeIntersectionFunctionTableIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001a7a2
- (id)dummyEncodeVisibleFunctionTableIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001a628
- (id)dummyEncodeComputePSOIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001a474
- (id)dummyEncodeRenderPSOIntoArgumentBufferForResourceIndex:(id)arg1 withMeshDescriptor:(id)arg2;	// IMP=0x000000000001a2d6
- (id)dummyEncodeRenderPSOIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001a138
- (id)dummyEncodeICBIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x0000000000019fcc
- (id)dummyEncodeSamplerIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x0000000000019e5a
- (id)dummyEncodeTextureIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x0000000000019cd7
- (void)_initDummyEncoder;	// IMP=0x0000000000019841
- (id)dummyArgumentEncoder;	// IMP=0x00000000000197d9
- (void)_initArgumentBufferPatchingTypes;	// IMP=0x0000000000019750
