...
- (void).cxx_destruct;	// IMP=0x0000000000035964
- (void)dealloc;	// IMP=0x0000000000035876
...
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000000000357e4
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x00000000000357d3
@property(readonly, copy) NSString *description;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000035712
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x00000000000356b2
- (id)originalObject;	// IMP=0x00000000000356a4
@property(readonly) id <MTLDepthStencilState> baseObject;
- (id)initWithBaseObject:(id)arg1 captureDevice:(id)arg2;	// IMP=0x00000000000355b8
