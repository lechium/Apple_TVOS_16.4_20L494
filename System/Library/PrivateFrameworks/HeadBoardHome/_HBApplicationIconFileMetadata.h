...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000007166b
- (void).cxx_destruct;	// IMP=0x00000000000716c4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007152c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007137d
