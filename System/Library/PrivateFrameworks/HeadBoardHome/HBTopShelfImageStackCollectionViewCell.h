...
- (void).cxx_destruct;	// IMP=0x0000000000098671
...
- (void)_exitIdleMode;	// IMP=0x000000000009840d
- (void)_enterIdleMode;	// IMP=0x0000000000098012
- (void)_updateWithCurrentUserInterfaceStyle;	// IMP=0x0000000000097f2a
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000097e89
- (void)dealloc;	// IMP=0x0000000000097dbd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000097c65
