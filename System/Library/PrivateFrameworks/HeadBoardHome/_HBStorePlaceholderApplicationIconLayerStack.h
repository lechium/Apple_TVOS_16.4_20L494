...
- (void).cxx_destruct;	// IMP=0x000000000000fd9f
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x000000000000fcab
- (id)initWithApplication:(id)arg1;	// IMP=0x000000000000fa51
