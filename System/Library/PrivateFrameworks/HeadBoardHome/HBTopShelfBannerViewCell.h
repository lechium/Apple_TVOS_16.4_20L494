...
- (void).cxx_destruct;	// IMP=0x000000000005a614
@property(nonatomic) __weak id <HBTopShelfBannerViewCellDelegate> delegate; // @synthesize delegate=_delegate;
- (_Bool)shouldHideFocusForReasons:(unsigned long long)arg1;	// IMP=0x000000000005a5f0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000005a56c
- (void)_setFocusDirection:(struct CGPoint)arg1;	// IMP=0x000000000005a4c3
