...
- (void).cxx_destruct;	// IMP=0x000000000000c51c
...
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x000000000000c2b8
