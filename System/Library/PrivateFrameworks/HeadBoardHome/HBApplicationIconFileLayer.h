...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000071170
- (void).cxx_destruct;	// IMP=0x000000000007136d
...
- (id)description;	// IMP=0x0000000000071178
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000070fca
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000070df0
- (id)_init;	// IMP=0x0000000000070dc1
