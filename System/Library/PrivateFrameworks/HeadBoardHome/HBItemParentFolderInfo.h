...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000003e1c1
- (void).cxx_destruct;	// IMP=0x000000000003e1fd
...
- (id)description;	// IMP=0x000000000003e0ed
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003e078
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003dfaf
