...
+ (id)_titleHeightCache;	// IMP=0x001000000009546c
+ (struct CGSize)_scaledSizeForSize:(struct CGSize)arg1 sizeIncreaseOffset:(double)arg2;	// IMP=0x0010000000092e8e
...
- (_Bool)shouldHideFocusForReasons:(unsigned long long)arg1;	// IMP=0x0000000000095e40
- (void)_updateTitleLabelContentScaleFactor;	// IMP=0x0000000000095de2
- (void)_updateTitleLabelFont;	// IMP=0x0000000000095cd7
- (void)_updateTitleShadowForFocus:(_Bool)arg1;	// IMP=0x0000000000095b43
- (void)_updateTitleTextColorForFocus:(_Bool)arg1;	// IMP=0x0000000000095aef
- (void)_updateTitleLayerAlphas;	// IMP=0x0000000000095a25
- (void)_updateTitleLayers;	// IMP=0x00000000000957ec
- (void)_updateTitleWidthAndHeight;	// IMP=0x0000000000095667
- (void)_updateTitleWidthForAccessory;	// IMP=0x00000000000955f4
- (void)_updateTitleHeightCache;	// IMP=0x00000000000954da
- (id)_textColorForFocus:(_Bool)arg1;	// IMP=0x0000000000095438
- (void)_showPressState;	// IMP=0x000000000009526c
@property(readonly, nonatomic, getter=_imageViewCenter) struct CGPoint imageViewCenter;
- (void)_layoutSubviewsAnimated:(_Bool)arg1 focused:(_Bool)arg2 focusUpdateContext:(id)arg3 focusAnimationCoordinator:(id)arg4;	// IMP=0x000000000009368c
- (double)_maxTitleWidthWithFocus:(_Bool)arg1;	// IMP=0x000000000009357c
- (id)_highlightFilterChain:(_Bool)arg1;	// IMP=0x0000000000093478
- (void)_ensureTitle;	// IMP=0x00000000000933e5
- (void)_detachMotionEffects;	// IMP=0x00000000000933c8
- (void)_attachMotionEffects;	// IMP=0x000000000009322d
@property(readonly, nonatomic, getter=_imageConfiguration) _UIStackedImageConfiguration *imageConfiguration;
- (Class)_labelClass;	// IMP=0x000000000009317d
- (double)_scaleForImageViewState;	// IMP=0x0000000000092f38
- (id)layeredImageContainerLayer;	// IMP=0x0000000000092504
...
- (void)clearPressStateWithDuration:(double)arg1;	// IMP=0x00000000000921ba
- (void)clearPressState;	// IMP=0x00000000000921a0
@property(readonly, nonatomic) _Bool allowsMotionEffects;
- (void)setOverlay:(id)arg1;	// IMP=0x00000000000920ba
- (void)prepareForReuse;	// IMP=0x000000000009202d
- (id)_preferredConfigurationForFocusAnimation:(long long)arg1 inContext:(id)arg2;	// IMP=0x0000000000091ee2
- (_Bool)_unapplyMotionEffect:(id)arg1;	// IMP=0x0000000000091eda
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000091d77
- (void)layoutSubviews;	// IMP=0x0000000000091d16
- (_Bool)_applyKeyPathsAndRelativeValues:(id)arg1 forMotionEffect:(id)arg2;	// IMP=0x0000000000091c4b
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000091c39
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000091b7a
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000091abb
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000919fc
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000918e3
- (void)willMoveToSuperview:(id)arg1;	// IMP=0x0000000000091876
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000091759
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000091522
