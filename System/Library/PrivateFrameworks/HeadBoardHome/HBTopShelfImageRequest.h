...
- (_Bool)_imageURLHasExtension:(id)arg1;	// IMP=0x0000000000048020
- (id)description;	// IMP=0x0000000000047ea8
...
- (id)initWithTopShelfImageRequest:(id)arg1;	// IMP=0x0000000000047d1b
