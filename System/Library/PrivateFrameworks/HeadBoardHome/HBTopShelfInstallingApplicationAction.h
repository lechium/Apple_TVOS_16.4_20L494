...
- (void).cxx_destruct;	// IMP=0x000000000004da4f
...
- (id)installApplicationProgress;	// IMP=0x000000000004da19
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000004d987
- (void)updateInstallApplicationPercentage:(double)arg1;	// IMP=0x000000000004d85a
- (id)initWithInstallApplicationAction:(id)arg1;	// IMP=0x000000000004d7b4
