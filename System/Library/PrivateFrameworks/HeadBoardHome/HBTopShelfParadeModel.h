...
- (void)_enumerateAppStoreParadeItemsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000026146
- (id)_logSafeDescriptionBuilder;	// IMP=0x0000000000026063
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000025f55
...
- (void)_removedFromController;	// IMP=0x0000000000025f03
- (void)_addedToController;	// IMP=0x0000000000025ed5
- (void)_applyItemUpdates:(id)arg1;	// IMP=0x0000000000025cf6
- (id)initWithApplicationIdentifier:(id)arg1 topShelfCarouselContent:(id)arg2;	// IMP=0x00000000000258e4
