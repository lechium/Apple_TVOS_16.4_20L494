...
- (void).cxx_destruct;	// IMP=0x000000000004dc76
...
- (id)description;	// IMP=0x000000000004db59
- (id)init;	// IMP=0x000000000004db40
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x000000000004da80
