...
+ (long long)_freshnessTypeFromTopShelfFreshnessType:(unsigned long long)arg1;	// IMP=0x001000000004757b
- (void).cxx_destruct;	// IMP=0x00000000000475ac
...
- (id)initWithTopShelfRottenTomatoesRating:(id)arg1;	// IMP=0x0000000000047378
