...
- (void).cxx_destruct;	// IMP=0x0000000000048942
...
- (id)decoratorIdentifier;	// IMP=0x0000000000048898
- (struct CGSize)expectedSize;	// IMP=0x0000000000048886
- (id)decorate:(id)arg1 scaledWithSize:(struct CGSize)arg2 croppedToFit:(_Bool)arg3;	// IMP=0x000000000004817a
