...
- (void).cxx_destruct;	// IMP=0x000000000000cb8b
...
- (id)copyFlattenedImage;	// IMP=0x000000000000c9ca
- (id)flattenedImage;	// IMP=0x000000000000c984
- (id)copyRadiosityImage;	// IMP=0x000000000000c83b
- (id)radiosityImage;	// IMP=0x000000000000c7f5
@property(readonly, nonatomic) double scale;
@property(readonly, nonatomic) struct CGSize size;
- (id)initWithApplication:(id)arg1;	// IMP=0x000000000000c54f
