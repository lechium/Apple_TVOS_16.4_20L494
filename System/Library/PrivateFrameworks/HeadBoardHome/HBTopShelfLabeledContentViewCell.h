...
- (void).cxx_destruct;	// IMP=0x0000000000036226
...
- (void)_updateDefaultUnhighlightedColor;	// IMP=0x000000000003605e
- (double)_maxTitleWidthWithFocus:(_Bool)arg1;	// IMP=0x0000000000036011
- (id)_animatedTitleLabel;	// IMP=0x0000000000035fff
- (Class)_labelClass;	// IMP=0x0000000000035fee
- (void)_updateTitleExpirationAppearance;	// IMP=0x0000000000035c99
- (void)_updateOverlayView;	// IMP=0x00000000000351e8
- (void)layoutSubviews;	// IMP=0x00000000000351a7
- (void)setUnhighlightedTextColor:(id)arg1;	// IMP=0x0000000000033ea5
- (id)unhighlightedTextColor;	// IMP=0x0000000000033e93
- (void)setHighlightedTextColor:(id)arg1;	// IMP=0x0000000000033e65
- (id)highlightedTextColor;	// IMP=0x0000000000033e53
- (void)setTitle:(id)arg1;	// IMP=0x0000000000033e25
- (id)title;	// IMP=0x0000000000033e13
- (void)didMoveToWindow;	// IMP=0x0000000000033da5
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000033ce6
- (void)prepareForReuse;	// IMP=0x0000000000033c46
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000003374b
- (void)dealloc;	// IMP=0x00000000000336ef
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000033583
