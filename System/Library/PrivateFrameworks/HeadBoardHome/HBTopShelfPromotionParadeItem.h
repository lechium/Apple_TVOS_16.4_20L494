...
- (id)_promotionImageName;	// IMP=0x000000000005c268
- (id)_topShelfPromotionCarouselItem;	// IMP=0x000000000005c256
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000005c18b
...
- (id)initWithTopShelfPromotionCarouselItem:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x000000000005c008
