...
- (void).cxx_destruct;	// IMP=0x000000000005f3c8
...
- (void)_deflateLayerStack;	// IMP=0x000000000005f1fb
- (void)_inflateLayerStack;	// IMP=0x000000000005edae
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x000000000005ec33
- (id)initWithApplication:(id)arg1;	// IMP=0x000000000005e78f
