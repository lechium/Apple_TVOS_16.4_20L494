...
- (void).cxx_destruct;	// IMP=0x0000000000004ff0
...
- (struct CGPath *)bottomStrokePath;	// IMP=0x0000000000004d88
- (struct CGPath *)topStrokePath;	// IMP=0x0000000000004c70
- (struct CGPath *)bottomStrokeLongPath;	// IMP=0x0000000000004a70
- (struct CGPath *)topStrokeLongPath;	// IMP=0x0000000000004870
- (id)strokeLayerWithPath:(struct CGPath *)arg1 color:(struct CGColor *)arg2;	// IMP=0x00000000000047a3
- (void)drawSolidShapeWithDuration:(double)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000004023
- (void)drawSolidShape;	// IMP=0x0000000000003e70
- (void)removeTransparentShapeWithDuration:(double)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000003a9d
- (void)drawTransparentShape;	// IMP=0x00000000000036d8
- (void)removeTransparentShape;	// IMP=0x0000000000003639
- (void)performFadeInIntroAnimation:(double)arg1 delay:(double)arg2;	// IMP=0x00000000000032ea
- (void)performSDrawingAnimationWithDuration:(double)arg1 delay:(double)arg2;	// IMP=0x0000000000003182
- (void)performSDrawingIntroAnimation;	// IMP=0x000000000000312b
- (void)skipIntroAnimation;	// IMP=0x00000000000030f8
- (void)layoutSublayers;	// IMP=0x0000000000002d50
- (void)setup;	// IMP=0x000000000000299e
