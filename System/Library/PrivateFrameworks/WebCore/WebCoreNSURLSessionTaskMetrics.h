...
- (id).cxx_construct;	// IMP=0x00000000022de6e0
- (void).cxx_destruct;	// IMP=0x00000000022de6c0
@property(readonly, copy) NSArray *transactionMetrics; // @dynamic transactionMetrics;
- (void)dealloc;	// IMP=0x00000000022de5a0
- (id)_initWithMetrics:(void *)arg1;	// IMP=0x00000000022de520
