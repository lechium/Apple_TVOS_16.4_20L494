...
- (id).cxx_construct;	// IMP=0x00000000022de4d0
- (void).cxx_destruct;	// IMP=0x00000000022de450
- (_Bool)multipath;	// IMP=0x00000000022de440
- (_Bool)constrained;	// IMP=0x00000000022de430
- (_Bool)expensive;	// IMP=0x00000000022de420
- (_Bool)cellular;	// IMP=0x00000000022de410
...
- (void)dealloc;	// IMP=0x00000000022ddfc0
- (id)_initWithMetrics:(void *)arg1;	// IMP=0x00000000022dded0
