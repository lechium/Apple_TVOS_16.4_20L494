...
- (id)actionForKey:(id)arg1;	// IMP=0x0000000000b249d0
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000b23cd0
- (void)renderInContext:(struct CGContext *)arg1;	// IMP=0x0000000000b23c70
- (void)layoutSublayers;	// IMP=0x0000000000b23bb0
- (void)setNeedsDisplayInRect:(struct CGRect)arg1;	// IMP=0x0000000000b23b60
