...
- (id).cxx_construct;	// IMP=0x00000000022e2ee0
- (void).cxx_destruct;	// IMP=0x00000000022e2dc0
...
- (void)resourceFinished:(void *)arg1 metrics:(const void *)arg2;	// IMP=0x00000000022e2cc0
- (void)resource:(void *)arg1 loadFailedWithError:(const void *)arg2;	// IMP=0x00000000022e2bc0
- (void)resource:(void *)arg1 accessControlCheckFailedWithError:(const void *)arg2;	// IMP=0x00000000022e2ac0
- (void)_resource:(void *)arg1 loadFinishedWithError:(id)arg2 metrics:(const void *)arg3;	// IMP=0x00000000022e26e0
- (void)resource:(void *)arg1 receivedRedirect:(const void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4;	// IMP=0x00000000022e21d0
- (void)resource:(void *)arg1 receivedData:(void *)arg2;	// IMP=0x00000000022e2090
- (_Bool)resource:(void *)arg1 shouldCacheResponse:(const void *)arg2;	// IMP=0x00000000022e2040
- (void)resource:(void *)arg1 receivedResponse:(const void *)arg2 completionHandler:(void *)arg3;	// IMP=0x00000000022e1be0
- (void)resource:(void *)arg1 sentBytes:(unsigned long long)arg2 totalBytesToBeSent:(unsigned long long)arg3;	// IMP=0x00000000022e1bd0
- (id)_timingData;	// IMP=0x00000000022e1bc0
- (void)dealloc;	// IMP=0x00000000022e19c0
- (void)resume;	// IMP=0x00000000022e1920
- (void)suspend;	// IMP=0x00000000022e1880
- (void)cancel;	// IMP=0x00000000022e17b0
...
- (void)_cancel;	// IMP=0x00000000022e1500
- (void)_restart;	// IMP=0x00000000022e0fb0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000022e0fa0
- (id)initWithSession:(id)arg1 identifier:(unsigned long long)arg2 request:(id)arg3;	// IMP=0x00000000022e0e70
