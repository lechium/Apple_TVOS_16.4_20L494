...
- (void).cxx_destruct;	// IMP=0x00000000000299d8
...
- (void)consumeStream:(struct __FSEventStream *)arg1 forVolume:(id)arg2;	// IMP=0x000000000002943a
- (void)callback:(id)arg1;	// IMP=0x00000000000286ee
- (void)dealloc;	// IMP=0x0000000000028677
- (id)initWithConsumer:(CDUnknownBlockType)arg1 identifier:(id)arg2;	// IMP=0x000000000002858a
