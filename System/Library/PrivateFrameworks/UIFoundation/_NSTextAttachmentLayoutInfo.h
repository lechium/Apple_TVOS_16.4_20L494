...
- (void)invalidateAttachmentMeasurements;	// IMP=0x000000000010d115
- (void)_invalidateLocations;	// IMP=0x000000000010d0f3
...
- (id)textLayoutFragment;	// IMP=0x000000000010ced8
@property(readonly) id <NSTextLocation> location; // @dynamic location;
- (void)_queryLayoutWithHorizontalOffset:(double)arg1;	// IMP=0x000000000010cd74
- (void)_queryLayout;	// IMP=0x000000000010cac3
- (void)dealloc;	// IMP=0x000000000010ca64
- (id)initWithContext:(id)arg1 location:(id)arg2 attributes:(id)arg3;	// IMP=0x000000000010c967
