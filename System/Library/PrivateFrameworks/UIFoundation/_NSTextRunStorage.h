...
- (void)invalidateElementsInRange:(id)arg1 delta:(long long)arg2;	// IMP=0x00000000000c0d1c
- (void)setObject:(id)arg1 forRange:(id)arg2;	// IMP=0x00000000000c061f
- (id)enumerateObjectsFromLocation:(id)arg1 options:(long long)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000bfd6e
@property(readonly) long long baseIndex;
@property(readonly) id <NSTextLocation> baseLocation;
- (id)description;	// IMP=0x00000000000bf783
- (void)dealloc;	// IMP=0x00000000000bf728
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000000000bf627
