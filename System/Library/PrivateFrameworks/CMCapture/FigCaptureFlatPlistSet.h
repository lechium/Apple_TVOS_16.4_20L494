...
- (id)objectEnumerator;	// IMP=0x0000000000004715
- (id)member:(id)arg1;	// IMP=0x000000000000461e
- (unsigned long long)count;	// IMP=0x000000000000460d
- (void)dealloc;	// IMP=0x00000000000045cb
- (id)initWithFlatPlist:(id)arg1 offset:(unsigned long long)arg2;	// IMP=0x0000000000004531
