...
- (void)remote_extractionEnteredPassthroughMode;	// IMP=0x00000000000025db
- (void)remote_extractionCompleteAtArchivePath:(id)arg1;	// IMP=0x0000000000002570
- (void)remote_setExtractionProgress:(double)arg1;	// IMP=0x0000000000002524
