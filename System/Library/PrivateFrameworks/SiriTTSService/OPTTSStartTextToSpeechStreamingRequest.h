...
- (void).cxx_destruct;	// IMP=0x0000000000020d6a
- (id)flatbuffData;	// IMP=0x0000000000020c28
- (Offset_acd6b661)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000002011d
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001f7bd
- (unsigned long long)context_info_count;	// IMP=0x000000000001f718
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000001f5f9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001f16e
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000001ef91
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2;	// IMP=0x000000000001ef7b
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000001ef60
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000001ef48
