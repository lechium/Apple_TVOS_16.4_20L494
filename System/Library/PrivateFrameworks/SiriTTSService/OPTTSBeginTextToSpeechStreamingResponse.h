...
- (void).cxx_destruct;	// IMP=0x0000000000021ed2
- (id)flatbuffData;	// IMP=0x0000000000021d90
- (Offset_afb4d078)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000021a2d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002156a
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BeginTextToSpeechStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000002138d
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BeginTextToSpeechStreamingResponse *)arg2;	// IMP=0x0000000000021377
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000002135c
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000021344
