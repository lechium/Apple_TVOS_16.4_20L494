...
+ (void)processServerLogs:(id)arg1;	// IMP=0x006000000002aadb
- (void).cxx_destruct;	// IMP=0x000000000002b63d
...
- (id)initWithOspreyPartialResponse:(id)arg1;	// IMP=0x000000000002a808
