...
- (id)flatbuffData;	// IMP=0x000000000001db73
- (Offset_91732649)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000001d168
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001c808
- (unsigned long long)context_info_count;	// IMP=0x000000000001c763
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000001c644
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001c227
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000001c04a
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2;	// IMP=0x000000000001c034
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000001c019
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000001c001
