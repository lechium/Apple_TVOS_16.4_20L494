...
- (void).cxx_destruct;	// IMP=0x0000000000013af3
...
- (void)invalidate;	// IMP=0x00000000000139b8
- (oneway void)revokeAuthorization;	// IMP=0x00000000000139a1
- (oneway void)grantAuthorizationForActivitySessionWithIdentifier:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x00000000000138fb
@property(readonly, nonatomic, getter=isConnectionActive) _Bool connectionActive;
- (void)transitionToStateIfPossible:(long long)arg1;	// IMP=0x0000000000013638
@property(readonly, nonatomic) long long state;
@property(readonly, copy) NSString *bundleIdentifier;
@property(readonly, copy) NSString *activitySessionIdentifier;
- (id)initWithConnection:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000013500
