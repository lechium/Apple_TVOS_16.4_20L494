...
- (void).cxx_destruct;	// IMP=0x00000000000421ae
...
- (void)resetChevronState;	// IMP=0x000000000004215f
- (void)setChevronHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x0000000000042129
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000041ece
- (void)layoutStashChevrons;	// IMP=0x0000000000041b16
- (void)layoutSubviews;	// IMP=0x0000000000041928
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000412ee
