...
- (void).cxx_destruct;	// IMP=0x0000000000031383
...
- (void)layoutSubviews;	// IMP=0x0000000000030e74
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000030dac
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000030d8f
- (double)_continuousCornerRadius;	// IMP=0x0000000000030d72
- (struct CGRect)_mainBodyBounds;	// IMP=0x0000000000030cff
@property(readonly, nonatomic) struct CGRect tabViewBounds;
- (void)setTabHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x0000000000030780
- (id)initWithFrame:(struct CGRect)arg1 minimumStashTabSize:(struct CGSize)arg2;	// IMP=0x0000000000030047
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000030025
