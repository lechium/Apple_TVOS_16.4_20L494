...
- (void).cxx_destruct;	// IMP=0x000000000000cda7
@property(nonatomic) double cornerRadiusScale; // @synthesize cornerRadiusScale=_cornerRadiusScale;
- (void)_manageSharingOfTouchesBetweenClientAndHostContext;	// IMP=0x000000000000cb22
- (void)didMoveToWindow;	// IMP=0x000000000000cb10
@property(retain, nonatomic) PGHostedWindowHostingHandle *hostedWindowHostingHandle;
- (void)dealloc;	// IMP=0x000000000000c9d9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000c947
