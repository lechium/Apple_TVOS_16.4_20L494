...
- (void).cxx_destruct;	// IMP=0x0000000000011f9f
...
- (void)_invalidateTimer;	// IMP=0x0000000000011ec8
- (void)_updateHideControlsAfterDelayTimer;	// IMP=0x0000000000011cf2
- (_Bool)_controlsShouldAutoHide;	// IMP=0x0000000000011c47
- (id)_performVisibilityTransitionAnimated:(_Bool)arg1 existingAnimator:(id)arg2 animations:(CDUnknownBlockType)arg3 success:(CDUnknownBlockType)arg4;	// IMP=0x0000000000011941
- (id)_updateVisibilityOfView:(id)arg1 hidden:(_Bool)arg2 animated:(_Bool)arg3 existingAnimator:(id)arg4;	// IMP=0x000000000001178c
- (void)_setControlsHidden:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000116e0
- (void)_setPrefersControlsHidden:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000011470
- (id)_acquirePreventAutoHideOfControlsAssertionWithReason:(id)arg1;	// IMP=0x0000000000011208
- (id)PG_acquireAssertionToPreventAutoHideOfControlsWithReason:(id)arg1;	// IMP=0x00000000000111f6
- (void)_handleHoverGestureRecognizer:(id)arg1;	// IMP=0x00000000000110da
- (void)_handleDoubleDoubleTapGestureRecognizer:(id)arg1;	// IMP=0x00000000000110ae
- (void)_handleDoubleTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000011091
- (void)_handleSingleTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000011046
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x0000000000010fb7
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000010e37
- (void)controlsViewModel:(id)arg1 valuesChangedFromOldValue:(id)arg2;	// IMP=0x0000000000010955
- (void)controlsViewModel:(id)arg1 didIssueCommand:(id)arg2;	// IMP=0x00000000000108a0
- (void)setHoverGestureDisbaled:(_Bool)arg1;	// IMP=0x000000000001087d
- (id)viewModel;	// IMP=0x0000000000010868
- (void)setControlsContainerHidden:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000010795
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000010721
- (void)layoutSubviews;	// IMP=0x0000000000010656
- (void)didMoveToWindow;	// IMP=0x0000000000010560
- (id)initWithFrame:(struct CGRect)arg1 viewModel:(id)arg2;	// IMP=0x0000000000010295
