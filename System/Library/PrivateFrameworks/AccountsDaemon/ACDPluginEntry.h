...
- (void).cxx_destruct;	// IMP=0x00000000000713c4
@property(readonly, nonatomic) NSBundle *bundle; // @synthesize bundle=_bundle;
- (id)debugDescription;	// IMP=0x000000000007128a
- (id)description;	// IMP=0x00000000000711e7
- (_Bool)principalObjectRespondsToSelector:(SEL)arg1;	// IMP=0x00000000000711b2
...
- (id)initWithBundle:(id)arg1;	// IMP=0x0000000000070d9b
- (id)init;	// IMP=0x0000000000070d70
