...
- (void).cxx_destruct;	// IMP=0x00000000000e712e
...
- (void)removeObserver:(id)arg1;	// IMP=0x00000000000e70fa
- (void)addObserver:(id)arg1;	// IMP=0x00000000000e70f4
- (id)initWithHFPEnabled:(_Bool)arg1;	// IMP=0x00000000000e70a6
