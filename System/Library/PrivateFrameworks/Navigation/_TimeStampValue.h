...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001537d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000015270
- (id)initWithTimeStamp:(double)arg1 timeZone:(id)arg2 formatPattern:(id)arg3;	// IMP=0x00000000000151b6
