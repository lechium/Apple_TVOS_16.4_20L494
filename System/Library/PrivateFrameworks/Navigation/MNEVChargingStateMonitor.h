...
- (void).cxx_destruct;	// IMP=0x000000000000622c
...
- (void)_notifyShouldShowChargingInfo;	// IMP=0x0000000000006189
- (void)_startTimer;	// IMP=0x0000000000005f74
- (void)updateForArrival;	// IMP=0x0000000000005f62
- (void)updateForLocation:(id)arg1;	// IMP=0x0000000000005e1d
- (void)dealloc;	// IMP=0x0000000000005ddb
- (id)initWithTargetBatteryCharge:(id)arg1;	// IMP=0x0000000000005d6c
