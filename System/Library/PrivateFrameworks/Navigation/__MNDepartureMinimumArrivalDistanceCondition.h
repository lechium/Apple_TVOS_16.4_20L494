...
- (void).cxx_destruct;	// IMP=0x00000000000d6fb2
- (double)scoreForLocation:(id)arg1;	// IMP=0x00000000000d6be9
- (id)initWithUpdater:(id)arg1 distanceThreshold:(double)arg2;	// IMP=0x00000000000d6b51
