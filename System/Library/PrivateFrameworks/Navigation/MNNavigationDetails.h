...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000bc331
- (void).cxx_destruct;	// IMP=0x00000000000c186b
...
- (id)description;	// IMP=0x00000000000c127a
@property(readonly, nonatomic) NSMapTable *routeIDLookup;
- (void)_updateRouteIDLookup;	// IMP=0x00000000000c0f28
- (id)removeTrafficIncidentAlert:(id)arg1;	// IMP=0x00000000000c0d2f
- (id)updateWithTrafficIncidentAlert:(id)arg1;	// IMP=0x00000000000c0c05
- (void)markAnnouncementSpoken:(id)arg1;	// IMP=0x00000000000c0b8a
- (id)routeLookupIDs;	// IMP=0x00000000000c0a44
- (id)routeInfoForRoute:(id)arg1;	// IMP=0x00000000000c09de
- (id)routeInfoForID:(id)arg1;	// IMP=0x00000000000c0859
- (void)updateETATrafficForRoute:(id)arg1;	// IMP=0x00000000000c05f1
- (void)setAlternateRoutes:(id)arg1;	// IMP=0x00000000000bf3e1
- (void)setCurrentRoute:(id)arg1 withAlternateRoutes:(id)arg2;	// IMP=0x00000000000be3f7
- (void)setPreviewRoutes:(id)arg1 withSelectedRouteIndex:(unsigned long long)arg2;	// IMP=0x00000000000bdd43
...
- (void)copySerializableValuesFrom:(id)arg1;	// IMP=0x00000000000bcf69
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000bca06
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000bc339
- (id)init;	// IMP=0x00000000000bc255
