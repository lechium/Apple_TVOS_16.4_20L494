...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004ba22
- (void).cxx_destruct;	// IMP=0x000000000004bc87
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004bb8a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004ba2a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004b979
