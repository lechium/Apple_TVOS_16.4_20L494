...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a0768
- (void).cxx_destruct;	// IMP=0x00000000000a0aba
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a095b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a0770
