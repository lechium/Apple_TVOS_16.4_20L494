...
- (void).cxx_destruct;	// IMP=0x00000000000d7d5a
- (double)scoreForLocation:(id)arg1;	// IMP=0x00000000000d77cf
- (id)initWithUpdater:(id)arg1 arrivalRegions:(id)arg2;	// IMP=0x00000000000d76ea
