...
- (void).cxx_destruct;	// IMP=0x000000000001511d
...
- (id)initWithToken:(id)arg1;	// IMP=0x0000000000014d46
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000014b94
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001476e
