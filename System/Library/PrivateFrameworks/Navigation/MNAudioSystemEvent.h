...
- (void).cxx_destruct;	// IMP=0x0000000000007920
...
- (id)description;	// IMP=0x0000000000007728
- (_Bool)isEqualToEvent:(id)arg1;	// IMP=0x00000000000075d5
@property(readonly, nonatomic) _Bool hasSoundEffect;
- (id)initWithUtterance:(id)arg1 andShortPrompt:(unsigned long long)arg2 andVoiceGuidanceLevel:(unsigned long long)arg3 andCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000074ae
