...
- (long long)behaviorType;	// IMP=0x00000000000111d3
- (void)_handleDidSeekToSeekTime:(_Bool)arg1;	// IMP=0x00000000000110ee
- (void)_callSeekCompletionHandler:(_Bool)arg1;	// IMP=0x0000000000011055
- (void)_seekIfNeeded;	// IMP=0x0000000000010f90
- (void)activeDidChange;	// IMP=0x0000000000010e8d
- (id)initWithInitialLayoutInfo:(id)arg1 seekTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000010de3
