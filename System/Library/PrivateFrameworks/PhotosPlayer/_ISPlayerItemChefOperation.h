...
- (void).cxx_destruct;	// IMP=0x000000000001dcb2
...
- (void)_preparePlayerItem;	// IMP=0x000000000001d0b2
- (void)_handleValuesDidLoad;	// IMP=0x000000000001d04d
- (void)main;	// IMP=0x000000000001cf7c
- (id)initWithAsset:(id)arg1 trimmedTimeRange:(CDStruct_e83c9415)arg2 photoTime:(CDStruct_1b6d18a9)arg3 includeAudio:(_Bool)arg4 includeVideo:(_Bool)arg5 resultHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000001ce35
