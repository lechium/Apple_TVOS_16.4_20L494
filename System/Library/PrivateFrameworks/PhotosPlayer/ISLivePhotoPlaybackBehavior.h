...
- (void)_showVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d84a
- (void)_transitionToVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d7b6
- (void)_startPlaybackWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d757
- (void)_didFinishPreparing;	// IMP=0x000000000000d705
- (void)_handleDidFinishPreroll;	// IMP=0x000000000000d6f3
- (void)_prerollWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000d611
- (void)_handleDidSeekToBeginning;	// IMP=0x000000000000d56d
- (void)_prepareVideoForPlaybackIfNeeded;	// IMP=0x000000000000d337
- (void)startPlayback;	// IMP=0x000000000000d2ac
- (void)activeDidChange;	// IMP=0x000000000000d22c
- (void)videoDidPlayToEnd;	// IMP=0x000000000000d1e8
- (void)_handleDidFinish;	// IMP=0x000000000000d179
- (void)videoWillPlayToEnd;	// IMP=0x000000000000cff4
- (long long)behaviorType;	// IMP=0x000000000000cfe9
@property(nonatomic) __weak id <ISLivePhotoPlaybackBehaviorDelegate> delegate; // @dynamic delegate;
- (id)initWithInitialLayoutInfo:(id)arg1 keyTime:(CDStruct_1b6d18a9)arg2 playbackTimeRange:(CDStruct_e83c9415)arg3 photoTransitionDuration:(double)arg4 immediatelyShowsPhotoWhenPlaybackEnds:(_Bool)arg5 hasBlurryTransition:(_Bool)arg6;	// IMP=0x000000000000ceac
