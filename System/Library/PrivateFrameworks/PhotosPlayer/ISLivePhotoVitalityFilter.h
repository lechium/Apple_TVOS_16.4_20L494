...
- (void).cxx_destruct;	// IMP=0x0000000000013d2b
...
- (void)updateOutput;	// IMP=0x0000000000013cc6
- (void)invalidateOutput;	// IMP=0x0000000000013caf
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000013c1f
- (void)setState:(long long)arg1;	// IMP=0x0000000000013ba1
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000013b36
- (id)init;	// IMP=0x0000000000013b22
