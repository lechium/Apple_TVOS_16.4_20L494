...
- (void)_stopObservingPlayer;	// IMP=0x0000000000002fcf
- (void)dealloc;	// IMP=0x0000000000002f91
- (void)cancel;	// IMP=0x0000000000002f7b
- (void)_didReachTargetTime;	// IMP=0x0000000000002de7
- (void)_stepDownRate;	// IMP=0x0000000000002b4a
- (void)start;	// IMP=0x0000000000002886
- (id)initWithTargetTime:(CDStruct_1b6d18a9)arg1 duration:(double)arg2 initialRate:(float)arg3 avPlayer:(id)arg4 progressHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000000027b1
