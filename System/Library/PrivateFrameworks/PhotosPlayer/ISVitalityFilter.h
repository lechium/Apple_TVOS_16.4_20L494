...
- (void).cxx_destruct;	// IMP=0x00000000000259b8
...
- (void)inputDidChange;	// IMP=0x00000000000257e2
- (void)_invalidateOutput;	// IMP=0x00000000000257cb
- (void)performOutputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000256f3
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000025663
- (id)initWithSettings:(id)arg1;	// IMP=0x00000000000255f8
