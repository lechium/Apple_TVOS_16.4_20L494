...
- (void).cxx_destruct;	// IMP=0x000000000001170e
...
- (id)initWithMask:(unsigned long long)arg1;	// IMP=0x00000000000115d9
- (void)setSmartCoverClosed:(_Bool)arg1;	// IMP=0x00000000000115d0
- (void)shouldSample:(_Bool)arg1 withDeadline:(unsigned long long)arg2 withOptions:(union)arg3;	// IMP=0x00000000000115c7
- (unsigned long long)minimumAttentionSamplerErrorRetryTime;	// IMP=0x00000000000115be
- (unsigned long long)nextSampleTimeForSamplingInterval:(unsigned long long)arg1;	// IMP=0x00000000000115b5
- (void)finishDeadlineComputationWithOptions:(union)arg1;	// IMP=0x0000000000011560
- (void)updateSamplingDeadline:(unsigned long long)arg1 forClient:(id)arg2;	// IMP=0x00000000000114fc
- (void)startDeadlineComputation;	// IMP=0x00000000000114cb
- (void)setUnitTestMode;	// IMP=0x00000000000114a5
- (id)description;	// IMP=0x000000000001140e
- (id)init;	// IMP=0x0000000000011369
