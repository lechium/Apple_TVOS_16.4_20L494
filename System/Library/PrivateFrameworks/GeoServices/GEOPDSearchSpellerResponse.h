...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000001196f60
+ (Class)tokenCandidatesType;	// IMP=0x001000000119521e
+ (Class)spellSuggestionType;	// IMP=0x0010000001194d33
- (void).cxx_destruct;	// IMP=0x0000000001198ffc
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000001198c38
- (unsigned long long)hash;	// IMP=0x00000000011988d6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000011985f6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000119808a
- (void)copyTo:(id)arg1;	// IMP=0x0000000001197d95
- (void)writeTo:(id)arg1;	// IMP=0x00000000011978a5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000001197898
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000001196aa6
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000001196a93
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000001196039
- (id)jsonRepresentation;	// IMP=0x000000000119602a
- (id)dictionaryRepresentation;	// IMP=0x0000000001195769
- (id)description;	// IMP=0x00000000011956ba
...
- (int)StringAsRankerModelType:(id)arg1;	// IMP=0x0000000001195497
- (id)rankerModelTypeAsString:(int)arg1;	// IMP=0x000000000119544e
...
- (id)tokenCandidatesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000011951ed
- (unsigned long long)tokenCandidatesCount;	// IMP=0x00000000011951c1
- (void)addTokenCandidates:(id)arg1;	// IMP=0x000000000119510c
- (void)clearTokenCandidates;	// IMP=0x00000000011950e3
...
- (int)StringAsResultStatus:(id)arg1;	// IMP=0x0000000001194e07
- (id)resultStatusAsString:(int)arg1;	// IMP=0x0000000001194dbc
@property(nonatomic) _Bool hasResultStatus;
@property(nonatomic) int resultStatus;
- (id)spellSuggestionAtIndex:(unsigned long long)arg1;	// IMP=0x0000000001194d02
- (unsigned long long)spellSuggestionsCount;	// IMP=0x0000000001194cd6
- (void)addSpellSuggestion:(id)arg1;	// IMP=0x0000000001194c21
- (void)clearSpellSuggestions;	// IMP=0x0000000001194bf8
@property(retain, nonatomic) NSMutableArray *spellSuggestions;
- (id)initWithData:(id)arg1;	// IMP=0x0000000001193cb5
- (id)init;	// IMP=0x0000000001193c59
