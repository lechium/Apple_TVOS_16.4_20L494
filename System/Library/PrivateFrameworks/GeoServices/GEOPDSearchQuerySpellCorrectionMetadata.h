...
- (void).cxx_destruct;	// IMP=0x0000000000aeba5a
- (unsigned long long)hash;	// IMP=0x0000000000aeb767
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aeb3e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aead91
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aea7cf
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aea7c0
- (id)jsonRepresentation;	// IMP=0x0000000000aea7b1
- (id)dictionaryRepresentation;	// IMP=0x0000000000ae9b20
- (id)description;	// IMP=0x0000000000ae9a71
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ae845e
- (id)init;	// IMP=0x0000000000ae8402
