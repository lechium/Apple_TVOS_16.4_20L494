...
- (void).cxx_destruct;	// IMP=0x0000000000685b57
- (unsigned long long)hash;	// IMP=0x00000000006858b7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000068570f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000068537c
- (void)writeTo:(id)arg1;	// IMP=0x000000000068504b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000068503c
- (id)jsonRepresentation;	// IMP=0x0000000000684234
- (id)dictionaryRepresentation;	// IMP=0x0000000000683c47
- (id)description;	// IMP=0x0000000000683b98
- (id)initWithData:(id)arg1;	// IMP=0x0000000000682bb8
- (id)init;	// IMP=0x0000000000682b5c
