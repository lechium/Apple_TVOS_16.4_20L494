...
- (void).cxx_destruct;	// IMP=0x000000000055bedc
- (unsigned long long)hash;	// IMP=0x000000000055bca3
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000055babc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000055b821
- (void)writeTo:(id)arg1;	// IMP=0x000000000055b58b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000055b57c
- (id)jsonRepresentation;	// IMP=0x000000000055ad1e
- (id)dictionaryRepresentation;	// IMP=0x000000000055a854
- (id)description;	// IMP=0x000000000055a7a5
- (id)initWithData:(id)arg1;	// IMP=0x0000000000559677
- (id)init;	// IMP=0x000000000055961b
