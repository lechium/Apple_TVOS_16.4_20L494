...
- (id).cxx_construct;	// IMP=0x000000000034ac1d
- (void).cxx_destruct;	// IMP=0x000000000034abf7
...
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000034abb8
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x000000000034ab7d
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000034a8dd
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *internalName;
@property(readonly, nonatomic) unsigned long long transitID;
@property(readonly, nonatomic) CDStruct_c3b9c2ee coordinate;
- (void)dealloc;	// IMP=0x000000000034a7b3
- (id)initWithMap:(id)arg1 node:(shared_ptr_52e51bdf)arg2;	// IMP=0x000000000034a6c4
