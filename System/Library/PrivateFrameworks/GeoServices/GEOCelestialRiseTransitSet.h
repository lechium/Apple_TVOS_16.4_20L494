...
- (id).cxx_construct;	// IMP=0x0000000000a351ea
- (void).cxx_destruct;	// IMP=0x0000000000a351b7
...
- (id)description;	// IMP=0x0000000000a34fc5
- (double)_oldestEventInJulianDay;	// IMP=0x0000000000a34f61
- (int)_numberOfEvents;	// IMP=0x0000000000a34f4b
...
- (id)_dateFromOffset:(double)arg1;	// IMP=0x0000000000a34dfc
- (id)initWithJulianDay:(double)arg1 riseTransitSet:(struct CAARiseTransitSetDetails)arg2;	// IMP=0x0000000000a34d9e
