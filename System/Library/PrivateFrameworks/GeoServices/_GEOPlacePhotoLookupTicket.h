...
- (void).cxx_destruct;	// IMP=0x000000000075442f
- (void)cancel;	// IMP=0x00000000007543a9
- (void)submitWithHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000007540dc
- (id)initWithVendorIdentifier:(id)arg1 mapItemIdentifier:(id)arg2 range:(struct _NSRange)arg3 traits:(id)arg4;	// IMP=0x0000000000753f99
