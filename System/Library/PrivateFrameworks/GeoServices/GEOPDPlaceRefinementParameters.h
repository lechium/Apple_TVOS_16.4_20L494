...
- (void).cxx_destruct;	// IMP=0x00000000005a347f
- (unsigned long long)hash;	// IMP=0x00000000005a3005
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005a2d69
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005a290f
- (void)writeTo:(id)arg1;	// IMP=0x00000000005a24b7
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005a24a8
- (id)jsonRepresentation;	// IMP=0x00000000005a10b0
- (id)dictionaryRepresentation;	// IMP=0x00000000005a07dc
- (id)description;	// IMP=0x00000000005a072d
- (id)initWithData:(id)arg1;	// IMP=0x000000000059f0e3
- (id)init;	// IMP=0x000000000059f087
- (_Bool)_routeHypothesisPlaceRefinementParametersIsEqual:(id)arg1;	// IMP=0x000000000115d472
- (unsigned long long)_routeHypothesisPlaceRefinementParametersHash;	// IMP=0x000000000115d3fd
- (_Bool)_hasRequiredFields;	// IMP=0x000000000115d3d1
- (id)initWithSearchURLQuery:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000137b276
- (id)initWithMapItemToRefine:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2;	// IMP=0x000000000137afd2
- (id)initWithIdentifier:(id)arg1 placeNameHint:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x000000000137adac
