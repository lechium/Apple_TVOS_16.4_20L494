...
- (void).cxx_destruct;	// IMP=0x0000000000af5a80
- (unsigned long long)hash;	// IMP=0x0000000000af597e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000af57a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000af567f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000af5571
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000af5562
- (id)jsonRepresentation;	// IMP=0x0000000000af5553
- (id)dictionaryRepresentation;	// IMP=0x0000000000af5225
- (id)description;	// IMP=0x0000000000af5176
