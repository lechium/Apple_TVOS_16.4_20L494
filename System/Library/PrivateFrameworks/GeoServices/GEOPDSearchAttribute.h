...
- (void).cxx_destruct;	// IMP=0x0000000000a91860
- (unsigned long long)hash;	// IMP=0x0000000000a91747
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a9153e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a912a6
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a90fff
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a90ff0
- (id)jsonRepresentation;	// IMP=0x0000000000a90d72
- (id)dictionaryRepresentation;	// IMP=0x0000000000a90737
- (id)description;	// IMP=0x0000000000a90688
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a8fd1d
- (id)init;	// IMP=0x0000000000a8fcc1
