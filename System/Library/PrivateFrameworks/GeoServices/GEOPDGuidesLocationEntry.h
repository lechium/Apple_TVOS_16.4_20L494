...
- (void).cxx_destruct;	// IMP=0x0000000000c34c1a
- (unsigned long long)hash;	// IMP=0x0000000000c34b2c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c34964
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c346de
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c3442b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c3441c
- (id)jsonRepresentation;	// IMP=0x0000000000c33748
- (id)dictionaryRepresentation;	// IMP=0x0000000000c3328b
- (id)description;	// IMP=0x0000000000c331dc
- (void)dealloc;	// IMP=0x0000000000c31e41
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c31de5
- (id)init;	// IMP=0x0000000000c31d89
