...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000118a1d4
- (void).cxx_destruct;	// IMP=0x000000000118b141
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000118a647
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000118a2ef
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000118a247
- (id)initWithIncident:(id)arg1;	// IMP=0x000000000118a1dc
