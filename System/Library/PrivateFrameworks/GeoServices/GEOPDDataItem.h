...
- (void).cxx_destruct;	// IMP=0x0000000000bef558
- (unsigned long long)hash;	// IMP=0x0000000000bef009
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000beee57
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000beebe3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bee8f3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bee8e4
- (id)jsonRepresentation;	// IMP=0x0000000000bec5ba
- (id)dictionaryRepresentation;	// IMP=0x0000000000bec144
- (id)description;	// IMP=0x0000000000bec095
- (id)initWithData:(id)arg1;	// IMP=0x0000000000beb11b
- (id)init;	// IMP=0x0000000000beb0bf
- (id)locationName;	// IMP=0x0000000000a41ead
- (id)categoryName;	// IMP=0x0000000000a41e32
