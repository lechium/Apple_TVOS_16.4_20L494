...
+ (id)placeInfoForPlaceData:(id)arg1;	// IMP=0x0010000000a3b03c
- (void).cxx_destruct;	// IMP=0x0000000000c91c7c
- (unsigned long long)hash;	// IMP=0x0000000000c91a8f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c91861
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c915a0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c9132f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c91320
- (id)jsonRepresentation;	// IMP=0x0000000000c90a32
- (id)dictionaryRepresentation;	// IMP=0x0000000000c9042e
- (id)description;	// IMP=0x0000000000c9037f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c8f373
- (id)init;	// IMP=0x0000000000c8f317
