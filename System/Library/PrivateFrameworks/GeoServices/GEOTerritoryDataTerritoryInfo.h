...
- (void).cxx_destruct;	// IMP=0x0000000000d76127
- (unsigned long long)hash;	// IMP=0x0000000000d7603c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d75e8b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d75c48
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d75988
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d7597b
- (id)jsonRepresentation;	// IMP=0x0000000000d7570b
- (id)dictionaryRepresentation;	// IMP=0x0000000000d7521f
- (id)description;	// IMP=0x0000000000d75170
- (void)dealloc;	// IMP=0x0000000000d740b4
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d74058
- (id)init;	// IMP=0x0000000000d73ffc
