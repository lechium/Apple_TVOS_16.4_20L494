...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000011bed3d
- (void).cxx_destruct;	// IMP=0x00000000011bf982
...
- (void)addLogoPath:(id)arg1;	// IMP=0x00000000011bf8ca
- (id)snippetLogoPathForScale:(double)arg1;	// IMP=0x00000000011bf5a4
- (id)logoPathForScale:(double)arg1;	// IMP=0x00000000011bf27e
- (_Bool)hasAttributionRequirement:(int)arg1;	// IMP=0x00000000011bf26f
- (id)description;	// IMP=0x00000000011bf1c0
- (id)dictionaryRepresentation;	// IMP=0x00000000011bf007
- (_Bool)supportsActionURLs;	// IMP=0x00000000011bed45
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000011bec37
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011be9fb
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000011be7d2
...
- (id)initWithSource:(id)arg1 localizedAttribution:(id)arg2 logoPaths:(id)arg3 snippetLogoPaths:(id)arg4;	// IMP=0x00000000011be55f
