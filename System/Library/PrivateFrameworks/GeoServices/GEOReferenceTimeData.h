...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002a39b5
...
- (id)description;	// IMP=0x00000000002a3cc4
- (double)currentReferenceTime;	// IMP=0x00000000002a3bc7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002a3b0b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002a3a32
- (id)initWithRefTime:(double)arg1 refError:(double)arg2 kernTime:(double)arg3 bootTime:(struct timeval)arg4;	// IMP=0x00000000002a39bd
