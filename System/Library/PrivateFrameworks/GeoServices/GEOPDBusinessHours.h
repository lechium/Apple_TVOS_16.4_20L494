...
+ (id)businessHoursForPlaceData:(id)arg1;	// IMP=0x0010000000a4244e
- (void).cxx_destruct;	// IMP=0x0000000000b5b04c
- (unsigned long long)hash;	// IMP=0x0000000000b5ad3e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b5ab66
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b5a78d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b5a2a2
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b5a293
- (id)jsonRepresentation;	// IMP=0x0000000000b58a83
- (id)dictionaryRepresentation;	// IMP=0x0000000000b5835a
- (id)description;	// IMP=0x0000000000b582ab
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b57143
- (id)init;	// IMP=0x0000000000b570e7
