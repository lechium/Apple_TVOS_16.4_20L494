...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000bf2ddd
- (void).cxx_destruct;	// IMP=0x0000000000bf4050
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000bf3fdd
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000bf3d97
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bf3874
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bf35d8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000bf344e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bf3177
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bf3168
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000bf2b84
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000bf2b72
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000bf2618
- (id)jsonRepresentation;	// IMP=0x0000000000bf2506
- (id)dictionaryRepresentation;	// IMP=0x0000000000bf2037
@property(readonly, copy) NSString *description;
@property(retain, nonatomic) NSString *displayNameOverride;
@property(readonly, nonatomic) _Bool hasDisplayNameOverride;
- (int)StringAsRealTimeStatusInfo:(id)arg1;	// IMP=0x0000000000bf1d98
- (id)realTimeStatusInfoAsString:(int)arg1;	// IMP=0x0000000000bf1d4f
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000bf0dd3
- (id)init;	// IMP=0x0000000000bf0d77
- (_Bool)isPastDepartureRelativeToDate:(id)arg1 usingGracePeriod:(_Bool)arg2;	// IMP=0x000000000118d037
