...
- (void).cxx_destruct;	// IMP=0x0000000000b2b99e
...
- (id)initWithProcess:(id)arg1 reason:(id)arg2 creationTimestamp:(double)arg3;	// IMP=0x0000000000b2b810
- (id)init;	// IMP=0x0000000000b2b7e6
