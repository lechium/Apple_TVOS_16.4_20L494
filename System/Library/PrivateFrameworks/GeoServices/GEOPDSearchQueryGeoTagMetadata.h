...
- (void).cxx_destruct;	// IMP=0x0000000000ac734b
- (unsigned long long)hash;	// IMP=0x0000000000ac72c1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ac71ad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ac6ebb
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ac6b72
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ac6b63
- (id)jsonRepresentation;	// IMP=0x0000000000ac6676
- (id)dictionaryRepresentation;	// IMP=0x0000000000ac6058
- (id)description;	// IMP=0x0000000000ac5fa9
- (void)dealloc;	// IMP=0x0000000000ac539c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ac5340
- (id)init;	// IMP=0x0000000000ac52e4
