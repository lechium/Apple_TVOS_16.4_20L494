...
+ (id)transitInfoSnippetForPlaceData:(id)arg1;	// IMP=0x0010000000a3a043
- (void).cxx_destruct;	// IMP=0x0000000000cebff5
- (unsigned long long)hash;	// IMP=0x0000000000cebecb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cebc7c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ceb671
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ceb074
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ceb065
- (id)jsonRepresentation;	// IMP=0x0000000000cea469
- (id)dictionaryRepresentation;	// IMP=0x0000000000ce9c0c
- (id)description;	// IMP=0x0000000000ce9b5d
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ce80d1
- (id)init;	// IMP=0x0000000000ce8075
