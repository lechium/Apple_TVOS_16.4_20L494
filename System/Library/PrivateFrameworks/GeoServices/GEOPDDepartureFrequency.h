...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000bf51c8
- (void).cxx_destruct;	// IMP=0x0000000000bf5bde
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000bf5b98
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000bf5aa5
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bf5853
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bf574a
- (void)copyTo:(id)arg1;	// IMP=0x0000000000bf566c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bf5563
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bf5554
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000bf4bb2
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000bf4ba0
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000bf484f
- (id)jsonRepresentation;	// IMP=0x0000000000bf473d
- (id)dictionaryRepresentation;	// IMP=0x0000000000bf437d
...
- (_Bool)isValidAtDate:(id)arg1;	// IMP=0x000000000118d39c
