...
- (void).cxx_destruct;	// IMP=0x0000000000c8a75b
- (unsigned long long)hash;	// IMP=0x0000000000c8a5b9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c8a31c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c89b47
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c894bf
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c894b0
- (id)jsonRepresentation;	// IMP=0x0000000000c881cf
- (id)dictionaryRepresentation;	// IMP=0x0000000000c87436
- (id)description;	// IMP=0x0000000000c87387
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c85552
- (id)init;	// IMP=0x0000000000c854f6
- (id)punchOutText;	// IMP=0x0000000000a41a5d
- (id)itemHTMLDescription;	// IMP=0x0000000000a41a07
- (id)itemDescription;	// IMP=0x0000000000a419b1
