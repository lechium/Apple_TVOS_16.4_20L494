...
- (void).cxx_destruct;	// IMP=0x000000000139f673
- (unsigned long long)hash;	// IMP=0x000000000139f59c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000139f43c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000139f20b
- (void)writeTo:(id)arg1;	// IMP=0x000000000139eefe
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000139eeef
- (id)jsonRepresentation;	// IMP=0x000000000139eddd
- (id)dictionaryRepresentation;	// IMP=0x000000000139e888
- (id)description;	// IMP=0x000000000139e7d9
- (void)dealloc;	// IMP=0x000000000139d9c6
- (id)initWithData:(id)arg1;	// IMP=0x000000000139d96a
- (id)init;	// IMP=0x000000000139d90e
