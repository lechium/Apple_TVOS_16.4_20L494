...
- (void).cxx_destruct;	// IMP=0x0000000000e37f8c
- (unsigned long long)hash;	// IMP=0x0000000000e37e63
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e37c63
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e379db
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e37765
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e37756
- (id)jsonRepresentation;	// IMP=0x0000000000e37644
- (id)dictionaryRepresentation;	// IMP=0x0000000000e3713b
- (id)description;	// IMP=0x0000000000e3708c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e361fe
- (id)init;	// IMP=0x0000000000e361a2
