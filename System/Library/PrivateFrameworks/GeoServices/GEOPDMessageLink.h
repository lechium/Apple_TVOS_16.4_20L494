...
+ (id)messageLinkForPlaceData:(id)arg1;	// IMP=0x0010000000a41025
- (void).cxx_destruct;	// IMP=0x0000000000c55e13
- (unsigned long long)hash;	// IMP=0x0000000000c55cf3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c55ad6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c556da
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c55365
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c55356
- (id)jsonRepresentation;	// IMP=0x0000000000c5517c
- (id)dictionaryRepresentation;	// IMP=0x0000000000c54b26
- (id)description;	// IMP=0x0000000000c54a77
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c5363e
- (id)init;	// IMP=0x0000000000c535e2
