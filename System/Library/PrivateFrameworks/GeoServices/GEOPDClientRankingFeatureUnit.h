...
- (void).cxx_destruct;	// IMP=0x000000000066c249
- (unsigned long long)hash;	// IMP=0x000000000066c15b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000066bfb3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000066bd45
- (void)writeTo:(id)arg1;	// IMP=0x000000000066bb1f
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000066bb10
- (id)jsonRepresentation;	// IMP=0x000000000066b78f
- (id)dictionaryRepresentation;	// IMP=0x000000000066b2f7
- (id)description;	// IMP=0x000000000066b248
- (id)initWithData:(id)arg1;	// IMP=0x000000000066a42b
- (id)init;	// IMP=0x000000000066a3cf
