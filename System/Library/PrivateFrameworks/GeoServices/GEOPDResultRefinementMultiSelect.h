...
- (void).cxx_destruct;	// IMP=0x0000000000e245ba
- (unsigned long long)hash;	// IMP=0x0000000000e244b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e242d8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e23f1d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e23bc8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e23bb9
- (id)jsonRepresentation;	// IMP=0x0000000000e23838
- (id)dictionaryRepresentation;	// IMP=0x0000000000e2322a
- (id)description;	// IMP=0x0000000000e2317b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e21f86
- (id)init;	// IMP=0x0000000000e21f2a
