...
- (void).cxx_destruct;	// IMP=0x00000000012d84c8
...
- (id)_chooseMostImportantTransitLegInRoute:(id)arg1;	// IMP=0x00000000012d833e
- (id)description;	// IMP=0x00000000012d8284
- (id)initWithComposedRoute:(id)arg1;	// IMP=0x00000000012d81df
