...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000013f23da
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000013f2538
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000013f248b
- (id)initWithWorkload:(unsigned long long)arg1 timeWindowDuration:(double)arg2;	// IMP=0x00000000013f243d
- (id)initWithWorkload:(unsigned long long)arg1 timeWindowStartTime:(double)arg2 timeWindowDuration:(double)arg3;	// IMP=0x00000000013f23e2
