...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000118b846
- (void).cxx_destruct;	// IMP=0x000000000118ba10
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000118b970
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000118b84e
...
- (id)initWithLine:(id)arg1 system:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x000000000118b361
