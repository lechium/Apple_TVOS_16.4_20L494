...
- (void).cxx_destruct;	// IMP=0x0000000000ad1377
- (unsigned long long)hash;	// IMP=0x0000000000ad12ae
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ad1100
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ad0aca
- (void)writeTo:(id)arg1;	// IMP=0x0000000000acf4eb
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000acf4dc
- (id)jsonRepresentation;	// IMP=0x0000000000ac92bb
- (id)dictionaryRepresentation;	// IMP=0x0000000000ac8876
- (id)description;	// IMP=0x0000000000ac87c7
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ac73e9
- (id)init;	// IMP=0x0000000000ac738d
