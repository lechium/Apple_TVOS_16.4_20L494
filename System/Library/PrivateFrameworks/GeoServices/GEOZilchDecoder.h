...
+ (_Bool)decodingSupported;	// IMP=0x0060000000d1d1fe
- (id).cxx_construct;	// IMP=0x0000000000d1d5a1
- (void).cxx_destruct;	// IMP=0x0000000000d1d552
...
- (void)requestComplete:(id)arg1;	// IMP=0x0000000000d1d488
- (void)trackRequest:(id)arg1;	// IMP=0x0000000000d1d3fc
- (id)decodeZilchMessage:(shared_ptr_27244a92)arg1 pathHandler:(CDUnknownBlockType)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000d1d2e9
- (void)setRequestQueue:(id)arg1;	// IMP=0x0000000000d1d2d5
- (id)requestQueue;	// IMP=0x0000000000d1d2c0
- (id)init;	// IMP=0x0000000000d1d217
