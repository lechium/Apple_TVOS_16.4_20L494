...
- (id).cxx_construct;	// IMP=0x00000000010407da
- (void).cxx_destruct;	// IMP=0x0000000001040744
...
- (void)cancel;	// IMP=0x000000000104064b
- (void)decodeWithPathHandler:(CDUnknownBlockType)arg1 errorHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000103f92d
- (void)_finishedDecodingWithPath:(Path_3f73a495)arg1;	// IMP=0x000000000103f7a1
- (id)initWithDecoder:(id)arg1 message:(shared_ptr_27244a92)arg2;	// IMP=0x000000000103f5b0
