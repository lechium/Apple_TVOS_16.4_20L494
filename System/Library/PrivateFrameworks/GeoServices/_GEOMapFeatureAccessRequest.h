...
- (void).cxx_destruct;	// IMP=0x000000000111dec8
@property(readonly, nonatomic) GEOTileLoader *tileLoader; // @synthesize tileLoader=_tileLoader;
- (void)cancel;	// IMP=0x000000000111dc94
- (void)addTileRequest:(id)arg1;	// IMP=0x000000000111dbe7
- (id)initWithTileLoader:(id)arg1;	// IMP=0x000000000111db37
