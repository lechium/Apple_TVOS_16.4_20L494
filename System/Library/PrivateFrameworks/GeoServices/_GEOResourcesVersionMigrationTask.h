...
+ (id)_resourcesDirectory:(id)arg1;	// IMP=0x0010000000a2f243
+ (Class)_resourceLoaderClass;	// IMP=0x0010000000a2f232
- (void).cxx_destruct;	// IMP=0x0000000000a32dfd
...
- (id)_staleResourceForResource:(id)arg1;	// IMP=0x0000000000a31c58
- (void)_loadImmediateResources:(id)arg1 conditionalWifiResources:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a313db
- (void)removeOldData:(id)arg1;	// IMP=0x0000000000a30af1
- (void)populateTileGroup:(id)arg1;	// IMP=0x0000000000a30602
- (void)cancel;	// IMP=0x0000000000a303e3
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000000a2f29c
- (id)_resourcesDirectory;	// IMP=0x0000000000a2f274
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 dataSet:(id)arg5 oldTileGroup:(id)arg6 activeScales:(id)arg7 activeScenarios:(id)arg8;	// IMP=0x0000000000a2ef7c
- (id)init;	// IMP=0x0000000000a2ef52
