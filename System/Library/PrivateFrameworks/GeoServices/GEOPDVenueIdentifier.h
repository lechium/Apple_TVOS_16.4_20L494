...
- (void).cxx_destruct;	// IMP=0x00000000011c8fbe
- (unsigned long long)hash;	// IMP=0x00000000011c8aaa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000011c8867
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000011c85cf
- (void)writeTo:(id)arg1;	// IMP=0x00000000011c82a7
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000011c8298
- (id)jsonRepresentation;	// IMP=0x00000000011c6f7b
- (id)dictionaryRepresentation;	// IMP=0x00000000011c6985
- (id)description;	// IMP=0x00000000011c68d6
- (void)dealloc;	// IMP=0x00000000011c56d0
- (id)initWithData:(id)arg1;	// IMP=0x00000000011c5674
- (id)init;	// IMP=0x00000000011c5618
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000a4302a
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3 componentIdentifier:(id)arg4;	// IMP=0x0000000000a42bfe
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3;	// IMP=0x0000000000a42afc
