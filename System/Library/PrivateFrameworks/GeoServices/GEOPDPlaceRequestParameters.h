...
- (void).cxx_destruct;	// IMP=0x00000000005e0280
- (unsigned long long)hash;	// IMP=0x00000000005dfcc7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005df229
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005de8cc
- (void)writeTo:(id)arg1;	// IMP=0x00000000005dc88a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005dc87b
- (id)jsonRepresentation;	// IMP=0x00000000005c8031
- (id)dictionaryRepresentation;	// IMP=0x00000000005c5b64
- (id)description;	// IMP=0x00000000005c5ab5
- (id)initWithData:(id)arg1;	// IMP=0x00000000005be900
- (id)init;	// IMP=0x00000000005be8a4
- (id)initWithSearchURLQuery:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2 maxResults:(unsigned int)arg3 traits:(id)arg4;	// IMP=0x000000000137e78b
- (id)initWithSearchURLQuery:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2 muid:(unsigned long long)arg3 resultProviderId:(int)arg4 contentProvider:(id)arg5;	// IMP=0x000000000137e6a6
- (id)initWithSearchURLQuery:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000137e5e7
- (id)initWithSearchQuery:(id)arg1 entryMetadata:(id)arg2 metadata:(id)arg3 autocompleteEntry:(id)arg4 retainedSearch:(id)arg5 maxResults:(unsigned int)arg6 filters:(id)arg7 traits:(id)arg8 routeInfo:(id)arg9 error:(id *)arg10;	// IMP=0x000000000137e2ec
- (id)initWithBrandMUID:(unsigned long long)arg1 traits:(id)arg2;	// IMP=0x000000000137e180
- (id)initWithCanonicalLocationSearchQueryString:(id)arg1;	// IMP=0x000000000137e0e6
- (id)initWithVendorSpecificPlaceRefinementParameters:(id)arg1 traits:(id)arg2;	// IMP=0x000000000137e06f
- (id)initWithPlaceRefinementParameters:(id)arg1 traits:(id)arg2;	// IMP=0x000000000137dff8
- (id)initWithMapItemToRefine:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2 traits:(id)arg3;	// IMP=0x000000000137df42
- (id)initWithMapItemToRefine:(id)arg1 traits:(id)arg2;	// IMP=0x000000000137dec5
- (id)initWithForwardGeocodeAddressString:(id)arg1 maxResults:(unsigned int)arg2 traits:(id)arg3;	// IMP=0x000000000137ddfc
- (id)initWithForwardGeocodeAddress:(id)arg1 maxResults:(unsigned int)arg2 traits:(id)arg3;	// IMP=0x000000000137dd33
- (id)initWithBatchReverseGeocodeLocations:(id)arg1 additionalPlaceTypes:(int *)arg2 additionalPlaceTypesCount:(unsigned long long)arg3 traits:(id)arg4;	// IMP=0x000000000137dc39
- (id)initWithReverseGeocodeCoordinate:(CDStruct_c3b9c2ee)arg1 preserveOriginalLocation:(_Bool)arg2;	// IMP=0x000000000137dc22
- (id)initWithReverseGeocodeCoordinate:(CDStruct_c3b9c2ee)arg1;	// IMP=0x000000000137dc0e
- (id)initWithReverseGeocodeLocation:(id)arg1 preserveOriginalLocation:(_Bool)arg2 placeTypeLimit:(int)arg3;	// IMP=0x000000000137db11
- (id)initWithReverseGeocodeCoordinate:(CDStruct_c3b9c2ee)arg1 preserveOriginalLocation:(_Bool)arg2 floorOrdinal:(int)arg3;	// IMP=0x000000000137da19
- (id)initWithExternalTransitStationCodes:(id)arg1 sourceID:(id)arg2 transactionDate:(id)arg3 transactionLocation:(id)arg4;	// IMP=0x000000000137d788
- (id)initWithAirportCode:(id)arg1 terminalCode:(id)arg2 gateCode:(id)arg3 traits:(id)arg4;	// IMP=0x000000000137d6a9
- (id)initWithMerchantCode:(id)arg1 rawMerchantCode:(id)arg2 relyingPartyIdentifier:(id)arg3 industryCategory:(id)arg4 industryCode:(id)arg5 paymentNetwork:(id)arg6 transactionDate:(id)arg7 transactionLocation:(id)arg8 terminalId:(id)arg9 transactionCurrencyCode:(id)arg10 transactionType:(int)arg11 transactionId:(id)arg12 warsawMerchantDomain:(id)arg13 warsawMerchantName:(id)arg14 warsawMerchantId:(id)arg15 adamId:(id)arg16 merchantId:(id)arg17 merchantDoingBizAsName:(id)arg18 merchantEnhancedName:(id)arg19 merchantCity:(id)arg20 merchantRawCity:(id)arg21 merchantState:(id)arg22 merchantRawState:(id)arg23 merchantZip:(id)arg24 merchantAddress:(id)arg25 merchantRawAddress:(id)arg26 merchantCountryCode:(id)arg27 merchantType:(id)arg28 merchantCleanConfidenceLevel:(id)arg29 merchantAdditionalData:(id)arg30 merchantCanl:(id)arg31 brandFallbackSupported:(_Bool)arg32 isSettlement:(_Bool)arg33 isRefund:(_Bool)arg34 fuzzyMatched:(id)arg35 coarseLocationUsed:(id)arg36;	// IMP=0x000000000137c99b
- (id)initWithExternalBusinessID:(id)arg1 contentProvider:(id)arg2;	// IMP=0x000000000137c8dc
- (id)initWithIdentifiers:(id)arg1 resultProviderID:(int)arg2;	// IMP=0x000000000137c834
- (void)clearLocations;	// IMP=0x00000000013abe62
