...
- (void).cxx_destruct;	// IMP=0x00000000011addbf
...
- (void)removeOldData:(id)arg1;	// IMP=0x00000000011add83
- (void)populateTileGroup:(id)arg1;	// IMP=0x00000000011add13
- (void)cancel;	// IMP=0x00000000011add0d
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x00000000011adc2b
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 oldTileGroup:(id)arg5 dataSet:(id)arg6;	// IMP=0x00000000011adaa3
- (id)init;	// IMP=0x00000000011ada79
