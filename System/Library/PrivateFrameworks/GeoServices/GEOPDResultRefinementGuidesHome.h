...
- (void).cxx_destruct;	// IMP=0x0000000000e1bfea
- (unsigned long long)hash;	// IMP=0x0000000000e1bef3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e1bd0c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e1ba71
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e1b7e5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e1b7d6
- (id)jsonRepresentation;	// IMP=0x0000000000e1b1d6
- (id)dictionaryRepresentation;	// IMP=0x0000000000e1ab36
- (id)description;	// IMP=0x0000000000e1aa87
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e19a59
- (id)init;	// IMP=0x0000000000e199fd
