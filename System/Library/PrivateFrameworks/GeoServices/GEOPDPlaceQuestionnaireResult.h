...
- (void).cxx_destruct;	// IMP=0x0000000001417a81
- (unsigned long long)hash;	// IMP=0x00000000014173a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000141714d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001416d6a
- (void)writeTo:(id)arg1;	// IMP=0x00000000014167ef
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000014167e0
- (id)jsonRepresentation;	// IMP=0x00000000014147b0
- (id)dictionaryRepresentation;	// IMP=0x00000000014140a4
- (id)description;	// IMP=0x0000000001413ff5
- (id)initWithData:(id)arg1;	// IMP=0x0000000001412d73
- (id)init;	// IMP=0x0000000001412d17
