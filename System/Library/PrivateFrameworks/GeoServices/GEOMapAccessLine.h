...
- (id).cxx_construct;	// IMP=0x00000000011ae230
- (void).cxx_destruct;	// IMP=0x00000000011ae1f8
- (double)distanceFromCoordinate:(CDStruct_c3b9c2ee)arg1 outSegmentCoordinate:(struct PolylineCoordinate *)arg2;	// IMP=0x00000000011adf52
...
- (id)initWithMap:(id)arg1 edge:(shared_ptr_035a2da2)arg2;	// IMP=0x00000000011ade32
