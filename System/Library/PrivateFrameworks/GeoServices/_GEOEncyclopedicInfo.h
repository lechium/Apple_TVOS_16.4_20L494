...
- (void).cxx_destruct;	// IMP=0x0000000000766e11
- (id)firstFactoidForSemantic:(int)arg1;	// IMP=0x0000000000766cb4
- (id)factoidAtIndex:(int)arg1;	// IMP=0x0000000000766c04
...
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2;	// IMP=0x0000000000766679
