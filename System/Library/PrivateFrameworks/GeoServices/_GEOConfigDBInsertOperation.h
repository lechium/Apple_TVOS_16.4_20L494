...
- (void).cxx_destruct;	// IMP=0x0000000000294fc6
- (_Bool)performOperation;	// IMP=0x0000000000294f1f
- (id)init:(id)arg1 rowId:(long long)arg2 type:(id)arg3 key:(id)arg4 value:(id)arg5 parentId:(long long)arg6;	// IMP=0x0000000000294e0e
