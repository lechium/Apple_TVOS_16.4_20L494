...
- (void).cxx_destruct;	// IMP=0x00000000013ab02d
...
- (void)setSectionOptions:(id)arg1;	// IMP=0x00000000013aafe7
- (void)setRideSelections:(id)arg1;	// IMP=0x00000000013aafd3
- (void)setIsWalkingOnlyRoute:(_Bool)arg1;	// IMP=0x00000000013aafc3
