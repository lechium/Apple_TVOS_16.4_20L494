...
- (void).cxx_destruct;	// IMP=0x0000000000753e19
- (void)_handleResponse:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000753bb9
- (void)_submitRequest:(id)arg1 auditToken:(id)arg2 timeout:(double)arg3 withHandler:(CDUnknownBlockType)arg4 networkActivity:(CDUnknownBlockType)arg5;	// IMP=0x0000000000753a5c
- (void)_processRequest:(id)arg1 auditToken:(id)arg2 timeout:(double)arg3 withHandler:(CDUnknownBlockType)arg4 refinedHandler:(CDUnknownBlockType)arg5 networkActivity:(CDUnknownBlockType)arg6;	// IMP=0x0000000000752fd8
- (id)initWithRequest:(id)arg1 locationShifter:(CDUnknownBlockType)arg2 traits:(id)arg3;	// IMP=0x0000000000752f37
