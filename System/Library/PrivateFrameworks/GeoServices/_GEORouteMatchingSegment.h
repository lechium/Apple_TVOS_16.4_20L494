...
- (void).cxx_destruct;	// IMP=0x00000000011e8df9
...
- (id)description;	// IMP=0x00000000011e8c99
- (double)distanceFromCoordinate:(CDStruct_c3b9c2ee)arg1 outCoordinateOnSegment:(CDStruct_c3b9c2ee *)arg2 outRouteCoordinate:(struct PolylineCoordinate *)arg3;	// IMP=0x00000000011e8b24
