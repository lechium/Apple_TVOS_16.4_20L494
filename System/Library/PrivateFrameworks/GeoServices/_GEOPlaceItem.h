...
- (void).cxx_destruct;	// IMP=0x0000000000873279
...
- (id)_placecardLayoutConfiguration;	// IMP=0x0000000000873251
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x0000000000873249
...
- (id)_businessClaim;	// IMP=0x0000000000873201
- (_Bool)_hasBusinessClaim;	// IMP=0x00000000008731f9
- (id)_mapItemByStrippingOptionalData;	// IMP=0x00000000008731f0
@property(readonly, nonatomic, getter=_photos) NSArray *photos;
@property(readonly, nonatomic, getter=_reviews) NSArray *reviews;
- (id)_asPlaceInfo;	// IMP=0x0000000000873198
...
- (id)_yelpID;	// IMP=0x0000000000872f3e
...
- (id)_urlForWritingAReview;	// IMP=0x0000000000872f26
- (id)_urlForReview:(id)arg1;	// IMP=0x0000000000872f1e
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x0000000000872f16
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000872e93
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000872e8b
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x0000000000872aee
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x0000000000872aac
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x0000000000872a6a
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x0000000000872a4d
- (int)_recommendedTransportType;	// IMP=0x0000000000872a42
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x0000000000872a25
...
- (id)weatherDisplayName;	// IMP=0x000000000087297d
- (id)addressObject;	// IMP=0x00000000008728ca
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x00000000008722fa
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x000000000087223d
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x0000000000872059
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x0000000000871f80
