...
- (void).cxx_destruct;	// IMP=0x0000000000522911
- (unsigned long long)hash;	// IMP=0x0000000000522677
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000052224d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000052193b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000520d55
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000520d46
- (id)jsonRepresentation;	// IMP=0x000000000052023d
- (id)dictionaryRepresentation;	// IMP=0x000000000051f00d
- (id)description;	// IMP=0x000000000051ef5e
- (id)initWithData:(id)arg1;	// IMP=0x000000000051c14e
- (id)init;	// IMP=0x000000000051c0f2
