...
- (void).cxx_destruct;	// IMP=0x0000000000e022cb
- (unsigned long long)hash;	// IMP=0x0000000000e01e5b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e01b94
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e0172d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e0133a
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e0132b
- (id)jsonRepresentation;	// IMP=0x0000000000e00706
- (id)dictionaryRepresentation;	// IMP=0x0000000000dffe67
- (id)description;	// IMP=0x0000000000dffdb8
- (id)initWithData:(id)arg1;	// IMP=0x0000000000dfe4f9
- (id)init;	// IMP=0x0000000000dfe49d
