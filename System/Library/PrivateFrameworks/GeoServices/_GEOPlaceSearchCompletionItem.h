...
- (void).cxx_destruct;	// IMP=0x0000000000758961
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000758553
@property(readonly, nonatomic) NSData *metadata;
@property(readonly, nonatomic) NSData *entryMetadata;
- (void)sendFeedback;	// IMP=0x000000000075845d
- (_Bool)getCoordinate:(CDStruct_c3b9c2ee *)arg1;	// IMP=0x00000000007582eb
...
- (id)calloutTitle;	// IMP=0x0000000000757f4c
- (id)queryLine;	// IMP=0x0000000000757e2d
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x0000000000757dde
- (id)initWithEntry:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 entryIndex:(int)arg4 mapItems:(id)arg5 collections:(id)arg6 publishers:(id)arg7;	// IMP=0x00000000007567b5
