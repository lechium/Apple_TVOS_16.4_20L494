...
- (void).cxx_destruct;	// IMP=0x0000000000c52f0f
- (unsigned long long)hash;	// IMP=0x0000000000c52e1f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c52c82
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c528e9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c525af
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c525a0
- (id)jsonRepresentation;	// IMP=0x0000000000c51c84
- (id)dictionaryRepresentation;	// IMP=0x0000000000c5169d
- (id)description;	// IMP=0x0000000000c515ee
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c505a8
- (id)init;	// IMP=0x0000000000c5054c
