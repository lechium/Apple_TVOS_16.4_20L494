...
- (void).cxx_destruct;	// IMP=0x000000000060605a
- (unsigned long long)hash;	// IMP=0x0000000000605dd0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000605b14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000060580a
- (void)writeTo:(id)arg1;	// IMP=0x00000000006054e1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006054d2
- (id)jsonRepresentation;	// IMP=0x00000000006048c4
- (id)dictionaryRepresentation;	// IMP=0x0000000000603f9d
- (id)description;	// IMP=0x0000000000603eee
- (void)dealloc;	// IMP=0x00000000006029ff
- (id)initWithData:(id)arg1;	// IMP=0x00000000006029a3
- (id)init;	// IMP=0x0000000000602947
