...
- (void).cxx_destruct;	// IMP=0x0000000000ae4d49
- (unsigned long long)hash;	// IMP=0x0000000000ae48de
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ae422f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ae39e3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ae318b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ae317c
- (id)jsonRepresentation;	// IMP=0x0000000000ad61b3
- (id)dictionaryRepresentation;	// IMP=0x0000000000ad3d84
- (id)description;	// IMP=0x0000000000ad3cd5
- (void)dealloc;	// IMP=0x0000000000ad14b5
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ad1459
- (id)init;	// IMP=0x0000000000ad13fd
