...
- (void).cxx_destruct;	// IMP=0x00000000006da901
- (unsigned long long)hash;	// IMP=0x00000000006da7fb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006da620
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006da084
- (void)writeTo:(id)arg1;	// IMP=0x00000000006d9b70
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006d9b61
- (id)jsonRepresentation;	// IMP=0x00000000006d97e0
- (id)dictionaryRepresentation;	// IMP=0x00000000006d91c0
- (id)description;	// IMP=0x00000000006d9111
- (void)dealloc;	// IMP=0x00000000006d7e73
- (id)initWithData:(id)arg1;	// IMP=0x00000000006d7e17
- (id)init;	// IMP=0x00000000006d7dbb
