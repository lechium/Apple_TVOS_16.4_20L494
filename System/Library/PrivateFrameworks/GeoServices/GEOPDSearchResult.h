...
- (void).cxx_destruct;	// IMP=0x00000000006174e0
- (unsigned long long)hash;	// IMP=0x0000000000617150
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000616b57
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000615e3c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000615371
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000615362
- (id)jsonRepresentation;	// IMP=0x0000000000615250
- (id)dictionaryRepresentation;	// IMP=0x0000000000613586
- (id)description;	// IMP=0x00000000006134d7
- (id)initWithData:(id)arg1;	// IMP=0x000000000060f49a
- (id)init;	// IMP=0x000000000060f43e
