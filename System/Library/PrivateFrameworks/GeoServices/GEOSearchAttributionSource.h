...
- (void).cxx_destruct;	// IMP=0x00000000010d8725
- (unsigned long long)hash;	// IMP=0x00000000010d85c5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000010d8349
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000010d7c8e
- (void)writeTo:(id)arg1;	// IMP=0x00000000010d7642
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000010d7633
- (id)jsonRepresentation;	// IMP=0x00000000010d7624
- (id)dictionaryRepresentation;	// IMP=0x00000000010d6beb
- (id)description;	// IMP=0x00000000010d6b3c
- (void)dealloc;	// IMP=0x00000000010d4e87
- (id)initWithData:(id)arg1;	// IMP=0x00000000010d4e2b
- (id)init;	// IMP=0x00000000010d4dcf
