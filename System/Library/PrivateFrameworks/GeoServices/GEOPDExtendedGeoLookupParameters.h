...
- (void).cxx_destruct;	// IMP=0x000000000052d83a
- (unsigned long long)hash;	// IMP=0x000000000052d6f2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000052d4bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000052d1fc
- (void)writeTo:(id)arg1;	// IMP=0x000000000052ced2
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000052cec3
- (id)jsonRepresentation;	// IMP=0x000000000052cb42
- (id)dictionaryRepresentation;	// IMP=0x000000000052c3df
- (id)description;	// IMP=0x000000000052c330
- (void)dealloc;	// IMP=0x000000000052b0e3
- (id)initWithData:(id)arg1;	// IMP=0x000000000052b087
- (id)init;	// IMP=0x000000000052b02b
