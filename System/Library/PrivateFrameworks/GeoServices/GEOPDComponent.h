...
- (void).cxx_destruct;	// IMP=0x0000000000b92978
@property(nonatomic) _Bool hasTimestampFirstSeen;
@property(nonatomic) double timestampFirstSeen;
- (unsigned long long)hash;	// IMP=0x0000000000b8d008
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b8ccfa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b8c7bd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b8c343
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b8c334
- (id)jsonRepresentation;	// IMP=0x0000000000b7f42c
- (id)dictionaryRepresentation;	// IMP=0x0000000000b7e3a4
- (id)description;	// IMP=0x0000000000b7e2f5
- (_Bool)statusCodeIsValid;	// IMP=0x0000000000a4317a
