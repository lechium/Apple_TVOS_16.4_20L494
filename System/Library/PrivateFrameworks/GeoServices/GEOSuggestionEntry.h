...
- (void).cxx_destruct;	// IMP=0x0000000001011748
- (unsigned long long)hash;	// IMP=0x000000000101163e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001011427
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001010f55
- (void)writeTo:(id)arg1;	// IMP=0x0000000001010a95
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000001010a86
- (id)jsonRepresentation;	// IMP=0x0000000001010705
- (id)dictionaryRepresentation;	// IMP=0x000000000100fcbf
- (id)description;	// IMP=0x000000000100fc10
- (void)dealloc;	// IMP=0x000000000100ea30
- (id)initWithData:(id)arg1;	// IMP=0x000000000100e9d4
- (id)init;	// IMP=0x000000000100e978
