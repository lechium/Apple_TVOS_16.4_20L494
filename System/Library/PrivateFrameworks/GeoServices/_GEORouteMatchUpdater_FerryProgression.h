...
- (void).cxx_destruct;	// IMP=0x00000000011ace4d
- (unsigned long long)priority;	// IMP=0x00000000011ace42
- (_Bool)updateRouteMatch:(id)arg1 previousRouteMatch:(id)arg2 forLocation:(id)arg3;	// IMP=0x00000000011acc3b
- (id)initWithRoute:(id)arg1 tripSegment:(id)arg2;	// IMP=0x00000000011aca71
