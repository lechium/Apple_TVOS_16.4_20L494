...
- (void).cxx_destruct;	// IMP=0x0000000000a8fc3b
- (unsigned long long)hash;	// IMP=0x0000000000a8fb58
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a8f995
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a8f50b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a8f0cf
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a8f0c0
- (id)jsonRepresentation;	// IMP=0x0000000000a8d7df
- (id)dictionaryRepresentation;	// IMP=0x0000000000a8d058
- (id)description;	// IMP=0x0000000000a8cfa9
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a8c24c
- (id)init;	// IMP=0x0000000000a8c1f0
