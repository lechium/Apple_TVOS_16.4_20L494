...
- (void).cxx_destruct;	// IMP=0x0000000000e15da8
- (unsigned long long)hash;	// IMP=0x0000000000e15488
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e152d6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e15062
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e14bd7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e14bc8
- (id)jsonRepresentation;	// IMP=0x0000000000e0f91b
- (id)dictionaryRepresentation;	// IMP=0x0000000000e0f3f6
- (id)description;	// IMP=0x0000000000e0f347
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e0e3af
- (id)init;	// IMP=0x0000000000e0e353
