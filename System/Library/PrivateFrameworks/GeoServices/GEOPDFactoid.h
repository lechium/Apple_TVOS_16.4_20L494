...
+ (id)factoidsForPlaceData:(id)arg1;	// IMP=0x0010000000a40b46
+ (_Bool)factoidPairAvailableForPlaceData:(id)arg1;	// IMP=0x0010000000a40a4c
- (void).cxx_destruct;	// IMP=0x0000000000c28063
- (unsigned long long)hash;	// IMP=0x0000000000c27e2a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c27bd7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c277cb
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c2742b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c2741c
- (id)jsonRepresentation;	// IMP=0x0000000000c268ec
- (id)dictionaryRepresentation;	// IMP=0x0000000000c26227
- (id)description;	// IMP=0x0000000000c26178
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c24dc7
- (id)init;	// IMP=0x0000000000c24d6b
- (id)bestLocalizedPlaceName;	// IMP=0x0000000000a40c99
