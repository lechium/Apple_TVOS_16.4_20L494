...
- (id).cxx_construct;	// IMP=0x000000000034bde3
- (void).cxx_destruct;	// IMP=0x000000000034bdb2
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000034bd30
- (id)findStation:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000034bb48
- (id)findStops:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000034bb40
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000034bafc
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x000000000034ba79
...
- (id)initWithMap:(id)arg1 accessPoint:(shared_ptr_4792c490)arg2;	// IMP=0x000000000034b8f5
