...
- (void).cxx_destruct;	// IMP=0x0000000000bfc0e7
- (unsigned long long)hash;	// IMP=0x0000000000bfbcab
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bfb9e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bfb460
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bfadf3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bfade4
- (id)jsonRepresentation;	// IMP=0x0000000000bf9800
- (id)dictionaryRepresentation;	// IMP=0x0000000000bf8d5e
- (id)description;	// IMP=0x0000000000bf8caf
- (void)dealloc;	// IMP=0x0000000000bf6d2f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000bf6cd3
- (id)init;	// IMP=0x0000000000bf6c77
