...
- (void).cxx_destruct;	// IMP=0x0000000000cfa237
- (unsigned long long)hash;	// IMP=0x0000000000cfa0e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cf9ec1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000cf9c1f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000cf9926
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000cf9917
- (id)jsonRepresentation;	// IMP=0x0000000000cf9805
- (id)dictionaryRepresentation;	// IMP=0x0000000000cf92c5
- (id)description;	// IMP=0x0000000000cf9216
- (void)dealloc;	// IMP=0x0000000000cf7b57
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cf7afb
- (id)init;	// IMP=0x0000000000cf7a9f
