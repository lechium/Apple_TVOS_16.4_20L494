...
- (void).cxx_destruct;	// IMP=0x0000000000aefe37
- (unsigned long long)hash;	// IMP=0x0000000000aefb5a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aef799
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aef0f0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aeeb30
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aeeb21
- (id)jsonRepresentation;	// IMP=0x0000000000aedc42
- (id)dictionaryRepresentation;	// IMP=0x0000000000aed0a0
- (id)description;	// IMP=0x0000000000aecff1
- (id)initWithData:(id)arg1;	// IMP=0x0000000000aebb1a
- (id)init;	// IMP=0x0000000000aebabe
