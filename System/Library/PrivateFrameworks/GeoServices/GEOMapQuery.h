...
- (void).cxx_destruct;	// IMP=0x0000000000d6de75
- (unsigned long long)hash;	// IMP=0x0000000000d6dc41
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d6d8c5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d6d529
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d6cf73
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d6cf66
- (id)jsonRepresentation;	// IMP=0x0000000000d6ccf6
- (id)dictionaryRepresentation;	// IMP=0x0000000000d6c58f
- (id)description;	// IMP=0x0000000000d6c4e0
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d6b176
- (id)init;	// IMP=0x0000000000d6b11a
