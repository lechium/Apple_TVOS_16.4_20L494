...
- (void).cxx_destruct;	// IMP=0x000000000143d252
- (unsigned long long)hash;	// IMP=0x000000000143d14a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000143cf78
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000143caf3
- (void)writeTo:(id)arg1;	// IMP=0x000000000143c557
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000143c548
- (id)jsonRepresentation;	// IMP=0x000000000143b394
- (id)dictionaryRepresentation;	// IMP=0x000000000143ab57
- (id)description;	// IMP=0x000000000143aaa8
- (id)initWithData:(id)arg1;	// IMP=0x00000000014398a7
- (id)init;	// IMP=0x000000000143984b
