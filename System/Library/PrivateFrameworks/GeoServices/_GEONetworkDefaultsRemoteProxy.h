...
- (void).cxx_destruct;	// IMP=0x0000000000d1ab22
@property(nonatomic) __weak id <_GEONetworkDefaultsServerProxyDelegate> delegate; // @synthesize delegate=_delegate;
- (void)updateNetworkDefaultsWithReason:(unsigned long long)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000d1a493
- (void)updateNetworkDefaults:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d1a479
- (void)_networkDefaultsDidChange;	// IMP=0x0000000000d1a39f
- (void)dealloc;	// IMP=0x0000000000d1a366
- (id)init;	// IMP=0x0000000000d1a222
