...
- (void).cxx_destruct;	// IMP=0x000000000051c028
- (unsigned long long)hash;	// IMP=0x000000000051bab3
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000051b609
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000051b178
- (void)writeTo:(id)arg1;	// IMP=0x000000000051ab33
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000051ab24
- (id)jsonRepresentation;	// IMP=0x000000000051a2b5
- (id)dictionaryRepresentation;	// IMP=0x0000000000519055
- (id)description;	// IMP=0x0000000000518fa6
- (void)dealloc;	// IMP=0x000000000051625e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000516202
- (id)init;	// IMP=0x00000000005161a6
