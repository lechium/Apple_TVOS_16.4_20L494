...
- (void).cxx_destruct;	// IMP=0x0000000000cbe3d5
- (unsigned long long)hash;	// IMP=0x0000000000cbe2e5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cbe0f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000cbdd1a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000cbd9c7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000cbd9b8
- (id)jsonRepresentation;	// IMP=0x0000000000cbd8a6
- (id)dictionaryRepresentation;	// IMP=0x0000000000cbcfd7
- (id)description;	// IMP=0x0000000000cbcf28
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cbc20a
- (id)init;	// IMP=0x0000000000cbc1ae
