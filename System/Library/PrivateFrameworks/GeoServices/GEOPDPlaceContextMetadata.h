...
- (void).cxx_destruct;	// IMP=0x0000000000c8f2c4
- (unsigned long long)hash;	// IMP=0x0000000000c8f00d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c8eed8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c8eccd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c8ea8f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c8ea80
- (id)jsonRepresentation;	// IMP=0x0000000000c8c06f
- (id)dictionaryRepresentation;	// IMP=0x0000000000c8bbbb
- (id)description;	// IMP=0x0000000000c8bb0c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c8b2a2
- (id)init;	// IMP=0x0000000000c8b246
