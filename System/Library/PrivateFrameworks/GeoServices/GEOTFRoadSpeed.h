...
- (void).cxx_destruct;	// IMP=0x0000000000319d17
- (unsigned long long)hash;	// IMP=0x0000000000319889
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003195a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000319151
- (void)writeTo:(id)arg1;	// IMP=0x0000000000318c89
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000318c7a
- (id)jsonRepresentation;	// IMP=0x00000000003189fc
- (id)dictionaryRepresentation;	// IMP=0x00000000003180c2
- (id)description;	// IMP=0x0000000000318013
- (void)dealloc;	// IMP=0x0000000000316c7f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000316c23
- (id)init;	// IMP=0x0000000000316bc7
