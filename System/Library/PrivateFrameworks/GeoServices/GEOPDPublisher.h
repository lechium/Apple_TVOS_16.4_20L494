...
- (void).cxx_destruct;	// IMP=0x0000000000ca1fb1
- (unsigned long long)hash;	// IMP=0x0000000000ca1ea3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ca1cc6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ca181c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ca141a
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ca140b
- (id)jsonRepresentation;	// IMP=0x0000000000ca0b5e
- (id)dictionaryRepresentation;	// IMP=0x0000000000ca0205
- (id)description;	// IMP=0x0000000000ca0156
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c9ee10
- (id)init;	// IMP=0x0000000000c9edb4
- (id)publisherDescription;	// IMP=0x0000000000a4195b
