...
- (void).cxx_destruct;	// IMP=0x0000000000aa53a0
- (unsigned long long)hash;	// IMP=0x0000000000aa5225
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aa4f74
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aa4c38
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aa492d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aa491e
- (id)jsonRepresentation;	// IMP=0x0000000000aa46a0
- (id)dictionaryRepresentation;	// IMP=0x0000000000aa3ddd
- (id)description;	// IMP=0x0000000000aa3d2e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000aa2e85
- (id)init;	// IMP=0x0000000000aa2e29
