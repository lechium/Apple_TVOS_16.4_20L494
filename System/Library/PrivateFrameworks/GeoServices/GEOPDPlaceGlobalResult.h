...
- (void).cxx_destruct;	// IMP=0x000000000059c848
- (unsigned long long)hash;	// IMP=0x0000000000594ba8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005941a6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005938c4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000591fc3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000591fb4
- (id)jsonRepresentation;	// IMP=0x0000000000579ad2
- (id)dictionaryRepresentation;	// IMP=0x0000000000576d8a
- (id)description;	// IMP=0x0000000000576cdb
- (id)initWithData:(id)arg1;	// IMP=0x0000000000571004
- (id)init;	// IMP=0x0000000000570fa8
