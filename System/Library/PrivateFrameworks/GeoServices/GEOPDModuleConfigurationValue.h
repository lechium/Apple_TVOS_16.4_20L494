...
- (void).cxx_destruct;	// IMP=0x0000000000c64b6a
- (unsigned long long)hash;	// IMP=0x0000000000c64a51
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c64807
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c64520
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c6425c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c6424d
- (id)jsonRepresentation;	// IMP=0x0000000000c6027d
- (id)dictionaryRepresentation;	// IMP=0x0000000000c5fbbf
- (id)description;	// IMP=0x0000000000c5fb10
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c5e48b
- (id)init;	// IMP=0x0000000000c5e42f
