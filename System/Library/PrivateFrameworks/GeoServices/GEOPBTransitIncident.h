...
- (void).cxx_destruct;	// IMP=0x0000000000e52f36
- (unsigned long long)hash;	// IMP=0x0000000000e52b35
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e527a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e522a9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e51dff
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e51df0
- (id)jsonRepresentation;	// IMP=0x0000000000e4fe08
- (id)dictionaryRepresentation;	// IMP=0x0000000000e4f478
- (id)description;	// IMP=0x0000000000e4f3c9
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e4d680
- (id)init;	// IMP=0x0000000000e4d624
