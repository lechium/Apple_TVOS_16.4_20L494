...
- (void).cxx_destruct;	// IMP=0x000000000060f2ec
- (unsigned long long)hash;	// IMP=0x000000000060ee38
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000060e72b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000060e125
- (void)writeTo:(id)arg1;	// IMP=0x000000000060db0b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000060dafc
- (id)jsonRepresentation;	// IMP=0x000000000060d9ea
- (id)dictionaryRepresentation;	// IMP=0x000000000060beac
- (id)description;	// IMP=0x000000000060bdfd
- (void)dealloc;	// IMP=0x0000000000608015
- (id)initWithData:(id)arg1;	// IMP=0x0000000000607fb9
- (id)init;	// IMP=0x0000000000607f5d
- (id)initWithSearchQuery:(id)arg1 entryMetadata:(id)arg2 metadata:(id)arg3 autocompleteEntry:(id)arg4 retainedSearch:(id)arg5 maxResults:(unsigned int)arg6 traits:(id)arg7 routeInfo:(id)arg8;	// IMP=0x000000000137bc18
