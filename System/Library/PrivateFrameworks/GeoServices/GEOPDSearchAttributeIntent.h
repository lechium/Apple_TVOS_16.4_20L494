...
- (void).cxx_destruct;	// IMP=0x0000000000a939c8
- (unsigned long long)hash;	// IMP=0x0000000000a938f7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a93745
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a934e3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a9321b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a9320c
- (id)jsonRepresentation;	// IMP=0x0000000000a927ac
- (id)dictionaryRepresentation;	// IMP=0x0000000000a921c7
- (id)description;	// IMP=0x0000000000a92118
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a91920
- (id)init;	// IMP=0x0000000000a918c4
