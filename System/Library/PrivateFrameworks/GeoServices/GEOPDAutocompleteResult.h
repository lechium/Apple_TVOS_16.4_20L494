...
- (void).cxx_destruct;	// IMP=0x0000000000503143
- (unsigned long long)hash;	// IMP=0x0000000000502ee8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000502ad4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000502401
- (void)writeTo:(id)arg1;	// IMP=0x00000000005016c2
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005016b3
- (id)jsonRepresentation;	// IMP=0x0000000000500d02
- (id)dictionaryRepresentation;	// IMP=0x00000000004ffe2a
- (id)description;	// IMP=0x00000000004ffd7b
- (id)initWithData:(id)arg1;	// IMP=0x00000000004fde66
- (id)init;	// IMP=0x00000000004fde0a
