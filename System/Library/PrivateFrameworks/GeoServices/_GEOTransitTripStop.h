...
+ (id)transitTripStopsForPlaceData:(id)arg1;	// IMP=0x00100000011249d9
- (void).cxx_destruct;	// IMP=0x00000000011251a2
...
- (id)initWithTransitSnippet:(id)arg1 departureSequence:(id)arg2;	// IMP=0x0000000001124e76
