...
- (void).cxx_destruct;	// IMP=0x00000000011b3027
...
- (void)dataSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x00000000011b12a8
- (void)dataSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000011b1123
...
- (double)startTime;	// IMP=0x00000000011b0fa6
- (double)elapsed;	// IMP=0x00000000011b0f56
- (void)clearAllRelatedOperations;	// IMP=0x00000000011b0f24
- (void)cancel;	// IMP=0x00000000011b0d7d
- (void)start;	// IMP=0x00000000011b0758
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long contentLength;
@property(readonly, nonatomic) NSURL *URL;
@property unsigned int priority;
- (id)initWithRequest:(id)arg1 delegateQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000011afe6a
- (id)init;	// IMP=0x00000000011afe5c
