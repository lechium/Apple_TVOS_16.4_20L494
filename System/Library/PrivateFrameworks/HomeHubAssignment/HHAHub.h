...
- (void).cxx_destruct;	// IMP=0x000000000001622a
...
- (void)updateActivity;	// IMP=0x0000000000016095
...
- (_Bool)hubAttributesChanged:(id)arg1;	// IMP=0x0000000000015cf9
- (void)revokeEndpoint:(id)arg1;	// IMP=0x0000000000015bf4
- (void)setAssignedEndpoints:(id)arg1;	// IMP=0x0000000000015bc7
- (void)assignEndpoint:(id)arg1;	// IMP=0x0000000000015adf
@property(readonly, nonatomic) NSDictionary *descriptionDictionaryWithAttributes;
- (id)descriptionDictionaryWithLeaderId:(id)arg1;	// IMP=0x00000000000155b9
- (long long)compare:(id)arg1;	// IMP=0x00000000000153fd
- (id)description;	// IMP=0x0000000000015375
- (void)_preferOthersTimerExpired;	// IMP=0x0000000000015321
- (void)invalidate;	// IMP=0x000000000001530b
- (id)initWithAttributes:(id)arg1 timerFactory:(id)arg2 queue:(id)arg3;	// IMP=0x0000000000015202
