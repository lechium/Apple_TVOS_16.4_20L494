...
- (void).cxx_destruct;	// IMP=0x000000000000a9ef
...
- (void)start;	// IMP=0x000000000000a8b0
- (void)cancel;	// IMP=0x000000000000a87a
- (void)_handleTimerFired;	// IMP=0x000000000000a845
- (void)dealloc;	// IMP=0x000000000000a807
- (id)initWithDuration:(unsigned long long)arg1 leeway:(unsigned long long)arg2 queue:(id)arg3 callback:(CDUnknownBlockType)arg4;	// IMP=0x000000000000a73c
