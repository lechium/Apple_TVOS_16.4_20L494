...
- (void).cxx_destruct;	// IMP=0x000000000001db48
...
- (void)_processEndpointStatus:(id)arg1;	// IMP=0x000000000001d7d8
- (void)updateEndpointIdleStatus:(id)arg1;	// IMP=0x000000000001d5ef
...
- (void)provider:(id)arg1 didUpdateEndpointWithStatus:(id)arg2;	// IMP=0x000000000001d03d
- (void)provider:(id)arg1 didRemoveEndpointWithIdentifier:(id)arg2;	// IMP=0x000000000001cf0f
- (void)informer:(id)arg1 didUpdateEndpointTrait:(id)arg2;	// IMP=0x000000000001cddf
@property(readonly, nonatomic) NSSet *inactiveEndpoints;
@property(readonly, nonatomic) NSSet *unassignedEndpoints;
- (id)endpointsNotAssignedToPreferredHubs:(id)arg1;	// IMP=0x000000000001cabe
@property(readonly, nonatomic) NSSet *endpointsRequestingAssignment;
@property(readonly, nonatomic) NSSet *allEndpoints;
- (id)endpointsAssignedToHub:(id)arg1;	// IMP=0x000000000001c92f
- (id)_endpointsPassingTest:(CDUnknownBlockType)arg1;	// IMP=0x000000000001c751
- (void)_requestTraitsForEndpoint:(id)arg1;	// IMP=0x000000000001c2ba
- (void)receivedTraits:(id)arg1 forEndpoint:(id)arg2;	// IMP=0x000000000001c16c
@property(readonly, nonatomic) NSArray *endpointAssignmentStatuses;
- (void)dealloc;	// IMP=0x000000000001bf95
- (void)stopMonitor;	// IMP=0x000000000001bef1
- (void)startMonitorWithObserver:(id)arg1 statusProvider:(id)arg2 traitInformer:(id)arg3 endpoints:(id)arg4;	// IMP=0x000000000001bce7
- (void)_clearEndpointList;	// IMP=0x000000000001bb97
- (id)initWithQueue:(id)arg1 endpointFactory:(id)arg2;	// IMP=0x000000000001bae4
