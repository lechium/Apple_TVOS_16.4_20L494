...
- (id).cxx_construct;	// IMP=0x0000000000027a7b
- (void).cxx_destruct;	// IMP=0x0000000000027a08
...
- (void)updateScoresWithNewMeasurement:(const void *)arg1;	// IMP=0x0000000000027860
- (void)updateScoresForTime:(double)arg1;	// IMP=0x00000000000274df
- (void)reportScoresToClientAlways:(_Bool)arg1 useUpdatedScoreList:(_Bool)arg2 currentMachContTime:(double)arg3;	// IMP=0x00000000000267d1
- (void)heartbeatTimeout:(double)arg1 currentMachContTime:(double)arg2 useUpdatedScores:(_Bool)arg3;	// IMP=0x0000000000026708
- (void)addBluetoothProximityEstimate:(struct NeighborMeasurements)arg1 currentMachContTime:(double)arg2;	// IMP=0x000000000002664c
- (void)addRoseSolutions:(id)arg1 currentMachContTime:(double)arg2;	// IMP=0x00000000000259e7
- (void)createEstimators;	// IMP=0x0000000000025952
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000025844
- (id)init;	// IMP=0x0000000000025806
