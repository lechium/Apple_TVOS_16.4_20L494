...
- (void).cxx_destruct;	// IMP=0x00000000000129e9
...
- (id)initWithFilter:(void *)arg1 sampleSize:(unsigned long long)arg2 rssiImmediate:(id)arg3 rssiNear:(id)arg4;	// IMP=0x00000000000128dd
- (id)init;	// IMP=0x000000000001289f
