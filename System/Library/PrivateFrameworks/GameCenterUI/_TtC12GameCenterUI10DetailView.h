...
- (void).cxx_destruct;	// IMP=0x00000000001f63b0
- (void)didTapWithAccessoryView:(id)arg1;	// IMP=0x00000000001f5950
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000000001f5810
- (void)layoutSubviews;	// IMP=0x00000000001f5400
- (void)wasTapped;	// IMP=0x00000000001f4f80
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001f48b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001f4730
