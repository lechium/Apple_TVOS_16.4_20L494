...
- (void).cxx_destruct;	// IMP=0x0000000000321bd0
...
- (void)prepareForReuse;	// IMP=0x0000000000320540
- (void)handleTapWithGestureRecognizer:(id)arg1;	// IMP=0x00000000003201b0
- (void)layoutSubviews;	// IMP=0x00000000003200c0
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x000000000031f7f0
@property(nonatomic) struct UIEdgeInsets layoutMargins;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000031f3f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000031f1b0
