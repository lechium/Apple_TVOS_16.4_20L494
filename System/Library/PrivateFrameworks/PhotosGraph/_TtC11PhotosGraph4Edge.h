...
- (void).cxx_destruct;	// IMP=0x00000000000d5220
- (id)init;	// IMP=0x00000000000d51c0
- (id)copyWithZone:(void *)arg1;	// IMP=0x00000000000d51b0
- (void)resolveIdentifier:(unsigned long long)arg1;	// IMP=0x00000000000d5190
- (id)oppositeNodeFromNode:(id)arg1;	// IMP=0x00000000000d5140
- (id)initWithIdentifier:(unsigned long long)arg1 labels:(id)arg2 properties:(id)arg3 sourceNode:(id)arg4 targetNode:(id)arg5;	// IMP=0x00000000000d4f00
