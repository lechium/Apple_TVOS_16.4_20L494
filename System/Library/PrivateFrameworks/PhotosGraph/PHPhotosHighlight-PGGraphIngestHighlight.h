...
+ (id)fetchParentDayGroupHighlightsForDayHighlights:(id)arg1;	// IMP=0x00100000003aa0b5
- (unsigned short)visibilityStateForHighlightFilter:(unsigned short)arg1;	// IMP=0x0010000000297596
- (id)keyAssetForHighlightFilter:(unsigned short)arg1;	// IMP=0x0010000000297442
@property(readonly, nonatomic) NSArray *extendedCuratedAssets;
@property(readonly, nonatomic) id modelObject;
- (unsigned long long)numberOfAssetsInExtendedForSharingFilter:(unsigned short)arg1;	// IMP=0x0010000000297317
...
- (id)changeRequest;	// IMP=0x00100000003a9dc2
- (double)nonDefaultCurationScorePercentageForPhotoLibrary:(id)arg1;	// IMP=0x00100000003a9c5b
- (double)sceneAnalysisProgressForPhotoLibrary:(id)arg1;	// IMP=0x00100000003a9c36
- (double)faceAnalysisProgressForPhotoLibrary:(id)arg1;	// IMP=0x00100000003a9c19
