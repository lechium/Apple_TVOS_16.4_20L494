...
+ (Class)eaProtocolStringsType;	// IMP=0x00100000000069eb
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000006112
- (unsigned long long)hash;	// IMP=0x00000000000054e4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004d99
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004712
- (void)copyTo:(id)arg1;	// IMP=0x000000000000428c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000003d38
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002d50
- (id)dictionaryRepresentation;	// IMP=0x00000000000022b6
- (id)description;	// IMP=0x0000000000002207
...
- (id)eaProtocolStringsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000000214b
- (unsigned long long)eaProtocolStringsCount;	// IMP=0x000000000000212e
- (void)addEaProtocolStrings:(id)arg1;	// IMP=0x00000000000020c4
- (void)clearEaProtocolStrings;	// IMP=0x00000000000020a7
