...
+ (id)regionsForLanguage:(id)arg1 withThreshold:(long long)arg2;	// IMP=0x0020000000001cff
+ (id)languagesForRegion:(id)arg1 subdivision:(id)arg2 withThreshold:(long long)arg3 filter:(long long)arg4;	// IMP=0x0020000000001bf6
+ (id)exemplarForLanguage:(id)arg1;	// IMP=0x0020000000001afb
+ (id)supportedLanguages;	// IMP=0x0020000000001868
+ (id)_deviceLanguages;	// IMP=0x0020000000001619
+ (id)baseSystemLanguages;	// IMP=0x00200000000013cc
+ (id)_globalPreferredLanguages;	// IMP=0x002000000000126a
+ (id)deviceLanguage;	// IMP=0x0020000000001251
