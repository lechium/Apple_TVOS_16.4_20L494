...
+ (id)logCategory;	// IMP=0x0010000000aea86b
- (void).cxx_destruct;	// IMP=0x0000000000aea7f1
...
- (id)logIdentifier;	// IMP=0x0000000000aea745
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)__handleXPCMessage:(id)arg1;	// IMP=0x0000000000aea57a
- (void)registerForMessage:(id)arg1 policies:(id)arg2;	// IMP=0x0000000000aea491
- (id)shortDescription;	// IMP=0x0000000000aea417
- (void)dealloc;	// IMP=0x0000000000aea35a
- (id)initWithReceiver:(id)arg1 handler:(id)arg2;	// IMP=0x0000000000aea2bf
