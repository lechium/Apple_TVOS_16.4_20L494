...
+ (id)logCategory;	// IMP=0x00100000007beebc
+ (double)timeout;	// IMP=0x00100000007bedde
- (void).cxx_destruct;	// IMP=0x00000000007bec0a
...
- (id)logIdentifier;	// IMP=0x00000000007beadb
- (void)main;	// IMP=0x00000000007be8f0
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x00000000007be7a5
