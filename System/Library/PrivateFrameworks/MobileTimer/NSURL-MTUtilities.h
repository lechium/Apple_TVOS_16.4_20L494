...
+ (id)mtURLForScheme:(id)arg1;	// IMP=0x002000000004174d
+ (id)mtURLForClockAppSection:(int)arg1 timerManager:(id)arg2;	// IMP=0x00200000000414ed
+ (id)mtURLForClockAppSection:(int)arg1;	// IMP=0x00200000000414d9
