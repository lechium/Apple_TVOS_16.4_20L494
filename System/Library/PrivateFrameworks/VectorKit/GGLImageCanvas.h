...
- (id).cxx_construct;	// IMP=0x00000000004fe138
- (void).cxx_destruct;	// IMP=0x00000000004fdfa9
...
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x00000000004fde28
- (void)didDrawView;	// IMP=0x00000000004fde1e
- (void)willDrawView;	// IMP=0x00000000004fddc2
- (void)renderWithTimestamp:(double)arg1 presentAtTime:(double)arg2 completion:(function_2e574590)arg3;	// IMP=0x00000000004fd912
- (_Bool)hasRenderTarget;	// IMP=0x00000000004fd901
- (void)destroyRenderTarget;	// IMP=0x00000000004fd751
- (void)createRenderTarget;	// IMP=0x00000000004fcbed
- (struct __IOSurface *)flipImage;	// IMP=0x00000000004fca37
...
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x00000000004fc837
@property(readonly, nonatomic) void *imageTexture;
@property(readonly, nonatomic) _Bool shouldRasterize;
- (void)dealloc;	// IMP=0x00000000004fc7cd
- (id)initWithSize:(struct CGSize)arg1 scale:(double)arg2 useMultisampling:(_Bool)arg3 extraColorFormats:(const void *)arg4 taskContext:(const void *)arg5 device:(void *)arg6 signpostId:(unsigned long long)arg7;	// IMP=0x00000000004fbb4c
- (void *)_internalRenderTarget;	// IMP=0x00000000004fbb42
@property(readonly, nonatomic) void *finalRenderTarget;
@property(readonly, nonatomic) struct CGSize sizeInPixels;
- (void)willDealloc;	// IMP=0x00000000004fb739
- (void *)finalSurface;	// IMP=0x00000000004fb72f
