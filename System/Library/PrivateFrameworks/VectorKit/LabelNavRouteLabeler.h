...
- (id).cxx_construct;	// IMP=0x00000000005b8dce
- (void).cxx_destruct;	// IMP=0x00000000005b8c66
...
- (unsigned char)computeRoutePositionForPOIAtPixel:(const void *)arg1 currentPosition:(unsigned char)arg2 context:(struct NavContext *)arg3;	// IMP=0x00000000005b8b6a
- (_Bool)_updateActiveRouteRange;	// IMP=0x00000000005b7ceb
- (_Bool)_findRouteOverlappingJunctionFrom:(long long)arg1 routeJunctions:(void *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(long long *)arg4 secondOverlap:(long long *)arg5;	// IMP=0x00000000005b7b19
- (void)_updateCurrentRoadInfo;	// IMP=0x00000000005b77e9
- (void)_initalizeCurrentRoadInfo;	// IMP=0x00000000005b77cc
- (void)_dedupOffRouteRoads;	// IMP=0x00000000005b6f49
- (void)_updatePreferredLabelPlacements;	// IMP=0x00000000005b6c2e
- (void)_updateRoadsInGuidance;	// IMP=0x00000000005b66d8
- (void)_updateRoadStarts;	// IMP=0x00000000005b6240
- (void)_updateUniqueOffRouteRoads;	// IMP=0x00000000005b5cac
- (_Bool)_addJunctionsForTile:(const void *)arg1;	// IMP=0x00000000005b4c65
- (void)_addLabelsForJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3 useAllJunctions:(_Bool)arg4 placeShieldsFrontToBack:(_Bool)arg5;	// IMP=0x00000000005b3e43
- (void)_addLabelsAtJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3;	// IMP=0x00000000005b3825
- (void)_addVisibleSigns;	// IMP=0x00000000005b3761
- (void)layoutWithNavContext:(struct NavContext *)arg1 avoidanceRects:(const void *)arg2;	// IMP=0x00000000005b0e68
- (unsigned char)orientationForRoadSign:(id)arg1 roadLabel:(id)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x00000000005b0cf2
- (unsigned char)resolveOrientation:(struct NavContext *)arg1 road:(id)arg2 currentOrientation:(unsigned char)arg3;	// IMP=0x00000000005b0ba7
- (struct RoadSignOrientationResolver)createRoadSignOrientationResolver:(id)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000005b0b0f
- (void)_generateCurrentRoadSignWithContext:(struct NavContext *)arg1;	// IMP=0x00000000005b0004
- (void)styleManagerDidFinishAnimating;	// IMP=0x00000000005afff7
- (void)styleManagerDidStartAnimating;	// IMP=0x00000000005affe8
- (void)styleManagerDidChange:(_Bool)arg1;	// IMP=0x00000000005affd1
- (_Bool)_collideLabel:(id)arg1 activeLabel:(id)arg2 labelsToRemove:(id)arg3;	// IMP=0x00000000005af79b
- (void)_tryAddLabel:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x00000000005ae4cf
- (void)_tryAddRoadSignForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 labelCollisionEnabled:(_Bool)arg4;	// IMP=0x00000000005ae034
- (void)_createOrUpdateLabelForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 hopOffsetDistance:(float)arg4;	// IMP=0x00000000005adec4
- (void)_tryAddRoadSignForJunction:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x00000000005add4c
- (void)grabTilesFromScene:(const void *)arg1;	// IMP=0x00000000005ada2d
- (void)_refreshGuidanceRoadNames;	// IMP=0x00000000005ad7a0
- (void)_reloadRouteJunctions;	// IMP=0x00000000005ad49b
- (void)clearSceneIsMemoryWarning:(_Bool)arg1;	// IMP=0x00000000005ad3a8
- (_Bool)isNavMode;	// IMP=0x00000000005ad390
- (void)setMaxVisibleRoadsigns:(unsigned int)arg1;	// IMP=0x00000000005ad20d
- (void)setStyleManager:(shared_ptr_3e3c7f86)arg1;	// IMP=0x00000000005ad036
- (id)init;	// IMP=0x00000000005acaa0
@property(readonly, nonatomic) float currentRoadSignPixelHeight;
@property(readonly, nonatomic) void *currentRoadSign;
- (void)drawNavOverlayDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000004adfac
- (void)drawRoadSignOrientationDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000004ad129
- (void)debugDraw:(id)arg1 overlayConsole:(void *)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x00000000004acfb6
- (_Bool)needsDebugDraw;	// IMP=0x00000000004acec0
