...
- (id).cxx_construct;	// IMP=0x00000000006bf497
- (void).cxx_destruct;	// IMP=0x00000000006bf43d
...
- (void)createLabelWithNavContext:(struct NavContext *)arg1 isDrivingSideRight:(_Bool)arg2 artworkCache:(void *)arg3;	// IMP=0x00000000006bed1a
- (void)prepareStyleVarsWithContext:(struct NavContext *)arg1;	// IMP=0x00000000006beaa6
@property(readonly, nonatomic) _Bool isVisible; // @synthesize isVisible=_isVisible;
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000006bea3f
- (void)_updateWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000006bea2a
- (void)_updateWithNavContext:(struct NavContext *)arg1 threshold:(double)arg2;	// IMP=0x00000000006be9ac
- (Mercator3_d8bb135c)_anchorCoordinateForSignOrientation:(unsigned char)arg1;	// IMP=0x00000000006be7f2
- (unsigned char)_signOrientationWithDrivingSide:(_Bool)arg1;	// IMP=0x00000000006be450
...
- (void)evaluateCrossStreetsUsingRouteJunction:(id)arg1;	// IMP=0x00000000006bd750
- (void)evaluateCrossStreets;	// IMP=0x00000000006bd73b
- (void)addRouteEdge:(const struct VKLabelNavRouteRoadEdge *)arg1 atA:(_Bool)arg2;	// IMP=0x00000000006bd4e2
- (void)findRoads;	// IMP=0x00000000006bcf3e
...
- (_Bool)matchesLocationForJunction:(id)arg1;	// IMP=0x00000000006bc879
- (id)description;	// IMP=0x00000000006bc7d1
- (void)dealloc;	// IMP=0x00000000006bc758
- (id)initWithRoadEdge:(const struct GeoCodecsRoadEdge *)arg1 atA:(_Bool)arg2 routeOffset:(struct PolylineCoordinate)arg3 tile:(const void *)arg4;	// IMP=0x00000000006bc512
- (id)initWithGEOJunction:(struct GeoCodecsConnectivityJunction *)arg1 routeOffset:(struct PolylineCoordinate)arg2 tile:(const void *)arg3;	// IMP=0x00000000006bc2c2
