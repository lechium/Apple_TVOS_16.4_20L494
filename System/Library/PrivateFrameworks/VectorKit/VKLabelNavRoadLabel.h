...
- (id).cxx_construct;	// IMP=0x000000000070c452
- (void).cxx_destruct;	// IMP=0x000000000070c423
...
- (id)description;	// IMP=0x000000000070c2e6
- (id)displayGroup;	// IMP=0x000000000070c134
- (void)layoutForStagingWithNavContext:(struct NavContext *)arg1;	// IMP=0x000000000070c123
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x000000000070c0f1
...
- (id)initWithNavFeature:(id)arg1 label:(const void *)arg2 navLabelType:(int)arg3;	// IMP=0x000000000070bfb0
