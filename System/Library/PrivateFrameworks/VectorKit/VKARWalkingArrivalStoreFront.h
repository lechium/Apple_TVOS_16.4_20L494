...
- (id).cxx_construct;	// IMP=0x0000000000507ee8
- (void).cxx_destruct;	// IMP=0x0000000000507ee2
...
- (id)description;	// IMP=0x0000000000507dd3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000507c66
...
- (id)initWithOrientedRect:(const void *)arg1 undulationProvider:(CDUnknownBlockType)arg2;	// IMP=0x0000000000507528
- (id)initWithYaw:(float)arg1 pitch:(float)arg2 roll:(float)arg3 x:(double)arg4 y:(double)arg5 z:(double)arg6 w:(float)arg7 h:(float)arg8 undulationProvider:(CDUnknownBlockType)arg9;	// IMP=0x00000000005072f2
- (id)initWithGEOOrientedBox:(id)arg1 undulationProvider:(CDUnknownBlockType)arg2;	// IMP=0x0000000000507071
- (id)initWithOrientedRect:(const void *)arg1;	// IMP=0x000000000050705d
