...
- (id).cxx_construct;	// IMP=0x0000000000305ee7
- (void).cxx_destruct;	// IMP=0x0000000000305e94
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000305bf1
- (void)resumeAnimation;	// IMP=0x0000000000305af6
- (void)pauseAnimation;	// IMP=0x0000000000305a95
- (_Bool)isAnimating;	// IMP=0x0000000000305a31
@property(readonly, nonatomic) _Bool shouldForceZoomToFit;
- (void)setGesturing:(_Bool)arg1;	// IMP=0x000000000030599b
- (void)stopTrackingAnnotation;	// IMP=0x0000000000305833
- (void)startTrackingAnnotation:(id)arg1 trackHeading:(_Bool)arg2 animated:(_Bool)arg3 duration:(double)arg4 timingFunction:(CDUnknownBlockType)arg5;	// IMP=0x0000000000305492
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x000000000030548c
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x0000000000305486
- (void)updateFramerate;	// IMP=0x000000000030536c
@property(readonly, nonatomic, getter=isTrackingHeading) _Bool trackingHeading;
- (void)dealloc;	// IMP=0x0000000000305214
- (id)initWithMapDataAccess:(struct MapDataAccess *)arg1 animationRunner:(struct AnimationRunner *)arg2 runLoopController:(struct RunLoopController *)arg3 cameraDelegate:(id)arg4;	// IMP=0x00000000003051b7
