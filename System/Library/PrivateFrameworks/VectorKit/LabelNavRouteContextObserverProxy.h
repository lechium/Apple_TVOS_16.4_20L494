...
- (id).cxx_construct;	// IMP=0x000000000035c63c
- (void).cxx_destruct;	// IMP=0x000000000035c5d1
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x000000000035c589
- (void)stopObserving:(id)arg1;	// IMP=0x000000000035c4a4
- (void)startObserving:(id)arg1;	// IMP=0x000000000035c287
- (void)dealloc;	// IMP=0x000000000035c1c5
- (id)initWithRouteContextChangeObserver:(struct RouteContextChangeObserver *)arg1;	// IMP=0x000000000035c188
