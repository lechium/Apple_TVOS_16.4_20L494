...
- (void).cxx_destruct;	// IMP=0x000000000078b7a1
...
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x000000000078af5d
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x0000000000789825
- (Matrix_443f5d51)_centerCursor;	// IMP=0x0000000000789677
- (void)setEdgeInsets:(struct VKEdgeInsets)arg1;	// IMP=0x000000000078962c
- (struct VKEdgeInsets)_effectiveEdgeInsets;	// IMP=0x0000000000789546
- (Matrix_443f5d51)_nonOffsetCenterCursor;	// IMP=0x00000000007893f7
- (void)dealloc;	// IMP=0x000000000078938b
- (id)init;	// IMP=0x0000000000789344
