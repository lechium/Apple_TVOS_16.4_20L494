...
- (id).cxx_construct;	// IMP=0x0000000000541591
- (void).cxx_destruct;	// IMP=0x00000000005414c9
...
- (double)boundsUnitsPerMeter;	// IMP=0x0000000000541318
- (Matrix_08d701e4)maneuverTransform;	// IMP=0x0000000000541286
- (Matrix_08d701e4)inverseManeuverTransform;	// IMP=0x0000000000541232
- (vector_9022e479)maneuverPoints;	// IMP=0x0000000000540ed8
- (void)_updateBounds:(id)arg1 boundsInflation:(float)arg2;	// IMP=0x0000000000540523
- (void)forEachSection:(CDUnknownBlockType)arg1;	// IMP=0x000000000054045d
- (void)splitRouteLineAtAnnotation:(id)arg1;	// IMP=0x000000000053fc1a
- (optional_db527fce)snapRouteMatch:(id)arg1;	// IMP=0x000000000053f027
- (_Bool)needsUpdateForViewingScale:(double)arg1;	// IMP=0x000000000053ef08
- (_Bool)isTrafficUptoDate:(double)arg1;	// IMP=0x000000000053eed9
- (_Bool)isTrafficUpToDate;	// IMP=0x000000000053eea2
- (void)createMeshIfNecessary:(long long)arg1;	// IMP=0x000000000053edca
- (void)generateArrowsForManeuverDisplayMode:(int)arg1 routeLineWidth:(double)arg2;	// IMP=0x000000000053e7bf
- (_Bool)buildRouteLine:(id)arg1 matchToRoads:(_Bool)arg2 shouldGenerateSnapPath:(_Bool)arg3 viewUnitsPerPoint:(double)arg4 force:(_Bool)arg5 boundsInflation:(float)arg6 isGradientTraffic:(_Bool)arg7 currentLegIndex:(unsigned int)arg8;	// IMP=0x000000000053be87
- (void)_updateTilesCovered:(id)arg1;	// IMP=0x000000000053bc64
@property(readonly, nonatomic) GEOComposedRoute *composedRoute;
- (void)dealloc;	// IMP=0x000000000053bb98
- (id)initWithPolylineOverlay:(id)arg1;	// IMP=0x000000000053ba66
