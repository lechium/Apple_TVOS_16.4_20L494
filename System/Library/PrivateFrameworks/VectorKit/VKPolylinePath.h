...
- (id).cxx_construct;	// IMP=0x00000000003224c2
- (void).cxx_destruct;	// IMP=0x000000000032246f
...
- (id)description;	// IMP=0x00000000003223af
- (Matrix_811b2232)convertCoordinateToTile:(const CDStruct_071ac149 *)arg1;	// IMP=0x00000000003222a8
@property(readonly) _Bool isMapMatched;
@property(readonly) _Bool hasCompletedMapMatching;
- (float)laneHalfWidthAtIndex:(unsigned int)arg1;	// IMP=0x000000000032227e
...
- (const struct GradientTraffic *)gradientTrafficAtIndex:(unsigned int)arg1;	// IMP=0x0000000000322245
- (id)initWithOverlay:(id)arg1 section:(id)arg2 routeStartIndex:(unsigned int)arg3 routeEndIndex:(unsigned int)arg4 matchedPathSegments:(id)arg5;	// IMP=0x0000000000321540
- (id)initWithOverlay:(id)arg1 section:(id)arg2 matchedPathSegments:(id)arg3;	// IMP=0x000000000032143c
