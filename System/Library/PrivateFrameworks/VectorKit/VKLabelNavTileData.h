...
- (id).cxx_construct;	// IMP=0x0000000000713d5a
- (void).cxx_destruct;	// IMP=0x0000000000713d00
...
- (void)findOppositeCarriagewayJunctionsWithRouteFeatures:(void *)arg1 distanceThreshold:(double)arg2;	// IMP=0x0000000000713462
- (void)appendNavJunctionsInWorldRect:(const void *)arg1 junctions:(id)arg2;	// IMP=0x00000000007132d8
- (void)initializeJunctionInfos;	// IMP=0x0000000000712f79
- (id)findTileEdgeJunctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x0000000000712db0
- (void)_findTileEdgeJunctions;	// IMP=0x0000000000712c96
- (void)addJunction:(id)arg1;	// IMP=0x0000000000712c02
- (id)junctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x0000000000712a6c
- (id)junctionForGeoJunction:(struct GeoCodecsConnectivityJunction *)arg1;	// IMP=0x0000000000712a56
- (id)initWithTile:(const void *)arg1;	// IMP=0x000000000071295c
