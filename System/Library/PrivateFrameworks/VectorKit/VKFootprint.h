...
- (id).cxx_construct;	// IMP=0x000000000008e890
...
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x000000000008e649
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x000000000008e49d
- (Box_3d7e3c2c)_expandedBoundingRect;	// IMP=0x000000000008e3fd
- (_Bool)containsGroundPoint:(const void *)arg1;	// IMP=0x000000000008e2e1
- (_Bool)rejectsRect:(const void *)arg1;	// IMP=0x000000000008e0d6
- (void)computeFromCamera:(id)arg1;	// IMP=0x000000000008dabf
