...
- (id).cxx_construct;	// IMP=0x00000000006d11c4
- (void).cxx_destruct;	// IMP=0x00000000006d11a0
@property(nonatomic) __weak id <VKMercatorTerrainHeightProvider> heightProvider; // @synthesize heightProvider=_heightProvider;
- (void)invalidateRect:(const void *)arg1;	// IMP=0x00000000006d1099
- (void)removeCachedValueForAnchor:(void *)arg1;	// IMP=0x00000000006d103d
- (double)heightForAnchor:(void *)arg1;	// IMP=0x00000000006d0ec6
