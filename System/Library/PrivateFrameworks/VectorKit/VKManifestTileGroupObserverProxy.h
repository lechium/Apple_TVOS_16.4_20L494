...
- (id).cxx_construct;	// IMP=0x00000000007cfd76
- (void).cxx_destruct;	// IMP=0x00000000007cfcf9
...
- (void)experimentConfigurationDidChange:(id)arg1;	// IMP=0x00000000007cf802
- (void)resourceManifestManager:(id)arg1 didChangeActiveTileGroup:(id)arg2 fromOldTileGroup:(id)arg3;	// IMP=0x00000000007cf6ff
- (void)resourceManifestManagerWillChangeActiveTileGroup:(id)arg1;	// IMP=0x00000000007cf679
- (void)dealloc;	// IMP=0x00000000007cf548
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000007cf430
