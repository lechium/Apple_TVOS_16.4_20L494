...
- (id).cxx_construct;	// IMP=0x000000000049b762
- (void).cxx_destruct;	// IMP=0x000000000049b748
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x000000000049b69e
- (void)dealloc;	// IMP=0x000000000049b622
- (id)initWithRouteContext:(id)arg1 transitSupport:(void *)arg2;	// IMP=0x000000000049b56b
