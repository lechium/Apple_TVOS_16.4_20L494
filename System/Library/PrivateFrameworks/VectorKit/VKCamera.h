...
- (id).cxx_construct;	// IMP=0x000000000008a275
- (void).cxx_destruct;	// IMP=0x000000000008a21f
...
- (void)updateCamera:(shared_ptr_46708168)arg1;	// IMP=0x0000000000089f19
- (CameraFrame_b765d6d7)cameraFrame;	// IMP=0x0000000000089da1
- (View_a667aa2f)view:(struct ViewSize)arg1;	// IMP=0x0000000000089cf7
...
- (void)adjustClipPlanes;	// IMP=0x0000000000089b04
- (float)zoomAtCentrePoint;	// IMP=0x0000000000089ae7
- (float)zoomAtPoint:(struct CGPoint)arg1;	// IMP=0x0000000000089a39
- (double)depthForViewWidth:(double)arg1;	// IMP=0x0000000000089a08
- (double)widthOfViewAtDepth:(double)arg1;	// IMP=0x00000000000899df
- (struct CGPoint)screenPointFromGroundPoint:(const void *)arg1;	// IMP=0x0000000000089927
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1 atGroundLevel:(double)arg2;	// IMP=0x000000000008976f
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1;	// IMP=0x000000000008974d
- (void)updateIfNeeded;	// IMP=0x0000000000088ced
- (void)setNeedsUpdate;	// IMP=0x0000000000088cbe
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x0000000000088ca8
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x0000000000088c92
- (Matrix_6e1d3589)groundPlaneIntersectionPoint;	// IMP=0x0000000000088b93
@property(nonatomic) struct VKCameraState cameraState;
@property(readonly, nonatomic) double yaw;
@property(readonly, nonatomic) double pitch;
- (double)displayZoomLevel;	// IMP=0x00000000000888d1
...
- (Mercator3_d8bb135c)mercatorPosition;	// IMP=0x00000000000882f0
- (void)setMercatorPosition:(const void *)arg1;	// IMP=0x000000000008818e
- (void)_setPosition:(const void *)arg1;	// IMP=0x0000000000088163
- (id)descriptionDictionaryRepresentation;	// IMP=0x0000000000087e42
- (id)description;	// IMP=0x0000000000087c69
- (id)detailedDescription;	// IMP=0x0000000000087c57
- (id)initWithRunLoopController:(struct RunLoopController *)arg1;	// IMP=0x0000000000087ace
