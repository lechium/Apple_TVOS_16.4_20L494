...
- (id).cxx_construct;	// IMP=0x00000000006cf637
- (void).cxx_destruct;	// IMP=0x00000000006cf370
...
- (struct __IOSurface *)flipImage;	// IMP=0x00000000006cf324
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x00000000006cf269
- (struct CGPoint)convertPoint:(struct CGPoint)arg1 toLayer:(id)arg2;	// IMP=0x00000000006cf253
@property(readonly, nonatomic) float averageFPS;
- (void)renderWithTimestamp:(double)arg1 presentAtTime:(double)arg2 completion:(function_2e574590)arg3;	// IMP=0x00000000006cebf7
- (_Bool)hasRenderTarget;	// IMP=0x00000000006cebe9
- (void)destroyRenderTarget;	// IMP=0x00000000006ceb32
- (void)createRenderTarget;	// IMP=0x00000000006cea5d
...
- (void)didEnterBackground;	// IMP=0x00000000006ce86c
- (void)didReceiveMemoryWarning;	// IMP=0x00000000006ce866
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x00000000006ce7e6
- (void)_didReadPixels:(void *)arg1;	// IMP=0x00000000006ce6bb
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x00000000006ce085
- (void)setBackgroundColor:(struct CGColor *)arg1;	// IMP=0x00000000006ce06f
- (void)setContentsGravity:(id)arg1;	// IMP=0x00000000006ce059
- (void)setOpaque:(_Bool)arg1;	// IMP=0x00000000006ce043
- (void)setNeedsDisplayOnBoundsChange:(_Bool)arg1;	// IMP=0x00000000006ce02d
- (void)expandedPerformanceHUD:(id)arg1;	// IMP=0x00000000006cdfc7
- (void)disablePerformanceHUD:(id)arg1;	// IMP=0x00000000006cdfb0
- (void)enablePerformanceHUD:(id)arg1;	// IMP=0x00000000006cdf96
@property(readonly, nonatomic) void *renderer;
- (void)didPresent;	// IMP=0x00000000006cdd7f
- (void)willPresent;	// IMP=0x00000000006cdcdb
- (void)didUpdateFrameTexture;	// IMP=0x00000000006cdc37
- (void)willUpdateFrameTexture;	// IMP=0x00000000006cdb93
- (void)drawToTexture:(void *)arg1 withRenderQueue:(void *)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006cd76c
- (void)drawToTexture:(void *)arg1 withRenderQueue:(void *)arg2;	// IMP=0x00000000006cd757
- (void *)_renderQueueForTimestamp:(double)arg1 prepareHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000006cd6c1
- (void *)renderQueueForTimestamp:(double)arg1;	// IMP=0x00000000006cd695
- (_Bool)isDelayedRenderQueueConsumptionSupported;	// IMP=0x00000000006cd64a
- (void)prepareTargetsForPlatormsWithoutFramebufferFetch:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x00000000006ccc48
- (void)prepareTargetsForPlatormsWithFramebufferFetch:(const void *)arg1;	// IMP=0x00000000006cc924
- (void)_prepareTexture:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x00000000006cc871
- (void)prepareTexture:(const void *)arg1;	// IMP=0x00000000006cc85a
- (void)dealloc;	// IMP=0x00000000006cc5e2
- (id)initWithContentScale:(double)arg1 useMultisampling:(_Bool)arg2 extraColorFormats:(const void *)arg3 shouldRasterize:(_Bool)arg4 allowBlitToDrawable:(_Bool)arg5 taskContext:(const void *)arg6 device:(void *)arg7 sharedResources:(id)arg8 signpostId:(unsigned long long)arg9;	// IMP=0x00000000006cbc96
