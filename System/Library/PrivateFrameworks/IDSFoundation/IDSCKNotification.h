...
+ (id)notificationFromRemoteNotificationDictionary:(id)arg1;	// IMP=0x00600000000a8e35
+ (Class)__class;	// IMP=0x00600000000a8de5
- (void).cxx_destruct;	// IMP=0x00000000000a8ea2
