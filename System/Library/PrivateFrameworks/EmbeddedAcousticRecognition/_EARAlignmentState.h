...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000515d71
- (void)incrementCost;	// IMP=0x0000000000515d67
- (void)incrementSubstitutions;	// IMP=0x0000000000515d5d
- (void)incrementDeletions;	// IMP=0x0000000000515d53
- (void)incrementInsertions;	// IMP=0x0000000000515d49
