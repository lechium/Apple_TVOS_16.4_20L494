...
- (id).cxx_construct;	// IMP=0x00000000000a3249
- (void).cxx_destruct;	// IMP=0x00000000000a31d4
...
- (void)updateLoggableResultWithCurrentResult:(const void *)arg1 currentCosts:(const void *)arg2 startMilliseconds:(unsigned int)arg3;	// IMP=0x00000000000a2d6f
- (id)description;	// IMP=0x00000000000a2c91
- (void)resetPartialResultContext;	// IMP=0x00000000000a2c3e
- (void)addPartialResultToContext:(const void *)arg1;	// IMP=0x00000000000a2b5c
- (void)incrementCountOfIsFinalFalseAlreadyWritten;	// IMP=0x00000000000a2b52
