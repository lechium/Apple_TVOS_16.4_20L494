...
- (id).cxx_construct;	// IMP=0x000000000005ac4c
- (void).cxx_destruct;	// IMP=0x000000000005ac12
- (unsigned long long)drawNoise;	// IMP=0x000000000005ab1a
- (id)initWithUnigram:(float *)arg1 ofSize:(unsigned long long)arg2;	// IMP=0x000000000005a404
- (id)initWithZipfOfSize:(unsigned long long)arg1;	// IMP=0x000000000005a28e
- (id)init;	// IMP=0x000000000005a280
