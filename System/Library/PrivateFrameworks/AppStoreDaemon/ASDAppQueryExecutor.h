...
- (void).cxx_destruct;	// IMP=0x0000000000027d45
@property(nonatomic) long long queryOptions; // @synthesize queryOptions=_queryOptions;
- (void)executeQueryWithPredicate:(id)arg1 onPairedDevice:(id)arg2 withResultHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000026bc0
- (id)initWithServiceBroker:(id)arg1;	// IMP=0x0000000000026b07
- (id)init;	// IMP=0x0000000000026af3
