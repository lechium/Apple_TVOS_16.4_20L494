...
+ (float)getMemoryUsage:(id)arg1 logType:(id)arg2 timeDelta:(double)arg3;	// IMP=0x00600000000de970
- (void).cxx_destruct;	// IMP=0x00000000000deea0
...
- (double)getTime;	// IMP=0x00000000000de900
- (id)initWithSwitch:(_Bool)arg1 atLevel:(BOOL)arg2;	// IMP=0x00000000000de780
