...
- (void).cxx_destruct;	// IMP=0x00000000000bab32
...
- (unsigned int)_updateWithDeviceIE:(const char *)arg1 end:(const char *)arg2;	// IMP=0x00000000000b9f9c
- (id)description;	// IMP=0x00000000000b9e05
