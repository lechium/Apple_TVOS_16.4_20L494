...
- (void).cxx_destruct;	// IMP=0x0000000000064a5c
...
- (void)performRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000006473c
- (void)setupWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000644e2
- (void)invalidate;	// IMP=0x00000000000644b0
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000642c5
