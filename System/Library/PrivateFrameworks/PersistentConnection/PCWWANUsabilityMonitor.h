...
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x00000000000163c9
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x0000000000016279
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000016157
...
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x0000000000015a62
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x00000000000159e9
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x0000000000015935
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x00000000000158e7
@property(readonly, nonatomic) struct __CFString *wwanInterfaceName;
@property(readonly, nonatomic) int currentRAT; // @synthesize currentRAT=_currentRAT;
- (id)_currentDataSimContext;	// IMP=0x0000000000015623
...
- (_Bool)_isCurrentDataSimContextOnIvarQueue:(id)arg1;	// IMP=0x000000000001559d
- (void)_adjustInterfaceNameForWWANContextID:(int)arg1 interfaceName:(id)arg2 forContext:(id)arg3;	// IMP=0x0000000000015358
- (void)_setupWWANMonitor;	// IMP=0x0000000000015282
- (void)dealloc;	// IMP=0x0000000000015224
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x0000000000015089
