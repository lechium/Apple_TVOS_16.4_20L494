...
- (void).cxx_destruct;	// IMP=0x0000000000015035
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x0000000000014efb
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x0000000000014d2e
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000014c0c
...
- (int)_linkQualityOnIvarQueue;	// IMP=0x000000000001480d
@property(readonly, nonatomic) long long interfaceIdentifier;
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x0000000000014786
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x000000000001470d
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x0000000000014659
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x000000000001460b
- (void)_addMonitor;	// IMP=0x000000000001454b
- (void)dealloc;	// IMP=0x0000000000014507
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x0000000000014384
