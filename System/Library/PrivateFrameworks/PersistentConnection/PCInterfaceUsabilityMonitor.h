...
+ (id)stringForLinkQuality:(int)arg1;	// IMP=0x001000000001392f
+ (_Bool)isBadLinkQuality:(int)arg1;	// IMP=0x0010000000012b6f
+ (_Bool)isPoorLinkQuality:(int)arg1;	// IMP=0x0010000000012b1f
- (void).cxx_destruct;	// IMP=0x000000000001430c
- (_Bool)_createLinkQualityMonitor:(_Bool)arg1;	// IMP=0x0000000000013f2c
- (void)_dynamicStoreCallbackForKeys:(id)arg1;	// IMP=0x0000000000013ec7
- (void)_dynamicStoreCallback:(id)arg1;	// IMP=0x0000000000013c39
- (void)_processLinkQualityUpdateWithChangedKey:(id)arg1 updatedLinkQuality:(int)arg2;	// IMP=0x0000000000013971
- (void)_unscheduleLinkQualityMonitor;	// IMP=0x00000000000138e8
- (void)_updatePathParameters;	// IMP=0x00000000000137fa
- (void)_pathUpdate:(id)arg1;	// IMP=0x00000000000131c8
- (void)_createPathEvaluator;	// IMP=0x0000000000013014
- (void)_unschedulePathEvaluator;	// IMP=0x0000000000012f2f
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012db0
...
- (_Bool)_isInterfaceHistoricallyUsable;	// IMP=0x0000000000012a4c
@property(readonly, nonatomic) _Bool isInterfaceUsable;
- (_Bool)_isInterfaceUsable;	// IMP=0x00000000000129ed
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x000000000001298a
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x0000000000012937
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x00000000000128b1
- (void)_flushStaleTransitions;	// IMP=0x000000000001272c
- (void)_updateOffTransitionsForLinkQualityChange;	// IMP=0x000000000001266d
- (id)currentInterfaceName;	// IMP=0x00000000000125e8
- (void)dealloc;	// IMP=0x0000000000012553
- (id)initWithInterfaceIdentifier:(long long)arg1 delegateQueue:(id)arg2;	// IMP=0x0000000000012448
- (id)init;	// IMP=0x00000000000123ca
