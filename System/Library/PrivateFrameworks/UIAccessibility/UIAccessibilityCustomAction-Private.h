...
- (id)_accessibilityAXAttributedName;	// IMP=0x0030000000011ba0
- (_Bool)_accessibilityMatchesCustomActionIdentifier:(id)arg1;	// IMP=0x0030000000011b10
- (id)_accessibilityCustomActionIdentifier;	// IMP=0x00300000000119e0
