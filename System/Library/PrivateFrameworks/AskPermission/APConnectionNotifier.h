...
+ (id)sharedNotifier;	// IMP=0x00400000000018cf
- (void).cxx_destruct;	// IMP=0x0000000000002087
...
- (id)_newRemoteConnection;	// IMP=0x0000000000001a6c
- (id)_remoteConnection;	// IMP=0x0000000000001924
@property(readonly, nonatomic) id <ConnectionProtocol> remoteObjectProxy;
- (id)init;	// IMP=0x0000000000001625
