...
+ (id)unzipStateWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0060000000022501
- (void).cxx_destruct;	// IMP=0x0000000000022898
...
- (id)initWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001e7fb
- (_Bool)openCurrentOutputFDForPath:(id)arg1 withOpenFlags:(int)arg2 mode:(unsigned short)arg3 error:(id *)arg4;	// IMP=0x000000000001e42b
- (id)finishStream;	// IMP=0x000000000001e302
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3;	// IMP=0x000000000001e2ed
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3 onlyFinishCurrentChunk:(_Bool)arg4;	// IMP=0x000000000001e022
- (id)checkLastChunkPartialHash;	// IMP=0x000000000001dd5f
- (id)_checkHashForOffset:(unsigned long long)arg1;	// IMP=0x000000000001d6c2
- (id)serializeState;	// IMP=0x000000000001c939
- (void)markResumptionPoint;	// IMP=0x000000000001c933
- (void)clearSavedState;	// IMP=0x000000000001c870
- (void)_internalSetStreamState:(unsigned char)arg1;	// IMP=0x000000000001c52e
@property(readonly, nonatomic) CDStruct_4686af4b *cmpState;
- (void)dealloc;	// IMP=0x000000000001c4c3
- (id)init;	// IMP=0x000000000001c4a0
