...
- (void).cxx_destruct;	// IMP=0x000000000002bcf8
...
- (void)executeCallbackwithResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000002baba
- (id)initWithAQIScaleRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002ba3c
- (id)initWithForecastRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002b9c5
