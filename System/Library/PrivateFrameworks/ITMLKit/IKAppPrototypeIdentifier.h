...
- (void).cxx_destruct;	// IMP=0x00000000000e07be
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e0527
- (unsigned long long)hash;	// IMP=0x00000000000e04e3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e04d8
- (id)initWithIdentifier:(id)arg1 selector:(id)arg2 groupingValues:(id)arg3;	// IMP=0x00000000000e03f2
