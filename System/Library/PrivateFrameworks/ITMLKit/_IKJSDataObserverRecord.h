...
+ (id)hashForObserver:(id)arg1;	// IMP=0x0060000000024dfa
- (void).cxx_destruct;	// IMP=0x0000000000025092
...
- (_Bool)isAffectedByPropertyPathWithString:(id)arg1 subpathString:(id *)arg2;	// IMP=0x0000000000024f28
- (id)initWithObserver:(id)arg1 pathString:(id)arg2;	// IMP=0x0000000000024e1f
