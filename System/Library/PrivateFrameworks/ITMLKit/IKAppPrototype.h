...
- (void).cxx_destruct;	// IMP=0x00000000000e14e4
...
- (id)_sparseObjectFromObject:(id)arg1 usingPropertyPaths:(id)arg2;	// IMP=0x00000000000e0b94
- (void)updateUsageIndexesWithChangeSet:(id)arg1;	// IMP=0x00000000000e0a56
- (void)removeUsageForIndex:(long long)arg1;	// IMP=0x00000000000e0a40
- (void)addUsageForIndex:(long long)arg1;	// IMP=0x00000000000e09e8
@property(readonly, copy, nonatomic) NSIndexSet *usageIndexes;
- (id)initWithPrototype:(id)arg1 dataItem:(id)arg2;	// IMP=0x00000000000e07f1
- (void)dsepm_setViewElement:(id)arg1;	// IMP=0x00000000000028e7
- (id)dsepm_viewElement;	// IMP=0x00000000000028d6
