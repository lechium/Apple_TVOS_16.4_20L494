...
+ (id)_prototypeGroupsByTypeForDOMElement:(id)arg1;	// IMP=0x001000000009401c
+ (id)_parsedMutationRulesForDOMElement:(id)arg1;	// IMP=0x0010000000093b6d
+ (id)instantiateDOMElementForItem:(id)arg1 withPrototype:(id)arg2 parentDOMElement:(id)arg3 existingDOMElement:(id)arg4;	// IMP=0x0010000000092a21
+ (id)domBindingControllerForDOMElement:(id)arg1;	// IMP=0x00100000000911ac
+ (void)prepareForDOMElement:(id)arg1;	// IMP=0x00100000000910f2
+ (id)parsedBindingForDOMElement:(id)arg1;	// IMP=0x00100000000908d6
- (void).cxx_destruct;	// IMP=0x0000000000096040
...
- (void)_evaluateMutationRules;	// IMP=0x0000000000095d5b
- (void)_resolveBinding;	// IMP=0x0000000000094a5f
- (_Bool)_canBeReused;	// IMP=0x00000000000947e0
- (void)dataObservable:(id)arg1 didChangePropertyPathWithString:(id)arg2 extraInfo:(id)arg3;	// IMP=0x000000000009323f
- (id)findPrototypeForDataItem:(id)arg1;	// IMP=0x0000000000092e4b
- (void)scheduleUpdateUsingPreUpdate:(CDUnknownBlockType)arg1 update:(CDUnknownBlockType)arg2;	// IMP=0x000000000009230b
- (void)dealloc;	// IMP=0x000000000009225a
- (id)initWithDOMElement:(id)arg1;	// IMP=0x00000000000911c1
