...
- (void)mutateWithDOMElement:(id)arg1;	// IMP=0x0000000000011a32
- (_Bool)passesForDataItem:(id)arg1 default:(_Bool)arg2;	// IMP=0x000000000001172a
...
- (id)initWithDOMElement:(id)arg1;	// IMP=0x00000000000111d1
