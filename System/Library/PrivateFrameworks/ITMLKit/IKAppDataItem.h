...
- (void).cxx_destruct;	// IMP=0x00000000000e19ea
...
- (id)valueForPropertyPath:(id)arg1;	// IMP=0x00000000000e1920
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e1915
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e1677
- (unsigned long long)hash;	// IMP=0x00000000000e1633
- (id)initWithType:(id)arg1 identifier:(id)arg2 prototypeIdentifier:(id)arg3 dataDictionary:(id)arg4;	// IMP=0x00000000000e1520
