...
- (id)personalDevicesForUser:(id)arg1;	// IMP=0x003000000005c688
- (id)devicesByRemovingNonAccessoryDevicesNotBelongingToUsers:(id)arg1;	// IMP=0x003000000005c31c
- (id)devicesInHome:(id)arg1;	// IMP=0x003000000005c00a
