...
- (void).cxx_destruct;	// IMP=0x000000000005d23c
...
- (void)buttonLockupPressed;	// IMP=0x000000000005d040
- (void)setupLocalizedStrings;	// IMP=0x000000000005ce17
- (void)setupLayout;	// IMP=0x000000000005b2be
- (void)setupDetailsView;	// IMP=0x000000000005af2e
- (void)setupInfoView;	// IMP=0x000000000005ae41
- (void)updateUIWithViewModel:(id)arg1;	// IMP=0x000000000005acf8
- (id)initWithButtonLockup:(_Bool)arg1;	// IMP=0x000000000005ac6f
