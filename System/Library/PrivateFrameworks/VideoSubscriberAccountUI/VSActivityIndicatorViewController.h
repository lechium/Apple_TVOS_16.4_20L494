...
- (void).cxx_destruct;	// IMP=0x00000000000737d3
...
- (id)_textColor;	// IMP=0x0000000000073740
- (void)viewDidLayoutSubviews;	// IMP=0x000000000007323e
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000072f99
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000072f06
- (void)dealloc;	// IMP=0x0000000000072ea5
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000072dda
