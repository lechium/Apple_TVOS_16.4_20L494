...
- (void).cxx_destruct;	// IMP=0x0000000000056ed3
...
- (void)clearFieldsAfterUsername;	// IMP=0x0000000000056be5
- (void)pickerDidSelectRow:(unsigned long long)arg1;	// IMP=0x0000000000056b94
- (void)buttonTappedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000056b43
- (void)validateCredentialEntryFields;	// IMP=0x0000000000056961
- (void)configureWithRequest:(id)arg1;	// IMP=0x00000000000564bd
- (void)_bindField:(id)arg1;	// IMP=0x00000000000562bc
- (void)_unbindField:(id)arg1;	// IMP=0x0000000000056265
