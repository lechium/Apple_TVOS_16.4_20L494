...
- (void).cxx_destruct;	// IMP=0x0000000000017856
...
- (id)removeAllMessages;	// IMP=0x00000000000177c7
- (void)addMessage:(id)arg1;	// IMP=0x00000000000176a9
- (id)init;	// IMP=0x00000000000175ad
