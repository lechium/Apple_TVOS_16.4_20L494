...
+ (id)toVSSubscriptions:(id)arg1;	// IMP=0x00100000000509f1
- (void).cxx_destruct;	// IMP=0x0000000000050d48
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000050bb9
- (id)toVSSubscription;	// IMP=0x000000000005088b
- (id)init;	// IMP=0x00000000000507ad
