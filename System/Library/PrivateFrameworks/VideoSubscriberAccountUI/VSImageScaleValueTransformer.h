...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000007e45
+ (Class)transformedValueClass;	// IMP=0x0060000000007e34
@property(nonatomic) struct CGSize preferredSize; // @synthesize preferredSize=_preferredSize;
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000007e4d
