...
- (void).cxx_destruct;	// IMP=0x0000000000046b70
...
- (void)buttonAtIndexWasPressed:(unsigned long long)arg1;	// IMP=0x0000000000046a56
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000004688c
