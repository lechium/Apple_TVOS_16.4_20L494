...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x00100000000194b1
+ (void)registerFeature;	// IMP=0x001000000001947f
...
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x0000000000019548
