...
- (void).cxx_destruct;	// IMP=0x0000000000018a3f
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000001890e
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000001887b
- (void)dealloc;	// IMP=0x0000000000018845
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000187f0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000017f3b
