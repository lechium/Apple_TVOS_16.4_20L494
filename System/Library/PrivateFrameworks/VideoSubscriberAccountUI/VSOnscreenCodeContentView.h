...
- (void).cxx_destruct;	// IMP=0x000000000001cace
...
- (void)setupLayout;	// IMP=0x000000000001c201
- (void)setupSeparatorContainer;	// IMP=0x000000000001c19c
- (void)setupWebsiteContainer;	// IMP=0x000000000001c107
- (void)setupQRCodeContainer;	// IMP=0x000000000001c0a2
- (void)buttonLockupPressed;	// IMP=0x000000000001c065
- (void)updateUIWithViewModel:(id)arg1;	// IMP=0x000000000001bfc5
- (void)setupViews;	// IMP=0x000000000001bf8a
- (id)initWithButtonLockup:(_Bool)arg1;	// IMP=0x000000000001bf1b
