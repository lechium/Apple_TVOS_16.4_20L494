...
- (void).cxx_destruct;	// IMP=0x0000000000071ba2
...
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x00000000000717d2
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x0000000000071660
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x0000000000071592
- (id)sectionIndexTitlesForTableView:(id)arg1;	// IMP=0x000000000007150a
- (id)tableView:(id)arg1 indexPathForSectionIndexTitle:(id)arg2 atIndex:(long long)arg3;	// IMP=0x0000000000071348
- (void)setNumberOfLinesForCell:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x0000000000071306
- (void)_scrollToTableHeaderView;	// IMP=0x0000000000071226
- (id)_textColorForRowAtIndexPath:(id)arg1;	// IMP=0x000000000007114d
- (long long)_textAlignmentForRowAtIndexPath:(id)arg1;	// IMP=0x00000000000710ea
- (id)_titleForRowAtIndexPath:(id)arg1;	// IMP=0x000000000007101c
- (long long)_cellStyleForRowAtIndexPath:(id)arg1;	// IMP=0x0000000000071014
- (id)_cellReuseIdentifierForRowAtIndexPath:(id)arg1;	// IMP=0x0000000000070fd1
- (id)_additionalProvidersRowTitle;	// IMP=0x0000000000070ee5
- (_Bool)hasStorefrontOrIdentityProviderAtIndexPath:(id)arg1;	// IMP=0x0000000000070e78
- (id)storefrontAtIndexPath:(id)arg1;	// IMP=0x0000000000070d90
- (id)identityProviderForRowAtIndexPath:(id)arg1;	// IMP=0x0000000000070c6b
- (unsigned long long)_minimumProviderCountForIndexes;	// IMP=0x0000000000070abe
- (id)init;	// IMP=0x000000000006fc40
