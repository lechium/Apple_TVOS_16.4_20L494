...
- (void).cxx_destruct;	// IMP=0x0000000000024487
...
- (void)cancel;	// IMP=0x0000000000024219
- (void)executionDidBegin;	// IMP=0x0000000000024207
- (void)_promptForPrivacyWithDisplayNameIfRequired:(id)arg1 providerID:(id)arg2 providerIsSupported:(_Bool)arg3 allowUI:(_Bool)arg4;	// IMP=0x0000000000023e93
- (void)_determineProviderDisplayNameWithUI:(_Bool)arg1;	// IMP=0x0000000000023867
- (void)_checkSupportedProviders;	// IMP=0x0000000000023187
- (void)_finishWithSupportedProviders:(id)arg1;	// IMP=0x00000000000228e4
- (void)_checkAvailability;	// IMP=0x0000000000022761
- (void)_continueCheckPrivacyWithAccessStatus:(unsigned long long)arg1;	// IMP=0x00000000000225c2
- (void)_checkPrivacy;	// IMP=0x0000000000021de0
- (void)_checkEntitlement;	// IMP=0x0000000000021c98
- (void)_finishWithError:(id)arg1;	// IMP=0x0000000000021b82
- (id)_privacyServiceWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000021aff
- (void)dealloc;	// IMP=0x0000000000021ab6
- (id)init;	// IMP=0x0000000000021863
