...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x0010000000026c9d
...
- (void)messagePort:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x0000000000026eac
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x0000000000026dde
