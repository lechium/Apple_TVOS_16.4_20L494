...
- (void).cxx_destruct;	// IMP=0x00000000000464b2
...
- (void)setupLocalizedStrings;	// IMP=0x000000000004639a
- (void)setupLayout;	// IMP=0x0000000000045b78
- (void)setupViews;	// IMP=0x00000000000458ec
