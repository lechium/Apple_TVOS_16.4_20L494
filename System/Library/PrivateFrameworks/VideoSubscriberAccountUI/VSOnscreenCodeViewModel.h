...
- (id)formattedWebsiteURL;	// IMP=0x000000000001d26d
- (id)websiteURLWithQueryParameters;	// IMP=0x000000000001cd52
- (void)generateQRCode;	// IMP=0x000000000001cb83
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000001cb1f
