...
+ (id)treatmentActionWithField:(id)arg1 configuration:(id)arg2 topic:(id)arg3;	// IMP=0x006000000002f770
- (void).cxx_destruct;	// IMP=0x0000000000030c6e
- (id)performAction:(id)arg1 context:(id)arg2;	// IMP=0x000000000003040e
- (void)performActionWithContext:(id)arg1;	// IMP=0x000000000002fdec
- (id)initWithField:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000002f95f
