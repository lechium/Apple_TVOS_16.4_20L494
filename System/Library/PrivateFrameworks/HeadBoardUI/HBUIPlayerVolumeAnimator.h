...
- (void).cxx_destruct;	// IMP=0x000000000000b689
...
- (void)_handleDisplayLink:(id)arg1;	// IMP=0x000000000000b4f2
- (void)invalidate;	// IMP=0x000000000000b49c
- (void)setVolume:(float)arg1;	// IMP=0x000000000000b488
- (void)setVolume:(float)arg1 animated:(_Bool)arg2;	// IMP=0x000000000000b2b8
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000000000b1c8
