...
- (_Bool)_isSupportedCharacterSetForFont:(id)arg1 string:(id)arg2;	// IMP=0x000000000000259b
- (void)setText:(id)arg1;	// IMP=0x0000000000002415
- (double)_firstBaselineOffsetFromTop;	// IMP=0x0000000000002280
- (void)drawTextInRect:(struct CGRect)arg1;	// IMP=0x0000000000002204
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000021ad
