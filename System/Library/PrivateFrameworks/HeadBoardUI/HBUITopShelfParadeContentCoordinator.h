...
- (void).cxx_destruct;	// IMP=0x00000000000077cd
...
- (void)paradeContentViewController:(id)arg1 didSelectAction:(id)arg2 forItem:(id)arg3;	// IMP=0x0000000000007678
- (void)paradeBackgroundViewControllerDidFinish:(id)arg1;	// IMP=0x000000000000761e
- (void)paradeBackgroundViewControllerContentStateDidChange:(id)arg1;	// IMP=0x0000000000007511
- (void)_configureContentGradientViewWithImage:(id)arg1;	// IMP=0x00000000000072dc
- (void)_updateStandardTitleView;	// IMP=0x0000000000006bef
- (_Bool)_promotionVideoIsPlaying;	// IMP=0x0000000000006bd1
- (void)_updateActionsDetailsViewAlpha;	// IMP=0x0000000000006b4c
- (void)_updateStandardAndPromotionTitleViewAlpha;	// IMP=0x0000000000006a36
- (id)initWithContentOptions:(unsigned long long)arg1;	// IMP=0x0000000000005aae
