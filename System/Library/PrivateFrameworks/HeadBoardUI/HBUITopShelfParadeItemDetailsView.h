...
- (void).cxx_destruct;	// IMP=0x000000000000f9e9
...
- (_Bool)canBecomeFocused;	// IMP=0x000000000000f7f3
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000000f720
- (id)preferredFocusEnvironments;	// IMP=0x000000000000f6b5
- (void)updateContentRating:(id)arg1;	// IMP=0x000000000000f567
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000d8ef
