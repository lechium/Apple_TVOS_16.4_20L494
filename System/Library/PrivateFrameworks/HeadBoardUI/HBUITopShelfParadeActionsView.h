...
- (void).cxx_destruct;	// IMP=0x0000000000010c11
...
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000010b2e
- (id)preferredFocusEnvironments;	// IMP=0x0000000000010ab4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000010642
