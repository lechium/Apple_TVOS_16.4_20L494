...
- (void)_willFailWithReason:(id)arg1;	// IMP=0x000000000001052b
- (void)_willInterruptWithReason:(id)arg1;	// IMP=0x00000000000104dd
- (_Bool)_canBeInterrupted;	// IMP=0x00000000000104d5
- (void)_begin;	// IMP=0x000000000001026a
- (id)initWithTimingParameters:(id)arg1 duration:(double)arg2 delay:(double)arg3 animations:(CDUnknownBlockType)arg4;	// IMP=0x000000000001008f
