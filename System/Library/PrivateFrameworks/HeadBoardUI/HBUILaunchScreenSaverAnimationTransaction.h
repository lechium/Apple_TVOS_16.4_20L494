...
- (void)_begin;	// IMP=0x000000000002c384
- (id)debugDescription;	// IMP=0x000000000002c29d
- (id)initWithContext:(id)arg1 topShelfAnimation:(id)arg2 appGridAnimation:(id)arg3;	// IMP=0x000000000002bf84
