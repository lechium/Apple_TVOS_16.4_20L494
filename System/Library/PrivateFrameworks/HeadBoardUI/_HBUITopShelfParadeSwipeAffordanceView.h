...
- (void).cxx_destruct;	// IMP=0x000000000001b479
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000001b446
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001b22b
