...
+ (id)wf_valueWithCGAffineTransform:(struct CGAffineTransform)arg1;	// IMP=0x002000000006197d
+ (id)wf_valueWithCGRect:(struct CGRect)arg1;	// IMP=0x002000000006196b
+ (id)wf_valueWithCGSize:(struct CGSize)arg1;	// IMP=0x0020000000061959
+ (id)wf_valueWithCGVector:(struct CGVector)arg1;	// IMP=0x0020000000061947
+ (id)wf_valueWithCGPoint:(struct CGPoint)arg1;	// IMP=0x0020000000061935
