...
- (void).cxx_destruct;	// IMP=0x000000000007a4d6
...
- (id)primaryIconView;	// IMP=0x000000000007a41f
- (id)playable;	// IMP=0x000000000007a402
- (id)subtitleButton;	// IMP=0x000000000007a347
- (id)button;	// IMP=0x000000000007a2db
- (void)updateTextStack;	// IMP=0x0000000000079e36
- (void)_buildViewsForCaptionBarIfNeeded;	// IMP=0x000000000007898e
- (void)setPresentationProperties:(id)arg1;	// IMP=0x000000000007897a
- (struct CGSize)_layoutCaptionBarForSize:(struct CGSize)arg1 applyingLayout:(_Bool)arg2;	// IMP=0x0000000000074ecd
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000074eb9
- (void)layoutComponentView;	// IMP=0x0000000000074e6b
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000074dc4
- (void)animateInWithBaseAnimation:(id)arg1 currentTime:(double)arg2;	// IMP=0x0000000000074a68
- (void)animateOut;	// IMP=0x00000000000747bb
- (void)setPlaybackInformation:(id)arg1;	// IMP=0x0000000000074745
- (id)initWithHost:(id)arg1 style:(id)arg2 presentationProperties:(id)arg3;	// IMP=0x00000000000745d6
- (id)initWithHost:(id)arg1;	// IMP=0x00000000000745c8
