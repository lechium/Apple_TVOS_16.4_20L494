...
- (void).cxx_destruct;	// IMP=0x00000000000406bb
...
- (id)adjustedForString:(id)arg1;	// IMP=0x00000000000405bd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000040518
- (id)initWithPlatform:(long long)arg1 fontScalingFactor:(double)arg2;	// IMP=0x000000000003fd4a
