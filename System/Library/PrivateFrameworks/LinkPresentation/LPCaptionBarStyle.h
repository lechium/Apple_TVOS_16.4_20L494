...
- (void).cxx_destruct;	// IMP=0x0000000000044af4
...
- (id)rightAccessory;	// IMP=0x0000000000044948
- (id)leftAccessory;	// IMP=0x0000000000044904
- (id)rightIcon;	// IMP=0x00000000000448c0
- (id)leftIcon;	// IMP=0x000000000004487c
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x0000000000043d34
