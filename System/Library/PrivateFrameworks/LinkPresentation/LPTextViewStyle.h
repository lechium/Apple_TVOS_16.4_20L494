...
- (void).cxx_destruct;	// IMP=0x000000000003fcd5
...
- (id)adjustedForString:(id)arg1;	// IMP=0x000000000003fb1e
- (void)_adjustForString:(id)arg1;	// IMP=0x000000000003fa5f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003f92d
- (id)initWithPlatform:(long long)arg1 fontScalingFactor:(double)arg2;	// IMP=0x000000000003f7bf
