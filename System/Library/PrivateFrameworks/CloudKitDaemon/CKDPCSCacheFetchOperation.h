...
- (void).cxx_destruct;	// IMP=0x0000000000296796
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002964a1
- (void)main;	// IMP=0x000000000029645d
- (void)_willRetryFetch;	// IMP=0x000000000029626b
- (_Bool)_savePCSDataToCache;	// IMP=0x0000000000296263
- (_Bool)_saveUpdatedPCSToServer;	// IMP=0x000000000029625b
- (_Bool)_decryptPCS;	// IMP=0x0000000000296253
- (_Bool)_fetchDependentPCS;	// IMP=0x000000000029624b
- (_Bool)_createAdditionalPCS;	// IMP=0x0000000000296243
- (_Bool)_fetchPCSDataFromServer;	// IMP=0x000000000029623b
- (_Bool)_fetchPCSDataFromDatabase;	// IMP=0x0000000000296233
- (_Bool)needsAdditionalPCSCreation;	// IMP=0x000000000029622b
@property(readonly, nonatomic) _Bool hasAllPCSData;
@property(readonly, nonatomic) NSString *itemTypeName;
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x0000000000296180
- (_Bool)makeStateTransition;	// IMP=0x00000000002956d0
- (_Bool)canBeUsedForOperation:(id)arg1 withOptions:(unsigned long long)arg2;	// IMP=0x0000000000295583
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000295485
