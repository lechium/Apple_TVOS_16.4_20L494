...
- (void).cxx_destruct;	// IMP=0x0000000000059516
...
- (void)_postflightRecords;	// IMP=0x0000000000058f9a
- (void)_deserialize;	// IMP=0x000000000005798b
- (void)_setupTranslator;	// IMP=0x00000000000575cc
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000574a6
- (_Bool)validateAgainstLiveContainer:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000572aa
- (void)main;	// IMP=0x0000000000057296
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x0000000000057240
- (_Bool)makeStateTransition;	// IMP=0x0000000000057134
- (id)activityCreate;	// IMP=0x000000000005710b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000005707c
