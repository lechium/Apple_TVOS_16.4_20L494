...
- (void).cxx_destruct;	// IMP=0x00000000000fcba9
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000fca49
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000fc82c
- (id)generateRequestOperations;	// IMP=0x00000000000fc5be
- (id)requestOperationClasses;	// IMP=0x00000000000fc552
- (id)initWithOperation:(id)arg1 shareRecordID:(id)arg2 encryptedKey:(id)arg3 participantID:(id)arg4 baseToken:(id)arg5;	// IMP=0x00000000000fc457
