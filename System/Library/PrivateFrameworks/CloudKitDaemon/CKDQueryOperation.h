...
- (void).cxx_destruct;	// IMP=0x000000000007b00a
...
- (id)relevantZoneIDs;	// IMP=0x000000000007ad8c
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000007ad26
- (void)main;	// IMP=0x000000000007a361
- (void)_sendQueryRequestWithCursor:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x0000000000079076
- (void)_handleRecordResponses:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x0000000000078341
- (id)_wrapError:(id)arg1 format:(id)arg2;	// IMP=0x000000000007813e
- (void)_handleQueryRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x0000000000077a8b
- (id)activityCreate;	// IMP=0x0000000000077a62
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x0000000000077a4a
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000776e9
