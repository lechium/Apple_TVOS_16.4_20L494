...
- (void).cxx_destruct;	// IMP=0x00000000003507d8
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000003504ed
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000034f09a
- (id)generateRequestOperations;	// IMP=0x000000000034e946
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000034e8c8
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x000000000034e8c0
- (id)requestOperationClasses;	// IMP=0x000000000034e854
- (id)zoneIDsToLock;	// IMP=0x000000000034e842
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000034e828
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2;	// IMP=0x000000000034e75d
