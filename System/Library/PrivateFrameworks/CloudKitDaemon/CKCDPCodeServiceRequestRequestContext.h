...
- (void).cxx_destruct;	// IMP=0x000000000034a7a1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000034a4b0
- (unsigned long long)hash;	// IMP=0x000000000034a339
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000034a0a7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000349eb5
- (void)copyTo:(id)arg1;	// IMP=0x0000000000349d31
- (void)writeTo:(id)arg1;	// IMP=0x0000000000349bb9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000349bac
- (id)dictionaryRepresentation;	// IMP=0x00000000003493ea
- (id)description;	// IMP=0x000000000034933b
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x0000000000349188
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x000000000034913f
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsDatabaseEnvironment:(id)arg1;	// IMP=0x0000000000349073
- (id)databaseEnvironmentAsString:(int)arg1;	// IMP=0x000000000034901e
