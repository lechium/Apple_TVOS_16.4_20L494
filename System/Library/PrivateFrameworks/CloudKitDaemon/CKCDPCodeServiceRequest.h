...
+ (Class)clientConfigType;	// IMP=0x0010000000334a2c
- (void).cxx_destruct;	// IMP=0x0000000000336b92
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000336697
- (unsigned long long)hash;	// IMP=0x00000000003364eb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003361ea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000335e2c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000335bec
- (Class)responseClass;	// IMP=0x0000000000335bdb
- (unsigned int)requestTypeCode;	// IMP=0x0000000000335bd0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000335948
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000033538b
- (id)dictionaryRepresentation;	// IMP=0x0000000000334dce
- (id)description;	// IMP=0x0000000000334d1f
- (void)clearOneofValuesForDataProtection;	// IMP=0x0000000000334cbf
- (int)StringAsDataProtection:(id)arg1;	// IMP=0x0000000000334c2d
- (id)dataProtectionAsString:(int)arg1;	// IMP=0x0000000000334be4
...
- (id)clientConfigAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000334a0f
- (unsigned long long)clientConfigsCount;	// IMP=0x00000000003349f2
- (void)addClientConfig:(id)arg1;	// IMP=0x0000000000334988
- (void)clearClientConfigs;	// IMP=0x000000000033496b
- (int)StringAsSerializationFormat:(id)arg1;	// IMP=0x0000000000334904
- (id)serializationFormatAsString:(int)arg1;	// IMP=0x00000000003348ae
