...
- (void).cxx_destruct;	// IMP=0x0000000000167295
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000016719b
- (unsigned long long)hash;	// IMP=0x00000000001670ff
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000166fd8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000166efd
- (void)copyTo:(id)arg1;	// IMP=0x0000000000166e5d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000166db1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000166da4
- (id)dictionaryRepresentation;	// IMP=0x000000000016696d
- (id)description;	// IMP=0x00000000001668be
@property(nonatomic) _Bool hasSkipBundleIDCheck;
- (int)StringAsApnsEnv:(id)arg1;	// IMP=0x0000000000166813
- (id)apnsEnvAsString:(int)arg1;	// IMP=0x00000000001667be
