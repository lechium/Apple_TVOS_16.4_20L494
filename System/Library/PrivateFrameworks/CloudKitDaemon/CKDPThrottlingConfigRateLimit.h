...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000016c3cc
- (unsigned long long)hash;	// IMP=0x000000000016c334
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016c212
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016c146
- (void)copyTo:(id)arg1;	// IMP=0x000000000016c09d
- (void)writeTo:(id)arg1;	// IMP=0x000000000016bfcd
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000016bfc0
- (id)dictionaryRepresentation;	// IMP=0x000000000016b97c
- (id)description;	// IMP=0x000000000016b8cd
