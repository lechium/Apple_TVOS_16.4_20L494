...
- (void).cxx_destruct;	// IMP=0x00000000000f41d3
...
- (id)CKStatusReportArray;	// IMP=0x00000000000f39b7
- (void)merge:(id)arg1;	// IMP=0x00000000000f3481
- (void)addOperation:(id)arg1;	// IMP=0x00000000000f2f48
- (id)_trimmedError:(id)arg1;	// IMP=0x00000000000f29ff
- (void)_addMetrics:(id)arg1 toAggregate:(id)arg2;	// IMP=0x00000000000f2832
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f26e0
- (id)initWithOperationClassName:(id)arg1;	// IMP=0x00000000000f2640
