...
- (void).cxx_destruct;	// IMP=0x000000000024381b
...
- (void)main;	// IMP=0x0000000000243093
- (int)operationType;	// IMP=0x0000000000243088
- (void)_handleRecordZoneFetch:(id)arg1 zoneID:(id)arg2 responseCode:(id)arg3;	// IMP=0x0000000000242cee
- (id)activityCreate;	// IMP=0x0000000000242cc5
- (id)relevantZoneIDs;	// IMP=0x0000000000242a56
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002429c7
