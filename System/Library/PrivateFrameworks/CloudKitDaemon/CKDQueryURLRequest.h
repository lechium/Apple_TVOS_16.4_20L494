...
- (void).cxx_destruct;	// IMP=0x00000000000e5ed2
...
- (void)requestDidComplete;	// IMP=0x00000000000e5cc3
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000e59f6
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000e512b
- (id)generateRequestOperations;	// IMP=0x00000000000e44df
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000000e447d
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000000e4475
- (id)zoneIDsToLock;	// IMP=0x00000000000e43b9
- (_Bool)requestGETPreAuth;	// IMP=0x00000000000e434c
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000000e4332
- (id)requestOperationClasses;	// IMP=0x00000000000e42c6
- (id)initWithOperation:(id)arg1 query:(id)arg2 cursor:(id)arg3 limit:(unsigned long long)arg4 requestedFields:(id)arg5 zoneID:(id)arg6;	// IMP=0x00000000000e4147
