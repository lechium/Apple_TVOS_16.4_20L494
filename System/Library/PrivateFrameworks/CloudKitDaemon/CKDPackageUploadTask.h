...
- (void).cxx_destruct;	// IMP=0x00000000002f43f4
...
- (void)cancel;	// IMP=0x00000000002f430a
...
- (id)activityCreate;	// IMP=0x00000000002f40a0
- (id)initWithPackage:(id)arg1 trackProgress:(_Bool)arg2;	// IMP=0x00000000002f3efa
