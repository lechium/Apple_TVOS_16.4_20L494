...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000280491
- (void).cxx_destruct;	// IMP=0x0000000000280989
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002805f5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000280499
