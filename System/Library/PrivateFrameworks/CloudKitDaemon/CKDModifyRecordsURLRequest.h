...
- (void).cxx_destruct;	// IMP=0x0000000000333cca
...
- (void)requestDidComplete;	// IMP=0x0000000000333525
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000332f77
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000033217d
- (id)returnVerificationKeyAndSignatureForRequestOperation:(id)arg1 dataToBeSigned:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000331b8f
- (id)generateMergeableDeltaSaveOperationsForRecord:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000330a7d
- (id)generateRequestOperations;	// IMP=0x000000000032e30a
- (_Bool)requiresCKAnonymousSignature;	// IMP=0x000000000032e2f8
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x000000000032e2f0
- (int)isolationLevel;	// IMP=0x000000000032e2d3
- (id)requestOperationClasses;	// IMP=0x000000000032e1b9
- (id)zoneIDsToLock;	// IMP=0x000000000032de5e
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000032de44
- (id)initWithOperation:(id)arg1 recordsToSave:(id)arg2 recordIDsToDelete:(id)arg3 recordIDsToDeleteToSigningPCSIdentity:(id)arg4 oplock:(_Bool)arg5 sendAllFields:(_Bool)arg6 clientChangeTokenData:(id)arg7 requestedFieldsByRecordId:(id)arg8;	// IMP=0x000000000032dc1b
