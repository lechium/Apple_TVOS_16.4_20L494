...
- (void).cxx_destruct;	// IMP=0x00000000001614be
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001613a2
- (void)_sendRequest:(_Bool)arg1;	// IMP=0x00000000001608de
- (int)operationType;	// IMP=0x00000000001608d3
- (void)main;	// IMP=0x0000000000160592
- (id)_addSelfIdentityToShareMetadataPublicPCS:(id)arg1 forShareWithURL:(id)arg2 error:(id *)arg3;	// IMP=0x000000000015fadf
- (id)_encryptedKeyDataWithShareMetadata:(id)arg1 error:(id *)arg2;	// IMP=0x000000000015f873
- (void)_handleVettingInitiationProgress:(id)arg1;	// IMP=0x000000000015f732
- (id)activityCreate;	// IMP=0x000000000015f709
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000015f61c
