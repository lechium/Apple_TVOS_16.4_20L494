...
- (void).cxx_destruct;	// IMP=0x0000000000260b0b
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002604f9
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000260111
- (id)_handleRecords:(id)arg1;	// IMP=0x000000000025fe00
- (id)generateRequestOperations;	// IMP=0x000000000025f6b8
- (id)requestOperationClasses;	// IMP=0x000000000025f64c
- (id)zoneIDsToLock;	// IMP=0x000000000025f63a
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x000000000025f485
