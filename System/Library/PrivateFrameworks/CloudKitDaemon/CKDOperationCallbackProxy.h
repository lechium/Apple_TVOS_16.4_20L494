...
- (void).cxx_destruct;	// IMP=0x000000000022f874
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000022f671
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000022f56b
- (id)initWithClientOperationCallbackProxy:(id)arg1 callbackProtocol:(id)arg2;	// IMP=0x000000000022f4b1
