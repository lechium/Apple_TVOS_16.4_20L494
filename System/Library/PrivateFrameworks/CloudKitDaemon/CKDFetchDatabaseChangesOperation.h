...
- (void).cxx_destruct;	// IMP=0x000000000028633c
...
- (id)analyticsPayload;	// IMP=0x0000000000286015
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000285f7a
- (void)main;	// IMP=0x0000000000285dad
- (void)_handleAnonymousZoneDataObjects:(id)arg1 schedulerInfo:(id)arg2;	// IMP=0x00000000002851e1
- (void)_sendFetchDatabaseChangesRequestWithChangeToken:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000028357e
- (int)operationType;	// IMP=0x0000000000283573
- (void)_handleFetchDatabaseChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x0000000000283061
- (id)activityCreate;	// IMP=0x0000000000283038
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (_Bool)shouldReturnServerChangeTokensToAdopter;	// IMP=0x0000000000282ea4
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000282c25
