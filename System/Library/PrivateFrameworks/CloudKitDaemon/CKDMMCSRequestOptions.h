...
- (void).cxx_destruct;	// IMP=0x00000000002b9f7f
...
- (id)MMCSOptions;	// IMP=0x00000000002b9083
- (_Bool)usesBackgroundSession;	// IMP=0x00000000002b9032
- (id)description;	// IMP=0x00000000002b9020
- (id)CKPropertiesDescription;	// IMP=0x00000000002b8b76
- (id)initWithOperation:(id)arg1;	// IMP=0x00000000002b8797
