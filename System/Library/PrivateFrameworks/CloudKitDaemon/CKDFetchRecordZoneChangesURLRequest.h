...
- (void).cxx_destruct;	// IMP=0x00000000002d1150
...
- (void)requestDidComplete;	// IMP=0x00000000002d0f02
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002d0a0d
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002d0188
- (id)_handleRecordChanges:(id)arg1 deltaChanges:(id)arg2 forZoneID:(id)arg3;	// IMP=0x00000000002ce3e5
- (id)generateRequestOperations;	// IMP=0x00000000002cd13c
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000002cd134
- (_Bool)requestGETPreAuth;	// IMP=0x00000000002cd0c7
- (id)requestOperationClasses;	// IMP=0x00000000002cd05b
- (id)zoneIDsToLock;	// IMP=0x00000000002cd049
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000002cd02f
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x00000000002cce49
