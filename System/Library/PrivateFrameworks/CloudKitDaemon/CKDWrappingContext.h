...
- (void).cxx_destruct;	// IMP=0x00000000000a33a5
...
- (id)encryptedDataContextString;	// IMP=0x00000000000a31fd
- (id)assetContextString;	// IMP=0x00000000000a2dd7
- (id)initWithRecordID:(id)arg1 fieldName:(id)arg2 mergeableDeltaID:(id)arg3 fileSignature:(id)arg4 referenceSignature:(id)arg5;	// IMP=0x00000000000a2bbc
