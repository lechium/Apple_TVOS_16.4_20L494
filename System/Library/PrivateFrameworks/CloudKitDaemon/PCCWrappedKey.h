...
- (void).cxx_destruct;	// IMP=0x0000000000365b15
...
- (void)dealloc;	// IMP=0x0000000000365a97
- (void)clear;	// IMP=0x0000000000365a91
- (id)data;	// IMP=0x0000000000365a67
- (id)initWithKey:(id)arg1 permittedRemoteMeasurement:(id)arg2 attestation:(id)arg3;	// IMP=0x00000000003652a6
