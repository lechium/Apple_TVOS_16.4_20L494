...
- (void).cxx_destruct;	// IMP=0x00000000001775a9
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000177276
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000176fad
- (id)generateRequestOperations;	// IMP=0x0000000000176bac
- (id)requestOperationClasses;	// IMP=0x0000000000176b40
- (id)zoneIDsToLock;	// IMP=0x0000000000176af0
- (id)initWithOperation:(id)arg1 recordIDsToArchive:(id)arg2;	// IMP=0x0000000000176835
