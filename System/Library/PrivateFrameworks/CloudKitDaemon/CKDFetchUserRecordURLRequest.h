...
- (void).cxx_destruct;	// IMP=0x00000000001abc6b
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001ab7bc
- (id)generateRequestOperations;	// IMP=0x00000000001ab6ee
- (id)requestOperationClasses;	// IMP=0x00000000001ab682
