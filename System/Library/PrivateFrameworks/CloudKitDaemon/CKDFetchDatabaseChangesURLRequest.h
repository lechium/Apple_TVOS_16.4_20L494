...
- (void).cxx_destruct;	// IMP=0x000000000026a199
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000269427
- (id)generateRequestOperations;	// IMP=0x0000000000269224
- (id)requestOperationClasses;	// IMP=0x00000000002691b8
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000002691b0
- (_Bool)allowsAnonymousAccount;	// IMP=0x0000000000269196
- (id)initWithOperation:(id)arg1 previousServerChangeTokenData:(id)arg2;	// IMP=0x000000000026908c
