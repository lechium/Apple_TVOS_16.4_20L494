...
- (void).cxx_destruct;	// IMP=0x000000000030b052
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000030ac1b
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000030a17e
- (id)generateRequestOperations;	// IMP=0x0000000000309501
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000003094f9
- (int)isolationLevel;	// IMP=0x00000000003094dc
- (id)requestOperationClasses;	// IMP=0x0000000000309470
- (id)zoneIDsToLock;	// IMP=0x0000000000309294
- (id)initWithOperation:(id)arg1 moveChanges:(id)arg2 sourceDatabaseScope:(long long)arg3 atomic:(_Bool)arg4;	// IMP=0x00000000003091b7
