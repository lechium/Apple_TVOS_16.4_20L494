...
- (void).cxx_destruct;	// IMP=0x00000000000da0b4
...
- (void)handleReplaceDeltasRequest:(id)arg1 result:(id)arg2;	// IMP=0x00000000000d9d00
- (void)handleDeltaUploaded:(id)arg1 result:(id)arg2;	// IMP=0x00000000000d9970
- (void)_uploadAndReplaceDeltas:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d896d
- (void)_uploadAndReplaceDeltas;	// IMP=0x00000000000d87d7
- (void)_encryptMergeableDeltas;	// IMP=0x00000000000d8443
- (void)main;	// IMP=0x00000000000d83a3
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000d8341
- (_Bool)makeStateTransition;	// IMP=0x00000000000d8270
- (id)activityCreate;	// IMP=0x00000000000d8247
- (int)operationType;	// IMP=0x00000000000d823c
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000d8106
