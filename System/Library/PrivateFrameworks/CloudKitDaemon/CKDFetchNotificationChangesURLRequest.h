...
- (void).cxx_destruct;	// IMP=0x000000000026f16e
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000026ec48
- (id)generateRequestOperations;	// IMP=0x000000000026e9f0
- (id)requestOperationClasses;	// IMP=0x000000000026e984
- (id)initWithOperation:(id)arg1 serverChangeTokenData:(id)arg2;	// IMP=0x000000000026e8eb
