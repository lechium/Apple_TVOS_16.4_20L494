...
+ (long long)isPredominatelyDownload;	// IMP=0x00600000000ce7dc
- (void).cxx_destruct;	// IMP=0x00000000000cebd2
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000cea38
- (void)main;	// IMP=0x00000000000ce7e4
- (void)_fetchRecords;	// IMP=0x00000000000cdfc2
- (void)_handleRecordFetched:(id)arg1 recordID:(id)arg2 error:(id)arg3;	// IMP=0x00000000000cd090
- (struct _PCSIdentityData *)_copyShareProtectionFromRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000ccc3f
- (void)_saveRecords;	// IMP=0x00000000000cc1dd
- (void)_handleRecordSaved:(id)arg1 error:(id)arg2;	// IMP=0x00000000000cbb83
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000cbb21
- (_Bool)makeStateTransition;	// IMP=0x00000000000cb98d
- (id)activityCreate;	// IMP=0x00000000000cb964
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000cb83b
