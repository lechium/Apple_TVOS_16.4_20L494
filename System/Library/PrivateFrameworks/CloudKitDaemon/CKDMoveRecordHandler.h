...
+ (id)moveHandlerWithMoveChange:(id)arg1 operation:(id)arg2;	// IMP=0x00600000001affef
- (void).cxx_destruct;	// IMP=0x00000000001b0119
...
- (id)record;	// IMP=0x00000000001b005b
- (id)_initWithMoveChange:(id)arg1 operation:(id)arg2;	// IMP=0x00000000001aff65
