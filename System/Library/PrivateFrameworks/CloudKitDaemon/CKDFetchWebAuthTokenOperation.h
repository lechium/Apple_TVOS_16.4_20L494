...
- (void).cxx_destruct;	// IMP=0x000000000021583c
...
- (void)main;	// IMP=0x0000000000214fcf
- (int)operationType;	// IMP=0x0000000000214fc4
- (id)activityCreate;	// IMP=0x0000000000214f9b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000214eea
