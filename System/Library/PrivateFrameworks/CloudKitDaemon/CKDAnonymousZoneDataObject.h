...
- (void).cxx_destruct;	// IMP=0x00000000001dd195
...
- (id)initWithEncryptedData:(id)arg1 changeType:(int)arg2 deleteType:(int)arg3;	// IMP=0x00000000001dd0f0
- (id)initWithEncryptedData:(id)arg1;	// IMP=0x00000000001dd07d
