...
- (void).cxx_destruct;	// IMP=0x00000000000e0860
...
- (void)main;	// IMP=0x00000000000e0709
- (void)_verifyOONParticipant;	// IMP=0x00000000000dfed8
- (void)_reconstructShareURL;	// IMP=0x00000000000dfc8c
- (void)_forceFetchShareMetadata;	// IMP=0x00000000000df55a
- (void)_performAuthKitVerification;	// IMP=0x00000000000def61
- (void)_reconstructShortToken;	// IMP=0x00000000000de9f5
- (id)shortSharingTokenFromData:(id)arg1;	// IMP=0x00000000000de9e0
- (id)shortSharingTokenFromFullToken:(id)arg1;	// IMP=0x00000000000de8e4
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000de7fc
- (_Bool)makeStateTransition;	// IMP=0x00000000000de6a0
- (id)activityCreate;	// IMP=0x00000000000de677
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000de450
