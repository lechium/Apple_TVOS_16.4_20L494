...
- (void)main;	// IMP=0x000000000000e5b8
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000000e552
- (void)_fetchRegisteredBundleIDs;	// IMP=0x000000000000da05
- (void)_fetchShareMetadata;	// IMP=0x000000000000d1bc
- (void)_performCallbackForURL:(id)arg1 withAppBundleIDs:(id)arg2 daemonBundleIDs:(id)arg3 error:(id)arg4;	// IMP=0x000000000000cf23
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000000cec1
- (_Bool)makeStateTransition;	// IMP=0x000000000000cdf0
- (int)operationType;	// IMP=0x000000000000cde5
- (id)activityCreate;	// IMP=0x000000000000cdbc
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000000cced
