...
- (void).cxx_destruct;	// IMP=0x00000000003648f8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003647e7
- (unsigned long long)hash;	// IMP=0x0000000000364773
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000364673
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003645b2
- (void)copyTo:(id)arg1;	// IMP=0x000000000036452f
- (void)writeTo:(id)arg1;	// IMP=0x00000000003644ad
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003644a0
- (id)dictionaryRepresentation;	// IMP=0x00000000003640cd
- (id)description;	// IMP=0x000000000036401e
