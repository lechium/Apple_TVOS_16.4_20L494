...
- (void).cxx_destruct;	// IMP=0x00000000002bbba8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002bba71
- (unsigned long long)hash;	// IMP=0x00000000002bb9ed
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002bb8c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002bb7d7
- (void)copyTo:(id)arg1;	// IMP=0x00000000002bb734
- (void)writeTo:(id)arg1;	// IMP=0x00000000002bb69d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002bb690
- (id)dictionaryRepresentation;	// IMP=0x00000000002bb3db
- (id)description;	// IMP=0x00000000002bb32c
