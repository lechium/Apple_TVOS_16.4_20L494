...
- (void).cxx_destruct;	// IMP=0x000000000028041c
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x0000000000280292
- (void)_noteOperationFinishedBlockEnd;	// IMP=0x0000000000280218
- (void)_noteOperationEnding;	// IMP=0x000000000028019e
- (void)_noteOperationBeginning;	// IMP=0x0000000000280124
- (void)_noteCompletedURLRequest:(id)arg1 withSchedulerInfo:(id)arg2;	// IMP=0x00000000002800aa
- (id)_optionsForZonesWithPendingChangesAfterRequest:(id)arg1;	// IMP=0x000000000028002d
- (id)_createAndConfigureURLRequestForZoneIDs:(id)arg1 optionsByZoneID:(id)arg2;	// IMP=0x000000000027ffb0
- (void)_noteDeletedRecordWithID:(id)arg1 recordType:(id)arg2;	// IMP=0x000000000027ff36
- (void)_noteChangedRecordWithID:(id)arg1 record:(id)arg2 error:(id)arg3;	// IMP=0x000000000027febc
- (id)activityCreate;	// IMP=0x000000000027fe3f
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x000000000027fdba
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000027fd56
- (void)main;	// IMP=0x000000000027f1d4
- (id)_possiblyWrapError:(id)arg1 forRecordWithID:(id)arg2 withCode:(long long)arg3 format:(id)arg4;	// IMP=0x000000000027efc5
- (void)_sendFetchChangesRequestForZoneIDs:(id)arg1 withOptions:(id)arg2 previousRequestSchedulerInfo:(id)arg3;	// IMP=0x000000000027e091
- (void)_handleRecordDelete:(id)arg1 recordType:(id)arg2 perRequestSchedulerInfo:(id)arg3;	// IMP=0x000000000027dde4
- (void)_handleChangedRecords:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000027cfd0
- (void)_handleFetchChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x000000000027cf55
- (id)relevantZoneIDs;	// IMP=0x000000000027cf40
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000027cdd0
