...
+ (id)options;	// IMP=0x00100000001755e4
- (void).cxx_destruct;	// IMP=0x00000000001767c0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000017654a
- (unsigned long long)hash;	// IMP=0x0000000000176440
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000176249
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001760c9
- (void)copyTo:(id)arg1;	// IMP=0x0000000000175fa9
- (Class)responseClass;	// IMP=0x0000000000175f98
- (unsigned int)requestTypeCode;	// IMP=0x0000000000175f8d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000175e6d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000175e60
- (id)dictionaryRepresentation;	// IMP=0x0000000000175811
- (id)description;	// IMP=0x0000000000175762
