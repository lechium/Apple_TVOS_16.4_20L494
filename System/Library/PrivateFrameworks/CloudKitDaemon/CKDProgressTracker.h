...
+ (unsigned long long)_sizeForItem:(id)arg1;	// IMP=0x006000000034199c
- (void).cxx_destruct;	// IMP=0x000000000034255c
...
- (double)updateProgressWithItem:(id)arg1 progress:(double)arg2;	// IMP=0x000000000034224d
- (unsigned long long)_updateTotalCompletedBytes;	// IMP=0x000000000034217b
- (unsigned long long)_updateTotalBytes;	// IMP=0x00000000003420a2
- (void)stopTrackingItems:(id)arg1;	// IMP=0x0000000000341df7
- (void)startTrackingItems:(id)arg1;	// IMP=0x0000000000341b46
- (id)initWithTrackingID:(id)arg1;	// IMP=0x0000000000341aec
- (id)init;	// IMP=0x0000000000341a86
