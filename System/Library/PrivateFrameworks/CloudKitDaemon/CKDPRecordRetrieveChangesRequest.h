...
+ (id)options;	// IMP=0x00100000002d8c60
- (void).cxx_destruct;	// IMP=0x00000000002da2d9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002da07d
- (unsigned long long)hash;	// IMP=0x00000000002d9f37
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002d9d10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002d9b94
- (void)copyTo:(id)arg1;	// IMP=0x00000000002d9a5a
- (Class)responseClass;	// IMP=0x00000000002d9a49
- (unsigned int)requestTypeCode;	// IMP=0x00000000002d9a3e
- (void)writeTo:(id)arg1;	// IMP=0x00000000002d98f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002d98ec
- (id)dictionaryRepresentation;	// IMP=0x00000000002d902c
- (id)description;	// IMP=0x00000000002d8f7d
...
- (int)StringAsRequestedChangeTypes:(id)arg1;	// IMP=0x00000000002d8dea
- (id)requestedChangeTypesAsString:(int)arg1;	// IMP=0x00000000002d8d9f
