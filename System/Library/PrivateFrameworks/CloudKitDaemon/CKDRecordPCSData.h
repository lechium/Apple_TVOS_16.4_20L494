...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000322cbb
+ (id)dataWithRecord:(id)arg1;	// IMP=0x00100000003227d2
- (void).cxx_destruct;	// IMP=0x000000000032337e
...
- (void)dealloc;	// IMP=0x00000000003231af
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000322f1f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000322cc3
- (id)CKPropertiesDescription;	// IMP=0x0000000000322b73
- (void)setPcs:(struct _OpaquePCSShareProtection *)arg1;	// IMP=0x0000000000322868
- (_Bool)shouldEncodePCSData;	// IMP=0x0000000000322835
- (id)itemID;	// IMP=0x0000000000322823
- (id)initWithRecord:(id)arg1;	// IMP=0x00000000003224cd
- (id)initWithPCSData:(id)arg1 recordID:(id)arg2;	// IMP=0x0000000000322455
