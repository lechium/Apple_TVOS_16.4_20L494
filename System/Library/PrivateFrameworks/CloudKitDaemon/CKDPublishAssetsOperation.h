...
- (void).cxx_destruct;	// IMP=0x0000000000137965
...
- (void)cancel;	// IMP=0x00000000001377fc
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000137796
- (void)main;	// IMP=0x00000000001376f3
- (void)_fetchRecords;	// IMP=0x00000000001369b8
- (void)_fetchPCSForRecords;	// IMP=0x00000000001363c9
- (void)_finishPublishAssetsForRecord:(id)arg1;	// IMP=0x0000000000135fc9
- (void)_dispatchAssetURLsForRecord:(id)arg1 pcs:(struct _OpaquePCSShareProtection *)arg2;	// IMP=0x000000000013562e
- (id)_checkEntitlements;	// IMP=0x000000000013556a
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x0000000000135514
- (_Bool)makeStateTransition;	// IMP=0x00000000001353cd
- (id)activityCreate;	// IMP=0x00000000001353a4
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000135284
