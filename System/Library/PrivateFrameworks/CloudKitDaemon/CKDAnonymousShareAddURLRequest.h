...
- (void).cxx_destruct;	// IMP=0x00000000002d18c2
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002d1711
- (id)generateRequestOperations;	// IMP=0x00000000002d1316
- (id)requestOperationClasses;	// IMP=0x00000000002d12aa
- (id)initWithOperation:(id)arg1 encryptedAnonymousSharesToAdd:(id)arg2;	// IMP=0x00000000002d1211
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000002d1209
