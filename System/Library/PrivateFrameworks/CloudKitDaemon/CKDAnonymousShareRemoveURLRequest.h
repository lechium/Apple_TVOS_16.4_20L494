...
- (void).cxx_destruct;	// IMP=0x0000000000215f26
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000215d75
- (id)generateRequestOperations;	// IMP=0x000000000021597a
- (id)requestOperationClasses;	// IMP=0x000000000021590e
- (id)initWithOperation:(id)arg1 encryptedAnonymousSharesToRemove:(id)arg2;	// IMP=0x0000000000215875
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000021586d
