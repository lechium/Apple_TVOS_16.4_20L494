...
- (void).cxx_destruct;	// IMP=0x00000000000cb3d5
...
- (void)main;	// IMP=0x00000000000cb056
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000caff0
- (void)_prepareShortTokens;	// IMP=0x00000000000ca4d7
- (_Bool)_currentUserIsOONForShareMetadata:(id)arg1;	// IMP=0x00000000000ca338
- (void)_decryptRootRecordsForShareURL:(id)arg1 withMetadata:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000c8eef
- (void)_continueHandlingFetchedShareMetadata:(id)arg1 shareURL:(id)arg2;	// IMP=0x00000000000c8779
- (void)_prepPPPCSDataForDugongShareMetadata:(id)arg1 withInvitationToken:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000c859e
- (void)_continueSharePCSPrepForShareMetadata:(id)arg1 shareURL:(id)arg2;	// IMP=0x00000000000c7f74
- (void)_handleTokenResolveWithLookupInfo:(id)arg1 shareMetadata:(id)arg2 responseCode:(id)arg3 urlByShortTokenLookupInfos:(id)arg4 tokensToFetchByURL:(id)arg5;	// IMP=0x00000000000c6d54
- (void)_fetchShortTokenMetadata;	// IMP=0x00000000000c605c
- (id)_decodeProtectedFullToken:(id)arg1 tokenMetadata:(id)arg2;	// IMP=0x00000000000c59a8
- (void)_performCallbackForURL:(id)arg1 withMetadata:(id)arg2 error:(id)arg3;	// IMP=0x00000000000c52cd
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000c526b
- (_Bool)makeStateTransition;	// IMP=0x00000000000c519a
- (int)operationType;	// IMP=0x00000000000c518f
- (id)activityCreate;	// IMP=0x00000000000c5166
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000c4f7e
