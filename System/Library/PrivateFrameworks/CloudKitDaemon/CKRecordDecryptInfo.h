...
- (void).cxx_destruct;	// IMP=0x00000000002e858b
...
- (void)_setupDecryptCallbackForQueue:(id)arg1;	// IMP=0x00000000002e822b
- (id)initWithRecord:(id)arg1 callbackQueue:(id)arg2;	// IMP=0x00000000002e80b7
- (id)init;	// IMP=0x00000000002e803b
