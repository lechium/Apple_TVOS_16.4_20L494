...
+ (Class)subtitleLocalizedArgumentsType;	// IMP=0x00100000001a9747
+ (Class)titleLocalizedArgumentsType;	// IMP=0x00100000001a964b
+ (Class)localizedArgumentsType;	// IMP=0x00100000001a94fb
- (void).cxx_destruct;	// IMP=0x00000000001ab596
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001aaf35
- (unsigned long long)hash;	// IMP=0x00000000001aadae
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001aaaae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001aa4d1
- (void)copyTo:(id)arg1;	// IMP=0x00000000001aa1b0
- (void)writeTo:(id)arg1;	// IMP=0x00000000001a9d9d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001a9d90
- (id)dictionaryRepresentation;	// IMP=0x00000000001a9807
- (id)description;	// IMP=0x00000000001a9758
- (id)subtitleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001a972a
- (unsigned long long)subtitleLocalizedArgumentsCount;	// IMP=0x00000000001a970d
- (void)addSubtitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001a96a3
- (void)clearSubtitleLocalizedArguments;	// IMP=0x00000000001a9686
@property(readonly, nonatomic) _Bool hasSubtitleLocalizedKey;
@property(readonly, nonatomic) _Bool hasSubtitle;
- (id)titleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001a962e
- (unsigned long long)titleLocalizedArgumentsCount;	// IMP=0x00000000001a9611
- (void)addTitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001a95a7
- (void)clearTitleLocalizedArguments;	// IMP=0x00000000001a958a
...
- (id)localizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001a94de
- (unsigned long long)localizedArgumentsCount;	// IMP=0x00000000001a94c1
- (void)addLocalizedArguments:(id)arg1;	// IMP=0x00000000001a9457
- (void)clearLocalizedArguments;	// IMP=0x00000000001a943a
