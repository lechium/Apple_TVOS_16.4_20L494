...
- (void).cxx_destruct;	// IMP=0x000000000029461d
...
- (id)relevantZoneIDs;	// IMP=0x0000000000293fd4
- (_Bool)supportsClearAssetEncryption;	// IMP=0x0000000000293fcc
- (void)main;	// IMP=0x0000000000293c9f
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000293c22
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000293b92
- (void)_downloadMergeableValues;	// IMP=0x0000000000292e2b
- (void)_downloadAssets;	// IMP=0x00000000002913d9
- (void)_fetchCloudCerts;	// IMP=0x0000000000290d2e
- (void)_didDownloadAssetsWithError:(id)arg1;	// IMP=0x0000000000290b4e
- (void)_finishAllDownloadTasksWithError:(id)arg1;	// IMP=0x0000000000290a32
- (void)_addMergeableValueDownloadTasksForRecord:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000029021f
- (void)_addAssetDownloadTaskForRecord:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000028e6e1
- (void)_addDownloadTasksForRecord:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000028e443
- (int)_prepareAsset:(id)arg1 record:(id)arg2 recordKey:(id)arg3 assetTransferOptions:(id)arg4;	// IMP=0x000000000028db56
- (void)_decryptPropertiesIfNeededForRecord:(id)arg1 record:(id)arg2;	// IMP=0x000000000028da7e
- (void)_handleSharePCSPrepForShare:(id)arg1 recordID:(id)arg2;	// IMP=0x000000000028d21f
- (void)_handleRecordFetch:(id)arg1 recordID:(id)arg2 etagMatched:(_Bool)arg3 responseCode:(id)arg4;	// IMP=0x000000000028c3c8
- (void)_fetchPCSForMergeableValueDeltaRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x000000000028bed9
- (void)_reallyDecryptPropertiesOnRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x000000000028b942
- (void)_decryptPropertiesOnRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x000000000028b8b8
...
- (void)_continueHandleFetchedRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x000000000028a124
- (void)setError:(id)arg1 forRecordID:(id)arg2;	// IMP=0x000000000028a01a
- (id)errorForRecordID:(id)arg1;	// IMP=0x0000000000289f4a
- (void)fetchRecordsWithIDs:(id)arg1 andFullRecords:(id)arg2;	// IMP=0x0000000000288769
- (int)operationType;	// IMP=0x000000000028875e
- (void)_findSpecialParticipantsOnShare:(id)arg1 identityDelegate:(id)arg2;	// IMP=0x00000000002882bb
- (void)_saveUpdatedShareRecords;	// IMP=0x0000000000287df7
- (id)desiredIndexedListKeys;	// IMP=0x0000000000287a42
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000002879ec
- (_Bool)makeStateTransition;	// IMP=0x000000000028767b
- (id)activityCreate;	// IMP=0x0000000000287652
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000287225
