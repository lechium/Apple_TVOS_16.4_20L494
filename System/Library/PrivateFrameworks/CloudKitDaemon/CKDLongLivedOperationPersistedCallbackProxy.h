...
- (void).cxx_destruct;	// IMP=0x000000000022fc99
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000022fae5
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000022f937
- (id)initWithOperationID:(id)arg1 callbackProtocol:(id)arg2 completionSelector:(SEL)arg3 operationInfoCache:(id)arg4;	// IMP=0x000000000022f89c
