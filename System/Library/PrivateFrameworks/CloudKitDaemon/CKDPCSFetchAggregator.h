...
- (void).cxx_destruct;	// IMP=0x00000000003453a8
...
- (void)cancelAllOperations;	// IMP=0x0000000000344fd2
- (void)requestFetchOfZoneWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000344d75
- (void)requestFetchOfShareWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000003449c8
- (void)requestFetchOfRecordWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000344597
- (_Bool)fetchRequestForExistingOperation:(id)arg1 isDependentOnOperation:(id)arg2;	// IMP=0x0000000000344015
- (id)_lockedGetQueuedFetchForOperation:(id)arg1 ofClass:(Class)arg2;	// IMP=0x0000000000343980
- (void)_lockedRescheduleFetchTimer;	// IMP=0x000000000034368b
- (void)_lockedTearDownFetchTimer;	// IMP=0x0000000000343606
- (void)_lockedFetchesAreReady;	// IMP=0x00000000003428e4
- (void)dealloc;	// IMP=0x00000000003428a5
- (id)initWithContainer:(id)arg1;	// IMP=0x00000000003425e4
- (id)init;	// IMP=0x0000000000342584
