...
- (void).cxx_destruct;	// IMP=0x000000000034e6f9
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000034e4d2
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000034e214
- (id)generateRequestOperations;	// IMP=0x000000000034d8f9
- (id)requestOperationClasses;	// IMP=0x000000000034d812
- (id)zoneIDsToLock;	// IMP=0x000000000034d555
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000034d54d
- (id)initWithOperation:(id)arg1 recordZonesToSave:(id)arg2 recordZoneIDsToDelete:(id)arg3;	// IMP=0x000000000034d482
