...
- (void).cxx_destruct;	// IMP=0x00000000001e1529
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001e1419
- (id)generateRequestOperations;	// IMP=0x00000000001e134b
- (id)requestOperationClasses;	// IMP=0x00000000001e12df
- (long long)databaseScope;	// IMP=0x00000000001e12d4
