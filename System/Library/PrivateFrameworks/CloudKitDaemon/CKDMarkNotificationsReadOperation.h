...
+ (long long)isPredominatelyDownload;	// IMP=0x00600000002979ef
- (void).cxx_destruct;	// IMP=0x00000000002981ab
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002980b4
- (void)main;	// IMP=0x0000000000297a02
- (int)operationType;	// IMP=0x00000000002979f7
- (void)_handleNotificationID:(id)arg1 withResponse:(id)arg2;	// IMP=0x0000000000297702
- (id)activityCreate;	// IMP=0x00000000002976d9
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000029760a
