...
- (void).cxx_destruct;	// IMP=0x000000000006f200
...
- (id)CKPropertiesDescription;	// IMP=0x000000000006f158
- (id)description;	// IMP=0x000000000006f146
- (void)invokeWaitCompletedHandler:(_Bool)arg1;	// IMP=0x000000000006f039
- (id)initWithWaiter:(id)arg1 zoneIDs:(id)arg2 waitCompletedHandler:(CDUnknownBlockType)arg3 activity:(id)arg4;	// IMP=0x000000000006ef2c
