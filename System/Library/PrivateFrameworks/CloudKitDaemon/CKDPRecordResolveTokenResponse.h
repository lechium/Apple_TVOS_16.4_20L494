...
+ (Class)recordType;	// IMP=0x001000000000f97a
- (void).cxx_destruct;	// IMP=0x0000000000010cf9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000109f7
- (unsigned long long)hash;	// IMP=0x000000000001092d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000010795
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010504
- (void)copyTo:(id)arg1;	// IMP=0x000000000001039f
- (void)writeTo:(id)arg1;	// IMP=0x00000000000101c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000101b8
- (id)dictionaryRepresentation;	// IMP=0x000000000000fa79
- (id)description;	// IMP=0x000000000000f9ca
...
- (id)recordAtIndex:(unsigned long long)arg1;	// IMP=0x000000000000f95d
- (unsigned long long)recordsCount;	// IMP=0x000000000000f940
- (void)addRecord:(id)arg1;	// IMP=0x000000000000f8d6
- (void)clearRecords;	// IMP=0x000000000000f8b9
- (int)StringAsContainerEnvironment:(id)arg1;	// IMP=0x000000000000f852
- (id)containerEnvironmentAsString:(int)arg1;	// IMP=0x000000000000f7fc
