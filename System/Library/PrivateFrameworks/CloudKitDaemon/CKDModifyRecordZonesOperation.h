...
+ (long long)isPredominatelyDownload;	// IMP=0x006000000010696a
- (void).cxx_destruct;	// IMP=0x00000000001070a5
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000106e44
- (void)main;	// IMP=0x0000000000106d94
- (void)_checkAndPrepareZones;	// IMP=0x0000000000106972
- (void)_fetchPCSDataForZonesFromServer:(_Bool)arg1;	// IMP=0x00000000001063a0
- (void)_fetchPCSDataForZone:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x0000000000105644
- (void)_createNewPCSForZone:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000010446b
- (_Bool)isOperationType:(int)arg1;	// IMP=0x0000000000104438
- (int)operationType;	// IMP=0x0000000000104410
- (_Bool)_saveZonesToServer;	// IMP=0x0000000000103a73
- (void)_handleRecordZoneDeleted:(id)arg1 responseCode:(id)arg2;	// IMP=0x00000000001035e9
- (void)_handleRecordZoneSaved:(id)arg1 responseCode:(id)arg2 serverCapabilities:(unsigned long long)arg3 expirationDate:(id)arg4 expired:(_Bool)arg5;	// IMP=0x0000000000102328
- (void)_sendErrorForFailedZones;	// IMP=0x0000000000101c00
- (void)_sendCoreAnalyticsEventForKeySync;	// IMP=0x00000000001019c9
- (void)_synchronizeUserKeyRegistryIfNeeded;	// IMP=0x000000000010127e
- (_Bool)supportsClearAssetEncryption;	// IMP=0x0000000000101276
- (id)relevantZoneIDs;	// IMP=0x0000000000101197
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x0000000000101141
- (id)activityCreate;	// IMP=0x0000000000101118
- (_Bool)makeStateTransition;	// IMP=0x0000000000100ee0
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000100b0c
