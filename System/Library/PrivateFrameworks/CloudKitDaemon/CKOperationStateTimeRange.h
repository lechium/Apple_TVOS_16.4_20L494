...
- (void).cxx_destruct;	// IMP=0x000000000032c096
...
- (id)CKPropertiesDescription;	// IMP=0x000000000032bfaa
@property(readonly) double relativeStart;
@property(readonly) double absoluteStop;
- (long long)compareStopTime:(id)arg1;	// IMP=0x000000000032be99
- (long long)compareStartTime:(id)arg1;	// IMP=0x000000000032be19
@property(readonly) double executing;
@property(readonly) double queueing;
@property(readonly) double absoluteStart;
- (id)initWithOperationState:(unsigned long long)arg1 startDate:(id)arg2 duration:(double)arg3;	// IMP=0x000000000032bd1a
