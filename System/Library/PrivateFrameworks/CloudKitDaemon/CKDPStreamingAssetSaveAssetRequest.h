...
- (void).cxx_destruct;	// IMP=0x00000000000d345e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000d3395
- (unsigned long long)hash;	// IMP=0x00000000000d332e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d3247
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d3198
- (void)copyTo:(id)arg1;	// IMP=0x00000000000d3116
- (void)writeTo:(id)arg1;	// IMP=0x00000000000d3086
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000d3079
- (id)dictionaryRepresentation;	// IMP=0x00000000000d2ca8
- (id)description;	// IMP=0x00000000000d2bf9
