...
- (void).cxx_destruct;	// IMP=0x00000000001637f6
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000016361f
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001634bf
- (id)generateRequestOperations;	// IMP=0x00000000001630a1
- (id)requestOperationClasses;	// IMP=0x0000000000163035
- (id)zoneIDsToLock;	// IMP=0x0000000000162e1c
- (id)initWithOperation:(id)arg1 shareMetadatasToDecline:(id)arg2;	// IMP=0x0000000000162d83
