...
+ (long long)isPredominatelyDownload;	// IMP=0x006000000014da00
- (void).cxx_destruct;	// IMP=0x000000000014e804
...
- (_Bool)isOperationType:(int)arg1;	// IMP=0x000000000014e71e
- (int)operationType;	// IMP=0x000000000014e6f2
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000014e675
- (void)main;	// IMP=0x000000000014da08
- (void)_handleSubscriptionDeleted:(id)arg1 responseCode:(id)arg2;	// IMP=0x000000000014d67c
- (void)_handleSubscriptionSaved:(id)arg1 error:(id)arg2;	// IMP=0x000000000014d41c
- (void)_handleSubscriptionSaved:(id)arg1 responseCode:(id)arg2;	// IMP=0x000000000014d2a4
- (id)activityCreate;	// IMP=0x000000000014d27b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000014cfb1
