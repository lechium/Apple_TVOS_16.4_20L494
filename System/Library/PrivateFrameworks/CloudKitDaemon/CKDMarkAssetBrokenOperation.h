...
- (void).cxx_destruct;	// IMP=0x00000000002776a7
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000027737a
- (void)main;	// IMP=0x0000000000277366
- (id)checkPreconditions;	// IMP=0x00000000002772a1
- (id)assetOrPackageForFetchedRecord;	// IMP=0x00000000002770eb
- (id)repairContainer;	// IMP=0x0000000000276cb1
- (void)_markAssetBroken;	// IMP=0x000000000027588d
- (int)operationType;	// IMP=0x0000000000275882
- (void)_breakAsset;	// IMP=0x0000000000274adb
- (void)_touchCreateRepairZone;	// IMP=0x00000000002741d5
- (void)_touchFetchRepairZone;	// IMP=0x00000000002738a9
- (void)_fetchRecord;	// IMP=0x00000000002730a6
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x0000000000273050
- (_Bool)makeStateTransition;	// IMP=0x0000000000272be2
- (id)activityCreate;	// IMP=0x0000000000272bb9
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000272a58
