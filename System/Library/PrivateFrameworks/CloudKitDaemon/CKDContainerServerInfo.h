...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000e15a0
- (void).cxx_destruct;	// IMP=0x00000000000e1a54
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e17aa
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e15a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e12de
- (unsigned long long)hash;	// IMP=0x00000000000e1149
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e0afb
- (id)description;	// IMP=0x00000000000e0ae9
- (id)CKPropertiesDescription;	// IMP=0x00000000000e0966
- (id)init;	// IMP=0x00000000000e092a
