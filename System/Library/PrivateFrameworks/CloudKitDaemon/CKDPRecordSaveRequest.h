...
+ (Class)conflictLosersToResolveType;	// IMP=0x0010000000137db0
+ (Class)fieldsToDeleteIfExistOnMergeType;	// IMP=0x0010000000137b3b
+ (id)options;	// IMP=0x00100000001379cc
- (void).cxx_destruct;	// IMP=0x0000000000139eb8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001398fb
- (unsigned long long)hash;	// IMP=0x0000000000139756
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000139447
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000138f77
- (void)copyTo:(id)arg1;	// IMP=0x0000000000138cbe
- (Class)responseClass;	// IMP=0x0000000000138cad
- (unsigned int)requestTypeCode;	// IMP=0x0000000000138ca2
- (void)writeTo:(id)arg1;	// IMP=0x0000000000138939
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000013892c
- (id)dictionaryRepresentation;	// IMP=0x0000000000137ec4
- (id)description;	// IMP=0x0000000000137e15
...
- (id)conflictLosersToResolveAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000137d93
- (unsigned long long)conflictLosersToResolvesCount;	// IMP=0x0000000000137d76
- (void)addConflictLosersToResolve:(id)arg1;	// IMP=0x0000000000137d0c
- (void)clearConflictLosersToResolves;	// IMP=0x0000000000137cef
@property(readonly, nonatomic) _Bool hasRecordProtectionInfoTag;
@property(readonly, nonatomic) _Bool hasZoneProtectionInfoTag;
- (int)StringAsSaveSemantics:(id)arg1;	// IMP=0x0000000000137c28
- (id)saveSemanticsAsString:(int)arg1;	// IMP=0x0000000000137bdd
...
- (id)fieldsToDeleteIfExistOnMergeAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000137b1e
- (unsigned long long)fieldsToDeleteIfExistOnMergesCount;	// IMP=0x0000000000137b01
- (void)addFieldsToDeleteIfExistOnMerge:(id)arg1;	// IMP=0x0000000000137a97
- (void)clearFieldsToDeleteIfExistOnMerges;	// IMP=0x0000000000137a7a
