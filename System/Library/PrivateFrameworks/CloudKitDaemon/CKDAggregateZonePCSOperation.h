...
- (void).cxx_destruct;	// IMP=0x0000000000251b63
...
- (void)_setPermanentFailure;	// IMP=0x000000000025179e
- (void)_handleZoneSavedWithID:(id)arg1 responseCode:(id)arg2;	// IMP=0x0000000000250b9c
- (void)_sendCoreAnalyticsEventForKeySync;	// IMP=0x000000000025098b
- (void)_sychronizeUserKeyRegistryIfNeeded;	// IMP=0x0000000000250497
- (int)operationType;	// IMP=0x000000000025048c
- (_Bool)_saveTargetZone;	// IMP=0x000000000024fd2c
- (void)_prepareTargetZonePCS;	// IMP=0x000000000024f595
- (void)_fetchPCSDataForZoneID:(id)arg1;	// IMP=0x000000000024efab
- (void)_fetchZonePCS;	// IMP=0x000000000024ed06
- (void)main;	// IMP=0x000000000024ecf2
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000024ec9c
- (_Bool)makeStateTransition;	// IMP=0x000000000024ea88
- (id)relevantZoneIDs;	// IMP=0x000000000024e995
- (id)activityCreate;	// IMP=0x000000000024e96c
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000024e848
