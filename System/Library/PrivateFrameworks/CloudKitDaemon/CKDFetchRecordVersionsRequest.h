...
- (void).cxx_destruct;	// IMP=0x0000000000308b0d
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000003088ca
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000030844b
- (id)generateRequestOperations;	// IMP=0x0000000000307ea0
- (id)requestOperationClasses;	// IMP=0x0000000000307e34
- (id)zoneIDsToLock;	// IMP=0x0000000000307c72
- (id)initWithOperation:(id)arg1 recordIDs:(id)arg2 desiredKeys:(id)arg3 minimumVersionETag:(id)arg4;	// IMP=0x0000000000307b6a
