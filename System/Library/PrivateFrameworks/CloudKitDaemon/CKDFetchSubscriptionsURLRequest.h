...
- (void).cxx_destruct;	// IMP=0x000000000018ea54
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000018e7a7
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000018e10a
- (id)generateRequestOperations;	// IMP=0x000000000018dcfe
- (id)requestOperationClasses;	// IMP=0x000000000018dc92
- (id)initWithOperation:(id)arg1 subscriptionIDs:(id)arg2;	// IMP=0x000000000018dbc7
