...
+ (void)registerEvictionTimer;	// IMP=0x0060000000059c20
+ (void)stopEvictionTimer;	// IMP=0x0060000000059b53
+ (void)startEvictionTimer;	// IMP=0x0060000000059a86
+ (void)runMemoryCacheEvictionInAllCaches;	// IMP=0x0060000000059848
+ (void)setupMemoryNotifications;	// IMP=0x00600000000597bb
+ (void)initialize;	// IMP=0x0060000000059774
- (void).cxx_destruct;	// IMP=0x000000000005b6ea
...
- (id)CKStatusReportArray;	// IMP=0x000000000005b38a
- (_Bool)hasStatusToReport;	// IMP=0x000000000005b371
- (unsigned long long)_cacheCount;	// IMP=0x000000000005b220
- (void)clearCache;	// IMP=0x000000000005b086
- (void)runCacheEviction;	// IMP=0x000000000005afc6
- (void)setPCSData:(id)arg1 forItemID:(id)arg2 databaseScope:(long long)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000005ab2f
- (void)getPCSDataFromCacheForID:(id)arg1 databaseScope:(long long)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000005a6bd
- (void)_lockedEvictEntriesFromCache;	// IMP=0x0000000000059f2f
- (id)init;	// IMP=0x0000000000059e15
