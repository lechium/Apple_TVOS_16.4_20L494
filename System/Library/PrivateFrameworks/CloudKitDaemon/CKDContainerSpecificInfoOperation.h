...
- (void).cxx_destruct;	// IMP=0x00000000002f0f90
...
- (void)main;	// IMP=0x00000000002f0ad1
- (void)setCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002f096b
- (_Bool)shouldCheckAppVersion;	// IMP=0x00000000002f0963
- (id)activityCreate;	// IMP=0x00000000002f093a
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002f08d7
