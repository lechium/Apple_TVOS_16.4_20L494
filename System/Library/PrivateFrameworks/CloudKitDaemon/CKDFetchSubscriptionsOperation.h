...
- (void).cxx_destruct;	// IMP=0x000000000019238b
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000192299
- (void)main;	// IMP=0x0000000000191bc8
- (int)operationType;	// IMP=0x0000000000191bbd
- (void)_handleSubscriptionFetched:(id)arg1 withID:(id)arg2 responseCode:(id)arg3;	// IMP=0x0000000000191955
- (id)activityCreate;	// IMP=0x000000000019192c
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000019185c
