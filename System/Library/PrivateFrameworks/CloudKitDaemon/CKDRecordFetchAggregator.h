...
- (void).cxx_destruct;	// IMP=0x00000000002111ee
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x0000000000210f7d
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000210ebc
- (void)_finishRecordFetchAggregator;	// IMP=0x0000000000210ab4
- (void)finishIfAppropriate;	// IMP=0x000000000021092a
- (void)fetchRecords:(id)arg1 withPerRecordCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000210625
- (id)_fetchRecord:(id)arg1 recordReadyHandle:(_Bool *)arg2 withRecordCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000000020f9f3
- (void)main;	// IMP=0x000000000020f74c
- (void)_addRecordFetchInfos:(id)arg1;	// IMP=0x000000000020f2ef
- (void)_recordFetchesAvailable;	// IMP=0x000000000020f225
- (void)_lockedSendFetchRequest;	// IMP=0x000000000020d614
- (void)_flushFetchedRecordsToConsumerLocked;	// IMP=0x000000000020d5a4
- (void)_flushFetchedRecordsToConsumerNoOrderingLocked;	// IMP=0x000000000020d3e2
- (void)_flushFetchedRecordsToConsumerOrderedLocked;	// IMP=0x000000000020d181
- (void)_performCallbackForFetchInfoLocked:(id)arg1;	// IMP=0x000000000020cf14
- (int)operationType;	// IMP=0x000000000020cf0c
- (id)description;	// IMP=0x000000000020cefa
- (id)CKPropertiesDescription;	// IMP=0x000000000020c985
- (void)dealloc;	// IMP=0x000000000020c92a
- (id)activityCreate;	// IMP=0x000000000020c901
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000020c32d
