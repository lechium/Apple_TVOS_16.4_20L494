...
- (void).cxx_destruct;	// IMP=0x0000000000308d21
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000308c10
- (unsigned long long)hash;	// IMP=0x0000000000308bcc
- (void)dealloc;	// IMP=0x0000000000308b85
