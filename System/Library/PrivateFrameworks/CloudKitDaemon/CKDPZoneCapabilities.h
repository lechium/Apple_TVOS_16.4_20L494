...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000027ccc2
- (unsigned long long)hash;	// IMP=0x000000000027cc09
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000027ca7a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000027c999
- (void)copyTo:(id)arg1;	// IMP=0x000000000027c8db
- (void)writeTo:(id)arg1;	// IMP=0x000000000027c7e9
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000027c7dc
- (id)dictionaryRepresentation;	// IMP=0x000000000027c063
- (id)description;	// IMP=0x000000000027bfb4
@property(nonatomic) _Bool hasHierarchicalSharing;
@property(nonatomic) _Bool hasZoneSharing;
- (int)StringAsSharingType:(id)arg1;	// IMP=0x000000000027be81
- (id)sharingTypeAsString:(int)arg1;	// IMP=0x000000000027be36
