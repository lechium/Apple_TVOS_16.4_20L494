...
+ (id)options;	// IMP=0x00100000000e2514
- (void).cxx_destruct;	// IMP=0x00000000000e3275
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000e3066
- (unsigned long long)hash;	// IMP=0x00000000000e2fa8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e2e14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e2cd1
- (void)copyTo:(id)arg1;	// IMP=0x00000000000e2bee
- (Class)responseClass;	// IMP=0x00000000000e2bdd
- (unsigned int)requestTypeCode;	// IMP=0x00000000000e2bd2
- (void)writeTo:(id)arg1;	// IMP=0x00000000000e2b01
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000e2af4
- (id)dictionaryRepresentation;	// IMP=0x00000000000e2691
- (id)description;	// IMP=0x00000000000e25e2
