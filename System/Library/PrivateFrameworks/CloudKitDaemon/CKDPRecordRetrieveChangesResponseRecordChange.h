...
- (void).cxx_destruct;	// IMP=0x00000000001aca38
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001ac893
- (unsigned long long)hash;	// IMP=0x00000000001ac7e6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ac689
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ac57b
- (void)copyTo:(id)arg1;	// IMP=0x00000000001ac4b8
- (void)writeTo:(id)arg1;	// IMP=0x00000000001ac3fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001ac3f0
- (id)dictionaryRepresentation;	// IMP=0x00000000001abeee
- (id)description;	// IMP=0x00000000001abe3f
@property(readonly, nonatomic) _Bool hasRecord;
- (int)StringAsType:(id)arg1;	// IMP=0x00000000001abd8d
- (id)typeAsString:(int)arg1;	// IMP=0x00000000001abd42
