...
- (void).cxx_destruct;	// IMP=0x00000000000199ea
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000195dd
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000192c7
- (id)generateRequestOperations;	// IMP=0x00000000000187f7
- (id)anonymousUserIDForHTTPHeader;	// IMP=0x000000000001877d
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x0000000000018775
- (id)requestOperationClasses;	// IMP=0x0000000000018685
- (id)zoneIDsToLock;	// IMP=0x000000000001857d
- (_Bool)allowsAnonymousAccount;	// IMP=0x0000000000018563
- (id)initWithOperation:(id)arg1 deltas:(id)arg2 replacementRequests:(id)arg3;	// IMP=0x000000000001843a
