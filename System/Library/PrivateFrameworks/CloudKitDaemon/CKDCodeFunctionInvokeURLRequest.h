...
- (void).cxx_destruct;	// IMP=0x000000000018db41
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000018d99c
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000018d636
- (id)generateRequestOperations;	// IMP=0x000000000018d129
- (_Bool)requestGETPreAuth;	// IMP=0x000000000018d0de
- (id)requestOperationClasses;	// IMP=0x000000000018d072
- (long long)databaseScope;	// IMP=0x000000000018cfd3
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000018cfb9
- (id)initWithOperation:(id)arg1 serviceName:(id)arg2 functionName:(id)arg3 serializedParameters:(id)arg4 attestationEntropy:(id)arg5 pccWrappedInvocationKeys:(id)arg6 trustedTargetWrappedInvocationKey:(id)arg7;	// IMP=0x000000000018ce6f
