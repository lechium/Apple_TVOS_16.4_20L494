...
- (void).cxx_destruct;	// IMP=0x000000000011fb7e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000011f7fb
- (unsigned long long)hash;	// IMP=0x000000000011f63e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000011f33e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011f117
- (void)copyTo:(id)arg1;	// IMP=0x000000000011ef61
- (void)writeTo:(id)arg1;	// IMP=0x000000000011eda5
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000011ed98
- (id)dictionaryRepresentation;	// IMP=0x000000000011e322
- (id)description;	// IMP=0x000000000011e273
