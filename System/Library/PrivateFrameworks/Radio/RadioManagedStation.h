...
+ (id)defaultPropertiesToFetch;	// IMP=0x0060000000001f12
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
@property(nonatomic) _Bool virtualPlayEnabled;
@property(nonatomic) int subscriberCount;
- (id)streamKeyURL;	// IMP=0x000000000000526c
- (id)streamCertificateURL;	// IMP=0x00000000000051cb
...
- (void)setStreamKeyURL:(id)arg1;	// IMP=0x00000000000048c1
- (void)setStreamCertificateURL:(id)arg1;	// IMP=0x00000000000047d3
...
- (id)feedbackDictionaryRepresentation;	// IMP=0x00000000000023f0
- (id)additionalReferencedTrackDescriptors;	// IMP=0x0000000000002005
