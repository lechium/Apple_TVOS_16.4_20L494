...
- (void).cxx_destruct;	// IMP=0x000000000001e656
...
- (void)onScenarioTriggers:(id)arg1 error:(id)arg2;	// IMP=0x000000000001e1f8
- (id)stopMonitoringForScenarioTriggerTypes:(unsigned long long)arg1;	// IMP=0x000000000001e12a
- (id)startMonitoringForScenarioTriggerTypes:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001df5f
- (id)init;	// IMP=0x000000000001df02
