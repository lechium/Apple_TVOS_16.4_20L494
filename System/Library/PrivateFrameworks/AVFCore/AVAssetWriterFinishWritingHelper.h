...
- (long long)status;	// IMP=0x000000000009b5b3
- (void)cancelWriting;	// IMP=0x000000000009b49c
- (void)_finishWritingOperationsDidFinish;	// IMP=0x000000000009b3c9
- (void)dealloc;	// IMP=0x000000000009b32e
- (id)initWithConfigurationState:(id)arg1 finishWritingOperations:(id)arg2 figAssetWriterCallbackContextToken:(void *)arg3;	// IMP=0x000000000009b0bc
