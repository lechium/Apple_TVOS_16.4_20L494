...
- (id)makePropertyListForProxyWithOptions:(id)arg1;	// IMP=0x00000000000e214c
...
- (_Bool)isCompatibleWithPhotosTranscodingServiceWithOptions:(id)arg1;	// IMP=0x00000000000e20ad
@property(readonly, nonatomic, getter=isPlayable) _Bool playable;
- (_Bool)hasProtectedContent;	// IMP=0x00000000000e209d
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x00000000000e206c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e1eec
