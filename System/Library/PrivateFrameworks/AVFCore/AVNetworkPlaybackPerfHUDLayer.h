...
- (void).cxx_destruct;	// IMP=0x00000000000586a2
...
- (void)_hudUpdateTrigger;	// IMP=0x00000000000583ca
- (void)copyPropertiesFromStringGenerator:(id)arg1;	// IMP=0x00000000000582f7
- (id)displayStringGenerator;	// IMP=0x0000000000058243
- (void)updateHudWithDisplayString:(id)arg1;	// IMP=0x0000000000057e2d
- (_Bool)valueLoadedForKey:(id)arg1 onObject:(id)arg2;	// IMP=0x0000000000057cf5
- (void)currentItemTracksChanged;	// IMP=0x0000000000057b79
- (void)currentItemChanged;	// IMP=0x0000000000057af9
- (float)getScaleFactorForDisplaySize:(struct CGSize)arg1;	// IMP=0x0000000000057a3c
- (void)dealloc;	// IMP=0x00000000000579aa
- (void)startDispatchTimer;	// IMP=0x000000000005787f
- (void)readHudSettingsAndCallCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000005779e
- (void)getHudSetting;	// IMP=0x0000000000057588
- (void)setColor:(int)arg1;	// IMP=0x0000000000057460
- (void)updateBounds:(struct CGRect)arg1;	// IMP=0x0000000000057370
- (id)init;	// IMP=0x000000000005727d
- (_Bool)hudEnabled;	// IMP=0x000000000005726d
