...
- (void)requestMediaDataIfNecessary;	// IMP=0x00000000000b0db6
@property __weak id <AVAssetWriterInputMediaDataRequesterDelegate> delegate;
- (void)dealloc;	// IMP=0x00000000000b0ba1
- (void)_collectUncollectables_invokedFromDeallocAndFinalize;	// IMP=0x00000000000b0b73
- (id)init;	// IMP=0x00000000000b0b5d
- (id)initWithRequestQueue:(id)arg1 requestBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b0a36
