...
- (void).cxx_destruct;	// IMP=0x00000000000cbf7b
@property __weak id <AVOutputDeviceImplSupport> implEventListener; // @synthesize implEventListener=_implSupportEventListener;
- (_Bool)supportsFitnessDataDestination;	// IMP=0x00000000000cbf54
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000cbf17
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cbef1
...
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cbeae
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000cbe7b
...
- (void)decreaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000cbde5
- (void)increaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000cbddf
- (void)setVolume:(float)arg1;	// IMP=0x00000000000cbdd9
@property(readonly) long long volumeControlType;
@property(readonly) _Bool canSetVolume;
@property(readonly) float volume;
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000cbd8b
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x00000000000cbd85
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000cbc34
