...
+ (id)runLoopStateWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00600000000e169e
...
- (void)dealloc;	// IMP=0x00000000000e173a
- (id)initWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00000000000e16d5
