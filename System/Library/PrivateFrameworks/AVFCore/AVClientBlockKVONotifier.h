...
- (void)cancelCallbacks;	// IMP=0x0000000000138d00
- (void)callbackDidFireWithChangeDictionary:(id)arg1;	// IMP=0x0000000000138cee
- (void)start;	// IMP=0x0000000000138ca5
@property(readonly, nonatomic) NSObject *observedObject;
- (void)dealloc;	// IMP=0x0000000000138bf3
- (id)initWithCallbackContextRegistry:(id)arg1 observer:(id)arg2 object:(id)arg3 keyPath:(id)arg4 options:(unsigned long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x0000000000138a11
