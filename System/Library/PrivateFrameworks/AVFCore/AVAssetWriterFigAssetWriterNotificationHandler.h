...
- (void)_handleFailedNotificationWithError:(id)arg1;	// IMP=0x0000000000097190
- (void)_handleCompletedWritingNotification;	// IMP=0x000000000009715b
- (void)_teardownNotificationHandlers;	// IMP=0x00000000000970aa
- (void)_callDelegateIfNotCalledWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x0000000000097047
- (void)dealloc;	// IMP=0x0000000000096fe2
- (id)initWithFigAssetWriter:(struct OpaqueFigAssetWriter *)arg1;	// IMP=0x0000000000096dbb
