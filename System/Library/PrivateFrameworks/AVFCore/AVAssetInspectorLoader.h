...
+ (void)initialize;	// IMP=0x00100000000e8584
- (id)_createAVErrorForError:(id)arg1 andFigErrorCode:(int)arg2;	// IMP=0x00000000000e882d
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 keysForCollectionKeys:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e8818
- (void)_ensureAllDependenciesOfKeyAreLoaded:(id)arg1;	// IMP=0x00000000000e8812
- (void)_setIsAssociatedWithFragmentMinder:(_Bool)arg1;	// IMP=0x00000000000e880c
...
- (void)cancelLoading;	// IMP=0x00000000000e86fb
- (id)assetInspector;	// IMP=0x00000000000e86f3
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e86c8
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e869a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e868f
- (void)dealloc;	// IMP=0x00000000000e8654
@property(readonly, nonatomic, getter=_weakReference) AVWeakReference *weakReference;
- (id)init;	// IMP=0x00000000000e85eb
