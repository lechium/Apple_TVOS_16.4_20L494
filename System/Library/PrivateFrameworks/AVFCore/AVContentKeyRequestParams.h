...
- (void)dealloc;	// IMP=0x000000000014942c
- (id)initWithInitializationData:(id)arg1 contentIdentifier:(id)arg2 keyIDFromInitializationData:(id)arg3 options:(id)arg4 identifier:(id)arg5;	// IMP=0x000000000014937a
