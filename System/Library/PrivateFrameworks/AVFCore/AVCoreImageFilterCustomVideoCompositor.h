...
+ (void)initialize;	// IMP=0x001000000012cee3
...
- (void)cancelAllPendingVideoCompositionRequests;	// IMP=0x000000000012d4e7
- (void)startVideoCompositionRequest:(id)arg1;	// IMP=0x000000000012d2ab
- (id)defaultCIContext;	// IMP=0x000000000012d178
...
- (void)renderContextChanged:(id)arg1;	// IMP=0x000000000012d0f9
@property(readonly, nonatomic) NSDictionary *requiredPixelBufferAttributesForRenderContext;
@property(readonly, nonatomic) NSDictionary *sourcePixelBufferAttributes;
- (void)dealloc;	// IMP=0x000000000012cf79
- (void)_willDeallocOrFinalize;	// IMP=0x000000000012cf4b
- (id)init;	// IMP=0x000000000012cef4
