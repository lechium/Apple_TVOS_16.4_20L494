...
@interface AVPlayerItemInternal : NSObject
{
    ...
    _Bool prefersSDRVideo;	// 704 = 0x2c0
    _Bool prefersSDRVideoWasSet;	// 705 = 0x2c1
    _Bool reversesMoreVideoFramesInMemory;	// 706 = 0x2c2
    _Bool reversesMoreVideoFramesInMemoryWasSet;	// 707 = 0x2c3
    _Bool aggressivelyCachesVideoFrames;	// 708 = 0x2c4
    _Bool aggressivelyCachesVideoFramesWasSet;	// 709 = 0x2c5
    _Bool decodesAllFramesDuringOrdinaryPlayback;	// 710 = 0x2c6
    _Bool decodesAllFramesDuringOrdinaryPlaybackWasSet;	// 711 = 0x2c7
    _Bool initialContinuesPlayingDuringPrerollForSeek;	// 712 = 0x2c8
    _Bool initialContinuesPlayingDuringPrerollForRateChange;	// 713 = 0x2c9
    _Bool usesIFrameOnlyPlaybackForHighRateScaledEditsWasSet;	// 714 = 0x2ca
    _Bool usesIFrameOnlyPlaybackForHighRateScaledEdits;	// 715 = 0x2cb
