...
+ (id)assetTrackInspectorWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00100000000eef3b
- (struct OpaqueFigSampleCursorService *)_getFigSampleCursorServiceReportingTimeAccuracy:(_Bool *)arg1;	// IMP=0x00000000000ef954
- (id)makeSampleCursorAtLastSampleInDecodeOrder;	// IMP=0x00000000000ef8cb
- (id)makeSampleCursorAtFirstSampleInDecodeOrder;	// IMP=0x00000000000ef842
- (id)makeSampleCursorWithPresentationTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000ef72f
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x00000000000ef641
...
- (CDStruct_1b6d18a9)samplePresentationTimeForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000ef42f
- (id)segmentForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000ef427
...
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ef0f4
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000ef0dd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ef0d2
- (void)dealloc;	// IMP=0x00000000000ef06c
- (id)_weakReference;	// IMP=0x00000000000ef05b
- (id)init;	// IMP=0x00000000000ef03e
- (id)_initWithAsset:(id)arg1 trackIndex:(long long)arg2;	// IMP=0x00000000000ef027
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2;	// IMP=0x00000000000ef00e
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00000000000eef91
