...
- (void)_requestMediaDataIfReady;	// IMP=0x00000000000c5635
- (void)invalidate;	// IMP=0x00000000000c558d
- (_Bool)_isInvalidatePending;	// IMP=0x00000000000c5565
- (void)_setInvalidatePending;	// IMP=0x00000000000c5540
- (void)startRequestingMediaData;	// IMP=0x00000000000c54df
- (void)dealloc;	// IMP=0x00000000000c548a
- (id)init;	// IMP=0x00000000000c5471
- (id)initWithMediaDataConsumer:(id)arg1 requestQueue:(id)arg2 requestBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000c52d0
