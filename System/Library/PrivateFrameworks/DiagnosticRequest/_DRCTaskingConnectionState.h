...
+ (id)sharedConnectionState;	// IMP=0x0060000000001128
- (void).cxx_destruct;	// IMP=0x0000000000001a6d
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x0000000000001843
- (_Bool)sendMessage:(id)arg1;	// IMP=0x000000000000165f
- (id)init;	// IMP=0x00000000000011f5
- (void)cleanupState;	// IMP=0x000000000000117d
