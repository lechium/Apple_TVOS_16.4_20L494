...
- (void).cxx_destruct;	// IMP=0x0000000001097a02
...
- (double)customSpacingAfterItem:(id)arg1;	// IMP=0x0000000001097885
- (void)setCustomSpacing:(double)arg1 afterItem:(id)arg2;	// IMP=0x00000000010977be
