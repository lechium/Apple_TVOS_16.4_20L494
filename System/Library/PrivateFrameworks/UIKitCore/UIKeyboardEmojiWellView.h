...
- (void).cxx_destruct;	// IMP=0x0000000000a036af
...
- (void)layoutSubviews;	// IMP=0x0000000000a030d5
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000a030a0
- (id)fontUsingSilhouette:(unsigned long long)arg1 size:(double)arg2;	// IMP=0x0000000000a02527
- (void)setStringRepresentation:(id)arg1 silhouette:(unsigned long long)arg2;	// IMP=0x0000000000a023f7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000a01f12
