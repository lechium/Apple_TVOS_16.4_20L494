...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007be35f
- (_Bool)matchesSettings:(id)arg1 strength:(double)arg2;	// IMP=0x00000000007be2e5
- (void)dealloc;	// IMP=0x00000000007be28c
