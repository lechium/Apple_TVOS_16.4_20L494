...
+ (id)descriptionWithTension:(double)arg1 friction:(double)arg2;	// IMP=0x00000000010d6e6f
+ (id)descriptionWithSpringAnimationParameters:(CDStruct_6c8af1d9)arg1;	// IMP=0x00000000010d6df3
