...
+ (id)replacementWithRange:(id)arg1 original:(id)arg2 replacement:(id)arg3 menuTitle:(id)arg4;	// IMP=0x0060000000f61581
- (void).cxx_destruct;	// IMP=0x0000000000f618c9
...
- (_Bool)_isNoReplacementsFoundItem;	// IMP=0x0000000000f6182a
- (void)didReplaceTextWithTarget:(id)arg1;	// IMP=0x0000000000f6164e
