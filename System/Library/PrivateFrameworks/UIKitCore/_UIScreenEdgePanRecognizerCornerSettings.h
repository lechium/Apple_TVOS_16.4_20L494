...
+ (id)settingsControllerModule;	// IMP=0x006000000073da08
+ (id)keyPathsForValuesAffectingCornerAngleWindowDegreees;	// IMP=0x006000000073d9e8
...
- (void)setDefaultValues;	// IMP=0x000000000073d945
