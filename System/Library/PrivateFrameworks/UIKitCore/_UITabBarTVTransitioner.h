...
- (void).cxx_destruct;	// IMP=0x00000000003ddb4d
...
- (void)animateTransition:(id)arg1;	// IMP=0x00000000003dcda4
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000003dcd43
- (void)finishTransition;	// IMP=0x00000000003dca92
- (void)interruptTabBarControllerTransition;	// IMP=0x00000000003dca80
- (id)init;	// IMP=0x00000000003dca44
