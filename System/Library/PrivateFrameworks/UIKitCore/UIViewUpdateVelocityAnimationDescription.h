...
+ (id)descriptionWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x00600000010d8c34
- (void).cxx_destruct;	// IMP=0x00000000010d8cd6
...
- (id)initWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x00000000010d8b9b
