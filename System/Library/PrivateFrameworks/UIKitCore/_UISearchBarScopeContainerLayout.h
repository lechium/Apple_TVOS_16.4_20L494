...
- (void).cxx_destruct;	// IMP=0x00000000001c6f63
...
- (id)description;	// IMP=0x00000000001c6c30
- (void)applyLayout;	// IMP=0x00000000001c6b7e
- (void)updateLayout;	// IMP=0x00000000001c67fe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c675e
- (double)scopeControlHeight;	// IMP=0x00000000001c66f9
