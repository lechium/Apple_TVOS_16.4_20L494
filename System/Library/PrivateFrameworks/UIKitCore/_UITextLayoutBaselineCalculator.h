...
- (void).cxx_destruct;	// IMP=0x0000000000603475
- (double)_convertOffset:(double)arg1;	// IMP=0x0000000000603395
...
- (double)_baselineOffsetAtPosition:(id)arg1;	// IMP=0x0000000000602c2a
- (id)initWithTextLayoutController:(id)arg1 typingAttributes:(id)arg2 usesLineFragmentOrigin:(_Bool)arg3 coordinateSpace:(id)arg4 scale:(double)arg5 fallbackTextContainerOrigin:(struct CGPoint)arg6;	// IMP=0x0000000000602b38
