...
- (void).cxx_destruct;	// IMP=0x0000000000606b3c
...
- (id)stringFromReport:(id)arg1;	// IMP=0x0000000000606a66
- (id)_componentsFromReport:(id)arg1;	// IMP=0x0000000000606548
- (id)init;	// IMP=0x0000000000606488
