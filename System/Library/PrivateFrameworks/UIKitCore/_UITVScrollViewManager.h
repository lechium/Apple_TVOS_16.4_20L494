...
- (void).cxx_destruct;	// IMP=0x0000000000761e59
...
- (void)_observeScrollViewDidScroll:(id)arg1;	// IMP=0x0000000000761bc2
- (id)_customScrollingMaskForScrollView:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x0000000000761a40
- (void)_removeScreenshotViewIfNeeded;	// IMP=0x00000000007619f2
- (void)_scroll:(id)arg1 toContentOffset:(struct CGPoint)arg2;	// IMP=0x00000000007616b9
- (void)_scrollAnimationDidEnd:(id)arg1;	// IMP=0x00000000007615ea
- (void)_tearDown:(id)arg1;	// IMP=0x0000000000761569
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x000000000076128f
- (void)dealloc;	// IMP=0x0000000000761140
- (id)initWithScrollView:(id)arg1 scrollStyle:(long long)arg2;	// IMP=0x0000000000760fc7
