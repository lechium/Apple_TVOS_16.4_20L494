...
- (void).cxx_destruct;	// IMP=0x000000000073fc29
...
- (unsigned long long)_targetEdges;	// IMP=0x000000000073fa83
- (void)_idleTimerElapsed:(id)arg1;	// IMP=0x000000000073f93a
- (void)_longPressTimerElapsed:(id)arg1;	// IMP=0x000000000073f840
- (void)_incorporateIncrementalSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x000000000073eaf3
- (void)_incorporateInitialTouchAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x000000000073e2f8
- (void)incorporateTouchSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x000000000073e26d
- (unsigned long long)touchedEdgesForInterfaceOrientation:(long long)arg1;	// IMP=0x000000000073e1dd
- (long long)_type;	// IMP=0x000000000073e1d0
- (void)_setState:(long long)arg1;	// IMP=0x000000000073dfdc
@property(readonly, nonatomic) _Bool useGrapeFlags;
- (void)reset;	// IMP=0x000000000073df47
- (void)dealloc;	// IMP=0x000000000073df0b
- (id)initWithType:(long long)arg1;	// IMP=0x000000000073deac
- (id)initWithType:(long long)arg1 settings:(id)arg2;	// IMP=0x000000000073dcc3
