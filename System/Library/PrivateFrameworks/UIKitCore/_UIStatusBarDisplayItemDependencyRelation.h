...
- (void).cxx_destruct;	// IMP=0x0000000000dbdf21
...
- (id)_ui_descriptionBuilder;	// IMP=0x0000000000dbdd95
- (id)type;	// IMP=0x0000000000dbdd6e
- (id)itemStates;	// IMP=0x0000000000dbdce3
- (_Bool)isFulfilled;	// IMP=0x0000000000dbdc81
