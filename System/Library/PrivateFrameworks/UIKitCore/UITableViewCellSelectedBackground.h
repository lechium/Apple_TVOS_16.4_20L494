...
- (void).cxx_destruct;	// IMP=0x0000000000e167d2
...
- (void)updateBackgroundColor;	// IMP=0x0000000000e166d8
- (void)tintColorDidChange;	// IMP=0x0000000000e16697
- (void)layoutSubviews;	// IMP=0x0000000000e16622
