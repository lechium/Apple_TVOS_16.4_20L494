...
- (void).cxx_destruct;	// IMP=0x000000000042e357
...
- (_Bool)isCompatibleWithCurlOfType:(long long)arg1 inDirection:(long long)arg2;	// IMP=0x000000000042e221
- (long long)_effectiveTransitionDirection;	// IMP=0x000000000042e1ef
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000042e162
- (void)cleanup;	// IMP=0x000000000042e13a
- (void)cleanupWithFinishedState:(_Bool)arg1 completedState:(_Bool)arg2;	// IMP=0x000000000042e0c4
- (void)finally;	// IMP=0x000000000042e091
- (void)incrementCompletionCount;	// IMP=0x000000000042e080
@property(readonly, nonatomic, getter=hasPendingAnimations) _Bool pendingAnimations;
- (void)setCurlState:(long long)arg1 willComplete:(_Bool)arg2;	// IMP=0x000000000042df8b
- (void)addBackPageContent;	// IMP=0x000000000042deda
- (void)addFrontPageContent;	// IMP=0x000000000042de29
@property(readonly, nonatomic) UIView *backPageView;
@property(readonly, nonatomic) UIView *frontPageView;
- (struct CGRect)_pageViewFrame;	// IMP=0x000000000042d7ee
- (void)invalidatePageCurl;	// IMP=0x000000000042d7cd
- (void)dealloc;	// IMP=0x000000000042d78f
- (id)initWithPageCurl:(id)arg1 andCurlType:(long long)arg2 fromLocation:(struct CGPoint)arg3 withReferenceLocation:(struct CGPoint)arg4 inDirection:(long long)arg5 withView:(id)arg6 revealingView:(id)arg7 completion:(CDUnknownBlockType)arg8 finally:(CDUnknownBlockType)arg9;	// IMP=0x000000000042d5e0
