...
+ (_Bool)_shouldDefaultToTouches;	// IMP=0x0060000000f128b2
- (void).cxx_destruct;	// IMP=0x0000000000f12a28
...
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000f1287f
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000f127ba
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000f12442
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000f121ed
- (void)clearIgnoreTouch;	// IMP=0x0000000000f12193
- (void)tooSlow:(id)arg1;	// IMP=0x0000000000f12160
- (void)clearTimer;	// IMP=0x0000000000f12128
- (void)_resetGestureRecognizer;	// IMP=0x0000000000f120d3
- (void)dealloc;	// IMP=0x0000000000f12071
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000f11fd1
