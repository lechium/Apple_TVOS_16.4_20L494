...
+ (Class)_visualProviderClass;	// IMP=0x0060000000bae0f2
- (void).cxx_destruct;	// IMP=0x0000000000bae217
@property(nonatomic) __weak id <_UITextFieldClearButtonImageProviding> imageProvider; // @synthesize imageProvider=_imageProvider;
- (id)_defaultImageForState:(unsigned long long)arg1 withConfiguration:(id)arg2;	// IMP=0x0000000000bae10b
- (_Bool)_isModernButton;	// IMP=0x0000000000bae103
