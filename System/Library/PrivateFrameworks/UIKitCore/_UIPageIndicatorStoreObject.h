...
- (void).cxx_destruct;	// IMP=0x0000000000b1e378
...
- (id)description;	// IMP=0x0000000000b1e28a
- (id)splitAtIndex:(long long)arg1 withImage:(id)arg2 active:(_Bool)arg3;	// IMP=0x0000000000b1e07d
- (_Bool)validPageWithinBound:(long long)arg1;	// IMP=0x0000000000b1e066
- (void)invalidateLayoutInfo;	// IMP=0x0000000000b1e022
- (void)_copyImagesFromObject:(id)arg1;	// IMP=0x0000000000b1df5e
@property(readonly, nonatomic) _Bool hasImage;
@property(readonly, nonatomic) struct CGSize resolvedSize;
- (id)initWithStartIndex:(long long)arg1 endIndex:(long long)arg2;	// IMP=0x0000000000b1de74
