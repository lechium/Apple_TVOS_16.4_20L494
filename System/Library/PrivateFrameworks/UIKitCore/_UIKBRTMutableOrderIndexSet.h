...
- (void).cxx_destruct;	// IMP=0x0000000000b16c5a
...
- (id)description;	// IMP=0x0000000000b16bb0
- (void)removeIndexes:(id)arg1;	// IMP=0x0000000000b16b9a
- (void)removeIndex:(unsigned long long)arg1;	// IMP=0x0000000000b16b84
- (void)addIndex:(unsigned long long)arg1;	// IMP=0x0000000000b16b6e
...
- (id)initWithIndexesInRange:(struct _NSRange)arg1;	// IMP=0x0000000000b16a5e
- (id)init;	// IMP=0x0000000000b16a04
