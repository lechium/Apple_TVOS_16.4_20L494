...
- (_Bool)coalesceScrollForNode:(id)arg1 offset:(struct CGPoint)arg2 isUserScroll:(_Bool)arg3;	// IMP=0x00000000012084e3
- (void)dealloc;	// IMP=0x00000000012084a8
- (id)initWithNode:(id)arg1 offset:(struct CGPoint)arg2 isUserScroll:(_Bool)arg3;	// IMP=0x000000000120842f
