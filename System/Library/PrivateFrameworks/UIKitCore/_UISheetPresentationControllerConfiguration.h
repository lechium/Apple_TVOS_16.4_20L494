...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000f083b2
+ (id)_fullScreenConfiguration;	// IMP=0x0010000000f075ff
- (void).cxx_destruct;	// IMP=0x0000000000f0850f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000f080eb
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f07e40
- (id)description;	// IMP=0x0000000000f07aca
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000f07637
- (id)init;	// IMP=0x0000000000f074f2
