...
+ (id)decodeFromCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x00600000000f7545
+ (id)transparentBackgroundData;	// IMP=0x00600000000f7452
+ (id)opaqueBackgroundData;	// IMP=0x00600000000f7333
+ (id)standardBackgroundData;	// IMP=0x00600000000f71c9
- (void).cxx_destruct;	// IMP=0x00000000000f983f
...
- (long long)behaviorForTransitioningTo:(id)arg1;	// IMP=0x00000000000f949c
@property(readonly, nonatomic) _Bool hasShadow;
@property(readonly, nonatomic) _Bool hasBackground;
- (void)configureWithoutShadow;	// IMP=0x00000000000f93e8
- (void)configureWithDefaultShadow;	// IMP=0x00000000000f9344
- (void)_updateShadowFlags;	// IMP=0x00000000000f911e
@property(copy, nonatomic) UIBlurEffect *backgroundEffect;
- (void)_updateBackgroundFlags;	// IMP=0x00000000000f8d10
- (id)replicate;	// IMP=0x00000000000f8ba4
- (_Bool)checkEqualTo:(id)arg1;	// IMP=0x00000000000f8866
- (long long)hashInto:(long long)arg1;	// IMP=0x00000000000f87be
- (void)describeInto:(id)arg1;	// IMP=0x00000000000f85ee
- (void)encodeToCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x00000000000f7d55
