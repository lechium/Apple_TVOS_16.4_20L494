...
- (void)reset;	// IMP=0x000000000070617b
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000706135
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000705e80
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000705ad9
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000705a93
- (id)description;	// IMP=0x0000000000705965
