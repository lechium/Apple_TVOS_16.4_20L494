...
- (void).cxx_destruct;	// IMP=0x000000000104c0db
...
- (id)_initialValueForLayer:(id)arg1 keyPath:(id)arg2 usePresentationValue:(_Bool)arg3;	// IMP=0x000000000104bfdf
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x000000000104bf71
- (void)applyIdentityFilterEffects;	// IMP=0x000000000104bf5a
- (void)applyRequestedFilterEffects;	// IMP=0x000000000104bf40
- (void)applyIdentityViewEffects;	// IMP=0x000000000104bef5
- (void)applyRequestedViewEffects;	// IMP=0x000000000104bedb
