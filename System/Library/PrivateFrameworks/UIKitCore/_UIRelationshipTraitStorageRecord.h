...
- (void).cxx_destruct;	// IMP=0x0000000000808027
...
- (id)description;	// IMP=0x0000000000807f89
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000807f06
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000807e27
- (id)initWithTraitCollection:(id)arg1 addedObjects:(id)arg2 removedObjects:(id)arg3;	// IMP=0x0000000000807d41
