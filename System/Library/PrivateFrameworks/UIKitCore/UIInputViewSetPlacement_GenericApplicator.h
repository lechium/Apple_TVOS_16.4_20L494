...
+ (id)applicatorForOwner:(id)arg1 withPlacement:(id)arg2;	// IMP=0x00100000009fd064
- (void).cxx_destruct;	// IMP=0x00000000009fdc32
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009fdae7
- (_Bool)allConstraintsActive;	// IMP=0x00000000009fda9c
- (void)invalidate;	// IMP=0x00000000009fda96
- (void)prepare;	// IMP=0x00000000009fda90
- (void)applyChanges:(id)arg1;	// IMP=0x00000000009fd7a3
- (void)checkVerticalConstraint;	// IMP=0x00000000009fd78a
...
- (_Bool)isGesture:(id)arg1 inDraggableView:(struct CGPoint)arg2;	// IMP=0x00000000009fd44c
- (_Bool)preBeginGesture:(id)arg1 shouldBegin:(_Bool *)arg2;	// IMP=0x00000000009fd3bf
- (struct CGRect)targetRect;	// IMP=0x00000000009fd1e2
...
- (id)initForOwner:(id)arg1 withPlacement:(id)arg2;	// IMP=0x00000000009fcc25
