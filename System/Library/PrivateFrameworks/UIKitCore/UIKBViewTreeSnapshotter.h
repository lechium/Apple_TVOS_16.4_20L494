...
+ (id)snapshotterForKeyboardView:(id)arg1 afterScreenUpdates:(_Bool)arg2;	// IMP=0x0060000000a2cacf
- (void).cxx_destruct;	// IMP=0x0000000000a2ce10
@property(readonly, nonatomic) UIView *snapshotView; // @synthesize snapshotView=_snapshotView;
- (void)dealloc;	// IMP=0x0000000000a2ccae
