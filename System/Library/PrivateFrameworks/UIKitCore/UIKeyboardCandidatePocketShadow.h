...
+ (id)leftShadowImage;	// IMP=0x0060000000812fba
+ (double)widthWithShadow:(_Bool)arg1;	// IMP=0x0060000000812f9e
...
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x00000000008135bb
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000008130b9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000813031
