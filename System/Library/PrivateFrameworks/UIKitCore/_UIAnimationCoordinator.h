...
- (void).cxx_destruct;	// IMP=0x000000000050ccba
...
- (void)animationEnded:(_Bool)arg1;	// IMP=0x000000000050cc04
- (void)animateTransition:(id)arg1;	// IMP=0x000000000050c8ff
- (double)transitionDuration:(id)arg1;	// IMP=0x000000000050c8f4
- (void)finishInteractiveAnimation;	// IMP=0x000000000050c85e
- (void)cancelInteractiveAnimation;	// IMP=0x000000000050c7c8
- (void)updateInteractiveProgress:(double)arg1;	// IMP=0x000000000050c6f1
- (void)animateInteractively;	// IMP=0x000000000050c5fe
- (void)animate;	// IMP=0x000000000050c56c
- (void)_updateTransitionContext;	// IMP=0x000000000050c440
@property(readonly, retain, nonatomic) NSMutableDictionary *stash;
- (void)dealloc;	// IMP=0x000000000050c171
