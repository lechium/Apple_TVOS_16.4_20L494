...
- (void).cxx_destruct;	// IMP=0x0000000000b44d4b
...
- (_Bool)canDisplayTransitionFromKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000000b44c9f
- (void)finishWithProgress:(double)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b44b34
- (void)transitionToFinalState:(id)arg1;	// IMP=0x0000000000b44aa2
- (void)finalizeTransition;	// IMP=0x0000000000b449b8
- (void)removeAllAnimations;	// IMP=0x0000000000b4474c
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000000b44407
- (void)cancelNonInteractiveAnimation;	// IMP=0x0000000000b443b1
- (void)runNonInteractivelyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b4439f
@property(readonly, nonatomic) double nonInteractiveDuration;
- (void)commitTransitionRebuild;	// IMP=0x0000000000b44390
- (void)addTransitionView:(id)arg1 startFrame:(struct CGRect)arg2 endFrame:(struct CGRect)arg3;	// IMP=0x0000000000b44050
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000000b43f47
@property(readonly, nonatomic) double endHeight;
@property(readonly, nonatomic) double startHeight;
- (void)dealloc;	// IMP=0x0000000000b43e5a
