...
+ (id)transitionFromPlacement:(id)arg1 toPlacement:(id)arg2 withAnimationStyle:(id)arg3;	// IMP=0x0060000000a05b39
- (void).cxx_destruct;	// IMP=0x0000000000a05dfe
...
- (void)dealloc;	// IMP=0x0000000000a05cd7
- (_Bool)didAdvanceAnimationToState:(int)arg1;	// IMP=0x0000000000a05bf1
