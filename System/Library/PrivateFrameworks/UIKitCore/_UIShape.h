...
+ (id)shapeWithRoundedRect:(struct CGRect)arg1 cornerRadius:(double)arg2 cornerCurve:(id)arg3 cornerMask:(unsigned long long)arg4;	// IMP=0x001000000004a1b4
+ (id)shapeWithRoundedRect:(struct CGRect)arg1 cornerRadius:(double)arg2 cornerCurve:(id)arg3;	// IMP=0x001000000004a196
+ (id)shapeWithPath:(id)arg1;	// IMP=0x001000000004a132
- (void).cxx_destruct;	// IMP=0x000000000004adcc
...
- (id)description;	// IMP=0x000000000004ab57
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004aa71
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004a7eb
...
- (id)shapeConvertedFromCoordinateSpace:(id)arg1 toCoordinateSpace:(id)arg2;	// IMP=0x000000000004a225
