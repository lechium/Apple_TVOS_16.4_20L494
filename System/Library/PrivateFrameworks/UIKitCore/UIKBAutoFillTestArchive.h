...
+ (id)autoFillTestArchiveWithData:(id)arg1;	// IMP=0x00100000008086b0
- (void).cxx_destruct;	// IMP=0x0000000000808a2b
...
- (void)setTableViewDataSource:(id)arg1 forTableViewWithTag:(long long)arg2;	// IMP=0x00000000008088e2
- (id)tableViewDataSourceWithTag:(long long)arg1;	// IMP=0x000000000080887b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000808828
- (id)autoFillTestArchiveData;	// IMP=0x00000000008087ac
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000008085b6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000008083a9
- (id)init;	// IMP=0x0000000000808331
