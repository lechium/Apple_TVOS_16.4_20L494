...
+ (id)settingsControllerModule;	// IMP=0x0010000000fb7f84
...
- (void)setDefaultValues;	// IMP=0x0000000000fb7ef7
- (void)settings:(id)arg1 changedValueForKey:(id)arg2;	// IMP=0x0000000000fb7c71
- (id)initWithDefaultValues;	// IMP=0x0000000000fb7c22
