...
- (void).cxx_destruct;	// IMP=0x0000000000b92e88
...
- (void)createDynamicColors;	// IMP=0x0000000000b929a1
- (id)vibrancyEffectForBlur:(id)arg1;	// IMP=0x0000000000b92988
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000b928b4
