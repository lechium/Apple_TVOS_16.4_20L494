...
- (id)disconnectionHandlers;	// IMP=0x00300000006c584c
- (id)connectionHandlers;	// IMP=0x00300000006c583f
...
- (id)coreSceneComponentClassDictionary;	// IMP=0x00300000006c5811
