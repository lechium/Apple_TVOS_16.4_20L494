...
+ (id)issueWithFormat:(id)arg1;	// IMP=0x0010000000606072
+ (id)issueWithDescription:(id)arg1;	// IMP=0x0010000000605fa5
- (void).cxx_destruct;	// IMP=0x0000000000606318
...
- (void)addIssue:(id)arg1;	// IMP=0x0000000000606223
@property(readonly, copy, nonatomic) NSArray *subissues;
- (id)init;	// IMP=0x0000000000605f35
