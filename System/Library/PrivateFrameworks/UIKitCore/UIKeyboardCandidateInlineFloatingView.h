...
- (void).cxx_destruct;	// IMP=0x00000000008395ef
...
- (id)traitCollection;	// IMP=0x0000000000839337
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000083910c
- (void)layoutSubviews;	// IMP=0x0000000000838f5d
- (void)setInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3 layout:(_Bool)arg4;	// IMP=0x0000000000838762
- (_Bool)shouldExtendUpwards;	// IMP=0x0000000000838538
- (void)adjustFrameForInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3;	// IMP=0x0000000000837efe
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textWidth:(double)arg2;	// IMP=0x0000000000837c16
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textHeight:(double)arg2;	// IMP=0x0000000000837797
- (_Bool)isAcceptableFrame:(struct CGRect)arg1 afterScrollBy:(double)arg2;	// IMP=0x0000000000836f0f
- (struct CGRect)adjustedInlineRectFromInlineText:(id)arg1 inlineRect:(struct CGRect)arg2;	// IMP=0x0000000000836e8a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000836dca
