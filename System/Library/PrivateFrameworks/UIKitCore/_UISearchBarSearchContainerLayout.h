...
- (void).cxx_destruct;	// IMP=0x00000000001c936d
...
- (void)sendWillLayoutSubviewsForSearchFieldContainerView:(id)arg1;	// IMP=0x00000000001c908d
- (id)description;	// IMP=0x00000000001c8b9c
- (void)applyLayout;	// IMP=0x00000000001c87e7
- (void)updateLayout;	// IMP=0x00000000001c7af9
- (double)searchFieldHeightUpdatingShrinkageAndFadeAlphas;	// IMP=0x00000000001c79d0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c749d
