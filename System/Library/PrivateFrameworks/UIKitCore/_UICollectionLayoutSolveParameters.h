...
- (void).cxx_destruct;	// IMP=0x000000000027647b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002763ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000027621c
- (id)init;	// IMP=0x0000000000275be9
