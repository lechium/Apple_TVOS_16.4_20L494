...
- (void)updateOffsetTo:(struct CGPoint)arg1;	// IMP=0x0000000000b13cd2
- (void)reset;	// IMP=0x0000000000b13c8c
- (id)initWithTimeoutDuration:(double)arg1 limitMovement:(_Bool)arg2;	// IMP=0x0000000000b13c4a
