...
+ (id)sharedInstance;	// IMP=0x0060000000b31abe
- (void).cxx_destruct;	// IMP=0x0000000000b327cd
...
- (void)configureOneFingerForcePressRecognizer:(id)arg1;	// IMP=0x0000000000b3252e
- (void)configureTwoFingerTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000b324d3
- (void)configureTwoFingerPanGestureRecognizer:(id)arg1;	// IMP=0x0000000000b32478
- (id)addLongPressTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000b32470
- (id)addTwoFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000b32404
- (id)addOneFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000b32365
- (_Bool)_longPressAllowedForView:(id)arg1;	// IMP=0x0000000000b32349
- (_Bool)allowOneFingerDeepPress;	// IMP=0x0000000000b32341
- (double)oneFingerForcePressAllowableMovement;	// IMP=0x0000000000b32333
- (_Bool)oneFingerForcePressShouldCancelTouchesInView;	// IMP=0x0000000000b3232b
- (_Bool)oneFingerForcePressShouldFailWithoutForce;	// IMP=0x0000000000b32323
- (double)oneFingerForcePressMinimumDuration;	// IMP=0x0000000000b32315
- (void)redisableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000b321d4
- (void)enableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000b32080
- (void)didRemoveSelectionController;	// IMP=0x0000000000b3207a
- (void)willRemoveSelectionController;	// IMP=0x0000000000b31fd1
- (void)_cleanupDeadGesturesIfNecessary;	// IMP=0x0000000000b31ebb
- (id)selectionController;	// IMP=0x0000000000b31e6b
- (void)dealloc;	// IMP=0x0000000000b31cbf
- (void)removeDeallocationHandler:(id)arg1;	// IMP=0x0000000000b31ca2
- (id)addDeallocationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b31be4
- (id)init;	// IMP=0x0000000000b31b6f
- (_Bool)shouldAddForceGesture;	// IMP=0x0000000000b31b24
- (Class)textInteractionClass;	// IMP=0x0000000000b31b13
