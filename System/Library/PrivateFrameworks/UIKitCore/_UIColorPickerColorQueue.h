...
- (void).cxx_destruct;	// IMP=0x0000000000704519
...
- (void)_pickerDidSelectColor:(id)arg1 colorspace:(id)arg2 isVolatile:(_Bool)arg3;	// IMP=0x00000000007043eb
- (void)_forwardToDelegate:(id)arg1;	// IMP=0x000000000070431e
- (void)_displayLinkFired;	// IMP=0x00000000007042ce
- (id)init;	// IMP=0x000000000070418b
