...
- (void).cxx_destruct;	// IMP=0x000000000005f4eb
...
- (id)_presentedAlertController;	// IMP=0x000000000005f278
- (id)presentationController:(id)arg1 viewControllerForAdaptivePresentationStyle:(long long)arg2;	// IMP=0x000000000005f270
- (long long)adaptivePresentationStyleForPresentationController:(id)arg1;	// IMP=0x000000000005f263
- (void)setDelegate:(id)arg1;	// IMP=0x000000000005f1a4
- (id)_createVisualStyleForProvider:(id)arg1;	// IMP=0x000000000005f11e
- (void)_presentedAlertControllerDidAdapt;	// IMP=0x000000000005f0ba
- (void)_updateConstraintsIfNecessary;	// IMP=0x000000000005ee99
- (void)_prepareConstraintsIfNecessary;	// IMP=0x000000000005e7ec
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000005e724
- (_Bool)_shouldOccludeDuringPresentation;	// IMP=0x000000000005e6b6
- (_Bool)_keyboardShouldAnimateAlongsideForInteractiveTransitions;	// IMP=0x000000000005e6a1
- (_Bool)_preserveResponderAcrossWindows;	// IMP=0x000000000005e633
- (void)presentationTransitionWillBegin;	// IMP=0x000000000005e3ff
- (void)_willRunTransitionForCurrentStateDeferred:(_Bool)arg1;	// IMP=0x000000000005e39d
- (void)_prepareDimmingViewIfNecessary;	// IMP=0x000000000005e182
- (struct CGRect)_frameForTransitionViewInPresentationSuperview:(id)arg1;	// IMP=0x000000000005e14c
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x000000000005dfdb
- (_Bool)_shouldRespectDefinesPresentationContext;	// IMP=0x000000000005dfc9
- (_Bool)shouldPresentInFullscreen;	// IMP=0x000000000005dfb4
- (void)containerViewDidLayoutSubviews;	// IMP=0x000000000005df01
- (void)containerViewWillLayoutSubviews;	// IMP=0x000000000005dec6
- (long long)adaptivePresentationStyle;	// IMP=0x000000000005debb
- (id)initWithPresentedViewController:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000000005dda9
- (_Bool)_canCommitPresentation;	// IMP=0x000000000005dda1
- (_Bool)_canDismissPresentation;	// IMP=0x000000000005dd02
