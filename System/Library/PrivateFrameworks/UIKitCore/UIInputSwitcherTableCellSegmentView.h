...
+ (id)_fontForBiasLabel;	// IMP=0x006000000086455a
- (void).cxx_destruct;	// IMP=0x0000000000864c27
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000864bae
- (void)layoutSubviews;	// IMP=0x00000000008648e1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000086457b
