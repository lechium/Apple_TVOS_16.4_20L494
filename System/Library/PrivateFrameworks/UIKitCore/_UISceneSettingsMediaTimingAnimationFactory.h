...
- (void).cxx_destruct;	// IMP=0x0000000000c4ca14
...
- (_Bool)_shouldAnimateAdditivelyForView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x0000000000c4c9f1
- (id)_basicAnimationForView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x0000000000c4c9e9
