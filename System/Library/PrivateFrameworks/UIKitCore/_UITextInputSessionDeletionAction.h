...
- (long long)inputActionCount;	// IMP=0x0000000000f2a432
- (id)description;	// IMP=0x0000000000f2a313
- (_Bool)changedContent;	// IMP=0x0000000000f2a30b
- (long long)mergeActionIfPossible:(id)arg1;	// IMP=0x0000000000f2a05c
