...
- (void).cxx_destruct;	// IMP=0x0000000000c3ab0b
...
- (id)initWithLeadingDelta:(double)arg1 trailingDelta:(double)arg2;	// IMP=0x0000000000c3aa63
- (id)init;	// IMP=0x0000000000c3a9e3
