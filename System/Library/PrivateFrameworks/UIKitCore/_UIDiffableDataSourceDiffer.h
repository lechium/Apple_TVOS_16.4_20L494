...
+ (id)differWithBeforeDataSourceState:(id)arg1 afterDataSourceState:(id)arg2 itemIdentifierDiffer:(id)arg3;	// IMP=0x00100000002bb898
+ (id)differWithBeforeDataSourceState:(id)arg1 afterDataSourceState:(id)arg2;	// IMP=0x00100000002bb829
- (void).cxx_destruct;	// IMP=0x00000000002bed11
...
- (_Bool)_verifyForUpdates:(id)arg1;	// IMP=0x00000000002bd1f9
- (id)_sectionUpdatesForDiffResults:(id)arg1 deletedSections:(id)arg2 insertedSections:(id)arg3;	// IMP=0x00000000002bcb6f
- (id)_itemUpdatesForDiffResults:(id)arg1 sectionBoundaryMoves:(id)arg2 deletedSections:(id)arg3 insertedSections:(id)arg4;	// IMP=0x00000000002bc143
- (id)_computeSectionBoundaryMovesForItemDiffer:(id)arg1;	// IMP=0x00000000002bc071
- (id)_computeUpdatesForIdentifierBasedDiff;	// IMP=0x00000000002bb958
- (void)_computeUpdates;	// IMP=0x00000000002bb926
- (id)description;	// IMP=0x00000000002bb210
- (id)initWithBeforeDataSource:(id)arg1 afterDataSource:(id)arg2 itemIdentifierDiffer:(id)arg3;	// IMP=0x00000000002bb149
