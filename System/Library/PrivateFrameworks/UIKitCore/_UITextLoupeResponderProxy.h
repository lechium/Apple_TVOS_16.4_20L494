...
+ (id)_proxyWithResponder:(id)arg1;	// IMP=0x0060000000f1ee51
- (void).cxx_destruct;	// IMP=0x0000000000f1ef7e
...
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x0000000000f1eebb
- (id)nextResponder;	// IMP=0x0000000000f1eea2
