...
- (void).cxx_destruct;	// IMP=0x0000000000b8d7fa
...
- (struct CGRect)boundingRectForGlyphsInRange:(struct _NSRange)arg1;	// IMP=0x0000000000b8d679
- (void)placeGlyphs;	// IMP=0x0000000000b8d4bb
- (void)removeGlyphs;	// IMP=0x0000000000b8d354
- (void)buildGlyphViews;	// IMP=0x0000000000b8c1a6
- (void)dealloc;	// IMP=0x0000000000b8c13d
- (id)initWithLabel:(id)arg1 attributedString:(id)arg2;	// IMP=0x0000000000b8bf38
