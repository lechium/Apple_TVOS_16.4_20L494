...
- (void).cxx_destruct;	// IMP=0x0000000000d6b886
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000d6b827
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000d6b552
@property(copy, nonatomic) NSString *text;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d6b106
