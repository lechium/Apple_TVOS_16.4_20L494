...
@class NSArray, NSDictionary, _UIDatePickerLinkedLabel, _UIDatePickerOverlayPresentation;
...
- (void).cxx_destruct;	// IMP=0x00000000003a0afb
...
- (void)setEnabled:(_Bool)arg1;	// IMP=0x00000000003a04cc
- (void)controlEventsGestureRecognizer:(id)arg1 recognizedControlEvent:(unsigned long long)arg2 withEvent:(id)arg3;	// IMP=0x00000000003a02e7
- (void)_didTapTextLabel;	// IMP=0x00000000003a00cd
- (void)activateLabel;	// IMP=0x00000000003a00bb
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000039f91e
