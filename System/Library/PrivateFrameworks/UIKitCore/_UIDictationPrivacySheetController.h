...
- (void).cxx_destruct;	// IMP=0x000000000099d73e
...
- (void)dismiss;	// IMP=0x000000000099d638
- (id)initWithType:(long long)arg1;	// IMP=0x000000000099d3a4
- (_Bool)_canShowWhileLocked;	// IMP=0x000000000099d39c
