...
+ (id)newTransitionDescriptorForStops:(id)arg1;	// IMP=0x00600000000e4f54
- (void).cxx_destruct;	// IMP=0x00000000000e5625
...
- (id)description;	// IMP=0x00000000000e5276
- (void)uniqueFilterNames;	// IMP=0x00000000000e5089
- (id)copyForTransitionToDescriptor:(id)arg1;	// IMP=0x00000000000e4a61
- (void)addOverlay:(id)arg1;	// IMP=0x00000000000e4a4b
- (void)addUnderlay:(id)arg1;	// IMP=0x00000000000e4a08
@property(retain, nonatomic) UIView<_UIVisualEffectViewParticipating> *containerView;
- (void)addViewEffect:(id)arg1;	// IMP=0x00000000000e4971
- (void)addFilterEntry:(id)arg1;	// IMP=0x00000000000e492e
- (id)init;	// IMP=0x00000000000e485e
