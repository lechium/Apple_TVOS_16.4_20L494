...
- (void).cxx_destruct;	// IMP=0x000000000039327e
...
- (double)_resizeAnimationDuration;	// IMP=0x00000000003930bc
- (struct CGSize)_minimumSizeForDismissButton;	// IMP=0x000000000039302c
- (_Bool)_shouldDisableAvoidsKeyboard;	// IMP=0x0000000000392f32
- (CDStruct_758ece87)_currentLayoutGeometry;	// IMP=0x0000000000392d4c
- (void)_handleDismiss:(id)arg1;	// IMP=0x0000000000392c2b
- (void)_dismiss;	// IMP=0x0000000000392b44
@property(nonatomic) _Bool dismissActionUsesShorterHeightWhenCompactVertically;
- (void)endPseudoAlertPresentationMode;	// IMP=0x00000000003929ab
- (void)beginPseudoAlertPresentationMode;	// IMP=0x0000000000392886
@property(copy, nonatomic) NSString *dismissActionTitle;
- (void)_updateForKeyboardStartFrame:(struct CGRect)arg1 endFrame:(struct CGRect)arg2 duration:(double)arg3 curve:(long long)arg4;	// IMP=0x0000000000392567
- (void)_keyboardChanged:(id)arg1;	// IMP=0x000000000039234f
- (void)_unsubscribeFromKeyboardNotifications;	// IMP=0x0000000000392281
- (void)_subscribeToKeyboardNotifications;	// IMP=0x00000000003921ac
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x0000000000391d60
- (void)dismissalTransitionWillBegin;	// IMP=0x0000000000391c6d
- (void)_willRunTransitionForCurrentStateDeferred:(_Bool)arg1;	// IMP=0x0000000000391c18
- (void)presentationTransitionWillBegin;	// IMP=0x000000000039190c
- (struct CGSize)preferredContentSize;	// IMP=0x00000000003918d3
- (void)_applyVisualAffordancesToViews;	// IMP=0x000000000039182b
- (void)_layoutViews;	// IMP=0x0000000000391621
- (struct CGRect)_frameOfPresentedViewControllerViewInSuperview;	// IMP=0x0000000000391602
- (struct CGRect)frameOfPresentedViewInContainerView;	// IMP=0x0000000000391489
- (void)_transitionToPresentationController:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0000000000391445
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0000000000391327
- (struct UIEdgeInsets)_baseContentInsetsWithLeftMargin:(double *)arg1 rightMargin:(double *)arg2;	// IMP=0x0000000000391143
- (_Bool)_shouldOccludeDuringPresentation;	// IMP=0x000000000039113b
- (_Bool)_shouldPresentedViewControllerControlStatusBarAppearance;	// IMP=0x0000000000391133
- (_Bool)shouldPresentInFullscreen;	// IMP=0x00000000003910e1
- (void)dealloc;	// IMP=0x000000000039106c
- (id)initWithPresentedViewController:(id)arg1 presentingViewController:(id)arg2 visualStyle:(id)arg3;	// IMP=0x0000000000390de8
