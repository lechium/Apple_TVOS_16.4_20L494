...
- (void)finishFullRotateUsingOnePartAnimation:(_Bool)arg1;	// IMP=0x00000000003dffe7
- (void)finishFirstHalfRotation;	// IMP=0x00000000003dfb66
- (void)rotateSnapshots;	// IMP=0x00000000003df4c9
- (void)setupRotationOrderingKeyboardInAfterRotation:(_Bool)arg1;	// IMP=0x00000000003de86e
- (_Bool)_isFooterTranslucent;	// IMP=0x00000000003de829
- (_Bool)_isHeaderTranslucent;	// IMP=0x00000000003de7ac
- (void)_positionHeaderView:(id)arg1 andFooterView:(id)arg2 outsideContentViewForInterfaceOrientation:(long long)arg3;	// IMP=0x00000000003de510
- (void)slideHeaderViewAndFooterViewOffScreen:(_Bool)arg1 forInterfaceOrientation:(long long)arg2;	// IMP=0x00000000003de4f0
- (void)_slideHeaderView:(id)arg1 andFooterView:(id)arg2 offScreen:(_Bool)arg3 forInterfaceOrientation:(long long)arg4;	// IMP=0x00000000003de20d
- (void)dealloc;	// IMP=0x00000000003de1a4
- (id)initWithClient:(id)arg1 toOrientation:(long long)arg2 duration:(double)arg3 andWindow:(id)arg4;	// IMP=0x00000000003ddf58
