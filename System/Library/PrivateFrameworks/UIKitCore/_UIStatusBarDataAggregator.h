...
+ (void)initialize;	// IMP=0x0060000000db5f26
- (void).cxx_destruct;	// IMP=0x0000000000db761a
...
- (void)endCoalescingUpdatesForEntryKeys:(id)arg1;	// IMP=0x0000000000db744c
- (void)beginCoalescingUpdatesForEntryKeys:(id)arg1 delay:(double)arg2;	// IMP=0x0000000000db7263
- (void)_coalescedUpdateForEntryKeys:(id)arg1;	// IMP=0x0000000000db704d
- (void)_updateForCoalescedKeysWithData:(id)arg1;	// IMP=0x0000000000db6cd2
@property(readonly, copy, nonatomic) NSSet *delayedEntryKeys;
- (void)endDelayingUpdatesForEntryKeys:(id)arg1;	// IMP=0x0000000000db69c6
- (void)beginDelayingUpdatesForEntryKeys:(id)arg1;	// IMP=0x0000000000db686a
- (void)_updateForDelayedKeysWithData:(id)arg1;	// IMP=0x0000000000db67c4
- (void)_updateForOverlayWithData:(id)arg1;	// IMP=0x0000000000db676e
- (void)_updateFromPendingUpdatesForKeys:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000db63ed
- (id)_updatedDataFromData:(id)arg1 delayedKeys:(id)arg2;	// IMP=0x0000000000db60d2
- (void)updateWithData:(id)arg1;	// IMP=0x0000000000db6077
- (id)initWithUpdateBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000db5f6d
