...
- (void).cxx_destruct;	// IMP=0x000000000110e37e
...
- (void)_layoutIfNeeded;	// IMP=0x000000000110d602
- (id)layoutDescription;	// IMP=0x000000000110cbdf
- (id)description;	// IMP=0x000000000110cacb
- (void)enumerateRunsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000110ca0e
...
- (void)resetLayout;	// IMP=0x000000000110c8a8
- (_Bool)hasLayout;	// IMP=0x000000000110c89a
@property(readonly, copy, nonatomic) _UIVectorTextLayoutParameters *parameters;
- (id)initWithTextParameters:(id)arg1;	// IMP=0x000000000110c7c8
