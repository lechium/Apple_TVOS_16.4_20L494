...
+ (id)settingsControllerModule;	// IMP=0x0060000000d2d556
- (void).cxx_destruct;	// IMP=0x0000000000d2d808
...
- (id)springAnimationBehavior;	// IMP=0x0000000000d2d768
- (void)setDefaultValues;	// IMP=0x0000000000d2d4f0
