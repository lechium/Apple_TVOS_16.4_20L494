...
- (void).cxx_destruct;	// IMP=0x0000000000717819
@property(readonly, copy) NSString *description;
- (double)timestampForDelivery;	// IMP=0x00000000007176db
- (long long)phaseForDelivery;	// IMP=0x00000000007176c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007175d9
- (id)init;	// IMP=0x0000000000717583
