...
+ (double)_interspaceForIconSize:(long long)arg1;	// IMP=0x0010000000d6ea14
+ (double)_fontSizeForIconSize:(long long)arg1;	// IMP=0x0010000000d6e9f4
- (void).cxx_destruct;	// IMP=0x0000000000d6f502
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000d6f0d8
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000d6efb4
- (void)_iconSizeDidChange;	// IMP=0x0000000000d6ee14
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000d6edcd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d6ed75
- (void)_commonInit;	// IMP=0x0000000000d6ea34
