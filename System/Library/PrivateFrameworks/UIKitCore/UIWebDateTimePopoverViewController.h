...
- (void)loadView;	// IMP=0x000000000067cca2
- (void)dealloc;	// IMP=0x000000000067cc62
- (id)initWithDOMHTMLInputElement:(id)arg1 datePickerMode:(long long)arg2;	// IMP=0x000000000067cbd6
