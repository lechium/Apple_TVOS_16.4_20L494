...
- (void).cxx_destruct;	// IMP=0x00000000000c9e7a
...
- (id)settingsScene;	// IMP=0x00000000000c9d90
- (id)remoteAssistantItemForResponder:(id)arg1;	// IMP=0x00000000000c9935
- (id)rtiGroupsForBarButtonItemGroups:(id)arg1;	// IMP=0x00000000000c992d
@property(readonly, nonatomic) UIRemoteInputViewInfo *inputViewInfo;
- (void)updateInputViewsIfNecessary;	// IMP=0x00000000000c96b8
- (_Bool)updateCustomInputViewIfNecessary;	// IMP=0x00000000000c8cc0
- (_Bool)updateAssistantViewIfNecessary;	// IMP=0x00000000000c8263
- (struct UIEdgeInsets)assistantViewInsets;	// IMP=0x00000000000c8117
