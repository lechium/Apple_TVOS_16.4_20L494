...
- (void).cxx_destruct;	// IMP=0x0000000000669877
...
- (void)_setupAlternateTitlesFromBarButtonItem:(id)arg1;	// IMP=0x000000000066904b
- (id)_titleAlternativeForTitle:(id)arg1;	// IMP=0x0000000000668f1a
- (_Bool)supportsBackButtons;	// IMP=0x0000000000668f12
- (void)updateButton:(id)arg1 forHighlightedState:(_Bool)arg2;	// IMP=0x0000000000668ee7
- (void)updateButton:(id)arg1 forFocusedState:(_Bool)arg2;	// IMP=0x0000000000668c59
- (void)buttonLayoutSubviews:(id)arg1 baseImplementation:(CDUnknownBlockType)arg2;	// IMP=0x000000000066893d
- (void)configureButton:(id)arg1 fromBarButtonItem:(id)arg2;	// IMP=0x00000000006671a8
- (void)_selectGestureChanged:(id)arg1;	// IMP=0x0000000000667142
- (void)configureButton:(id)arg1 withAppearanceDelegate:(id)arg2 fromBarItem:(id)arg3;	// IMP=0x00000000006670ab
- (id)contentView;	// IMP=0x0000000000667017
- (id)backIndicatorView;	// IMP=0x0000000000667005
