...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000148615
- (void).cxx_destruct;	// IMP=0x0000000000148e68
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000148b22
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000148756
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014861d
- (unsigned long long)hash;	// IMP=0x00000000001485a5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001480e2
- (id)init;	// IMP=0x0000000000148084
