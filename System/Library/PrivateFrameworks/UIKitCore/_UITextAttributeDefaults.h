...
+ (id)_unspecifiedDefaults;	// IMP=0x00100000002436f8
+ (id)_defaultsForUserInterfaceIdiom:(long long)arg1;	// IMP=0x00100000002436c2
+ (void)_getFontSizesForUserInterfaceIdiom:(long long)arg1 labelFontSize:(double *)arg2 buttonFontSize:(double *)arg3 systemFontSize:(double *)arg4 smallSystemFontSize:(double *)arg5;	// IMP=0x0010000000243d8d
- (void).cxx_destruct;	// IMP=0x0000000000243d7d
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000243c7d
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000243b62
...
- (id)_initWithFallback:(id)arg1;	// IMP=0x00000000002437ba
- (id)_init;	// IMP=0x0000000000243764
