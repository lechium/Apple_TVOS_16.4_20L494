...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000092d924
- (void)renderEffectWithRenderer:(id)arg1 traits:(id)arg2;	// IMP=0x000000000092d909
...
- (struct CGColor *)CGColor;	// IMP=0x000000000092d8d5
