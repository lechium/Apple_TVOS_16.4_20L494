...
- (void).cxx_destruct;	// IMP=0x00000000001cc265
...
- (void)cancel;	// IMP=0x00000000001cc1f4
- (void)complete;	// IMP=0x00000000001cc1ee
- (void)animate;	// IMP=0x00000000001cc1b8
- (void)prepare;	// IMP=0x00000000001cc182
- (id)initWithNewTransitionContextForSearchBar:(id)arg1;	// IMP=0x00000000001cc11e
- (id)init;	// IMP=0x00000000001cc018
- (id)initWithTransitionContext:(id)arg1 forSearchBar:(id)arg2;	// IMP=0x00000000001cbe97
