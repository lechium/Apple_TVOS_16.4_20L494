...
- (void).cxx_destruct;	// IMP=0x0000000000e527de
...
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x0000000000e52594
- (id)viewForIdentifier:(id)arg1;	// IMP=0x0000000000e52582
- (void)_create_sensorActivityIndicator;	// IMP=0x0000000000e52528
- (id)dependentEntryKeys;	// IMP=0x0000000000e524ce
