...
- (void).cxx_destruct;	// IMP=0x0000000000393642
...
- (_Bool)currentSateCanTransitionWithEvents:(id)arg1;	// IMP=0x0000000000393505
@property(readonly, nonatomic) unsigned long long *currentStateRef;
- (void)_updateFromState:(unsigned long long)arg1;	// IMP=0x00000000003934d5
- (id)initWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003933e5
