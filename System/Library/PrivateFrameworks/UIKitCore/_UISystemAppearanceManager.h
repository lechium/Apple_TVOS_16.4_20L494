...
- (void).cxx_destruct;	// IMP=0x000000000024e733
...
- (void)_logOrientationPreferencesChangeWithOldSupportedOrientations:(unsigned long long)arg1 newSupportedOrientations:(unsigned long long)arg2 oldPreferredOrientation:(long long)arg3 newPreferredOrientation:(long long)arg4 animationSettings:(id)arg5 fenced:(_Bool)arg6;	// IMP=0x000000000024e20e
- (void)window:(id)arg1 didUpdateSupportedOrientations:(unsigned long long)arg2 preferredOrientation:(long long)arg3 prefersAnimation:(_Bool)arg4;	// IMP=0x000000000024d9c8
- (void)updateMultitaskingDragExclusionRects;	// IMP=0x000000000024d55e
- (void)updateWhitePointAdaptivityStyle;	// IMP=0x000000000024d43c
- (void)updateUserInterfaceStyle;	// IMP=0x000000000024d386
- (void)updateScreenEdgesDeferringSystemGestures;	// IMP=0x000000000024d380
- (void)updateHomeIndicatorAutoHidden;	// IMP=0x000000000024d37a
- (void)_windowDrivingSystemAppearanceDidChange:(id)arg1;	// IMP=0x000000000024d363
- (void)_handleWindowVisibilityNotification:(id)arg1;	// IMP=0x000000000024d099
- (id)_findWindowDrivingSystemAppearance;	// IMP=0x000000000024cd3b
@property(nonatomic, getter=_scene, setter=_setScene:) __weak UIScene *_scene;
- (void)dealloc;	// IMP=0x000000000024ca31
- (id)initWithScene:(id)arg1;	// IMP=0x000000000024c88f
