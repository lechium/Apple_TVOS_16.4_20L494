...
+ (double)defaultDuration;	// IMP=0x0060000000463594
+ (id)timingCurveProviderWithVelocity:(double)arg1;	// IMP=0x0060000000463556
+ (id)timingCurveProvider;	// IMP=0x006000000046353d
- (void).cxx_destruct;	// IMP=0x0000000000463691
...
- (id)description;	// IMP=0x00000000004634a3
