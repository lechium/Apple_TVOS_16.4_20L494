...
- (void).cxx_destruct;	// IMP=0x0000000000fdbc7f
...
- (void)setupToInsertResultForNewHypothesis:(id)arg1;	// IMP=0x0000000000fdbb30
- (void)_displayLinkFired:(id)arg1;	// IMP=0x0000000000fdb26f
- (void)_startStreamingAnimations;	// IMP=0x0000000000fdb157
- (void)_stopStreamingAnimation;	// IMP=0x0000000000fdb0e1
- (void)setWords:(id)arg1;	// IMP=0x0000000000fdb00f
- (void)commitFinalResults;	// IMP=0x0000000000fdafbf
- (id)initWithTextView:(id)arg1;	// IMP=0x0000000000fdaf4f
