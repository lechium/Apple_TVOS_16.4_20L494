...
- (void).cxx_destruct;	// IMP=0x000000000018be6a
...
- (void)updateLayoutData:(id)arg1 layoutWidth:(double)arg2;	// IMP=0x000000000018bd58
- (void)removeContent;	// IMP=0x000000000018bd10
- (struct CGSize)sizeFittingSize:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x000000000018bce8
- (struct CGSize)_cachedTitleHeightSizeAndUpdateRestingSizeForWidth:(double)arg1;	// IMP=0x000000000018b74e
- (struct CGSize)_cachedTitleHeightSizeAndUpdateRestingSizeForWidthSupportingMultiLineShrinkToFit:(double)arg1;	// IMP=0x000000000018af9a
- (void)_invalidateTitleHeightCache;	// IMP=0x000000000018af61
- (double)_textHeightForSize:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x000000000018aedb
- (void)setContentHidden:(_Bool)arg1;	// IMP=0x000000000018aeba
- (void)setContentAlpha:(double)arg1;	// IMP=0x000000000018ae75
- (void)cleanupAfterLayoutTransitionCompleted;	// IMP=0x000000000018ae63
- (void)layoutViewsWithOffset:(struct UIOffset)arg1 useRestingTitleHeight:(_Bool)arg2;	// IMP=0x000000000018a4ce
- (void)layoutViewsWithOffsetSupportingMultiLineShrinkToFit:(struct UIOffset)arg1 useRestingTitleHeight:(_Bool)arg2;	// IMP=0x0000000000189908
- (void)layoutViews;	// IMP=0x00000000001898ee
- (void)_enforceLayoutOrdering;	// IMP=0x0000000000189891
- (void)updateRestingTitleHeight;	// IMP=0x000000000018972a
- (struct CGRect)_contentLayoutBounds;	// IMP=0x0000000000189709
- (struct CGRect)_contentLayoutBoundsUsingRestingTitleHeight:(_Bool)arg1;	// IMP=0x0000000000189632
- (id)initWithContentView:(id)arg1;	// IMP=0x00000000001894c3
- (id)description;	// IMP=0x000000000018932d
