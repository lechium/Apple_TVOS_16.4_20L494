...
- (void).cxx_destruct;	// IMP=0x000000000070240a
...
- (id)description;	// IMP=0x00000000007022be
@property(readonly, nonatomic, getter=isLoop) _Bool loop;
- (id)commonNode:(id)arg1;	// IMP=0x0000000000702138
- (id)oppositeNode:(id)arg1;	// IMP=0x00000000007020fb
- (id)initWithLabel:(id)arg1 sourceNode:(id)arg2 targetNode:(id)arg3 directed:(_Bool)arg4;	// IMP=0x0000000000701f7c
