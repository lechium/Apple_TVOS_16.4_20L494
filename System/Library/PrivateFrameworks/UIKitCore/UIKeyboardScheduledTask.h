...
- (void).cxx_destruct;	// IMP=0x0000000000abb875
...
- (void)resetTimer;	// IMP=0x0000000000abb5dd
- (void)invalidate;	// IMP=0x0000000000abb51d
- (_Bool)isValid;	// IMP=0x0000000000abb469
- (void)handleDeferredTimerFiredEvent;	// IMP=0x0000000000abb1ed
- (void)timerFired:(id)arg1;	// IMP=0x0000000000abb11d
@property(readonly, nonatomic) _Bool repeats;
- (id)initWithTaskQueue:(id)arg1 timeInterval:(double)arg2 repeats:(_Bool)arg3 task:(CDUnknownBlockType)arg4;	// IMP=0x0000000000abafb7
- (void)dealloc;	// IMP=0x0000000000abaf5c
