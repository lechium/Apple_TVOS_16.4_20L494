...
- (void).cxx_destruct;	// IMP=0x0000000000ba519d
...
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000ba4f37
@property(readonly, nonatomic) NSString *eventName;
- (_Bool)_affectedByGesture:(id)arg1;	// IMP=0x0000000000ba4f22
- (void)reset;	// IMP=0x0000000000ba4ebf
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ba4e23
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ba4d87
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ba4d81
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ba4c78
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x0000000000ba4bf0
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000ba4b58
