...
+ (id)atomWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x00600000009d9960
- (void).cxx_destruct;	// IMP=0x00000000009d99f8
...
- (id)description;	// IMP=0x00000000009d98aa
- (id)initWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x00000000009d9819
