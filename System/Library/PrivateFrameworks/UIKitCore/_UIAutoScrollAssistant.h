...
- (void).cxx_destruct;	// IMP=0x000000000103cb4d
...
- (void)setPoint:(struct CGPoint)arg1 forContentOffset:(struct CGPoint)arg2;	// IMP=0x000000000103ca22
- (void)_adjustPointToCurrentContentOffset;	// IMP=0x000000000103c995
- (void)_handleAutoScrollerWithContentOffset:(struct CGPoint)arg1 direction:(unsigned long long)arg2;	// IMP=0x000000000103c91f
- (void)displayLinkFired:(id)arg1;	// IMP=0x000000000103c70a
- (_Bool)_scrollContinuous;	// IMP=0x000000000103c6a3
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (void)stop;	// IMP=0x000000000103c607
- (void)autoScrollFromPoint:(struct CGPoint)arg1;	// IMP=0x000000000103c3d9
- (id)initWithScrollView:(id)arg1;	// IMP=0x000000000103c30a
