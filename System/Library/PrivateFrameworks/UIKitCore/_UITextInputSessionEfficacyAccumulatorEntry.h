...
+ (id)generateAccumulatorEntryFromAction:(id)arg1;	// IMP=0x0060000001002b00
...
- (_Bool)isAllZeroes;	// IMP=0x0000000001002e57
- (void)increaseWithEntry:(id)arg1;	// IMP=0x0000000001002dc9
