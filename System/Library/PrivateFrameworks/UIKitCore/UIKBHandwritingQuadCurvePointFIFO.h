...
- (void).cxx_destruct;	// IMP=0x00000000008ce91d
...
- (void)clear;	// IMP=0x00000000008ce804
- (void)flush;	// IMP=0x00000000008ce4fa
- (void)addPoint:(struct)arg1;	// IMP=0x00000000008cdf62
- (id)initWithFIFO:(id)arg1 scale:(double)arg2;	// IMP=0x00000000008cdecc
