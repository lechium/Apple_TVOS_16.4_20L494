...
+ (id)contextForTransition:(int)arg1;	// IMP=0x0060000000190b23
- (void).cxx_destruct;	// IMP=0x0000000000192688
...
- (void)_updateIncomingLayoutWidthToMatchOutgoingLayout;	// IMP=0x0000000000192504
- (void)_animateAsTwoPartsWithoutOverlap:(CDUnknownBlockType)arg1 partTwo:(CDUnknownBlockType)arg2;	// IMP=0x00000000001924ea
- (void)_animateAsTwoPartsWithOverlapIfNecessaryPartOne:(CDUnknownBlockType)arg1 partTwo:(CDUnknownBlockType)arg2;	// IMP=0x0000000000192462
- (void)_animateAsTwoPartsWithOverlap:(double)arg1 partOne:(CDUnknownBlockType)arg2 partTwo:(CDUnknownBlockType)arg3;	// IMP=0x00000000001922cf
- (void)_removeAllClippingViews;	// IMP=0x0000000000192181
- (void)_addClippingView:(id)arg1;	// IMP=0x0000000000192116
...
- (void)cancel;	// IMP=0x0000000000191e39
- (void)complete;	// IMP=0x0000000000191c89
- (void)_resetContentAndLargeTitleViewCompleted:(_Bool)arg1;	// IMP=0x0000000000191c3a
- (void)setAllLargeTitleLayoutsVisible;	// IMP=0x0000000000191bfb
- (void)animate;	// IMP=0x0000000000191be9
- (void)_animateBackgroundView;	// IMP=0x0000000000191a20
- (_Bool)shouldPerformTwoPartCrossfadeTransition;	// IMP=0x00000000001919d6
- (void)_animateFromBottomPaletteAtEdge:(unsigned long long)arg1;	// IMP=0x0000000000191542
- (void)_prepareToBottomPaletteAtEdge:(unsigned long long)arg1;	// IMP=0x0000000000191259
- (void)prepare;	// IMP=0x0000000000190fc1
- (void)recordUpdates:(CDUnknownBlockType)arg1;	// IMP=0x0000000000190c1c
- (id)description;	// IMP=0x0000000000190a99
- (void)setBackgroundView:(id)arg1 isBarBackground:(_Bool)arg2;	// IMP=0x0000000000190a63
