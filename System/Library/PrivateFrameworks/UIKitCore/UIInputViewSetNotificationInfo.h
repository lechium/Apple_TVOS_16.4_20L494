...
+ (id)info;	// IMP=0x0060000000a03b63
...
- (void)populateEndInfoWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000a04560
- (void)populateStartInfoWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000a044e0
- (void)populateWithAnimationStyle:(id)arg1;	// IMP=0x0000000000a0445f
- (_Bool)containsChange;	// IMP=0x0000000000a043de
- (void)logGeometry;	// IMP=0x0000000000a043d8
@property(readonly, nonatomic) NSDictionary *privateUserInfo;
- (id)rotationUserInfo;	// IMP=0x0000000000a0409f
@property(readonly, nonatomic) NSDictionary *userInfo;
- (id)inverseInfo;	// IMP=0x0000000000a03c8e
- (id)init;	// IMP=0x0000000000a03b7c
