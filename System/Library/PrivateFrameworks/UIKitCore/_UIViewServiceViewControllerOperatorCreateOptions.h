...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000001077391
- (void).cxx_destruct;	// IMP=0x000000000107746f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000001076f97
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001076caf
