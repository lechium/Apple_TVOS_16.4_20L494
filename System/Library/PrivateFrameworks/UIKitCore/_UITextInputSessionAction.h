...
- (void).cxx_destruct;	// IMP=0x0000000000f295e7
...
- (_Bool)isMergeableWith:(id)arg1;	// IMP=0x0000000000f293d2
- (id)inputModeUniqueString;	// IMP=0x0000000000f29352
@property(readonly, nonatomic) long long inputActionCount;
@property(readonly, nonatomic) _Bool changedContent;
- (long long)mergeActionIfPossible:(id)arg1;	// IMP=0x0000000000f2926d
