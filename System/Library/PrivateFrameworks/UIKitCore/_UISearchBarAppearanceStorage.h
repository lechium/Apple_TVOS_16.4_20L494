...
- (void).cxx_destruct;	// IMP=0x00000000001c1569
...
- (id)imageForIcon:(long long)arg1 state:(unsigned long long)arg2;	// IMP=0x00000000001c143d
- (void)setImage:(id)arg1 forIcon:(long long)arg2 state:(unsigned long long)arg3;	// IMP=0x00000000001c1377
- (id)searchFieldBackgroundImageForState:(unsigned long long)arg1;	// IMP=0x00000000001c1310
- (void)setSearchFieldBackgroundImage:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x00000000001c122e
