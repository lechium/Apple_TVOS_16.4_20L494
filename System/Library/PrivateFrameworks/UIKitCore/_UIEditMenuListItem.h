...
+ (id)itemWithTitle:(id)arg1;	// IMP=0x0060000000bc857f
+ (id)itemWithMenuElement:(id)arg1;	// IMP=0x0060000000bc8105
- (void).cxx_destruct;	// IMP=0x0000000000bc872b
...
- (_Bool)hidesImageForTraitCollection:(id)arg1;	// IMP=0x0000000000bc8643
- (_Bool)hidesTitleForTraitCollection:(id)arg1;	// IMP=0x0000000000bc85c3
