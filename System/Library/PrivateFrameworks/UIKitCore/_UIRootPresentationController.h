...
+ (_Bool)_allowsDeferredTransitions;	// IMP=0x00100000003bcab4
- (void).cxx_destruct;	// IMP=0x00000000003bcb13
...
- (id)_createVisualStyleForProvider:(id)arg1;	// IMP=0x00000000003bcac4
- (_Bool)_mayChildGrabPresentedViewControllerView;	// IMP=0x00000000003bcabc
- (_Bool)_isRootPresentation;	// IMP=0x00000000003bcaac
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000003bc9c1
...
- (id)_fullscreenPresentationSuperview;	// IMP=0x00000000003bc999
- (id)_parentTraitEnvironment;	// IMP=0x00000000003bc987
- (id)initWithPresentedViewController:(id)arg1 presentingWindow:(id)arg2;	// IMP=0x00000000003bc914
