...
- (void).cxx_destruct;	// IMP=0x0000000000bde8fc
...
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x0000000000bde27c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000bde054
