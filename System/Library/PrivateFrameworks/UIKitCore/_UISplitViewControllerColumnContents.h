...
- (void).cxx_destruct;	// IMP=0x000000000049ccd1
...
- (id)description;	// IMP=0x000000000049cbcf
@property(readonly, nonatomic) UIViewController *viewController; // @synthesize viewController=_viewController;
- (id)initWithViewController:(id)arg1 navigationController:(id)arg2 navigationControllerWrapper:(id)arg3;	// IMP=0x000000000049ca52
