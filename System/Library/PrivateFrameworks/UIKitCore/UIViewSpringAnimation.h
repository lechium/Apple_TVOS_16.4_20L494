...
- (void).cxx_destruct;	// IMP=0x00000000010d6555
...
- (_Bool)isStable;	// IMP=0x00000000010d636e
@property(retain, nonatomic) id <UIVectorOperatable> velocity;
- (id)stepWithDelta:(double)arg1;	// IMP=0x00000000010d60e3
- (id)initWithCurrent:(id)arg1 targetValue:(id)arg2;	// IMP=0x00000000010d603c
- (void)updateWithDescription:(id)arg1 initial:(_Bool)arg2;	// IMP=0x00000000010d5a91
- (void)updateWithDescription:(id)arg1;	// IMP=0x00000000010d5a7d
- (id)initWithDescription:(id)arg1 current:(id)arg2 targetValue:(id)arg3;	// IMP=0x00000000010d5858
