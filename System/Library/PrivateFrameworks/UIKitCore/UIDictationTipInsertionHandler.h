...
- (void).cxx_destruct;	// IMP=0x00000000011c99e0
...
- (void)startRecodingText:(id)arg1;	// IMP=0x00000000011c98f4
- (void)resetHandler;	// IMP=0x00000000011c98b2
- (void)recordDictationTipText:(id)arg1;	// IMP=0x00000000011c980e
- (void)finalizeRecordedText;	// IMP=0x00000000011c9672
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000011c95b9
