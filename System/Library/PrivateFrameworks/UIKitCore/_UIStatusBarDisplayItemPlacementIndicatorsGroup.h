...
+ (id)groupWithHighPriority:(long long)arg1 lowPriority:(long long)arg2 bluetoothPaddingInset:(double)arg3;	// IMP=0x0040000000d58ceb
+ (id)activityItemDisplayIdentifier;	// IMP=0x0040000000d58cd2
- (void).cxx_destruct;	// IMP=0x0000000000d59486
