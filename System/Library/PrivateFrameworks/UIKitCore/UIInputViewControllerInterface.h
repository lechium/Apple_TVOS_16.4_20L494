...
- (void).cxx_destruct;	// IMP=0x000000000087fa82
...
- (void)syncToKeyboardState:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000087f938
- (void)_tearDownRemoteService;	// IMP=0x000000000087f932
- (void)_handleInputViewControllerState:(id)arg1;	// IMP=0x000000000087f92c
- (void)dealloc;	// IMP=0x000000000087f7ab
- (id)init;	// IMP=0x000000000087f676
