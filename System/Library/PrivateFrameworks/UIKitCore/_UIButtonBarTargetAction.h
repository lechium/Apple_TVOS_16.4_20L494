...
- (void).cxx_destruct;	// IMP=0x000000000010364d
...
- (void)_invoke:(id)arg1 forEvent:(id)arg2;	// IMP=0x000000000010342b
@property(readonly, nonatomic) SEL proxyAction;
- (id)initWithBarButtonItem:(id)arg1;	// IMP=0x00000000001033b3
- (id)init;	// IMP=0x0000000000103304
