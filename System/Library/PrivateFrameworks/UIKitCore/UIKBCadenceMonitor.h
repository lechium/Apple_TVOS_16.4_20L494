...
- (void).cxx_destruct;	// IMP=0x0000000000b05fb5
...
- (id)init;	// IMP=0x0000000000b05ebc
- (void)reset;	// IMP=0x0000000000b05e3a
- (void)addTypingTouchTime:(double)arg1;	// IMP=0x0000000000b05df3
- (void)logUserTyping:(id)arg1;	// IMP=0x0000000000b05d79
- (void)typingCadence:(double)arg1;	// IMP=0x0000000000b05aaa
- (void)updateConfidenceWithGap:(double)arg1;	// IMP=0x0000000000b059fc
- (id)recognizer:(id)arg1 confidenceWhenSettingTouchInfo:(id)arg2;	// IMP=0x0000000000b059f4
- (id)recognizer:(id)arg1 confidenceWhenPendingTouchInfo:(id)arg2;	// IMP=0x0000000000b0596f
