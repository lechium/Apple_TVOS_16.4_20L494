...
- (void).cxx_destruct;	// IMP=0x0000000000f8d9e4
...
- (void)setDefaultResult;	// IMP=0x0000000000f8d551
- (void)setNoResult;	// IMP=0x0000000000f8d536
- (void)setAttachmentResult:(id)arg1;	// IMP=0x0000000000f8d4dd
- (void)setAttributedStringResult:(id)arg1;	// IMP=0x0000000000f8d4c4
- (void)setStringResult:(id)arg1;	// IMP=0x0000000000f8d41a
- (id)initWithTextPasteCoordinator:(id)arg1;	// IMP=0x0000000000f8d3af
