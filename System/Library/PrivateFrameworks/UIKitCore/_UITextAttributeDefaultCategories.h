...
- (void).cxx_destruct;	// IMP=0x0000000000243684
...
- (id)_textViewDefaults:(long long)arg1;	// IMP=0x00000000002431cc
- (id)_textFieldDefaults:(long long)arg1;	// IMP=0x0000000000243180
- (id)_labelDefaults:(long long)arg1;	// IMP=0x0000000000243071
- (id)_genericDefaults:(long long)arg1;	// IMP=0x0000000000242f02
- (id)initWithUserInterfaceIdiom:(long long)arg1;	// IMP=0x0000000000242ce7
