...
+ (_Bool)isEnabled;	// IMP=0x0060000000b0e3bf
- (void).cxx_destruct;	// IMP=0x0000000000b13830
...
- (void)_updateDriftViewTimer:(id)arg1;	// IMP=0x0000000000b1311e
- (void)_updateDriftView;	// IMP=0x0000000000b11891
- (struct CGPoint)_pinOffset:(struct CGPoint)arg1;	// IMP=0x0000000000b117ae
- (struct CGPoint)_pointFromPoint:(struct CGPoint)arg1 plusOffset:(struct CGPoint)arg2;	// IMP=0x0000000000b117a0
- (struct CGPoint)_offsetForPoint:(struct CGPoint)arg1 fromPoint:(struct CGPoint)arg2;	// IMP=0x0000000000b11792
- (void)_updateDriftForFingers:(id)arg1 leftHand:(_Bool)arg2 newestTouch:(id)arg3;	// IMP=0x0000000000b10d3a
- (void)_updateDriftWithTouchInfo:(id)arg1;	// IMP=0x0000000000b1033c
- (id)_touchDictWithFingerIds:(id)arg1;	// IMP=0x0000000000b0ff0d
- (void)_updateHistory;	// IMP=0x0000000000b0fec4
- (void)removeTouchWithIdentifier:(id)arg1 touchCancelled:(_Bool)arg2;	// IMP=0x0000000000b0fb57
- (void)moveTouchWithIdentifier:(id)arg1 toLocation:(struct CGPoint)arg2 withRadius:(double)arg3 atTouchTime:(double)arg4;	// IMP=0x0000000000b0f85d
- (void)ignoreTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2;	// IMP=0x0000000000b0f483
- (void)updateTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 resultingError:(struct CGPoint)arg3 rowOffsetFromHomeRow:(long long)arg4;	// IMP=0x0000000000b0f1df
- (void)addTouchLocation:(struct CGPoint)arg1 withRadius:(double)arg2 withTouchTime:(double)arg3 withIdentifier:(id)arg4;	// IMP=0x0000000000b0ef85
...
- (void)updateWithFCenter:(struct CGPoint)arg1 jCenter:(struct CGPoint)arg2 keySize:(struct CGSize)arg3 rowOffsets:(id)arg4 homeRowOffsetIndex:(int)arg5;	// IMP=0x0000000000b0ec71
- (void)reset;	// IMP=0x0000000000b0ea1e
- (void)_resetFeedback;	// IMP=0x0000000000b0e955
- (void)dealloc;	// IMP=0x0000000000b0e917
- (id)initWithParentView:(id)arg1;	// IMP=0x0000000000b0e8c6
- (id)init;	// IMP=0x0000000000b0e3ea
