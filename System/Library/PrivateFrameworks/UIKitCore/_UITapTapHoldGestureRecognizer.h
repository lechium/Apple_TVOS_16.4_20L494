...
- (_Bool)_shouldFailInResponseToPresses:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000099d05e
- (void)cancelPendingHoldToAction;	// IMP=0x000000000099d01b
- (void)scheduleHoldToAction;	// IMP=0x000000000099cfe2
- (void)holdToAction:(id)arg1;	// IMP=0x000000000099cf5d
- (void)cancelPendingTooSlowForDoubleTap;	// IMP=0x000000000099cf1a
- (void)scheduleTooSlowForDoubleTap;	// IMP=0x000000000099ceec
- (void)tooSlowForDoubleTap:(id)arg1;	// IMP=0x000000000099cea9
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000099cd9b
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000099ccf9
- (void)reset;	// IMP=0x000000000099cc67
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x000000000099cc38
