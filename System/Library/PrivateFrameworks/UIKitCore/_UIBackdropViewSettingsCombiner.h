...
- (void).cxx_destruct;	// IMP=0x00000000000c4dc6
...
- (void)computeOutputSettingsUsingModel:(id)arg1;	// IMP=0x00000000000c46f4
- (_Bool)isBackdropVisible;	// IMP=0x00000000000c46ec
- (_Bool)requiresBackdropLayer;	// IMP=0x00000000000c46e4
- (void)setRequiresColorStatistics:(_Bool)arg1;	// IMP=0x00000000000c46b3
- (void)copyAdditionalSettingsFromSettings:(id)arg1;	// IMP=0x00000000000c4511
- (void)setDefaultValues;	// IMP=0x00000000000c44dc
