...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000010778e0
- (void).cxx_destruct;	// IMP=0x000000000107795d
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000107766f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000010774c3
