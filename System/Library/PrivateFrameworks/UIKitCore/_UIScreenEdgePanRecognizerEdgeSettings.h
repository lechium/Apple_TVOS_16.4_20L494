...
+ (id)settingsControllerModule;	// IMP=0x006000000073cdbf
+ (id)keyPathsForValuesAffectingEdgeAngleWindowDegreees;	// IMP=0x006000000073cd9f
...
- (void)setDefaultValues;	// IMP=0x000000000073cbea
