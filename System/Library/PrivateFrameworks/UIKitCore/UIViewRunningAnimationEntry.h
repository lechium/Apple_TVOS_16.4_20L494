...
- (void).cxx_destruct;	// IMP=0x00000000010e2a36
...
- (void)performWithoutLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000010e29d0
- (void)performWithLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000010e292c
- (void)setCompletionCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000010e2907
- (void)performCompletionCallbackFinished:(_Bool)arg1;	// IMP=0x00000000010e28b6
@property(nonatomic) _Bool invalidated;
- (id)initWithAnimation:(id)arg1 completion:(CDUnknownBlockType)arg2 composer:(id)arg3;	// IMP=0x00000000010e27b3
