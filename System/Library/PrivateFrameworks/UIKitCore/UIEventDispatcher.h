...
- (void).cxx_destruct;	// IMP=0x0000000000d02e07
- (void)dealloc;	// IMP=0x0000000000d02dc4
- (void)eventFetcherDidReceiveEvents:(id)arg1;	// IMP=0x0000000000d02da3
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000000d02afd
