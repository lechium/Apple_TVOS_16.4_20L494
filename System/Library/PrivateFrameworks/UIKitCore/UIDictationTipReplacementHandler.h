...
- (void).cxx_destruct;	// IMP=0x000000000022cebb
...
- (void)recordDictationTipReplacementText:(id)arg1;	// IMP=0x000000000022ce1d
- (void)startRecodingReplacementText:(id)arg1;	// IMP=0x000000000022ce0b
- (void)finalizeRecordedText;	// IMP=0x000000000022cc7f
- (void)recordDictationTipText:(id)arg1;	// IMP=0x000000000022cbdc
- (void)startRecodingText:(id)arg1;	// IMP=0x000000000022cb21
- (void)resetHandler;	// IMP=0x000000000022cac9
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000022ca10
