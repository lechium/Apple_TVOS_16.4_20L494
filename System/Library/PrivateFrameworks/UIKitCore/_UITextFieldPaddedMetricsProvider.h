...
- (struct CGSize)intrinsicSizeForContentSize:(struct CGSize)arg1;	// IMP=0x00000000005a4554
- (struct CGRect)contentFrameForBounds:(struct CGRect)arg1;	// IMP=0x00000000005a44a7
- (id)initWithPerEdgePadding:(struct UIEdgeInsets)arg1;	// IMP=0x00000000005a4460
- (id)initWithSymmetricalPadding:(struct CGSize)arg1;	// IMP=0x00000000005a4404
- (id)init;	// IMP=0x00000000005a43c5
