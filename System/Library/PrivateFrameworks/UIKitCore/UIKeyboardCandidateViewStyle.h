...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x001000000082a5e7
+ (id)tvGridStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x001000000082a1e9
+ (id)tvLinearStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000829e1e
+ (id)disambiguationStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000829dec
+ (id)styleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000829dba
+ (id)darkKeyboardStyleForDisambiguation;	// IMP=0x0010000000829b3b
+ (id)lightKeyboardStyleForDisambiguation;	// IMP=0x001000000082990a
+ (id)darkKeyboardStyle;	// IMP=0x00100000008294d6
+ (id)lightKeyboardStyle;	// IMP=0x00100000008290a2
- (void).cxx_destruct;	// IMP=0x000000000082af25
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008288af
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008284b2
