...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000009c867c
- (void).cxx_destruct;	// IMP=0x00000000009c89f4
...
- (id)description;	// IMP=0x00000000009c8921
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009c8844
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009c8732
- (id)initWithInterpretations:(id)arg1 isLowConfidence:(_Bool)arg2;	// IMP=0x00000000009c870e
- (id)initWithInterpretations:(id)arg1;	// IMP=0x00000000009c8684
