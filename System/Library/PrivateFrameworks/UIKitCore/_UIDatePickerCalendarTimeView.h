...
- (void).cxx_destruct;	// IMP=0x0000000000512b38
...
- (id)createDatePickerForCompactTimeLabel:(id)arg1;	// IMP=0x0000000000512a15
- (_Bool)compactTimeLabel:(id)arg1 shouldDismissForInteractionAtLocation:(struct CGPoint)arg2;	// IMP=0x0000000000512a0d
- (void)compactTimeLabelDidEndEditing:(id)arg1;	// IMP=0x00000000005129c1
- (void)compactTimeLabelDidBeginEditing:(id)arg1;	// IMP=0x0000000000512975
- (void)compactTimeLabelWillBecomeFirstResponder:(id)arg1;	// IMP=0x0000000000512929
- (void)compactTimeLabel:(id)arg1 didSelectTime:(id)arg2;	// IMP=0x0000000000512886
- (void)_updateFonts;	// IMP=0x000000000051251b
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000512428
- (void)setSelectedDate:(id)arg1;	// IMP=0x0000000000512271
- (void)_updateTextFieldsFromSelectedDateComponents;	// IMP=0x00000000005121e4
- (void)reloadWithCalendar:(id)arg1 locale:(id)arg2 selectedDate:(id)arg3;	// IMP=0x0000000000512024
- (void)_reload;	// IMP=0x0000000000511fa2
- (void)_reloadDateFormatters;	// IMP=0x0000000000511ee7
- (void)tintColorDidChange;	// IMP=0x0000000000511d5c
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000511c6f
- (id)primaryFirstResponder;	// IMP=0x0000000000511c5d
- (void)_updateClockLayout;	// IMP=0x00000000005116e1
- (void)_setupViewHierarchy;	// IMP=0x0000000000510f95
- (void)willMoveToSuperview:(id)arg1;	// IMP=0x0000000000510f08
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000000510e7b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000510d2f
