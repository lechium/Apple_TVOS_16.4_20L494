...
+ (void)setupRelationsBetweenDisplayItemStates:(id)arg1 visualProvider:(id)arg2;	// IMP=0x0010000000db9d16
+ (id)stateForDisplayItemWithIdentifier:(id)arg1 statusBar:(id)arg2;	// IMP=0x0010000000db9567
- (void).cxx_destruct;	// IMP=0x0000000000dbd426
...
- (id)description;	// IMP=0x0000000000dbcf86
@property(readonly, nonatomic) long long priority;
@property(readonly, copy, nonatomic) NSArray *potentialPlacementRegionIdentifiers;
- (_Bool)isCurrentPlacement:(id)arg1;	// IMP=0x0000000000dbcbf0
- (_Bool)prepareAnimation:(id)arg1;	// IMP=0x0000000000dbc6ad
- (id)_animationWithUpdateAnimation:(id)arg1;	// IMP=0x0000000000dbc41d
- (void)_cancelObsoleteAnimations;	// IMP=0x0000000000dbc226
@property(readonly, nonatomic, getter=_animationType) long long animationType;
- (id)_effectiveStyleAttributesFromStyleAttributes:(id)arg1 data:(id)arg2 styleAttributesChanged:(_Bool *)arg3;	// IMP=0x0000000000dbbcfe
- (id)_updateForUpdatedData:(id)arg1 updatedStyleAttributes:(id)arg2 updatedEnability:(id)arg3;	// IMP=0x0000000000dbbae0
- (id)_updateForItem:(id)arg1 data:(id)arg2 styleAttributes:(id)arg3;	// IMP=0x0000000000dbb826
- (id)updateWithData:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x0000000000dbb126
- (_Bool)updatePlacement;	// IMP=0x0000000000dbb049
- (void)resetToPreferredPlacement;	// IMP=0x0000000000dbb033
- (_Bool)_updatePlacementWithRecursionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000dbaea9
- (_Bool)_resolveDependentItemStatesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000dbac07
- (void)_updateStatuses;	// IMP=0x0000000000dbab28
- (void)prepareForDataUpdate;	// IMP=0x0000000000dbab11
- (void)prepareForOverflowDataUpdate;	// IMP=0x0000000000dbaafb
- (id)placementStateForPlacement:(id)arg1;	// IMP=0x0000000000db9b51
- (void)addPlacement:(id)arg1 inRegion:(id)arg2;	// IMP=0x0000000000db996d
- (_Bool)_updateToNextPlacementStateIfNeeded;	// IMP=0x0000000000db98e0
- (void)updateToNextEnabledPlacement;	// IMP=0x0000000000db98a9
@property(readonly, nonatomic) _UIStatusBarDisplayItemPlacementState *currentPlacementState;
- (_Bool)hasRunningAnimations;	// IMP=0x0000000000db9825
