...
- (void).cxx_destruct;	// IMP=0x00000000007b7d30
...
- (id)imageWithConfiguration:(id)arg1;	// IMP=0x00000000007b7b2d
- (id)initWithData:(id)arg1;	// IMP=0x00000000007b79b2
- (id)initWithContentsOfFile:(id)arg1;	// IMP=0x00000000007b7893
