...
- (void).cxx_destruct;	// IMP=0x00000000006f9a6e
@property(readonly, nonatomic) NSDictionary *subfeatures; // @synthesize subfeatures=_subfeatures;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000006f997d
- (id)debugDictionary;	// IMP=0x00000000006f9826
- (void)featureDidChangeState:(id)arg1;	// IMP=0x00000000006f9769
- (id)initWithSettings:(id)arg1 createFeatureBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000006f96b6
