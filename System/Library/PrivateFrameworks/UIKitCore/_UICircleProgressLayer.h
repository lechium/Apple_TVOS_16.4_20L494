...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x0060000000512ee8
- (void).cxx_destruct;	// IMP=0x0000000000513248
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000512f5a
- (id)initWithLayer:(id)arg1;	// IMP=0x0000000000512d18
- (id)init;	// IMP=0x0000000000512bde
