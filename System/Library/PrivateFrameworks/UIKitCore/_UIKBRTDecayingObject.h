...
- (void).cxx_destruct;	// IMP=0x0000000000b13c3a
...
- (void)onResetDo:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b13b35
- (void)resetActiveDecayTo:(double)arg1;	// IMP=0x0000000000b13b15
- (void)startOrUpdateDecay;	// IMP=0x0000000000b13ae9
- (void)updateDecay;	// IMP=0x0000000000b13aa4
- (void)reset;	// IMP=0x0000000000b13a6e
- (void)resetDecayTo:(double)arg1;	// IMP=0x0000000000b13a17
@property(readonly, nonatomic) _Bool isActive;
- (void)startDecaying;	// IMP=0x0000000000b139d4
- (id)initWithTimeoutDuration:(double)arg1;	// IMP=0x0000000000b13991
