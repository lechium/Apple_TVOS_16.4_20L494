...
+ (id)accessoryWithIdentifier:(id)arg1;	// IMP=0x0060000000e3afc1
- (void).cxx_destruct;	// IMP=0x0000000000e3b208
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000e3b1b0
- (id)description;	// IMP=0x0000000000e3b0e5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e3b013
- (id)init;	// IMP=0x0000000000e3af85
