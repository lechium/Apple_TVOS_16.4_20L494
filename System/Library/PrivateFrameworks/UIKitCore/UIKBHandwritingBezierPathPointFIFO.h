...
- (void).cxx_destruct;	// IMP=0x00000000008cf411
...
- (void)clear;	// IMP=0x00000000008cf302
- (void)flush;	// IMP=0x00000000008cf0f8
- (void)addPoint:(struct)arg1;	// IMP=0x00000000008cea08
- (id)initWithFIFO:(id)arg1;	// IMP=0x00000000008ce94e
