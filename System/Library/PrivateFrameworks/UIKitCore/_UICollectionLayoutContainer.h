...
- (void).cxx_destruct;	// IMP=0x000000000026fc31
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000026faf6
...
- (id)initWithContentSize:(struct CGSize)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2 insetsEnvironment:(id)arg3;	// IMP=0x000000000026f8e3
- (id)initWithContentSize:(struct CGSize)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2;	// IMP=0x000000000026f84c
