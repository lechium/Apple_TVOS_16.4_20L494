...
- (void).cxx_destruct;	// IMP=0x0000000000f97595
...
- (_Bool)endEditing;	// IMP=0x0000000000f972e3
- (id)initWithTextStorage:(id)arg1 attributeNames:(id)arg2;	// IMP=0x0000000000f9723f
