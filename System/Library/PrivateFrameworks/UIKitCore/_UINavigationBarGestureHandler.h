...
- (void).cxx_destruct;	// IMP=0x000000000015318c
...
- (void)_handlePopSwipe:(id)arg1;	// IMP=0x000000000015301b
- (_Bool)_gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000152f6d
- (id)initWithNavigationBar:(id)arg1;	// IMP=0x0000000000152eab
