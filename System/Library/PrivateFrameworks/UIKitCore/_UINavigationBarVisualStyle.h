...
+ (id)visualStyleForIdiom:(long long)arg1;	// IMP=0x006000000016e96b
...
- (id)_legacyButtonFontForStyle:(long long)arg1;	// IMP=0x000000000016f032
...
- (id)defaultTitleColorForUserInterfaceStyle:(long long)arg1 barStyle:(long long)arg2;	// IMP=0x000000000016efd0
- (double)imageButtonMarginInNavigationBar:(id)arg1;	// IMP=0x000000000016efbb
- (double)textButtonMarginInNavigationBar:(id)arg1;	// IMP=0x000000000016efa6
- (long long)navigationBar:(id)arg1 metricsForOrientation:(long long)arg2 hasPrompt:(_Bool)arg3;	// IMP=0x000000000016ef7c
- (double)leftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x000000000016ee81
- (_Bool)shouldForceLegacyLeftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x000000000016ee75
- (id)buttonFontForStyle:(long long)arg1;	// IMP=0x000000000016ee17
...
- (double)leftBackTitleMarginLetterpressPadding;	// IMP=0x000000000016eca4
...
- (double)barHeightForMetrics:(long long)arg1;	// IMP=0x000000000016ebec
...
- (double)backButtonAnimationClippingPadding;	// IMP=0x000000000016ebb9
...
- (id)timingFunctionForAnimationInView:(id)arg1 withKeyPath:(id)arg2 isInteractive:(_Bool)arg3;	// IMP=0x000000000016ea3e
- (id)initWithIdiom:(long long)arg1;	// IMP=0x000000000016ea01
