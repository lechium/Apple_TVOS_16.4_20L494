...
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2 desiredUnits:(long long)arg3;	// IMP=0x0060000000c05b28
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2;	// IMP=0x0060000000c05b0c
- (void).cxx_destruct;	// IMP=0x0000000000c06500
...
- (id)description;	// IMP=0x0000000000c0628f
- (id)_initWithFormatString:(id)arg1 calendarUnit:(unsigned long long)arg2;	// IMP=0x0000000000c061f2
