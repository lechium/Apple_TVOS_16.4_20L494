...
+ (id)mainBundleInfoParser;	// IMP=0x0060000000697da6
- (void).cxx_destruct;	// IMP=0x0000000000698dc5
...
- (_Bool)_isLinkedOnOrAfterYukon;	// IMP=0x0000000000698c9a
- (void)_computeSupportedUserInterfaceStyleFromInfo:(id)arg1;	// IMP=0x0000000000698bcd
- (void)_computeSupportedInterfaceOrientationsWithInfo:(id)arg1;	// IMP=0x00000000006988f8
- (_Bool)_shouldUseHiResForClassic;	// IMP=0x00000000006988f0
- (id)_initWithApplicationPlistData:(id)arg1;	// IMP=0x000000000069811a
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x0000000000697ea2
- (id)_initWithBundle:(id)arg1;	// IMP=0x0000000000697e4c
