...
- (void).cxx_destruct;	// IMP=0x0000000000bdfb76
...
- (double)_touchForceFromTouches:(id)arg1;	// IMP=0x0000000000bdf96a
@property(readonly, nonatomic, getter=isDeepPressLikely) _Bool deepPressLikely;
- (void)analyzeTouchForce:(double)arg1 centroidAtLocation:(struct CGPoint)arg2;	// IMP=0x0000000000bdf7e4
- (void)analyzeTouches:(id)arg1;	// IMP=0x0000000000bdf760
- (id)init;	// IMP=0x0000000000bdf6ae
