...
- (void).cxx_destruct;	// IMP=0x00000000000e484e
...
- (id)description;	// IMP=0x00000000000e46e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e463d
- (id)initWithHost:(id)arg1;	// IMP=0x00000000000e4600
