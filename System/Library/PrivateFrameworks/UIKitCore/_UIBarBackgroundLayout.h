...
- (void).cxx_destruct;	// IMP=0x00000000006fff25
...
- (id)description;	// IMP=0x00000000006ffde7
- (void)describeInto:(id)arg1;	// IMP=0x00000000006ffd18
...
- (_Bool)bg2HasHeight;	// IMP=0x00000000006ffcaf
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006ffb9b
- (id)initWithLayout:(id)arg1;	// IMP=0x00000000006ffad8
- (id)init;	// IMP=0x00000000006ffac4
