...
+ (long long)typicalBarPosition;	// IMP=0x00600000001369db
- (void).cxx_destruct;	// IMP=0x0000000000136e65
...
- (id)representativeImageForIdiom:(long long)arg1;	// IMP=0x0000000000136c94
...
- (double)titleVerticalAdjustmentForBarMetrics:(long long)arg1;	// IMP=0x0000000000136b59
- (void)setTitleVerticalAdjustment:(double)arg1 forBarMetrics:(long long)arg2;	// IMP=0x0000000000136a47
