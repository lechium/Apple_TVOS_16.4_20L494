...
- (void).cxx_destruct;	// IMP=0x0000000000060603
...
- (void)interactionProgress:(id)arg1 didEnd:(_Bool)arg2;	// IMP=0x0000000000060597
- (void)interactionProgressDidUpdate:(id)arg1;	// IMP=0x000000000006054e
- (void)startInteractiveTransition:(id)arg1;	// IMP=0x00000000000603da
