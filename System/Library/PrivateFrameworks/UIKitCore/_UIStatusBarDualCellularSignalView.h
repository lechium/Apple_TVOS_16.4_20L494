...
+ (double)_interspaceForIconSize:(long long)arg1;	// IMP=0x0010000000d6de0c
- (void).cxx_destruct;	// IMP=0x0000000000d6e9a1
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000d6e4c5
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000d6e383
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000d6e358
- (void)_iconSizeDidChange;	// IMP=0x0000000000d6e20c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000d6e1c5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d6e16d
- (void)_commonInit;	// IMP=0x0000000000d6de2c
