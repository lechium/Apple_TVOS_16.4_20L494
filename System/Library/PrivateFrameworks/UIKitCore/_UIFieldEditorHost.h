...
+ (id)fieldEditorHostForTextField:(id)arg1;	// IMP=0x00600000000acc45
- (void).cxx_destruct;	// IMP=0x00000000000acfc4
...
- (id)description;	// IMP=0x00000000000acf81
- (void)layoutIfNeeded;	// IMP=0x00000000000acf7b
- (void)addPlaceholderLabel:(id)arg1;	// IMP=0x00000000000aced8
- (void)removeFieldEditor;	// IMP=0x00000000000acea6
- (id)_viewForHostingFieldEditor;	// IMP=0x00000000000ace63
- (void)addFieldEditor:(id)arg1;	// IMP=0x00000000000acd45
@property(readonly, nonatomic, getter=isHostingFieldEditor) _Bool hostingFieldEditor;
- (id)initWithHostingView:(id)arg1;	// IMP=0x00000000000accd3
