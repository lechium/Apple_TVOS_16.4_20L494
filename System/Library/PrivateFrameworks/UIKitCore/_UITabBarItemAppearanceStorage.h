...
- (void).cxx_destruct;	// IMP=0x000000000020310c
...
- (void)enumerateBadgeTextAttributesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000202fcf
- (id)badgeTextAttributesForState:(unsigned long long)arg1;	// IMP=0x0000000000202f48
- (void)setBadgeTextAttributes:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x0000000000202dc5
