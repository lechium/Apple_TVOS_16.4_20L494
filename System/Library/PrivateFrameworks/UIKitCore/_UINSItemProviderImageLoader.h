...
- (void).cxx_destruct;	// IMP=0x000000000059c89d
@property(retain, setter=_setProgress:) NSProgress *_progress; // @synthesize _progress=__progress;
- (_Bool)_really_cancel;	// IMP=0x000000000059c836
- (void)_really_loadImage:(CDUnknownBlockType)arg1;	// IMP=0x000000000059c6ac
- (id)initWithItemProvider:(id)arg1 typeIdentifier:(id)arg2;	// IMP=0x000000000059c5c8
