...
- (void).cxx_destruct;	// IMP=0x0000000000fb98cf
...
- (_Bool)supportsCoalescing;	// IMP=0x0000000000fb9884
- (void)undoRedo;	// IMP=0x0000000000fb987e
- (id)initWithAffectedRange:(struct _NSRange)arg1 inputController:(id)arg2;	// IMP=0x0000000000fb97f1
