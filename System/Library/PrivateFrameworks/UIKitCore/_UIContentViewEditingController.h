...
- (void).cxx_destruct;	// IMP=0x00000000007f0947
...
- (_Bool)passthroughScrollInteractionDidRecognize:(id)arg1;	// IMP=0x00000000007f08e2
- (_Bool)passthroughScrollInteraction:(id)arg1 shouldInteractAtLocation:(struct CGPoint)arg2 withEvent:(id)arg3;	// IMP=0x00000000007f08c6
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x00000000007f074d
- (_Bool)textFieldShouldEndEditing:(id)arg1;	// IMP=0x00000000007f05fe
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x00000000007f05e6
- (void)textFieldDidBeginEditing:(id)arg1;	// IMP=0x00000000007f050c
- (_Bool)textFieldShouldBeginEditing:(id)arg1;	// IMP=0x00000000007f04c5
- (_Bool)textField:(id)arg1 shouldChangeCharactersInRange:(struct _NSRange)arg2 replacementString:(id)arg3;	// IMP=0x00000000007f032a
@property(readonly, nonatomic, getter=isDisplayingEditedText) _Bool displayingEditedText;
- (_Bool)makeTextInputFirstResponderWithInitialLayoutBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000007f01d5
- (void)longPressRecognizerChanged:(id)arg1;	// IMP=0x00000000007f0124
- (void)dealloc;	// IMP=0x00000000007f00ee
- (void)updateLabelConfiguration:(id)arg1 editingConfiguration:(id)arg2;	// IMP=0x00000000007efb88
@property(readonly, copy) NSString *description;
- (id)initWithContentView:(id)arg1 editableLabel:(id)arg2;	// IMP=0x00000000007ef983
