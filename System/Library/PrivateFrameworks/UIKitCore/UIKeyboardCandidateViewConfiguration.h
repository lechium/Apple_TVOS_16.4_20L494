...
+ (id)configuration;	// IMP=0x0060000000822aac
+ (id)languagesWithReducedFontSize;	// IMP=0x0060000000822a5c
...
- (_Bool)usesReducedFontSize;	// IMP=0x0000000000822f69
- (double)candidateDefaultFontSize;	// IMP=0x0000000000822f5b
- (id)candidateFontWithSize:(double)arg1 language:(id)arg2;	// IMP=0x0000000000822df0
- (id)candidateFontWithSize:(double)arg1;	// IMP=0x0000000000822d33
...
- (id)extendedScrolledState;	// IMP=0x0000000000822d08
- (id)extendedState;	// IMP=0x0000000000822d00
- (id)initialState;	// IMP=0x0000000000822abe
