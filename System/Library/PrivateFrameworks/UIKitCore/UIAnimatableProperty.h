...
- (void).cxx_destruct;	// IMP=0x00000000010d1d97
...
- (id)debugDescription;	// IMP=0x00000000010d1ba9
- (id)transformer;	// IMP=0x00000000010d1b94
- (void)setTransformer:(id)arg1;	// IMP=0x00000000010d1b80
- (void)invalidateAndStopImmediately:(_Bool)arg1;	// IMP=0x00000000010d1a10
- (void)invalidate;	// IMP=0x00000000010d19f9
- (_Bool)_performAnimationFromCurrentValue:(id)arg1;	// IMP=0x00000000010d1770
- (id)velocityTarget:(_Bool)arg1;	// IMP=0x00000000010d1429
@property(nonatomic) id velocity;
- (void)setVelocity:(id)arg1 target:(_Bool)arg2;	// IMP=0x00000000010d10e0
@property(retain, nonatomic) UIViewRunningAnimationEntry *animationEntry;
- (void)invalidateIfPossible;	// IMP=0x00000000010d0eaa
- (id)initWithInvalidationCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000010d0df2
- (_Bool)animatePropertyWithCurrentValue:(id)arg1 targetValue:(id)arg2 preTickShouldRemoveCallback:(CDUnknownBlockType)arg3 newValueCallback:(CDUnknownBlockType)arg4 removedCallback:(CDUnknownBlockType)arg5;	// IMP=0x00000000010d0d0f
