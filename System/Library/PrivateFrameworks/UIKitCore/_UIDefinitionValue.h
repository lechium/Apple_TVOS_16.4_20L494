...
- (void).cxx_destruct;	// IMP=0x000000000044db4b
...
- (id)description;	// IMP=0x000000000044da60
- (id)initWithLocalizedDictionaryName:(id)arg1 term:(id)arg2 definition:(id)arg3 longDefinition:(id)arg4;	// IMP=0x000000000044d953
