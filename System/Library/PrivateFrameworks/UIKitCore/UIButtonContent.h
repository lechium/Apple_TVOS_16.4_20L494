...
- (void).cxx_destruct;	// IMP=0x000000000051e4d3
...
- (_Bool)updateVariableLengthStringForView:(id)arg1;	// IMP=0x000000000051e371
- (id)description;	// IMP=0x000000000051e2d6
@property(retain, nonatomic) _UIGraphicsLetterpressStyle *letterpressStyle;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000051e11f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000051dec2
