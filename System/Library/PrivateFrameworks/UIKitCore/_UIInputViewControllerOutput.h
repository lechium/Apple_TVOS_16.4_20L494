...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000008823e6
- (void).cxx_destruct;	// IMP=0x0000000000883788
...
- (id)description;	// IMP=0x00000000008832a6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000882dbd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000882b68
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000008828ab
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008827a4
- (void)setInputModeList:(long long)arg1 touchBegan:(double)arg2 fromLocation:(struct CGPoint)arg3 updatePoint:(struct CGPoint)arg4;	// IMP=0x0000000000882781
- (void)adjustTextPositionByCharacterOffset:(long long)arg1;	// IMP=0x000000000088268e
- (void)deleteBackward;	// IMP=0x00000000008825d3
- (void)insertText:(id)arg1;	// IMP=0x0000000000882561
- (id)_currentKeyboardOutput;	// IMP=0x00000000008824b8
- (void)_pushNewKeyboardOutput;	// IMP=0x00000000008823ee
