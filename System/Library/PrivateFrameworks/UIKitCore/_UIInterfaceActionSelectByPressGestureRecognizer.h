...
- (void).cxx_destruct;	// IMP=0x0000000000045e07
...
- (void)_gestureChanged:(id)arg1;	// IMP=0x0000000000045cba
- (void)reset;	// IMP=0x0000000000045c77
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000045b72
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000045adb
- (id)initWithFocusedInterfaceActionPressDelegate:(id)arg1;	// IMP=0x0000000000045a37
