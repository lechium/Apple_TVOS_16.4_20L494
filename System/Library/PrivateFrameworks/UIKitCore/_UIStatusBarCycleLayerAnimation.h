...
+ (id)cycleAnimationWithLayer:(id)arg1 animation:(id)arg2 key:(id)arg3;	// IMP=0x0060000000dac677
- (void).cxx_destruct;	// IMP=0x0000000000dac995
...
- (id)description;	// IMP=0x0000000000dac834
