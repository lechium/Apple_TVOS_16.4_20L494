...
+ (id)_withDisabledAppearanceTransitions:(_Bool)arg1 forVisibleDescendantsOf:(id)arg2 perform:(CDUnknownBlockType)arg3;	// IMP=0x001000000046dc59
- (void).cxx_destruct;	// IMP=0x000000000047c8b8
...
- (void)_adjustNonOverlayLeadingScrollViewsForKeyboardInfo:(id)arg1;	// IMP=0x000000000047c370
- (void)_adjustForKeyboardInfo:(id)arg1;	// IMP=0x000000000047bd40
- (void)_stopObservingKeyboardNotifications;	// IMP=0x000000000047bc99
- (void)_observeKeyboardNotificationsOnScreen:(id)arg1;	// IMP=0x000000000047bbb1
...
- (void)animateToRequest:(id)arg1 forceOverlay:(_Bool)arg2 withVelocity:(double)arg3;	// IMP=0x000000000047b793
- (void)animateToRequest:(id)arg1 forceOverlay:(_Bool)arg2;	// IMP=0x000000000047b77e
- (void)animateToRequest:(id)arg1;	// IMP=0x000000000047b76a
- (_Bool)isSupplementaryViewControllerVisibleAfterAnimation;	// IMP=0x000000000047b6cc
- (_Bool)isTrailingViewControllerVisibleAfterAnimation;	// IMP=0x000000000047b62e
- (_Bool)isLeadingViewControllerVisibleAfterAnimation;	// IMP=0x000000000047b590
@property(readonly, nonatomic) id <UIViewControllerTransitionCoordinator> transitionCoordinator;
- (void)_animateFromRequest:(id)arg1 toRequest:(id)arg2 withAffectedSides:(long long)arg3 forceOverlay:(_Bool)arg4 velocity:(double)arg5;	// IMP=0x000000000047a357
- (struct CGSize)_expectedSecondaryColumnSizeAfterAnimatingToState:(id)arg1 getLeadingColumnSize:(struct CGSize *)arg2 trailingColumnSize:(struct CGSize *)arg3 supplementaryColumnSize:(struct CGSize *)arg4;	// IMP=0x0000000000479c54
- (void)stopAnimations;	// IMP=0x0000000000479c3d
- (void)_stopAnimationsBeginningInteraction:(_Bool)arg1;	// IMP=0x000000000047962e
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000004795af
- (void)_updateBorderViewsBackgroundColor:(id)arg1;	// IMP=0x000000000047945b
- (void)_setBorderViewsObserveViewBackgroundColor:(_Bool)arg1;	// IMP=0x00000000004793eb
- (id)_createOverlayEdgeShadowViewForEdge:(unsigned long long)arg1;	// IMP=0x00000000004793ad
- (id)_createBorderView;	// IMP=0x0000000000479365
- (double)interpolatedMarginForPrimaryNavigationBar:(id)arg1 supplementaryOrSecondaryNavbar:(id)arg2 getInterpolatedAlpha:(double *)arg3;	// IMP=0x000000000047903c
- (void)_updateToNewPublicState:(id)arg1 withSize:(struct CGSize)arg2;	// IMP=0x0000000000471a74
- (void)_unspecifiedUpdateToNewPublicState:(id)arg1 withSize:(struct CGSize)arg2;	// IMP=0x000000000046f8d4
- (void)_performWrappedUpdate:(CDUnknownBlockType)arg1;	// IMP=0x000000000046f651
- (void)_performSingleDeferredUpdatePass;	// IMP=0x000000000046e88a
- (void)_performDeferredUpdate;	// IMP=0x000000000046e831
- (void)_setNeedsDeferredUpdate;	// IMP=0x000000000046e695
- (void)_setNeedsLayoutAndPerformImmediately:(_Bool)arg1;	// IMP=0x000000000046e654
- (void)__viewWillLayoutSubviews;	// IMP=0x000000000046e460
- (void)_layoutContainerViewDidMoveToWindow:(id)arg1;	// IMP=0x000000000046e45a
- (void)_layoutContainerViewWillMoveToWindow:(id)arg1;	// IMP=0x000000000046e2e3
- (void)_withDisabledAppearanceTransitionsPerform:(CDUnknownBlockType)arg1;	// IMP=0x000000000046d568
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2 superBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000046b6ab
- (void)traitCollectionDidChange:(id)arg1 toNewTraits:(id)arg2;	// IMP=0x000000000046b5f0
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2 superBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000046b3ef
- (void)_expandWithTransitionCoordinator:(id)arg1;	// IMP=0x000000000046a8f9
- (void)_collapseWithTransitionCoordinator:(id)arg1;	// IMP=0x0000000000469862
- (void)_updateForTraitCollection:(id)arg1 oldTraitCollection:(id)arg2 withTransitionCoordinator:(id)arg3;	// IMP=0x00000000004694ef
- (_Bool)_willExpandWithNewTraitCollection:(id)arg1 oldTraitCollection:(id)arg2;	// IMP=0x0000000000469414
- (_Bool)_willCollapseWithNewTraitCollection:(id)arg1 oldTraitCollection:(id)arg2;	// IMP=0x0000000000469327
- (id)gatherMultitaskingDragExclusionRectsFromVisibleColumns;	// IMP=0x0000000000468d3d
- (void)addWrapperBlockForNextUpdate:(CDUnknownBlockType)arg1;	// IMP=0x0000000000468cb1
@property(readonly, nonatomic, getter=isCollapsed) _Bool collapsed;
@property(readonly, nonatomic) long long collapsedState;
- (_Bool)isAnimating;	// IMP=0x0000000000468aa4
- (void)setNeedsUpdate;	// IMP=0x0000000000468a92
- (id)allViewControllers;	// IMP=0x00000000004688c4
- (void)navigationControllerDidChangeNavigationBarHidden:(id)arg1;	// IMP=0x00000000004688be
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x00000000004688ac
- (void)removeChildViewController:(id)arg1;	// IMP=0x00000000004685b3
- (void)_removeIdentifiedChildViewController:(id)arg1;	// IMP=0x00000000004684a5
- (void)_addIdentifiedChildViewController:(id)arg1;	// IMP=0x0000000000468191
- (void)loadView;	// IMP=0x0000000000467f3c
...
- (void)setSupplementaryViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x0000000000467894
@property(retain, nonatomic) UIViewController *supplementaryViewController;
- (void)setTrailingViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x000000000046773b
@property(retain, nonatomic) UIViewController *trailingViewController;
- (void)setLeadingViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x00000000004675e2
@property(retain, nonatomic) UIViewController *leadingViewController;
- (void)setMainViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x0000000000467489
...
- (void)dealloc;	// IMP=0x00000000004673a9
@property(readonly, nonatomic) _Bool supportsColumnStyle;
- (id)initWithOwningViewController:(id)arg1;	// IMP=0x000000000046729d
