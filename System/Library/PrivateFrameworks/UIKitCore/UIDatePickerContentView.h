...
- (void).cxx_destruct;	// IMP=0x0000000000c01f71
...
- (void)layoutSubviews;	// IMP=0x0000000000c01b4c
@property(nonatomic) _Bool useDigitFont;
@property(nonatomic) _Bool isAmPm;
- (_Bool)_canBeReusedInPickerView;	// IMP=0x0000000000c01a7e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000c018e2
- (id)initWithMode:(id)arg1;	// IMP=0x0000000000c01863
