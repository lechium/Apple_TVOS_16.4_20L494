...
- (void).cxx_destruct;	// IMP=0x000000000051dc8b
...
- (void)animateTransition:(id)arg1;	// IMP=0x000000000051d36e
- (double)transitionDuration:(id)arg1;	// IMP=0x000000000051d35c
- (void)dealloc;	// IMP=0x000000000051d31c
