...
- (void).cxx_destruct;	// IMP=0x0000000000b168c0
...
- (void)timerFired:(id)arg1;	// IMP=0x0000000000b164c9
- (void)invalidate;	// IMP=0x0000000000b16428
- (void)fireNow;	// IMP=0x0000000000b16339
- (void)dealloc;	// IMP=0x0000000000b162fb
- (id)initWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3 owner:(id)arg4;	// IMP=0x0000000000b16190
