...
- (void).cxx_destruct;	// IMP=0x00000000001c606b
...
- (void)setLayoutCustomizationDelegateSearchFieldContainerWillLayoutSubviewsCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c5d1c
- (void)setDelegateSearchFieldFrameManipulationBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c5cc2
@property(readonly, copy) NSString *description;
- (void)cleanUpLayout;	// IMP=0x00000000001c4e26
- (void)applyScopeContainerSublayout;	// IMP=0x00000000001c4dc4
- (void)applyLayout;	// IMP=0x00000000001c44a5
- (void)ensureCorrectContainerViewOrdering;	// IMP=0x00000000001c4406
- (double)minimumLayoutWidth;	// IMP=0x00000000001c43ce
- (void)updateLayout;	// IMP=0x00000000001c3fc4
- (double)layout:(id)arg1 fontScaledValueForValue:(double)arg2;	// IMP=0x00000000001c3f11
- (void)containerLayoutWillUpdateLayout:(id)arg1;	// IMP=0x00000000001c3ea8
- (void)prepareSublayouts;	// IMP=0x00000000001c3e7a
- (void)prepareScopeContainerLayout;	// IMP=0x00000000001c3d45
- (void)prepareSearchContainerLayout;	// IMP=0x00000000001c3a9a
- (void)prepareBaseConfigurationForSublayout:(id)arg1;	// IMP=0x00000000001c3a0e
- (void)setUpSearchContainerLayout;	// IMP=0x00000000001c398f
- (void)setUpScopeContainerLayout;	// IMP=0x00000000001c3910
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c2aed
