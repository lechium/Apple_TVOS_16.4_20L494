...
+ (id)_darkStyleGlyphColor;	// IMP=0x0060000000a394ae
+ (id)_standardGlyphColor;	// IMP=0x0060000000a39475
- (void).cxx_destruct;	// IMP=0x0000000000a39c40
...
- (id)imageWithRenderConfig:(id)arg1;	// IMP=0x0000000000a398b7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a3959d
- (id)initWithImageName:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000a394c7
