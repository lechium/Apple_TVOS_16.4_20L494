...
+ (id)graphCacheForScreen:(id)arg1;	// IMP=0x0010000000950934
- (void).cxx_destruct;	// IMP=0x00000000009509ae
@property(readonly, nonatomic) NSMutableDictionary *graphCache; // @synthesize graphCache=_graphCache;
@property(readonly) NSDictionary *_options;
- (_Bool)_matchingOptions:(id)arg1;	// IMP=0x0000000000950924
@property(readonly) UIScreen *_intendedScreen;
- (id)_initWithScreen:(id)arg1 options:(id)arg2;	// IMP=0x000000000095087c
