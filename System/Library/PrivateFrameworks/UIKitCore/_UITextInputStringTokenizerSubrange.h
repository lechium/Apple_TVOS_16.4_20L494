...
+ (id)subrangeWithSubstring:(id)arg1 basePosition:(id)arg2;	// IMP=0x0060000000b80676
- (void).cxx_destruct;	// IMP=0x0000000000b80783
...
- (id)description;	// IMP=0x0000000000b806fe
