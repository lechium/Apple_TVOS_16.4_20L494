...
+ (id)itemMoveFromIndexIndexPath:(id)arg1 toIndexPath:(id)arg2 fromIndex:(long long)arg3 toIndex:(long long)arg4;	// IMP=0x006000000038f7cc
+ (id)itemMoveSection:(long long)arg1 toSection:(long long)arg2 fromRange:(struct _NSRange)arg3 toRange:(struct _NSRange)arg4;	// IMP=0x006000000038f718
+ (id)itemDeleteItemAtIndexPath:(id)arg1 index:(long long)arg2;	// IMP=0x006000000038f65c
+ (id)itemDeleteSection:(long long)arg1 deleteRange:(struct _NSRange)arg2;	// IMP=0x006000000038f5d2
+ (id)itemInsertItemAtIndexPath:(id)arg1 index:(long long)arg2;	// IMP=0x006000000038f516
+ (id)itemInsertSection:(long long)arg1 insertRange:(struct _NSRange)arg2;	// IMP=0x006000000038f48c
- (void).cxx_destruct;	// IMP=0x000000000038fe9c
...
- (id)reverseUpdateItem;	// IMP=0x000000000038fa53
- (id)description;	// IMP=0x000000000038f8e8
