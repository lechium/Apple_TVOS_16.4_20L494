...
- (void).cxx_destruct;	// IMP=0x00000000010eb4ba
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x00000000010eb292
- (void)animationDidStart:(id)arg1;	// IMP=0x00000000010eafb7
- (id)initWithLabel:(id)arg1;	// IMP=0x00000000010eaf53
