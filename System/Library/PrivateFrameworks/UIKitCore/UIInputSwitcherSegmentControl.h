...
- (void).cxx_destruct;	// IMP=0x0000000000865a20
...
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000008658f2
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000086583c
- (_Bool)shouldTrack;	// IMP=0x0000000000865834
@property(readonly, nonatomic) unsigned long long numberOfSegments;
- (void)updateSelectionWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000865719
- (void)_populateSegmentViewsWithCount:(unsigned long long)arg1;	// IMP=0x0000000000865159
- (void)_removeAllSegmentViews;	// IMP=0x0000000000864f8e
- (void)layoutSubviews;	// IMP=0x0000000000864f19
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000864c69
