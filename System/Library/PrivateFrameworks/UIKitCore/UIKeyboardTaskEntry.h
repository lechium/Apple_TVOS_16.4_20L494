...
- (void).cxx_destruct;	// IMP=0x0000000000abb9dd
@property(readonly, retain, nonatomic) NSArray *originatingStack; // @synthesize originatingStack=__creationStack;
- (void)execute:(id)arg1;	// IMP=0x0000000000abb9c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000abb981
- (id)initWithTask:(CDUnknownBlockType)arg1;	// IMP=0x0000000000abb8be
