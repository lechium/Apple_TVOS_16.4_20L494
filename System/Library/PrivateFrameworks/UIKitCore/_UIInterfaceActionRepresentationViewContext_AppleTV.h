...
- (void).cxx_destruct;	// IMP=0x000000000002e508
...
- (id)_newMotionEffectsGroupForHighlightedAction;	// IMP=0x000000000002e2de
- (void)_removeMotionEffects;	// IMP=0x000000000002e1e9
- (void)_insertMotionEffects;	// IMP=0x000000000002e0e4
- (struct CATransform3D)_enlargedTransformForSize:(struct CGSize)arg1 pressed:(_Bool)arg2;	// IMP=0x000000000002e016
- (void)_applyHighlightTransform;	// IMP=0x000000000002dbe1
- (id)initWithHighlightTransformTargetView:(id)arg1;	// IMP=0x000000000002db45
