...
+ (id)sharedInstance;	// IMP=0x001000000064c49b
- (void).cxx_destruct;	// IMP=0x000000000064cdb5
...
- (void)_playSystemSound:(unsigned int)arg1 withVolume:(double)arg2 pan:(double)arg3;	// IMP=0x000000000064c7f7
- (void)playSoundWithFocusSound:(long long)arg1 volume:(double)arg2 pan:(double)arg3;	// IMP=0x000000000064c709
- (void)playSoundWithURL:(id)arg1 volume:(double)arg2 pan:(double)arg3;	// IMP=0x000000000064c59d
- (void)dealloc;	// IMP=0x000000000064c500
- (void)_registerForSystemSoundsIfNecessary;	// IMP=0x000000000064c2a7
- (id)_init;	// IMP=0x000000000064c0d8
