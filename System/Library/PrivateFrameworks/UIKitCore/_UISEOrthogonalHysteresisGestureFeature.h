...
- (void).cxx_destruct;	// IMP=0x00000000006f9deb
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000006f9b45
- (id)initWithSettings:(id)arg1 touchedEdgesProvider:(id)arg2;	// IMP=0x00000000006f9ab0
