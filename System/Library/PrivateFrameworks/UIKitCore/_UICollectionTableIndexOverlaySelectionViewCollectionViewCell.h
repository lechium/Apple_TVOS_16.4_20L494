...
- (void).cxx_destruct;	// IMP=0x0000000000e5daaf
@property(readonly) UIButton *button; // @synthesize button=_button;
@property(readonly) UILabel *label;
@property(nonatomic) double rightMargin;
@property(nonatomic) long long textAlignment;
@property(copy, nonatomic) NSString *text;
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000000e5d8c9
- (void)layoutSubviews;	// IMP=0x0000000000e5d754
- (void)tintColorDidChange;	// IMP=0x0000000000e5d640
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000e5d4b9
