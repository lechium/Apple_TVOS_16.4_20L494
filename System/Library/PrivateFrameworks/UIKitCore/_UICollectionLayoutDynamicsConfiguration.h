...
- (void).cxx_destruct;	// IMP=0x0000000000274b33
...
- (id)_dirtyItems;	// IMP=0x0000000000274aae
- (void)_reset;	// IMP=0x0000000000274a3e
- (void)_setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x000000000027492d
@property(retain, nonatomic) NSArray *dynamicItems;
- (void)setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x0000000000274849
- (id)behaviorsForItem:(id)arg1;	// IMP=0x000000000027473b
- (id)init;	// IMP=0x00000000002746c6
