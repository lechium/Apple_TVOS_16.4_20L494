...
+ (id)traitsWithSymbolStyle:(id)arg1;	// IMP=0x001000000092d9f0
+ (id)traitsWithGeometry:(id)arg1;	// IMP=0x001000000092d985
+ (id)emptyTraits;	// IMP=0x001000000092d96c
- (void).cxx_destruct;	// IMP=0x000000000092f231
...
- (void)modifyForMasking;	// IMP=0x000000000092ee9c
- (void)overlayWithTraits:(id)arg1;	// IMP=0x000000000092e6e1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000092e3f4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000092e0ce
- (id)description;	// IMP=0x000000000092db74
- (void)removeAllRenderEffects;	// IMP=0x000000000092db39
- (void)addForegroundRenderEffect:(id)arg1;	// IMP=0x000000000092daca
- (void)addRenderEffect:(id)arg1;	// IMP=0x000000000092da5b
