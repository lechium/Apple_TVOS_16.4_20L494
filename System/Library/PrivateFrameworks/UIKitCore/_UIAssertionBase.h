...
- (void).cxx_destruct;	// IMP=0x00000000008398e4
...
- (void)dealloc;	// IMP=0x00000000008397c1
@property(readonly, copy) NSString *description;
- (void)_invalidate;	// IMP=0x0000000000839696
- (id)_initWithType:(unsigned long long)arg1 initialState:(_Bool)arg2 reason:(id)arg3 requiresExplicitInvalidation:(_Bool)arg4;	// IMP=0x0000000000839602
