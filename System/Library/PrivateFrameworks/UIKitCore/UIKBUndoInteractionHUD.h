...
- (void).cxx_destruct;	// IMP=0x0000000000b98292
...
- (void)updateControlWithDirection:(long long)arg1 travelProgress:(double)arg2 isRTL:(_Bool)arg3;	// IMP=0x0000000000b97fda
- (void)controlActionUpOutside:(id)arg1;	// IMP=0x0000000000b97f77
- (void)controlActionUpInside:(id)arg1 forEvent:(id)arg2;	// IMP=0x0000000000b97d65
- (void)controlActionDown:(id)arg1;	// IMP=0x0000000000b97cc7
- (void)performDelegateRedoAndUpdateHUDIfNeeded;	// IMP=0x0000000000b97c4c
- (void)performDelegateUndoAndUpdateHUDIfNeeded;	// IMP=0x0000000000b97bd1
- (void)updateHUDControlState;	// IMP=0x0000000000b978c5
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000000b97851
- (_Bool)availableOfControl:(id)arg1;	// IMP=0x0000000000b97754
- (id)controlForType:(long long)arg1;	// IMP=0x0000000000b975d1
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000b9755e
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000b97558
- (id)createSeparatorView;	// IMP=0x0000000000b9741d
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2 mode:(long long)arg3 sceneBounds:(struct CGRect)arg4;	// IMP=0x0000000000b94a2b
