...
+ (id)createTouchInfoForTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0060000000b153b7
+ (id)touchInfoForTouch:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0060000000b15310
+ (void)setTouchInfo:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0060000000b1526e
+ (id)touchDict;	// IMP=0x0060000000b151fc
- (void).cxx_destruct;	// IMP=0x0000000000b1614e
...
- (_Bool)willChangeTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000b15f32
- (id)setOfTouchesToIgnoreWhenSettingTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000b15a28
- (void)cleanup;	// IMP=0x0000000000b159b8
- (void)invalidateTimer;	// IMP=0x0000000000b15926
- (void)fireTimerNow;	// IMP=0x0000000000b15880
- (void)setTimerWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b1573f
- (void)updateTouch:(id)arg1;	// IMP=0x0000000000b1564f
@property(readonly, nonatomic) _UIKBRTTouchInfo *nextTouch;
@property(readonly, nonatomic) _UIKBRTTouchInfo *previousTouch;
- (void)dealloc;	// IMP=0x0000000000b155ed
- (id)initWithTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0000000000b15452
