...
+ (id)reuseIdentifier;	// IMP=0x00600000008639dd
...
- (void)_updateRoundedCorners;	// IMP=0x0000000000863d31
- (void)updateSelectionWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000863d2b
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000863c81
- (void)layoutSubviews;	// IMP=0x0000000000863a6e
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000008639e7
