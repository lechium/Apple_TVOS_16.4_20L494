...
- (void).cxx_destruct;	// IMP=0x0000000000b99ade
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000b999d8
- (void)updateUndoStateHUDControlType:(long long)arg1 available:(_Bool)arg2;	// IMP=0x0000000000b99841
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000b9836b
