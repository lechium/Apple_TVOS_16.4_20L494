...
+ (id)decodeFromCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x0060000000de6265
+ (id)standardLayoutData;	// IMP=0x0060000000de620d
- (void).cxx_destruct;	// IMP=0x0000000000de7199
...
- (long long)positioningForTraitCollection:(id)arg1;	// IMP=0x0000000000de710b
- (id)replicate;	// IMP=0x0000000000de6e63
- (_Bool)checkEqualTo:(id)arg1;	// IMP=0x0000000000de6cc6
- (long long)hashInto:(long long)arg1;	// IMP=0x0000000000de6c0f
- (void)describeInto:(id)arg1;	// IMP=0x0000000000de6a98
- (void)encodeToCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x0000000000de673b
