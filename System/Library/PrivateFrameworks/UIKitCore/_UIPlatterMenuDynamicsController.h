...
- (void).cxx_destruct;	// IMP=0x0000000000bd23c3
...
- (_Bool)_isPlatterInYLockedPosition;	// IMP=0x0000000000bd1fae
- (void)_updateSwipeEdgeMultipliersIfNeededForTouchPosition:(struct CGPoint)arg1;	// IMP=0x0000000000bd1d51
- (void)_positionSwipeActionViewsForCurrentPlatterViewPosition;	// IMP=0x0000000000bd1ab4
- (_Bool)isDefaultAnimatorBehavior:(id)arg1;	// IMP=0x0000000000bd18f1
- (void)addBehaviorIfNotPresent:(id)arg1;	// IMP=0x0000000000bd181e
- (void)resetAnimatorToDefaultBehaviors;	// IMP=0x0000000000bd1628
- (struct CGPoint)menuCenter;	// IMP=0x0000000000bd151e
- (struct CGPoint)platterCenter;	// IMP=0x0000000000bd1414
- (struct CGPoint)centerForCurrentPlatterPosition;	// IMP=0x0000000000bd130d
- (struct CGPoint)centerForMenuPresentedRelativeToCurrentPlatter;	// IMP=0x0000000000bd1118
- (struct CGVector)modifiedOffsetForPosition:(struct CGPoint)arg1 offset:(struct CGVector)arg2 touchPosition:(struct CGPoint)arg3 axisLock:(unsigned long long)arg4;	// IMP=0x0000000000bd0e26
- (void)beginTransitionWithAnimatorUsingBehaviors:(id)arg1 observedItems:(id)arg2 stateIfCompleted:(long long)arg3;	// IMP=0x0000000000bd0a88
- (void)performActionsAndEnterState:(long long)arg1 velocity:(struct CGVector)arg2 underDirectManipulation:(_Bool)arg3;	// IMP=0x0000000000bcfbd9
- (void)performActionsAndEnterState:(long long)arg1;	// IMP=0x0000000000bcfbbc
- (long long)_stateForPosition:(struct CGPoint)arg1 offset:(struct CGVector)arg2 velocity:(struct CGVector)arg3;	// IMP=0x0000000000bcf9b2
- (void)stopObservingBehavior;	// IMP=0x0000000000bcf958
- (void)_configureAnimator;	// IMP=0x0000000000bcef35
- (void)panningTransformer:(id)arg1 didEnterTransitionNotchForTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000bcef2f
- (void)panningTransformer:(id)arg1 didEndPanToTransformedPosition:(struct CGPoint)arg2 offsetFromPrevious:(struct CGVector)arg3 velocity:(struct CGVector)arg4;	// IMP=0x0000000000bcede8
- (void)panningTransformer:(id)arg1 didPanToTransformedPosition:(struct CGPoint)arg2 offsetFromPrevious:(struct CGVector)arg3 touchPosition:(struct CGPoint)arg4 velocity:(struct CGVector)arg5 didChangeAxis:(_Bool)arg6 axisLock:(unsigned long long)arg7;	// IMP=0x0000000000bcea0a
- (void)panningTransformer:(id)arg1 didBeginPanToTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000bce8f7
- (_Bool)hasBeenPresented;	// IMP=0x0000000000bce8de
- (void)_animateToPlatterDismissedWithDuration:(double)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000bce688
- (void)_animateToPlatterPresentedWithVelocity:(struct CGVector)arg1;	// IMP=0x0000000000bce612
- (void)_beginInYLockedStatePresented;	// IMP=0x0000000000bce5c0
- (void)lockIntoYAxis;	// IMP=0x0000000000bce583
- (_Bool)platterPanned;	// IMP=0x0000000000bce4a9
- (_Bool)isSelectingSwipeAction;	// IMP=0x0000000000bce3a7
- (_Bool)isMenuPresenting;	// IMP=0x0000000000bce38d
- (_Bool)isMenuPresented;	// IMP=0x0000000000bce373
- (void)resetAnimator;	// IMP=0x0000000000bce336
- (void)dealloc;	// IMP=0x0000000000bce2cb
- (void)toggleAnimatorDebugState;	// IMP=0x0000000000bce243
- (void)didEndPanningWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000bce19d
- (void)didPanWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000bce106
- (void)didBeginPanningWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000bce039
...
- (id)initWithContainerView:(id)arg1 platterView:(id)arg2 menuView:(id)arg3 delegate:(id)arg4;	// IMP=0x0000000000bcde90
