...
- (void).cxx_destruct;	// IMP=0x00000000009ef0b5
@property(readonly, nonatomic) NSIndexSet *invalidatedSections; // @synthesize invalidatedSections=_invalidatedSections;
- (double)preferredWidthForHeaderInSection:(long long)arg1;	// IMP=0x00000000009ef051
- (void)dealloc;	// IMP=0x00000000009ef00b
