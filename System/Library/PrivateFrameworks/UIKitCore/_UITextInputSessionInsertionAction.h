...
- (long long)inputActionCount;	// IMP=0x0000000000f29f70
- (id)description;	// IMP=0x0000000000f29e51
- (_Bool)changedContent;	// IMP=0x0000000000f29e49
- (long long)mergeActionIfPossible:(id)arg1;	// IMP=0x0000000000f29b3a
