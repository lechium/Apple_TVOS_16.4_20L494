...
- (void).cxx_destruct;	// IMP=0x0000000000fef30a
...
- (void)_checkNewCurrentValue;	// IMP=0x0000000000fef239
- (void)resetCurrentValue;	// IMP=0x0000000000fef1bf
- (void)increaseToValue:(double)arg1;	// IMP=0x0000000000fef14d
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000fef0a1
