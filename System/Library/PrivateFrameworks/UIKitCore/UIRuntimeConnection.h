...
- (void).cxx_destruct;	// IMP=0x00000000007fe9fd
...
- (void)connectForSimulator;	// IMP=0x00000000007fe9a8
- (void)connect;	// IMP=0x00000000007fe9a2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000007fe91f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007fe851
