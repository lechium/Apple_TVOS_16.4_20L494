...
+ (id)stateWithGeometry:(struct UIPeripheralAnimationGeometry)arg1 inPositionIsDestination:(_Bool)arg2;	// IMP=0x0060000000abcf09
- (void).cxx_destruct;	// IMP=0x0000000000abd0af
...
- (void)dealloc;	// IMP=0x0000000000abcfa8
