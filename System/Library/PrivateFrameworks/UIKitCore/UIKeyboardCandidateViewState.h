...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x0010000000828266
- (void).cxx_destruct;	// IMP=0x000000000082848a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008280d3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000827ff4
