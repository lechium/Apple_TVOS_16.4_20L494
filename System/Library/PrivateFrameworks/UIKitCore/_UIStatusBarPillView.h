...
- (void).cxx_destruct;	// IMP=0x00000000000b752e
...
- (id)viewForLastBaselineLayout;	// IMP=0x00000000000b7435
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x00000000000b72c2
- (void)_updateBackgroundColor;	// IMP=0x00000000000b720f
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000b71ce
- (_Bool)isUserInteractionEnabled;	// IMP=0x00000000000b7185
- (_Bool)canBecomeFocused;	// IMP=0x00000000000b713c
- (void)layoutSubviews;	// IMP=0x00000000000b6fac
- (void)resumePersistentAnimation;	// IMP=0x00000000000b6e3f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000b6c08
