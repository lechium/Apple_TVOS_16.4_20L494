...
- (void).cxx_destruct;	// IMP=0x0000000000e3d786
...
- (id)description;	// IMP=0x0000000000e3d61f
- (void)performWithEnforcedContainerSize:(struct CGSize)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000e3d5ec
- (struct CGRect)containerBounds;	// IMP=0x0000000000e3d5b6
@property(readonly, nonatomic) struct CGSize containerSize;
@property(readonly, nonatomic) struct CGRect contentFrame;
- (void)layoutIfNeeded;	// IMP=0x0000000000e3d3d0
- (void)setNeedsLayout;	// IMP=0x0000000000e3d39b
- (struct CGRect)_updateAccessories:(id)arg1 previousAccessories:(id)arg2 withLayout:(id)arg3 edge:(unsigned long long)arg4;	// IMP=0x0000000000e3c2a3
- (void)_updateFromPreviousConfiguration:(id)arg1;	// IMP=0x0000000000e3becb
@property(readonly, nonatomic) UICellAccessoryConfiguration *currentConfiguration;
- (id)_configurationWithIdentifier:(id)arg1;	// IMP=0x0000000000e3be7c
- (void)updateContainerView:(id)arg1;	// IMP=0x0000000000e3bcfb
- (id)initWithContainerView:(id)arg1;	// IMP=0x0000000000e3bc69
