...
- (void).cxx_destruct;	// IMP=0x000000000124eec4
...
- (struct CGRect)assistantFrameForKeyplane:(id)arg1 key:(id)arg2;	// IMP=0x000000000124edeb
- (id)candidateList;	// IMP=0x000000000124ed9b
