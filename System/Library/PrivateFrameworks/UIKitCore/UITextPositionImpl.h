...
+ (id)wrapWebVisiblePosition:(id)arg1;	// IMP=0x0060000000b7f055
- (void).cxx_destruct;	// IMP=0x0000000000b7f51b
@property(retain, nonatomic) WebVisiblePosition *webVisiblePosition; // @synthesize webVisiblePosition=_webVisiblePosition;
- (id)description;	// IMP=0x0000000000b7f13c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b7f0ab
