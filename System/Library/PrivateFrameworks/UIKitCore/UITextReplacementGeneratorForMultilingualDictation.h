...
- (void).cxx_destruct;	// IMP=0x0000000000f63f56
...
- (id)replacements;	// IMP=0x0000000000f63c6d
- (id)initWithMultilingualAlternatives:(id)arg1 stringToReplace:(id)arg2 replacementRange:(id)arg3;	// IMP=0x0000000000f63ba0
