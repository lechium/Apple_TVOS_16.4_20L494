...
- (void).cxx_destruct;	// IMP=0x00000000007ff016
...
- (_Bool)_shouldSuppressForDelegate:(id)arg1;	// IMP=0x00000000007fef37
- (id)_recognitionLocaleIdentifier;	// IMP=0x00000000007fef22
