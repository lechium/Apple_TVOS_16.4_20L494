...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000108dfa8
+ (id)descriptionForTransitionCoordinatorContext:(id)arg1;	// IMP=0x001000000108de2f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000108e182
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000108dfb0
