...
- (void).cxx_destruct;	// IMP=0x0000000000e3439f
- (id)reorderSeparatorView:(_Bool)arg1;	// IMP=0x0000000000e3429b
- (id)reorderControl:(_Bool)arg1;	// IMP=0x0000000000e341f7
- (id)editControl:(_Bool)arg1;	// IMP=0x0000000000e340dc
@property(readonly, nonatomic) _Bool wantsMaskingWhileAnimatingDisabled;
- (void)dealloc;	// IMP=0x0000000000e34029
- (id)initWithTableViewCell:(id)arg1 editingStyle:(long long)arg2;	// IMP=0x0000000000e33fba
