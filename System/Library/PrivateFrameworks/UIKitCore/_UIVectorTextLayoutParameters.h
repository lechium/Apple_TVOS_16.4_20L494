...
+ (id)parametersSuitableForView:(id)arg1;	// IMP=0x001000000110e3a6
- (void).cxx_destruct;	// IMP=0x000000000110e7af
...
- (_Bool)isEqualToParameters:(id)arg1;	// IMP=0x000000000110e5fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000110e5cc
- (void)_copyFromParameters:(id)arg1;	// IMP=0x000000000110e4d5
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000110e46d
