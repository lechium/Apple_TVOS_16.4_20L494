...
- (void).cxx_destruct;	// IMP=0x0000000000d4e853
...
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x0000000000d4e65d
- (id)viewForIdentifier:(id)arg1;	// IMP=0x0000000000d4e64b
- (void)_create_nameView;	// IMP=0x0000000000d4e5f1
- (id)dependentEntryKeys;	// IMP=0x0000000000d4e557
