...
- (id)description;	// IMP=0x00000000010ad522
- (unsigned long long)hash;	// IMP=0x00000000010ad4f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000010ad4a9
- (_Bool)isEqualToTargetInfo:(id)arg1;	// IMP=0x00000000010ad401
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000010ad3f6
- (id)initWithTargetSize:(struct CGSize)arg1 horizontalPriority:(float)arg2 verticalPriority:(float)arg3;	// IMP=0x00000000010ad386
