...
+ (id)overrideForResponder:(id)arg1 withTarget:(id)arg2 forType:(long long)arg3;	// IMP=0x0060000000cb3f04
- (void).cxx_destruct;	// IMP=0x0000000000cb435b
...
- (id)description;	// IMP=0x0000000000cb413f
- (void)dealloc;	// IMP=0x0000000000cb4098
