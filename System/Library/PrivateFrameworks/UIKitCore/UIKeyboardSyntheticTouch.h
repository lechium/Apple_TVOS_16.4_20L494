...
+ (id)syntheticTouchWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0060000000950bdf
- (void).cxx_destruct;	// IMP=0x0000000000950ed2
...
- (void)_setLocationInWindow:(struct CGPoint)arg1 resetPrevious:(_Bool)arg2;	// IMP=0x0000000000950e2d
- (struct CGPoint)getLocationInWindow;	// IMP=0x0000000000950e0d
- (struct CGPoint)previousLocationInView:(id)arg1;	// IMP=0x0000000000950d81
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x0000000000950cf5
- (id)initWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0000000000950c52
