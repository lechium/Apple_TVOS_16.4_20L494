...
- (void).cxx_destruct;	// IMP=0x0000000000877c99
...
- (void)endMultiselectInteraction;	// IMP=0x0000000000877b7d
- (void)beginMultiselectInteraction;	// IMP=0x0000000000877b73
@property(readonly, nonatomic, getter=isInMultiselectInteraction) _Bool inMultiselectInteraction;
- (id)pathsToDeselectForInterpolatedIndexPaths:(id)arg1 currentlySelectedIndexPaths:(id)arg2;	// IMP=0x0000000000877a79
- (id)pathsToSelectForInterpolatedIndexPaths:(id)arg1;	// IMP=0x00000000008779bc
- (void)beginSelectingWithStartingIndexPath:(id)arg1 otherSelectedIndexPaths:(id)arg2 keepCurrentSelection:(_Bool)arg3;	// IMP=0x000000000087790c
- (void)updateStateWithStartingIndexPath:(id)arg1 otherSelectedIndexPaths:(id)arg2;	// IMP=0x00000000008777d2
- (void)updateStateWithDifferenceFromCurrentSelection:(id)arg1;	// IMP=0x00000000008773da
- (_Bool)stillValidForSelectedIndexPaths:(id)arg1;	// IMP=0x0000000000877363
@property(readonly, nonatomic) _Bool ignoringSelectionChangedNotifications;
- (void)ignoreSelectionChangedNotificationsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000877337
- (id)initWithCurrentSelection:(id)arg1;	// IMP=0x0000000000877251
