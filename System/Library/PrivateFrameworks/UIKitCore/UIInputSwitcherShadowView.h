...
- (void).cxx_destruct;	// IMP=0x000000000086e410
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000086d6a0
- (void)layoutSubviews;	// IMP=0x000000000086d512
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000086d41b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000086d15f
