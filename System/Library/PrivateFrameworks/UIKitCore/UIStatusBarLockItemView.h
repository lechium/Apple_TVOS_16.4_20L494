...
+ (double)lockSlideAnimationDuration;	// IMP=0x0010000000d32198
- (void).cxx_destruct;	// IMP=0x0000000000d35004
...
- (id)accessibilityHUDRepresentation;	// IMP=0x0000000000d34dc0
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000d34dae
- (void)jiggleCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d34bc3
- (void)animateUnlockForegroundView:(id)arg1 timeItemSnapshot:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000d329ab
- (void)setVisible:(_Bool)arg1 frame:(struct CGRect)arg2 duration:(double)arg3;	// IMP=0x0000000000d32565
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x0000000000d324e4
- (double)updateContentsAndWidth;	// IMP=0x0000000000d3231e
- (_Bool)_isAnimating;	// IMP=0x0000000000d3230a
- (void)_endAnimation;	// IMP=0x0000000000d321c8
- (void)_beginAnimation;	// IMP=0x0000000000d321b8
- (_Bool)isExclusive;	// IMP=0x0000000000d321a6
