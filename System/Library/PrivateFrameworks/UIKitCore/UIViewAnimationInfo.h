...
- (void).cxx_destruct;	// IMP=0x00000000011a4b13
...
- (void)performWithLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000011a49bb
- (void)setModifierGroupRequestHandler:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000011a4970
- (id)modifierGroupRequestHandlerForKey:(id)arg1;	// IMP=0x00000000011a495a
- (void)setPresentationModifier:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000011a490f
- (id)presentationModifierForKey:(id)arg1;	// IMP=0x00000000011a48f9
- (void)setAnimatableProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000011a47e9
- (id)animatablePropertyForKey:(id)arg1 createIfNecessary:(_Bool)arg2;	// IMP=0x00000000011a452c
- (id)animatablePropertyKeys;	// IMP=0x00000000011a4431
- (void)_invalidateIfPossible;	// IMP=0x00000000011a43ec
- (_Bool)_canInvalidate;	// IMP=0x00000000011a4389
- (id)initWithView:(id)arg1;	// IMP=0x00000000011a429c
