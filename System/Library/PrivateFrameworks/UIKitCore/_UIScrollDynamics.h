...
- (void)recalculateForDecelerationTarget:(struct CGPoint)arg1;	// IMP=0x0000000001155f4e
- (void)calculateToReachDecelerationTarget;	// IMP=0x0000000001155f48
- (void)calculateDecelerationTarget;	// IMP=0x0000000001155f42
- (_Bool)isRubberBandingAfterDuration:(double)arg1;	// IMP=0x0000000001155f3a
- (struct CGPoint)positionAfterDuration:(double)arg1;	// IMP=0x0000000001155f24
- (struct CGVector)velocityAfterDuration:(double)arg1;	// IMP=0x0000000001155f18
- (double)speedAfterDuration:(double)arg1;	// IMP=0x0000000001155f0f
@property(readonly, nonatomic) double durationUntilStop;
- (id)initWithInitialContentOffset:(struct CGPoint)arg1 velocity:(struct CGVector)arg2 contentFrame:(struct CGRect)arg3 viewSize:(struct CGSize)arg4 screenScale:(double)arg5;	// IMP=0x0000000001155dfa
- (id)init;	// IMP=0x0000000001155d8f
