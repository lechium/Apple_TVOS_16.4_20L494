...
+ (id)defaultFormatter;	// IMP=0x00600000006087cb
- (void).cxx_destruct;	// IMP=0x0000000000608c55
...
- (id)stringFromReportComponents:(id)arg1;	// IMP=0x000000000060882e
- (id)init;	// IMP=0x00000000006087dd
