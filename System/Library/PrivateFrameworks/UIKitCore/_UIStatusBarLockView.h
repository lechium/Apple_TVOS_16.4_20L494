...
- (void).cxx_destruct;	// IMP=0x0000000000d78b14
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000d78a51
- (void)jiggleWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d78572
- (void)animateUnlockWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d7820f
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000d781f9
- (void)resetLock;	// IMP=0x0000000000d7813f
@property(readonly, nonatomic) _Bool prefersBaselineAlignment;
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000d77f2f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d77e20
