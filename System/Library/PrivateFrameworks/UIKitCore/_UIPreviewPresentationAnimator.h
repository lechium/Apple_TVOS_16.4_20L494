...
- (void).cxx_destruct;	// IMP=0x0000000000be60bd
...
- (void)_advanceFromDisplayLink:(id)arg1;	// IMP=0x0000000000be5f0c
- (void)stopAnimation;	// IMP=0x0000000000be5ea3
- (id)initWithDuration:(double)arg1 advanceBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000be5d2a
- (id)init;	// IMP=0x0000000000be5d1c
