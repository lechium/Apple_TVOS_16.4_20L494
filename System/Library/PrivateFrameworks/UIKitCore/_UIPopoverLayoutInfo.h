...
+ (id)_observationKeys;	// IMP=0x00100000010439a5
- (void).cxx_destruct;	// IMP=0x00000000010453af
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000010451b5
- (void)_updateOutputs;	// IMP=0x00000000010443a0
- (struct CGSize)_popoverViewSizeForContentSize:(struct CGSize)arg1 arrowDirection:(unsigned long long)arg2;	// IMP=0x0000000001044214
- (id)candidates;	// IMP=0x0000000001044203
- (void)updateProperties:(CDUnknownBlockType)arg1;	// IMP=0x000000000104419c
- (id)description;	// IMP=0x0000000001043ebb
- (void)dealloc;	// IMP=0x0000000001043d58
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001043bd5
- (id)init;	// IMP=0x0000000001043a2a
