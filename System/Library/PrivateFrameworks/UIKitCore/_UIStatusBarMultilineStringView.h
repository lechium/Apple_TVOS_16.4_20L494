...
- (void).cxx_destruct;	// IMP=0x0000000000d7a284
@property(retain, nonatomic) UIStackView *stackView; // @synthesize stackView=_stackView;
@property(nonatomic) long long numberOfLines; // @synthesize numberOfLines=_numberOfLines;
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000d7a1fe
- (id)viewForFirstBaselineLayout;	// IMP=0x0000000000d7a1ae
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000d7a05d
@property(readonly, nonatomic) NSArray *stringViews;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d79b26
