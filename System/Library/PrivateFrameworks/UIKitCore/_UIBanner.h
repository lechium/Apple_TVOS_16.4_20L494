...
- (void).cxx_destruct;	// IMP=0x0000000000d1b9da
...
- (void)addTapHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d1b866
- (void)addDismissalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d1b7ea
- (void)addDismissalAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d1b76e
- (void)dismiss;	// IMP=0x0000000000d1b580
- (void)handleLongPressGesture:(id)arg1;	// IMP=0x0000000000d1b2f9
- (void)present;	// IMP=0x0000000000d1b15e
