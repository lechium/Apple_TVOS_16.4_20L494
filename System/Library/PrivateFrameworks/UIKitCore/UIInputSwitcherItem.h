...
+ (id)switcherItemWithIdentifier:(id)arg1;	// IMP=0x0060000000865d74
- (void).cxx_destruct;	// IMP=0x000000000086605c
...
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000865e23
- (void)dealloc;	// IMP=0x0000000000865dbd
