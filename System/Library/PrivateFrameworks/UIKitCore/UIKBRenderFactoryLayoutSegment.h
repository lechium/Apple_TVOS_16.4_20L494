...
+ (id)segmentWithTraits:(id)arg1;	// IMP=0x00600000008ef130
- (void).cxx_destruct;	// IMP=0x00000000008efb59
...
- (_Bool)containsPoint:(struct CGPoint)arg1 inRect:(struct CGRect)arg2 withKeyplane:(id)arg3;	// IMP=0x00000000008ef4d0
- (_Bool)shouldOverlayTraitsForKey:(id)arg1;	// IMP=0x00000000008ef397
- (void)addRelativeLayoutRectFromEdge:(unsigned long long)arg1 ofCachedKey:(id)arg2;	// IMP=0x00000000008ef2b1
- (void)addLayoutRect:(struct CGRect)arg1 asTriangle:(unsigned long long)arg2;	// IMP=0x00000000008ef1f2
- (id)initWithTraits:(id)arg1;	// IMP=0x00000000008ef179
