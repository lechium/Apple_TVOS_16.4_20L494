...
- (void).cxx_destruct;	// IMP=0x00000000000b089c
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000b054c
- (id)debugDescriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000b04fc
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000b04ac
- (id)succinctDescriptionBuilder;	// IMP=0x00000000000b0371
- (id)succinctDescription;	// IMP=0x00000000000b0321
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000000b020e
- (id)init;	// IMP=0x00000000000b0094
