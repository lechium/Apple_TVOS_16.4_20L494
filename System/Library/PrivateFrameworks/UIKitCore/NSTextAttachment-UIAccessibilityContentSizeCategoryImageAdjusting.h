...
+ (id)textAttachmentWithImage:(id)arg1;	// IMP=0x00100000007ac49e
+ (id)_imageFromAttachment:(id)arg1;	// IMP=0x0010000000ef7b0a
+ (_Bool)_attachmentHasImage:(id)arg1;	// IMP=0x0010000000ef79a3
