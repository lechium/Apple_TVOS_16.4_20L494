...
- (void).cxx_destruct;	// IMP=0x00000000011614b2
...
- (void)didFinishRotation;	// IMP=0x00000000011612d9
- (void)willBeginRotationWithOriginalBounds:(struct CGRect)arg1 newBounds:(struct CGRect)arg2;	// IMP=0x00000000011611c0
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000001160f0d
- (void)setMagicShadowAlpha:(double)arg1;	// IMP=0x0000000001160ebe
- (void)_grabberPrimaryAction;	// IMP=0x0000000001160e61
- (_Bool)_isGrabber:(id)arg1;	// IMP=0x0000000001160ddd
@property(readonly, nonatomic) _Bool _hasCreatedGrabbers;
- (void)didMoveToWindow;	// IMP=0x00000000011603be
- (void)updateCornerClippingViews;	// IMP=0x000000000115fdc0
@property(readonly, nonatomic) UIView *deepestClippingView;
- (void)_layoutGrabbers;	// IMP=0x000000000115faad
- (void)layoutSubviews;	// IMP=0x000000000115fa6c
- (id)initWithFrame:(struct CGRect)arg1 independentCorners:(long long)arg2 supportsShadow:(_Bool)arg3 stylesSheetsAsCards:(_Bool)arg4;	// IMP=0x000000000115f068
