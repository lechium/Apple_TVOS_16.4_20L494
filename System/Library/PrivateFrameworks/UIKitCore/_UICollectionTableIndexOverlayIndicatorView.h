...
- (void).cxx_destruct;	// IMP=0x0000000000e5b2f7
@property(copy, nonatomic) NSString *currentText;
- (void)layoutSubviews;	// IMP=0x0000000000e5b268
- (void)_willChangeToIdiom:(long long)arg1 onScreen:(id)arg2;	// IMP=0x0000000000e5b160
- (void)_tapGestureChanged:(id)arg1;	// IMP=0x0000000000e5b109
- (id)initWithHost:(id)arg1;	// IMP=0x0000000000e5b00f
