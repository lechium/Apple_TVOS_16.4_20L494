...
+ (id)sliceWithStart:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0060000000b4624b
- (void).cxx_destruct;	// IMP=0x0000000000b46518
...
- (id)description;	// IMP=0x0000000000b4636e
@property(readonly) _Bool hasGeometry;
- (void)addStartRect:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0000000000b462b1
- (id)init;	// IMP=0x0000000000b461ac
