...
- (void)cancel;	// IMP=0x000000000123fcd8
- (void)main;	// IMP=0x000000000123fb99
- (void)_search;	// IMP=0x000000000123f478
- (id)sanitizedAttributedStringForAttributedString:(id)arg1;	// IMP=0x000000000123ef8e
- (struct __CTFont *)_fontWithPDFFont:(struct CGPDFFont *)arg1 size:(double)arg2;	// IMP=0x000000000123ec92
- (void)_notifyDelegateOfStatus;	// IMP=0x000000000123eb17
- (_Bool)_hitSearchLimit;	// IMP=0x000000000123eaec
- (void)dealloc;	// IMP=0x000000000123ea84
- (id)init;	// IMP=0x000000000123e9ff
