...
- (void).cxx_destruct;	// IMP=0x00000000000e6867
...
- (id)description;	// IMP=0x00000000000e666e
- (id)describeMergeTable;	// IMP=0x00000000000e654b
- (id)mergeSource:(id)arg1 andDestination:(id)arg2;	// IMP=0x00000000000e6494
@property(readonly, copy, nonatomic) NSArray *merged;
- (void)_calculate;	// IMP=0x00000000000e630d
- (void)_calculateMerge;	// IMP=0x00000000000e5aea
- (void)_calculateLCSSTable;	// IMP=0x00000000000e58c5
- (void)_calculatePrefixAndSuffix;	// IMP=0x00000000000e56e0
- (void)_reset;	// IMP=0x00000000000e56b3
- (void)dealloc;	// IMP=0x00000000000e5679
