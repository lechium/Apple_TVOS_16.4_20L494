...
- (void).cxx_destruct;	// IMP=0x000000000101ae43
...
- (void)updateIndicator;	// IMP=0x000000000101ad38
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000101acb7
- (void)setupView;	// IMP=0x000000000101a891
- (id)initWithKeyboardInputModeIdentifier:(id)arg1;	// IMP=0x000000000101a7e5
