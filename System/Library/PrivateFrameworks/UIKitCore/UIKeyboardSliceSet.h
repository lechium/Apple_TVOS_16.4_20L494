...
+ (id)sliceSetWithDictionaryRepresenation:(id)arg1;	// IMP=0x0060000000b45a4e
- (void).cxx_destruct;	// IMP=0x0000000000b46179
...
- (id)description;	// IMP=0x0000000000b45e99
- (void)addSlice:(id)arg1;	// IMP=0x0000000000b45e83
- (id)initWithSliceID:(id)arg1;	// IMP=0x0000000000b4589b
