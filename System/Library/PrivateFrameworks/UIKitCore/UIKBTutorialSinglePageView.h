...
- (void).cxx_destruct;	// IMP=0x00000000006e2d72
...
- (void)configPageView;	// IMP=0x00000000006e1b55
- (void)layoutSubviews;	// IMP=0x00000000006e1b43
- (id)initWithImageView:(id)arg1;	// IMP=0x00000000006e1a09
