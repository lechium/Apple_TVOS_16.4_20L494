...
+ (void)setAnimationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00600000011b25ff
+ (id)animationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00600000011b2526
- (void).cxx_destruct;	// IMP=0x00000000011b2b80
...
- (_Bool)_allowsHitTesting;	// IMP=0x00000000011b2b35
- (_Bool)_allowsUserInteractionToCutOffEndOfAnimation;	// IMP=0x00000000011b2b2c
- (void)_sendDeferredCompletion:(id)arg1;	// IMP=0x00000000011b2ab7
- (void)_didEndBlockAnimation:(id)arg1 finished:(id)arg2 context:(void *)arg3;	// IMP=0x00000000011b2744
- (void)_willBeginBlockAnimation:(id)arg1 context:(id)arg2;	// IMP=0x00000000011b271c
