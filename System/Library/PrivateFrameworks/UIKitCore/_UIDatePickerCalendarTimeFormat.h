...
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2;	// IMP=0x00100000006aec64
- (void).cxx_destruct;	// IMP=0x00000000006b1222
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006b0f1b
- (id)withTimeZone:(id)arg1;	// IMP=0x00000000006b0e6f
- (id)withDisplaysTimeZone:(_Bool)arg1;	// IMP=0x00000000006b0e25
- (id)withForceDoubleDigitHours:(_Bool)arg1;	// IMP=0x00000000006b0d1b
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3;	// IMP=0x00000000006b0d06
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3 ranges:(CDStruct_a33ff3ce *)arg4;	// IMP=0x00000000006b00ba
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 forceDoubleDigitHours:(_Bool)arg3 displaysTimeZone:(_Bool)arg4;	// IMP=0x00000000006aece0
