...
+ (void)_addAnimations:(id)arg1 toDispatchGroup:(id)arg2;	// IMP=0x0010000000daa34a
+ (void)_addAnimations:(id)arg1 toPreparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3 visitedDisplayItemIdentifiers:(id)arg4;	// IMP=0x0010000000da986e
+ (void)prepareAnimations:(id)arg1 forStatusBar:(id)arg2;	// IMP=0x0010000000da9652
+ (id)animationWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000da930b
+ (void)initialize;	// IMP=0x0010000000da92b4
- (void).cxx_destruct;	// IMP=0x0000000000dabab3
...
- (id)description;	// IMP=0x0000000000dab76c
- (id)_dependentItemIdentifiersEnabledOnly:(_Bool)arg1;	// IMP=0x0000000000dab52a
@property(readonly, nonatomic) NSSet *effectiveDelayedItemIdentifiers;
- (void)addSubAnimation:(id)arg1 forDisplayItemWithIdentifier:(id)arg2;	// IMP=0x0000000000daafa9
- (void)cancel;	// IMP=0x0000000000daad99
- (void)addTimeout:(double)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000daad6f
- (void)performForStatusBar:(id)arg1;	// IMP=0x0000000000daa5a4
- (void)_prepareForStatusBar:(id)arg1 preparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3;	// IMP=0x0000000000da9d75
- (void)addTotalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000da9579
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000da94ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000da93d0
