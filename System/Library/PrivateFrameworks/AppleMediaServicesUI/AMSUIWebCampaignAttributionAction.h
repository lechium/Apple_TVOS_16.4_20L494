...
+ (id)_campaignAttributionTaskForURL:(id)arg1;	// IMP=0x006000000006356f
...
- (id)runAction;	// IMP=0x0000000000062bac
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000626d8
