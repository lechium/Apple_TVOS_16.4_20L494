...
- (void).cxx_destruct;	// IMP=0x00000000000587cb
...
- (id)_responseForAccount:(id)arg1;	// IMP=0x00000000000585da
- (void)_updateContextWithAccountIfNeeded:(id)arg1;	// IMP=0x00000000000584ad
- (id)runAction;	// IMP=0x0000000000057dc7
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000005750e
