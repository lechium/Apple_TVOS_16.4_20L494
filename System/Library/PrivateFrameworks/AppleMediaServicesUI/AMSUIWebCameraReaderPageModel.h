...
- (void).cxx_destruct;	// IMP=0x0000000000060e6e
...
- (id)loadPage;	// IMP=0x00000000000607e7
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000060776
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006023c
