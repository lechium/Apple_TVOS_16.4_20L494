...
- (void)_finishPromiseWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x00000000000563d3
- (id)runAction;	// IMP=0x0000000000056259
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000055f32
