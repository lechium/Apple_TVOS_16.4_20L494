...
- (void).cxx_destruct;	// IMP=0x0000000000042965
...
- (void)updateContentSize;	// IMP=0x0000000000042391
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000004233f
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000004214d
- (void)adjustedContentInsetDidChange;	// IMP=0x00000000000420f7
- (void)layoutSubviews;	// IMP=0x0000000000041b66
- (id)initWithFeatures:(id)arg1;	// IMP=0x000000000004177a
