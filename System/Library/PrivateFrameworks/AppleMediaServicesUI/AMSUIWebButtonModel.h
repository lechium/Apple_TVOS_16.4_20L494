...
- (void).cxx_destruct;	// IMP=0x000000000005b9de
...
- (id)_imageForButtonWithNavStyle:(long long)arg1;	// IMP=0x000000000005b7c1
@property(readonly, copy) NSString *description;
- (id)createDialogAction;	// IMP=0x000000000005b682
- (id)_createProxCardItemWithActionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000005b67a
- (id)_createSpinnerItem;	// IMP=0x000000000005b5b1
- (long long)_barButtonItemStyle;	// IMP=0x000000000005b598
- (id)createBarButtonItemWithNavigationBarModel:(id)arg1 actionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000005b1d3
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000005ad4e
