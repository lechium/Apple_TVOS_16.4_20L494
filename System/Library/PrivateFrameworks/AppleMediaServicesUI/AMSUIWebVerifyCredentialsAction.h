...
+ (id)_authenticationTypeFromStringedType:(id)arg1;	// IMP=0x001000000009af15
+ (long long)_serviceTypeFromType:(long long)arg1;	// IMP=0x001000000009adba
- (void).cxx_destruct;	// IMP=0x000000000009b08a
...
- (id)runAction;	// IMP=0x000000000009a8bf
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000009a07f
