...
+ (id)_createClientInfoFromAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x006000000006547d
+ (_Bool)_boolForKey:(id)arg1 defaultValue:(_Bool)arg2 domain:(struct __CFString *)arg3;	// IMP=0x0060000000065413
- (void).cxx_destruct;	// IMP=0x0000000000065b22
...
- (void)updateBackingBag:(id)arg1;	// IMP=0x0000000000065401
- (void)replaceCurrentAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x0000000000064e02
- (id)loadSnapshot;	// IMP=0x0000000000064b11
- (id)JSAccountFromAccount:(id)arg1 store:(id)arg2;	// IMP=0x0000000000064536
- (id)iTunesAccountFromJSDSID:(id)arg1;	// IMP=0x000000000006441c
- (id)iTunesAccountFromJSAccount:(id)arg1;	// IMP=0x0000000000063f61
...
- (id)initWithAccount:(id)arg1 clientInfo:(id)arg2 backingBag:(id)arg3;	// IMP=0x0000000000063d08
