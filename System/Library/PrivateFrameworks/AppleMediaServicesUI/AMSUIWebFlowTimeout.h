...
+ (id)timeoutWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0060000000079454
- (void).cxx_destruct;	// IMP=0x0000000000079c9c
...
- (void)reset;	// IMP=0x0000000000079ad8
- (void)pause;	// IMP=0x00000000000798a9
- (void)start;	// IMP=0x00000000000794dc
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000007939d
