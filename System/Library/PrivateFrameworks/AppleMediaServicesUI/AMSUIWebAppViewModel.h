...
+ (_Bool)validateJSObject:(id)arg1;	// IMP=0x0010000000057427
- (void).cxx_destruct;	// IMP=0x00000000000574d0
...
- (id)iconWithSize:(struct CGSize)arg1 scale:(double)arg2;	// IMP=0x0000000000056fda
- (id)createBarButtonItem;	// IMP=0x0000000000056a38
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000056655
