...
- (void).cxx_destruct;	// IMP=0x0000000000091085
...
- (id)_webPageViewController;	// IMP=0x0000000000090dec
- (id)loadPage;	// IMP=0x0000000000090dd3
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000090db9
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000009083b
