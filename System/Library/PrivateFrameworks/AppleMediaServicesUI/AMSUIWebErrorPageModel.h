...
+ (id)_messageFromError:(id)arg1;	// IMP=0x001000000006f17a
- (void).cxx_destruct;	// IMP=0x000000000006f479
...
- (id)loadPage;	// IMP=0x000000000006f161
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000006f0f0
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *errorMessage; // @synthesize errorMessage=_errorMessage;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006e8a6
- (id)initWithError:(id)arg1 context:(id)arg2 actionBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000006e60f
