...
- (id)_runMediaRequestWithType:(long long)arg1 clientIdentifier:(id)arg2 clientVersion:(id)arg3;	// IMP=0x0000000000083722
- (id)_runMediaRequestWithURL:(id)arg1 clientIdentifier:(id)arg2 clientVersion:(id)arg3;	// IMP=0x00000000000832bf
- (id)runAction;	// IMP=0x0000000000082feb
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000082c80
