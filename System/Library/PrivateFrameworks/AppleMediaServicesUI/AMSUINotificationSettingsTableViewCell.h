...
- (void).cxx_destruct;	// IMP=0x000000000003f045
...
- (void)switchToggled:(id)arg1;	// IMP=0x000000000003eeb9
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000003ec41
