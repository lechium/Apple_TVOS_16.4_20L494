...
- (void).cxx_destruct;	// IMP=0x0000000000080f30
...
- (id)loadPage;	// IMP=0x0000000000080e8f
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000080e02
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000080813
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000807a8
