...
- (void).cxx_destruct;	// IMP=0x000000000006d99e
...
- (id)loadPage;	// IMP=0x000000000006d504
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000006d36a
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006cfba
