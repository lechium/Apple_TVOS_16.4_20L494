...
- (void)_fetchValuesForKeys:(id)arg1 bag:(id)arg2 startingAtIndex:(long long)arg3 valuesArray:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x000000000005989e
- (id)runAction;	// IMP=0x00000000000591f4
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000058bd1
