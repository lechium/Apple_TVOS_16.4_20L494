...
- (void).cxx_destruct;	// IMP=0x00000000000466e5
...
- (void)_toggleChanged:(id)arg1;	// IMP=0x00000000000465e7
- (long long)selectionStyle;	// IMP=0x00000000000465df
- (void)_setup;	// IMP=0x00000000000464d1
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000046485
