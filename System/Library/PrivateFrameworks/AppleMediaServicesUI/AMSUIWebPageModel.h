...
- (void).cxx_destruct;	// IMP=0x000000000008b595
...
- (id)loadPage;	// IMP=0x000000000008b1d9
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000008b17d
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000008ae6e
