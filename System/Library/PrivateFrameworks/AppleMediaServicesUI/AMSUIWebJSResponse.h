...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000804ba
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000080591
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000804c2
- (id)initWithRequest:(id)arg1 duration:(double)arg2;	// IMP=0x0000000000080440
