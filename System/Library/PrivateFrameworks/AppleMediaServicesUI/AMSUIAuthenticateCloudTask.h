...
- (id)_serviceContextWithResults:(id)arg1 parentViewController:(id)arg2;	// IMP=0x000000000000e765
- (id)performAuthenticate;	// IMP=0x000000000000e10b
- (id)initWithAuthRequest:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000000000e069
