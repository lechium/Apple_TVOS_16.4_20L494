...
- (void).cxx_destruct;	// IMP=0x00000000000530f1
...
- (void)viewTapped:(id)arg1;	// IMP=0x0000000000052f89
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x0000000000052f06
- (void)mediaPause;	// IMP=0x0000000000052e2d
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000522a2
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000521b2
- (void)viewWillLayoutSubviews;	// IMP=0x00000000000518d3
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x000000000005184e
- (void)loadView;	// IMP=0x000000000005142d
- (void)dealloc;	// IMP=0x000000000005136b
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000050555
