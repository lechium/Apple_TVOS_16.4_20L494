...
- (void).cxx_destruct;	// IMP=0x0000000000054f82
...
- (id)runAction;	// IMP=0x0000000000054e68
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000054ce3
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000054c78
