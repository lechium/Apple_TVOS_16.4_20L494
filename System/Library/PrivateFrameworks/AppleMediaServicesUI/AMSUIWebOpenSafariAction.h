...
+ (id)resultFromURL:(id)arg1 error:(id)arg2;	// IMP=0x0010000000088e90
- (void).cxx_destruct;	// IMP=0x0000000000089e58
...
- (void)_safariDataUpdate:(id)arg1;	// IMP=0x000000000008996c
- (_Bool)_presentViewContoller:(id)arg1;	// IMP=0x000000000008977b
- (id)runAction;	// IMP=0x0000000000088fde
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000088c94
