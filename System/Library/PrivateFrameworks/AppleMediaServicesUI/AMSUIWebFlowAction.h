...
- (void).cxx_destruct;	// IMP=0x0000000000074d6a
...
- (void)_runWithType:(long long)arg1 options:(id)arg2;	// IMP=0x00000000000748bf
- (id)runAction;	// IMP=0x00000000000744aa
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000073ea7
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000073e64
