...
- (void).cxx_destruct;	// IMP=0x000000000005acfb
...
- (id)makeBusinessChatDeeplink;	// IMP=0x000000000005a93f
- (id)runAction;	// IMP=0x000000000005a7b8
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000005a596
