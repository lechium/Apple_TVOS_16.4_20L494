...
+ (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x001000000003f500
- (void).cxx_destruct;	// IMP=0x000000000003fc2c
...
- (void)accessFileAtURLWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f788
- (void)getDataWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f5cc
- (void)getDataFileWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f5ba
- (id)getFileName;	// IMP=0x000000000003f56a
- (id)initWithURL:(id)arg1 sandboxExtension:(id)arg2;	// IMP=0x000000000003f03f
