...
- (void).cxx_destruct;	// IMP=0x0000000000200ca5
...
- (id)exportObject;	// IMP=0x00000000002007ef
- (id)initWithIdentifier:(id)arg1 cacheObject:(id)arg2;	// IMP=0x0000000000200286
