...
+ (id)sharedTaskQueue;	// IMP=0x004000000034d3cd
+ (id)sharedTaskStore;	// IMP=0x004000000034d378
+ (void)removeTaskInfoForTask:(id)arg1;	// IMP=0x004000000034c2f3
+ (id)createTaskInfoForTask:(id)arg1;	// IMP=0x004000000034c0b0
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x004000000034bed8
- (void).cxx_destruct;	// IMP=0x000000000034d490
...
- (void)setAccount:(id)arg1;	// IMP=0x000000000034d292
- (void)_performDataAccessUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000034d1e6
- (void)finishContiguousAsyncActionWithIdentifier:(unsigned long long)arg1;	// IMP=0x000000000034d19a
- (void)continueContiguousAsyncActionWithIdentifier:(unsigned long long)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000000034d122
- (unsigned long long)startContiguousAsyncActionWithInitialDataBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000034cfcc
- (unsigned long long)startContiguousAsyncActionWithInitialBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000034cf55
- (void)performSyncBlockWithExclusiveAccess:(CDUnknownBlockType)arg1;	// IMP=0x000000000034ce3b
- (void)performSyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000034cda3
- (void)performAsyncBlockWithData:(CDUnknownBlockType)arg1;	// IMP=0x000000000034ccc7
- (void)performAsyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000034cc55
- (void)migrateFromTaskInfo:(id)arg1;	// IMP=0x000000000034cb19
- (id)createMetricsContextForDecodedObject:(id)arg1;	// IMP=0x000000000034ca74
- (void)assertIsOnPrivateQueue;	// IMP=0x000000000034ca3f
- (void)assertHasExclusiveAccess;	// IMP=0x000000000034c9fc
- (void)appendData:(id)arg1;	// IMP=0x000000000034c979
- (void)addRetryIdentifier:(id)arg1;	// IMP=0x000000000034c920
...
- (id)initWithTask:(id)arg1;	// IMP=0x000000000034bd95
