...
- (void).cxx_destruct;	// IMP=0x00000000001d3ff2
...
- (void)invalidate;	// IMP=0x00000000001d3fa2
- (id)initWithDeallocGuardBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001d3f24
- (void)dealloc;	// IMP=0x00000000001d3e9f
