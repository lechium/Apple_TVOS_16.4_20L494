...
+ (id)configForType:(long long)arg1;	// IMP=0x006000000026a332
- (void).cxx_destruct;	// IMP=0x000000000026aa11
...
- (id)initWithType:(long long)arg1 typeString:(id)arg2 hostBagKey:(id)arg3 realm:(id)arg4 includePlatform:(_Bool)arg5;	// IMP=0x000000000026a268
