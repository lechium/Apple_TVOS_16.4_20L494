...
- (void).cxx_destruct;	// IMP=0x000000000020c6d2
...
- (void)removeServiceType:(id)arg1;	// IMP=0x000000000020c60f
- (void)addServiceType:(id)arg1;	// IMP=0x000000000020c59d
- (void)removePlacement:(id)arg1;	// IMP=0x000000000020c52b
- (void)addPlacement:(id)arg1;	// IMP=0x000000000020c4b9
@property(readonly, nonatomic) NSSet *serviceTypes;
@property(readonly, nonatomic) NSSet *placements;
- (id)initWithQueue:(id)arg1;	// IMP=0x000000000020c31c
