...
+ (id)valueForURLVariable:(id)arg1 account:(id)arg2 clientInfo:(id)arg3;	// IMP=0x001000000018b155
- (void).cxx_destruct;	// IMP=0x000000000018c949
...
- (void)_updateCachedResult:(id)arg1;	// IMP=0x000000000018c3b4
- (id)_newCompletionQueue;	// IMP=0x000000000018c320
- (void)_invalidateCacheNotification:(id)arg1;	// IMP=0x000000000018c1d4
- (id)_fetchBag;	// IMP=0x000000000018b8b8
- (void)_accountStoreDidChange;	// IMP=0x000000000018b35e
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x000000000018b0b2
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000018b013
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000018ab83
@property(readonly, copy, nonatomic) NSString *bagLoadingPartialIdentifier;
- (id)defaultValueForKey:(id)arg1;	// IMP=0x000000000018a9bf
...
- (void)dealloc;	// IMP=0x0000000000189fac
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 processInfo:(id)arg3 accountProvider:(id)arg4;	// IMP=0x000000000018980c
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 processInfo:(id)arg3;	// IMP=0x0000000000189770
