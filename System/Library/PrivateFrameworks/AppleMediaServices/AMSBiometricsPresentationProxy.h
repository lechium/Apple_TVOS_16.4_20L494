...
- (void).cxx_destruct;	// IMP=0x00000000001a4f04
...
- (void)handleDialogRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001a4d27
- (void)handleAuthenticateRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001a49bb
- (id)initWithSession:(id)arg1 task:(id)arg2;	// IMP=0x00000000001a48e4
