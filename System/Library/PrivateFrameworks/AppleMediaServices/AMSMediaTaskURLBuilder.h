...
- (void).cxx_destruct;	// IMP=0x000000000026cde9
...
- (id)_devicePlatform;	// IMP=0x000000000026ca9d
- (void)_addSearchTerm:(id)arg1;	// IMP=0x000000000026c8b8
- (void)_addItemIdentifiers:(id)arg1;	// IMP=0x000000000026c68f
- (void)_addCharts:(id)arg1;	// IMP=0x000000000026c570
- (void)_addBundleIdentifiers:(id)arg1;	// IMP=0x000000000026c3c6
- (id)_queryItemsWithLanguage:(id)arg1;	// IMP=0x000000000026bbce
- (id)_pathPromise;	// IMP=0x000000000026b66b
- (id)_languagePromise;	// IMP=0x000000000026b279
- (id)_hostPromise;	// IMP=0x000000000026b1b4
- (id)_verifyConfiguration;	// IMP=0x000000000026ae99
- (id)build;	// IMP=0x000000000026ab19
- (id)initWithConfig:(id)arg1 clientVersion:(id)arg2 bag:(id)arg3;	// IMP=0x000000000026aa44
