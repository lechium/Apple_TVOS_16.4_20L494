...
- (void).cxx_destruct;	// IMP=0x00000000002730d2
...
- (double)_calculateThrottleInterval;	// IMP=0x0000000000272feb
- (void)throttle;	// IMP=0x0000000000272f64
- (_Bool)shouldThrottle;	// IMP=0x0000000000272f17
- (void)reset;	// IMP=0x0000000000272ee5
- (id)initWithBaseSleepInterval:(double)arg1 maxSleepInterval:(double)arg2;	// IMP=0x0000000000272e7b
