...
- (void).cxx_destruct;	// IMP=0x00000000001a489c
...
- (id)perform;	// IMP=0x00000000001a3d29
- (id)initWithAccount:(id)arg1 session:(id)arg2 task:(id)arg3;	// IMP=0x00000000001a3c63
