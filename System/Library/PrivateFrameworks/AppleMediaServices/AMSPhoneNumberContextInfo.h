...
- (void).cxx_destruct;	// IMP=0x00000000002d2bca
...
- (id)description;	// IMP=0x00000000002d2a15
- (id)initWithPhoneNumber:(id)arg1 simLabel:(id)arg2 uuid:(id)arg3 isVoicePreferred:(_Bool)arg4;	// IMP=0x00000000002d2953
