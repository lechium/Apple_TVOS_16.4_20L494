...
- (void).cxx_destruct;	// IMP=0x00000000002ddf34
...
- (id)nextPurchase;	// IMP=0x00000000002dde8f
- (_Bool)finishPurchase:(id)arg1 withResult:(id)arg2;	// IMP=0x00000000002ddb44
- (_Bool)finishPurchase:(id)arg1 withError:(id)arg2;	// IMP=0x00000000002dd6cd
- (id)purchaseForPurchaseId:(id)arg1;	// IMP=0x00000000002dd60f
- (id)initWithPurchases:(id)arg1 weakPromise:(id)arg2;	// IMP=0x00000000002dd36f
