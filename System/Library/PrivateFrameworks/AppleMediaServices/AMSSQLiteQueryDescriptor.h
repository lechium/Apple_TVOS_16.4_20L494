...
- (void).cxx_destruct;	// IMP=0x0000000000311ccb
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x000000000031156f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000031147d
