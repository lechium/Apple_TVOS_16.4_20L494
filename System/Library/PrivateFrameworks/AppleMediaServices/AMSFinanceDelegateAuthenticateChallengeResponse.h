...
+ (_Bool)isDelegateAuthChallengeForTaskInfo:(id)arg1;	// IMP=0x0010000000225ec9
- (void).cxx_destruct;	// IMP=0x00000000002261f3
...
- (id)performWithTaskInfo:(id)arg1;	// IMP=0x0000000000226099
- (id)initWithResponseDictionary:(id)arg1 taskInfo:(id)arg2;	// IMP=0x0000000000225e30
