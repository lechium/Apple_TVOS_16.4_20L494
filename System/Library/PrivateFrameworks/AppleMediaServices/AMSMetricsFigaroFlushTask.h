...
- (void).cxx_destruct;	// IMP=0x00000000002959ac
...
- (_Bool)_shouldClearEventsDespiteError:(id)arg1 result:(id)arg2;	// IMP=0x000000000029570e
- (id)_postBatch:(id)arg1;	// IMP=0x0000000000294ca4
- (id)_nextBatchWithConfig:(id)arg1 topic:(id)arg2 maxBatchSize:(long long)arg3;	// IMP=0x0000000000293f97
- (id)_mescalSignatureWithBodyData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000293df1
- (id)_flushNextBatchWithMaxRequestCount:(unsigned long long)arg1 topic:(id)arg2 maxBatchSize:(long long)arg3 requestCount:(unsigned long long)arg4 flushedEventCount:(unsigned long long)arg5 config:(id)arg6;	// IMP=0x00000000002934a7
- (id)performFlush;	// IMP=0x0000000000293198
- (_Bool)cancel;	// IMP=0x0000000000292fff
@property(readonly, nonatomic) AMSURLSession *URLSession; // @synthesize URLSession=_URLSession;
- (id)initWithDataSource:(id)arg1 bag:(id)arg2;	// IMP=0x0000000000292e23
