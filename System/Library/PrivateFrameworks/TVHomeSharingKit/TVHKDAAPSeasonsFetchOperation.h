...
- (void).cxx_destruct;	// IMP=0x00000000000b5c0d
...
- (id)_episodesFetchRequest;	// IMP=0x00000000000b5b24
- (id)_mediaEntitiesWithFetchedEpisodes:(id)arg1 andMediaEntityCache:(id)arg2;	// IMP=0x00000000000b5a8c
- (id)_mediaEntityCacheWithFetchCache:(id)arg1;	// IMP=0x00000000000b5a77
