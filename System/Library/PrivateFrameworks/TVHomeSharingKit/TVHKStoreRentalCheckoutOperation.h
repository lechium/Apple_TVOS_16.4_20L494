...
+ (id)new;	// IMP=0x006000000002d9a5
- (void).cxx_destruct;	// IMP=0x000000000002e014
...
- (void)cancel;	// IMP=0x000000000002df1e
- (void)executionDidBegin;	// IMP=0x000000000002db94
- (id)initWithRentalItem:(id)arg1;	// IMP=0x000000000002da43
- (id)init;	// IMP=0x000000000002d9d4
