...
- (id)description;	// IMP=0x0000000000037799
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000037702
- (void)clear;	// IMP=0x0000000000037681
- (id)initWithMediaServerIdentifier:(id)arg1;	// IMP=0x00000000000375d8
- (id)init;	// IMP=0x0000000000037569
