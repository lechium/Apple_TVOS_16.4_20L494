...
+ (id)new;	// IMP=0x0060000000030cf1
- (void).cxx_destruct;	// IMP=0x000000000003158f
...
- (void)_runNextFetchOperationIfPossible;	// IMP=0x0000000000030ff4
- (void)cancel;	// IMP=0x0000000000030f76
- (void)executionDidBegin;	// IMP=0x0000000000030f64
- (id)initWithRequests:(id)arg1 mediaServerIdentifier:(id)arg2 sessionState:(id)arg3 requestSession:(id)arg4 fetchCache:(id)arg5;	// IMP=0x0000000000030d8f
- (id)init;	// IMP=0x0000000000030d20
