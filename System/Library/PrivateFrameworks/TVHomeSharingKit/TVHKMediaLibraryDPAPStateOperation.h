...
+ (id)new;	// IMP=0x00600000000319b0
- (void).cxx_destruct;	// IMP=0x00000000000322f0
...
- (void)_startSubOperation:(id)arg1;	// IMP=0x000000000003216c
- (void)_startBasePlaylistOperation;	// IMP=0x0000000000031e8e
- (void)_startDatabasesOperation;	// IMP=0x0000000000031bc1
- (void)cancel;	// IMP=0x0000000000031b43
- (void)executionDidBegin;	// IMP=0x0000000000031b31
- (id)initWithSessionState:(id)arg1 requestSession:(id)arg2;	// IMP=0x0000000000031a4e
- (id)init;	// IMP=0x00000000000319df
