...
+ (id)new;	// IMP=0x0010000000066fec
- (void).cxx_destruct;	// IMP=0x00000000000679ed
...
- (void)_handleResponse:(id)arg1 andData:(id)arg2;	// IMP=0x00000000000675f3
- (void)cancel;	// IMP=0x0000000000067575
- (void)executionDidBegin;	// IMP=0x00000000000671c1
- (id)initWithTemplateImageURLString:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x000000000006708a
- (id)init;	// IMP=0x000000000006701b
