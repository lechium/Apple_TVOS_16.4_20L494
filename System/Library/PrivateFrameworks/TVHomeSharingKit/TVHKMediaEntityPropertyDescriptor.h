...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x0010000000085693
- (void).cxx_destruct;	// IMP=0x0000000000085846
...
- (id)description;	// IMP=0x0000000000085305
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000851cf
- (id)init;	// IMP=0x0000000000084db4
