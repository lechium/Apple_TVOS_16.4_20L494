...
- (id)description;	// IMP=0x00000000000a70be
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a6e36
- (unsigned long long)hash;	// IMP=0x00000000000a6d52
- (id)_init;	// IMP=0x00000000000a6d23
- (id)init;	// IMP=0x00000000000a6cb4
