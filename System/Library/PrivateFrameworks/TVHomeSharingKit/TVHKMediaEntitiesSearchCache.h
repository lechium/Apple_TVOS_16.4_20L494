...
+ (id)_nonPersistentIDsFromMediaEntityIdentifiers:(id)arg1;	// IMP=0x0010000000036d95
+ (id)_nonPersistentIDFromMediaEntityIdentifier:(id)arg1;	// IMP=0x0010000000036cec
+ (id)_mediaEntityTypePredicateWithMediaEntityCollectionType:(unsigned long long)arg1 mediaItemType:(unsigned long long)arg2 mediaCategoryType:(unsigned long long)arg3;	// IMP=0x0010000000036c66
+ (id)_mediaEntityTypePredicateWithMediaEntityCollectionType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x0010000000036c4f
+ (id)_mediaEntityTypePredicateWithMediaItemType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x0010000000036c35
+ (id)_sortedMediaEntitiesWithMediaEntities:(id)arg1;	// IMP=0x0010000000036b5a
+ (_Bool)_updateMediaEntitiesDictionary:(id)arg1 withMediaEntityFetchResponse:(id)arg2;	// IMP=0x0010000000036471
+ (id)new;	// IMP=0x00100000000351c2
- (void).cxx_destruct;	// IMP=0x0000000000037134
...
- (id)_albumsWithMediaCategoryType:(unsigned long long)arg1;	// IMP=0x0000000000036a8f
- (id)_albumArtistsWithMediaCategoryType:(unsigned long long)arg1;	// IMP=0x00000000000369c4
- (id)_mediaItemsWithMediaItemType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x000000000003680e
- (void)_updateAlbumsWithAlbumsResponse:(id)arg1;	// IMP=0x00000000000363ec
- (void)_updateAlbumArtistsWithAlbumArtistResponse:(id)arg1;	// IMP=0x0000000000036367
- (void)_updateMediaItemsWithMediaItemsResponse:(id)arg1;	// IMP=0x00000000000362e2
- (void)_clearCachedMediaItemArrays;	// IMP=0x000000000003621a
- (void)_clearCachedAlbumArrays;	// IMP=0x00000000000361bb
- (void)_clearCachedAlbumArtistArrays;	// IMP=0x0000000000036189
- (id)description;	// IMP=0x0000000000035b42
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000035a6f
- (void)reset;	// IMP=0x0000000000035449
- (void)updateWithSearchFetchResponse:(id)arg1 searchText:(id)arg2;	// IMP=0x000000000003533e
- (id)initWithMediaServerIdentifier:(id)arg1;	// IMP=0x0000000000035260
- (id)init;	// IMP=0x00000000000351f1
