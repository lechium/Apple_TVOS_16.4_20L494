...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000001db4
+ (Class)transformedValueClass;	// IMP=0x0060000000001da3
- (void).cxx_destruct;	// IMP=0x0000000000002705
...
- (id)initWithIdentifierKeyPath:(id)arg1;	// IMP=0x0000000000001cf2
- (id)init;	// IMP=0x0000000000001c83
