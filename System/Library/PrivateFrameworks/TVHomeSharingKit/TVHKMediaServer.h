...
+ (id)new;	// IMP=0x0010000000096849
- (void).cxx_destruct;	// IMP=0x0000000000096efc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000096e42
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000096c76
@property(readonly) unsigned long long hash;
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000096b6f
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000969fa
- (id)succinctDescriptionBuilder;	// IMP=0x00000000000969e6
- (id)succinctDescription;	// IMP=0x00000000000969d4
- (id)initWithIdentifier:(id)arg1 type:(unsigned long long)arg2 homeSharingGroupIdentifier:(id)arg3 bonjourServiceConfiguration:(id)arg4;	// IMP=0x00000000000968e7
- (id)init;	// IMP=0x0000000000096878
