...
+ (id)new;	// IMP=0x0060000000085f3d
- (void).cxx_destruct;	// IMP=0x0000000000086c68
...
- (id)description;	// IMP=0x0000000000086ab2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008677f
- (unsigned long long)hash;	// IMP=0x000000000008663c
- (id)_init;	// IMP=0x0000000000085fdb
