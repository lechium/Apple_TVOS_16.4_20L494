...
+ (id)_clientApplicationParameterValueForSearchType:(unsigned long long)arg1;	// IMP=0x00600000000b7e59
+ (id)new;	// IMP=0x00600000000b75c3
- (void).cxx_destruct;	// IMP=0x00000000000b7f00
...
- (void)_handleResponse:(id)arg1;	// IMP=0x00000000000b7b4d
- (void)cancel;	// IMP=0x00000000000b7acf
- (void)executionDidBegin;	// IMP=0x00000000000b7750
- (id)initWithSearchTerm:(id)arg1 andType:(unsigned long long)arg2;	// IMP=0x00000000000b7661
- (id)init;	// IMP=0x00000000000b75f2
