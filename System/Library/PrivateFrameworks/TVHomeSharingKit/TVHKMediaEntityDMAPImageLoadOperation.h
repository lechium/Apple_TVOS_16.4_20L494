...
- (void).cxx_destruct;	// IMP=0x000000000000b72f
...
- (void)_handleResponse:(id)arg1;	// IMP=0x000000000000b496
- (id)_mediaEntityImageLoadParams;	// IMP=0x000000000000b484
- (void)cancel;	// IMP=0x000000000000b406
- (void)executionDidBegin;	// IMP=0x000000000000b0ce
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3 sessionState:(id)arg4 requestSession:(id)arg5;	// IMP=0x000000000000afa0
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x000000000000af31
