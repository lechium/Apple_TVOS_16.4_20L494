...
- (void)_handleProductResponse:(id)arg1;	// IMP=0x0000000000004347
- (void)_startFetchProductOperationWithURL:(id)arg1;	// IMP=0x000000000000404d
- (id)_productURLFromLookupResults:(id)arg1 forStoreID:(id)arg2;	// IMP=0x0000000000003d80
- (void)_startLookupOperationWithStoreID:(unsigned long long)arg1;	// IMP=0x000000000000399f
- (id)_productURLFromSearchResults:(id)arg1;	// IMP=0x0000000000003715
- (void)_startSearchOperationWithTitle:(id)arg1 andType:(unsigned long long)arg2;	// IMP=0x000000000000338b
- (void)cancel;	// IMP=0x000000000000330d
- (void)executionDidBegin;	// IMP=0x000000000000328d
- (id)initWithItemTitle:(id)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x00000000000031a8
- (id)init;	// IMP=0x0000000000003139
