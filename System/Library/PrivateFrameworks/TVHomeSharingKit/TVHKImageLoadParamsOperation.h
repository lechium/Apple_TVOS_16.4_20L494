...
+ (id)new;	// IMP=0x00100000000a6a0f
- (void).cxx_destruct;	// IMP=0x00000000000a6c43
...
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x00000000000a6aad
- (id)init;	// IMP=0x00000000000a6a3e
