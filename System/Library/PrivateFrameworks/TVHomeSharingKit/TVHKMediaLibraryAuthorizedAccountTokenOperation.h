...
- (void).cxx_destruct;	// IMP=0x000000000006a19d
...
- (id)_decryptTokenData:(id)arg1;	// IMP=0x000000000006a091
- (void)_handleResponse:(id)arg1;	// IMP=0x0000000000069cd0
- (id)initWithUserIdentifier:(id)arg1 sessionState:(id)arg2 useTokenEncryption:(_Bool)arg3 requestSession:(id)arg4;	// IMP=0x0000000000069af9
- (id)initWithRequest:(id)arg1 requestSession:(id)arg2;	// IMP=0x0000000000069a8a
