...
+ (id)new;	// IMP=0x0060000000089805
- (void).cxx_destruct;	// IMP=0x0000000000089e60
...
- (void)homeSharingGroupIDWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000008995c
- (id)initWithAccountName:(id)arg1 andPassword:(id)arg2;	// IMP=0x00000000000898a3
- (id)init;	// IMP=0x0000000000089834
