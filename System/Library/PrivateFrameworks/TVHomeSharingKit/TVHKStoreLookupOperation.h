...
+ (id)new;	// IMP=0x0060000000006df1
- (void).cxx_destruct;	// IMP=0x000000000000761d
...
- (id)_countryCode;	// IMP=0x000000000000736a
- (void)cancel;	// IMP=0x00000000000072ec
- (void)executionDidBegin;	// IMP=0x0000000000006fba
...
- (id)initWithStoreID:(unsigned long long)arg1;	// IMP=0x0000000000006e8f
