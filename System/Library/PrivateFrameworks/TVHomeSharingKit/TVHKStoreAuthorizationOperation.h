...
+ (id)new;	// IMP=0x006000000000a6a1
- (void).cxx_destruct;	// IMP=0x000000000000aebc
...
- (void)cancel;	// IMP=0x000000000000ad9f
- (void)executionDidBegin;	// IMP=0x000000000000a8de
- (id)initWithAccountIdentifier:(id)arg1 tokenData:(id)arg2 keybagPath:(id)arg3;	// IMP=0x000000000000a73f
- (id)init;	// IMP=0x000000000000a6d0
