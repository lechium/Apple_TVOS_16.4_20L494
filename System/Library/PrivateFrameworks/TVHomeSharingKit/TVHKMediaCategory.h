...
- (id)description;	// IMP=0x00000000000b20d8
- (id)_initWithType:(unsigned long long)arg1 typeString:(id)arg2;	// IMP=0x00000000000b1fed
- (id)init;	// IMP=0x00000000000b1f7e
