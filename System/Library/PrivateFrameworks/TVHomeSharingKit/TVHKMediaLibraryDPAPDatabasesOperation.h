...
- (void)_handleResponse:(id)arg1;	// IMP=0x000000000005f50e
- (id)initWithSessionState:(id)arg1 requestSession:(id)arg2;	// IMP=0x000000000005f437
- (id)initWithRequest:(id)arg1 requestSession:(id)arg2;	// IMP=0x000000000005f3c8
