...
- (void).cxx_destruct;	// IMP=0x000000000008a907
...
- (id)description;	// IMP=0x000000000008a6c9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008a254
- (unsigned long long)hash;	// IMP=0x000000000008a0a1
