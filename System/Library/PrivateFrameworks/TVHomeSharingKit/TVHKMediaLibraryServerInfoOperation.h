...
- (void).cxx_destruct;	// IMP=0x00000000000a2b78
...
- (void)_parseServerHeaderValue:(id)arg1 serverApplicationName:(id *)arg2 serverApplicationVersion:(unsigned long long *)arg3;	// IMP=0x00000000000a270a
- (void)_handleResponse:(id)arg1;	// IMP=0x00000000000a23a1
- (id)initWithAccessMode:(unsigned long long)arg1 homeSharingGroupIdentifier:(id)arg2 requestSession:(id)arg3;	// IMP=0x00000000000a22c0
- (id)initWithRequest:(id)arg1 requestSession:(id)arg2;	// IMP=0x00000000000a2251
