...
+ (id)new;	// IMP=0x0060000000037913
- (void).cxx_destruct;	// IMP=0x0000000000037eec
...
- (void)_handleResponse:(id)arg1 responseData:(id)arg2 error:(id)arg3;	// IMP=0x0000000000037df5
- (void)cancel;	// IMP=0x0000000000037d77
- (void)executionDidBegin;	// IMP=0x0000000000037b69
@property(readonly, nonatomic) unsigned long long elapsedTimeInMilliseconds;
- (id)initWithRequest:(id)arg1 session:(id)arg2;	// IMP=0x00000000000379c5
- (id)initWithRequest:(id)arg1;	// IMP=0x00000000000379b1
- (id)init;	// IMP=0x0000000000037942
