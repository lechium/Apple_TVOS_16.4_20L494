...
+ (id)_mediaEntityCollectionProperties;	// IMP=0x006000000002512c
+ (id)_mediaItemProperties;	// IMP=0x0060000000024fda
+ (void)_updateMediaCategoryDictionary:(id)arg1 withMediaItem:(id)arg2 forMediaEntityCollectionType:(unsigned long long)arg3;	// IMP=0x0060000000024b95
+ (id)new;	// IMP=0x0060000000023679
- (void).cxx_destruct;	// IMP=0x00000000000253a8
...
- (void)_finishExecution;	// IMP=0x0000000000024e82
- (void)_startSubOperation:(id)arg1;	// IMP=0x0000000000024e30
- (void)_populateMediaCategoryDictionaries;	// IMP=0x0000000000024921
- (void)_startAlbumArtistsFetchOperation;	// IMP=0x000000000002441a
- (void)_startAlbumsFetchOperation;	// IMP=0x0000000000023f77
- (void)_startMediaItemsFetchOperation;	// IMP=0x0000000000023b1b
- (void)_updateFetchRequest:(id)arg1 properties:(id)arg2;	// IMP=0x0000000000023a2d
- (void)cancel;	// IMP=0x0000000000023933
- (void)executionDidBegin;	// IMP=0x0000000000023895
- (id)initWithMediaServerIdentifier:(id)arg1 searchText:(id)arg2 fromRevision:(unsigned long long)arg3 toRevision:(unsigned long long)arg4 sessionState:(id)arg5 requestSession:(id)arg6;	// IMP=0x0000000000023717
- (id)init;	// IMP=0x00000000000236a8
