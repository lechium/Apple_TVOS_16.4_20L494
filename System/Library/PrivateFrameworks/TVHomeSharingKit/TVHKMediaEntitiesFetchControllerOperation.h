...
+ (id)new;	// IMP=0x0060000000048108
- (void).cxx_destruct;	// IMP=0x0000000000049232
...
- (void)_completeWithResultSet:(id)arg1 error:(id)arg2;	// IMP=0x0000000000049078
- (id)_resultSetWithResponses:(id)arg1;	// IMP=0x0000000000048e0c
- (void)_startChangesOperationWithMediaEntityFetchResponses:(id)arg1 currentFetchResponses:(id)arg2;	// IMP=0x0000000000048975
- (void)_handleCompletdFetchWithResponses:(id)arg1 error:(id)arg2;	// IMP=0x00000000000487cf
- (void)_startMediaServerFetchOperation;	// IMP=0x0000000000048470
- (void)cancel;	// IMP=0x0000000000048376
- (void)executionDidBegin;	// IMP=0x00000000000482d8
- (id)initWithMediaLibrary:(id)arg1 queryReason:(long long)arg2 requests:(id)arg3 sourceMediaEntity:(id)arg4;	// IMP=0x00000000000481a6
- (id)init;	// IMP=0x0000000000048137
