...
+ (id)new;	// IMP=0x006000000001bc70
- (void).cxx_destruct;	// IMP=0x000000000001bffe
...
- (id)initWithMediaItem:(id)arg1 sessionState:(id)arg2 requestSession:(id)arg3;	// IMP=0x000000000001bd0e
- (id)init;	// IMP=0x000000000001bc9f
