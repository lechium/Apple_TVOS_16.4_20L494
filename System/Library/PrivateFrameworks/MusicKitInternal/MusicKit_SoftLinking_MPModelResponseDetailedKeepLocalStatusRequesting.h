...
- (id)newOperationForDetailedKeepLocalStatusConfigurationForSectionAtIndex:(long long)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000004546
- (id)initWithModelObject:(id)arg1 children:(id)arg2;	// IMP=0x000000000000449b
