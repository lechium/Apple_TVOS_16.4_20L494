...
- (long long)_libraryAddStatusFromUnderlyingStatus:(long long)arg1;	// IMP=0x000000000000b45b
- (void)_handleUpdatedUnderlyingLibraryAddStatus:(long long)arg1;	// IMP=0x000000000000b426
@property(readonly, nonatomic) long long currentStatus;
- (id)initWithIdentifyingModelObject:(id)arg1;	// IMP=0x000000000000b014
