...
- (void)restoreStateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000000321b
- (void)becomeActive;	// IMP=0x0000000000003205
- (void)start;	// IMP=0x00000000000031ef
- (void)setStateRestorationSupported:(_Bool)arg1;	// IMP=0x00000000000031d9
- (void)setVideoSupported:(_Bool)arg1;	// IMP=0x00000000000031ad
- (void)setAudioAnalyzerEnabled:(_Bool)arg1;	// IMP=0x0000000000003181
- (void)setSystemMusicApplication:(_Bool)arg1;	// IMP=0x0000000000003155
@property(readonly, nonatomic, getter=isStarted) _Bool started;
@property(readonly, copy, nonatomic) NSString *playerID;
- (id)initWithPlayerID:(id)arg1 options:(unsigned long long)arg2 fallbackPlaybackIntent:(id)arg3;	// IMP=0x0000000000002f19
