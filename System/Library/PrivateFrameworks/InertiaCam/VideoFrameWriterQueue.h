...
- (void).cxx_destruct;	// IMP=0x000000000001e2b9
...
- (void)DrainIfAbove:(unsigned int)arg1 downTo:(unsigned int)arg2;	// IMP=0x000000000001df67
- (void)StartWatchingForFrames;	// IMP=0x000000000001dea4
- (void)FrameRequestCallback;	// IMP=0x000000000001da1b
- (id)FindFrameWithIndex:(long long)arg1;	// IMP=0x000000000001d943
- (_Bool)WaitForFinish;	// IMP=0x000000000001d6f4
- (unsigned long long)FramesInQueue;	// IMP=0x000000000001d6a5
- (void)AddAFrame:(id)arg1;	// IMP=0x000000000001d61c
- (void)dealloc;	// IMP=0x000000000001d5ed
- (id)initWithOutputURL:(id)arg1 forMovieDimensions:(struct CGSize)arg2 outputTransform:(struct CGAffineTransform)arg3 startTime:(CDStruct_1b6d18a9)arg4 endTime:(CDStruct_1b6d18a9)arg5;	// IMP=0x000000000001d1ce
