...
- (id)initWithRBSXPCCoder:(id)arg1;	// IMP=0x0000000000033c2a
- (_Bool)matchesProcess:(id)arg1;	// IMP=0x0000000000033ba8
@property(readonly, nonatomic) NSSet *processIdentifiers;
- (id)initWithIdentifiers:(id)arg1;	// IMP=0x0000000000033ac2
