...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002473d
- (void).cxx_destruct;	// IMP=0x00000000000249f1
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000024830
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000024745
