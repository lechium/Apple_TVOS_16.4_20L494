...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000002dc983
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000002dc90b
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000002dc7e1
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000547a42
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00200000005479f3
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000005479a4
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x002000000074d439
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000074d3cf
- (unsigned long long)homeManagerOptions;	// IMP=0x00100000002dc790
...
- (_Bool)_supportsFeature:(unsigned long long)arg1 forCapabilitiesKey:(id)arg2;	// IMP=0x00100000003fa9b9
- (_Bool)supportsRequestedFeature:(unsigned long long)arg1;	// IMP=0x00100000003fa9a0
- (_Bool)supportsRequiredFeature:(unsigned long long)arg1;	// IMP=0x00100000003fa987
...
- (id)userForHome:(id)arg1;	// IMP=0x0010000000957c27
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x001000000095784c
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0010000000b0821c
