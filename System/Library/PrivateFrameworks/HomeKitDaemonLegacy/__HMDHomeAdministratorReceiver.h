...
+ (id)logCategory;	// IMP=0x0010000000995fd5
- (void).cxx_destruct;	// IMP=0x0000000000995f5b
...
- (id)logIdentifier;	// IMP=0x0000000000995eaf
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)__handleXPCMessage:(id)arg1;	// IMP=0x0000000000995ce4
- (void)registerForMessage:(id)arg1 policies:(id)arg2;	// IMP=0x0000000000995bfb
- (id)shortDescription;	// IMP=0x0000000000995b81
- (void)dealloc;	// IMP=0x0000000000995ac4
- (id)initWithReceiver:(id)arg1 handler:(id)arg2;	// IMP=0x0000000000995a29
