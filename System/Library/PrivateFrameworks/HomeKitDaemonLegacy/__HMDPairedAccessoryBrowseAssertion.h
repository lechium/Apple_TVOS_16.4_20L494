...
- (void).cxx_destruct;	// IMP=0x00000000008972f4
@property(readonly) __weak HMDAccessoryBrowser *accessoryBrowser; // @synthesize accessoryBrowser=_accessoryBrowser;
- (void)invalidate;	// IMP=0x0000000000897260
- (id)initWithAccessoryBrowser:(id)arg1 reason:(id)arg2;	// IMP=0x000000000089712d
- (id)initWithName:(id)arg1;	// IMP=0x0000000000897077
