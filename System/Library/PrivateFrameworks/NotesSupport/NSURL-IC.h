...
@interface NSURL (IC)
+ (id)ic_urlFromWeblocFileAtURL:(id)arg1;	// IMP=0x002000000001818f
...
- (_Bool)ic_isSafeFileURLForAttachment;	// IMP=0x0010000000017d92
...
- (void)ic_updateFlagToExcludeFromBackup:(_Bool)arg1;	// IMP=0x001000000001757c
- (id)ic_dedupedURLWithProhibitedNames:(id)arg1;	// IMP=0x00100000000172d5
- (void)ic_updateFlagToExcludeFromBackupNow:(_Bool)arg1;	// IMP=0x0010000000018197
@end
