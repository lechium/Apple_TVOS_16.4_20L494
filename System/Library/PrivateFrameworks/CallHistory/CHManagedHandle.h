...
+ (id)managedHandlesForHandles:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000becb
+ (id)managedHandleForHandle:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000bc62
+ (id)fetchRequest;	// IMP=0x008000000000d5b5
- (id)copyWithContext:(id)arg1;	// IMP=0x000000000000c19d
