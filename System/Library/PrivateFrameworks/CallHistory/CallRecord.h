...
+ (id)fetchRequest;	// IMP=0x008000000001b029
...
- (_Bool)supportsJunkConfidence;	// IMP=0x0000000000008ccc
...
- (id)compositeVerificationStatusForContext:(id)arg1;	// IMP=0x0000000000008af5
- (id)compositeServiceProviderForContext:(id)arg1;	// IMP=0x0000000000008a57
- (id)compositeRemoteParticipantHandlesForContext:(id)arg1;	// IMP=0x00000000000087c9
- (id)compositeParticipantGroupUUIDForContext:(id)arg1;	// IMP=0x0000000000008785
- (id)compositeOutgoingLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x0000000000008741
- (id)compositeLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x00000000000086fd
- (id)compositeJunkConfidenceForContext:(id)arg1;	// IMP=0x000000000000869d
- (id)compositeHandleTypeForContext:(id)arg1;	// IMP=0x0000000000008668
- (id)compositeCallCategoryForContext:(id)arg1;	// IMP=0x00000000000085b4
