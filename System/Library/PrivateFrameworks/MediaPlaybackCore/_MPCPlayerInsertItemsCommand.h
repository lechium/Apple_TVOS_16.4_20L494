...
- (void).cxx_destruct;	// IMP=0x0000000000290d05
...
- (_Bool)_isSupportedPlaybackIntent:(id)arg1 forRemotePlayer:(_Bool)arg2 atInsertionPosition:(int)arg3;	// IMP=0x0000000000290921
- (id)_createRadioStationCommandRequest;	// IMP=0x0000000000290764
- (id)_insertWithOptions:(id)arg1;	// IMP=0x0000000000290538
- (id)insertAtEndOfTracklistWithPlaybackIntent:(id)arg1;	// IMP=0x00000000002903db
- (id)insertPlaybackIntent:(id)arg1 afterItem:(id)arg2;	// IMP=0x00000000002901b5
- (id)insertAfterPlayingItemWithPlaybackIntent:(id)arg1;	// IMP=0x000000000028fd44
