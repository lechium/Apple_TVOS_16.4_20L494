...
- (void).cxx_destruct;	// IMP=0x000000000028fcf1
...
- (id)replaceWithPlaybackIntent:(id)arg1 replaceIntent:(long long)arg2;	// IMP=0x000000000028f753
- (id)replaceWithPlaybackIntent:(id)arg1;	// IMP=0x000000000028f73c
- (id)clearUpNextItems;	// IMP=0x000000000028f5e6
- (id)clear;	// IMP=0x000000000028f404
