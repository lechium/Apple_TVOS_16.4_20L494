...
- (void).cxx_destruct;	// IMP=0x0000000000312738
...
- (unsigned long long)reportingEventType;	// IMP=0x0000000000312702
- (_Bool)isValidReportingEvent;	// IMP=0x00000000003126f4
