...
- (void).cxx_destruct;	// IMP=0x000000000031891d
...
- (void)recordLyricsViewEvent:(id)arg1;	// IMP=0x00000000003188d6
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x0000000000318858
