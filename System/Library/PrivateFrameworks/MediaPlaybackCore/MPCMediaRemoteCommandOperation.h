...
- (void).cxx_destruct;	// IMP=0x000000000020f4a2
...
- (void)execute;	// IMP=0x000000000020e582
- (id)initWithCommandRequest:(id)arg1 options:(unsigned long long)arg2 sendDate:(id)arg3;	// IMP=0x000000000020e4cd
