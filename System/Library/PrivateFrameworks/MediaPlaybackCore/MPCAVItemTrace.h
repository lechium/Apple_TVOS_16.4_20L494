...
+ (id)traceIntervalWithName:(id)arg1 item:(id)arg2 beginEvent:(unsigned int)arg3 endEvent:(unsigned int)arg4;	// IMP=0x006000000031e775
+ (void)traceWithName:(id)arg1 item:(id)arg2 event:(unsigned int)arg3;	// IMP=0x006000000031e691
- (void).cxx_destruct;	// IMP=0x000000000031e66b
...
- (void)cancel;	// IMP=0x000000000031e45b
- (void)endInterval;	// IMP=0x000000000031e2cb
- (void)dealloc;	// IMP=0x000000000031e28d
