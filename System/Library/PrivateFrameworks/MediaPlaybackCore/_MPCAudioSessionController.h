...
- (void).cxx_destruct;	// IMP=0x000000000014852b
...
- (void)tearDownObservations;	// IMP=0x00000000001483ca
- (void)setupObservations;	// IMP=0x00000000001481aa
- (void)restoreSessionSettingsFromSnapshot;	// IMP=0x000000000014813c
- (void)snapshotSessionSettings;	// IMP=0x000000000014804f
- (void)updateAudioSession:(id)arg1 options:(unsigned long long)arg2 routeSharingPolicy:(unsigned long long)arg3;	// IMP=0x0000000000147fc0
- (void)dealloc;	// IMP=0x0000000000147f82
- (id)init;	// IMP=0x0000000000147ef5
