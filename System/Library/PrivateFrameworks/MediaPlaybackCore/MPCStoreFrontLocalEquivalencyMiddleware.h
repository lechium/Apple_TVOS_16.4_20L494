...
- (void).cxx_destruct;	// IMP=0x0000000000312a0f
...
- (id)_stateDumpObject;	// IMP=0x0000000000312871
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x00000000003127b5
- (id)operationsForRequest:(id)arg1;	// IMP=0x0000000000312748
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x0000000000312a42
