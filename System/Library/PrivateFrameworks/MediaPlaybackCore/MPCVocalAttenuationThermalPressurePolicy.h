...
- (void).cxx_destruct;	// IMP=0x0000000000229bf6
...
- (void)updateEvaluationWithReason:(id)arg1;	// IMP=0x0000000000229a2b
- (void)thermalStateDidChange:(long long)arg1;	// IMP=0x00000000002297d5
- (void)environmentMonitorDidChangeThermalLevel:(id)arg1;	// IMP=0x000000000022977c
- (id)evaluation;	// IMP=0x000000000022967b
- (void)reset;	// IMP=0x0000000000229675
@property(readonly, nonatomic) _Bool canBeReset;
- (id)initWithThermalMonitor:(id)arg1 calloutQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000000022955d
- (id)initWithCalloutQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000002294c6
