...
- (void).cxx_destruct;	// IMP=0x0000000000147d30
...
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x0000000000147c3e
- (id)operationsForRequest:(id)arg1;	// IMP=0x0000000000147bd1
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x0000000000147d58
