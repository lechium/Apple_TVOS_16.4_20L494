...
- (void).cxx_destruct;	// IMP=0x00000000002aa1b4
...
- (id)changeValue:(_Bool)arg1;	// IMP=0x00000000002a9f57
- (id)initWithResponse:(id)arg1 mediaRemoteCommand:(unsigned int)arg2;	// IMP=0x00000000002a9f15
