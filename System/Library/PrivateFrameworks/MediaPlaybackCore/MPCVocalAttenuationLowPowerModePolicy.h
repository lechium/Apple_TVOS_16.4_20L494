...
- (void)updateEvaluationWithReason:(id)arg1;	// IMP=0x000000000022a0f3
- (void)powerModeDidChange:(_Bool)arg1;	// IMP=0x0000000000229f93
- (void)processInfoPowerStateDidChange:(id)arg1;	// IMP=0x0000000000229f5e
- (id)evaluation;	// IMP=0x0000000000229e5e
- (void)reset;	// IMP=0x0000000000229e58
@property(readonly, nonatomic) _Bool canBeReset;
- (id)initWithPowerModeMonitor:(id)arg1 calloutQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000000229d13
- (id)initWithCalloutQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000229c7c
