...
- (void).cxx_destruct;	// IMP=0x00000000002c7c26
...
- (void)_onQueue_flush;	// IMP=0x00000000002c7417
- (void)subscribeToEventType:(id)arg1 options:(unsigned long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000002c70a9
- (void)subscribeToEventType:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002c7092
- (void)flushEventsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002c6ea1
- (void)cancelSubscription;	// IMP=0x00000000002c6d26
@property(readonly, copy) NSString *debugDescription;
- (id)initWithConsumer:(id)arg1 eventStream:(id)arg2;	// IMP=0x00000000002c6abb
