...
+ (id)enumeratorWithMusicBehavior:(id)arg1 mode:(long long)arg2 options:(unsigned long long)arg3 startPosition:(id)arg4 endPosition:(id)arg5;	// IMP=0x00600000001f8270
- (void).cxx_destruct;	// IMP=0x00000000001f8144
...
- (void)_buildEnumerator;	// IMP=0x00000000001f7b33
- (id)_init;	// IMP=0x00000000001f7b04
- (id)nextObject;	// IMP=0x00000000001f7a4b
