...
- (void).cxx_destruct;	// IMP=0x00000000002aacc8
...
- (id)_seekCommandWithMediaRemoteCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00000000002aaa9f
- (id)changePositionToElapsedInterval:(double)arg1;	// IMP=0x00000000002aa9ce
- (id)jumpByInterval:(double)arg1;	// IMP=0x00000000002aa838
- (id)endSeek;	// IMP=0x00000000002aa7f3
- (id)beginSeekWithDirection:(long long)arg1;	// IMP=0x00000000002aa792
- (id)initWithResponse:(id)arg1 seekSupport:(unsigned long long)arg2;	// IMP=0x00000000002aa74e
