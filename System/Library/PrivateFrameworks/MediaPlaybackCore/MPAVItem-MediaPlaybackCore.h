...
- (_Bool)_isInContiguousAlbumWith:(id)arg1;	// IMP=0x00200000002b7904
- (_Bool)shouldPerformCrossFadeTransitionWith:(id)arg1;	// IMP=0x00200000002b78b6
- (_Bool)shouldPerformGaplessTransitionWith:(id)arg1;	// IMP=0x00200000002b7868
...
- (void)reset;	// IMP=0x00200000002b7721
- (void)setCurrentItemTransition:(long long)arg1;	// IMP=0x00200000002b76ef
