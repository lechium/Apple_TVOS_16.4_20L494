...
- (void).cxx_destruct;	// IMP=0x0000000000297034
...
- (id)itemAtIndexPath:(id)arg1;	// IMP=0x0000000000296f3a
- (unsigned long long)numberOfItemsInSection:(unsigned long long)arg1;	// IMP=0x0000000000296e45
- (id)sectionAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000296dba
- (unsigned long long)numberOfSections;	// IMP=0x0000000000296d3f
- (id)displayIndexPathForStructuredIndexPath:(id)arg1;	// IMP=0x00000000002967c0
- (id)structuredIndexPathForDisplayIndexPath:(id)arg1;	// IMP=0x00000000002964b2
- (id)initWithTracklistItems:(id)arg1 playingItemIndexPath:(id)arg2;	// IMP=0x0000000000295b8f
