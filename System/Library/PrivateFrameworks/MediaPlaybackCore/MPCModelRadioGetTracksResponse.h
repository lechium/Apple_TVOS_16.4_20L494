...
- (void).cxx_destruct;	// IMP=0x00000000002d81c8
...
- (id)description;	// IMP=0x00000000002d80ca
- (id)initWithTracks:(id)arg1 tracklistAction:(long long)arg2;	// IMP=0x00000000002d804c
