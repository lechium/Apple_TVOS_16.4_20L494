...
+ (id)packageTypeIdentifier;	// IMP=0x006000000030ac6f
- (void).cxx_destruct;	// IMP=0x000000000030ac1c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000030a929
- (unsigned long long)hash;	// IMP=0x000000000030a8e5
- (_Bool)writeWithError:(id *)arg1;	// IMP=0x0000000000309515
- (_Bool)saveWithError:(id *)arg1;	// IMP=0x00000000003093c5
- (id)description;	// IMP=0x000000000030937d
- (id)initWithURL:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000309227
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000309164
