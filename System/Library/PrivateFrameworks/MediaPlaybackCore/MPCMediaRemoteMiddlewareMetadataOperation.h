...
- (void).cxx_destruct;	// IMP=0x000000000015b2f4
...
- (id)_itemGenericObjectPropertySetForContentItem:(id)arg1 propertySet:(id)arg2;	// IMP=0x000000000015ac57
- (id)_genericObjectPropertySetForContentItem:(id)arg1 preferredRelationships:(id)arg2 propertySet:(id)arg3;	// IMP=0x000000000015a740
- (struct _MSVSignedRange)rangeFromTracklistRange:(CDStruct_912cb5d2)arg1;	// IMP=0x000000000015a71c
@property(readonly, nonatomic) NSArray *outputProtocols;
@property(readonly, nonatomic) NSArray *inputProtocols;
- (id)timeoutDescription;	// IMP=0x000000000015a571
- (void)execute;	// IMP=0x000000000015a4aa
- (void)_loadPlayingIdentifierWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000015a28c
- (void)_loadItemsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000159d00
- (id)initWithMiddleware:(id)arg1 request:(id)arg2;	// IMP=0x0000000000159c5e
