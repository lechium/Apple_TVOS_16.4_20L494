...
- (void).cxx_destruct;	// IMP=0x00000000001ab666
...
- (id)flushSamplesToCSVDataWithHeader:(_Bool)arg1;	// IMP=0x00000000001ab504
- (id)dictionaryRepresentation;	// IMP=0x00000000001ab3ff
- (id)description;	// IMP=0x00000000001ab346
@property(readonly, nonatomic) int numberOfSamples;
- (void)recordSample:(id)arg1;	// IMP=0x00000000001ab2b2
- (id)initWithRecordID:(id)arg1 modelID:(id)arg2 firstFailureDetector:(id)arg3 shouldStoreSamples:(_Bool)arg4 delegate:(id)arg5;	// IMP=0x00000000001ab11f
