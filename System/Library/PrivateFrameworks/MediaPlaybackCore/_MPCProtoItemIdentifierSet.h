...
- (void).cxx_destruct;	// IMP=0x00000000001b2179
- (unsigned long long)hash;	// IMP=0x00000000001b206c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b1e94
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b1d33
- (void)writeTo:(id)arg1;	// IMP=0x00000000001b1c0a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001b1bfd
- (id)dictionaryRepresentation;	// IMP=0x00000000001b198e
- (id)description;	// IMP=0x00000000001b18df
