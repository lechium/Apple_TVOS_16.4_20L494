...
- (void).cxx_destruct;	// IMP=0x00000000002cc268
...
- (void)invalidate;	// IMP=0x00000000002cc024
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000002cbf99
- (id)initWithEventStream:(id)arg1 type:(long long)arg2 reason:(id)arg3 timeout:(double)arg4;	// IMP=0x00000000002cbdf9
