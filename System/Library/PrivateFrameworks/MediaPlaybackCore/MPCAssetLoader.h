...
- (void).cxx_destruct;	// IMP=0x0000000000207db2
...
- (void)cancelLoading;	// IMP=0x0000000000207d29
- (void)loadAssetFor:(id)arg1 token:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000207a91
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000002079cd
