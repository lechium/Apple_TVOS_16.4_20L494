...
+ (id)identifier;	// IMP=0x0010000000181e82
- (void).cxx_destruct;	// IMP=0x0000000000184bf7
...
- (id)_playbackBarWithElapsedTime:(double)arg1 duration:(double)arg2;	// IMP=0x0000000000184a12
- (_Bool)_logAccountEvent:(id)arg1 subscription:(id)arg2 cursor:(id)arg3;	// IMP=0x000000000018420e
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x00000000001841d5
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x0000000000181e8f
