...
- (void).cxx_destruct;	// IMP=0x00000000002f8abb
@property(readonly, nonatomic) ICSuzeLeaseSession *icSuzeLeaseSession; // @synthesize icSuzeLeaseSession=_icSuzeLeaseSession;
- (void)endAutomaticallyRefreshingLease;	// IMP=0x00000000002f8a9b
- (void)beginAutomaticallyRefreshingLease;	// IMP=0x00000000002f8a85
- (id)initWithICSuzeLeaseSession:(id)arg1;	// IMP=0x00000000002f8a1a
