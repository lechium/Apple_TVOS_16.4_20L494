...
- (void).cxx_destruct;	// IMP=0x000000000024eaff
@property(copy, nonatomic) MPSectionedCollection *radioStationTracks; // @synthesize radioStationTracks=_radioStationTracks;
- (void)dealloc;	// IMP=0x000000000024ea48
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2;	// IMP=0x000000000024e8e7
