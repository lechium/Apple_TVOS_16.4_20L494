...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002001e5
+ (id)payloadValueFromJSONValue:(id)arg1;	// IMP=0x00100000002f7a5c
- (void).cxx_destruct;	// IMP=0x000000000020004c
...
- (id)_copyWithClass:(Class)arg1 zone:(struct _NSZone *)arg2;	// IMP=0x00000000001fff53
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001fff20
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001ffe58
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ffce6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ffcdb
- (id)initWithStoreAccountID:(unsigned long long)arg1 deviceGUID:(id)arg2;	// IMP=0x00000000001ffc5d
- (id)mpc_jsonValue;	// IMP=0x00000000002f50a4
