...
- (void).cxx_destruct;	// IMP=0x000000000031cd14
...
- (void)_presentServerDialog:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000031cb38
- (void)_performDefaultHandlingForButtonAction:(id)arg1;	// IMP=0x000000000031caaf
- (void)_fireAndForgetServerDialog:(id)arg1;	// IMP=0x000000000031ca63
- (void)performWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000031ca52
- (id)nextStepWithError:(id)arg1;	// IMP=0x000000000031c9d3
- (id)initWithPreviousStep:(id)arg1;	// IMP=0x000000000031c947
- (id)initWithGetTracksRequest:(id)arg1 siriAssetInfo:(id)arg2;	// IMP=0x000000000031c4d5
