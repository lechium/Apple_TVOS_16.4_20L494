...
- (void)analyzeAudioData:(void *)arg1 numberFrames:(unsigned int)arg2 observers:(id)arg3;	// IMP=0x0000000000143e05
- (void)analyzeFrequencies:(struct AudioBufferList *)arg1 numberFrames:(unsigned long long)arg2 observers:(id)arg3;	// IMP=0x0000000000143d2c
- (void)_freeBuffers;	// IMP=0x0000000000143cf0
- (void)_destroyFFTSetup;	// IMP=0x0000000000143cca
- (void)_prepareBuffers;	// IMP=0x0000000000143c75
- (void)dealloc;	// IMP=0x0000000000143c22
- (id)initWithMaximumNumberOfFrames:(long long)arg1 sampleRate:(float)arg2;	// IMP=0x0000000000143b83
