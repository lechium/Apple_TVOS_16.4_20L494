...
- (void)resetWithReason:(id)arg1;	// IMP=0x000000000004a3a0
- (void)setRelativeVolume:(float)arg1;	// IMP=0x000000000004b730
- (void)setSpatializationFormat:(long long)arg1;	// IMP=0x000000000004b700
