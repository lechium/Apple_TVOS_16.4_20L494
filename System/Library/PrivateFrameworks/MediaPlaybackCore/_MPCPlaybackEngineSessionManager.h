...
+ (id)archivesAtURL:(id)arg1;	// IMP=0x0010000000346774
- (void).cxx_destruct;	// IMP=0x000000000034596f
...
- (id)_playbackSessionsDirectory;	// IMP=0x000000000034583b
@property(retain, nonatomic) NSString *stateRestorationSessionIdentifier;
- (void)deleteSessionWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000034554d
- (void)saveSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000344c84
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x0000000000344afa
