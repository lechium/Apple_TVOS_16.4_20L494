...
- (void).cxx_destruct;	// IMP=0x00000000002080a8
...
- (id)stringRepresentation;	// IMP=0x0000000000208042
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000207f8f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000207ed8
- (id)initWithIdentifier:(id)arg1 artworkProperties:(id)arg2 artworkIdentifier:(id)arg3;	// IMP=0x0000000000207df2
