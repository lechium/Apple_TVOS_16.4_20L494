...
+ (id)sharedController;	// IMP=0x0040000000232c2b
- (void).cxx_destruct;	// IMP=0x0000000000232a9b
@property(retain, nonatomic) NSDate *lastCDNWarming; // @synthesize lastCDNWarming=_lastCDNWarming;
- (void)loadAVAssetWithURL:(id)arg1;	// IMP=0x0000000000232944
- (void)markCDNConnectionWarmed;	// IMP=0x00000000002328de
- (void)warmCDNConnection;	// IMP=0x0000000000232699
- (id)trialExperimentWithNamespaceName:(id)arg1;	// IMP=0x00000000002325a3
...
- (id)sortedExperiments;	// IMP=0x0000000000232336
- (id)init;	// IMP=0x00000000002322c9
