...
- (void).cxx_destruct;	// IMP=0x00000000002ae198
- (unsigned long long)hash;	// IMP=0x00000000002add63
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002ad943
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002ad65d
- (void)writeTo:(id)arg1;	// IMP=0x00000000002ad3d8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002ad3cb
- (id)dictionaryRepresentation;	// IMP=0x00000000002ace8a
- (id)description;	// IMP=0x00000000002acddb
