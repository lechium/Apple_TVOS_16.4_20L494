...
+ (id)playMetricsWithErrorSignature:(id)arg1 event:(id)arg2 cursor:(id)arg3;	// IMP=0x0060000000343a77
+ (id)playMetricsWithFirstFrameEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x0060000000340cd5
- (void).cxx_destruct;	// IMP=0x0000000000340260
@property(retain, nonatomic) NSMutableDictionary *data; // @synthesize data=_data;
- (void)addEnvironmentInfoWithCursor:(id)arg1;	// IMP=0x0000000000340199
- (void)addAssetLoadInfoWithCursor:(id)arg1 itemIDPayload:(id)arg2;	// IMP=0x000000000033f557
- (void)addSessionActivationTimesWithScopedCursor:(id)arg1;	// IMP=0x000000000033f269
- (void)addNetworkTimesWithScopedCursor:(id)arg1;	// IMP=0x000000000033efde
- (void)addSharePlayWithCursor:(id)arg1;	// IMP=0x000000000033eef0
- (void)addPlaybackBehaviorWithCursor:(id)arg1;	// IMP=0x000000000033ed06
- (void)addQueueMetadata:(id)arg1;	// IMP=0x000000000033ec58
- (id)jsonObject;	// IMP=0x000000000033d968
- (id)description;	// IMP=0x000000000033d75a
- (id)dictionaryRepresentation;	// IMP=0x000000000033d712
...
- (id)init;	// IMP=0x000000000033cc32
