...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0030000000002aeb
- (void)sendPersonalizedAdsStatusToAdPlatforms:(CDUnknownBlockType)arg1;	// IMP=0x0030000000002a50
- (void)sendSegmentDataToAdPlatforms:(CDUnknownBlockType)arg1;	// IMP=0x00300000000029b5
- (void)retrieveSegmentDataFromiTunes:(CDUnknownBlockType)arg1;	// IMP=0x0030000000002919
- (_Bool)isActiveRecord;	// IMP=0x003000000000285b
- (void)resetiAdIDsAndDPID:(CDUnknownBlockType)arg1;	// IMP=0x00300000000026f3
- (void)resetDeviceNewsPlusSubscriberIDIfNeeded;	// IMP=0x0030000000002378
- (void)resetiAdIDs;	// IMP=0x0030000000001f7d
- (void)ensureiAdIDs;	// IMP=0x0030000000001b63
- (void)removeIDForClientType:(long long)arg1;	// IMP=0x0030000000001a22
- (_Bool)hasIDForClientType:(long long)arg1;	// IMP=0x0030000000001955
