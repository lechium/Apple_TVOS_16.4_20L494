...
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000005a1b
- (id)remoteObjectProxyWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000059db
- (id)remoteObjectProxy;	// IMP=0x000000000000599d
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000000584f
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000000000057f3
- (void)dealloc;	// IMP=0x000000000000578d
- (id)initWithConnection:(id)arg1 interface:(id)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000056ec
