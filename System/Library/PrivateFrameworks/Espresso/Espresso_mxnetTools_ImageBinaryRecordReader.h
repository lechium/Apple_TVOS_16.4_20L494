...
- (void).cxx_destruct;	// IMP=0x000000000077db87
...
- (struct _mxnetTools_imageID_t_)imageID;	// IMP=0x000000000077da36
- (id)labels;	// IMP=0x000000000077d93b
- (id)imageData;	// IMP=0x000000000077d7d2
- (_Bool)nextRecordAndError:(id *)arg1;	// IMP=0x000000000077d2f8
- (_Bool)seekRecordWithID:(struct _mxnetTools_imageID_t_ *)arg1 error:(id *)arg2;	// IMP=0x000000000077d1fb
- (id)initWithRecFile:(id)arg1 error:(id *)arg2;	// IMP=0x000000000077cf2f
