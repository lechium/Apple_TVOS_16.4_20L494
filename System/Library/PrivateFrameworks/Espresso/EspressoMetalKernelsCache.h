...
- (id).cxx_construct;	// IMP=0x00000000007ed3f9
- (void).cxx_destruct;	// IMP=0x00000000007ed380
...
- (_Bool)shouldUseTexArray;	// IMP=0x00000000007ed336
- (id)kernelForFunction:(const char *)arg1 cacheString:(const char *)arg2 withConstants:(id)arg3;	// IMP=0x00000000007ec1d7
- (id)kernelForFunction:(const char *)arg1;	// IMP=0x00000000007ec1c0
- (void)addLibraryAtPath:(id)arg1;	// IMP=0x00000000007ebfca
- (void)loadLibraryNamed:(id)arg1;	// IMP=0x00000000007ebd9a
- (_Bool)wasSetup;	// IMP=0x00000000007ebd8c
- (void)lazySetup;	// IMP=0x00000000007eb53d
- (id)initWithDevice:(id)arg1;	// IMP=0x00000000007eb408
