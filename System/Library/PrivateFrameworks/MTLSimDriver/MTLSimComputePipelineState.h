...
- (id)pipelineBinaries;	// IMP=0x000000000000dfb0
- (unsigned int)pipelineRef;	// IMP=0x000000000000dfa0
- (void)dealloc;	// IMP=0x000000000000dec6
@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x000000000000dccd
