...
- (unsigned long long)constantOffsetAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000001056
- (unsigned long long)alignment;	// IMP=0x0000000000001045
- (unsigned long long)encodedLength;	// IMP=0x0000000000001034
- (_Bool)bufferLayoutMatchesFrontEndLayout;	// IMP=0x0000000000001024
- (void)dealloc;	// IMP=0x0000000000000f4f
- (id)initWithDevice:(id)arg1 reference:(unsigned int)arg2 data:(CDStruct_146dae35 *)arg3;	// IMP=0x0000000000000eb0
