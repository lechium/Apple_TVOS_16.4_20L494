...
- (id).cxx_construct;	// IMP=0x00000000000073d7
...
- (id)newIntersectionFunctionTableWithDescriptor:(id)arg1;	// IMP=0x00000000000072fd
- (id)newVisibleFunctionTableWithDescriptor:(id)arg1;	// IMP=0x00000000000072f5
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3 sparsePageSize:(long long)arg4;	// IMP=0x00000000000072de
...
- (id)newSharedEventWithMachPort:(unsigned int)arg1;	// IMP=0x0000000000006fc8
- (id)newSharedEventWithHandle:(id)arg1;	// IMP=0x0000000000006cb5
- (id)newSharedEvent;	// IMP=0x0000000000006aa3
- (id)newEvent;	// IMP=0x0000000000006a91
...
- (id)newRasterizationRateMapWithDescriptor:(id)arg1;	// IMP=0x0000000000006a6d
- (_Bool)supportsRasterizationRateMapWithLayerCount:(unsigned long long)arg1;	// IMP=0x0000000000006a65
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000006a44
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006a23
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000069ff
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000069db
- (id)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000069b7
- (void)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000006996
- (unsigned long long)minimumTextureBufferAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x000000000000682d
- (unsigned long long)minimumLinearTextureAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x000000000000666a
- (id)newBufferWithIOSurface:(struct __IOSurface *)arg1;	// IMP=0x000000000000663f
- (_Bool)setResourcesPurgeableState:(id *)arg1 newState:(unsigned long long)arg2 oldState:(unsigned long long *)arg3 count:(int)arg4;	// IMP=0x0000000000006637
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x00000000000064b1
- (id)vendorName;	// IMP=0x00000000000064a4
- (_Bool)supportsSampleCount:(unsigned long long)arg1;	// IMP=0x000000000000648e
- (int)llvmVersion;	// IMP=0x0000000000006483
- (id)productName;	// IMP=0x0000000000006476
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 descriptor:(id)arg3 offset:(unsigned long long)arg4 bytesPerRow:(unsigned long long)arg5;	// IMP=0x0000000000006452
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 deallocator:(CDUnknownBlockType)arg3 descriptor:(id)arg4 offset:(unsigned long long)arg5 bytesPerRow:(unsigned long long)arg6;	// IMP=0x000000000000642e
- (id)newIndirectRenderCommandEncoderWithBuffer:(id)arg1;	// IMP=0x000000000000640a
- (id)newIndirectComputeCommandEncoderWithBuffer:(id)arg1;	// IMP=0x00000000000063e6
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x00000000000063c2
- (id)newArgumentEncoderWithLayout:(id)arg1;	// IMP=0x000000000000614c
- (id)newIndirectArgumentBufferLayoutWithStructType:(id)arg1;	// IMP=0x0000000000005f06
- (id)familyName;	// IMP=0x0000000000005ef9
- (id)newComputePipelineWithDescriptor:(id)arg1 variant:(id)arg2 errorMessage:(id *)arg3;	// IMP=0x0000000000005c1b
- (id)newComputeVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000005c04
- (id)wrapComputeState:(id)arg1 descriptor:(id)arg2;	// IMP=0x0000000000005be0
- (id)pipelinePerformanceStatisticsWithComputeVariant:(id)arg1 compileTimeOutput:(id)arg2;	// IMP=0x0000000000005b71
- (id)pipelinePerformanceStatisticsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2 vertexCompileTimeOutput:(id)arg3 fragmentCompileTimeOutput:(id)arg4;	// IMP=0x0000000000005a58
- (CDStruct_04792461)pipelineFlagsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2;	// IMP=0x0000000000005a50
- (id)newRenderPipelineWithDescriptor:(id)arg1 vertexVariant:(id)arg2 fragmentVariant:(id)arg3 errorMessage:(id *)arg4;	// IMP=0x00000000000057d0
- (id)newVertexVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x00000000000057b9
- (id)newFragmentVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x00000000000057a2
- (id)newFunctionVariantWithCompilerOutput:(id)arg1 functionType:(unsigned long long)arg2;	// IMP=0x00000000000054ca
- (id)reportLeaks;	// IMP=0x00000000000053e7
- (void)freeVertexFunctionKey:(void *)arg1 vertexKeySize:(unsigned long long)arg2;	// IMP=0x00000000000053e1
- (void)freeFragmentFunctionKey:(void *)arg1 fragmentKeySize:(unsigned long long)arg2;	// IMP=0x00000000000053db
- (void *)vertexFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 nextStageVariant:(id)arg3 vertexKeySize:(unsigned long long *)arg4;	// IMP=0x00000000000053cc
- (void *)fragmentFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 previousStateVariant:(id)arg3 fragmentKeySize:(unsigned long long *)arg4;	// IMP=0x00000000000053bd
- (id)wrapRenderState:(id)arg1 descriptor:(id)arg2;	// IMP=0x0000000000005399
- (void)registerViewTexture:(id)arg1 baseTextureView:(id)arg2;	// IMP=0x0000000000005393
@property(readonly) _Bool deserializerSupportsSharedTextures;
- (id)newTextureWithDescriptor:(id)arg1 iosurface:(struct __IOSurface *)arg2 plane:(unsigned long long)arg3;	// IMP=0x0000000000004f78
- (id)newTextureWithDescriptor:(id)arg1;	// IMP=0x0000000000004caa
- (id)newSamplerStateWithDescriptor:(id)arg1;	// IMP=0x0000000000004b62
- (void)dispatchNotificationWithReference:(unsigned int)arg1;	// IMP=0x0000000000004a41
- (void)registerEventNotification:(unsigned int)arg1 listener:(id)arg2 event:(id)arg3 value:(unsigned long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000000004960
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCommandCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x000000000000493c
- (id)newHeapWithDescriptor:(id)arg1;	// IMP=0x00000000000046c6
- (id)newFence;	// IMP=0x0000000000004431
- (id)newDepthStencilStateWithDescriptor:(id)arg1;	// IMP=0x00000000000042e9
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000000042c0
- (id)newBufferWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 deallocator:(CDUnknownBlockType)arg4;	// IMP=0x0000000000004292
- (id)newBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x000000000000425d
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 pointer:(void *)arg3 copyBytes:(_Bool)arg4 deallocator:(CDUnknownBlockType)arg5;	// IMP=0x0000000000003fa2
- (void)releaseCommandBufferRef:(unsigned int)arg1;	// IMP=0x0000000000003eed
- (unsigned int)registerCommandBuffer:(id)arg1;	// IMP=0x0000000000003d5a
- (id)commandBufferForReference:(unsigned int)arg1;	// IMP=0x0000000000003bed
- (CDStruct_4bcfbbae)heapTextureSizeAndAlignWithDescriptor:(id)arg1;	// IMP=0x0000000000003974
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3;	// IMP=0x0000000000003937
- (CDStruct_4bcfbbae)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000000037a1
- (unsigned int)getNewResourceID;	// IMP=0x000000000000378e
- (id)compiler;	// IMP=0x0000000000003665
- (id)_deviceWrapper;	// IMP=0x000000000000363b
- (void)_setDeviceWrapper:(id)arg1;	// IMP=0x000000000000362a
- (void)dealloc;	// IMP=0x0000000000003531
- (id)init;	// IMP=0x0000000000002c29
...
- (_Bool)supportsVertexAmplificationCount:(unsigned long long)arg1;	// IMP=0x00000000000028ac
