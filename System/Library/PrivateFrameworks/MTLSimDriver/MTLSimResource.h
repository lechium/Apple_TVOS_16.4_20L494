...
- (void)setHeapOffset:(unsigned long long)arg1;	// IMP=0x000000000001324d
- (void)waitUntilComplete;	// IMP=0x0000000000013247
- (_Bool)isPurgeable;	// IMP=0x000000000001323f
- (_Bool)isComplete;	// IMP=0x0000000000013237
- (_Bool)doesAliasResource:(id)arg1;	// IMP=0x0000000000013207
- (_Bool)doesAliasAnyResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x00000000000131f2
- (_Bool)doesAliasAllResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x00000000000131da
- (_Bool)doesAliasResources:(const id *)arg1 count:(unsigned long long)arg2 all:(_Bool)arg3;	// IMP=0x0000000000013089
...
- (unsigned long long)setPurgeableState:(unsigned long long)arg1;	// IMP=0x0000000000012fed
- (void)makeAliasable;	// IMP=0x0000000000012f4f
- (_Bool)isAliasable;	// IMP=0x0000000000012f46
@property(readonly) id <MTLHeap> heap; // @dynamic heap;
@property(copy) NSString *label; // @dynamic label;
- (id)retainedLabel;	// IMP=0x0000000000012eef
@property(readonly) id <MTLDevice> device; // @dynamic device;
- (void)dealloc;	// IMP=0x0000000000012e24
- (id)initWithResourceRef:(unsigned int)arg1 options:(unsigned long long)arg2 device:(id)arg3 heap:(id)arg4;	// IMP=0x0000000000012d87
