...
- (id)pipelineBinaries;	// IMP=0x0000000000012d7a
- (unsigned long long)imageblockMemoryLengthForDimensions:(CDStruct_da2e99ad)arg1;	// IMP=0x0000000000012d72
@property(readonly) unsigned long long imageblockSampleLength;
- (unsigned int)getVertexShaderTelemetryID;	// IMP=0x0000000000012d62
- (unsigned int)getFragmentShaderTelemetryID;	// IMP=0x0000000000012d5a
- (id)newVertexShaderDebugInfo;	// IMP=0x0000000000012d52
- (id)newFragmentShaderDebugInfo;	// IMP=0x0000000000012d4a
- (unsigned int)pipelineRef;	// IMP=0x0000000000012d3a
@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (void)dealloc;	// IMP=0x0000000000012ad3
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x0000000000012a67
