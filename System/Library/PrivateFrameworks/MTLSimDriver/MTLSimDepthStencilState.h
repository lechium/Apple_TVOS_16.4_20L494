...
- (unsigned int)depthStencilRef;	// IMP=0x0000000000012a57
- (void)dealloc;	// IMP=0x000000000001298d
- (id)initWithDescriptor:(id)arg1 reference:(unsigned int)arg2 device:(id)arg3;	// IMP=0x0000000000012945
