...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000088b6
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1 reflection:(id *)arg2;	// IMP=0x00000000000088ae
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1;	// IMP=0x00000000000088a6
@property(readonly) unsigned int functionRef;
- (void)dealloc;	// IMP=0x00000000000087c8
- (id)initWithDevice:(id)arg1 functionType:(unsigned long long)arg2 functionRef:(unsigned int)arg3;	// IMP=0x0000000000008762
