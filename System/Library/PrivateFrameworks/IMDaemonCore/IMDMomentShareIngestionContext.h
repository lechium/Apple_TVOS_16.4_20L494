...
- (void)completeTransferForAssetUUID:(id)arg1;	// IMP=0x0000000000002c36
- (void)clearAllTransfers;	// IMP=0x0000000000002c20
- (void)addTransfers:(id)arg1;	// IMP=0x0000000000002c0a
@property(readonly, nonatomic) NSDictionary *assetUUIDsToFileTransfers;
- (id)initWithURL:(id)arg1 message:(id)arg2 inChat:(id)arg3;	// IMP=0x0000000000002b28
