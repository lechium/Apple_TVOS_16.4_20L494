...
+ (id)dataFetcherForSourceURL:(id)arg1;	// IMP=0x006000000000cbde
...
- (id)initWithDataURL:(id)arg1;	// IMP=0x000000000000cd49
- (id)initWithDataURL:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x000000000000ccb0
- (id)initWithData:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x000000000000cc17
