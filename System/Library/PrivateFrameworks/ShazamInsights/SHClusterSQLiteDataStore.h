...
+ (_Bool)sqliteDatabaseExistsAtURL:(id)arg1;	// IMP=0x006000000000a0e1
- (void).cxx_destruct;	// IMP=0x000000000000a8d3
...
- (_Bool)isDataLoaded;	// IMP=0x000000000000a467
- (_Bool)hasNotPassedExpiryDate:(id)arg1 isForCountryCode:(id)arg2;	// IMP=0x000000000000a2ae
- (_Bool)isDataValid;	// IMP=0x000000000000a20a
- (id)initWithClusterType:(long long)arg1 databaseMaxAge:(double)arg2 forStorefront:(id)arg3 databaseFilePathURL:(id)arg4;	// IMP=0x000000000000a159
