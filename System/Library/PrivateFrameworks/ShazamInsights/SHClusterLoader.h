...
+ (void)loadDataForRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00600000000020f4
...
- (void)loadFromURL:(id)arg1 type:(long long)arg2 storefront:(id)arg3 reuseExistingData:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000002538
- (id)initWithDataFetcher:(id)arg1 dataStore:(id)arg2;	// IMP=0x000000000000249f
