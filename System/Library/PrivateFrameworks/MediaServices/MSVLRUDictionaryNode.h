...
- (void).cxx_destruct;	// IMP=0x000000000005130e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000051268
- (id)initWithKey:(id)arg1 object:(id)arg2;	// IMP=0x00000000000511cf
