...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x002000000000e6e7
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x002000000000e675
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x002000000000e608
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x002000000000e596
- (_Bool)isHSVoiceTrigger:(id)arg1;	// IMP=0x0010000000007d1c
- (id)getCategoryKeyWithRecordCtx:(id)arg1;	// IMP=0x0010000000007cb7
- (_Bool)shouldRunSpkrIdForCategory:(id)arg1;	// IMP=0x0010000000007c95
- (id)nldaConfigFileForCategory:(id)arg1;	// IMP=0x0010000000007be3
- (id)mitigationConfigFileForCategory:(id)arg1;	// IMP=0x0010000000007b31
...
- (id)nldaConfigFile;	// IMP=0x0010000000007994
@property(readonly, nonatomic) float mitigationModelDefaultAFTMScore;
- (id)mitigatonConfigFile;	// IMP=0x001000000000789a
@property(readonly, nonatomic) NSDictionary *SSVParameterDirectionary;
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0010000000010caf
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x001000000000d946
@property(readonly, nonatomic) NSString *flexKwdThresholdFile;
@property(readonly, nonatomic) NSString *flexKwdConfigFile;
- (id)_sha256:(id)arg1;	// IMP=0x001000000004ff06
- (id)_sha1:(id)arg1;	// IMP=0x001000000004fe15
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000004fc6c
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000004fc38
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000004fc1f
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000004fc06
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000004fbed
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004fbd0
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004fbb0
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x001000000004f38c
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x001000000004efbe
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000004ef58
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x001000000004ef24
...
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000081b30
@property(readonly, nonatomic) _Bool containsSpeakerRecognitionCategory;
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x00100000000ad5be
