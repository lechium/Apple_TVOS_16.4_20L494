...
- (void).cxx_destruct;	// IMP=0x000000000007942f
- (id)deviceConnectionKey;	// IMP=0x0000000000079402
- (void)_daemonDied:(id)arg1;	// IMP=0x00000000000792c8
- (void)_cleanupCompletionBlock;	// IMP=0x0000000000079278
- (void)xpcObject:(id)arg1 objectContext:(id)arg2;	// IMP=0x0000000000078c09
- (void)_close;	// IMP=0x0000000000078773
- (void)close;	// IMP=0x00000000000786c7
- (_Bool)updateConnectionWithOptions:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000078312
- (void)setStreamPairWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x0000000000078147
...
- (void)_connect;	// IMP=0x0000000000077bd7
- (void)dealloc;	// IMP=0x0000000000077ab5
- (id)initWithDevice:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 queue:(id)arg4;	// IMP=0x0000000000076bce
