...
- (void).cxx_destruct;	// IMP=0x000000000000a5a9
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000009bb0
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x0000000000009b93
- (id)initWithProtocol:(id)arg1 ivarQueue:(id)arg2 remoteMessageQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000009aa2
- (id)initWithProtocol:(id)arg1 ivarQueue:(id)arg2 remoteMessageQueue:(id)arg3;	// IMP=0x0000000000009a8d
