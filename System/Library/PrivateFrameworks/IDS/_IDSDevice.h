...
- (void).cxx_destruct;	// IMP=0x00000000000e1d84
@property(readonly, nonatomic) IDSEndpointCapabilities *capabilities; // @synthesize capabilities=_capabilities;
- (void)_setService:(id)arg1;	// IMP=0x00000000000e1c98
- (void)_setAccount:(id)arg1;	// IMP=0x00000000000e1bb6
- (void)_stateChanged;	// IMP=0x00000000000e1a44
- (void)_cloudConnectedStateChanged;	// IMP=0x00000000000e1905
- (void)_connectedStateChanged;	// IMP=0x00000000000e17c6
- (void)_nearbyStateChanged;	// IMP=0x00000000000e1687
- (_Bool)isTinker;	// IMP=0x00000000000e166f
- (void)_addIdentity:(id)arg1;	// IMP=0x00000000000e131b
...
- (id)compactDescription;	// IMP=0x00000000000df628
- (id)description;	// IMP=0x00000000000df19e
- (id)fullDescription;	// IMP=0x00000000000decea
...
- (void)dealloc;	// IMP=0x00000000000de5dc
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000dde0f
