...
+ (id)logCategory;	// IMP=0x0010000000056668
- (void).cxx_destruct;	// IMP=0x000000000005670c
...
- (void)dealloc;	// IMP=0x000000000005662a
- (void)close;	// IMP=0x0000000000056508
@property(readonly, nonatomic) double lastEventTime; // @synthesize lastEventTime=_lastEventTime;
- (_Bool)sendMessage:(id)arg1;	// IMP=0x000000000005644e
- (id)initWithServiceName:(id)arg1 sessionUUID:(id)arg2 isRealtime:(_Bool)arg3 submitter:(id)arg4 timeSourceBlock:(CDUnknownBlockType)arg5;	// IMP=0x0000000000056325
