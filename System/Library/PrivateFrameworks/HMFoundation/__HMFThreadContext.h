...
+ (id)currentContext;	// IMP=0x004000000001fb93
- (void).cxx_destruct;	// IMP=0x000000000001fdc1
...
- (id)description;	// IMP=0x000000000001fd09
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001fc7b
- (unsigned long long)hash;	// IMP=0x000000000001fc5e
- (id)__init;	// IMP=0x000000000001fc2f
- (id)init;	// IMP=0x000000000001faeb
