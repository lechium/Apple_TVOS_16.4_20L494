...
- (void).cxx_destruct;	// IMP=0x000000000004604d
...
- (id)responseWithStatusCode:(long long)arg1;	// IMP=0x0000000000045f01
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x0000000000045ebf
- (id)init;	// IMP=0x0000000000045e10
