...
- (void).cxx_destruct;	// IMP=0x00000000000205ac
...
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x0000000000020450
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020345
- (id)initWithStatusCode:(long long)arg1 headerFields:(id)arg2 body:(id)arg3;	// IMP=0x0000000000020270
- (id)init;	// IMP=0x00000000000201c8
