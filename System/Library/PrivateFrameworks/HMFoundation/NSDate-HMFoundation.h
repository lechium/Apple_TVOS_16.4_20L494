...
+ (id)shortDescription;	// IMP=0x001000000004090b
+ (id)timeIntervalDescription:(double)arg1;	// IMP=0x0010000000040acb
- (id)hmf_dateComponentsUsingTimeZone:(id)arg1;	// IMP=0x0010000000040a2c
