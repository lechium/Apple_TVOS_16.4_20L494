...
- (void).cxx_destruct;	// IMP=0x000000000000ea71
...
- (id)description;	// IMP=0x000000000000e988
- (void)reset;	// IMP=0x000000000000e966
- (void)close;	// IMP=0x000000000000e93c
- (void)dealloc;	// IMP=0x000000000000e8fe
