...
- (void).cxx_destruct;	// IMP=0x0000000000019054
...
- (void)reflectNextFireDelay:(double)arg1 fireInterval:(double)arg2;	// IMP=0x0000000000018f44
- (void)dealloc;	// IMP=0x0000000000018ef3
- (id)initWithDispatchSilo:(id)arg1;	// IMP=0x0000000000018c70
