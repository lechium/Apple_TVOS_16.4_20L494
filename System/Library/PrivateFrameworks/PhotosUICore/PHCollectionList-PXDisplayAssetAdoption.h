...
+ (id)px_otherAlbumsCollectionListIncludeDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3;	// IMP=0x001000000072cba0
+ (id)_otherAlbumAssetCollectionsIncludingRecentlyDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3 includingSharedLibrary:(_Bool)arg4 includingDebugAlbums:(_Bool)arg5;	// IMP=0x001000000072bd21
+ (id)_otherAlbumsCollectionListWithDeletedCollection:(_Bool)arg1 withHiddenCollection:(_Bool)arg2 withDuplicatesCollection:(_Bool)arg3;	// IMP=0x001000000072bc59
+ (id)px_mediaTypesCollectionList;	// IMP=0x001000000072bc29
+ (id)px_sharedAlbumsAndActivityCollectionList;	// IMP=0x001000000072bbf9
+ (id)px_sharedAlbumsCollectionList;	// IMP=0x001000000072bbc9
+ (id)px_rootAlbumCollectionList;	// IMP=0x001000000072bb62
+ (id)px_rootProjectCollectionList;	// IMP=0x001000000072bafb
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x001000000072abd0
- (_Bool)px_isContainedInCollectionList:(id)arg1;	// IMP=0x001000000072aaa4
...
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x001000000072a89d
