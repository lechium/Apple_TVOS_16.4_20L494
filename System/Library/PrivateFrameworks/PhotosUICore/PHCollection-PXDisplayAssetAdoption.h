...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x002000000072a643
@property(readonly, nonatomic) NSDictionary *px_debugDictionary;
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x002000000072a4d5
- (_Bool)px_fetchIsEmpty;	// IMP=0x002000000072a45a
- (id)px_fetchContainedAssetCollections;	// IMP=0x002000000072a39d
- (id)px_fetchAncestryIncludingRoot:(_Bool)arg1;	// IMP=0x002000000072a1fa
