...
+ (void)px_loadRepresentativeFacesForPersons:(id)arg1;	// IMP=0x00100000000136da
...
- (void)requestFaceTileImageWithTargetSize:(struct CGSize)arg1 cropFactor:(unsigned long long)arg2 style:(unsigned long long)arg3 cacheResult:(_Bool)arg4 boundFaceRect:(_Bool)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000000131ee
