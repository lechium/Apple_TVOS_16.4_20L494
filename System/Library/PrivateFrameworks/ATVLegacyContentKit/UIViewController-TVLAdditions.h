...
- (void)tvl_saveStateWithCoder:(id)arg1;	// IMP=0x00300000000857f4
- (void)tvl_restoreStateWithCoder:(id)arg1;	// IMP=0x00300000000857ee
- (void)reloadPage;	// IMP=0x003000000008574c
- (void)reloadForRefreshInterval;	// IMP=0x0030000000085531
- (void)reloadCurrentPage;	// IMP=0x0030000000085487
- (void)reloadOriginalURL;	// IMP=0x003000000008531a
- (void)reloadVolatile;	// IMP=0x0030000000084cab
- (void)didUpdateFeedElementRequiringUserInterfaceUpdate:(_Bool)arg1 previousElement:(id)arg2;	// IMP=0x0030000000084ca5
- (void)updateWithFeedElement:(id)arg1;	// IMP=0x0030000000084bd2
- (_Bool)updatableWithFeedElement:(id)arg1;	// IMP=0x0030000000084b3b
