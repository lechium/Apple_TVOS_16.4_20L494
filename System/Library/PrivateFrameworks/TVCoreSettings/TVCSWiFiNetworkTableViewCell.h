...
- (void).cxx_destruct;	// IMP=0x000000000001c966
...
- (void)_updateAccessoryTintColor;	// IMP=0x000000000001c74a
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000001c683
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001c642
- (void)setBars:(unsigned long long)arg1;	// IMP=0x000000000001c63c
- (void)setSecure:(_Bool)arg1;	// IMP=0x000000000001c61f
- (void)setSubtitle:(id)arg1;	// IMP=0x000000000001c619
- (void)setTitle:(id)arg1;	// IMP=0x000000000001c5a7
- (void)didMoveToSuperview;	// IMP=0x000000000001c435
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000001c375
