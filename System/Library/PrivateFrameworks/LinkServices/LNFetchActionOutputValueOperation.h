...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000780c6
- (void)start;	// IMP=0x0000000000077ecf
- (id)initWithConnectionInterface:(id)arg1 actionOutput:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000077c57
