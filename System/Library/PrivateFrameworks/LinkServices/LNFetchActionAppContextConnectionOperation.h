...
- (void).cxx_destruct;	// IMP=0x00000000000644bf
...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000064370
- (void)start;	// IMP=0x0000000000064252
- (id)initWithConnectionInterface:(id)arg1 action:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000063fe2
