...
- (void).cxx_destruct;	// IMP=0x000000000009c93a
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000009c779
- (void)start;	// IMP=0x000000000009c4cf
- (id)initWithConnectionInterface:(id)arg1 actionMetadata:(id)arg2 parameterMetadata:(id)arg3 searchTerm:(id)arg4 localeIdentifier:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000009c0a9
