...
- (void).cxx_destruct;	// IMP=0x000000000007ade5
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000007ac93
- (void)start;	// IMP=0x000000000007ab61
- (id)initWithConnectionInterface:(id)arg1 typeIdentifier:(long long)arg2 entityIdentifiers:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000007a8d9
