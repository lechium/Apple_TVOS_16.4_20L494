...
- (void).cxx_destruct;	// IMP=0x0000000000079768
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000007962a
- (void)start;	// IMP=0x0000000000079564
- (id)initWithConnectionInterface:(id)arg1 query:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000792ec
