...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000099bab
- (unsigned long long)hash;	// IMP=0x0000000000099b46
- (id)description;	// IMP=0x0000000000099a04
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009995f
- (id)init;	// IMP=0x00000000000998e2
