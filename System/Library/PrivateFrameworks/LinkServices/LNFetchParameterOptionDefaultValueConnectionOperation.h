...
- (void).cxx_destruct;	// IMP=0x0000000000083098
...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000082f24
- (void)start;	// IMP=0x0000000000082d29
- (id)initWithConnectionInterface:(id)arg1 actionMetadata:(id)arg2 parameterIdentifier:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000082a14
