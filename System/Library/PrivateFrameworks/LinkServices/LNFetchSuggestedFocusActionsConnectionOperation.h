...
- (void).cxx_destruct;	// IMP=0x0000000000090130
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000008ffb9
- (void)start;	// IMP=0x000000000008fe0c
- (id)initWithConnectionInterface:(id)arg1 actionMetadata:(id)arg2 suggestionContext:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000008fbdf
