...
- (void).cxx_destruct;	// IMP=0x00000000000187a3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000018681
- (unsigned long long)hash;	// IMP=0x00000000000185eb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000184c2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000183db
- (void)copyTo:(id)arg1;	// IMP=0x000000000001833d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000018295
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000018288
- (id)dictionaryRepresentation;	// IMP=0x0000000000017f23
- (id)description;	// IMP=0x0000000000017e74
...
- (id)attributes;	// IMP=0x000000000000b29c
