...
- (void).cxx_destruct;	// IMP=0x0000000000019058
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000018f21
- (unsigned long long)hash;	// IMP=0x0000000000018e9d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000018d71
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000018c87
- (void)copyTo:(id)arg1;	// IMP=0x0000000000018bec
- (void)writeTo:(id)arg1;	// IMP=0x0000000000018b3d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000018b30
- (id)dictionaryRepresentation;	// IMP=0x00000000000188a9
- (id)description;	// IMP=0x00000000000187fa
