...
+ (id)hardwareUUID;	// IMP=0x001000000001e51b
+ (id)bootSessionUUID;	// IMP=0x001000000001e47b
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001e473
- (void).cxx_destruct;	// IMP=0x000000000001e2b5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001df39
- (id)initForEmbeddedSystem;	// IMP=0x000000000001db2d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001d7e4
- (id)initWithXPCObject:(id)arg1;	// IMP=0x000000000001d3e8
- (id)init;	// IMP=0x000000000001d37e
