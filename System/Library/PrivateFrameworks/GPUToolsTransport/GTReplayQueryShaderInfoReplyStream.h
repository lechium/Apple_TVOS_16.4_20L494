...
- (void).cxx_destruct;	// IMP=0x0000000000013e00
@property unsigned long long dispatcherId; // @synthesize dispatcherId;
- (void)dispatchMessage:(id)arg1 replyConnection:(id)arg2;	// IMP=0x0000000000013d35
- (id)initWithCallback:(CDUnknownBlockType)arg1 bulkDataProxy:(id)arg2;	// IMP=0x0000000000013c68
