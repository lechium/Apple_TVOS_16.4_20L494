...
+ (id)writingDirectionOrderedStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2;	// IMP=0x00600000000ebc20
- (void).cxx_destruct;	// IMP=0x00000000000ec030
...
- (long long)_substrokeCountForStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2;	// IMP=0x00000000000eb9a0
- (id)initWithStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2 splitIndex:(long long)arg3;	// IMP=0x00000000000eb460
