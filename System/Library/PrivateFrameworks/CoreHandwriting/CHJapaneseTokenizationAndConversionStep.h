...
- (void).cxx_destruct;	// IMP=0x00000000001c48e0
...
- (void)dealloc;	// IMP=0x00000000001c4770
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001c1a90
- (id)_extendedConversionCandidates:(id)arg1 withPhraseCandidates:(id)arg2;	// IMP=0x00000000001c1770
- (id)_updatedTokenFromToken:(id)arg1 withString:(id)arg2;	// IMP=0x00000000001c14b0
- (id)initWithMecabra:(id)arg1 wordLanguageModel:(void *)arg2 ovsStringChecker:(id)arg3 promoteKanaConversion:(_Bool)arg4;	// IMP=0x00000000001c13a0
