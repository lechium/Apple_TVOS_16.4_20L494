...
- (void).cxx_destruct;	// IMP=0x00000000000f99e0
...
- (id)newGroupingManager;	// IMP=0x00000000000f9740
- (id)newStrokeClassifier;	// IMP=0x00000000000f9650
- (id)clutterFilter;	// IMP=0x00000000000f95d0
- (id)_recognitionResultsForNonTextStrokeGroup:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000f92e0
- (id)_tokenizedTextResultForDrawing:(id)arg1 usingRecognizer:(id)arg2 isRemoteRecognizer:(_Bool)arg3 locale:(id)arg4 strokeLimit:(long long)arg5 recognitionError:(id *)arg6;	// IMP=0x00000000000f79e0
- (id)_textRecognitionResultsForTextStrokeGroup:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000f6be0
- (id)textCorrectionResultsForGroupingResult:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000f6bd0
- (id)recognitionResultsForGroupingResult:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000f6130
- (void)_logResultsIfAppropriateWithStrokeProvider:(id)arg1;	// IMP=0x00000000000f6100
- (_Bool)_isTransitionValidFromStatus:(long long)arg1 toStatus:(long long)arg2;	// IMP=0x00000000000f60d0
- (void)cancel;	// IMP=0x00000000000f5fc0
- (void)main;	// IMP=0x00000000000f3c80
- (id)initWithLocales:(id)arg1 preferredLocales:(id)arg2 strokeProvider:(id)arg3 inputResult:(id)arg4 recognitionQOSClass:(unsigned int)arg5 recognitionEnvironment:(long long)arg6 isHighResponsivenessTask:(_Bool)arg7 strokeClassificationModel:(id)arg8 strokeGroupingRequirement:(long long)arg9 subjectStrokeIdentifiers:(id)arg10 partialResultBlock:(CDUnknownBlockType)arg11;	// IMP=0x00000000000f3bd0
- (id)initWithLocales:(id)arg1 preferredLocales:(id)arg2 strokeProvider:(id)arg3 inputResult:(id)arg4 recognitionQOSClass:(unsigned int)arg5 recognitionEnvironment:(long long)arg6 isHighResponsivenessTask:(_Bool)arg7 strokeClassificationModel:(id)arg8 strokeGroupingRequirement:(long long)arg9 partialResultBlock:(CDUnknownBlockType)arg10;	// IMP=0x00000000000f3930
- (id)initWithLocales:(id)arg1 preferredLocales:(id)arg2 strokeProvider:(id)arg3 inputResult:(id)arg4 recognitionQOSClass:(unsigned int)arg5 recognitionEnvironment:(long long)arg6;	// IMP=0x00000000000f38e0
- (id)init;	// IMP=0x00000000000f3850
