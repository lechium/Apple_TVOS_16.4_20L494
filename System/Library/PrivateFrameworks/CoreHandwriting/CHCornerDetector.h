...
- (id).cxx_construct;	// IMP=0x0000000000083500
- (void).cxx_destruct;	// IMP=0x0000000000083480
...
- (id)_resolveResampledDirectionChangePointIndexes:(id)arg1;	// IMP=0x0000000000082fb0
- (_Bool)_isLine:(id)arg1 usingThreshold:(double)arg2 p1:(long long)arg3 p2:(long long)arg4;	// IMP=0x0000000000082ef0
- (long long)_strokeHalfwayCorner:(id)arg1 p1:(long long)arg2 p2:(long long)arg3;	// IMP=0x0000000000082cf0
- (id)_postProcessCorners:(id)arg1 corners:(id)arg2 straws:(id)arg3;	// IMP=0x0000000000082a00
- (void)_removeAdjacentCorners:(id)arg1 corners:(id)arg2 straws:(id)arg3;	// IMP=0x0000000000082720
- (void)_removeColinearCorners:(id)arg1 usingDistanceThreshold:(double)arg2 usingLowerThreshold:(double)arg3 usingUpperThreshold:(double)arg4 corners:(id)arg5;	// IMP=0x0000000000082480
- (void)_removeColinearCorners:(id)arg1 usingThreshold:(double)arg2 corners:(id)arg3;	// IMP=0x00000000000822e0
- (double)_pathDistance:(id)arg1 p1:(long long)arg2 p2:(long long)arg3;	// IMP=0x0000000000082230
- (double)_distance:(id)arg1 p1:(long long)arg2 p2:(long long)arg3;	// IMP=0x0000000000082170
- (double)_resamplingDistance:(id)arg1;	// IMP=0x0000000000082020
- (id)_resampleDrawing:(id)arg1 outputPointMap:(void *)arg2;	// IMP=0x0000000000081fa0
- (void)_detectCorners;	// IMP=0x00000000000813f0
- (unsigned long long)_detectDirectionalChanges;	// IMP=0x0000000000080bc0
- (id)directionChangeCornerIndexes;	// IMP=0x0000000000080b80
- (id)cornerIndexes;	// IMP=0x0000000000080b40
- (id)init;	// IMP=0x0000000000080990
