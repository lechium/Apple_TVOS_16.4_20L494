...
- (void)dealloc;	// IMP=0x00000000001b9b50
- (id)handleChineseLigaturesInString:(id)arg1;	// IMP=0x00000000001b99c0
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001b8d40
- (id)initWithTransliterateSentences:(_Bool)arg1;	// IMP=0x00000000001b8c60
