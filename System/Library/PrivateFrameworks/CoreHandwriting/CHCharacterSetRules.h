...
+ (unsigned long long)characterTypeFromString:(id)arg1;	// IMP=0x0060000000170000
+ (unsigned long long)characterType:(unsigned int)arg1;	// IMP=0x006000000016feb0
+ (unsigned long long)expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x006000000016fd60
+ (unsigned long long)expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x006000000016fc10
+ (unsigned long long)expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x006000000016fac0
+ (id)sharedCharacterSetRules;	// IMP=0x006000000016fa50
- (id).cxx_construct;	// IMP=0x0000000000172600
- (void).cxx_destruct;	// IMP=0x0000000000172420
...
- (unsigned long long)_expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x0000000000171d00
- (unsigned long long)_characterType:(unsigned int)arg1;	// IMP=0x0000000000171620
- (unsigned long long)_expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x0000000000171080
- (unsigned long long)_expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x0000000000170890
- (id)init;	// IMP=0x0000000000170150
