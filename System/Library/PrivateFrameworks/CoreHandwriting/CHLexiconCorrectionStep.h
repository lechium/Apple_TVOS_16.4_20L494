...
+ (id)validatedTokenForCorrectedToken:(id)arg1 rawToken:(id)arg2;	// IMP=0x00600000001a5fd0
- (void).cxx_destruct;	// IMP=0x00000000001ac480
...
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001aa7d0
- (id)createPseudoTokensFromToken:(id)arg1;	// IMP=0x00000000001a9d60
- (id)applyCorrectionsAcrossToken:(id)arg1 isFirstToken:(_Bool)arg2 contextBeforeToken:(id)arg3 shouldCapitalizeGivenHistory:(_Bool)arg4 textReplacements:(id)arg5 isSingleIsolatedCharacter:(_Bool)arg6;	// IMP=0x00000000001a9430
- (id)applyCorrectionsOnSingleToken:(id)arg1 isFirstToken:(_Bool)arg2 contextBeforeToken:(id)arg3 shouldCapitalizeGivenHistory:(_Bool)arg4 textReplacements:(id)arg5 isSingleIsolatedCharacter:(_Bool)arg6 allowSpellChecker:(_Bool)arg7;	// IMP=0x00000000001a8140
- (id)applyLexiconCorrections:(id)arg1 shouldCapitalizeWord:(_Bool)arg2 shouldSkipEntryCorrection:(_Bool)arg3 outBestTokenIndex:(long long *)arg4 bestLexiconTokenScore:(double *)arg5 textReplacements:(id)arg6 contextBeforeToken:(id)arg7 allowSpellChecker:(_Bool)arg8;	// IMP=0x00000000001a70c0
- (id)getSpellCorrectedToken:(id)arg1 contextBeforeToken:(id)arg2;	// IMP=0x00000000001a6be0
- (void)dealloc;	// IMP=0x00000000001a6b00
- (id)initWithAutoCapitalizationMode:(int)arg1 shouldAutoCorrect:(_Bool)arg2 shouldAutoCapitalize:(_Bool)arg3 shouldCreatePseudoTokens:(_Bool)arg4 locale:(id)arg5 staticLexicon:(struct _LXLexicon *)arg6 customLexicon:(struct _LXLexicon *)arg7 phraseLexicon:(struct _LXLexicon *)arg8 customPhraseLexicon:(struct _LXLexicon *)arg9 spellChecker:(id)arg10 lmVocabulary:(void *)arg11 ovsStringChecker:(id)arg12 textReplacements:(id)arg13;	// IMP=0x00000000001a6870
