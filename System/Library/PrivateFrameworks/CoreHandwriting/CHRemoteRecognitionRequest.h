...
+ (id)loadFromFile:(id)arg1;	// IMP=0x001000000009ab10
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000009a760
- (void).cxx_destruct;	// IMP=0x000000000009c5a0
...
- (id)description;	// IMP=0x000000000009c030
- (unsigned long long)hash;	// IMP=0x000000000009bd70
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009bcf0
- (_Bool)isEqualToRemoteRecognitionRequest:(id)arg1;	// IMP=0x000000000009b6f0
- (id)recognizerConfigurationKeyWithLocale:(id)arg1;	// IMP=0x000000000009abc0
@property(readonly, nonatomic) _Bool shouldRemoveUnnaturalGaps;
- (id)writeToFileInFolder:(id)arg1 basename:(id)arg2;	// IMP=0x000000000009a770
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009a500
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000099cd0
- (id)initWithLocales:(id)arg1 recognitionMode:(int)arg2 drawing:(id)arg3 options:(id)arg4 priority:(long long)arg5;	// IMP=0x0000000000099aa0
