...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000a8400
- (id).cxx_construct;	// IMP=0x00000000000a8490
- (void).cxx_destruct;	// IMP=0x00000000000a8430
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a74e0
- (struct CGPath *)newEstimatedBaselineForSubStrokes:(id)arg1 tokens:(id)arg2 tokenSubStrokeIndexes:(id)arg3 estimatedDescenderLocations:(id)arg4;	// IMP=0x00000000000a5540
- (const struct CGPath *)newEstimatedBaselineForStrokesWithTokens:(id)arg1 tokenStrokeIdentifiers:(id)arg2;	// IMP=0x00000000000a47a0
- (id)coalescedLastSubstrokes;	// IMP=0x00000000000a4780
- (long long)lastSubstrokeIndexBeforeMerge;	// IMP=0x00000000000a4760
- (struct CGVector)averageStrokeDeviation;	// IMP=0x00000000000a4740
- (struct CGVector)averageWritingOrientation;	// IMP=0x00000000000a4720
- (struct CGVector)localWritingOrientationAtStrokeIndex:(long long)arg1;	// IMP=0x00000000000a4700
- (void *)localStrokeWritingOrientations;	// IMP=0x00000000000a46f0
- (id)writingDirectionSortedSubstrokes;	// IMP=0x00000000000a46d0
- (id)groupByAddingStrokeIdentifiers:(id)arg1 removingStrokeIdentifiers:(id)arg2 firstStrokeIdentifier:(id)arg3 lastStrokeIdentifier:(id)arg4 bounds:(struct CGRect)arg5 writingDirectionSortedSubstrokes:(id)arg6 averageWritingOrientation:(struct CGVector)arg7 averageStrokeDeviation:(struct CGVector)arg8 writingDirectionSortedStrokeIdentifiers:(id)arg9 localStrokeWritingOrientations:(const void *)arg10 coalescedLastSubstrokes:(id)arg11 groupingConfidence:(double)arg12 lastSubstrokeIndexBeforeMerge:(long long)arg13 firstStrokeOrigin:(struct CGPoint)arg14;	// IMP=0x00000000000a44c0
