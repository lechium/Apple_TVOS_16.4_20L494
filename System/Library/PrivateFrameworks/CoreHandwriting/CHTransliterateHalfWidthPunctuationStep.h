...
- (void).cxx_destruct;	// IMP=0x00000000001ada60
...
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001ac6b0
- (id)initWithShouldAddAlternatives:(_Bool)arg1;	// IMP=0x00000000001ac510
