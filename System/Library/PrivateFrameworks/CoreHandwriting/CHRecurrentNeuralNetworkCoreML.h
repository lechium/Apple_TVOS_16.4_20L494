...
- (void).cxx_destruct;	// IMP=0x00000000000e62b0
...
- (void)dealloc;	// IMP=0x00000000000e6130
- (id)initWithModelName:(id)arg1 featureIndex:(long long)arg2;	// IMP=0x00000000000e5160
- (id)initWithModelName:(id)arg1;	// IMP=0x00000000000e5140
