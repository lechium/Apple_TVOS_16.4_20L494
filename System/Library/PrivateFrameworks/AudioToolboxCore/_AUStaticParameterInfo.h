...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000dc9af
- (void).cxx_destruct;	// IMP=0x00000000000dc987
...
- (void)dealloc;	// IMP=0x00000000000dc898
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000dc5de
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000dc4a8
