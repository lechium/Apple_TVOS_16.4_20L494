...
- (void).cxx_destruct;	// IMP=0x00000000000ab2e0
...
- (void)reset;	// IMP=0x00000000000aae9c
- (id)initWithDiscoveryType:(long long)arg1;	// IMP=0x00000000000aacc7
- (id)init;	// IMP=0x00000000000aac1f
