...
- (void).cxx_destruct;	// IMP=0x00000000000081fe
...
- (void)updateContentSize;	// IMP=0x0000000000007c2a
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000007bd8
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000079e6
- (void)adjustedContentInsetDidChange;	// IMP=0x0000000000007990
- (void)layoutSubviews;	// IMP=0x0000000000007220
- (id)initWithFeatures:(id)arg1;	// IMP=0x0000000000006f28
