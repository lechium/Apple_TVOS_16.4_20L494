...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000004850
- (void)mediaPause;	// IMP=0x00000000000046c5
- (void)imageViewTapped:(id)arg1;	// IMP=0x0000000000004688
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000003ef0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000003e00
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x0000000000003ad5
- (void)loadView;	// IMP=0x0000000000003709
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000002922
