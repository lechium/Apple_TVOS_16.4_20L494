...
- (id).cxx_construct;	// IMP=0x00000000000eebd5
- (void).cxx_destruct;	// IMP=0x00000000000eeb9b
@property(readonly, nonatomic) __weak CKXStructProxyBase *proxy; // @synthesize proxy=_proxy;
- (id)structListProxyForListReference:(unsigned long long)arg1 mutable:(_Bool)arg2;	// IMP=0x00000000000eea27
- (id)structProxyForStructReference:(unsigned long long)arg1 mutable:(_Bool)arg2;	// IMP=0x00000000000ee8c9
- (void)reset;	// IMP=0x00000000000ee87a
- (id)initWithProxy:(id)arg1;	// IMP=0x00000000000ee802
