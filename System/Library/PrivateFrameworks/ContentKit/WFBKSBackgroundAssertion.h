...
+ (id)backgroundAssertionWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x006000000007f476
- (void).cxx_destruct;	// IMP=0x000000000007f013
...
- (void)end;	// IMP=0x000000000007ee70
- (id)initWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000007ead7
