...
- (void).cxx_destruct;	// IMP=0x000000000000c749
...
- (void)removeWatchers;	// IMP=0x000000000000c4d3
- (void)installWatchers;	// IMP=0x000000000000c215
- (void)cancel;	// IMP=0x000000000000bf9b
- (void)_performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2 uninstalledProxies:(id)arg3;	// IMP=0x000000000000ba2b
- (void)performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2;	// IMP=0x000000000000b314
- (void)dealloc;	// IMP=0x000000000000b1dd
- (id)initWithAttributes:(id)arg1 flags:(unsigned long long)arg2 host:(id)arg3 report:(CDUnknownBlockType)arg4;	// IMP=0x000000000000ad82
