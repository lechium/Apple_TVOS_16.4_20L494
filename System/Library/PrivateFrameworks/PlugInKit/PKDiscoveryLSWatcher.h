...
- (void).cxx_destruct;	// IMP=0x000000000000cd3a
...
- (void)updateWithUninstalledProxies:(id)arg1;	// IMP=0x000000000000cb5a
- (void)update;	// IMP=0x000000000000cb41
- (void)pluginsDidUninstall:(id)arg1;	// IMP=0x000000000000ca39
- (void)pluginsDidInstall:(id)arg1;	// IMP=0x000000000000c934
- (void)stopUpdates;	// IMP=0x000000000000c8e8
- (id)initWithDriver:(id)arg1;	// IMP=0x000000000000c7be
