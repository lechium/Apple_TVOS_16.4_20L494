...
- (void).cxx_destruct;	// IMP=0x000000000000c39c
...
- (void)didUpdateHH2State:(_Bool)arg1;	// IMP=0x000000000000c1ff
- (void)notifyDidUpdateSetting:(id)arg1 forKeyPath:(id)arg2;	// IMP=0x000000000000c179
- (id)initWithInterface:(id)arg1;	// IMP=0x000000000000c115
