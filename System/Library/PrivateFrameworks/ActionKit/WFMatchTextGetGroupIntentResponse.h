...
+ (id)rangeErrorIntentResponseWithRangeErrorGroupNumber:(id)arg1 rangeErrorGroupCount:(id)arg2;	// IMP=0x006000000036b200
+ (id)noMatchIntentResponseWithNoMatchIndex:(id)arg1;	// IMP=0x006000000036b192
@property(nonatomic) long long code; // @synthesize code=_code;
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x000000000036b0f6
