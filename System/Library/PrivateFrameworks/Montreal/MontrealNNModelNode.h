...
- (void).cxx_destruct;	// IMP=0x00000000001394d0
...
- (id)createDataContainer;	// IMP=0x00000000001390b0
- (void)generateJSONAtPath:(id)arg1;	// IMP=0x0000000000138f40
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000138e20
- (id)jsonDescription;	// IMP=0x0000000000138bd0
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000138830
- (CDStruct_96916c69)parameters:(void *)arg1;	// IMP=0x0000000000138790
- (void)keepTensors:(id)arg1;	// IMP=0x00000000001384a0
- (id)auditAndUpdateTensors:(id)arg1 dimensionTensors:(id)arg2;	// IMP=0x00000000001380a0
- (id)initWithDictionary:(id)arg1 tensors:(id)arg2 quantization:(id)arg3 jsonDir:(id)arg4;	// IMP=0x00000000001376b0
- (id)initWithName:(id)arg1 nodeStr:(id)arg2 activations:(id)arg3 properties:(id)arg4 weights:(id)arg5;	// IMP=0x00000000001374e0
- (id)checkForValidity;	// IMP=0x00000000001372a0
