...
+ (id)serviceName;	// IMP=0x00600000000301b5
+ (id)sharedInstance;	// IMP=0x0060000000030150
- (void).cxx_destruct;	// IMP=0x000000000003095e
...
- (void)removeObserver:(id)arg1;	// IMP=0x000000000003085b
- (void)addObserver:(id)arg1;	// IMP=0x0000000000030807
- (id)findOrRegisterIcon:(id)arg1;	// IMP=0x0000000000030631
- (void)dealloc;	// IMP=0x0000000000030602
- (id)_init;	// IMP=0x000000000003020c
