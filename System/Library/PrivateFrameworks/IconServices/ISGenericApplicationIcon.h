...
+ (id)sharedInstance;	// IMP=0x0060000000011271
- (void).cxx_destruct;	// IMP=0x000000000001137f
- (id)makeResourceProvider;	// IMP=0x000000000001136d
@property(readonly) ISResourceProvider *resourceProvider; // @synthesize resourceProvider=_resourceProvider;
- (id)init;	// IMP=0x00000000000112c6
