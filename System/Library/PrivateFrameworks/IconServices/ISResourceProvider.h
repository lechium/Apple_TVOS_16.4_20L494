...
+ (id)resourceProviderWithTypeIdentifier:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0010000000025a66
+ (id)resourceProviderWithLSIconReource:(id)arg1;	// IMP=0x0010000000025a5e
+ (id)resourceProviderWithRecord:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0010000000025a02
+ (id)defaultIconResourceProvider;	// IMP=0x0010000000026ca0
+ (id)resourceWithTypeCode:(unsigned int)arg1 options:(unsigned long long)arg2;	// IMP=0x0010000000026c98
+ (id)resourceWithTypeIdentifier:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0010000000026c90
+ (id)resourceWithBundleURL:(id)arg1 iconDictionary:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x00100000000260a1
+ (id)resourceWithRecord:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0010000000025f00
- (void).cxx_destruct;	// IMP=0x0000000000025ea1
...
- (_Bool)_isAppleResource;	// IMP=0x0000000000025d48
@property(readonly) IFSymbol *symbol; // @dynamic symbol;
@property(readonly) NSData *validationToken; // @dynamic validationToken;
- (id)resourceNamed:(id)arg1;	// IMP=0x0000000000025c1c
- (id)resourceForKey:(id)arg1;	// IMP=0x0000000000025c0a
@property(retain) id <ISCompositorResource> iconResource; // @dynamic iconResource;
- (id)initWithResources:(id)arg1;	// IMP=0x0000000000025b65
- (id)initWithResource:(id)arg1 templateResource:(id)arg2;	// IMP=0x0000000000025ad0
- (id)init;	// IMP=0x0000000000025a6e
