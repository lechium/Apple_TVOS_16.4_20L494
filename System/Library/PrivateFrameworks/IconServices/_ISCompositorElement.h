...
- (void).cxx_destruct;	// IMP=0x000000000001540c
...
- (id)resourceNamed:(id)arg1;	// IMP=0x0000000000015352
- (void)clearResources;	// IMP=0x0000000000015319
- (void)addResourcesFromDictionary:(id)arg1;	// IMP=0x00000000000152a7
- (void)setResource:(id)arg1 forName:(id)arg2;	// IMP=0x0000000000015205
@property(readonly) id <ISCompositorResourceProvider> resourceProvider;
- (id)initWithRecipe:(id)arg1 resources:(id)arg2;	// IMP=0x0000000000015142
- (id)init;	// IMP=0x00000000000150cd
