...
+ (id)customRecipeWithInfo:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000254f0
- (void).cxx_destruct;	// IMP=0x00000000000259c4
...
- (id)resourceNamed:(id)arg1;	// IMP=0x0000000000025814
- (id)initWithRecipe:(id)arg1 bitmapResources:(id)arg2 symbolResources:(id)arg3 bundle:(id)arg4;	// IMP=0x000000000002570d
