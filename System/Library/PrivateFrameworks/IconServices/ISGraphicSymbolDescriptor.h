...
+ (id)descriptorFromGraphicIconConfiguration:(id)arg1;	// IMP=0x0060000000024a72
+ (id)descriptorFromGraphicSymbolRecipe:(id)arg1;	// IMP=0x0060000000024606
- (void).cxx_destruct;	// IMP=0x0000000000024f71
...
- (id)description;	// IMP=0x0000000000024e4f
