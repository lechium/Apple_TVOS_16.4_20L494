...
- (void).cxx_destruct;	// IMP=0x000000000001d62a
...
- (void)_observableAtIndex:(unsigned long long)arg1 didFailWithError:(id)arg2 observer:(id)arg3;	// IMP=0x000000000001d49f
- (void)_observableAtIndex:(unsigned long long)arg1 didCompleteForObserver:(id)arg2;	// IMP=0x000000000001d3cd
- (void)_observableAtIndex:(unsigned long long)arg1 receivedResult:(id)arg2 observer:(id)arg3;	// IMP=0x000000000001d2dc
- (id)subscribe:(id)arg1;	// IMP=0x000000000001ceaf
- (id)initWithObservables:(id)arg1;	// IMP=0x000000000001cc7c
