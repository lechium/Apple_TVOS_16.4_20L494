...
- (void).cxx_destruct;	// IMP=0x0000000000016d81
...
- (id)copyMappedChunkStore:(id *)arg1;	// IMP=0x0000000000016d35
- (_Bool)_determineTimespan;	// IMP=0x0000000000016b76
- (_Bool)_loadCatalogMetadataForTimespan;	// IMP=0x0000000000016955
- (_Bool)_loadHeaderMetadata:(id)arg1;	// IMP=0x000000000001688f
- (void)dealloc;	// IMP=0x0000000000016855
- (id)initWithChunkStore:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000016797
- (id)initWithTraceFile:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000016662
