...
- (void).cxx_destruct;	// IMP=0x000000000003d8e1
...
- (id)stringForIndex:(id)arg1;	// IMP=0x000000000003d79b
- (id)indexForString:(id)arg1;	// IMP=0x000000000003d68f
- (id)dataRepresentation;	// IMP=0x000000000003d269
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x000000000003cdd6
- (id)init;	// IMP=0x000000000003cd70
