...
- (void).cxx_destruct;	// IMP=0x00000000000165bb
...
- (id)copyMappedChunkFile:(id *)arg1;	// IMP=0x000000000001648f
- (_Bool)readXattrForTimespan:(id *)arg1;	// IMP=0x000000000001624e
- (void)dealloc;	// IMP=0x0000000000016214
- (id)initWithCollection:(id)arg1 subpath:(const char *)arg2;	// IMP=0x0000000000016196
