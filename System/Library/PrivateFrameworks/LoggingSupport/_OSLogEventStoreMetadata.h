...
- (void).cxx_destruct;	// IMP=0x0000000000049a1e
...
- (id)timeRefForTTLClass:(unsigned char)arg1;	// IMP=0x00000000000499ea
- (id)initWithCollection:(id)arg1 localStorePlist:(id)arg2 liveDataDescriptor:(int)arg3;	// IMP=0x0000000000049729
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000049181
