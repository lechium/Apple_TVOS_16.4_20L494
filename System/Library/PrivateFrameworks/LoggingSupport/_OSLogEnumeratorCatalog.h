...
- (void)enumerateSubchunksUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000017ae8
- (void)unionWithRange:(struct _NSRange)arg1;	// IMP=0x0000000000017ac3
...
- (void)dealloc;	// IMP=0x0000000000017a52
- (id)initWithStore:(id)arg1 index:(id)arg2 fileHeader:(struct tracev3_chunk_s *)arg3 range:(struct _NSRange)arg4 chunk:(struct tracev3_chunk_s *)arg5;	// IMP=0x0000000000017963
