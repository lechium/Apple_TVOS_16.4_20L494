...
- (void)appendBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000000002c0f7
- (void)setTruncated;	// IMP=0x000000000002c0ef
- (void)setPublic;	// IMP=0x000000000002c0ce
- (void)_initBlob;	// IMP=0x000000000002c020
