...
- (void).cxx_destruct;	// IMP=0x0000000000081549
...
- (id)attributeDescriptions;	// IMP=0x00000000000813e3
- (id)initWithModel:(id)arg1 externalID:(id)arg2;	// IMP=0x0000000000081341
