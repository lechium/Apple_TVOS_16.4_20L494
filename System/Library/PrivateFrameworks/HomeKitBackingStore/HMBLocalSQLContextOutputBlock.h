...
+ (id)logCategory;	// IMP=0x0010000000071ebe
- (void).cxx_destruct;	// IMP=0x0000000000071c57
...
- (id)logIdentifier;	// IMP=0x0000000000071b96
- (id)abort;	// IMP=0x0000000000071704
- (id)commit:(id)arg1;	// IMP=0x00000000000711d5
- (id)updateModelID:(id)arg1 modelEncoding:(unsigned long long)arg2 modelData:(id)arg3;	// IMP=0x0000000000070e85
- (id)initWithOwner:(id)arg1 identifier:(id)arg2 zoneRow:(unsigned long long)arg3 blockRow:(unsigned long long)arg4;	// IMP=0x0000000000070bff
