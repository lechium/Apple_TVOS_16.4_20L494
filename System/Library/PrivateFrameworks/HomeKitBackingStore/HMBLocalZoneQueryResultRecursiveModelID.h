...
- (void).cxx_destruct;	// IMP=0x000000000005562b
...
- (id)nextObject;	// IMP=0x0000000000055345
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x000000000005527f
- (id)initWithLocalZone:(id)arg1 modelID:(id)arg2;	// IMP=0x0000000000054f8f
