...
- (void).cxx_destruct;	// IMP=0x000000000005403f
...
- (id)description;	// IMP=0x0000000000053f5e
- (id)initWithName:(id)arg1 offset:(int)arg2 modelField:(id)arg3;	// IMP=0x0000000000053eab
