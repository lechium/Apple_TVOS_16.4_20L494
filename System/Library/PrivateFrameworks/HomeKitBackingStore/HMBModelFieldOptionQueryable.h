...
- (void).cxx_destruct;	// IMP=0x000000000009df67
...
- (void)applyTo:(id)arg1;	// IMP=0x000000000009dd10
- (id)initWithEncodingBlock:(CDUnknownBlockType)arg1 decodingBlock:(CDUnknownBlockType)arg2 descriptionBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000009dc2b
