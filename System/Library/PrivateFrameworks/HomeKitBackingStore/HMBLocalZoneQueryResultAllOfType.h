...
- (void).cxx_destruct;	// IMP=0x0000000000054940
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000054859
- (id)initWithLocalZone:(id)arg1 modelClassName:(id)arg2;	// IMP=0x00000000000546e3
