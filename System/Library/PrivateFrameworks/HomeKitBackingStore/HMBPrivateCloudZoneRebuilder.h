...
+ (id)logCategory;	// IMP=0x001000000003b1c0
- (void).cxx_destruct;	// IMP=0x0000000000034409
...
- (id)logIdentifier;	// IMP=0x00000000000342a7
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000003401d
- (void)handleZoneChanged;	// IMP=0x0000000000033d87
@property(readonly, nonatomic, getter=isZoneRebuildInProgress) _Bool zoneRebuildInProgress;
- (void)rebuild;	// IMP=0x0000000000033ba8
- (void)handleIdentityLost;	// IMP=0x0000000000033a0c
- (id)zoneStartUp;	// IMP=0x00000000000338af
- (id)initWithCloudZone:(id)arg1;	// IMP=0x00000000000337e8
