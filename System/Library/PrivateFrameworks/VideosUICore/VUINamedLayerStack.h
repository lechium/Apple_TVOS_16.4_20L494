...
+ (id)decodedNamedLayerStackWithImage:(id)arg1 size:(struct CGSize)arg2 cornerRadius:(double)arg3;	// IMP=0x001000000000cc6f
+ (id)namedLayerStackWithImage:(id)arg1;	// IMP=0x001000000000c8bc
...
- (id)_init;	// IMP=0x000000000000c88d
- (id)init;	// IMP=0x000000000000c87f
