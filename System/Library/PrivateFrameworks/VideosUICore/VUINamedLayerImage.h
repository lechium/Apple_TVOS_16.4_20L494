...
+ (id)decodedNamedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x0010000000006530
+ (id)namedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x00100000000064bc
- (void).cxx_destruct;	// IMP=0x0000000000006978
...
- (id)imageObj;	// IMP=0x0000000000006927
@property(nonatomic) _Bool fixedFrame;
@property(readonly, nonatomic) double opacity;
@property(readonly, nonatomic) struct CGRect frame;
@property(readonly, nonatomic) NSString *name;
- (id)_init;	// IMP=0x0000000000006481
- (id)init;	// IMP=0x0000000000006473
