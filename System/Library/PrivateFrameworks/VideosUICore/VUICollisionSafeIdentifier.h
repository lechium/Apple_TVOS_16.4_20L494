...
- (id)description;	// IMP=0x0000000000013eac
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000013d11
- (unsigned long long)hash;	// IMP=0x0000000000013caf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000013c67
- (id)initWithRootIdentifier:(id)arg1 collisionCount:(unsigned long long)arg2;	// IMP=0x0000000000013be9
