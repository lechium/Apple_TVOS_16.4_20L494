...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000b35a
...
- (unsigned long long)hash;	// IMP=0x000000000000c1db
- (id)populateOrderedInputFeature;	// IMP=0x000000000000bd78
- (id)description;	// IMP=0x000000000000ba32
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000b362
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b312
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000ad97
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000ab28
- (id)initWithBiasEstimatorFeatures:(id)arg1;	// IMP=0x000000000000a7b5
