...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002b1eb
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002acdd
- (id)initWithModel:(id)arg1;	// IMP=0x000000000002ac5e
- (id)initWithContentsOfURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002aaab
