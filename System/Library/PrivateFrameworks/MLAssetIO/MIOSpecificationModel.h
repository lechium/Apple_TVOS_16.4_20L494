...
- (id).cxx_construct;	// IMP=0x000000000002a980
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002a6d2
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002a22a
@property(readonly, nonatomic) void *irProgram;
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000029bdb
- (id)initWithMessageStream:(struct CodedInputStream *)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000029734
- (id)initWithSpecificationData:(id)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000295f0
