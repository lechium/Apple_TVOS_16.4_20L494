...
- (void).cxx_destruct;	// IMP=0x000000000000f2bd
...
- (void)invalidate;	// IMP=0x000000000000f1ef
- (void)performObserverBlock;	// IMP=0x000000000000f196
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000000ef4e
