...
+ (int)payloadForVideoPayload:(int)arg1;	// IMP=0x0010000000351c8a
+ (int)videoPayloadForPayload:(int)arg1;	// IMP=0x0010000000351c6c
+ (_Bool)convertVideoFormat:(int)arg1 width:(int *)arg2 height:(int *)arg3;	// IMP=0x0010000000351adc
+ (int)videoFormatForWidth:(int)arg1 height:(int)arg2;	// IMP=0x0010000000351980
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000b0ab
- (unsigned long long)hash;	// IMP=0x000000000000af5f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000adb4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000ac7c
- (void)copyTo:(id)arg1;	// IMP=0x000000000000ab82
- (void)writeTo:(id)arg1;	// IMP=0x000000000000a9fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000a9f0
- (id)dictionaryRepresentation;	// IMP=0x0000000000009f08
- (id)description;	// IMP=0x0000000000009e6e
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x000000000035171e
@property(readonly, nonatomic) _Bool isSubStream;
- (id)newMultiwayVideoStream;	// IMP=0x00000000003514af
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000003512ad
