...
- (void)dealloc;	// IMP=0x000000000005df13
@property struct tagCONNRESULT *result;
- (id)initWithCallID:(unsigned int)arg1;	// IMP=0x000000000005de58
- (id)initWithResult:(struct tagCONNRESULT *)arg1;	// IMP=0x000000000005ddc5
