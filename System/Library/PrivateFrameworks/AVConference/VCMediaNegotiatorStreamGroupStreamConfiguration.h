...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e47ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e421a
- (_Bool)isEqualPayloads:(id)arg1;	// IMP=0x00000000000e40d8
- (_Bool)applyCipherSuiteOnMediaStreamConfig:(id)arg1 codecConfigs:(id)arg2;	// IMP=0x00000000000e3eb7
- (_Bool)areCodecsEqualTo:(id)arg1;	// IMP=0x00000000000e3e5a
- (void)resetCodecs;	// IMP=0x00000000000e3e44
- (void)removeCodec:(unsigned int)arg1;	// IMP=0x00000000000e3e0b
- (void)addCodec:(unsigned int)arg1;	// IMP=0x00000000000e3dd2
- (void)resetPayloads;	// IMP=0x00000000000e3dbc
- (void)addPayload:(int)arg1;	// IMP=0x00000000000e3d83
- (void)dealloc;	// IMP=0x00000000000e3d16
- (id)init;	// IMP=0x00000000000e3c90
