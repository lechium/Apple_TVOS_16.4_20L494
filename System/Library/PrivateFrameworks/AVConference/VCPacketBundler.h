...
- (void)unlock;	// IMP=0x0000000000304154
- (void)lock;	// IMP=0x0000000000304146
- (void)initLock;	// IMP=0x00000000003040d1
- (void)resetBuffer;	// IMP=0x0000000000303de8
- (_Bool)bundleAudioLegacy:(void *)arg1 numInputBytes:(unsigned int)arg2 payloadType:(int)arg3 timestamp:(unsigned int)arg4;	// IMP=0x0000000000303a3e
- (_Bool)_copyInputBytes:(void *)arg1 numInputBytes:(unsigned int)arg2 payloadType:(int)arg3 timestamp:(unsigned int)arg4;	// IMP=0x00000000003038e3
- (_Bool)bundleAudioRFC3640:(void *)arg1 numInputBytes:(unsigned int)arg2 payloadType:(int)arg3 timestamp:(unsigned int)arg4;	// IMP=0x0000000000302dc4
- (char *)accessUnitDataSectionHead;	// IMP=0x0000000000302da1
- (unsigned int)accessUnitHeaderSectionSizeMaximum;	// IMP=0x0000000000302d93
- (unsigned int)accessUnitHeaderSectionSize;	// IMP=0x0000000000302d80
- (unsigned int)encodedBufferSizeForRFC3640;	// IMP=0x0000000000302d60
- (char *)encodedBufferForRFC3640;	// IMP=0x0000000000302ce8
...
- (_Bool)setPacketsPerBundle:(unsigned int)arg1;	// IMP=0x0000000000302c6d
@property(nonatomic) unsigned int maxPacketSize;
- (_Bool)reallocateBufferWithMaxPacketSize:(unsigned int)arg1 maxPacketCount:(unsigned int)arg2;	// IMP=0x0000000000302bb3
- (_Bool)allocateBundleBuffer:(unsigned int)arg1;	// IMP=0x0000000000302b95
- (unsigned int)bundleBufferSizeWidthMaxPacketSize:(unsigned int)arg1 maxPacketCount:(unsigned int)arg2;	// IMP=0x0000000000302b86
- (void)dealloc;	// IMP=0x0000000000302a6e
- (id)initWithOperatingMode:(int)arg1 bundlingScheme:(int)arg2 packetHandler:(CDUnknownFunctionPointerType)arg3 packetHandlerContext:(void *)arg4;	// IMP=0x00000000003027e6
