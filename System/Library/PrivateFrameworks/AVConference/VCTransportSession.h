...
+ (int)vtpPacketTypeForStreamType:(unsigned int)arg1;	// IMP=0x006000000027e9b2
+ (unsigned int)trafficClassForStreamType:(unsigned int)arg1;	// IMP=0x006000000027e8bb
...
- (struct tagVCNWConnectionMonitor *)createNWMonitor;	// IMP=0x000000000027eced
- (void)setupNWMonitorPacketEventHandler;	// IMP=0x000000000027eca7
- (void)setupNWMonitorNotificationHandler;	// IMP=0x000000000027ec61
- (void)destroyNWMonitor;	// IMP=0x000000000027ec20
- (void)setupNWMonitor;	// IMP=0x000000000027ebcc
@property(readonly) _Bool isIPv6;
@property(readonly) unsigned int networkMTU;
@property(readonly) int networkInterfaceType;
- (void)resetActiveConnection;	// IMP=0x000000000027e8b5
- (void)setOneToOneModeEnabled:(_Bool)arg1 isInitiator:(_Bool)arg2;	// IMP=0x000000000027e8af
- (void)reportNetworkConditionsDegraded;	// IMP=0x000000000027e8a9
- (void)handleMediaReceivedOverPeerToPeerLinkWithConnectionId:(int)arg1;	// IMP=0x000000000027e8a3
- (void)handleMediaReceivedOverRelayLinkWithConnectionId:(int)arg1;	// IMP=0x000000000027e89d
- (_Bool)getConnectionSetupData:(id *)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x000000000027e895
...
- (void)setConnectionSelectionVersionWithLocalFrameworkVersion:(id)arg1 remoteFrameworkVersion:(id)arg2;	// IMP=0x000000000027e730
@property(nonatomic, setter=setCallActive:) _Bool isCallActive;
- (int)deregisterNotificationForTransportStream:(struct OpaqueVCTransportStream *)arg1;	// IMP=0x000000000027e56b
- (int)createVFD:(int *)arg1 forStreamType:(unsigned int)arg2;	// IMP=0x000000000027e50a
- (int)createTransportStream:(struct OpaqueVCTransportStream **)arg1 withType:(unsigned int)arg2 options:(id)arg3;	// IMP=0x000000000027e297
- (void)handleTransportStreamDeactivated:(struct OpaqueVCTransportStream *)arg1;	// IMP=0x000000000027e231
- (void)callEventHandlerWithEvent:(unsigned int)arg1 info:(id)arg2;	// IMP=0x000000000027e07c
- (void)stop;	// IMP=0x000000000027dec5
- (void)start;	// IMP=0x000000000027de64
- (void)dealloc;	// IMP=0x000000000027dc69
- (id)initWithNotificationQueue:(id)arg1 reportingAgent:(struct opaqueRTCReporting *)arg2 notificationHandler:(CDUnknownFunctionPointerType)arg3 eventHandler:(CDUnknownFunctionPointerType)arg4 handlerQueue:(id)arg5 context:(void *)arg6;	// IMP=0x000000000027db0c
- (id)initWithNotificationQueue:(id)arg1 reportingAgent:(struct opaqueRTCReporting *)arg2;	// IMP=0x000000000027dae4
