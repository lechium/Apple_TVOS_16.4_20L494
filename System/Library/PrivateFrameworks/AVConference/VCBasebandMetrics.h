...
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x000000000019a0c3
- (void)addBDCDListWithNotificationArrivalTime:(double)arg1 bdcd:(double)arg2 queuingDelay:(double)arg3;	// IMP=0x0000000000199fb7
- (void)resetBBNoteHistoryList;	// IMP=0x0000000000199f9c
- (void)resetBDCDList;	// IMP=0x0000000000199f81
- (void)normalizeBDCD:(double)arg1;	// IMP=0x0000000000199d28
- (double)updateTotalQueueDepth:(unsigned int)arg1;	// IMP=0x0000000000199cb9
- (void)calculateBitratesAndDelaysWithTotalQueueDepth:(unsigned int)arg1;	// IMP=0x0000000000199a02
- (void)addInfoListWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x000000000019993f
- (struct tagVCStatisticsMessage)getBasebandMetricsWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x00000000001996d1
- (void)dealloc;	// IMP=0x0000000000199673
- (id)init;	// IMP=0x00000000001995cc
