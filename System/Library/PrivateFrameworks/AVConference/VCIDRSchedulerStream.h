...
+ (id)schedulerStreamWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x00600000002ad0aa
...
- (id)description;	// IMP=0x00000000002ad1bd
- (long long)compareWeightFactor:(id)arg1;	// IMP=0x00000000002ad166
- (id)initWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x00000000002ad0f2
