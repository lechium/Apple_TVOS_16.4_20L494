...
+ (long long)compareAudioEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x006000000019b49e
+ (long long)compareVideoEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x006000000019b099
+ (long long)compareAudioEntry:(id)arg1 audioEntry:(id)arg2;	// IMP=0x006000000019aef8
+ (unsigned char)entryTypeForMediaType:(unsigned int)arg1;	// IMP=0x006000000019acb6
...
- (long long)compare:(id)arg1;	// IMP=0x000000000019ad42
- (id)description;	// IMP=0x000000000019aba2
- (void)dealloc;	// IMP=0x000000000019ab44
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 streamID:(unsigned int)arg4 streamGroupID:(unsigned int)arg5;	// IMP=0x000000000019aa94
...
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 networkBitrate:(unsigned int)arg4 mediaBitrate:(unsigned int)arg5 qualityIndex:(unsigned int)arg6 streamID:(unsigned int)arg7 streamGroupID:(unsigned int)arg8;	// IMP=0x000000000019a95f
