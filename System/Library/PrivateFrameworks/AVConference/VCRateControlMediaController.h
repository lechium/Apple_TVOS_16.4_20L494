...
- (void)updateLargeFrameSizeWithBandwidth:(unsigned int)arg1;	// IMP=0x0000000000112a50
- (void)updateProbingLargeFrameSizeCap;	// IMP=0x0000000000112997
- (_Bool)isProbingLargeFrameRequiredAtTime:(double)arg1;	// IMP=0x00000000001126c2
- (void)printLargeFrameStatsAtTime:(double)arg1 timestamp:(unsigned int)arg2 timeSinceLastProbingSequence:(double)arg3 frameSize:(unsigned int)arg4 wastedBytes:(unsigned int)arg5 fecRatio:(double)arg6 isFrameRequested:(_Bool)arg7;	// IMP=0x00000000001124fc
- (void)scheduleProbingSequenceAtTime:(double)arg1;	// IMP=0x00000000001123f8
- (void)increaseBasebandFlushCountInternallyWithSuggestion:(struct VCRateControlMediaSuggestion *)arg1;	// IMP=0x0000000000112350
- (_Bool)increaseFlushCountForVideoRefresh:(int)arg1 transactionID:(unsigned short)arg2;	// IMP=0x00000000001122df
- (void)recordVideoRefreshFrameWithTimestamp:(unsigned int)arg1 payloadType:(unsigned char)arg2 packetCount:(unsigned int)arg3 isKeyFrame:(_Bool)arg4;	// IMP=0x000000000011224c
- (void)scheduleProbingSequenceWithFrameSize:(unsigned int)arg1 paddingBytes:(unsigned int)arg2 timestamp:(unsigned int)arg3 fecRatio:(double)arg4 isProbingSequenceScheduled:(_Bool *)arg5;	// IMP=0x000000000011208f
...
- (_Bool)rampUpAudioFraction;	// IMP=0x0000000000111dd7
- (_Bool)rampDownAudioFraction;	// IMP=0x0000000000111d3a
- (_Bool)didMediaGetFlushedWithPayloadType:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x0000000000111b6b
- (void)decreaseFlushCount:(int)arg1;	// IMP=0x0000000000111a39
@property(readonly, nonatomic) _Bool isVideoStopped;
- (void)resumeVideoByVCRateControl;	// IMP=0x000000000011177a
- (void)stopVideoByVCRateControl;	// IMP=0x000000000011162e
- (void)pauseVideoByUser:(_Bool)arg1;	// IMP=0x0000000000111475
- (void)updateAudioStallInMediaSuggestion:(struct VCRateControlMediaSuggestion *)arg1 isSuggestionNeeded:(_Bool *)arg2 atTime:(double)arg3;	// IMP=0x0000000000111387
- (void)updateBasebandSuggestionWithStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000110c1d
- (void)computePacketLossWithRemoteInfo:(struct VCRCMediaPLPFromRemoteInfo *)arg1;	// IMP=0x0000000000110aed
- (void)getMediaQueueRateChangeCounter:(unsigned int *)arg1 rateChangeTime:(double *)arg2;	// IMP=0x0000000000110a49
- (void)getMediaQueueInVideoBitrate:(double *)arg1 outVideoBitrate:(double *)arg2 inAudioBitrate:(double *)arg3 outAudioBitrate:(double *)arg4;	// IMP=0x0000000000110976
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x000000000011058b
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x000000000011057e
- (void)dealloc;	// IMP=0x00000000001104fc
- (id)initWithMediaQueue:(struct tagHANDLE *)arg1 delegate:(id)arg2;	// IMP=0x00000000001103be
