...
- (void)didServerDie;	// IMP=0x00000000001851e9
- (void)didResumeAudioIO:(id)arg1;	// IMP=0x00000000001851e3
- (void)didSuspendAudioIO:(id)arg1;	// IMP=0x00000000001851dd
@property(retain, nonatomic) AVAudioDevice *outputDevice;
@property(retain, nonatomic) AVAudioDevice *inputDevice;
- (_Bool)setCurrentAudioDevice:(id)arg1 type:(_Bool)arg2;	// IMP=0x00000000001851b9
- (id)getCurrentAudioDeviceWithType:(_Bool)arg1;	// IMP=0x00000000001851b1
- (void)stopAudioIOWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001851ab
- (void)startAudioIOWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001851a5
- (_Bool)stopAudioSessionWithError:(id *)arg1;	// IMP=0x000000000018519d
- (_Bool)startAudioSessionWithError:(id *)arg1;	// IMP=0x0000000000185195
- (_Bool)stopWithError:(id *)arg1;	// IMP=0x0000000000184c84
- (_Bool)startWithError:(id *)arg1;	// IMP=0x00000000001847fa
- (void)setAudioSessionProperties:(id)arg1;	// IMP=0x000000000018477f
- (_Bool)resetAudioSessionOutputPortOverride:(id *)arg1;	// IMP=0x0000000000184777
- (_Bool)unmuteWithError:(id *)arg1;	// IMP=0x000000000018471e
- (_Bool)muteWithError:(id *)arg1;	// IMP=0x00000000001846f9
- (void)unlock;	// IMP=0x00000000001846eb
- (void)lock;	// IMP=0x00000000001846dd
- (void)dealloc;	// IMP=0x0000000000184676
- (id)initWithProcessId:(int)arg1;	// IMP=0x00000000001845dc
