...
- (void)updateRedundancyPercentage;	// IMP=0x00000000002120d7
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000212056
- (id)init;	// IMP=0x0000000000211fea
