...
- (unsigned int)getBitrateKbpsSinceTime:(double)arg1;	// IMP=0x000000000016df1b
- (double)getFramerateSinceTime:(double)arg1;	// IMP=0x000000000016dea2
- (void)updateMinMaxSinceTime:(double)arg1;	// IMP=0x000000000016de3f
@property(readonly, nonatomic) unsigned int bitrateKbps;
@property(readonly, nonatomic) double framerate;
- (void)recordDataWithSize:(double)arg1 atTime:(double)arg2;	// IMP=0x000000000016dd88
- (void)dealloc;	// IMP=0x000000000016dd21
- (id)init;	// IMP=0x000000000016dc4a
