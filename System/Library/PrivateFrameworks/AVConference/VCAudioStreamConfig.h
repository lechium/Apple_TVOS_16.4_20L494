...
+ (int)bundlingSchemeForAudioStreamMode:(long long)arg1 payloadType:(int)arg2;	// IMP=0x00600000003aac8c
...
- (void)addSupportedNumRedundantPayload:(unsigned int)arg1;	// IMP=0x00000000003ab85c
- (void)addCodecConfiguration:(id)arg1;	// IMP=0x00000000003ab781
@property(nonatomic) const struct tagVCAudioFrameFormat *externalIOFormat;
- (_Bool)setupDTMFCodecWithClientDictionary:(id)arg1;	// IMP=0x00000000003ab4e4
- (_Bool)setupCNCodecWithClientDictionary:(id)arg1;	// IMP=0x00000000003ab282
- (void)setupRedWithRxPayload:(unsigned int)arg1 txPayload:(unsigned int)arg2;	// IMP=0x00000000003ab22e
- (_Bool)setupCodecWithClientDictionary:(id)arg1;	// IMP=0x00000000003aad6c
- (void)dealloc;	// IMP=0x00000000003aac11
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x00000000003aa7e0
- (id)init;	// IMP=0x00000000003aa753
