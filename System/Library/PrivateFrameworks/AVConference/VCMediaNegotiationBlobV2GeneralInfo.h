...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000016f467
- (unsigned long long)hash;	// IMP=0x000000000016f3d5
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016f2e7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016f216
- (void)copyTo:(id)arg1;	// IMP=0x000000000016f183
- (void)writeTo:(id)arg1;	// IMP=0x000000000016f0dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000016f0d0
- (id)dictionaryRepresentation;	// IMP=0x000000000016ec5b
- (id)description;	// IMP=0x000000000016ebc1
...
- (void)dealloc;	// IMP=0x000000000016ea50
- (void)printWithLogFile:(void *)arg1 prefix:(id)arg2;	// IMP=0x0000000000320e65
@property(readonly, nonatomic) struct CGSize screenResolution;
@property(readonly, nonatomic) union tagNTP creationTime;
- (id)initWithCreationTime:(union tagNTP)arg1 screenResolution:(struct CGSize)arg2 abSwitches:(unsigned int)arg3;	// IMP=0x0000000000320c72
