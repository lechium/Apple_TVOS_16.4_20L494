...
+ (id)sharedInstance;	// IMP=0x0060000000100909
@property(readonly) unsigned char wifiAssistState; // @synthesize wifiAssistState=_wifiAssistState;
- (void)removeDelegate:(id)arg1;	// IMP=0x0000000000100917
- (void)addDelegate:(id)arg1;	// IMP=0x0000000000100911
@property(readonly) _Bool isAvailable;
- (id)init;	// IMP=0x00000000001008f3
