...
+ (id)streamGroupConfigWithGroupID:(unsigned int)arg1 mediaType:(unsigned int)arg2 subtype:(unsigned int)arg3 syncGroupID:(unsigned int)arg4 cipherSuite:(unsigned int)arg5;	// IMP=0x00100000000fd42d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000fda2c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fd7ad
- (void)removeStreamConfigs:(struct _NSRange)arg1;	// IMP=0x00000000000fd797
- (unsigned long long)indexOfCodecConfig:(id)arg1;	// IMP=0x00000000000fd702
- (void)addCodecConfig:(id)arg1;	// IMP=0x00000000000fd5ae
- (void)addStreamConfig:(id)arg1;	// IMP=0x00000000000fd56a
- (id)description;	// IMP=0x00000000000fd4ff
- (void)dealloc;	// IMP=0x00000000000fd48b
- (id)initWithGroupID:(unsigned int)arg1 mediaType:(unsigned int)arg2 subtype:(unsigned int)arg3 syncGroupID:(unsigned int)arg4 cipherSuite:(unsigned int)arg5;	// IMP=0x00000000000fd40f
- (id)initWithGroupID:(unsigned int)arg1 mediaType:(unsigned int)arg2 subtype:(unsigned int)arg3 syncGroupID:(unsigned int)arg4;	// IMP=0x00000000000fd3cf
- (id)init;	// IMP=0x00000000000fd350
