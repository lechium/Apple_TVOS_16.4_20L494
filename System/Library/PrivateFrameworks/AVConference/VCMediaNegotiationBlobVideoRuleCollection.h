...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000356fcf
- (unsigned long long)hash;	// IMP=0x0000000000356f35
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000356e57
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000356d9a
- (void)copyTo:(id)arg1;	// IMP=0x0000000000356d1b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000356c4d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000356c40
- (id)dictionaryRepresentation;	// IMP=0x00000000003565d7
- (id)description;	// IMP=0x000000000035653d
...
- (int)StringAsOperation:(id)arg1;	// IMP=0x0000000000356418
- (id)operationAsString:(int)arg1;	// IMP=0x00000000003563d8
- (int)StringAsTransport:(id)arg1;	// IMP=0x000000000035638c
- (id)transportAsString:(int)arg1;	// IMP=0x000000000035634c
