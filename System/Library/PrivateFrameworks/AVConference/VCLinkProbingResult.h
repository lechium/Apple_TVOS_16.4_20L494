...
- (id)description;	// IMP=0x000000000038e6d1
- (unsigned char)getPLRTierFromPLREnvelope:(double)arg1;	// IMP=0x000000000038e629
- (void)updateLinkStatsWithArrivingNewValueMeanRTT:(double)arg1 arrivingNewValuePLR:(double)arg2;	// IMP=0x000000000038e47f
- (void)updateProbingResult:(id)arg1 initialResult:(_Bool)arg2;	// IMP=0x000000000038dfd8
- (void)mergeProbingResults:(id)arg1;	// IMP=0x000000000038dfc4
- (void)dealloc;	// IMP=0x000000000038df49
- (id)initWithProbingResults:(id)arg1 linkProbingResultConfig:(CDStruct_7421bd8e)arg2;	// IMP=0x000000000038de3d
