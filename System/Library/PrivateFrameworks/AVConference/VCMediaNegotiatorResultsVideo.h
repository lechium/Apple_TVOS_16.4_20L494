...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002ef5c0
- (void)addNegotiatedHDRMode:(id)arg1;	// IMP=0x00000000002ef5aa
- (void)addPixelFormatSet:(id)arg1;	// IMP=0x00000000002ef594
- (void)addParameterSet:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002ef54a
- (void)addFeatureString:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002ef500
- (void)addVideoRules:(id)arg1 transportType:(unsigned char)arg2 payload:(int)arg3 encodingType:(unsigned char)arg4;	// IMP=0x00000000002ef4ea
- (void)dealloc;	// IMP=0x00000000002ef468
- (id)init;	// IMP=0x00000000002ef3b9
