...
- (id)description;	// IMP=0x0000000000413574
- (unsigned long long)hash;	// IMP=0x0000000000413543
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004134b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000413465
- (id)initWithPayload:(int)arg1 transportType:(unsigned char)arg2 encodingType:(unsigned char)arg3;	// IMP=0x00000000004133f1
