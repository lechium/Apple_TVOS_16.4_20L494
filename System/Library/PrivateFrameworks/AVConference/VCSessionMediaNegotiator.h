...
+ (id)unserializeNegotiationData:(id)arg1;	// IMP=0x001000000012cb36
+ (id)serializeNegotiationData:(id)arg1;	// IMP=0x001000000012caf2
+ (_Bool)initializeLocalConfiguration:(id)arg1 negotiationData:(id)arg2 deviceRole:(int)arg3 preferredAudioPayload:(int)arg4;	// IMP=0x001000000012c92a
+ (id)streamGroupIDsWithMediaBlob:(id)arg1;	// IMP=0x001000000012c6b4
+ (id)negotiationDataWithVersion1:(id)arg1 version2:(id)arg2;	// IMP=0x001000000012c0e9
+ (id)negotiationDataWithVersion:(int)arg1 mediaBlob:(id)arg2;	// IMP=0x001000000012c073
+ (id)mediaBlobForVersion:(int)arg1 negotiationData:(id)arg2;	// IMP=0x001000000012c018
@property(readonly, nonatomic) VCMediaNegotiatorLocalConfiguration *localSettings; // @synthesize localSettings=_localSettings;
- (unsigned int)remoteMaxBandwidthForOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x000000000012c914
- (id)negotiatedResultsForGroupID:(unsigned int)arg1;	// IMP=0x000000000012c69e
...
- (_Bool)processRemoteNegotiationData:(id)arg1;	// IMP=0x000000000012c3ee
- (id)negotiationData;	// IMP=0x000000000012c16e
- (void)dealloc;	// IMP=0x000000000012bfa4
- (id)initWithLocalConfiguration:(id)arg1;	// IMP=0x000000000012bd6a
