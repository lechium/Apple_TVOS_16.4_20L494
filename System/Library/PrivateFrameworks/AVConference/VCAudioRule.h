...
- (unsigned long long)hash;	// IMP=0x000000000023a770
...
- (id)description;	// IMP=0x000000000023a6de
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000023a637
- (id)initWithPayload:(int)arg1 isSecondary:(_Bool)arg2 sbr:(_Bool)arg3 samplesPerBlock:(unsigned int)arg4;	// IMP=0x000000000023a598
- (id)init;	// IMP=0x000000000023a58a
