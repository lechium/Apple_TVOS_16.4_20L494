...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000305056
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000304e94
- (_Bool)isSecondaryPayload:(int)arg1;	// IMP=0x0000000000304e5b
- (void)addAudioPayload:(int)arg1 isSecondary:(_Bool)arg2;	// IMP=0x0000000000304cd7
- (void)dealloc;	// IMP=0x0000000000304c6a
- (id)initWithAllowAudioSwitching:(_Bool)arg1 allowAudioRecording:(_Bool)arg2 useSBR:(_Bool)arg3 ssrc:(unsigned int)arg4 audioUnitNumber:(unsigned int)arg5 audioRuleCollection:(id)arg6;	// IMP=0x00000000003049f0
- (id)initWithAllowAudioSwitching:(_Bool)arg1 allowAudioRecording:(_Bool)arg2 useSBR:(_Bool)arg3 ssrc:(unsigned int)arg4 audioUnitNumber:(unsigned int)arg5;	// IMP=0x00000000003049d3
