...
- (void)setConfig:(id)arg1 pid:(id)arg2;	// IMP=0x00000000003c29e3
- (void)updateScreenShareWith:(id)arg1 pid:(id)arg2;	// IMP=0x00000000003c29d1
- (void)dealloc;	// IMP=0x00000000003c2957
- (id)initWithConfig:(id)arg1 pid:(id)arg2;	// IMP=0x00000000003c28d4
