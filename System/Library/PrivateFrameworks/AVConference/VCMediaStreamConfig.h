...
- (int)jitterBufferModeFromAVCJitterBufferMode:(unsigned int)arg1;	// IMP=0x000000000038d1ac
- (void)applyMediaStreamClientDictionary:(id)arg1;	// IMP=0x000000000038ccda
- (void)setupMediaStreamConfig;	// IMP=0x000000000038cc51
@property(readonly, nonatomic) long long primaryTxCodecType;
- (void)addTxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x000000000038ca91
- (void)addTxPayloadType:(int)arg1;	// IMP=0x000000000038ca7a
- (void)addRxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x000000000038ca0f
- (void)addRxPayloadType:(int)arg1;	// IMP=0x000000000038c9f8
- (id)description;	// IMP=0x000000000038c9b7
- (void)dealloc;	// IMP=0x000000000038c8d9
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000038c810
- (id)init;	// IMP=0x000000000038c7a1
