...
- (void)printFlushAckToBasebandDump:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x000000000019a7c3
- (void)processBasebandAck:(CDStruct_b203c80d *)arg1;	// IMP=0x000000000019a67d
- (_Bool)isRadioAccessTechnologyOnCellular:(unsigned int)arg1;	// IMP=0x000000000019a66e
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x000000000019a654
- (_Bool)processBasebandNotification:(CDStruct_b203c80d *)arg1 arrivalTime:(double)arg2 error:(id *)arg3;	// IMP=0x000000000019a421
- (_Bool)processBasebandNotification:(id)arg1 metaData:(id)arg2 error:(id *)arg3;	// IMP=0x000000000019a31e
- (void)dealloc;	// IMP=0x000000000019a17c
- (id)init;	// IMP=0x000000000019a10d
