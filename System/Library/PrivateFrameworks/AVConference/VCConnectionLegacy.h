...
- (_Bool)matchesSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x00000000000f4fe2
- (struct tagIPPORT)IPPortForNWConnection:(id)arg1;	// IMP=0x00000000000f4f73
- (void)getSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x00000000000f4e73
...
- (int)cellularMTU;	// IMP=0x00000000000f4b83
...
- (unsigned short)updateMaxConnectionMTU:(unsigned short)arg1;	// IMP=0x00000000000f48a2
- (_Bool)isSameAsConnection:(id)arg1;	// IMP=0x00000000000f4652
@property(readonly, copy) NSString *description;
- (id)ipportToString:(struct tagIPPORT *)arg1;	// IMP=0x00000000000f43e5
- (_Bool)isOnSameInterfacesWithConnection:(id)arg1;	// IMP=0x00000000000f41b8
@property(readonly) _Bool isWifiToWifi;
- (_Bool)isOnSameIPPortWithConnection:(id)arg1;	// IMP=0x00000000000f3e3d
- (_Bool)isRemoteIPPort:(struct tagIPPORT *)arg1;	// IMP=0x00000000000f3ceb
- (_Bool)isLocalIPPort:(struct tagIPPORT *)arg1;	// IMP=0x00000000000f3bea
- (void)dealloc;	// IMP=0x00000000000f3b81
- (id)copy;	// IMP=0x00000000000f3ae8
- (id)initWithCandidatePair:(struct tagCANDIDATEPAIR *)arg1;	// IMP=0x00000000000f39d1
- (id)initWithConnectionResult:(struct tagCONNRESULT *)arg1 type:(unsigned int)arg2;	// IMP=0x00000000000f3865
