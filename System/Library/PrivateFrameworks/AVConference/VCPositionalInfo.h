...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002fbe0c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002fbf2b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002fbe14
...
- (void)unserialize:(id)arg1;	// IMP=0x00000000002fb9f0
- (id)serialize;	// IMP=0x00000000002fb92e
- (id)description;	// IMP=0x00000000002fb8e4
- (id)init;	// IMP=0x00000000002fb889
