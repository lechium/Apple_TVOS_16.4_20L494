...
- (void)setClientFormat:(const struct tagVCAudioFrameFormat *)arg1;	// IMP=0x000000000026a2bf
- (void)setRemoteCodecType:(unsigned int)arg1 sampleRate:(double)arg2;	// IMP=0x000000000026a2a7
- (void)setFarEndVersionInfo:(struct VoiceIOFarEndVersionInfo)arg1;	// IMP=0x000000000026a27b
