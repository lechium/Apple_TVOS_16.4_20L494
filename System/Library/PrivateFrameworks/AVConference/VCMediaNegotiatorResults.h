...
- (unsigned int)maxBandwidthWithOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x00000000002ebfb4
- (void)addBandwidthConfigurations:(id)arg1;	// IMP=0x00000000002ebf7f
- (void)dealloc;	// IMP=0x00000000002ebf0b
- (id)init;	// IMP=0x00000000002ebe8b
