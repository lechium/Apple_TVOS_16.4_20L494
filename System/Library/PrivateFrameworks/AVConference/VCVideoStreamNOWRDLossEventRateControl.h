...
- (id)className;	// IMP=0x0000000000056173
- (void)calculateNOWRD:(double)arg1 time:(double)arg2;	// IMP=0x0000000000055d4c
- (void)calculateOWRDWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000055913
- (void)resetLossEventBuffer;	// IMP=0x0000000000055902
- (int)lossEventCountThresholdForBitrate:(unsigned int)arg1;	// IMP=0x00000000000558da
- (int)lossEventCount;	// IMP=0x00000000000558c0
- (void)updatePacketLossRate:(double)arg1 time:(double)arg2;	// IMP=0x0000000000055870
- (_Bool)shouldRampUp;	// IMP=0x00000000000557aa
- (_Bool)shouldRampDown;	// IMP=0x00000000000556f6
- (unsigned short)rampDownTier;	// IMP=0x00000000000556cc
- (unsigned short)rampUpTier;	// IMP=0x00000000000556ad
- (void)stateEnter;	// IMP=0x000000000005568e
- (void)stateExit;	// IMP=0x0000000000055688
- (void)stateChange:(int)arg1;	// IMP=0x000000000005552f
- (void)printRateControlFullInfoWithLogDump:(void *)arg1 time:(double)arg2 videoStall:(_Bool)arg3 videoFrozenDuration:(double)arg4 averageTargetBitrate:(unsigned int)arg5;	// IMP=0x000000000005540f
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x00000000000553fd
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingTierIndex:(unsigned short)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x0000000000055200
@property(readonly, copy) NSString *description;
- (void)setMaxTierIndex:(unsigned short)arg1 minTierIndex:(unsigned short)arg2;	// IMP=0x000000000005514a
- (id)init;	// IMP=0x0000000000054f3a
