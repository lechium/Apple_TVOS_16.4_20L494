...
- (void)readStoreBagValues;	// IMP=0x00000000002589b9
- (unsigned int)bitrateForStoreBagKey:(id)arg1 connectionType:(int)arg2 currentBitrate:(unsigned int)arg3 isExpensive:(_Bool)arg4;	// IMP=0x00000000002587ab
- (void)readHardwareValues;	// IMP=0x0000000000258781
- (_Bool)rangeCheck:(unsigned int)arg1;	// IMP=0x0000000000258708
- (void)dealloc;	// IMP=0x00000000002586aa
- (id)init;	// IMP=0x0000000000258626
