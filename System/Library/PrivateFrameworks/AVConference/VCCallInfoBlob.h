...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003df111
- (unsigned long long)hash;	// IMP=0x00000000003df078
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003def8c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003deea5
- (void)copyTo:(id)arg1;	// IMP=0x00000000003dee20
- (void)writeTo:(id)arg1;	// IMP=0x00000000003ded99
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003ded8c
- (id)dictionaryRepresentation;	// IMP=0x00000000003de953
- (id)description;	// IMP=0x00000000003de8b9
- (void)dealloc;	// IMP=0x00000000003de830
- (id)stringForCheckpoint;	// IMP=0x00000000003c9da6
