...
- (_Bool)isVirtualRelayLink;	// IMP=0x00000000003107d0
- (long long)connectionType;	// IMP=0x00000000003107c5
- (unsigned int)remoteRATType;	// IMP=0x00000000003107b1
- (unsigned int)RATType;	// IMP=0x000000000031079d
- (id)init;	// IMP=0x0000000000310665
