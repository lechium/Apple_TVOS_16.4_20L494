...
- (struct tagVCStatisticsMessage)getVCStatisticsWithType:(int)arg1 time:(double)arg2;	// IMP=0x000000000003b176
- (_Bool)shouldProcessAtTime:(double)arg1;	// IMP=0x000000000003b137
- (void)unregisterAllStatisticsChangeHandlers;	// IMP=0x000000000003ad2e
- (_Bool)unregisterStatisticsChangeHandlerWithType:(int)arg1 handlerIndex:(int)arg2;	// IMP=0x000000000003aafc
- (int)registerStatisticsChangeHandlerWithType:(int)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000003a92c
@property(readonly, nonatomic) _Bool isStarted;
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x000000000003a90b
- (id)getStatistics:(id)arg1;	// IMP=0x000000000003a64a
- (void)setStatistics:(id)arg1;	// IMP=0x000000000003a46a
- (void)stop;	// IMP=0x000000000003a2da
- (void)start;	// IMP=0x00000000000394fc
- (void)dealloc;	// IMP=0x00000000000391c2
- (id)initForSimulation:(_Bool)arg1 useExternalThread:(_Bool)arg2;	// IMP=0x0000000000038fee
- (id)init;	// IMP=0x0000000000038fd8
