...
- (void)deregisterWithUUID:(id)arg1 service:(char *)arg2;	// IMP=0x00000000002e4071
- (void)registerBlockWithUUID:(id)arg1 service:(char *)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000002e3913
- (void)deregisterFromNotifications;	// IMP=0x00000000002e37c4
- (void)dealloc;	// IMP=0x00000000002e373c
- (id)init;	// IMP=0x00000000002e361d
