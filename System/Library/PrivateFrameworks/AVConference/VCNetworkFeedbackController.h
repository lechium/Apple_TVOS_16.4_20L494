...
- (void)cleanupWRMClient;	// IMP=0x0000000000183900
- (void)setupWRMClientWithMetricsConfig:(CDStruct_21a0265e)arg1;	// IMP=0x00000000001837a7
- (void)cleanupWCMClient;	// IMP=0x00000000001837a1
- (void)setupWCMClient;	// IMP=0x000000000018379b
- (void)wcmGetCallConfig:(unsigned int *)arg1 targetBitrate:(unsigned int *)arg2;	// IMP=0x0000000000183682
- (void)wcmSetCallConfig:(unsigned int)arg1 interferenceLevel:(unsigned int)arg2;	// IMP=0x0000000000183536
- (void)setPreWarmState:(_Bool)arg1;	// IMP=0x00000000001834f7
- (void)setWRMCoexMetrics:(id)arg1;	// IMP=0x00000000001833e6
- (void)setWRMNotification:(CDStruct_cd8cfafa *)arg1;	// IMP=0x00000000001832a7
- (void)setWRMMetricConfig:(CDStruct_69d7cc99 *)arg1;	// IMP=0x0000000000183242
- (void)reportWRMMetrics:(const CDStruct_dea828ac *)arg1;	// IMP=0x0000000000183221
- (void)reportImmediateWRMMetric:(int)arg1 value:(unsigned long long)arg2;	// IMP=0x0000000000183200
- (void)requestWRMNotification;	// IMP=0x000000000018312d
- (void)sendStatusUpdate:(const CDStruct_8aeecdac *)arg1;	// IMP=0x0000000000183117
- (void)sendFeedbackControllerReport:(CDStruct_4b4d87a1)arg1;	// IMP=0x0000000000183026
- (void)cleanupWRMData;	// IMP=0x0000000000182fea
- (void)setRSSIThresholdEnabled:(_Bool)arg1;	// IMP=0x0000000000182fd4
- (void)updateMetricsConfig:(CDStruct_21a0265e)arg1;	// IMP=0x0000000000182fbe
@property(readonly) unsigned int recommendedTargetBitrateCap;
- (id)strongDelegate;	// IMP=0x0000000000182f6a
- (void)stop;	// IMP=0x0000000000182e4e
- (void)startWithMetricsConfig:(CDStruct_21a0265e)arg1;	// IMP=0x0000000000182d36
- (void)initializeWRMInfo;	// IMP=0x0000000000182c13
- (void)dealloc;	// IMP=0x0000000000182b7d
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2;	// IMP=0x0000000000182ae4
