...
- (id)description;	// IMP=0x00000000003e2515
- (id)className;	// IMP=0x00000000003e2503
@property(readonly, nonatomic) unsigned int flags;
- (float)qualityForBitRate:(unsigned int)arg1;	// IMP=0x00000000003e2421
- (void)dealloc;	// IMP=0x00000000003e23b4
- (id)initWithConfigDict:(id)arg1;	// IMP=0x00000000003e232c
- (void)setupEncodeProperties:(id)arg1;	// IMP=0x00000000003e1f47
- (void)createSupportedBitratesForEVS;	// IMP=0x00000000003e1f26
- (void)createSupportedBitratesForAMR16k;	// IMP=0x00000000003e1f05
- (void)createSupportedBitratesForAMR8k;	// IMP=0x00000000003e1ee4
- (void)createSupportedBitratesForOpus;	// IMP=0x00000000003e1ec3
- (void)createSupportedBitratesForAACELD48;	// IMP=0x00000000003e1ea2
- (void)createSupportedBitratesForAACELD;	// IMP=0x00000000003e1e81
- (void)createSupportedBitrates;	// IMP=0x00000000003e1e02
- (unsigned int)aacBitrate;	// IMP=0x00000000003e1cd4
- (void)setUseSBR:(_Bool)arg1;	// IMP=0x00000000003e1c59
- (_Bool)configure:(id)arg1;	// IMP=0x00000000003e15c0
