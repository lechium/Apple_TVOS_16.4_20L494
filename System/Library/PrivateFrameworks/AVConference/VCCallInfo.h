...
+ (unsigned char)getVCCurrentVersion;	// IMP=0x006000000039ef62
...
- (_Bool)supportSDPCompression;	// IMP=0x000000000039ef55
- (void)setUserAgent:(id)arg1;	// IMP=0x000000000039ee1e
- (struct VoiceIOFarEndVersionInfo)audioVersionInfo:(_Bool)arg1;	// IMP=0x000000000039edbd
@property(readonly) _Bool supportsDynamicContentsRectWithAspectPreservation;
- (_Bool)updateWithLastDecodedFrameTime:(double)arg1 time:(double)arg2;	// IMP=0x000000000039ebd5
@property(readonly, nonatomic) _Bool requiresImplicitFeatureString;
- (void)dealloc;	// IMP=0x000000000039eb16
- (id)init;	// IMP=0x000000000039e94c
