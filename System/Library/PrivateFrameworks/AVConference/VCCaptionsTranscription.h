...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016d64b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016dac1
- (unsigned long long)hash;	// IMP=0x000000000016da79
- (id)description;	// IMP=0x000000000016da0c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000016d6e9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000016d653
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016d4af
- (void)addSegment:(id)arg1;	// IMP=0x000000000016d47c
@property(readonly, nonatomic) NSString *formattedText;
- (void)dealloc;	// IMP=0x000000000016d3cb
- (id)initWithSFTranscription:(id)arg1 utteranceNumber:(unsigned int)arg2 updateNumber:(unsigned int)arg3 isLocal:(_Bool)arg4 isFinal:(_Bool)arg5 streamToken:(long long)arg6;	// IMP=0x000000000016d177
- (id)initWithUtteranceNumber:(unsigned int)arg1 updateNumber:(unsigned int)arg2 isLocal:(_Bool)arg3 isFinal:(_Bool)arg4 streamToken:(long long)arg5;	// IMP=0x000000000016d0d4
