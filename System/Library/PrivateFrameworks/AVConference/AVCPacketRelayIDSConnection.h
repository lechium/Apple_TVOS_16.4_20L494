...
- (void)dealloc;	// IMP=0x000000000032f591
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x000000000032f251
- (void)readyToRead;	// IMP=0x000000000032f219
- (int)stop;	// IMP=0x000000000032f0f9
- (int)start;	// IMP=0x000000000032e9b5
- (id)initWithIDSDestination:(id)arg1;	// IMP=0x000000000032e7ac
- (id)initWithIDSSocketDescriptor:(unsigned short)arg1;	// IMP=0x000000000032e5a2
