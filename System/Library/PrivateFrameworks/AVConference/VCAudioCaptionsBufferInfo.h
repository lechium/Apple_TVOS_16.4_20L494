...
- (unsigned long long)hash;	// IMP=0x00000000002629e2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000026294d
- (id)description;	// IMP=0x00000000002628f8
- (void)dealloc;	// IMP=0x0000000000262894
- (id)initWithStreamToken:(long long)arg1 format:(struct AudioStreamBasicDescription)arg2 bufferLength:(double)arg3;	// IMP=0x0000000000262661
