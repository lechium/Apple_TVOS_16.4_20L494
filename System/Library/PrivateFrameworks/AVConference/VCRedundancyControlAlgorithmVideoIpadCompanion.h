...
- (unsigned int)computeRedundancyWithBurstyLoss;	// IMP=0x000000000005c47e
- (unsigned int)computeRedundancyWithLossPercentage;	// IMP=0x000000000005c454
- (void)updateBurstyLoss:(unsigned int)arg1;	// IMP=0x000000000005c408
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000005c35a
