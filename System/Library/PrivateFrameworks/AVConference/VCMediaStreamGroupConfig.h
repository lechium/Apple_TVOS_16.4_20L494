...
- (void)setupStreams;	// IMP=0x0000000000154b92
...
- (_Bool)addMediaStreamInfo:(id)arg1;	// IMP=0x000000000015493f
- (void)unlock;	// IMP=0x00000000001548f0
- (void)lock;	// IMP=0x00000000001548df
- (void)dealloc;	// IMP=0x00000000001547fc
- (id)init;	// IMP=0x000000000015476c
