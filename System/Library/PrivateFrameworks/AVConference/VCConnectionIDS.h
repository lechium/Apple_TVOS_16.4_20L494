...
+ (unsigned int)worstCaseNetworkOverheadInBytesWithNumOfStreamId:(int)arg1 isPriorityIncluded:(_Bool)arg2;	// IMP=0x001000000023373a
...
- (int)cellTechForSoMask:(unsigned int)arg1 fallbackTo:(int)arg2;	// IMP=0x0000000000234200
- (_Bool)matchesChannelTokenWithSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x00000000002341d0
- (_Bool)matchesSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x0000000000234189
@property(readonly) unsigned char linkID;
- (_Bool)isOnSameInterfacesAndQRSessionWithConnection:(id)arg1;	// IMP=0x0000000000233f65
- (_Bool)isOnSameQRSessionWithConnection:(id)arg1;	// IMP=0x0000000000233eb4
- (_Bool)isOnSameInterfacesWithConnection:(id)arg1;	// IMP=0x0000000000233c97
- (unsigned short)updateMaxConnectionMTU:(unsigned short)arg1;	// IMP=0x0000000000233ae0
- (_Bool)isSameAsConnection:(id)arg1;	// IMP=0x0000000000233a6a
@property int remoteCellTech;
@property int localCellTech;
- (void)setCellularMTU:(int)arg1;	// IMP=0x00000000002339e0
- (void)getSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x00000000002338f0
...
- (int)networkOverheadInBytesWithNumOfStreamId:(int)arg1 isPriorityIncluded:(_Bool)arg2;	// IMP=0x00000000002336eb
@property int connectionMTU;
- (id)connectionQRSessionID;	// IMP=0x00000000002336ae
...
- (void)dealloc;	// IMP=0x0000000000232e25
- (id)initWithLinkContext:(id)arg1 dataChannelToken:(unsigned int)arg2;	// IMP=0x0000000000232a2c
