...
- (void)addCustomFeatureListString:(id)arg1 payload:(int)arg2;	// IMP=0x000000000027f0d7
- (void)dealloc;	// IMP=0x000000000027f030
- (id)description;	// IMP=0x000000000027eef7
- (id)init;	// IMP=0x000000000027ee1e
