...
- (_Bool)isPrimaryConnectionImprovedFromHistory:(struct ConnectionStatsHistory *)arg1 withIndex:(int)arg2 remoteStatsHistory:(struct ConnectionStatsHistory *)arg3;	// IMP=0x00000000002cf323
- (_Bool)isHistoryImproved:(char *)arg1 currentIndex:(int)arg2;	// IMP=0x00000000002cf2a8
- (_Bool)isHistoryValid:(char *)arg1;	// IMP=0x00000000002cf27c
- (void)updateRatiosForHistory:(struct ConnectionStatsHistory *)arg1 withIndex:(int)arg2;	// IMP=0x00000000002cf20b
- (void)reportConnectionHealthWithStatsHistory:(struct ConnectionStatsHistory *)arg1 index:(int)arg2 isPeerStats:(_Bool)arg3;	// IMP=0x00000000002cf0f7
- (void)resetHistory:(struct ConnectionStatsHistory *)arg1;	// IMP=0x00000000002cf0d4
- (void)updateStatsHistory;	// IMP=0x00000000002cef27
- (void)resetConnectionStats:(_Bool)arg1;	// IMP=0x00000000002ceecd
- (void)processPeerStatsBlob:(unsigned int)arg1;	// IMP=0x00000000002cec1a
- (unsigned int)generateStatsBlob;	// IMP=0x00000000002ceb73
- (void)updateReceiveStats;	// IMP=0x00000000002ceabb
@property id <VCConnectionHealthMonitorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)dealloc;	// IMP=0x00000000002cea12
- (id)init;	// IMP=0x00000000002ce891
