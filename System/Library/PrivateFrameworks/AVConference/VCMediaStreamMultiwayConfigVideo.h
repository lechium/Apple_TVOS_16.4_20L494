...
- (id)streamIds;	// IMP=0x00000000002dfa04
- (void)addSubStreamConfig:(id)arg1;	// IMP=0x00000000002df9e7
- (void)addPayload:(int)arg1;	// IMP=0x00000000002df9a7
- (void)dealloc;	// IMP=0x00000000002df92c
- (id)init;	// IMP=0x00000000002df89f
