...
- (id)className;	// IMP=0x00000000002f3c4d
- (void)releaseLogDumpFile;	// IMP=0x00000000002f3b84
- (void)createLogDumpFile:(unsigned int)arg1;	// IMP=0x00000000002f3add
- (void)updateAverageTargetBitrate:(unsigned int)arg1 interval:(double)arg2;	// IMP=0x00000000002f3a39
- (void)setOperatingTierIndexWithBitrate:(unsigned int)arg1;	// IMP=0x00000000002f382f
- (unsigned short)maxTierIndex:(unsigned int)arg1;	// IMP=0x00000000002f37ad
- (unsigned short)minTierIndex:(unsigned int)arg1;	// IMP=0x00000000002f3726
...
- (void)updateVideoStall:(_Bool)arg1 withStallDuration:(unsigned int)arg2;	// IMP=0x00000000002f362c
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x00000000002f3546
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingBitrate:(unsigned int)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x00000000002f32ab
- (void)setRateControlInterval:(double)arg1;	// IMP=0x00000000002f3219
- (void)setMaxTargetBitrate:(unsigned int)arg1 minTargetBitrate:(unsigned int)arg2;	// IMP=0x00000000002f311f
- (void)dealloc;	// IMP=0x00000000002f30ab
- (id)initWithDumpID:(unsigned int)arg1;	// IMP=0x00000000002f2f08
