...
+ (unsigned int)encoderUsageTypeWithOperatingMode:(int)arg1;	// IMP=0x00600000004125d4
...
- (void)featureListString;	// IMP=0x00000000004127fc
- (unsigned int)numTilesPerVideoFrameForHDRMode:(unsigned long long)arg1;	// IMP=0x0000000000412708
- (void)dealloc;	// IMP=0x000000000041269b
- (id)initWithMode:(int)arg1;	// IMP=0x00000000004125f0
