...
+ (unsigned long long)hdrModeWithOptions:(id)arg1;	// IMP=0x006000000027d2d0
+ (id)negotiatorSettingsForMode:(long long)arg1 deviceRole:(unsigned char)arg2 options:(id)arg3 errorString:(id *)arg4;	// IMP=0x006000000027d19b
...
- (void)dealloc;	// IMP=0x000000000027d065
- (id)init;	// IMP=0x000000000027cffe
- (id)initWithOptions:(id)arg1 deviceRole:(unsigned char)arg2 error:(id *)arg3;	// IMP=0x000000000027cfec
