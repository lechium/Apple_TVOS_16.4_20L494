...
- (void)runUntilTime:(double)arg1;	// IMP=0x000000000007c367
- (id)copyPacketFromPop;	// IMP=0x000000000007c317
- (void)push:(id)arg1;	// IMP=0x000000000007c2de
- (void)dealloc;	// IMP=0x000000000007c25a
- (id)initWithPolicies:(id)arg1;	// IMP=0x000000000007c16b
