...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018b0ff
- (void)dealloc;	// IMP=0x000000000018b0a1
- (void)addSecondaryPayload:(int)arg1;	// IMP=0x000000000018b068
@property(readonly, nonatomic) NSArray *secondaryPayloads;
- (id)init;	// IMP=0x000000000018afce
