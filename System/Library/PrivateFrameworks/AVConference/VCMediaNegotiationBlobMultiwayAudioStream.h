...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000003ef53
- (unsigned long long)hash;	// IMP=0x000000000003ed60
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003ec00
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003eaf4
- (void)copyTo:(id)arg1;	// IMP=0x000000000003ea26
- (void)writeTo:(id)arg1;	// IMP=0x000000000003e8f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003e8ec
- (id)dictionaryRepresentation;	// IMP=0x000000000003e0a6
- (id)description;	// IMP=0x000000000003e00c
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000003510ad
- (id)newMultiwayAudioStream;	// IMP=0x0000000000350f0a
- (void)setPayloadFlagsWithPayloads:(id)arg1;	// IMP=0x0000000000350d96
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x0000000000350beb
