...
- (void)enableNWLogDump:(void *)arg1;	// IMP=0x0000000000028656
- (void)sendCongestionEventWithTimestamp:(unsigned int)arg1;	// IMP=0x0000000000028595
- (_Bool)processNWConnectionPacketEvent:(struct packet_id *)arg1 eventType:(int)arg2;	// IMP=0x0000000000028432
- (_Bool)processNWConnectionNotification:(struct ifnet_interface_advisory *)arg1;	// IMP=0x00000000000281f3
- (void)dealloc;	// IMP=0x0000000000028195
