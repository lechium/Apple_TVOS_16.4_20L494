...
- (int)getSockaddrStorage:(struct sockaddr_storage *)arg1 size:(unsigned long long *)arg2;	// IMP=0x000000000038bf29
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000038bead
- (id)description;	// IMP=0x000000000038be29
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000038bd5d
- (_Bool)isIPv6;	// IMP=0x000000000038bd4f
- (void)dealloc;	// IMP=0x000000000038bce2
