...
+ (void)updateMaxAllowedBitratePerConnection:(unsigned int *)arg1 connectionType:(int)arg2 negotiatedSettings:(id)arg3;	// IMP=0x00600000003c1924
...
- (void)updateNegotiatedSettings:(id)arg1;	// IMP=0x00000000003c194f
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1 operatingMode:(int)arg2;	// IMP=0x00000000003c18b8
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 operatingMode:(int)arg3 encodeRule:(id)arg4;	// IMP=0x00000000003c17d4
- (id)maxAllowedBitrateRuleForConnection:(int)arg1;	// IMP=0x00000000003c1612
- (unsigned int)maxAllowedAudioOnlyBitrateForConnection:(int)arg1;	// IMP=0x00000000003c1519
- (unsigned int)maxAllowedScreenShareBitrateForConnection:(int)arg1;	// IMP=0x00000000003c1420
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 encodeRule:(id)arg3;	// IMP=0x00000000003c1191
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2;	// IMP=0x00000000003c117c
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1;	// IMP=0x00000000003c104d
- (unsigned int)maxAllowedScreenShareCellularBitrate;	// IMP=0x00000000003c1034
- (unsigned int)maxAllowedCellularBitrate;	// IMP=0x00000000003c1013
- (void)readCarrierBundleValues;	// IMP=0x00000000003c100d
- (void)updateMaxAllowedBitrate:(unsigned int *)arg1 key:(struct __CFString *)arg2 type:(id)arg3 isAudio:(_Bool)arg4 carrierBundleBitrates:(struct __CFDictionary *)arg5;	// IMP=0x00000000003c1007
- (void)readStoreBagValues:(void *)arg1;	// IMP=0x00000000003c0ec8
- (int)storeBagBitrateForKey:(id)arg1;	// IMP=0x00000000003c0e2b
- (void)readHardwareValues;	// IMP=0x00000000003c0e25
- (void)addRuleForBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x00000000003c0db8
- (void)createSupportedBitrateRuleSets;	// IMP=0x00000000003c0d82
- (void)dealloc;	// IMP=0x00000000003c0d24
- (id)initWithDeviceRole:(int)arg1 callLogFile:(void *)arg2;	// IMP=0x00000000003c0b8d
