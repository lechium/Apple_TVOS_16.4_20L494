...
- (void)setupEVSModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004bbce
- (void)setupAMRWBModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004b9c5
- (void)setupAMRModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004b7f1
- (void)setPreferredModeWithClientMode:(int)arg1;	// IMP=0x000000000004b7e8
- (void)setupCodecBandwidthsWithClientBandwidthMask:(unsigned int)arg1;	// IMP=0x000000000004b681
- (void)setupModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x000000000004b632
@property(readonly, nonatomic) _Bool isComfortNoise;
- (void)dealloc;	// IMP=0x000000000004b58b
- (id)initWithCodecType:(long long)arg1;	// IMP=0x000000000004b4f2
