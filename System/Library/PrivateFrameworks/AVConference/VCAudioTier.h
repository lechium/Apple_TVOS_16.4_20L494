...
+ (_Bool)bundlingAppliedByCodecForPayload:(int)arg1 mode:(int)arg2;	// IMP=0x006000000038395d
+ (id)newAudioTierForPayloadConfig:(id)arg1 bundlingAppliedByCodec:(_Bool)arg2 audioCodecBitrate:(unsigned int)arg3 packetsPerBundle:(unsigned int)arg4 redNumPayloads:(unsigned int)arg5 headerSize:(unsigned int)arg6;	// IMP=0x0060000000383828
...
- (_Bool)isEqualTo:(id)arg1;	// IMP=0x0000000000383c93
- (id)dictionary;	// IMP=0x0000000000383b25
- (id)description;	// IMP=0x0000000000383a5e
- (id)initWithNetworkBitrate:(unsigned int)arg1 bundlingAppliedByCodec:(_Bool)arg2 audioCodecBitrate:(unsigned int)arg3 packetsPerBundle:(unsigned int)arg4 redNumPayloads:(unsigned int)arg5 payloadSize:(unsigned int)arg6 headerSize:(unsigned int)arg7 payloadConfig:(id)arg8;	// IMP=0x0000000000383992
