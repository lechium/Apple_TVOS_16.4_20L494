...
+ (id)copyStringValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000003f5190
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x00600000003f516d
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000003f5152
+ (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x00600000003f5005
+ (long long)integerValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000003f4fea
+ (double)getDoubleValueForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x00600000003f4e95
+ (id)sharedInstance;	// IMP=0x00600000003f4db6
...
- (_Bool)forceUseInternalRTPThreadingWithDefaultValue:(_Bool)arg1;	// IMP=0x00000000003f6fc8
...
- (_Bool)shouldOverrideEffectsFramerate:(unsigned int *)arg1;	// IMP=0x00000000003f6c64
...
- (_Bool)enableAudioDumpParticipantLocal:(_Bool)arg1;	// IMP=0x00000000003f6938
- (_Bool)enableAudioDumpParticipantRemote:(_Bool)arg1;	// IMP=0x00000000003f6916
...
- (_Bool)forceWifiAssistOutOfBudget;	// IMP=0x00000000003f6676
- (_Bool)forceWifiAssist;	// IMP=0x00000000003f6656
...
- (unsigned int)forceThermalLevelFramerate:(unsigned int)arg1;	// IMP=0x00000000003f5766
...
- (void)seperateString:(id)arg1;	// IMP=0x00000000003f5459
...
- (id)autorelease;	// IMP=0x00000000003f5252
- (oneway void)release;	// IMP=0x00000000003f524c
- (unsigned long long)retainCount;	// IMP=0x00000000003f523f
- (id)retain;	// IMP=0x00000000003f5236
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003f522d
- (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003f5220
- (id)init;	// IMP=0x00000000003f51ce
