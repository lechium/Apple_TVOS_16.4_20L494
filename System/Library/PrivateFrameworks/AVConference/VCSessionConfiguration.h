...
- (void)cleanupNwActivity;	// IMP=0x000000000004b282
- (_Bool)applyConfigurationUsingClientDict:(id)arg1;	// IMP=0x000000000004b094
- (_Bool)updateWithClientDictionary:(id)arg1;	// IMP=0x000000000004aeee
@property(nonatomic) long long sessionMode; // @synthesize sessionMode=_sessionMode;
- (void)dealloc;	// IMP=0x000000000004ad41
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000004ad02
- (id)init;	// IMP=0x000000000004aca3
