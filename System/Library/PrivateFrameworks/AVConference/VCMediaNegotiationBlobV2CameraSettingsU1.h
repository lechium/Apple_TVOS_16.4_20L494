...
+ (Class)payloadsType;	// IMP=0x00100000002b1bf6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002b3074
- (unsigned long long)hash;	// IMP=0x00000000002b2f76
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002b2de7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002b2b5d
- (void)copyTo:(id)arg1;	// IMP=0x00000000002b29fa
- (void)writeTo:(id)arg1;	// IMP=0x00000000002b280d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002b2800
- (id)dictionaryRepresentation;	// IMP=0x00000000002b1e5b
- (id)description;	// IMP=0x00000000002b1dc1
...
- (id)payloadsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000002b1bd9
- (unsigned long long)payloadsCount;	// IMP=0x00000000002b1bbc
- (void)addPayloads:(id)arg1;	// IMP=0x00000000002b1b6f
- (void)clearPayloads;	// IMP=0x00000000002b1b52
@property(nonatomic) _Bool hasRtpSSRC;
- (void)dealloc;	// IMP=0x00000000002b1aa4
- (_Bool)setupVideoRuleCollection:(id)arg1;	// IMP=0x00000000002faf00
- (id)rulesForEncodeType:(unsigned char)arg1 paylaod:(int)arg2 videoRuleCollection:(id)arg3;	// IMP=0x00000000002fae6b
- (void)printWithLogFile:(void *)arg1 prefix:(id)arg2 screenSize:(struct CGSize)arg3;	// IMP=0x00000000002fab4f
@property(readonly, nonatomic) VCVideoRuleCollections *videoRuleCollections;
- (_Bool)addVideoRules:(id)arg1 encodingType:(unsigned char)arg2 payload:(int)arg3 videoRuleCollections:(id)arg4;	// IMP=0x00000000002fa6ab
@property(readonly, nonatomic) struct CGSize orientationMismatchDisplayRatio;
- (void)aspectRatioPortrait:(struct CGSize *)arg1 aspectRatioLandscape:(struct CGSize *)arg2 orientationMismatchAspectRatioLandscape:(struct CGSize *)arg3 orientationMismatchAspectRatioPortrait:(struct CGSize *)arg4 screenSize:(struct CGSize)arg5;	// IMP=0x00000000002fa434
- (id)initWithSSRC:(unsigned int)arg1 videoRuleCollections:(id)arg2 screenSize:(struct CGSize)arg3 aspectRatioPortrait:(struct CGSize)arg4 aspectRatioLandscape:(struct CGSize)arg5 orientationMismatchAspectRatioLandscape:(struct CGSize)arg6;	// IMP=0x00000000002fa22a
