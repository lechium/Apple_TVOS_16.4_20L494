...
+ (id)sharedManager;	// IMP=0x00600000003b62ca
...
- (void)registerBlocksForService;	// IMP=0x00000000003b663d
- (void)reportSessionMediaDaemonStats:(id)arg1;	// IMP=0x00000000003b6319
- (void)dealloc;	// IMP=0x00000000003b625a
- (id)init;	// IMP=0x00000000003b61b8
