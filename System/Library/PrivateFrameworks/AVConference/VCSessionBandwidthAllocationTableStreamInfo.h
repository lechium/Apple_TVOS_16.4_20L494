...
- (id)entryForQualityIndex:(unsigned int)arg1;	// IMP=0x00000000003e7b96
- (_Bool)addTableEntry:(id)arg1;	// IMP=0x00000000003e7a53
- (void)dealloc;	// IMP=0x00000000003e79e6
- (id)init;	// IMP=0x00000000003e7967
