...
- (id)description;	// IMP=0x0000000000068334
- (long long)compareBudget:(id)arg1;	// IMP=0x00000000000682dd
- (void)addStream:(id)arg1;	// IMP=0x0000000000068278
- (void)dealloc;	// IMP=0x000000000006821a
- (id)init;	// IMP=0x00000000000681a4
