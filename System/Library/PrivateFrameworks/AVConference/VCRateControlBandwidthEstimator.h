...
- (void)updateQualificationParameters;	// IMP=0x000000000033cdb8
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x000000000033cdab
- (void)dealloc;	// IMP=0x000000000033bf0f
- (id)init;	// IMP=0x000000000033be5d
