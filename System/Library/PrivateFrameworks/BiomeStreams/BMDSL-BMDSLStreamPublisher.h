...
- (id)asTableWithTransform:(id)arg1 schema:(id)arg2;	// IMP=0x0030000000052942
- (id)trackDerivatesInDBAtURL:(id)arg1 derivedTableName:(id)arg2;	// IMP=0x003000000008e7fb
@end
