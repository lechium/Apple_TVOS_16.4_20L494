...
- (void).cxx_destruct;	// IMP=0x000000000001d440
...
- (id)postProcessCaptions:(id)arg1 visionObservations:(id)arg2;	// IMP=0x000000000001d350
- (id)initWithOptions:(id)arg1 runtimeParameters:(id)arg2;	// IMP=0x000000000001d280
