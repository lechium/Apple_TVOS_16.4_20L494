...
- (id).cxx_construct;	// IMP=0x00000000000446a0
...
- (void)_runBlockWithCopyOutputBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000043be0
- (void)runBlockWithCopyInput:(float *)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000043a40
- (void)runBlockWithCopyInputBlock:(CDUnknownBlockType)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000043820
- (void)copyOutputState:(id)arg1;	// IMP=0x0000000000042900
- (void)copyInputState:(id)arg1;	// IMP=0x0000000000041c70
- (void)buildNetworkForSequenceLength:(unsigned long long)arg1 imageFeatures:(id)arg2;	// IMP=0x000000000003e420
- (_Bool)_loadNetwork:(id)arg1 modelIndex:(unsigned long long)arg2;	// IMP=0x000000000003d160
- (void)dealloc;	// IMP=0x000000000003d040
- (id)initWithOptions:(id)arg1 modelIndex:(unsigned long long)arg2 runTimeParams:(id)arg3;	// IMP=0x000000000003ce20
