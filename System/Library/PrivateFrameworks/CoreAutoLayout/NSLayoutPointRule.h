...
- (id)makeChildRules;	// IMP=0x0000000000002ba7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000002b1c
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002aca
- (void)dealloc;	// IMP=0x0000000000002a80
