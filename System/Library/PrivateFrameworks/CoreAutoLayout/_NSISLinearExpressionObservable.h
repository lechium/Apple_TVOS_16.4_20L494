...
+ (id)observableForExpression:(id)arg1 inEngine:(id)arg2;	// IMP=0x0060000000005170
- (id)addObserver:(id)arg1;	// IMP=0x000000000000582a
- (id)addObserverBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000057ea
- (_Bool)_overrideUseFastBlockObservers;	// IMP=0x00000000000057e2
- (void)dealloc;	// IMP=0x0000000000005215
