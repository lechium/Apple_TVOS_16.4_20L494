...
- (void)_addToEngine:(id)arg1;	// IMP=0x00000000000197f5
- (id)secondItem;	// IMP=0x00000000000197ed
- (id)firstItem;	// IMP=0x00000000000197e5
- (id)description;	// IMP=0x0000000000019780
- (int)nsis_orientationHintForVariable:(id)arg1;	// IMP=0x000000000001976e
- (_Bool)nsis_valueOfVariableIsUserObservable:(id)arg1;	// IMP=0x000000000001975c
- (id)nsis_descriptionOfVariable:(id)arg1;	// IMP=0x000000000001974a
- (void)nsis_valueOfVariable:(id)arg1 didChangeInEngine:(id)arg2;	// IMP=0x0000000000019744
- (void)dealloc;	// IMP=0x00000000000196f3
