...
- (unsigned long long)hash;	// IMP=0x000000000001a50e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001a503
- (id)initWithPlaceholderToken:(id)arg1;	// IMP=0x000000000001a020
