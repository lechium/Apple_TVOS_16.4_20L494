...
- (void).cxx_destruct;	// IMP=0x0000000000022772
...
- (void)prepareAgent:(id)arg1 loader:(id)arg2;	// IMP=0x000000000002240c
- (void)holdAgent:(id)arg1 loader:(id)arg2;	// IMP=0x0000000000021921
