...
+ (void)initialize;	// IMP=0x006000000001542a
- (void).cxx_destruct;	// IMP=0x000000000001573b
...
- (_Bool)isFinished;	// IMP=0x00000000000155dd
- (double)currentPlaybackTime;	// IMP=0x000000000001547a
