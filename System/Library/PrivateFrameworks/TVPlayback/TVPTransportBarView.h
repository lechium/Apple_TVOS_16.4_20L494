...
- (void).cxx_destruct;	// IMP=0x0000000000049f58
...
- (void)_updateUserInteractionEnabled;	// IMP=0x0000000000049d0b
- (void)setLabelAlpha:(double)arg1;	// IMP=0x0000000000049cbc
...
- (id)createProgressBarView;	// IMP=0x0000000000049a18
- (double)dimmingAlpha;	// IMP=0x0000000000049a0a
- (void)setInteractionMode:(long long)arg1;	// IMP=0x00000000000493c6
...
- (struct CGRect)playerHeadFrameForRect:(struct CGRect)arg1;	// IMP=0x000000000004834c
- (void)layoutSubviews;	// IMP=0x00000000000476f8
- (void)updateProgressBarPlayheadLocations;	// IMP=0x000000000004752a
- (id)timeFont;	// IMP=0x000000000004731f
@property(nonatomic) _Bool dimsWithGradient;
@property(nonatomic) _Bool dimsEntireBounds;
- (id)initWithPlayer:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x0000000000046110
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000460fc
