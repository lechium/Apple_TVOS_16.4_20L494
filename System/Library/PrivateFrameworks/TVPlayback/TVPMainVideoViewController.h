...
- (void).cxx_destruct;	// IMP=0x000000000000ab14
...
- (void)viewDidLoad;	// IMP=0x000000000000a560
- (void)loadView;	// IMP=0x000000000000a489
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000000a368
- (void)_addPlaybackView:(id)arg1;	// IMP=0x000000000000a108
- (void)_handleSelectButton:(id)arg1;	// IMP=0x0000000000009ff8
- (void)_didSelect;	// IMP=0x0000000000009f9b
- (void)preserveVideoViewForReuse;	// IMP=0x0000000000009df4
- (id)initWithPlayer:(id)arg1;	// IMP=0x0000000000009d82
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000009d57
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000009d2c
