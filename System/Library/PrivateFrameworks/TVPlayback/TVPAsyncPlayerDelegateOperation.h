...
- (void).cxx_destruct;	// IMP=0x00000000000086cf
@property(copy, nonatomic) CDUnknownBlockType block; // @synthesize block=_block;
@property(readonly, nonatomic) NSNumber *identifier; // @synthesize identifier=_identifier;
- (unsigned long long)hash;	// IMP=0x0000000000008668
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000085ba
- (id)init;	// IMP=0x0000000000008542
