...
- (void).cxx_destruct;	// IMP=0x0000000000022164
...
- (unsigned long long)hash;	// IMP=0x00000000000220c8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000022044
- (id)description;	// IMP=0x0000000000022009
