...
- (void).cxx_destruct;	// IMP=0x00000000000f36fe
...
- (void)_skipTimerFired:(id)arg1;	// IMP=0x00000000000f34f4
- (double)_nextTimeToAdvanceFromTime:(double)arg1;	// IMP=0x00000000000f340e
- (void)cancelScrub;	// IMP=0x00000000000f33dc
- (void)startScrubWithRate:(double)arg1;	// IMP=0x00000000000f32fc
