...
- (void).cxx_destruct;	// IMP=0x0000000000005b55
...
- (void)_updateMasks;	// IMP=0x000000000000574f
- (void)layoutSubviews;	// IMP=0x000000000000570e
- (void)setMinPlayheadProgress:(double)arg1 maxPlayheadProgress:(double)arg2;	// IMP=0x0000000000005566
- (void)setMinBufferingProgress:(double)arg1 maxBufferingProgress:(double)arg2;	// IMP=0x00000000000053ed
- (void)_commonInit;	// IMP=0x00000000000050eb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000509f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000005042
