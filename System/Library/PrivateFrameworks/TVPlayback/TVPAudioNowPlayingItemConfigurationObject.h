...
- (void).cxx_destruct;	// IMP=0x00000000000943fc
...
- (_Bool)_isStringEqual:(id)arg1 rhsString:(id)arg2;	// IMP=0x0000000000094251
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000093dca
