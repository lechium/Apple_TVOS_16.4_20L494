...
- (void).cxx_destruct;	// IMP=0x000000000006d1f3
...
- (void)setView:(id)arg1 forContentType:(long long)arg2;	// IMP=0x000000000006ce2e
- (id)viewForContentType:(long long)arg1;	// IMP=0x000000000006cdae
- (void)setPreferredSize:(struct CGSize)arg1 forContentType:(long long)arg2;	// IMP=0x000000000006ca36
- (struct CGSize)preferredSizeForContentType:(long long)arg1;	// IMP=0x000000000006c983
- (id)_keyForContentType:(long long)arg1;	// IMP=0x000000000006c96a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006c926
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000006c13c
