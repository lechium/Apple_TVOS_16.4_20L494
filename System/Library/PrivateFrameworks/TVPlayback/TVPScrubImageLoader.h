...
- (void).cxx_destruct;	// IMP=0x0000000000024176
...
- (double)_timeAfterInsertingInterstitials:(double)arg1;	// IMP=0x0000000000023fd3
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x0000000000023f1c
- (id)_closestLoadedImageInfoForTime:(double)arg1;	// IMP=0x0000000000023bac
- (void)_saveLoadedImageInfo:(id)arg1;	// IMP=0x00000000000239b0
- (id)_imageLoadInfoIfNeededForTime:(double)arg1;	// IMP=0x00000000000238a1
- (id)_imageInfosNeededWithStride:(double)arg1;	// IMP=0x00000000000236a6
- (id)_progressiveImageLoadInfosNeeded;	// IMP=0x0000000000023596
- (void)_loadImages;	// IMP=0x00000000000228ec
- (void)_reset;	// IMP=0x0000000000022779
- (void)_playerCurrentMediaItemMetadataDidChange:(id)arg1;	// IMP=0x000000000002261b
- (id)closestImageForTime:(double)arg1 imageTime:(double *)arg2;	// IMP=0x000000000002233f
- (void)prioritizeLoadingOfImageAtTime:(double)arg1;	// IMP=0x0000000000022304
- (void)loadImages;	// IMP=0x00000000000222f2
- (void)dealloc;	// IMP=0x000000000002226f
- (id)initWithPlayer:(id)arg1 maxImageSize:(struct CGSize)arg2;	// IMP=0x000000000002218c
