...
- (void).cxx_destruct;	// IMP=0x0000000000078e90
...
- (unsigned long long)hash;	// IMP=0x0000000000078c8a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000078aa1
- (void)dealloc;	// IMP=0x0000000000078a36
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000786e3
