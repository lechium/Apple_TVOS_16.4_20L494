...
- (void).cxx_destruct;	// IMP=0x0000000000004fef
...
- (double)_textLabelWidthWithXPosition:(double)arg1 currentWidth:(double)arg2;	// IMP=0x0000000000004e51
- (void)_updateImage;	// IMP=0x0000000000004d3c
- (void)layoutSubviews;	// IMP=0x00000000000047fd
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000004159
- (id)labelForMarquee;	// IMP=0x00000000000040e6
- (_Bool)canBecomeFocused;	// IMP=0x000000000000408e
- (void)prepareForReuse;	// IMP=0x0000000000003fba
- (void)dealloc;	// IMP=0x0000000000003f55
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000003e8c
