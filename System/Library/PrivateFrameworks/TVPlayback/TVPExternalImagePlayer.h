...
- (void).cxx_destruct;	// IMP=0x0000000000045f07
...
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x0000000000045ce9
- (void)_updateImageIntervalWithRate:(double)arg1;	// IMP=0x0000000000045c15
- (void)_cancelStaleImageLoadsForTime:(double)arg1;	// IMP=0x00000000000459e4
- (void)_cancelAllImageLoads;	// IMP=0x0000000000045950
- (void)_loadImagesIfNecessary;	// IMP=0x0000000000044e51
- (void)_displayLinkTimerFired:(id)arg1;	// IMP=0x0000000000044a45
- (void)invalidate;	// IMP=0x0000000000044a30
- (id)initWithMediaItem:(id)arg1 referenceTime:(CDStruct_1b6d18a9)arg2 forDate:(id)arg3;	// IMP=0x0000000000044643
