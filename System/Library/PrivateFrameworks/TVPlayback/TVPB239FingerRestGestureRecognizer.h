...
+ (_Bool)_shouldDefaultToTouches;	// IMP=0x0060000000014ad8
- (void).cxx_destruct;	// IMP=0x0000000000015367
...
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000152e0
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000015074
- (void)pressesChanged:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000001506e
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000014ed5
- (void)recognizeFingerRest;	// IMP=0x0000000000014e69
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000014d8c
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000014caf
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000014c41
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000014ae0
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000014a8a
