...
- (void).cxx_destruct;	// IMP=0x0000000000008511
...
- (void)_loadChapterNameFromMetadataItem:(id)arg1;	// IMP=0x0000000000008231
- (id)imageProxy;	// IMP=0x000000000000818d
- (id)initWithAVTimedMetadataGroup:(id)arg1 filterByLanguages:(id)arg2;	// IMP=0x0000000000007ef7
