...
- (void).cxx_destruct;	// IMP=0x00000000000887b3
- (unsigned long long)hash;	// IMP=0x000000000008863a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008836a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000088133
- (void)writeTo:(id)arg1;	// IMP=0x0000000000087fd1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000087fc4
- (id)dictionaryRepresentation;	// IMP=0x0000000000087be7
- (id)description;	// IMP=0x0000000000087b38
