...
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000012bdb7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012bced
- (id)initWithRequestContext:(id)arg1 requestType:(long long)arg2 leaseID:(id)arg3 mediaType:(long long)arg4 clientData:(id)arg5;	// IMP=0x000000000012bbe6
