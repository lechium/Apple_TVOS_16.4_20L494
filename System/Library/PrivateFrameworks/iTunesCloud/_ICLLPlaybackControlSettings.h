...
- (void).cxx_destruct;	// IMP=0x00000000000a4fab
- (unsigned long long)hash;	// IMP=0x00000000000a4ec0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a4d04
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a4bbf
- (void)writeTo:(id)arg1;	// IMP=0x00000000000a4ada
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000a4acd
- (id)dictionaryRepresentation;	// IMP=0x00000000000a484f
- (id)description;	// IMP=0x00000000000a47a0
