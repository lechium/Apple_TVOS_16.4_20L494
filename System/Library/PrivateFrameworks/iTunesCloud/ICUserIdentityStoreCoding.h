...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000c8b89
- (void).cxx_destruct;	// IMP=0x00000000000c8b4b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c8a0e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c885f
- (void)lock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000c87f5
- (id)initWithIdentityStoreStyle:(long long)arg1;	// IMP=0x00000000000c87a4
- (id)_initCommon;	// IMP=0x00000000000c8769
