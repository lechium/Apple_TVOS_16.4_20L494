...
- (void).cxx_destruct;	// IMP=0x000000000003eecf
...
- (void)_updateNetServiceStatus;	// IMP=0x000000000003e9d0
- (void)stop;	// IMP=0x000000000003e985
- (void)publish;	// IMP=0x000000000003e93a
@property(readonly, nonatomic) ICDelegationServiceSecuritySettings *securitySettings;
- (void)netService:(id)arg1 didNotPublish:(id)arg2;	// IMP=0x000000000003e615
- (void)netServiceDidPublish:(id)arg1;	// IMP=0x000000000003e55c
- (void)netService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x000000000003e3d6
- (void)dealloc;	// IMP=0x000000000003e315
- (id)initWithUserIdentityDelegationAccountUUIDs:(id)arg1;	// IMP=0x000000000003e24a
