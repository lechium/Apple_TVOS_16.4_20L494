...
- (void).cxx_destruct;	// IMP=0x0000000000180f4d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000180a8e
- (id)description;	// IMP=0x00000000001808e4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000180823
- (unsigned long long)hash;	// IMP=0x00000000001807d9
- (id)initWithTXTRecordData:(id)arg1;	// IMP=0x0000000000180451
