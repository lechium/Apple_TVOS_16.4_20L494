...
+ (id)dataSourceForExistingSharedListeningSession:(id)arg1 identity:(id)arg2;	// IMP=0x001000000018dda4
+ (id)dataSourceForNewSharedListeningSessionWithIdentity:(id)arg1;	// IMP=0x001000000018dd55
- (void).cxx_destruct;	// IMP=0x000000000018b47d
...
- (id)sessionURLForBag:(id)arg1 error:(id *)arg2;	// IMP=0x000000000018ac3d
- (void)_joinSharedListeningSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000018a8a2
- (void)_revokeUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000018a74c
- (void)_renewUserPseudonym;	// IMP=0x000000000018a59a
- (void)_beginPseudonymAutoRenewal;	// IMP=0x000000000018a401
- (void)_provisionUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000189bd7
- (void)populateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000189b26
- (void)dealloc;	// IMP=0x0000000000189a74
- (id)initWithSharedListeningSessionIdentifier:(id)arg1 identity:(id)arg2;	// IMP=0x000000000018997c
