...
- (void).cxx_destruct;	// IMP=0x00000000001c32f5
@property(readonly, nonatomic) NSNetService *netService; // @synthesize netService=_netService;
- (void)_updateTXTRecordProperties;	// IMP=0x00000000001c3171
- (void)_setState:(long long)arg1;	// IMP=0x00000000001c3028
- (void)_resolveWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c2f47
...
- (void)getResolvedStreamsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c2c19
- (void)netService:(id)arg1 didNotResolve:(id)arg2;	// IMP=0x00000000001c2b22
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x00000000001c2a54
- (void)netService:(id)arg1 didUpdateTXTRecordData:(id)arg2;	// IMP=0x00000000001c2986
- (void)dealloc;	// IMP=0x00000000001c2942
- (id)initWithNetService:(id)arg1;	// IMP=0x00000000001c2814
