...
- (void).cxx_destruct;	// IMP=0x000000000003c5f8
- (unsigned long long)hash;	// IMP=0x000000000003c3dd
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003bfdf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003bcc4
- (void)writeTo:(id)arg1;	// IMP=0x000000000003baa0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003ba93
- (id)dictionaryRepresentation;	// IMP=0x000000000003b4f7
- (id)description;	// IMP=0x000000000003b448
