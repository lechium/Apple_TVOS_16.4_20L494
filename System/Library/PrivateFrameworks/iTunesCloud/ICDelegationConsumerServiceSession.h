...
- (void).cxx_destruct;	// IMP=0x00000000001877b9
...
- (void)_stop;	// IMP=0x00000000001875e4
- (void)_handleTimeout;	// IMP=0x0000000000187502
- (void)stop;	// IMP=0x00000000001874b7
- (void)start;	// IMP=0x000000000018746c
- (_Bool)delegationServiceConnection:(id)arg1 didReceiveRequest:(id)arg2;	// IMP=0x0000000000187156
- (void)delegationServiceConnection:(id)arg1 didEncouterError:(id)arg2;	// IMP=0x00000000001870cb
- (void)delegationServiceConnectionDidClose:(id)arg1;	// IMP=0x0000000000187040
- (void)delegationConsumerNetService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x0000000000186f76
- (void)dealloc;	// IMP=0x0000000000186f38
- (id)initWithRequest:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000186dd3
