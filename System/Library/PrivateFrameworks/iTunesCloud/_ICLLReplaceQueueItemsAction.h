...
- (void).cxx_destruct;	// IMP=0x000000000006e262
- (unsigned long long)hash;	// IMP=0x000000000006e178
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006dfb3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006dd0b
- (void)writeTo:(id)arg1;	// IMP=0x000000000006db31
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006db24
- (id)dictionaryRepresentation;	// IMP=0x000000000006d723
- (id)description;	// IMP=0x000000000006d674
