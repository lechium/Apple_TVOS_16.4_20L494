...
- (void).cxx_destruct;	// IMP=0x000000000013450c
- (unsigned long long)hash;	// IMP=0x00000000001335b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000132767
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000131bed
- (void)writeTo:(id)arg1;	// IMP=0x0000000000131290
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000012f794
- (id)dictionaryRepresentation;	// IMP=0x000000000012e4f0
- (id)description;	// IMP=0x000000000012e441
