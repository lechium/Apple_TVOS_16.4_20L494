...
- (void).cxx_destruct;	// IMP=0x00000000001b11a8
...
- (void)_addEvents:(id)arg1 toReportString:(id)arg2 eventLevel:(long long)arg3;	// IMP=0x00000000001b0d93
@property(readonly, nonatomic) NSString *formattedReport;
- (void)endEvent:(id)arg1 withError:(id)arg2;	// IMP=0x00000000001b0945
- (void)endEvent:(id)arg1;	// IMP=0x00000000001b0931
- (void)startEvent:(id)arg1 withParentEvent:(id)arg2;	// IMP=0x00000000001b07cf
- (void)startEvent:(id)arg1;	// IMP=0x00000000001b07bb
- (id)init;	// IMP=0x00000000001b0736
