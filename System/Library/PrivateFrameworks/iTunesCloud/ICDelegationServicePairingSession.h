...
- (void).cxx_destruct;	// IMP=0x0000000000135ed4
...
- (void)_sendData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000135d60
- (void)_receivedData:(id)arg1;	// IMP=0x0000000000135ade
- (_Bool)_deriveEncryptionKeysReturningError:(id *)arg1;	// IMP=0x00000000001355a2
- (void)_handlePairingSessionCompletionWithError:(id)arg1;	// IMP=0x0000000000135360
- (id)_encryptedDataForData:(id)arg1;	// IMP=0x00000000001351e7
- (void)getEncryptedDataForData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000135130
- (void)getDecryptedDataForEncryptedData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000135079
- (void)receievedData:(id)arg1;	// IMP=0x0000000000134fee
- (void)prepareEncryptedSessionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000134f63
- (void)dealloc;	// IMP=0x0000000000134f24
- (id)initWithRole:(long long)arg1 securitySettings:(id)arg2;	// IMP=0x0000000000134e71
