...
- (void).cxx_destruct;	// IMP=0x000000000015bd24
...
- (id)_analyticSignature;	// IMP=0x000000000015baab
- (id)description;	// IMP=0x000000000015b9c1
- (void)_populateItemIdentifiers:(id)arg1;	// IMP=0x000000000015b7e3
- (id)_actionType;	// IMP=0x000000000015b7ad
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000015b6d5
