...
- (void).cxx_destruct;	// IMP=0x000000000015953c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015943f
@property(readonly, copy, nonatomic) NSMutableDictionary *propertyListRepresentation;
- (id)initWithDSID:(id)arg1 SICData:(id)arg2;	// IMP=0x00000000001592f1
