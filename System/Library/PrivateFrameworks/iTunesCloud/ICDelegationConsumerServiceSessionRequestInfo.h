...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a357e
- (unsigned long long)hash;	// IMP=0x00000000000a3570
- (id)initWithAccountID:(unsigned long long)arg1 fairPlaySessionID:(unsigned long long)arg2;	// IMP=0x00000000000a3528
