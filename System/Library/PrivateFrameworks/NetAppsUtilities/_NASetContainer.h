...
+ (id)containerWithObject:(id)arg1 atIndex:(unsigned long long)arg2 comparator:(CDUnknownBlockType)arg3 hashGenerator:(CDUnknownBlockType)arg4;	// IMP=0x0060000000004e97
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004f63
