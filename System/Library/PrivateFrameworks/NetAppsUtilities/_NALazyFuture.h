...
- (void).cxx_destruct;	// IMP=0x0000000000004a68
...
- (void)willAddCompletionBlock;	// IMP=0x0000000000004786
- (id)initWithBlock:(CDUnknownBlockType)arg1 scheduler:(id)arg2;	// IMP=0x0000000000004675
