...
- (void).cxx_destruct;	// IMP=0x0000000000002f77
@property(readonly, copy, nonatomic) NATreeNode *node; // @synthesize node=_node;
@property(readonly, copy, nonatomic) NSArray *allObjects;
- (id)nextObject;	// IMP=0x0000000000002d10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002ca7
- (id)initWithNode:(id)arg1;	// IMP=0x0000000000002c2d
