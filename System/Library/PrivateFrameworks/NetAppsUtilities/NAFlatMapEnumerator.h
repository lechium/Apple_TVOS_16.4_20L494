...
- (id)allObjects;	// IMP=0x000000000000429f
- (id)nextObject;	// IMP=0x00000000000041fc
- (id)initWithEnumerator:(id)arg1 map:(CDUnknownBlockType)arg2;	// IMP=0x0000000000004147
