...
- (void).cxx_destruct;	// IMP=0x0000000000004116
...
- (id)allObjects;	// IMP=0x000000000000404d
- (id)nextObject;	// IMP=0x0000000000003f7a
- (id)initWithEnumerator:(id)arg1 filter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003ec5
