...
- (void).cxx_destruct;	// IMP=0x000000000001ef8f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001ec63
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001eb1f
- (id)init;	// IMP=0x000000000001ea9e
