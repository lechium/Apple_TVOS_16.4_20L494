...
- (void).cxx_destruct;	// IMP=0x00000000002488b0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000248850
- (void)didTapOptOutButton;	// IMP=0x00000000002487d0
- (void)didTapOptInButton;	// IMP=0x00000000002487c0
- (void)doNotSharePressed:(id)arg1;	// IMP=0x0000000000248710
- (void)sharePressed:(id)arg1;	// IMP=0x0000000000248700
- (void)viewDidLoad;	// IMP=0x00000000002486d0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000247f90
