...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000db1d0
- (void)didMoveToSuperview;	// IMP=0x00000000000dafc0
- (void)layoutSubviews;	// IMP=0x00000000000dad70
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000dac10
