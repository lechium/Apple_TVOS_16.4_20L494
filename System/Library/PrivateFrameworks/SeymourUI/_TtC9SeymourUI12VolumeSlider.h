...
- (void).cxx_destruct;	// IMP=0x0000000000032110
- (void)didMoveToWindow;	// IMP=0x0000000000031710
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000031640
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000313a0
