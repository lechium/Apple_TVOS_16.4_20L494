...
+ (long long)activityCategory;	// IMP=0x0040000000075fd0
- (void).cxx_destruct;	// IMP=0x0000000000076530
- (id)init;	// IMP=0x00000000000764d0
- (void)performActivity;	// IMP=0x00000000000764a0
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x00000000000762f0
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0000000000076170
