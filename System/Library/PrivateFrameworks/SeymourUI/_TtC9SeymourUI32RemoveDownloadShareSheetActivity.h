...
+ (long long)activityCategory;	// IMP=0x00400000005ebe50
- (void).cxx_destruct;	// IMP=0x00000000005ec420
- (id)init;	// IMP=0x00000000005ec3c0
- (void)performActivity;	// IMP=0x00000000005ec390
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x00000000005ec1e0
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x00000000005ec060
