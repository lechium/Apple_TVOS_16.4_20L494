...
- (void).cxx_destruct;	// IMP=0x0000000000627d20
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000626a40
- (void)tintColorDidChange;	// IMP=0x0000000000626a10
- (void)layoutSubviews;	// IMP=0x0000000000626800
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000626520
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000006261a0
@property(nonatomic) _Bool highlighted;
- (_Bool)isHighlighted;	// IMP=0x00000000006257e0
