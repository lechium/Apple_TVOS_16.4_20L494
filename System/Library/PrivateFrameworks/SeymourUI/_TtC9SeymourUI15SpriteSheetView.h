...
- (void).cxx_destruct;	// IMP=0x0000000000200440
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002003c0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000200370
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001ff5b0
