...
+ (long long)activityCategory;	// IMP=0x0040000000217e20
- (void).cxx_destruct;	// IMP=0x0000000000218310
- (id)init;	// IMP=0x00000000002182b0
- (void)performActivity;	// IMP=0x0000000000218280
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x00000000002180d0
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0000000000217f50
