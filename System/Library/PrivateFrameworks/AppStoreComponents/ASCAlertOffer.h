...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000003317
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003c4c
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000000388f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003884
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003644
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000331f
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x0000000000003146
