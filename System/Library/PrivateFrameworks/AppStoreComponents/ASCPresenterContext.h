...
+ (id)sharedContext;	// IMP=0x004000000003f332
- (void).cxx_destruct;	// IMP=0x000000000003f91f
...
- (id)description;	// IMP=0x000000000003f7f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003f5c0
- (unsigned long long)hash;	// IMP=0x000000000003f4e0
- (id)initWithArtworkFetcher:(id)arg1 lockupFetcher:(id)arg2 appOfferStateCenter:(id)arg3;	// IMP=0x000000000003f429
