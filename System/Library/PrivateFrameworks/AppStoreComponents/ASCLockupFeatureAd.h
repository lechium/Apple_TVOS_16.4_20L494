...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001b2b6
- (void).cxx_destruct;	// IMP=0x000000000001bdcd
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b7d6
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b64a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001b4b9
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001b2be
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x000000000001b165
