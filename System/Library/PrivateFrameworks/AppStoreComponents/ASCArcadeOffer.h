...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000ec47
- (void).cxx_destruct;	// IMP=0x000000000000fbe0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000f461
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000000f144
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000f139
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000ef61
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000ec4f
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x000000000000eaa2
