...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000043c1a
- (void).cxx_destruct;	// IMP=0x0000000000044d51
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000444b1
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000044142
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000044137
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000043f2b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000043c22
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x0000000000043a60
