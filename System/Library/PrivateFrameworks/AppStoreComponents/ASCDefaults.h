...
+ (id)daemonDefaults;	// IMP=0x004000000001570b
- (void).cxx_destruct;	// IMP=0x00000000000162ee
@property(readonly, copy, nonatomic) NSString *bundleID; // @synthesize bundleID=_bundleID;
- (id)description;	// IMP=0x0000000000016246
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000016140
- (unsigned long long)hash;	// IMP=0x00000000000160c5
...
- (id)objectForKey:(id)arg1;	// IMP=0x000000000001586a
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000000157ea
- (id)initWithBundleID:(id)arg1;	// IMP=0x0000000000015777
