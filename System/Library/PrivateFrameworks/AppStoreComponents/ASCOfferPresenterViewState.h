...
- (void).cxx_destruct;	// IMP=0x000000000003bbbd
...
- (id)description;	// IMP=0x000000000003bacd
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003b93a
- (unsigned long long)hash;	// IMP=0x000000000003b888
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003b87d
- (id)initWithMetadata:(id)arg1 theme:(id)arg2;	// IMP=0x000000000003b7c4
