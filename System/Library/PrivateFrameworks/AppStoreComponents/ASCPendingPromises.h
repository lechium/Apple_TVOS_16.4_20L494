...
- (void).cxx_destruct;	// IMP=0x000000000003f2ff
...
- (void)finishAllWithError:(id)arg1;	// IMP=0x000000000003f1bc
- (void)cancelAll;	// IMP=0x000000000003f172
- (void)enumerateBinaryPromises:(CDUnknownBlockType)arg1 andPromises:(CDUnknownBlockType)arg2;	// IMP=0x000000000003ee4d
- (void)addPromise:(id)arg1;	// IMP=0x000000000003eb6b
- (_Bool)containsPromise:(id)arg1;	// IMP=0x000000000003e9e2
@property(readonly, nonatomic) _Bool hasPromises;
- (void)addBinaryPromise:(id)arg1;	// IMP=0x000000000003e48e
- (_Bool)containsBinaryPromise:(id)arg1;	// IMP=0x000000000003e28e
@property(readonly, nonatomic) NSMutableArray *promises;
@property(readonly, nonatomic) NSMutableArray *binaryPromises;
- (void)withLock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003e102
- (id)init;	// IMP=0x000000000003e0ac
