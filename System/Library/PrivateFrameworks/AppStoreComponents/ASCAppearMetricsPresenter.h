...
+ (id)log;	// IMP=0x0010000000004654
- (void).cxx_destruct;	// IMP=0x0000000000006f7d
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000000006df0
- (void)disappearIfNeeded;	// IMP=0x0000000000006c26
@property(readonly, nonatomic) _Bool canDisappear;
- (void)appearIfNeeded;	// IMP=0x000000000000657d
@property(readonly, nonatomic) _Bool canAppear;
- (void)viewDidRetryFailedRequest;	// IMP=0x0000000000005d8f
- (void)viewDidFailRequest:(id)arg1 withError:(id)arg2;	// IMP=0x0000000000005a0a
- (void)viewDidEndRenderWithPredicate:(id)arg1;	// IMP=0x00000000000057b3
- (void)viewDidAction;	// IMP=0x00000000000055cb
- (void)viewDidSetHidden;	// IMP=0x000000000000546e
- (void)viewDidMoveToWindow;	// IMP=0x0000000000005174
- (void)hostWillEnterForeground;	// IMP=0x000000000000509c
- (void)hostDidEnterBackground;	// IMP=0x0000000000004fc4
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000000048ca
- (id)initWithView:(id)arg1;	// IMP=0x0000000000004824
- (id)initWithView:(id)arg1 metrics:(id)arg2 notificationCenter:(id)arg3;	// IMP=0x00000000000046b0
