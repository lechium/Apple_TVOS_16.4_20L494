...
- (void).cxx_destruct;	// IMP=0x000000000000ea50
...
- (void)invalidateTemporaryStateForcingUpdate:(_Bool)arg1;	// IMP=0x000000000000e89b
- (void)installTemporaryWaitingState;	// IMP=0x000000000000e613
- (id)performActionWithActivity:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000000e557
- (void)offerStatusTextDidChange:(id)arg1;	// IMP=0x000000000000e47a
- (void)offerStateDidChange:(id)arg1 withMetadata:(id)arg2 flags:(long long)arg3;	// IMP=0x000000000000e108
- (void)enumerateDelegatesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000df56
- (void)removeDelegate:(id)arg1;	// IMP=0x000000000000de40
- (void)addDelegate:(id)arg1;	// IMP=0x000000000000dbc7
- (void)dealloc;	// IMP=0x000000000000d9c7
- (id)initWithOffer:(id)arg1 stateCenter:(id)arg2;	// IMP=0x000000000000d906
