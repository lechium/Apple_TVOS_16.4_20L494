...
+ (id)defaultURLOfModelInThisBundle;	// IMP=0x0010000000118eac
- (void).cxx_destruct;	// IMP=0x00000000001190e4
...
- (void)releaseIntermediateBuffers;	// IMP=0x000000000011906f
- (_Bool)preheatWithError:(id *)arg1;	// IMP=0x0000000000119067
- (id)inputBatchFromTextFeatures:(id)arg1 image:(id)arg2 featureWidth:(double)arg3 configuration:(id)arg4;	// IMP=0x000000000011905f
- (id)predictFromInputs:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000119052
- (id)initWithConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000119023
- (_Bool)supportCharacterBoxes;	// IMP=0x000000000011901b
@property(readonly) NSURL *modelURL;
- (id)populateInputBatchData:(float *)arg1 textFeatures:(id)arg2 image:(id)arg3 batchSize:(long long)arg4 width:(double)arg5 configuration:(id)arg6;	// IMP=0x0000000000117f9f
- (void)dealloc;	// IMP=0x0000000000117f58
