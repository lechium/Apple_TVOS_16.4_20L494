...
- (void).cxx_destruct;	// IMP=0x00000000000204fd
...
- (void)invalidate;	// IMP=0x0000000000020447
- (id)initWithQuery:(id)arg1 priority:(long long)arg2 processAsync:(_Bool)arg3 withCompletionQueue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000002035e
