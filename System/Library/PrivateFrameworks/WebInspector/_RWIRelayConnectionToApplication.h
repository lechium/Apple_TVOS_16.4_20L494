...
- (void)sendMessage:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000000003db0
- (void)_handleEvent:(id)arg1;	// IMP=0x0000000000003ae9
- (id)_deserializeMessage:(id)arg1;	// IMP=0x00000000000039b5
- (void)dealloc;	// IMP=0x0000000000003977
- (void)close;	// IMP=0x0000000000003941
- (id)initWithConnection:(id)arg1;	// IMP=0x00000000000037f5
