...
+ (id)identifierForPID:(int)arg1;	// IMP=0x0060000000001e10
- (void).cxx_destruct;	// IMP=0x000000000000282b
...
- (_Bool)updateFromListing:(id)arg1;	// IMP=0x00000000000021af
- (id)dictionaryRepresentation;	// IMP=0x0000000000001f61
@property(readonly, nonatomic) NSString *identifier; // @dynamic identifier;
- (id)initWithPID:(int)arg1 bundleId:(id)arg2 name:(id)arg3 isProxy:(_Bool)arg4 connection:(id)arg5 debuggerAvailability:(unsigned long long)arg6;	// IMP=0x0000000000001e35
