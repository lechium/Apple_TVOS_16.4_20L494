...
- (void).cxx_destruct;	// IMP=0x0020000000048c45
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000048af2
- (unsigned long long)hash;	// IMP=0x0010000000048a3f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000488f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000487e7
- (void)copyTo:(id)arg1;	// IMP=0x0010000000048725
- (void)writeTo:(id)arg1;	// IMP=0x001000000004865b
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000004864e
- (id)dictionaryRepresentation;	// IMP=0x00100000000484e0
- (id)description;	// IMP=0x0010000000048431
