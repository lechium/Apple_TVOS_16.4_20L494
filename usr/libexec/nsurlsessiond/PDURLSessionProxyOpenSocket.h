...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000002973
- (unsigned long long)hash;	// IMP=0x00100000000028da
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000027b1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000026cd
- (void)copyTo:(id)arg1;	// IMP=0x001000000000262a
- (void)writeTo:(id)arg1;	// IMP=0x001000000000258c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000022d4
- (id)dictionaryRepresentation;	// IMP=0x00100000000021a3
