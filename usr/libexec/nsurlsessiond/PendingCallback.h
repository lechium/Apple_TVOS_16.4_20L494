...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000004b9a8
- (void).cxx_destruct;	// IMP=0x002000000004b998
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000004b842
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000004b761
- (id)initWithCallbackType:(int)arg1 taskIdentifier:(unsigned long long)arg2 args:(id)arg3;	// IMP=0x001000000004b697
