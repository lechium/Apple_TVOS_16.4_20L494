...
- (void).cxx_destruct;	// IMP=0x00200000000049c5
- (_Bool)delegateImplementsDidReceiveResponse;	// IMP=0x00100000000049b5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000047f5
- (unsigned long long)hash;	// IMP=0x00100000000046e9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000044e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000004399
- (void)copyTo:(id)arg1;	// IMP=0x001000000000428d
- (void)writeTo:(id)arg1;	// IMP=0x0010000000004160
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000003bcf
- (id)dictionaryRepresentation;	// IMP=0x0010000000003905
- (id)description;	// IMP=0x0010000000003856
@property(nonatomic) _Bool hasDelegateImplementsDidReceiveResponse;
- (void)setDelegateImplementsDidReceiveResponse:(_Bool)arg1;	// IMP=0x0010000000003811
