...
@interface GKTurnBasedMatchInternal
{
    ...
    MISSING_TYPE *_minPlayers;	// 172 = 0xac
    unsigned char _maxPlayers;	// 173 = 0xad
    BOOL _currentParticipant;	// 174 = 0xae
}

+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000171587
- (void).cxx_destruct;	// IMP=0x0020000000172bd8
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000017288c
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x0010000000171f1b
- (long long)previousParticipantIndex;	// IMP=0x0010000000171ca4
- (long long)localPlayerParticipantIndex;	// IMP=0x0010000000171c12
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000171a77
- (unsigned long long)hash;	// IMP=0x0010000000171a33
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001be212
