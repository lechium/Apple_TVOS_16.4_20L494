...
@class GKAchievementPointsEntryCacheObject, GKGameCacheObject, GKPlayerProfileCacheObject, MISSING_TYPE, NSDate, NSNumber, NSString;

@interface GKGameRecordCacheObject
{
}

+ (id)relationshipKeyPathsForPrefetch;	// IMP=0x00400000001553e2
+ (MISSING_TYPE *)fetchSortDescriptors;	// IMP=0x00100000001552b3
+ (id)entityName;	// IMP=0x00100000001552a6
+ (id)recordForGame:(id)arg1 playerProfile:(id)arg2;	// IMP=0x001000000015358c
+ (id)recordsForGames:(id)arg1 playerProfile:(id)arg2;	// IMP=0x00100000001531c5
- (id)internalRepresentation;	// IMP=0x0020000000155101
- (void)updateAchievementsWithServerRepresentation:(id)arg1;	// IMP=0x0010000000154e65
- (void)updateIDsWithServerRepresentation:(id)arg1;	// IMP=0x00100000001543b2
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000153684
