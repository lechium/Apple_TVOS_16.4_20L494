...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001d04da
- (void).cxx_destruct;	// IMP=0x00100000001d089d
...
- (unsigned long long)hash;	// IMP=0x00100000001d07a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d06cc
