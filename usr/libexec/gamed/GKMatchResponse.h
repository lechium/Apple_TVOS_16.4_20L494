...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000002237a3
- (void).cxx_destruct;	// IMP=0x0020000000223bf5
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x00100000002239d6
- (_Bool)isNetworkError;	// IMP=0x0010000000223995
- (_Bool)isTimeout;	// IMP=0x0010000000223954
- (_Bool)isCancelled;	// IMP=0x0010000000223913
- (_Bool)isFinished;	// IMP=0x00100000002238d2
- (int)_incrementSequence;	// IMP=0x00100000002238c1
