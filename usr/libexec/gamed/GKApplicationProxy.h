...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x0040000000112cac
- (void).cxx_destruct;	// IMP=0x00200000001132e8
...
- (id)bundleURL;	// IMP=0x0010000000112f60
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x0010000000112c52
- (id)initWithProxy:(id)arg1;	// IMP=0x0010000000112bea
