...
+ (id)entityName;	// IMP=0x004000000016c1ee
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x002000000016c7f8
- (id)internalRepresentation;	// IMP=0x001000000016c40a
- (Class)classForInternalRepresentation;	// IMP=0x001000000016c3f9
- (_Bool)hasDetails;	// IMP=0x001000000016c1fb
