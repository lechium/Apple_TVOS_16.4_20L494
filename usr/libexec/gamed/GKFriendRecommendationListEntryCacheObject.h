...
+ (id)entityName;	// IMP=0x004000000015c8f9
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x002000000015c906
- (id)internalRepresentation;	// IMP=0x001000000015c5fe
