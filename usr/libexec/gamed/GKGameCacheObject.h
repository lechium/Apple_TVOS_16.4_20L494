...
+ (id)entityName;	// IMP=0x0020000000151c46
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x001000000014f5c5
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x001000000014f406
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x001000000014f247
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x001000000014ef4c
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x001000000014ee4d
+ (id)fetchSortDescriptors;	// IMP=0x001000000014ed6e
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x001000000014ed61
+ (id)uniqueAttributeName;	// IMP=0x001000000014ed54
- (id)gameDescriptor;	// IMP=0x0020000000151836
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x0010000000151796
- (id)internalRepresentation;	// IMP=0x00100000001515f1
- (_Bool)storePiecesExpired;	// IMP=0x00100000001515a4
- (_Bool)storePiecesValid;	// IMP=0x0010000000151571
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000150d8b
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000015040e
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x001000000014fb74
- (_Bool)isValid;	// IMP=0x001000000014fae2
