...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001d2cef
- (void).cxx_destruct;	// IMP=0x00100000001d3540
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001d3075
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x00100000001d2fac
- (_Bool)isValid;	// IMP=0x00100000001d2f79
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d2ecc
- (unsigned long long)hash;	// IMP=0x00100000001d2eaf
- (void)updateWithProperties:(id)arg1;	// IMP=0x00100000001bc6a0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00100000001bc109
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001bbc62
