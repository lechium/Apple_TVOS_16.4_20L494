...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000c2af7
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000000c28be
- (void).cxx_destruct;	// IMP=0x00100000000c324e
...
- (id)descriptionSubstitutionMap;	// IMP=0x00100000000c30f5
...
- (unsigned long long)hash;	// IMP=0x00100000000c2fef
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c2eb3
- (id)serverRepresentation;	// IMP=0x00100000000c2cd6
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000c2bd7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000c2aff
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x00100000000c32e5
