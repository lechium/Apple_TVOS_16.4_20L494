...
+ (id)entityName;	// IMP=0x0040000000161e8e
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0020000000161e9b
- (id)internalRepresentation;	// IMP=0x0010000000161cf0
