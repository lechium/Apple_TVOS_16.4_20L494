...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001cfbad
- (void).cxx_destruct;	// IMP=0x00200000001d0380
...
- (void)setOverallRankCount:(unsigned int)arg1;	// IMP=0x00100000001d01e8
- (unsigned int)overallRankCount;	// IMP=0x00100000001d01d8
...
- (unsigned long long)hash;	// IMP=0x00100000001d004c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001cff78
