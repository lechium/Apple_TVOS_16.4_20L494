...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000001fca08
- (void).cxx_destruct;	// IMP=0x00200000001fde73
...
- (void)handleAction:(id)arg1;	// IMP=0x00100000001fd9a3
- (void)assembleBulletin;	// IMP=0x00100000001fd59e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001fd1f0
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001fce33
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00100000001fca4d
- (_Bool)isAccept;	// IMP=0x00100000001fca45
- (id)notificationName;	// IMP=0x00100000001fca31
- (id)debugLine;	// IMP=0x00100000001fca24
- (id)aggregateDictionaryKey;	// IMP=0x00100000001fca10
