...
- (void).cxx_destruct;	// IMP=0x00200000001b4096
...
- (_Bool)shouldBeCleared;	// IMP=0x00100000001b3a85
- (void)removeAllResponses;	// IMP=0x00100000001b38e1
- (void)addResponse:(id)arg1;	// IMP=0x00100000001b3891
- (void)removeAllInvitees;	// IMP=0x00100000001b3539
- (id)allInvitees;	// IMP=0x00100000001b3519
- (id)referencesForInvitee:(id)arg1;	// IMP=0x00100000001b34b6
- (void)removeInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x00100000001b2a5b
- (void)addInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x00100000001b28da
- (void)performSync:(CDUnknownBlockType)arg1;	// IMP=0x00100000001b28c9
- (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00100000001b2721
- (id)initWithSessionToken:(id)arg1;	// IMP=0x00100000001b26c7
- (id)init;	// IMP=0x00100000001b25b2
