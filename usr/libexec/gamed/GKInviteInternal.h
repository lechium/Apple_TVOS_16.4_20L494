...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000012ce30
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x001000000012cda1
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x001000000012cbe8
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x001000000012c5ed
- (void).cxx_destruct;	// IMP=0x002000000012d585
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000012d2ae
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000012d1d3
- (unsigned long long)hash;	// IMP=0x001000000012d18f
- (id)init;	// IMP=0x001000000012cdd0
