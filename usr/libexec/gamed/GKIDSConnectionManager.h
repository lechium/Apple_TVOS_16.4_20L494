...
+ (id)sharedManager;	// IMP=0x002000000010370b
- (void).cxx_destruct;	// IMP=0x0020000000103e83
...
- (void)accountController:(id)arg1 accountAdded:(id)arg2;	// IMP=0x0010000000103bcd
- (void)fetchIDSDataForHandles:(id)arg1 service:(id)arg2 infoTypes:(unsigned long long)arg3 performingBlockPerBatch:(CDUnknownBlockType)arg4;	// IMP=0x00100000001038c7
- (_Bool)isReady;	// IMP=0x001000000010387c
- (void)dealloc;	// IMP=0x0010000000103837
- (id)init;	// IMP=0x0010000000103760
