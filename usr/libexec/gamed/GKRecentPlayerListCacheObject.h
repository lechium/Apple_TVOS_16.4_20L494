...
+ (Class)entryClass;	// IMP=0x004000000015fc7f
+ (id)entityName;	// IMP=0x001000000015fc72
- (id)internalRepresentation;	// IMP=0x002000000015ff17
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000015fc90
