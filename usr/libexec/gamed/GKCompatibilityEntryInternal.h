...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000012d671
- (void).cxx_destruct;	// IMP=0x002000000012dc3c
...
- (unsigned long long)hash;	// IMP=0x001000000012dad8
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000012d85e
