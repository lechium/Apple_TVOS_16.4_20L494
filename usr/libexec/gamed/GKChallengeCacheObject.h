...
+ (id)entityName;	// IMP=0x002000000016b48c
+ (id)fetchSortDescriptors;	// IMP=0x001000000016a479
+ (id)challengeWithServerRepresentation:(id)arg1 context:(id)arg2;	// IMP=0x001000000016a0cb
+ (id)challengesWithChallengeIDs:(id)arg1 context:(id)arg2;	// IMP=0x0010000000169eb5
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x0010000000169ea8
+ (id)uniqueAttributeName;	// IMP=0x0010000000169e9b
- (void)invalidate;	// IMP=0x002000000016b64c
- (_Bool)hasDetails;	// IMP=0x001000000016b499
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000016ad14
- (id)orderedSetOfCompatibleBundleIDs;	// IMP=0x001000000016a975
- (id)internalRepresentation;	// IMP=0x001000000016a51c
- (Class)classForInternalRepresentation;	// IMP=0x001000000016a514
