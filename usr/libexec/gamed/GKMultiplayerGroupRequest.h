...
+ (id)bagKey;	// IMP=0x00200000000fec37
- (void).cxx_destruct;	// IMP=0x00200000000ff6f0
...
- (id)requestIdentifier;	// IMP=0x00100000000ff51b
- (id)postBody;	// IMP=0x00100000000ff329
- (id)taskInfo;	// IMP=0x00100000000ff0f5
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000feef6
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000fee4a
- (id)initWithGroupID:(id)arg1;	// IMP=0x00100000000fed4b
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000fed38
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000fec44
