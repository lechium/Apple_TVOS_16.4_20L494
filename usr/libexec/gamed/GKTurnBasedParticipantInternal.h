...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000172d19
- (void).cxx_destruct;	// IMP=0x0010000000173433
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000017322d
- (id)serverRepresentation;	// IMP=0x0010000000172fc0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000172ed4
- (unsigned long long)hash;	// IMP=0x0010000000172ebe
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001bed83
