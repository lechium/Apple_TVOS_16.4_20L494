...
@class CKRecordID, MISSING_TYPE, NSMutableSet;
...
@interface GKInviteURLManager : NSObject
{
    ...
    MISSING_TYPE *_inviteManagerQueue;	// 24 = 0x18
}

+ (id)sharedManager;	// IMP=0x00400000000cc324
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x00100000000cc588
- (id)init;	// IMP=0x00100000000cc4d4
