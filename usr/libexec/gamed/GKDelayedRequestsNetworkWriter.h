...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0020000000113cfe
- (void).cxx_destruct;	// IMP=0x00200000001141a9
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000113e0c
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0010000000113d6e
