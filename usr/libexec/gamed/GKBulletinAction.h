...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001da4e9
- (void).cxx_destruct;	// IMP=0x00200000001da97c
...
- (id)description;	// IMP=0x00100000001da77a
@property(readonly) NSDictionary *actionDictionary;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001da4f1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001da1a5
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001d9e74
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000001d9db0
- (id)init;	// IMP=0x00100000001d9d76
