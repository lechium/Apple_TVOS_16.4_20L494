...
+ (id)entityName;	// IMP=0x0040000000166f9a
- (id)internalRepresentation;	// IMP=0x0020000000167918
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x0010000000166fa7
