...
+ (id)bagKey;	// IMP=0x00200000000ff75a
- (void).cxx_destruct;	// IMP=0x00200000001000ab
...
- (id)requestIdentifier;	// IMP=0x00100000000ffee2
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000ffecf
- (id)taskInfo;	// IMP=0x00100000000ffcf4
- (id)postBody;	// IMP=0x00100000000ffce2
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000ffc51
- (id)initWithInstanceScore:(id)arg1 bundleID:(id)arg2 challenges:(id)arg3;	// IMP=0x00100000000ff99d
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000ff813
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000ff767
