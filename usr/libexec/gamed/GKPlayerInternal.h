...
+ (Class)classForFamiliarity:(int)arg1;	// IMP=0x00200000001150cc
+ (id)displayNameWithOptions:(unsigned char)arg1 alias:(id)arg2 composite:(id)arg3;	// IMP=0x0010000000114f77
+ (id)compositeNameForFirstName:(id)arg1 lastName:(id)arg2;	// IMP=0x0010000000114dd6
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000001141d9
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001141d1
+ (id)propertiesToFetch;	// IMP=0x00100000001bd07a
+ (int)familiarity;	// IMP=0x00100000001bd072
+ (unsigned char)piecesToLoad;	// IMP=0x00100000001bd03e
- (void).cxx_destruct;	// IMP=0x0010000000115ac1
...
- (void)stripPIIs;	// IMP=0x0010000000115524
- (id)debugDescription;	// IMP=0x0010000000115332
...
- (void)setAllowNearbyMultiplayer:(_Bool)arg1;	// IMP=0x00100000001152fa
- (_Bool)allowNearbyMultiplayer;	// IMP=0x00100000001152f2
...
- (int)globalFriendListSharingStatus;	// IMP=0x0010000000115297
...
- (int)defaultFamiliarity;	// IMP=0x00100000001150ff
- (id)displayNameWithOptions:(unsigned char)arg1;	// IMP=0x0010000000114eb0
- (id)minimalInternal;	// IMP=0x0010000000114a73
- (unsigned long long)hash;	// IMP=0x0010000000114a2f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000114964
- (id)serverRepresentation;	// IMP=0x0010000000114859
- (id)conciseDescription;	// IMP=0x001000000011479c
- (id)cacheKey;	// IMP=0x001000000011478a
- (void)updateWithProperties:(id)arg1;	// IMP=0x00100000001bd0ca
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001bcad4
