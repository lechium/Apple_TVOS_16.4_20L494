...
+ (id)entityName;	// IMP=0x002000000015fc65
- (id)internalRepresentation;	// IMP=0x002000000015f7be
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000015eecb
