...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001d1107
- (void).cxx_destruct;	// IMP=0x00200000001d140b
...
- (id)description;	// IMP=0x00100000001d0fbb
@property(readonly) NSString *scopeAsString;
- (unsigned long long)hash;	// IMP=0x00100000001d0e85
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d0c18
