...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000002231d5
+ (id)secureCodedPropertyKeys;	// IMP=0x001000000022308a
- (void).cxx_destruct;	// IMP=0x0020000000223305
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000222fc0
