...
+ (id)entityName;	// IMP=0x0040000000152529
- (id)internalRepresentation;	// IMP=0x002000000015284d
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000001525c6
- (_Bool)isValid;	// IMP=0x0010000000152536
