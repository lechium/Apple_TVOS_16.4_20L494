...
+ (id)entityName;	// IMP=0x002000000014d426
+ (id)playerProfilesWithPlayerIDs:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000014b753
+ (id)playerProfilesWithPlayers:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000014b6ae
+ (id)profileForPlayer:(id)arg1 context:(id)arg2;	// IMP=0x001000000014b5c6
+ (id)playerProfileWithPlayerID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000014b2fa
+ (id)localPlayerInManagedObjectContext:(id)arg1;	// IMP=0x001000000014b058
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x001000000014a3da
+ (id)uniqueAttributeName;	// IMP=0x001000000014a3cd
+ (id)filterPlayerIDs:(id)arg1 familiarity:(int)arg2 includeSelf:(_Bool)arg3;	// IMP=0x001000000014eb61
+ (unsigned char)piecesToLoadForFamiliarity:(int)arg1;	// IMP=0x001000000014eb3b
+ (id)playersByFamiliarity:(id)arg1;	// IMP=0x001000000014e507
+ (void)setFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x001000000014e2d3
+ (void)removeFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x001000000014ded2
+ (void)addFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x001000000014dccb
+ (int)familiarityForPlayerID:(id)arg1;	// IMP=0x001000000014dad6
+ (id)selfPlayerID;	// IMP=0x001000000014da7f
+ (void)buildFamiliarilyLookupForProfile:(id)arg1;	// IMP=0x001000000014d7b1
+ (id)_familiarityLookup;	// IMP=0x001000000014d5bd
- (void)expireRecentMatchesWithGame:(id)arg1;	// IMP=0x001000000014d433
- (id)internalRepresentation;	// IMP=0x001000000014d26f
- (id)internalRepresentationWithPieces:(unsigned char)arg1;	// IMP=0x001000000014d091
- (void)updateContactsIntegrationInformationFromServerRepresentation:(id)arg1;	// IMP=0x001000000014cf2a
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2 pieces:(unsigned char)arg3;	// IMP=0x001000000014bfc2
- (id)updateImagesWithImageURLs:(id)arg1;	// IMP=0x001000000014bb3b
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000014bb26
- (void)deleteCachedImage:(id)arg1;	// IMP=0x001000000014ab5d
- (void)deleteCachedAvatars;	// IMP=0x001000000014a898
- (void)clearImages;	// IMP=0x001000000014a569
...
- (void)invalidate;	// IMP=0x001000000014a45d
