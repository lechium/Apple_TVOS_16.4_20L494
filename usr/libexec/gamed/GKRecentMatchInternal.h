...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001d3eec
- (void).cxx_destruct;	// IMP=0x00200000001d42ba
...
- (unsigned long long)hash;	// IMP=0x00100000001d418a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d3fe6
