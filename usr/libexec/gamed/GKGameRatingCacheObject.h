...
+ (id)entityName;	// IMP=0x0040000000155928
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0010000000155406
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00200000001556cb
