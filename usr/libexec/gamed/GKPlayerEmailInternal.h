...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000117593
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000011758b
- (void).cxx_destruct;	// IMP=0x0020000000117897
...
- (unsigned long long)hash;	// IMP=0x001000000011778c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000117672
