...
- (void).cxx_destruct;	// IMP=0x00200000001a26d6
...
- (void)cancelConnection;	// IMP=0x00100000001a263c
- (void)readData;	// IMP=0x00100000001a2636
- (void)_sendData:(id)arg1;	// IMP=0x00100000001a2630
- (_Bool)sendData:(id)arg1;	// IMP=0x00100000001a25cd
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000001a23cd
- (void)dealloc;	// IMP=0x00100000001a2330
- (id)initWithConnection:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;	// IMP=0x00100000001a2248
