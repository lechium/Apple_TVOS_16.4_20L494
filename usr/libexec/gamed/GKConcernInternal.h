...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001183e6
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001183de
- (void).cxx_destruct;	// IMP=0x0020000000118627
...
- (unsigned long long)hash;	// IMP=0x00100000001185b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001184e0
