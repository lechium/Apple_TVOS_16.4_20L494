...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001303ce
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000012fd7e
- (void).cxx_destruct;	// IMP=0x0010000000130b67
...
- (unsigned long long)hash;	// IMP=0x00100000001309f7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000130705
- (id)serverRepresentation;	// IMP=0x0010000000130573
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001302ba
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000012fda2
