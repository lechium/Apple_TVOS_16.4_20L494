...
+ (id)entityName;	// IMP=0x002000000015640c
- (id)internalRepresentation;	// IMP=0x002000000015610a
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000155ae3
