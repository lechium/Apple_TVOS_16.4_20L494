...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000012be70
- (void).cxx_destruct;	// IMP=0x002000000012c567
...
- (_Bool)hasGuestPlayers;	// IMP=0x001000000012c21f
- (unsigned long long)hash;	// IMP=0x001000000012be01
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000012b723
- (id)init;	// IMP=0x001000000012b6ad
