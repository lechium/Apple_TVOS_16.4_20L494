...
+ (id)entityName;	// IMP=0x004000000016b695
- (id)internalRepresentation;	// IMP=0x002000000016b6a2
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000016b68f
