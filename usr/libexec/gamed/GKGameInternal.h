...
+ (id)createGameControllerDaemonGameInternal;	// IMP=0x00200000001d2ad2
+ (id)createGamedGameInternal;	// IMP=0x00100000001d2a7e
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000001d222d
+ (id)propertiesToFetch;	// IMP=0x00100000001ba9ea
- (void).cxx_destruct;	// IMP=0x00200000001d2c67
...
- (_Bool);	// IMP=0x00100000001d2613
- (id)description;	// IMP=0x00100000001d2570
- (id)serverRepresentation;	// IMP=0x00100000001d255e
- (unsigned long long)hash;	// IMP=0x00100000001d21e9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d213c
- (void)updateWithProperties:(id)arg1;	// IMP=0x00100000001baa3a
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001ba218
- (id)defaultCategory;	// IMP=0x00100000001d2cdd
- (unsigned short)numberOfCategories;	// IMP=0x00100000001d2ccb
