...
+ (id)internalRepresentation;	// IMP=0x0040000000004336
+ (id)secureCodedPropertyKeys;	// IMP=0x0010000000003eda
- (void).cxx_destruct;	// IMP=0x0020000000004a58
...
- (id)descriptionSubstitutionMap;	// IMP=0x00100000000048dc
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x00100000000044be
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x0010000000004350
- (id)serverRepresentation;	// IMP=0x001000000000433e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000004289
- (unsigned long long)hash;	// IMP=0x0010000000004245
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000004113
