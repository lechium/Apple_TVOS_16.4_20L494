...
- (void).cxx_destruct;	// IMP=0x0020000000025013
...
- (id)compile;	// IMP=0x0010000000024d78
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000002498b
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x0010000000024860
