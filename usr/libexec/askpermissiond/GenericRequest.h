...
- (void).cxx_destruct;	// IMP=0x00200000000232fe
...
- (id)compile;	// IMP=0x0010000000023063
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000022c77
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x0010000000022b4c
