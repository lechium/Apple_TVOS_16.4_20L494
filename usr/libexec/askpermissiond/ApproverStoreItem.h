...
- (void).cxx_destruct;	// IMP=0x0020000000006181
...
- (id)description;	// IMP=0x0010000000005f0c
- (id)compile;	// IMP=0x001000000000591e
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000045dc
- (id)initWithItemIdentifier:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 date:(id)arg4;	// IMP=0x00100000000044fa
- (id)initWithRequest:(id)arg1 date:(id)arg2;	// IMP=0x001000000000419d
