...
- (void).cxx_destruct;	// IMP=0x001000000001062b
@property(readonly, getter=isManaging) _Bool managing; // @synthesize managing=_managing;
@property(readonly) NSData *state;
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001024e
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000010066
- (id)init;	// IMP=0x001000000000ffa5
- (void)_loadEnterpriseData;	// IMP=0x001000000001065e
