...
- (void).cxx_destruct;	// IMP=0x0020000000010d9d
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000010943
- (void)scheduleBackgroundTasks;	// IMP=0x001000000000fc6e
- (void)resume;	// IMP=0x001000000000fc58
- (void)dealloc;	// IMP=0x001000000000fbfe
- (id)init;	// IMP=0x001000000000fb68
