...
- (void).cxx_destruct;	// IMP=0x004000000001a840
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x001000000001a7b0
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x001000000001a780
- (id)initToMemory;	// IMP=0x001000000001a750
- (void)close;	// IMP=0x001000000001a720
- (void)open;	// IMP=0x001000000001a3f0
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x001000000001a280
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x0010000000019da0
