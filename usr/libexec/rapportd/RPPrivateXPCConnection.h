...
- (void).cxx_destruct;	// IMP=0x002000000006a459
...
// Error: Property attributes should begin with the type ('T') attribute, property name: activatedDiscovery
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000006a2d6
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000006a1c2
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000006a0c8
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000069fb4
- (void)xpcConnectionInvalidated;	// IMP=0x0010000000069e31
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x0010000000069d0c
