...
- (void).cxx_destruct;	// IMP=0x0020000000057000
...
- (void)setDispatchQueue:(id)arg1;	// IMP=0x0010000000056fb1
- (id)dispatchQueue;	// IMP=0x0010000000056fa7
...
- (void)session:(id)arg1 object:(id)arg2 didUpdateRegion:(id)arg3 previousRegion:(id)arg4;	// IMP=0x0010000000056c0c
- (void)invalidate;	// IMP=0x0010000000056b17
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000567a5
- (id)init;	// IMP=0x0010000000056735
