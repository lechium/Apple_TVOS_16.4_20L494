...
- (void).cxx_destruct;	// IMP=0x00200000000576da
...
- (id)description;	// IMP=0x0010000000057595
- (void)invalidate;	// IMP=0x001000000005731e
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000057120
