...
+ (id)sharedDaemon;	// IMP=0x00200000000406da
- (void).cxx_destruct;	// IMP=0x0020000000043a63
...
- (void)_xpcPublisherStateChangedForToken:(unsigned long long)arg1 state:(_Bool)arg2;	// IMP=0x0010000000043822
- (void)_xpcPublisherTriggeredReply:(id)arg1 token:(unsigned long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000434f3
- (void)_xpcPublisherTriggeredToken:(unsigned long long)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000431da
- (void)_xpcPublisherRemoveToken:(unsigned long long)arg1;	// IMP=0x001000000004304e
- (void)_xpcPublisherAddToken:(unsigned long long)arg1 event:(id)arg2;	// IMP=0x0010000000042b4c
- (MISSING_TYPE *)_xpcPublisherAction:token:event: /* Error: Ran out of types for this method. */;	// IMP=0x0010000000042a82
- (void)_updateErrorFlags;	// IMP=0x0010000000042939
- (void)_prefsChanged;	// IMP=0x00100000000427fd
- (void)postDaemonInfoChanges:(unsigned long long)arg1;	// IMP=0x001000000004260b
- (id)keychainStateString;	// IMP=0x001000000004236b
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000004211d
- (_Bool)diagnosticCommand:(id)arg1 params:(id)arg2;	// IMP=0x0010000000041ff9
- (void)invalidate;	// IMP=0x0010000000041bf8
- (void)activate;	// IMP=0x00100000000411d1
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x0010000000040925
- (id)init;	// IMP=0x001000000004072f
