...
- (void).cxx_destruct;	// IMP=0x00200000000bd188
...
- (void)cancel;	// IMP=0x00100000000bd0cb
- (void)main;	// IMP=0x00100000000bca58
- (id)initWithVariant:(long long)arg1 userInterfaceStyle:(long long)arg2 imageProvider:(CDUnknownBlockType)arg3;	// IMP=0x00100000000bc934
