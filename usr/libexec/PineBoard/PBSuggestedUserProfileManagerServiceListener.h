...
- (void).cxx_destruct;	// IMP=0x0020000000197376
@property(retain, nonatomic) BSServiceConnectionListener *listener; // @synthesize listener=_listener;
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x00100000001970c3
- (void)invalidate;	// IMP=0x0010000000197041
- (void)activate;	// IMP=0x0010000000196ee2
