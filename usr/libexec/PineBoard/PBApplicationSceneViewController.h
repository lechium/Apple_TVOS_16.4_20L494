...
- (void).cxx_destruct;	// IMP=0x00200000001b8f58
...
- (void)applicationSceneView:(id)arg1 didUpdateReadiness:(_Bool)arg2;	// IMP=0x00100000001b8e94
- (void)applicationSceneViewDidUpdatePresentationMode:(id)arg1;	// IMP=0x00100000001b8e81
- (void)applicationSceneView:(id)arg1 willLoadSnapshotWithRequest:(id)arg2;	// IMP=0x00100000001b8e60
...
- (void)_updateDeferralTargetAssertionIfNeeded;	// IMP=0x00100000001b8b49
- (id)preferredFocusEnvironments;	// IMP=0x00100000001b8abd
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00100000001b8a7c
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long effectivePresentationMode;
@property(nonatomic) unsigned long long presentationMode;
- (void)setPresentationMode:(unsigned long long)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001b8871
@property(readonly, nonatomic) PBApplicationSceneView *sceneView;
- (void)loadView;	// IMP=0x00100000001b86d9
- (void)dealloc;	// IMP=0x00100000001b8690
- (id)initWithSceneHandle:(id)arg1 layoutLevel:(long long)arg2;	// IMP=0x00100000001b85df
