...
- (void).cxx_destruct;	// IMP=0x002000000011b18a
...
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x001000000011b084
- (void)viewServiceDidDismiss:(id)arg1;	// IMP=0x001000000011afbb
- (void)viewService:(id)arg1 willDismissWithResult:(id)arg2;	// IMP=0x001000000011af44
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000011ade1
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000011acde
@property(readonly, nonatomic) _Bool expectsEventForwarding;
- (void)viewDidLoad;	// IMP=0x001000000011ab85
- (id)initWithRemoteViewController:(id)arg1 supportsInterruption:(_Bool)arg2 allowsInteraction:(_Bool)arg3;	// IMP=0x001000000011aacd
- (id)initWithRemoteViewController:(id)arg1 supportsInterruption:(_Bool)arg2;	// IMP=0x001000000011aab4
