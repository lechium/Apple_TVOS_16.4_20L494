...
- (void).cxx_destruct;	// IMP=0x002000000015adc4
...
- (void)_willInterruptWithReason:(id)arg1;	// IMP=0x001000000015ac91
- (void)_begin;	// IMP=0x001000000015a226
- (_Bool)_canBeInterrupted;	// IMP=0x001000000015a21e
