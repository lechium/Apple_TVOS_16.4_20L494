...
- (void).cxx_destruct;	// IMP=0x002000000005c4fc
@property(readonly, nonatomic) BSSimpleAssertion *assertion; // @synthesize assertion=_assertion;
- (void)invalidate;	// IMP=0x001000000005c4db
@property(readonly, copy) NSString *description;
@property(readonly, copy, nonatomic) NSString *reason;
- (void)dealloc;	// IMP=0x001000000005c3d9
- (id)initWithReason:(id)arg1;	// IMP=0x001000000005c23f
