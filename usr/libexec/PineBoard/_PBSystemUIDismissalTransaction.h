...
- (void).cxx_destruct;	// IMP=0x002000000006c837
...
- (_Bool)_canBeInterrupted;	// IMP=0x001000000006c7ec
- (void)_begin;	// IMP=0x001000000006c61e
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x001000000006c533
