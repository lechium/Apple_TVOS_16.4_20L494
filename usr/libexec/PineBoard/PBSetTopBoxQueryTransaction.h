...
- (void).cxx_destruct;	// IMP=0x0020000000106382
...
- (void)_didComplete;	// IMP=0x00100000001061a7
- (void)_begin;	// IMP=0x0010000000105bf6
- (_Bool)_canBeInterrupted;	// IMP=0x0010000000105bee
- (double)watchdogTimeout;	// IMP=0x0010000000105be0
- (_Bool)shouldWatchdog:(id *)arg1;	// IMP=0x0010000000105bd8
@property(readonly, nonatomic, getter=isFresh) _Bool fresh;
- (id)init;	// IMP=0x0010000000105b10
- (id)initWithLog:(id)arg1 identityProviderInfoCenter:(id)arg2 currentBundleIdentifier:(id)arg3;	// IMP=0x0010000000105a36
