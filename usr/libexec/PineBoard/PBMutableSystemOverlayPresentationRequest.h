...
- (void)_setInsertAtFrontOfQueue:(_Bool)arg1;	// IMP=0x00200000000dcf08
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000dce34
- (id)init;	// IMP=0x00100000000dce03
