...
- (void).cxx_destruct;	// IMP=0x002000000006a483
...
- (unsigned long long)hash;	// IMP=0x001000000006a332
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000006a021
- (id)description;	// IMP=0x0010000000069f2c
- (id)initWithBluetoothDevice:(id)arg1;	// IMP=0x0010000000069e17
- (id)initWithPeripheral:(id)arg1;	// IMP=0x0010000000069d0c
