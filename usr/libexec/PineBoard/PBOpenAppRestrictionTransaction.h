...
- (void).cxx_destruct;	// IMP=0x002000000008d50f
...
- (_Bool)_needsUI;	// IMP=0x001000000008d3a4
- (void)_begin;	// IMP=0x001000000008d01e
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000008ce99
