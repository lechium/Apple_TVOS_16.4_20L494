...
+ (id)_infoPlistKeys;	// IMP=0x0040000000099d20
+ (id)_entitlementKeys;	// IMP=0x0010000000099c5a
- (void).cxx_destruct;	// IMP=0x001000000009a07d
...
- (void)_refreshRunsAsCurrentUser;	// IMP=0x0010000000099afa
- (void)_refreshLocalizedName;	// IMP=0x0010000000099a0d
- (id)getEntitlementValueUncached:(id)arg1 ofClass:(Class)arg2;	// IMP=0x0010000000099959
- (id)getInfoPlistValueUncached:(id)arg1;	// IMP=0x0010000000099875
...
- (void)_loadFromProxy:(id)arg1;	// IMP=0x00100000000988bb
- (void)pb_reportUntrustedLaunchAttempt;	// IMP=0x00100000001e2dc9
