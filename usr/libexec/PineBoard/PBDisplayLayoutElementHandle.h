...
- (void).cxx_destruct;	// IMP=0x00200000001fa883
...
- (void)update:(CDUnknownBlockType)arg1 withReason:(id)arg2;	// IMP=0x00100000001fa5d8
- (void)invalidate;	// IMP=0x00100000001fa5a8
- (id)initWithElement:(id)arg1 publisher:(id)arg2;	// IMP=0x00100000001fa50f
