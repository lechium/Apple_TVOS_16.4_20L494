...
- (void).cxx_destruct;	// IMP=0x0020000000080daa
...
- (_Bool);	// IMP=0x0010000000080caa
- (_Bool)stretchVolumeSliderForMaximumVolumeUpdateIfNeeded;	// IMP=0x0010000000080c3c
- (void)noteVolumeDownWasHit:(_Bool)arg1;	// IMP=0x0010000000080a95
- (void)noteVolumeUpWasHit:(_Bool)arg1;	// IMP=0x0010000000080a2c
- (void)dismissVolumeHUDWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000080604
- (void)stretchVolumeHUDWithLevel:(id)arg1;	// IMP=0x00100000000802b3
- (void)updateVolumeHUDWithLevel:(id)arg1;	// IMP=0x001000000007ff60
- (void)initializeVolumeHUDWithImage:(id)arg1 level:(id)arg2;	// IMP=0x001000000007fb06
