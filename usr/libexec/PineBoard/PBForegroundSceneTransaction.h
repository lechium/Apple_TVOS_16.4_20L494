...
- (void).cxx_destruct;	// IMP=0x002000000015842e
...
- (void)_begin;	// IMP=0x00100000001580c1
- (id)initWithSceneIdentity:(id)arg1 backgroundAllOtherScenes:(_Bool)arg2;	// IMP=0x0010000000158041
