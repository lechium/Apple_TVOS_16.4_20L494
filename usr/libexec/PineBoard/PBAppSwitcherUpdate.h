...
+ (id)insertUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x00400000000538e9
+ (id)deleteUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x0010000000053872
- (void).cxx_destruct;	// IMP=0x0020000000053985
...
- (id)initWithType:(long long)arg1 item:(id)arg2 fromIndexPath:(id)arg3 toIndexPath:(id)arg4;	// IMP=0x0010000000053785
