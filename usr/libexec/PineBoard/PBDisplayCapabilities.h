...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00200000001363fd
- (_Bool)isLikelyUpgradeFrom:(id)arg1;	// IMP=0x00100000001363f5
- (_Bool)supportsDynamicRange:(long long)arg1;	// IMP=0x00100000001363c6
...
- (id)debugDescription;	// IMP=0x001000000013619e
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x00100000001360f0
- (id)initWithAvailableModes:(id)arg1 forDisplay:(id)arg2;	// IMP=0x0010000000135bb8
