...
+ (id)keyPathsForValuesAffectingHasActivePresentation;	// IMP=0x00200000000dbcd5
- (void).cxx_destruct;	// IMP=0x00200000000dca67
...
- (void)_checkPendingRequests;	// IMP=0x00100000000dc4a0
- (void)_callPendingDismissalCompletionHandlersForSession:(id)arg1 success:(_Bool)arg2;	// IMP=0x00100000000dc315
- (void)_callPendingPresentationCompletionHandlersForSession:(id)arg1 success:(_Bool)arg2;	// IMP=0x00100000000dc18a
- (void)systemOverlaySessionDidInvalidate:(id)arg1;	// IMP=0x00100000000dbff2
- (void)systemOverlaySessionDidCancel:(id)arg1 withContext:(id)arg2;	// IMP=0x00100000000dbf3f
- (void)systemOverlaySessionDidDismiss:(id)arg1;	// IMP=0x00100000000dbec9
- (void)systemOverlaySessionWillDismiss:(id)arg1 withContext:(id)arg2;	// IMP=0x00100000000dbe2f
- (void)systemOverlaySessionDidPresent:(id)arg1;	// IMP=0x00100000000dbdb9
- (void)systemOverlaySessionWillPresent:(id)arg1;	// IMP=0x00100000000dbd59
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000000dbd12
- (void)resume;	// IMP=0x00100000000dbb3c
- (void)pauseWithOptions:(long long)arg1;	// IMP=0x00100000000db9eb
@property(readonly, nonatomic) _Bool hasActivePresentation;
- (void)dismissWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000db6dc
- (void)presentWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000db1c8
- (id)initWithName:(id)arg1 layoutLevel:(long long)arg2 presentationHandler:(id)arg3 delegate:(id)arg4;	// IMP=0x00100000000daffe
- (id)init;	// IMP=0x00100000000daff0
