...
- (void).cxx_destruct;	// IMP=0x002000000018f59a
...
- (void)_addLegacyGameDialogTransaction;	// IMP=0x001000000018f302
- (void)_addRestrictionDialogTransaction;	// IMP=0x001000000018f073
- (void)_addValidateSignatureVersionDialogTransaction;	// IMP=0x001000000018ee11
- (void)_addInitialDialogTransaction;	// IMP=0x001000000018edfe
@property(readonly, nonatomic) NSString *launchPreventionReason;
@property(readonly, nonatomic) _Bool shouldContinueLaunch;
- (_Bool)_shouldFailForChildTransaction:(id)arg1;	// IMP=0x001000000018ed74
- (void)_begin;	// IMP=0x001000000018ed33
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000018ec40
