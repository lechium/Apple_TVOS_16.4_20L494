...
- (void).cxx_destruct;	// IMP=0x0020000000007f3d
...
- (id)_createAnimationTransaction;	// IMP=0x0010000000007e7e
- (void)animateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000007bcc
- (id)initWithContainingView:(id)arg1 goingFullScreenLayout:(id)arg2 goingToPIPLayout:(id)arg3 quadrant:(long long)arg4 currentPIPInsets:(struct UIEdgeInsets)arg5;	// IMP=0x0010000000007af4
