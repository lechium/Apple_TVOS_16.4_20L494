...
- (void).cxx_destruct;	// IMP=0x00200000001260cb
...
- (void)_prepareKioskAnimationInTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000125c35
- (id)_defaultAppAnimationTransaction;	// IMP=0x0010000000125ba0
- (void)_begin;	// IMP=0x00100000001257e0
- (_Bool)_canBeInterrupted;	// IMP=0x00100000001257d8
- (id)initWithScreenSaverViewController:(id)arg1 animated:(_Bool)arg2 updateWallpaper:(_Bool)arg3 applyStartValues:(_Bool)arg4;	// IMP=0x0010000000125730
