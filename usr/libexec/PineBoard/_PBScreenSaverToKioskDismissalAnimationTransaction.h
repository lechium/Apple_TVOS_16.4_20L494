...
@interface _PBScreenSaverToKioskDismissalAnimationTransaction : BSTransaction
{
    ...
    MISSING_TYPE *_alphaAnimator;	// 40 = 0x28
}

- (void).cxx_destruct;	// IMP=0x00200000001280cd
...
- (void)_begin;	// IMP=0x001000000012749e
- (_Bool)_canBeInterrupted;	// IMP=0x0010000000127496
