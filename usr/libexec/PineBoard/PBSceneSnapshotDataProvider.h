...
- (void).cxx_destruct;	// IMP=0x0020000000118258
...
- (void)invalidateImage;	// IMP=0x00100000001181ee
- (id)fetchImage;	// IMP=0x0010000000117e1a
- (id)initWithSceneSnapshot:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x0010000000117c95
- (id)init;	// IMP=0x0010000000117c87
