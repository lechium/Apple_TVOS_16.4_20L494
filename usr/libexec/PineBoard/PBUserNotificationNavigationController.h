...
- (void).cxx_destruct;	// IMP=0x00200000001e2d4e
...
- (void)didCancelUserNotificationViewController:(id)arg1;	// IMP=0x00100000001e2c97
- (void)userNotificationViewController:(id)arg1 didSelectButtonIndex:(unsigned long long)arg2;	// IMP=0x00100000001e2c30
@property(retain, nonatomic) PBCFUserNotification *notification;
- (id)initWithUserNotificationViewController:(id)arg1;	// IMP=0x00100000001e2b0f
