...
- (void).cxx_destruct;	// IMP=0x0020000000018286
...
- (id)description;	// IMP=0x0010000000018049
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0010000000017ff5
- (id)entitlementValueForKey:(id)arg1;	// IMP=0x0010000000017f3e
@property(readonly) int pid;
- (void)dead;	// IMP=0x0010000000017e65
- (void)dying;	// IMP=0x0010000000017e1a
- (void)dealloc;	// IMP=0x0010000000017ddb
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x001000000001745c
