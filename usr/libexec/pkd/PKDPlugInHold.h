...
- (void).cxx_destruct;	// IMP=0x00200000000173f8
...
- (id)description;	// IMP=0x0010000000017200
- (unsigned long long)hash;	// IMP=0x00100000000171bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001710e
- (id)initWithPlugIns:(id)arg1 extensionPointName:(id)arg2 forClient:(id)arg3;	// IMP=0x0010000000016f88
