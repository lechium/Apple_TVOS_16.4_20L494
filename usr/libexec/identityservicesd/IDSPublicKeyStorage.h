...
+ (id)sharedInstance;	// IMP=0x00400000003745e0
- (void).cxx_destruct;	// IMP=0x0020000000375770
...
- (void)logState;	// IMP=0x00100000003755c0
- (id)publicDeviceIdentityContainerForDeviceID:(id)arg1;	// IMP=0x0010000000374f40
- (void)clearCache;	// IMP=0x0010000000374e50
- (void)dealloc;	// IMP=0x0010000000374df0
- (void)_removeOldPersistence;	// IMP=0x0010000000374d00
- (id)initWithPeerIDManager:(id)arg1 accountController:(id)arg2;	// IMP=0x0010000000374790
- (id)init;	// IMP=0x00100000003746d0
