...
- (void).cxx_destruct;	// IMP=0x0020000000594090
...
- (id)description;	// IMP=0x00100000005925d0
- (unsigned long long)requestLength;	// IMP=0x0010000000591e60
- (unsigned long long)_recipientDataSize;	// IMP=0x0010000000590a00
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000005909c0
- (_Bool)wantsAPSRetries;	// IMP=0x00100000005909a0
- (id)messageBody;	// IMP=0x001000000058f650
- (id)requiredKeys;	// IMP=0x001000000058f540
- (long long)responseCommand;	// IMP=0x001000000058f520
- (long long)command;	// IMP=0x001000000058f500
- (_Bool)wantsIntegerUniqueIDs;	// IMP=0x001000000058f4e0
- (_Bool)wantsBinaryPush;	// IMP=0x001000000058f4c0
- (_Bool)wantsCompressedBody;	// IMP=0x001000000058f4a0
- (_Bool)wantsHTTPHeaders;	// IMP=0x001000000058f480
- (_Bool)wantsBagKey;	// IMP=0x001000000058f460
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000058e6d0
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000582120
- (id)init:(id)arg1;	// IMP=0x0010000000581f00
