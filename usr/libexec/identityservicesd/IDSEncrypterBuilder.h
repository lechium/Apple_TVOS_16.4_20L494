...
+ (id)builderWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 serviceController:(id)arg7 avoidMainQueue:(_Bool)arg8 forceLegacy:(_Bool)arg9;	// IMP=0x00400000001642d0
- (void).cxx_destruct;	// IMP=0x0020000000165740
...
- (id)verifierWithEndpoint:(id)arg1 keyType:(unsigned int)arg2 keyDiversifier:(id)arg3;	// IMP=0x0010000000165340
- (id)verifierWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5 keyType:(unsigned int)arg6 keyDiversifier:(id)arg7;	// IMP=0x0010000000165050
- (id)signerWithKeyType:(unsigned int)arg1 keyDiversifier:(id)arg2 service:(id)arg3;	// IMP=0x0010000000164f10
- (id)encrypterWithOTRToken:(id)arg1;	// IMP=0x0010000000164e60
- (id)encrypterWithEndpoint:(id)arg1;	// IMP=0x0010000000164cf0
- (id)encrypterWithDeviceID:(id)arg1;	// IMP=0x0010000000164bd0
- (id)encrypterWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5;	// IMP=0x00100000001648a0
- (id)_createHashingDeviceIdentityEncrypter;	// IMP=0x0010000000164790
- (id)initWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 serviceController:(id)arg7 avoidMainQueue:(_Bool)arg8 forceLegacy:(_Bool)arg9;	// IMP=0x0010000000164520
