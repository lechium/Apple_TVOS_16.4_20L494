...
- (void).cxx_destruct;	// IMP=0x0020000000700510
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000700000
- (id)bagKey;	// IMP=0x00100000006fffe0
- (id)requiredKeys;	// IMP=0x00100000006fff80
- (id)messageBody;	// IMP=0x00100000006ff780
- (id)additionalMessageHeaders;	// IMP=0x00100000006ff2e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006fefd0
