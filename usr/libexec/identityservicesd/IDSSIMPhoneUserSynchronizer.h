...
- (void).cxx_destruct;	// IMP=0x0020000000373dd0
...
- (void)didUpdatePairedDevice:(id)arg1;	// IMP=0x0010000000373880
- (void)_checkRegistrationStatus;	// IMP=0x0010000000372c40
- (void)_setupForCurrentSubscriptionState;	// IMP=0x0010000000372c00
- (void)SIMInformationDidChange;	// IMP=0x0010000000372ab0
- (void)userStore:(id)arg1 didUpdateUser:(id)arg2;	// IMP=0x0010000000372a40
- (void)userStore:(id)arg1 didRemoveAuthenticationCertificateForUser:(id)arg2;	// IMP=0x00100000003729d0
- (void)userStore:(id)arg1 didAddAuthenticationCertificate:(id)arg2 forUser:(id)arg3;	// IMP=0x0010000000372940
- (void)userStore:(id)arg1 didAddUser:(id)arg2;	// IMP=0x00100000003728d0
- (void)userStore:(id)arg1 didRemoveUser:(id)arg2 withAuthenticationCertificate:(id)arg3;	// IMP=0x00100000003727e0
- (void)selectedSubscriptionLabelDidChange:(id)arg1;	// IMP=0x0010000000372660
- (id)updatedUserSetForRealm:(long long)arg1 currentUsers:(id)arg2;	// IMP=0x0010000000370600
- (void)forceRemoveUser:(id)arg1 silently:(_Bool)arg2;	// IMP=0x00100000003704f0
- (_Bool)_isInDualPhoneIdentityModeForSims:(id)arg1;	// IMP=0x001000000036ff80
- (void)verifyState;	// IMP=0x001000000036feb0
- (void)dealloc;	// IMP=0x001000000036fe50
- (id)initWithUserStore:(id)arg1 queue:(id)arg2 lockdownManager:(id)arg3 systemMonitor:(id)arg4 CTAdapter:(id)arg5 userConfiguration:(id)arg6 registrationController:(id)arg7 pairingManager:(id)arg8;	// IMP=0x001000000036fb30
