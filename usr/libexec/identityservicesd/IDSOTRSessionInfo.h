...
- (void).cxx_destruct;	// IMP=0x0020000000444de0
...
- (void)_negotiationTimerFiredOnMain;	// IMP=0x0010000000444b20
- (void)setNegotiationTimer;	// IMP=0x0010000000444840
- (void)_handleNegotiationTimeout;	// IMP=0x0010000000443f00
- (void)removeNegotiationTimer;	// IMP=0x0010000000443cc0
- (void)dealloc;	// IMP=0x0010000000443c50
- (id)initWithToken:(id)arg1;	// IMP=0x0010000000443b90
