...
@interface IDSIncomingMessageBroadcast : NSObject
{
    ...
    MISSING_TYPE *_messagePriority;	// 40 = 0x28
    NSString *_messageSenderID;	// 48 = 0x30
    unsigned int _messageSequenceNumber;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x002000000013d190
...
- (id)initWithBroadcastBlock:(CDUnknownBlockType)arg1 needsClientAck:(_Bool)arg2 messageUUID:(id)arg3 priority:(long long)arg4 senderID:(id)arg5 sequenceNumber:(unsigned int)arg6;	// IMP=0x001000000013ccf0
- (id)init;	// IMP=0x001000000013cc20
