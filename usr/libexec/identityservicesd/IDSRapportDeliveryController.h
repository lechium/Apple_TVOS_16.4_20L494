...
+ (id)sharedInstance;	// IMP=0x00200000001a0a00
- (void).cxx_destruct;	// IMP=0x00200000001a2520
...
- (void)rapportClient:(id)arg1 didReceiveMessage:(id)arg2 fromID:(id)arg3;	// IMP=0x00100000001a2170
- (unsigned int)_nextMessageID;	// IMP=0x00100000001a2150
- (void)sendMessage:(id)arg1 messageID:(id)arg2 topic:(id)arg3 command:(id)arg4 destinationIDs:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000001a0c90
- (void)dealloc;	// IMP=0x00100000001a0c30
- (id)init;	// IMP=0x00100000001a0ba0
- (id)initWithRapportClient:(id)arg1;	// IMP=0x00100000001a0ac0
