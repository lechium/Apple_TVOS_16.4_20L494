...
- (void).cxx_destruct;	// IMP=0x00100000006edc70
...
- (id)debugDescription;	// IMP=0x00100000006e95a0
- (id)description;	// IMP=0x00100000006e9020
- (id)_userStore;	// IMP=0x00100000006e8f80
- (id)_user;	// IMP=0x00100000006e8f00
- (void)voidPassword;	// IMP=0x00100000006e8b90
- (void)voidAuthenticationTokenAllowingGracePeriod;	// IMP=0x00100000006e8950
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000006e69c0
...
- (id)_userID;	// IMP=0x00100000006e43c0
@property(readonly, nonatomic) NSArray *confirmedEmails;
- (void)removeCandidateEmail:(id)arg1;	// IMP=0x00100000006e4240
- (void)addCandidateEmail:(id)arg1;	// IMP=0x00100000006e4120
@property(readonly, nonatomic) NSArray *candidateEmails;
- (_Bool)saveToKeychain;	// IMP=0x00100000006e40a0
- (_Bool)removeFromKeychain;	// IMP=0x00100000006e4040
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000006ddb60
- (id)init;	// IMP=0x00100000006ddad0
- (id)initWithPasswordManager:(id)arg1;	// IMP=0x00100000006dd9d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006dd9b0
- (id)_keychain_comparisonValue;	// IMP=0x001000000038c6b0
- (_Bool)_keychain_isEqual:(id)arg1;	// IMP=0x001000000038c450
