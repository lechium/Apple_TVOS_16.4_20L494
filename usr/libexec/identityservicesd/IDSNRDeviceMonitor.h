...
- (void).cxx_destruct;	// IMP=0x0020000000007a80
...
- (id)init;	// IMP=0x0010000000007970
- (id)initWithDeviceIdentifier:(id)arg1 delegate:(id)arg2 queue:(id)arg3;	// IMP=0x00100000000078d0
