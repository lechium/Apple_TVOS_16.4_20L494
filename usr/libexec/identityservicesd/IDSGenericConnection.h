...
- (void).cxx_destruct;	// IMP=0x00200000005ddf90
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x00100000005dc4e0
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x00100000005dbd70
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x00100000005dbb50
- (void)invalidate;	// IMP=0x00100000005db180
- (void)dealloc;	// IMP=0x00100000005db070
- (void)_closeSockets;	// IMP=0x00100000005da960
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x00100000005da510
- (id)flagsString;	// IMP=0x00100000005da410
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x00100000005da3f0
- (id)description;	// IMP=0x00100000005d9e80
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x00100000005d9a80
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x00100000005d9660
