...
- (void).cxx_destruct;	// IMP=0x002000000020c910
...
- (id)description;	// IMP=0x001000000020c7e0
- (id)initWithLocalFullIdentity:(id)arg1 remotePublicIdentity:(id)arg2;	// IMP=0x001000000020c6f0
