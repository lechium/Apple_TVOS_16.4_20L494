...
- (void).cxx_destruct;	// IMP=0x0020000000071880
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000000715b0
- (id)bagKey;	// IMP=0x0010000000071590
- (id)messageBody;	// IMP=0x0010000000071260
- (id)additionalMessageHeaders;	// IMP=0x0010000000070ee0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000070cc0
