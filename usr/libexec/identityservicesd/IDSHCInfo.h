...
- (void *)remoteContext;	// IMP=0x00100000002e9010
- (void *)localContext;	// IMP=0x00100000002e8ff0
- (void)setRemoteContext:(void *)arg1;	// IMP=0x00100000002e8df0
- (void)setLocalContext:(void *)arg1;	// IMP=0x00100000002e8bf0
- (void)invalidate;	// IMP=0x00100000002e8960
