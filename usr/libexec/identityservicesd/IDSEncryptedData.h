...
- (void).cxx_destruct;	// IMP=0x002000000017ffb0
...
- (id)description;	// IMP=0x001000000017fe90
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x001000000017fd80
