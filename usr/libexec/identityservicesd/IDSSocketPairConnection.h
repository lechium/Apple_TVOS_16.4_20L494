...
- (void).cxx_destruct;	// IMP=0x0020000000067520
...
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000066fb0
- (void)setNotifyWhenConnectionReceivesBytes:(_Bool)arg1;	// IMP=0x0010000000066f60
- (void)_endSession;	// IMP=0x0010000000066bc0
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x0010000000066710
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x00100000000666a0
- (void)_sendToConnectedSocket;	// IMP=0x0010000000065730
- (_Bool)_queueNextOutgoingData;	// IMP=0x0010000000064560
- (void)_processBytesAvailable;	// IMP=0x0010000000062fb0
- (_Bool)_processIncomingMessage:(id)arg1;	// IMP=0x0010000000061fc0
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0010000000061bc0
- (void)removePendingMessagesForProtectionClass:(unsigned int)arg1;	// IMP=0x00100000000612d0
- (long long)_read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x0010000000060de0
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000060c60
...
- (void)endSession;	// IMP=0x0010000000060180
- (void)dealloc;	// IMP=0x0010000000060070
- (void)start;	// IMP=0x001000000005fe00
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 connectionID:(id)arg5 linkType:(unsigned long long)arg6;	// IMP=0x001000000005f790
