...
+ (id)sharedInstance;	// IMP=0x00400000002025b0
- (void).cxx_destruct;	// IMP=0x0020000000204ba0
...
- (void)_notifyFamilyServicesOfUpdate;	// IMP=0x0010000000204250
- (void)_familyDidUpdate:(id)arg1;	// IMP=0x0010000000204030
- (void)forceFamilyFetch;	// IMP=0x0010000000203c70
- (_Bool)canForceFamilyFetch;	// IMP=0x0010000000203c30
- (id)initWithFamilyRequest:(id)arg1;	// IMP=0x0010000000203ae0
- (id)init;	// IMP=0x00100000002038d0
- (void)fetchFamilyWithFamilyRequest:(id)arg1;	// IMP=0x0010000000202920
- (id)handlesFromFamilyMember:(id)arg1;	// IMP=0x0010000000202670
