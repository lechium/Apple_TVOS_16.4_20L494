...
- (void).cxx_destruct;	// IMP=0x00200000005b7050
...
- (void)purgeData;	// IMP=0x00100000005b6cc0
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000005b6bb0
- (id)data;	// IMP=0x00100000005b6b10
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x00100000005b67b0
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x00100000005b66c0
