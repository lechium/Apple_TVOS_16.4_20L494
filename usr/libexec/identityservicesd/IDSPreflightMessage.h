...
- (void).cxx_destruct;	// IMP=0x0020000000019b80
...
- (void)setHardwareVersion:(id)arg1;	// IMP=0x00100000000197e0
- (id)hardwareVersion;	// IMP=0x00100000000197c0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000019270
- (_Bool)requiresPushTokenKeys;	// IMP=0x0010000000019250
- (id)bagKey;	// IMP=0x0010000000019230
- (id)requiredKeys;	// IMP=0x00100000000191d0
- (id)messageBody;	// IMP=0x00100000000186f0
- (id)additionalMessageHeaders;	// IMP=0x00100000000184a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000180f0
