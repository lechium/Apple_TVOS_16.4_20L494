...
- (id)initWithMPIdentityIdentifier:(id)arg1;	// IMP=0x001000000021db30
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x001000000021daa0
- (id)init;	// IMP=0x001000000021da40
