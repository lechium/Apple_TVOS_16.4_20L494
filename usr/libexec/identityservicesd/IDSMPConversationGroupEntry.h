...
+ (id)entryFromPublicDataRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x00400000001ba610
- (void).cxx_destruct;	// IMP=0x00200000001bb0c0
...
- (id)description;	// IMP=0x00100000001bad50
- (id)publicDataRepresentationWithError:(id *)arg1;	// IMP=0x00100000001ba9d0
- (id)initWithStableGroupID:(id)arg1 groupServerEntry:(id)arg2;	// IMP=0x00100000001ba3d0
