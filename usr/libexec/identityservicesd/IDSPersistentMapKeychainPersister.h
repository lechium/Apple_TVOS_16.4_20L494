...
- (void).cxx_destruct;	// IMP=0x00200000005b3e90
...
- (void)purgeData;	// IMP=0x00100000005b3c10
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000005b3800
- (id)data;	// IMP=0x00100000005b3460
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 keychainWrapper:(id)arg2 systemMonitor:(id)arg3;	// IMP=0x00100000005b32d0
