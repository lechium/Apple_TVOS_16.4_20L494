...
- (void).cxx_destruct;	// IMP=0x002000000043fba0
...
- (void)persistNumberOfPreflightAttempts:(unsigned int)arg1;	// IMP=0x001000000043f3a0
- (unsigned int)loadNumberOfPreflightAttempts;	// IMP=0x001000000043f370
- (void)persistNumberOfSuccessfulValidationSends:(unsigned int)arg1;	// IMP=0x001000000043f340
- (unsigned int)loadNumberOfSuccessfulValidationSends;	// IMP=0x001000000043f310
- (void)heartbeat;	// IMP=0x001000000043e880
- (void)removePhoneNumberValidationRequestor:(id)arg1;	// IMP=0x001000000043e630
- (id)identifyPhoneNumberForRequestor:(id)arg1 queue:(id)arg2;	// IMP=0x001000000043e520
- (void)addPhoneNumberValidationRequestor:(id)arg1;	// IMP=0x001000000043e390
- (void)removeListener:(id)arg1;	// IMP=0x001000000043e330
- (void)addListener:(id)arg1;	// IMP=0x001000000043e270
- (void)timedOutWaitingForSMS;	// IMP=0x001000000043dad0
- (void)resetSMSCounter;	// IMP=0x001000000043d8c0
- (void)handleIncomingSMSForResponse:(id)arg1;	// IMP=0x001000000043c8b0
- (void)handleRegistrationSMSSuccessfullyDeliveredWithTelephonyTimeout:(id)arg1;	// IMP=0x001000000043bf60
- (void)handleRegistrationSMSDeliveryFailedWithShouldBypassRetry:(_Bool)arg1;	// IMP=0x001000000043b450
- (void)handleRegistrationSMSDeliveryFailed;	// IMP=0x001000000043b420
- (void)_requestUserConsentForPhoneNumberValidationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000043b2c0
- (void)_tryToSendSMSIdentification;	// IMP=0x0010000000439a30
- (void)_sendPreflightVerificationWithIMSI:(id)arg1 PLMN:(id)arg2;	// IMP=0x0010000000438b80
- (void)_performHighestPriorityPreflightVerification;	// IMP=0x0010000000438b20
- (void)_popHighestPriorityPreflightVerification;	// IMP=0x0010000000438a50
- (id)_getHighestPriorityMechanism;	// IMP=0x0010000000438960
- (void)_sendPreflightVerificationIfNeeded;	// IMP=0x0010000000438630
- (void)_issueAsyncCoreTelephonyPhoneNumberValidationRequestWithPushToken:(id)arg1 mechanism:(id)arg2;	// IMP=0x00100000004385c0
- (void)_sendSMSVerificationWithMechanism:(id)arg1;	// IMP=0x0010000000438000
- (void)_lastSendSMSTimerFiredOnMain;	// IMP=0x0010000000437f30
- (void)_setSMSDeliveryTimeout:(double)arg1;	// IMP=0x0010000000437cf0
- (_Bool)_canDeliverSMSNow;	// IMP=0x0010000000437cd0
- (void)_smsDeliveryClear;	// IMP=0x0010000000437a70
- (void)_clearSMSDeliveryTimeout;	// IMP=0x0010000000437a30
- (void)_keychainMigrationComplete:(id)arg1;	// IMP=0x00100000004378d0
- (void)_SIMSetupDidComplete;	// IMP=0x00100000004377f0
- (void)systemRestoreStateDidChange;	// IMP=0x0010000000437700
- (void)systemDidStopBackup;	// IMP=0x0010000000437610
- (void)systemDidFinishMigration;	// IMP=0x0010000000437420
- (void)PNRResponseReceivedWithResponseData:(id)arg1;	// IMP=0x0010000000436dd0
- (void)PNRRequestSentWithRequestData:(id)arg1;	// IMP=0x00100000004368e0
- (void)PNRReadyStateChanged:(_Bool)arg1;	// IMP=0x0010000000436730
- (void)_deviceIDChangedNotification:(id)arg1;	// IMP=0x0010000000436560
- (void)_registerForLockdownNotifications;	// IMP=0x0010000000436420
- (void)_lockdownStateChanged:(id)arg1;	// IMP=0x0010000000436210
- (_Bool)_validSIMStateForRegistration;	// IMP=0x00100000004360f0
- (_Bool)_deviceCanRegisterPresently;	// IMP=0x0010000000435e70
- (long long)_errorCodeForRegistrationError:(long long)arg1;	// IMP=0x0010000000435d90
- (void)_failPromisesWithError:(long long)arg1;	// IMP=0x0010000000435b10
- (void)_fulfillPromisesWithPhoneNumber:(id)arg1 token:(id)arg2;	// IMP=0x0010000000435850
- (void)_notifySuccess:(id)arg1;	// IMP=0x0010000000434980
- (void)_notifyFailureWithError:(long long)arg1;	// IMP=0x0010000000433bd0
- (_Bool)_isAwaitingUserSelectionDuringSetup;	// IMP=0x0010000000433bb0
- (_Bool)_isUserSubscriptionSelectionStillPending;	// IMP=0x0010000000433960
- (_Bool)_userHasDisabledSMSRegistration;	// IMP=0x0010000000433940
- (long long)_registrationControlStatus;	// IMP=0x00100000004338e0
@property(copy, nonatomic) IDSPreflightStack *currentPreflightStack;
- (void)_registerForDeviceCenterNotifications;	// IMP=0x0010000000433700
- (void)dealloc;	// IMP=0x00100000004336b0
- (void)invalidate;	// IMP=0x0010000000433570
- (id)initWithCTPNR:(id)arg1 preflightStackStore:(id)arg2;	// IMP=0x0010000000433300
- (id)initWithCTPNR:(id)arg1 preflightStackStore:(id)arg2 HTTPDelivery:(id)arg3 pushHandler:(id)arg4 lockdownManager:(id)arg5 systemMonitor:(id)arg6 arbiter:(id)arg7 systemAccountAdapter:(id)arg8;	// IMP=0x0010000000432af0
- (void)_cancelScheduledSMSTimeout;	// IMP=0x0010000000432a50
- (void)_scheduleSMSTimeout:(double)arg1;	// IMP=0x0010000000432870
- (void)_cancelScheduledHeartbeat;	// IMP=0x00100000004327d0
- (void)_scheduleHeartbeat:(double)arg1;	// IMP=0x0010000000432570
@property(readonly, copy) NSString *description;
- (_Bool)_isPhoneNumberIdentificationSupported;	// IMP=0x0010000000432300
