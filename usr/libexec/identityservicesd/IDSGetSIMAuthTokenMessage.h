...
- (void).cxx_destruct;	// IMP=0x00200000007319f0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000731570
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x0010000000731550
- (id)bagKey;	// IMP=0x0010000000731530
- (id)requiredKeys;	// IMP=0x00100000007314d0
- (id)messageBody;	// IMP=0x0010000000730d40
- (id)additionalMessageHeaders;	// IMP=0x0010000000730af0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000007307e0
