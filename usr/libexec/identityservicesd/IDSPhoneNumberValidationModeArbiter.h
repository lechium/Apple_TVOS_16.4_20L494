...
- (void).cxx_destruct;	// IMP=0x00200000004bbab0
...
- (_Bool)isPrefightEnabledByServerBag;	// IMP=0x00100000004bb240
...
- (id)initWithServerBag:(id)arg1;	// IMP=0x00100000004bad80
- (id)init;	// IMP=0x00100000004bacf0
