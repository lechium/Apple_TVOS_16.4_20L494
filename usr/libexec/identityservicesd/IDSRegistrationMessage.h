...
- (void).cxx_destruct;	// IMP=0x0020000000383bf0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000383550
- (double)anisetteHeadersTimeout;	// IMP=0x0010000000383530
- (id)nonStandardMessageHeadersForOutgoingPush;	// IMP=0x0010000000383520
- (id)messageBody;	// IMP=0x0010000000382ab0
- (id)requiredKeys;	// IMP=0x00100000003829d0
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x00100000003829b0
- (id)bagKey;	// IMP=0x0010000000382990
- (_Bool)requiresPushTokenKeys;	// IMP=0x0010000000382970
- (_Bool)hasRequiredKeys:(id *)arg1;	// IMP=0x0010000000382890
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000382490
