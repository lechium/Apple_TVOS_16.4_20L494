...
- (void).cxx_destruct;	// IMP=0x00200000007261d0
...
- (void)_sendDataViaNWConnection:(id)arg1 isLargeTransfer:(_Bool)arg2;	// IMP=0x0010000000725650
@property(readonly, nonatomic) NSSet *inFlightMessages;
- (void)_dequeueNextMessageFromOutgoingQueue;	// IMP=0x0010000000724f10
- (double)lastSocketActivityTime;	// IMP=0x0010000000724ef0
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x0010000000724710
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x00100000007246a0
- (void)_processIncomingRawMessage:(id)arg1;	// IMP=0x00100000007231c0
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0010000000723160
- (void)_receiveFromNWConnection:(id)arg1;	// IMP=0x00100000007221b0
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000007220f0
- (void)_notifyDelegateAboutClosedConnection;	// IMP=0x0010000000722050
- (void)endSession;	// IMP=0x0010000000721d50
- (void)dealloc;	// IMP=0x0010000000721c40
- (void)start;	// IMP=0x0010000000720a50
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 identifier:(id)arg5;	// IMP=0x0010000000720770
