...
- (void).cxx_destruct;	// IMP=0x00200000004dff80
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000004dfb80
- (id)bagKey;	// IMP=0x00100000004dfb60
- (id)messageBody;	// IMP=0x00100000004df890
- (id)additionalMessageHeaders;	// IMP=0x00100000004df510
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004df2a0
