...
- (void).cxx_destruct;	// IMP=0x0020000000447190
...
- (id)dictionaryMetric;	// IMP=0x0010000000446d10
- (void)reportMetric;	// IMP=0x0010000000446ae0
- (void)endCollector;	// IMP=0x0010000000446a70
- (void)incrementMessageCount;	// IMP=0x0010000000446a20
- (id)awdLogger;	// IMP=0x00100000004469f0
- (id)initWithTopic:(id)arg1 isPrimary:(_Bool)arg2;	// IMP=0x00100000004468c0
