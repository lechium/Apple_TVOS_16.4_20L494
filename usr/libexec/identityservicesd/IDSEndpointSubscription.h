...
- (void).cxx_destruct;	// IMP=0x0020000000016ab0
...
- (void)_signalDidUpdateEndpoints;	// IMP=0x0010000000016890
- (void)_noteSourceDidDiscoverEndpointMap:(id)arg1 forLocalURI:(id)arg2;	// IMP=0x00100000000162d0
- (void)_registerEndpointQueryCompletionBlock;	// IMP=0x0010000000015f90
- (id)resolvedEndpoints;	// IMP=0x0010000000015cd0
- (void)initializeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000155e0
- (id)peerIDManager;	// IMP=0x00100000000155b0
- (id)description;	// IMP=0x00100000000154a0
- (void)dealloc;	// IMP=0x0010000000015420
- (id)initWithServiceIdentifier:(id)arg1 localURI:(id)arg2 subscribedURIs:(id)arg3 queue:(id)arg4;	// IMP=0x0010000000015270
