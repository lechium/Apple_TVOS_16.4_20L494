...
- (void).cxx_destruct;	// IMP=0x002000000020e170
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000020d930
- (id)additionalMessageHeaders;	// IMP=0x001000000020d560
- (id)messageBody;	// IMP=0x001000000020cf10
- (id)requiredKeys;	// IMP=0x001000000020ce70
- (id)bagKey;	// IMP=0x001000000020ce50
- (long long)responseCommand;	// IMP=0x001000000020ce30
- (long long)command;	// IMP=0x001000000020ce10
- (_Bool)wantsBinaryPush;	// IMP=0x001000000020cdf0
- (_Bool)wantsCompressedBody;	// IMP=0x001000000020cdd0
- (_Bool)wantsHTTPHeaders;	// IMP=0x001000000020cdb0
- (_Bool)wantsBagKey;	// IMP=0x001000000020cd90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000020cb80
- (void)addPhoneAuthenticationCertificate:(id)arg1 withUserID:(id)arg2;	// IMP=0x001000000020ca80
- (id)init;	// IMP=0x001000000020c950
