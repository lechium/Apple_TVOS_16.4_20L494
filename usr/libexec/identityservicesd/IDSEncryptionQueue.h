...
- (void).cxx_destruct;	// IMP=0x00200000001f9990
...
- (void)performSyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001f9860
- (void)performAsyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001f97f0
- (id)initWithName:(char *)arg1 qosClass:(unsigned int)arg2 specific:(char *)arg3;	// IMP=0x00100000001f9640
