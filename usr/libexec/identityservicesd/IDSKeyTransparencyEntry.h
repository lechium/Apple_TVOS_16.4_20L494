...
@interface IDSKeyTransparencyEntry : NSObject
{
    ...
    MISSING_TYPE *_transparencyVersion;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x002000000073da30
...
- (id)description;	// IMP=0x001000000073d660
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000073d640
- (unsigned long long)hash;	// IMP=0x001000000073d560
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000073d4c0
- (_Bool)isEqualToKeyTransparencyEntry:(id)arg1;	// IMP=0x001000000073cfd0
- (id)initWithPushToken:(id)arg1 loggableData:(id)arg2 signedData:(id)arg3;	// IMP=0x001000000073cea0
