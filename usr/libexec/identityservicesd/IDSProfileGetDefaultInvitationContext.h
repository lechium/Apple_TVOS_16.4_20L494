...
- (void).cxx_destruct;	// IMP=0x002000000007aec0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000007ab30
- (double)anisetteHeadersTimeout;	// IMP=0x001000000007ab10
- (id)messageBody;	// IMP=0x001000000007aab0
- (id)requiredKeys;	// IMP=0x001000000007aa50
- (id)bagKey;	// IMP=0x001000000007aa30
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007a8c0
- (id)init;	// IMP=0x001000000007a820
