...
- (void).cxx_destruct;	// IMP=0x0020000000164250
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000163fd0
- (id)additionalMessageHeaders;	// IMP=0x0010000000163990
- (id)additionalMessageHeadersForOutgoingPush;	// IMP=0x00100000001631e0
- (_Bool)hasRequiredKeys:(id *)arg1;	// IMP=0x0010000000163050
- (long long)responseCommand;	// IMP=0x0010000000163030
- (long long)command;	// IMP=0x0010000000163010
- (_Bool)wantsBinaryPush;	// IMP=0x0010000000162ff0
- (_Bool)wantsCompressedBody;	// IMP=0x0010000000162fd0
- (_Bool)wantsHTTPHeaders;	// IMP=0x0010000000162fb0
- (_Bool)wantsBagKey;	// IMP=0x0010000000162f90
- (void)dealloc;	// IMP=0x0010000000162db0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000162bc0
- (id)init;	// IMP=0x0010000000162a70
