...
+ (long long)phaseForExpirationDate:(id)arg1;	// IMP=0x0040000000180340
- (void).cxx_destruct;	// IMP=0x0020000000180420
...
- (id)initWithUser:(id)arg1 expirationPhase:(long long)arg2;	// IMP=0x00100000001800d0
- (id)initWithUser:(id)arg1;	// IMP=0x001000000017fff0
