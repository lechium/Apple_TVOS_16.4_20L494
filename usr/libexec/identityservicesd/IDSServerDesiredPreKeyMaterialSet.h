...
- (void).cxx_destruct;	// IMP=0x0020000000726950
...
- (id)materialDataByID;	// IMP=0x0010000000726650
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000726570
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long forParticipantID;
- (id)initWithUUID:(id)arg1 publicPreKeyData:(id)arg2 wrapMode:(long long)arg3 creationDate:(id)arg4;	// IMP=0x0010000000726360
- (id)initWithPublicPreKeyData:(id)arg1 wrapMode:(long long)arg2 creationDate:(id)arg3;	// IMP=0x0010000000726270
