...
+ (int)queryRetryNumberForBadSignature;	// IMP=0x002000000061c1a0
+ (double)queryRetryIntervalForBadSignature;	// IMP=0x001000000061c0d0
+ (_Bool)isQueryRetryForBadSignatureEnabled;	// IMP=0x001000000061c010
+ (int)serverBackoffModeReceiverRetryInterval;	// IMP=0x001000000061bec0
+ (int)serverBackoffModeMaxSenderRetries;	// IMP=0x001000000061bd70
+ (_Bool)isServerBackoffModeActive;	// IMP=0x001000000061bcd0
+ (_Bool)shouldUseSelfTokens;	// IMP=0x001000000061bc00
- (void).cxx_destruct;	// IMP=0x002000000062aad0
...
- (void)removeCompletionBlockForToken:(id)arg1;	// IMP=0x001000000062a590
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forToken:(id)arg2;	// IMP=0x001000000062a0c0
- (_Bool)startQueryForURIs:(id)arg1 fromIdentity:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x0010000000629eb0
- (void)_dequeuePendingQueryIfPossible;	// IMP=0x001000000061ec20
- (void)_startQueryForURIs:(id)arg1 fromIdentity:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x001000000061de60
- (void)_removeCompletionBlocksForURIs:(id)arg1 fromURI:(id)arg2 fromService:(id)arg3 forRefresh:(_Bool)arg4;	// IMP=0x001000000061d960
- (id)_completionBlocksForURIs:(id)arg1 fromURI:(id)arg2 fromService:(id)arg3 forRefresh:(_Bool)arg4;	// IMP=0x001000000061d7a0
- (_Bool)_addCompletionBlock:(CDUnknownBlockType)arg1 forURIs:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5;	// IMP=0x001000000061c990
- (void)_bagLoaded:(id)arg1;	// IMP=0x001000000061c6c0
- (void)dealloc;	// IMP=0x001000000061c620
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2 dualMessageDelivery:(id)arg3 networkChangeNotifier:(id)arg4 pushHandler:(id)arg5;	// IMP=0x001000000061c3e0
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2;	// IMP=0x001000000061c260
