...
- (void).cxx_destruct;	// IMP=0x00200000002a8040
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forSession:(id)arg2;	// IMP=0x00100000002a7ca0
- (void)addSession:(id)arg1;	// IMP=0x00100000002a7c20
- (void)addServiceType:(id)arg1;	// IMP=0x00100000002a7bc0
- (void)addAlias:(id)arg1;	// IMP=0x00100000002a7b50
- (id)init;	// IMP=0x00100000002a7a40
