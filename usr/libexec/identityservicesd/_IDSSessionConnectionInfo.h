...
@class MISSING_TYPE, NSData, NSDictionary, NSMutableArray, NSNumber, NSString;
...
@interface _IDSSessionConnectionInfo : NSObject
{
    ...
    MISSING_TYPE *_localCallInfoData;	// 168 = 0xa8
    NSData *_remoteCallInfoData;	// 176 = 0xb0
}

- (void).cxx_destruct;	// IMP=0x00200000004584f0
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x0010000000457aa0
- (void)_addRemotePacketOutage;	// IMP=0x00100000004579f0
- (id)description;	// IMP=0x00100000004578e0
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x00100000004571f0
