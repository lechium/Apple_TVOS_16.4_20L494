...
+ (id)sharedInstance;	// IMP=0x00400000000748f0
...
- (void)_initializePluginWithClass:(Class)arg1;	// IMP=0x0010000000075a60
- (void)_initializePlugin;	// IMP=0x00100000000756c0
- (void)executeSynchronouslyOnCallbackQueue:(CDUnknownBlockType)arg1;	// IMP=0x00100000000755e0
- (void)initializePluginWithClass:(Class)arg1;	// IMP=0x0010000000075510
- (void)notifyWatchToStopAdvertising;	// IMP=0x0010000000075200
- (void)notifyWatchDidStopAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x0010000000075010
- (void)notifyWatchToStartAdvertising;	// IMP=0x0010000000074d00
- (void)notifyWatchDidStartAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x0010000000074b50
- (id)init;	// IMP=0x00100000000749b0
