...
- (void).cxx_destruct;	// IMP=0x00200000005b9f30
...
- (id)description;	// IMP=0x00100000005b9630
- (_Bool)overrideSendOnePerTokenForService:(id)arg1;	// IMP=0x00100000005b95a0
- (id)initWithInfo:(id)arg1 uris:(id)arg2 service:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x00100000005b8e80
