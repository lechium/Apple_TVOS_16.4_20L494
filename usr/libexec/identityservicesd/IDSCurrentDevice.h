...
+ (id)sharedInstance;	// IMP=0x00400000005312f0
- (void).cxx_destruct;	// IMP=0x0020000000531a30
- (void)regenerateDeviceIdentifier;	// IMP=0x0010000000531890
@property(readonly, retain, nonatomic) NSString *deviceIdentifier;
- (id)_deviceIdentifierKeychainID;	// IMP=0x0010000000531590
...
- (id)init;	// IMP=0x00100000005313b0
