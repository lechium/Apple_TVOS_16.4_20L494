...
- (void).cxx_destruct;	// IMP=0x002000000044e100
...
- (_Bool)wantsBinaryPush;	// IMP=0x001000000044e030
- (id)messageBody;	// IMP=0x001000000044de30
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000044dd70
- (id)initWithPayload:(id)arg1 command:(id)arg2;	// IMP=0x001000000044dc40
