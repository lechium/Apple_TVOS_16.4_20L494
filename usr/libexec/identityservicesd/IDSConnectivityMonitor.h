...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x0010000000201440
- (void)sendMonitorMessage;	// IMP=0x0010000000200af0
- (void)checkConnectivityState:(id)arg1;	// IMP=0x00100000002006d0
- (id)init;	// IMP=0x0010000000200640
