...
- (void).cxx_destruct;	// IMP=0x0020000000739140
...
- (void)injectFakePacket:(CDStruct_dc2926a3 *)arg1;	// IMP=0x0010000000738d90
- (void)suspendLink:(_Bool)arg1;	// IMP=0x0010000000738970
- (_Bool)isLinkSuspended;	// IMP=0x0010000000738950
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x00100000007384f0
- (void)_processOutgoingPacket;	// IMP=0x0010000000737b20
- (void)_processIncomingPacket;	// IMP=0x0010000000734d40
- (long long)_readFromDataChannel:(void *)arg1 size:(unsigned long long)arg2 withFlags:(int)arg3 isSynced:(_Bool *)arg4;	// IMP=0x0010000000734d10
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000007347e0
- (void)flushBuffer:(unsigned long long)arg1;	// IMP=0x0010000000734770
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x00100000007346f0
- (unsigned long long)sendPacketBuffer:(CDStruct_dc2926a3 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x0010000000733eb0
- (void)invalidate;	// IMP=0x0010000000733e60
- (void)remoteDetectedCorruption;	// IMP=0x0010000000733c90
- (void)start;	// IMP=0x0010000000733b20
- (void)triggerBTCorruptionRecovery;	// IMP=0x0010000000733af0
- (void)_submitMagnetCorruptionMetricsToAWD;	// IMP=0x0010000000733770
- (void)_resetMagnetCorruptionMetrics;	// IMP=0x0010000000733730
- (void)_dumpLogs:(double)arg1 isDownstream:(_Bool)arg2;	// IMP=0x0010000000732df0
- (void)_localDetectedCorruption;	// IMP=0x0010000000732c60
- (void)dealloc;	// IMP=0x0010000000732940
- (id)initWithPipe:(id)arg1 useSkywalkChannel:(_Bool)arg2 withDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x0010000000731c80
- (id)copyLinkStatsDict;	// IMP=0x0010000000731b20
