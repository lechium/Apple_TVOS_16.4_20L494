...
- (id)socketPairMessage;	// IMP=0x00100000002e5370
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x00100000002e5310
- (void)kickProgressBlock;	// IMP=0x00100000002e5160
- (id)init;	// IMP=0x00100000002e4ed0
