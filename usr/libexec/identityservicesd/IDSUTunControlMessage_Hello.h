...
- (void).cxx_destruct;	// IMP=0x00200000001a87d0
...
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2 loggingPrefixString:(id)arg3;	// IMP=0x00100000001a5250
- (id)data;	// IMP=0x00100000001a43b0
- (id)init;	// IMP=0x00100000001a4340
- (_Bool)_isTinkerFlagSet;	// IMP=0x00100000001a42c0
- (_Bool)_isSupportIPsecLinkFlagSet;	// IMP=0x00100000001a4240
- (id)description;	// IMP=0x00100000001a40a0
