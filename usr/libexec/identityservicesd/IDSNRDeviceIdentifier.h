...
+ (id)newDeviceIdentifierWithBluetoothUUID:(id)arg1;	// IMP=0x0020000000006fc0
- (void).cxx_destruct;	// IMP=0x0020000000007030
@property(readonly, nonatomic) NSUUID *nrDeviceIdentifier; // @synthesize nrDeviceIdentifier=_nrDeviceIdentifier;
- (id)initWithUUID:(id)arg1;	// IMP=0x0010000000006f70
