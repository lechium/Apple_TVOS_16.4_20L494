...
- (void).cxx_destruct;	// IMP=0x0020000000096740
...
- (void)copyOpportunisticCacheWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000962a0
- (id)initWithQueue:(id)arg1 connection:(id)arg2 opportunisticCache:(id)arg3;	// IMP=0x0010000000096180
