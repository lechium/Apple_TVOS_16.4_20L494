...
- (void).cxx_destruct;	// IMP=0x00200000005a1b60
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x00100000005a04f0
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x00100000005a0420
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x00100000005a03b0
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x001000000059fc30
- (_Bool)supportsReinitiate;	// IMP=0x001000000059fb30
- (void)_endSessionTimedOut;	// IMP=0x001000000059f9d0
- (void)_endSessionTimerFiredOnMain;	// IMP=0x001000000059f900
- (void)setEndSessionTimeoutTimer;	// IMP=0x001000000059f690
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x001000000059f4a0
- (void)_clearPacketLossTimer;	// IMP=0x001000000059f320
- (void)_connectionTimedOut;	// IMP=0x001000000059f1d0
- (void)_connectionTimerFiredOnMain;	// IMP=0x001000000059f100
- (void)setConnectionTimer;	// IMP=0x001000000059ec90
- (void)_clearConnectionTimer;	// IMP=0x001000000059eaa0
- (void)_clearInvitationTimer;	// IMP=0x001000000059e8b0
- (void)_inviteTimedOut;	// IMP=0x001000000059e6f0
- (void)_inviteTimerFiredOnMain;	// IMP=0x001000000059e620
- (void)setInvitationTimer;	// IMP=0x001000000059e3a0
- (void)clearAllTimers;	// IMP=0x001000000059e340
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x001000000059ba50
