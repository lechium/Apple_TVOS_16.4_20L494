...
- (void).cxx_destruct;	// IMP=0x002000000000494d
...
- (void)layoutSubviews;	// IMP=0x0010000000004724
- (id)initWithMatchingView:(id)arg1 image:(id)arg2 bottom:(_Bool)arg3;	// IMP=0x00100000000045ce
