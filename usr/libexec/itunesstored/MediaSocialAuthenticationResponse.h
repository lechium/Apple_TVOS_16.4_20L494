...
- (void).cxx_destruct;	// IMP=0x00200000000d6792
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d669e
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00100000000d6644
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00000000000d65ea
- (id)init;	// IMP=0x00100000000d6575
