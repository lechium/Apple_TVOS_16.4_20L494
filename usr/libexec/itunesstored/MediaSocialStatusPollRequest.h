...
- (void).cxx_destruct;	// IMP=0x0020000000027179
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002702d
- (unsigned long long)hash;	// IMP=0x0010000000027017
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000026f50
