...
+ (id)_unrecoverableErrors;	// IMP=0x0020000000141455
- (void).cxx_destruct;	// IMP=0x00200000001415a3
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x00100000001413d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000141320
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x0010000000140ef1
