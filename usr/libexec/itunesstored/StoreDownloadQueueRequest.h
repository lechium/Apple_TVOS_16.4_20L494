...
+ (void)initialize;	// IMP=0x00200000000b4242
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b41a7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b407d
- (unsigned long long)hash;	// IMP=0x00100000000b4067
- (id)description;	// IMP=0x00100000000b4007
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00100000000b3f54
