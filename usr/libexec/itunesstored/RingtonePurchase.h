...
+ (id)entityFromContext:(id)arg1;	// IMP=0x0040000000067b99
- (void)_assignToContact:(id)arg1 inContactStore:(id)arg2 withSoundIdentifier:(id)arg3;	// IMP=0x0020000000067f8b
- (void)_assignToPersonWithID:(int)arg1 withIdentifier:(id)arg2;	// IMP=0x0010000000067f17
- (void)_assignToContactWithID:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0010000000067e27
- (void)loadFromPurchase:(id)arg1;	// IMP=0x0010000000067d17
- (void)applyUserActionWithToneIdentifier:(id)arg1;	// IMP=0x0010000000067be6
