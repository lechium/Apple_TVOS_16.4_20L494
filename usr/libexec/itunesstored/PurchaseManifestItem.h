...
- (void)_setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00100000000105e8
...
- (void)dealloc;	// IMP=0x001000000001049f
- (id)initWithManifestItemDictionary:(id)arg1;	// IMP=0x0010000000010448
- (id)init;	// IMP=0x00100000000103fc
