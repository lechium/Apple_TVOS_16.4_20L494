...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000176d94
- (void)dealloc;	// IMP=0x0010000000176d4a
- (id)initWithPolicyIdentifiers:(id)arg1;	// IMP=0x0010000000176cf3
