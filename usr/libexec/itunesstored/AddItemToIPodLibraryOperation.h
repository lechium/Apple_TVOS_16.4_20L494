...
- (void)_setInsertedItemPersistentIdentifier:(long long)arg1;	// IMP=0x002000000009eb6a
- (id)_libraryItem;	// IMP=0x001000000009eb15
- (void)run;	// IMP=0x001000000009e920
@property(readonly) NSNumber *insertedItemPersistentIdentifier;
@property(readonly) IPodLibraryItem *IPodLibraryItem;
- (void)dealloc;	// IMP=0x001000000009e81a
- (id)initWithIPodLibraryItem:(id)arg1;	// IMP=0x001000000009e7bc
