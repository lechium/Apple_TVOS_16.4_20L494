...
- (void).cxx_destruct;	// IMP=0x002000000006750e
- (void)_runForIdentity:(id)arg1;	// IMP=0x0010000000066ab7
- (id)_newFetchOperationForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3;	// IMP=0x0010000000066530
- (id)_copyResponseForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3 returningError:(id *)arg4;	// IMP=0x0010000000066302
- (void)run;	// IMP=0x0010000000065f13
