...
- (_Bool)_ntsLoadFromPropertyList:(id)arg1;	// IMP=0x00200000000465dd
- (id)_dsidFromDictionary:(id)arg1;	// IMP=0x0010000000046538
- (id)_copyPaymentsFromDictionary:(id)arg1;	// IMP=0x00100000000462cb
- (id)_copyAppReceiptFromDictionary:(id)arg1;	// IMP=0x0010000000046279
@property(copy) NSNumber *userIdentifier;
@property _Bool shouldTriggerQueueCheck;
- (void)setRangesToLoad:(id)arg1;	// IMP=0x00100000000460f5
...
- (_Bool)loadFromPropertyList:(id)arg1;	// IMP=0x0010000000045e8c
- (void)appendResponse:(id)arg1;	// IMP=0x0010000000045b73
- (void)dealloc;	// IMP=0x0010000000045b14
- (id)initWithRequestType:(long long)arg1;	// IMP=0x0010000000045ad7
