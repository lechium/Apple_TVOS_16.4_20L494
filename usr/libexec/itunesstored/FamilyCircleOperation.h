...
- (void)_writeCacheWithFamilyCircle:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x00100000000117fd
- (id)_familyCircleForDictionary:(id)arg1;	// IMP=0x0010000000010e95
- (id)_cachePath;	// IMP=0x0010000000010e09
- (id)_cachedFamilyCircleWithAccountIdentifier:(id)arg1;	// IMP=0x0010000000010c1b
- (void)run;	// IMP=0x0010000000010684
- (void)dealloc;	// IMP=0x001000000001061e
