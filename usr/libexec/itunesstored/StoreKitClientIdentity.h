...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x0020000000198715
+ (void)initialize;	// IMP=0x00100000001986e7
...
- (id)description;	// IMP=0x0010000000198e7d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000198d83
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x0010000000198b15
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x001000000019896a
- (void)dealloc;	// IMP=0x00100000001988fd
