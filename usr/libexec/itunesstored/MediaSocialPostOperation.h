...
- (void).cxx_destruct;	// IMP=0x002000000018c54f
@property(nonatomic) long long postID; // @synthesize postID=_postID;
- (id)_targetDictionaryWithContentItem:(id)arg1;	// IMP=0x001000000018c458
- (id)_requestBodyDictionary;	// IMP=0x001000000018bcd3
- (id)_externalServiceDictionaryWithDestination:(id)arg1;	// IMP=0x001000000018bb10
- (id)_attachmentDictionaryWithAttachment:(id)arg1;	// IMP=0x001000000018b4fa
- (void)run;	// IMP=0x001000000018a65a
@property(copy) NSString *userAgent;
@property(copy) CDUnknownBlockType resultBlock;
- (id)initWithPostEntity:(id)arg1;	// IMP=0x001000000018a0c6
- (id)initWithPostDescription:(id)arg1;	// IMP=0x0010000000189f40
