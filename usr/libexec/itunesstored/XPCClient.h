...
- (void).cxx_destruct;	// IMP=0x00200000000a4f49
@property(readonly) NSData *auditTokenData; // @synthesize auditTokenData=_auditTokenData;
- (_Bool)_isAdHocCodeSigned;	// IMP=0x00100000000a4f1d
- (_Bool)_isBetaApp;	// IMP=0x00100000000a4f05
- (_Bool)_isNewsstandApp;	// IMP=0x00100000000a4e66
- (void)_invalidateBackgroundTaskAssertion:(id)arg1;	// IMP=0x00100000000a4aaa
- (void)_handleOutputConnectionDisconnect;	// IMP=0x00100000000a497e
@property(readonly, nonatomic) long long _clientType;
@property(readonly, nonatomic) unsigned int _applicationState;
- (id)_applicationBackgroundModes;	// IMP=0x00100000000a4728
- (void)_applicationStateChanged:(id)arg1;	// IMP=0x00100000000a4310
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000a4288
- (unsigned long long)hash;	// IMP=0x00100000000a4272
- (id)description;	// IMP=0x00100000000a41ec
- (id)valueForEntitlement:(id)arg1;	// IMP=0x00100000000a41d6
@property(readonly) NSString *userAgent;
- (void)setOutputConnectionWithConnection:(id)arg1;	// IMP=0x00100000000a3ff3
- (void)sendCoalescedMessageWithIdentifier:(unsigned long long)arg1;	// IMP=0x00100000000a3e35
@property(readonly) int processIdentifier;
@property(readonly) SSXPCConnection *outputConnection;
- (void)loadSpringBoardStateWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000a3c35
...
- (void)endBackgroundTaskWithIdentifier:(id)arg1;	// IMP=0x00100000000a3668
- (id)copyInputConnection;	// IMP=0x00100000000a3595
- (id)copyApplicationBackgroundModes;	// IMP=0x00100000000a347d
...
- (id)beginBackgroundTaskWithReason:(unsigned int)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000000a2d91
@property(readonly) unsigned int applicationState;
- (void)dealloc;	// IMP=0x00100000000a2a24
- (id)initWithApplicationIdentifier:(id)arg1 isAppleSigned:(_Bool)arg2;	// IMP=0x00100000000a299e
- (id)initWithInputConnection:(id)arg1;	// IMP=0x00100000000a2443
- (id)init;	// IMP=0x00100000000a242f
- (id)_initCommon;	// IMP=0x00100000000a23c2
