...
- (void).cxx_destruct;	// IMP=0x00200000001cd9c4
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00100000001cd898
- (id)description;	// IMP=0x00100000001cd781
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x00100000001cd678
