...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x0040000000062e13
...
- (id)copyProduct;	// IMP=0x0010000000062a42
- (void)dealloc;	// IMP=0x00100000000629c0
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000622ff
