...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x00200000000139a0
- (void).cxx_destruct;	// IMP=0x0020000000013ed3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000013d07
- (id)copyXPCEncoding;	// IMP=0x0010000000013c4a
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0010000000013a3e
