...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x001000000018f24c
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x001000000018f225
- (void)dealloc;	// IMP=0x001000000018f1cd
