...
- (void).cxx_destruct;	// IMP=0x00200000001ca003
@property(nonatomic) __weak id <MediaSocialStatusPollingDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_finishRequests:(id)arg1 withResponses:(id)arg2;	// IMP=0x00100000001c9949
- (void)_addBackgroundTaskJob;	// IMP=0x00100000001c9943
- (void)_handleBackgroundTaskEvent:(id)arg1;	// IMP=0x00100000001c993d
@property(readonly, nonatomic) long long numberOfPollRequests;
- (void)addPollRequest:(id)arg1;	// IMP=0x00100000001c9921
- (void)dealloc;	// IMP=0x00100000001c98f2
- (id)initWithDispatchQueue:(id)arg1;	// IMP=0x00100000001c9823
