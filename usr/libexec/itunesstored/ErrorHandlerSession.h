...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a01f6
- (unsigned long long)hash;	// IMP=0x00100000001a01ec
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x00100000001a01c5
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x00100000001a0156
- (void)dealloc;	// IMP=0x00100000001a011b
- (id)init;	// IMP=0x00100000001a00b5
