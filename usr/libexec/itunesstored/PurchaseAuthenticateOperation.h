...
- (id)_userAgentForPurchases:(id)arg1;	// IMP=0x00200000001b3148
- (id)_clientIdentifierForPurchases:(id)arg1;	// IMP=0x00100000001b2fd6
- (void)run;	// IMP=0x00100000001b2dfd
@property(copy) NSString *clientIdentifierHeader;
@property(copy) CDUnknownBlockType authenticationBlock;
- (void)dealloc;	// IMP=0x00100000001b2c4c
- (id)initWithPurchases:(id)arg1;	// IMP=0x00100000001b2a84
