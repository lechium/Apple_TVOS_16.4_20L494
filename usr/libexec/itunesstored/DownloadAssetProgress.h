...
- (void).cxx_destruct;	// IMP=0x00200000001cf06a
...
- (id)_newProgressForMediaSelection:(id)arg1;	// IMP=0x00100000001ceeff
- (void)setMediaSelectionDidComplete:(id)arg1;	// IMP=0x00100000001ceef5
- (void)setProgress:(double)arg1 forMediaSelection:(id)arg2;	// IMP=0x00100000001ced54
@property(readonly, nonatomic) double progress;
- (id)init;	// IMP=0x00100000001cecd8
