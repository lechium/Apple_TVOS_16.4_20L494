...
- (_Bool)_postTokenToURL:(id)arg1 error:(id *)arg2;	// IMP=0x0020000000099ffe
- (void)run;	// IMP=0x0010000000099a4f
@property(readonly) NSData *tokenData;
@property(copy) SSAuthenticationContext *authenticationContext;
@property(readonly) NSString *environmentName;
- (void)dealloc;	// IMP=0x00100000000998f7
- (id)initWithEnvironmentName:(id)arg1 tokenData:(id)arg2;	// IMP=0x001000000009986f
- (id)init;	// IMP=0x0010000000099859
