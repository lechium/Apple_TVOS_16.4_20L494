...
- (void).cxx_destruct;	// IMP=0x002000000016cea1
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x001000000016c28e
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x001000000016bbf6
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1 error:(id *)arg2;	// IMP=0x001000000016b89f
- (id)sessionConfiguration;	// IMP=0x001000000016b6c7
