...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001a12c7
- (void)_presentDialog:(id)arg1;	// IMP=0x00100000001a1233
- (void)dealloc;	// IMP=0x00100000001a11f1
