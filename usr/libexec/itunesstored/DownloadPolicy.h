...
+ (id)defaultProperties;	// IMP=0x002000000017583b
+ (Class)databaseEntityClass;	// IMP=0x001000000017582a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0020000000175862
@property(copy, nonatomic) NSData *policyData;
@property(readonly, nonatomic) SSDownloadPolicy *downloadPolicy;
- (void)dealloc;	// IMP=0x0010000000175594
