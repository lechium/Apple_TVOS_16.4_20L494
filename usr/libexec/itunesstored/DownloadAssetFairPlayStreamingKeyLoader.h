...
@class IPodLibraryItem, MISSING_TYPE, NSMutableDictionary, NSString;
...
{
    MISSING_TYPE *_resourceLoaderQueue;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x0020000000098686
...
- (id)_track;	// IMP=0x00100000000982f2
- (void)_persistURI:(id)arg1 persistentContentKey:(id)arg2;	// IMP=0x00100000000982ec
- (void)_persistKeys;	// IMP=0x00100000000982e6
- (id)_pastisKeyServerURL;	// IMP=0x0010000000098219
- (id)_pastisCertificateURL;	// IMP=0x001000000009814c
- (_Bool)resourceLoader:(id)arg1 shouldWaitForLoadingOfRequestedResource:(id)arg2;	// IMP=0x0010000000098144
- (void)persistKeys;	// IMP=0x001000000009813e
- (void)applyResourceLoaderDelegate:(id)arg1;	// IMP=0x001000000009811f
- (id)initWithDownloadEntity:(id)arg1;	// IMP=0x0010000000097fa4
