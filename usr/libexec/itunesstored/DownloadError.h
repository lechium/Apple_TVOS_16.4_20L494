...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000108c79
- (_Bool)representsDownloadWithIdentifier:(long long)arg1;	// IMP=0x0010000000108c18
- (void)removeDownloadIdentifier:(long long)arg1;	// IMP=0x0010000000108bbe
- (void)performActionForResponseFlags:(unsigned long long)arg1;	// IMP=0x0010000000108bb8
...
- (id)copyUserNotification;	// IMP=0x0010000000108b8a
- (_Bool)canCoalesceWithError:(id)arg1;	// IMP=0x0010000000108b82
- (void)addDownloadIdentifiers:(id)arg1;	// IMP=0x0010000000108b45
- (void)addDownloadIdentifier:(long long)arg1;	// IMP=0x0010000000108ad5
- (void)dealloc;	// IMP=0x0010000000108a7d
