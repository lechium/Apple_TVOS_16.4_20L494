...
- (void).cxx_destruct;	// IMP=0x0020000000043bc5
...
- (id)_fullBuyParametersWithAppProxy:(id)arg1;	// IMP=0x00100000000431d2
- (id)_appProxy;	// IMP=0x0010000000042d7d
- (void)run;	// IMP=0x0010000000042141
- (_Bool)purchaseOperation:(id)arg1 shouldContinueWithNewStorefront:(id)arg2;	// IMP=0x001000000004205d
...
- (void)setClientAuditTokenData:(id)arg1;	// IMP=0x0010000000041d29
...
- (id)clientAuditTokenData;	// IMP=0x001000000004196c
