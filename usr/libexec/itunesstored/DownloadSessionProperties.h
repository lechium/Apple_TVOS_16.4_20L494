...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000027396
- (unsigned long long)hash;	// IMP=0x001000000002738c
- (id)description;	// IMP=0x0010000000027326
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000027266
- (void)dealloc;	// IMP=0x001000000002720e
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x00100000000271ac
