...
- (_Bool)_parsePropertyList:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000084eac
- (_Bool)_loadResponseReturningError:(id *)arg1;	// IMP=0x0010000000084bca
- (_Bool)_appendRangeRequestsToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000084967
- (void)run;	// IMP=0x0010000000084905
- (void)dealloc;	// IMP=0x001000000008489f
