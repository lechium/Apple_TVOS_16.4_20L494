...
- (id)description;	// IMP=0x0020000000026c51
...
- (id)resetDisavowedSessionProperties;	// IMP=0x00100000000267d6
@property(readonly) NSSet *disavowedSessionProperties;
- (void)addDisavowedSessionProperties:(id)arg1;	// IMP=0x00100000000263ca
- (void)dealloc;	// IMP=0x0010000000026372
- (id)initWithInputConnection:(id)arg1;	// IMP=0x0010000000026328
