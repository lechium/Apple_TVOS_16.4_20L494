...
- (void).cxx_destruct;	// IMP=0x00200000000b6a54
- (id)_requestPropertiesWithAccount:(id)arg1 syncState:(id)arg2 fairPlaySubscriptionController:(id)arg3;	// IMP=0x00100000000b6a4c
- (id)_newMachineDataOperationWithAccount:(id)arg1 response:(id)arg2;	// IMP=0x00100000000b6923
- (void)run;	// IMP=0x00100000000b68ba
