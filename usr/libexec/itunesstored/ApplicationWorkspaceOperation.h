...
- (void)runWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000004de4e
@property(readonly, nonatomic) _Bool blocksAppInstallation;
- (_Bool)applicationIsInstalled:(id)arg1;	// IMP=0x001000000004ddcd
- (void)dealloc;	// IMP=0x001000000004dd92
- (id)initWithApplicationHandle:(id)arg1;	// IMP=0x001000000004dd3b
