...
+ (_Bool)responseIsValid:(id)arg1;	// IMP=0x00400000000400ef
+ (id)paymentEntityFromContext:(id)arg1;	// IMP=0x00100000000400a2
@property(nonatomic, getter=isTransientFailed) _Bool transientFailed; // @synthesize transientFailed=_transientFailed;
- (void)_updateDownloadsFromResponse:(id)arg1;	// IMP=0x0010000000041363
- (id)_temporaryIdentifier;	// IMP=0x0010000000041314
- (long long)_serverStateForClientState:(long long)arg1;	// IMP=0x00100000000412b8
- (long long)_clientStateForServerState:(long long)arg1;	// IMP=0x0010000000041233
- (void)setValuesWithPaymentTransaction:(id)arg1;	// IMP=0x0010000000040e65
@property(retain, nonatomic) NSString *transactionIdentifier; // @dynamic transactionIdentifier;
- (void)awakeFromInsert;	// IMP=0x0010000000040d7e
- (void)setFailedWithError:(id)arg1;	// IMP=0x0010000000040c9a
@property(readonly, nonatomic) NSString *matchingIdentifier;
@property(readonly, nonatomic, getter=isReady) _Bool ready;
- (void)mergeValuesFromResponse:(id)arg1;	// IMP=0x00100000000408bb
- (_Bool)isEqualToResponse:(id)arg1 compareAllFields:(_Bool)arg2;	// IMP=0x00100000000406bd
- (id)copyPaymentTransaction;	// IMP=0x001000000004013b
- (void)dealloc;	// IMP=0x0010000000040054
