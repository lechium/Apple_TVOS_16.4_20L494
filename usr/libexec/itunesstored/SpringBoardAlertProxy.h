...
- (void).cxx_destruct;	// IMP=0x002000000004bf57
@property(readonly) NSObject<OS_xpc_object> *XPCEndpoint; // @synthesize XPCEndpoint=_inputEndpoint;
- (void)_handleMessage:(id)arg1 connection:(id)arg2;	// IMP=0x001000000004bd94
- (void)_disconnect;	// IMP=0x001000000004bc7b
@property __weak id <SpringBoardAlertProxyDelegate> delegate;
- (void)sendMessage:(id)arg1;	// IMP=0x001000000004bb2e
- (void)dealloc;	// IMP=0x000000000004b9c2
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000004b645
