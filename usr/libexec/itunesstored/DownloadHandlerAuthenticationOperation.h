...
- (void)_setURLCredential:(id)arg1;	// IMP=0x002000000017eac4
- (void)_setState:(long long)arg1;	// IMP=0x001000000017ea75
- (id)_openSession;	// IMP=0x001000000017e809
- (void)downloadHandlerManager:(id)arg1 sessionsDidChange:(id)arg2;	// IMP=0x001000000017e635
- (void)run;	// IMP=0x001000000017e134
- (void)cancel;	// IMP=0x001000000017e0ac
...
- (void)dealloc;	// IMP=0x001000000017decb
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x001000000017de5b
