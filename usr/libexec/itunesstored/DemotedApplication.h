...
- (void).cxx_destruct;	// IMP=0x00200000000320ce
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000031f34
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000000319ab
- (id)initWithApplication:(id)arg1;	// IMP=0x001000000003181a
