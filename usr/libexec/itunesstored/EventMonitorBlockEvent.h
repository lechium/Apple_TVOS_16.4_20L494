...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000126c96
- (void)performAction;	// IMP=0x0010000000126c7c
- (_Bool)hasOccurred;	// IMP=0x0010000000126c60
- (void)dealloc;	// IMP=0x0010000000126c08
