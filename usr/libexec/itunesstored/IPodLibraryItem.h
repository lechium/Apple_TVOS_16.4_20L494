...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x00200000000f726e
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x00200000000f88ab
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x00100000000f8743
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x00100000000f7e3c
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f70b7
- (void)dealloc;	// IMP=0x00100000000f7048
- (id)init;	// IMP=0x00100000000f6ffa
