...
- (void).cxx_destruct;	// IMP=0x00200000000c82b4
...
- (_Bool)_shouldSkipInitialDialog:(id)arg1;	// IMP=0x00100000000c7ad2
- (_Bool)_shouldAuthenticateForButton:(id)arg1;	// IMP=0x00100000000c7a14
- (_Bool)_isLocalizationAlreadyConfiguredForAuthContext:(id)arg1;	// IMP=0x00100000000c7960
- (void)_handleSelectedButton:(id)arg1;	// IMP=0x00100000000c766d
- (_Bool)_copySelectedButton:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000c7341
- (id)_copyButtonToSkipDialog:(id)arg1;	// IMP=0x00100000000c719e
- (id)_copyAuthenticationContext;	// IMP=0x00100000000c6727
- (_Bool)_copyAccountIdentifier:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000c62da
- (void)run;	// IMP=0x00100000000c5d95
...
- (id)initWithDialog:(id)arg1;	// IMP=0x00100000000c5a52
- (id)init;	// IMP=0x00100000000c581b
