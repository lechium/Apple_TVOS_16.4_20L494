...
+ (id)propertiesForDownloadEntities;	// IMP=0x00400000001864a2
+ (id)downloadEntityFromContext:(id)arg1;	// IMP=0x0010000000186455
- (void)awakeFromInsert;	// IMP=0x002000000018697c
- (void)setValuesWithAssetDictionary:(id)arg1;	// IMP=0x001000000018665c
- (id)copySKDownload;	// IMP=0x001000000018650d
