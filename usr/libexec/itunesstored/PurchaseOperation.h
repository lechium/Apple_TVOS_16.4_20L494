...
+ (double)_randomDouble;	// IMP=0x0020000000025423
+ (void)reportAnonymousPings:(id)arg1;	// IMP=0x0010000000018925
- (void).cxx_destruct;	// IMP=0x002000000002600a
...
- (id)_URLBagContext;	// IMP=0x0010000000025cc8
- (_Bool)_shouldUseClientAuthentication;	// IMP=0x00100000000257f2
- (_Bool)_shouldSendSBSyncData;	// IMP=0x001000000002573c
- (_Bool)_shouldSendKeyBagSyncData;	// IMP=0x001000000002554c
- (void)_setMoveToiOS;	// IMP=0x001000000002545d
- (_Bool)_shouldDisableReversePush;	// IMP=0x0010000000025045
- (void)_setChangedBuyParameters:(id)arg1 fromDataProvider:(id)arg2;	// IMP=0x0010000000024edb
- (void)_scoreDeviceRetryFailedV2Score;	// IMP=0x00100000000249ec
- (void)_scoreDevice;	// IMP=0x0010000000024126
- (void)_runPurchaseRequest;	// IMP=0x00100000000232c7
- (void)_runDialogOperationForDialog:(id)arg1;	// IMP=0x00100000000210c3
- (id)_recordEngagementEventWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00100000000206c2
- (long long)_purchaseType;	// IMP=0x00100000000205fa
- (id)_priceFromBuyParams;	// IMP=0x00100000000204f6
- (void)_performAutoEnrollmentCheck;	// IMP=0x0010000000020347
- (void)_performApplePayClassicCheck;	// IMP=0x0010000000020198
- (void)_performMachineDataActionForURLResponse:(id)arg1;	// IMP=0x001000000001fced
- (void)_performDelayedGotoForOperation:(id)arg1;	// IMP=0x001000000001fb57
- (id)_newRequestParameters;	// IMP=0x001000000001f32a
- (id)_newPurchaseRequestOperation;	// IMP=0x001000000001d903
- (void)_handleFailureForOperation:(id)arg1;	// IMP=0x001000000001c91e
- (id)_fairPlaySubscriptionController;	// IMP=0x001000000001c8c2
- (id);	// IMP=0x001000000001c82f
- (id)_countryCode;	// IMP=0x001000000001c40e
- (void)_continueTouchIDSessionWithDialog:(id)arg1;	// IMP=0x001000000001c1e0
- (_Bool)_clientIsViewService;	// IMP=0x001000000001c069
- (id)_buyParamProductType;	// IMP=0x001000000001bdef
- (void)_addFairPlayToRequestProperties:(id)arg1 withAccountIdentifier:(unsigned long long)arg2;	// IMP=0x001000000001bde9
- (id)_accountWithUniqueIdentifier:(id)arg1;	// IMP=0x001000000001bcc4
- (id)_account;	// IMP=0x001000000001bb85
- (void)sender:(id)arg1 willSendChallenge:(id)arg2 andSignature:(id)arg3 andPaymentTokenData:(id)arg4 andFpanID:(id)arg5 isExtendedAction:(_Bool)arg6 isPayment:(_Bool)arg7 additionalHeaders:(id)arg8;	// IMP=0x001000000001b963
- (void)sender:(id)arg1 shouldContinueTouchIDSession:(_Bool)arg2;	// IMP=0x001000000001b944
- (void)sender:(id)arg1 didFallbackToPassword:(_Bool)arg2;	// IMP=0x001000000001b925
- (void)operation:(id)arg1 willSendRequest:(id)arg2;	// IMP=0x001000000001b869
- (void)operation:(id)arg1 shouldAuthenticateWithContext:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000001b773
- (void)operation:(id)arg1 didAuthenticateWithDSID:(id)arg2;	// IMP=0x001000000001b3eb
- (id)uniqueKey;	// IMP=0x001000000001b3de
- (void)run;	// IMP=0x00100000000196a8
- (id)authenticatedAccountDSID;	// IMP=0x0010000000019624
...
- (id)initWithPurchase:(id)arg1;	// IMP=0x0010000000018401
- (id)init;	// IMP=0x00100000000183ed
