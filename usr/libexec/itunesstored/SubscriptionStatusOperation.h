...
- (void).cxx_destruct;	// IMP=0x002000000000cd27
- (id)_loadStatusOnce:(id *)arg1;	// IMP=0x001000000000c972
- (id)_getInitialStatus:(id *)arg1;	// IMP=0x001000000000c634
- (_Bool)_carrierBundleStatusIsValidForCachedStatus:(id)arg1;	// IMP=0x001000000000c49c
- (void)_cacheAccountEligibilityWithStatus:(id)arg1;	// IMP=0x001000000000c19b
- (void)run;	// IMP=0x001000000000b64c
