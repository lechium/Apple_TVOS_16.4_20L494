...
- (id)_policyChangedDownloadIDs;	// IMP=0x001000000000b020
- (id)_finishedDownloadKinds;	// IMP=0x001000000000aff7
- (id)_deletedIPodLibraryDownloadIDs;	// IMP=0x001000000000afce
- (id)_deletedHTTPCookies;	// IMP=0x001000000000afa5
- (id)_cookies;	// IMP=0x001000000000af7c
- (id)_canceledIPodLibraryDownloadIDs;	// IMP=0x001000000000af53
- (id)_canceledAppDataRestoreIDs;	// IMP=0x001000000000af2a
- (id)_applicationWorkspaceChanges;	// IMP=0x001000000000af01
- (id)_SSAppWakeRequests;	// IMP=0x001000000000aed8
- (void)_addApplicationWorkspaceChangeWithHandle:(id)arg1 changeType:(long long)arg2;	// IMP=0x001000000000ae64
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000ac68
- (void)unionChangeset:(id)arg1;	// IMP=0x001000000000a833
- (void)restartDownloadsInPipelineWithIDs:(id)arg1;	// IMP=0x001000000000a81d
- (void)removeDownloadFromPipelineWithID:(long long)arg1;	// IMP=0x001000000000a7c3
- (void)addUpdatedDownloadID:(long long)arg1;	// IMP=0x001000000000a766
- (void)addStatusChangedDownloadID:(long long)arg1;	// IMP=0x001000000000a709
- (void)addRetryAppWithHandle:(id)arg1;	// IMP=0x001000000000a6f2
- (void)addRestorableDownloadID:(long long)arg1;	// IMP=0x001000000000a695
- (void)addRemovedPersistentDownloadID:(long long)arg1;	// IMP=0x001000000000a638
- (void)addRemovedDownloadID:(long long)arg1;	// IMP=0x001000000000a5db
- (void)addPolicyChangedDownloadID:(long long)arg1;	// IMP=0x001000000000a575
- (void)addIPodLibraryItem:(id)arg1;	// IMP=0x001000000000a55f
- (void)addHTTPCookie:(id)arg1;	// IMP=0x001000000000a52e
- (void)addFinishedDownloadKind:(id)arg1;	// IMP=0x001000000000a4f7
- (void)addFinishedAppWithHandle:(id)arg1;	// IMP=0x001000000000a4e0
- (void)addFailedAppWithHandle:(id)arg1;	// IMP=0x001000000000a4c9
- (void)addDownloadsToPipelineWithIDs:(id)arg1;	// IMP=0x001000000000a4b3
- (void)addDownloadToPipelineWithID:(long long)arg1;	// IMP=0x001000000000a459
- (void)addDownloadKind:(id)arg1;	// IMP=0x001000000000a43c
- (void)addDownloadChangeTypes:(long long)arg1;	// IMP=0x001000000000a432
- (void)addDeletedIPodLibraryDownloadID:(long long)arg1;	// IMP=0x001000000000a3cc
- (void)addDeletedHTTPCookies:(id)arg1;	// IMP=0x001000000000a39b
- (void)addCanceledIPodLibraryDownloadID:(long long)arg1;	// IMP=0x001000000000a335
- (void)addCanceledAppDataRestoreID:(id)arg1;	// IMP=0x001000000000a304
- (void)addCanceledAppWithHandle:(id)arg1;	// IMP=0x001000000000a2ed
- (void)addAppPlaceholderUpdateWithHandle:(id)arg1;	// IMP=0x001000000000a2d6
- (void)addAppPlaceholderWithHandle:(id)arg1;	// IMP=0x001000000000a2c2
- (void)addApplicationWorkspaceChange:(id)arg1;	// IMP=0x001000000000a291
- (void)addSSAppWakeRequest:(id)arg1;	// IMP=0x001000000000a260
- (void)dealloc;	// IMP=0x001000000000a17c
- (id)init;	// IMP=0x001000000000a0b4
- (id)_initDownloadsChangeset;	// IMP=0x001000000000a085
