...
- (void)addRefreshed:(id)arg1;	// IMP=0x001000000010ed55
- (void)addRevoked:(id)arg1;	// IMP=0x001000000010ecf9
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000010ec1e
- (void)dealloc;	// IMP=0x001000000010ebb8
