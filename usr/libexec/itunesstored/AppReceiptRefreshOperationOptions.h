...
- (void).cxx_destruct;	// IMP=0x0020000000199191
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000199067
@property(readonly, nonatomic) NSString *URLBagKey;
- (id)initWithReceiptFlags:(unsigned long long)arg1;	// IMP=0x0010000000198fff
