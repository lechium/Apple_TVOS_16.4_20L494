...
- (id)_ntsQueryParameters:(id *)arg1;	// IMP=0x00200000000832fc
- (id)_copyApplicationIdentity:(id *)arg1;	// IMP=0x0010000000083090
- (id)description;	// IMP=0x0010000000082fe8
...
- (id)newStoreURLOperation:(id *)arg1;	// IMP=0x0010000000082b5a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000082a4e
- (void)dealloc;	// IMP=0x00100000000829ef
- (id)init;	// IMP=0x00100000000829a3
