...
- (void).cxx_destruct;	// IMP=0x002000000018fc1e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000018f7f2
- (id)description;	// IMP=0x001000000018f7a4
- (id)initWithAppAdamId:(id)arg1 transactionId:(id)arg2 campaignId:(id)arg3 adNetworkId:(id)arg4 attributionSignature:(id)arg5 pingbackUrl:(id)arg6 retryCount:(long long)arg7 localTimestamp:(id)arg8;	// IMP=0x001000000018f3be
