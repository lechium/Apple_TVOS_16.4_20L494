...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000826ce
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x00100000000823ec
- (void)run;	// IMP=0x0010000000082138
- (void)dealloc;	// IMP=0x00100000000820d2
