...
- (void).cxx_destruct;	// IMP=0x002000000008484c
...
- (id)_URLBagContext;	// IMP=0x001000000008476e
- (_Bool)_shouldCheckAutoRenewQueue;	// IMP=0x0010000000084685
- (_Bool)_appendToResponse:(id)arg1 usingOperation:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000841b9
- (_Bool)_appendNormalQueueToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000084054
- (_Bool)_appendAutoRenewQueueToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000083eef
- (void)run;	// IMP=0x00100000000837b1
