...
- (void).cxx_destruct;	// IMP=0x00200000000f6743
...
- (void)run;	// IMP=0x00100000000f66a1
- (id)initWithAccountIdentifier:(id)arg1 rentalKeyIdentifier:(id)arg2;	// IMP=0x00100000000f65da
