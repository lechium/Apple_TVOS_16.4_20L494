...
- (void).cxx_destruct;	// IMP=0x002000000012026e
...
- (void)_timerFired;	// IMP=0x0010000000120166
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x001000000012000e
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x001000000011ff40
- (void)dealloc;	// IMP=0x001000000011fed5
- (id)initWithThreadKey:(id)arg1 longPressDelay:(double)arg2 longPressHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000011fdf6
