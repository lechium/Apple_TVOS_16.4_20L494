...
- (void).cxx_destruct;	// IMP=0x0020000000061b3d
...
- (long long)_repeatStateForEvent:(id)arg1;	// IMP=0x0010000000061a35
- (long long)_currentGestureRepeaterEvent;	// IMP=0x0010000000061a10
- (double)_delayForCurrentRepeatCount;	// IMP=0x0010000000061a02
- (void)_handleRepeaterTimerDidFire:(id)arg1;	// IMP=0x0010000000061922
- (void)updateWithEvent:(id)arg1;	// IMP=0x00100000000616ed
- (void)dealloc;	// IMP=0x00100000000615ea
- (id)initWithThread:(id)arg1;	// IMP=0x00100000000613a2
