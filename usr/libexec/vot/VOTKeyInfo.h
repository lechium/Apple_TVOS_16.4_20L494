...
- (void).cxx_destruct;	// IMP=0x0010000000102e79
...
- (id)description;	// IMP=0x0010000000102c0f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000102685
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x0010000000102525
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x0010000000102eac
