...
+ (id)keyboardManager;	// IMP=0x00400000000f775e
+ (void)initialize;	// IMP=0x00100000000f771d
- (void).cxx_destruct;	// IMP=0x00200000000fc19f
...
- (void)clearConsecutiveKeyPressCount;	// IMP=0x00100000000fc055
- (void)_postEvent:(id)arg1;	// IMP=0x00100000000fbfc1
- (void)_handleQuickNavPressTimer:(id)arg1;	// IMP=0x00100000000fbf76
- (void)_handleQuickNavPress:(id)arg1;	// IMP=0x00100000000fbc07
- (void)_handleQuickNavDownArrowRepostPress:(id)arg1;	// IMP=0x00100000000fbaf7
- (void)_postKeyboardKey:(id)arg1 keyCode:(unsigned short)arg2 eventFlags:(unsigned int)arg3 keyFlags:(unsigned short)arg4 keyDown:(_Bool)arg5 source:(unsigned short)arg6;	// IMP=0x00100000000fb8db
- (void)_sendEventForCommand:(id)arg1 withKeyInfo:(id)arg2 arrowMask:(long long)arg3;	// IMP=0x00100000000fb82a
- (void)_sendEvent:(id)arg1 withKeyInfo:(id)arg2 arrowMask:(long long)arg3;	// IMP=0x00100000000fb71e
- (void)_keyRepeat:(id)arg1;	// IMP=0x00100000000fb6ce
- (void)_dispatchKeyEventIntoSystem:(id)arg1;	// IMP=0x00100000000fb3b5
- (_Bool)_keyInfoIsModifierOnly:(id)arg1;	// IMP=0x00100000000fb2ae
- (void)_handleKeyboardKeyEvent:(id)arg1 isRepeatedEvent:(_Bool)arg2;	// IMP=0x00100000000fafe3
- (void)_handleModifierCapsLockBehavior:(id)arg1;	// IMP=0x00100000000faf15
- (void)_handleCapsLockToggle:(id)arg1;	// IMP=0x00100000000fabae
- (void)_dispatchEventRepresentationIntoSystem:(id)arg1;	// IMP=0x00100000000fab35
- (_Bool)_keyEventShouldGoToFocusedContext:(id)arg1;	// IMP=0x00100000000fab2d
- (void)_handleKeyboardKeyEvent:(id)arg1;	// IMP=0x00100000000fab19
- (void)_updateEventFlags:(id)arg1;	// IMP=0x00100000000faa31
- (void)_handleAnnouncementsForKeyInfo:(id)arg1;	// IMP=0x00100000000fa8ec
- (void)_speakCapsLockKey;	// IMP=0x00100000000fa843
- (_Bool)_handleArrowKeyEvent:(id)arg1;	// IMP=0x00100000000fa3bc
- (void)_initializeQuickNav;	// IMP=0x00100000000fa2ed
- (void)_axEndPassthroughTouch;	// IMP=0x00100000000fa205
- (void)_axStartPassthroughTouch;	// IMP=0x00100000000fa06c
- (_Bool)_dispatchCommandForKeyInfo:(id)arg1 isRepeatedEvent:(_Bool)arg2;	// IMP=0x00100000000f9261
- (id)_localizeKeyboardString:(id)arg1;	// IMP=0x00100000000f91ef
- (void)setKeyDownInfo:(id)arg1;	// IMP=0x00100000000f9170
- (void)_updateConsecutiveKeyCount:(id)arg1;	// IMP=0x00100000000f906e
- (void)updateQuickNavState:(_Bool)arg1;	// IMP=0x00100000000f905e
- (id)keyDownInfo;	// IMP=0x00100000000f9036
- (id)threadSafe_keyDownInfo;	// IMP=0x00100000000f8fda
- (void)postEvent:(id)arg1;	// IMP=0x00100000000f8f4b
- (id)singleLetterCommandForKeyInfo:(id)arg1;	// IMP=0x00100000000f8e5e
- (id)keyboardEventForKeyInfo:(id)arg1;	// IMP=0x00100000000f86c0
- (id)_characterStringRepresentationForKey:(id)arg1;	// IMP=0x00100000000f814c
- (void)loadKeyboardMap;	// IMP=0x00100000000f7c4b
- (void)handleKeyboardKeyEvent:(id)arg1 eventOrigin:(long long)arg2;	// IMP=0x00100000000f7b93
- (void)_initializeThread;	// IMP=0x00100000000f7af9
- (_Bool)modifierKeyLockEnabled;	// IMP=0x00100000000f7aed
- (void)toggleVoiceOverModifierKeyLock;	// IMP=0x00100000000f7ae0
- (void)_verifyCorrectThread;	// IMP=0x00100000000f7a17
- (id)init;	// IMP=0x00100000000f77fe
- (void)dealloc;	// IMP=0x00100000000f7783
- (void)setCommandManager:(id)arg1;	// IMP=0x00100000000f776f
