...
- (id)_localizedStringForKey:(id)arg1;	// IMP=0x00100000000d864b
- (void)previousSegment;	// IMP=0x00100000000d85bf
- (void)nextSegment;	// IMP=0x00100000000d854c
...
- (id)initWithSegments:(id)arg1;	// IMP=0x00100000000d82f1
