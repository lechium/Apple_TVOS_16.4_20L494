...
- (void).cxx_destruct;	// IMP=0x00200000001217f8
...
- (void)_drainQueueAndSendEventsToSystem:(_Bool)arg1;	// IMP=0x001000000012159c
- (void)_releaseTimerFired;	// IMP=0x001000000012152d
- (void)_holdTimerFired;	// IMP=0x00100000001214be
- (void)_resetStateAndSendPendingEventsToSystem:(_Bool)arg1;	// IMP=0x0010000000121454
- (void)_processStateChangeWithEvent:(long long)arg1 axEvent:(id)arg2;	// IMP=0x0010000000121076
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x0010000000120f9a
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x0010000000120ec1
- (void)dealloc;	// IMP=0x0010000000120e2e
- (id)initWithThreadKey:(id)arg1;	// IMP=0x0010000000120ca8
