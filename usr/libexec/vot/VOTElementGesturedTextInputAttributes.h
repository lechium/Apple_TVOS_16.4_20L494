...
- (void).cxx_destruct;	// IMP=0x0020000000061392
...
- (id)description;	// IMP=0x00100000000610d7
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x00100000000610b9
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x0010000000060ffb
- (id)initWithAttributes:(id)arg1;	// IMP=0x0010000000060cbf
