...
- (void).cxx_destruct;	// IMP=0x002000000000421c
...
- (id)errorForStatusCode:(long long)arg1 responseData:(id)arg2;	// IMP=0x0010000000004142
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 outError:(id *)arg3;	// IMP=0x001000000000413a
- (void)completeOperationWithResponse:(id)arg1 error:(id)arg2;	// IMP=0x0010000000003fbb
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 statusCode:(long long)arg3 retryNeeded:(_Bool *)arg4 outError:(id *)arg5;	// IMP=0x0010000000003e89
