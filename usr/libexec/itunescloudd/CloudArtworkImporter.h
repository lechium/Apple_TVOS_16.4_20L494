...
- (void).cxx_destruct;	// IMP=0x00200000000ea81a
...
- (void)_adjustOperationQueueStatusForMediaDownloads;	// IMP=0x00100000000ea5d9
- (void)downloadManager:(id)arg1 didCancelAssets:(id)arg2;	// IMP=0x00100000000ea5c7
- (void)downloadManager:(id)arg1 didFinishAsset:(id)arg2 withError:(id)arg3;	// IMP=0x00100000000ea5b5
- (void)downloadManager:(id)arg1 didUpdateDownloadProgress:(id)arg2;	// IMP=0x00100000000ea5a3
- (void)downloadManager:(id)arg1 didEnqueueAssetDownloads:(id)arg2 didRemoveAssetDownloads:(id)arg3;	// IMP=0x00100000000ea591
- (void)cancelAllImports;	// IMP=0x00100000000ea57d
- (void)cancelAllImportsAndWaitForOperationsToFinish:(_Bool)arg1;	// IMP=0x00100000000ea4c6
- (void)increasePriorityForAllOperations;	// IMP=0x00100000000ea455
- (void)decreasePriorityForAllOperations;	// IMP=0x00100000000ea3e4
- (void)deprioritizeImportArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2;	// IMP=0x00100000000ea35d
- (void)importCloudArtworkForRequests:(id)arg1;	// IMP=0x00100000000ea2a6
- (void)importArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2 token:(id)arg3 mediaType:(unsigned int)arg4 allowsCellularData:(_Bool)arg5 clientIdentity:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000ea13c
- (void)dealloc;	// IMP=0x00100000000ea034
- (id)initWithConfiguration:(id)arg1 sourceType:(long long)arg2;	// IMP=0x00100000000e9aad
