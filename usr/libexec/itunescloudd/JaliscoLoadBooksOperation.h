...
- (void).cxx_destruct;	// IMP=0x00200000000c1e84
...
- (id)metadataFilter;	// IMP=0x00100000000c1dfa
- (id)queryFilter;	// IMP=0x00100000000c1d8d
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x00100000000c1d6a
- (void)main;	// IMP=0x00100000000c1699
