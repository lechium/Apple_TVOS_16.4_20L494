...
- (void).cxx_destruct;	// IMP=0x002000000004295c
...
- (void)main;	// IMP=0x0010000000042379
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 sagaID:(unsigned long long)arg3;	// IMP=0x0010000000042335
- (id)initWithClientIdentity:(id)arg1 sagaID:(unsigned long long)arg2;	// IMP=0x00100000000422c2
