...
- (void).cxx_destruct;	// IMP=0x00200000000bb020
...
- (id)_resizedImageDataFromLocation:(id)arg1;	// IMP=0x00100000000babe8
- (void)cancel;	// IMP=0x00100000000bab8f
- (void)start;	// IMP=0x00100000000ba232
- (id)description;	// IMP=0x00100000000ba162
- (void)callCompletionHandlers;	// IMP=0x00100000000b9fd6
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000b9f38
- (id)initWithURLSession:(id)arg1 configuration:(id)arg2 cloudID:(unsigned long long)arg3 artworkToken:(id)arg4 artworkType:(long long)arg5 sourceType:(long long)arg6 clientIdentity:(id)arg7;	// IMP=0x00100000000b9e0e
