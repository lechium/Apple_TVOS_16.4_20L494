...
- (void).cxx_destruct;	// IMP=0x002000000006d459
...
- (id)debugDescription;	// IMP=0x001000000006d26e
- (_Bool)isValid;	// IMP=0x001000000006d265
- (id)initWithSong:(id)arg1;	// IMP=0x001000000006cec1
