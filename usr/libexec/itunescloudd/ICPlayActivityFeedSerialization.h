...
+ (id)defaultOverrideHTTPHeaderFields;	// IMP=0x004000000006a14f
- (void).cxx_destruct;	// IMP=0x002000000006c3c9
@property(copy, nonatomic) NSString *currentStoreFrontID; // @synthesize currentStoreFrontID=_currentStoreFrontID;
- (id)propertyListObjectWithPlayActivityEvent:(id)arg1;	// IMP=0x001000000006a1d5
