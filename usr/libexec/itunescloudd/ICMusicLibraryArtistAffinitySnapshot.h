...
- (void).cxx_destruct;	// IMP=0x0020000000070f93
...
- (id)debugDescription;	// IMP=0x0010000000070d4b
- (float)legacyScore;	// IMP=0x0010000000070c33
...
- (id)initWithContentItemSnapshot:(id)arg1;	// IMP=0x0010000000070940
