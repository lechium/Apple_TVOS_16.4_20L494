...
+ (id)eTagValueFromContentTasteResponse:(id)arg1;	// IMP=0x00400000000433fd
- (void).cxx_destruct;	// IMP=0x00200000000433d5
...
- (id)initWithContentTasteResponse:(id)arg1;	// IMP=0x00100000000432e0
