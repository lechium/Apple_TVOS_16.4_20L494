...
- (void).cxx_destruct;	// IMP=0x00200000000906ca
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000090536
- (unsigned long long)hash;	// IMP=0x0010000000090460
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000902c6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009019b
- (void)writeTo:(id)arg1;	// IMP=0x00100000000900b4
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000008fdc2
- (id)dictionaryRepresentation;	// IMP=0x001000000008fc2d
- (id)description;	// IMP=0x001000000008fb7e
