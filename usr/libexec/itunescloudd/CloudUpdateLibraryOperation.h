...
- (void).cxx_destruct;	// IMP=0x00200000001033aa
...
- (void)_clearAllCloudIDs;	// IMP=0x0010000000103120
- (id)_determineResultsURLWhenReadyWithUpdateID:(id)arg1 retryTimeout:(double)arg2 responseStatusCode:(out long long *)arg3;	// IMP=0x0010000000102a2f
- (_Bool)_updateLibrary;	// IMP=0x00100000001016c7
- (void)_prepareLibraryForInitialUpdate;	// IMP=0x00100000001015c4
- (_Bool)_uploadLibrary;	// IMP=0x00100000000fe846
- (_Bool)_ensureDeviceIsRegistered;	// IMP=0x00100000000fe72b
- (void)main;	// IMP=0x00100000000fcda7
- (void)cancel;	// IMP=0x00100000000fcc5d
@property(readonly, nonatomic) float progress;
@property(readonly, nonatomic, getter=isInitialUpdate) _Bool initialUpdate;
- (void)dealloc;	// IMP=0x00100000000fcbed
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 reason:(long long)arg3 updateTaskHelper:(id)arg4;	// IMP=0x00100000000fcb58
