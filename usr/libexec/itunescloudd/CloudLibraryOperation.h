...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000816fa
- (void).cxx_destruct;	// IMP=0x0020000000081663
...
- (id)description;	// IMP=0x0010000000081537
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000008149f
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000813c3
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x0010000000081269
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000081207
- (id)init;	// IMP=0x00100000000811c7
