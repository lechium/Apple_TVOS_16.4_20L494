...
- (void).cxx_destruct;	// IMP=0x00200000000d6491
...
- (void)disconnect;	// IMP=0x00100000000d63d7
- (void)connectWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000d62d0
- (void)_onQueue_sendRequest:(id)arg1 withInternalResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000d4d24
- (void)sendRequest:(id)arg1 withResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000d4c48
@property(readonly, nonatomic) ICUserIdentityStore *userIdentityStore;
@property(readonly, nonatomic) ICUserIdentity *userIdentity;
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000d4b21
