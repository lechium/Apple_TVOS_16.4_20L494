...
+ (id)daemonDefaults;	// IMP=0x002000000002082e
- (void).cxx_destruct;	// IMP=0x0020000000020806
...
- (void)_setOrRemoveObject:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000002072e
- (id)_init;	// IMP=0x001000000002063e
