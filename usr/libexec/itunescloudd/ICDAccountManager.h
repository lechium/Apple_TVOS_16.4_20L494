...
- (void).cxx_destruct;	// IMP=0x0020000000105d01
...
- (void)_updateStateWithChange:(id)arg1;	// IMP=0x0010000000105c13
- (id)_buildStateChange;	// IMP=0x0010000000105a11
...
- (void)changeLibraryManagementPolicy:(long long)arg1;	// IMP=0x0010000000105448
- (void)updateState;	// IMP=0x001000000010523b
- (id)initWithLibraryManagementPolicy:(long long)arg1;	// IMP=0x0010000000104fd7
