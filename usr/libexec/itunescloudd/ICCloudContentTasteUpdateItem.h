...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000a03c6
- (void).cxx_destruct;	// IMP=0x00200000000a0388
...
- (unsigned long long)hash;	// IMP=0x001000000009d13e
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000009d038
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000009cf62
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000009cdd6
- (id)description;	// IMP=0x001000000009cce4
- (id)initWithGlobalPlaylistID:(id)arg1 contentTaste:(long long)arg2 configuration:(id)arg3;	// IMP=0x001000000009cb99
- (id)initWithStoreItemID:(long long)arg1 mediaContentTasteItem:(long long)arg2 contentTaste:(long long)arg3 configuration:(id)arg4 timeStamp:(id)arg5;	// IMP=0x001000000009ca66
