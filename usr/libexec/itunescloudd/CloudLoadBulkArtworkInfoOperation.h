...
- (void)main;	// IMP=0x00100000000449a2
- (id)initWithConfiguration:(id)arg1 cloudIDs:(id)arg2;	// IMP=0x0010000000044881
- (id)initWithCloudIDs:(id)arg1;	// IMP=0x001000000004481d
