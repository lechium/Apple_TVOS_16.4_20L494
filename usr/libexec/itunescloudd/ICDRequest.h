...
+ (id)request;	// IMP=0x004000000010eba6
- (void).cxx_destruct;	// IMP=0x002000000010eafa
...
- (id)_HTTPMethodStringForICDRequestMethod:(long long)arg1;	// IMP=0x001000000010ea1c
@property(readonly, nonatomic) _Bool acceptsGzipEncoding;
- (id)canonicalResponseForResponse:(id)arg1;	// IMP=0x001000000010ea07
- (id)URLRequestForBaseURL:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x001000000010e8a8
- (id)requestURLForBaseURL:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x001000000010e6dd
- (void)setValue:(id)arg1 forArgument:(id)arg2;	// IMP=0x001000000010e65d
@property(readonly, nonatomic) double timeoutInterval;
- (id)description;	// IMP=0x001000000010e5a2
- (id)initWithAction:(id)arg1;	// IMP=0x001000000010e522
