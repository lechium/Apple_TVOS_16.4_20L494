...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x004000000009bb4a
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x001000000009ba8d
- (void).cxx_destruct;	// IMP=0x002000000009ba44
...
- (id)description;	// IMP=0x001000000009b955
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x001000000009b83c
