...
- (void).cxx_destruct;	// IMP=0x002000000000dfc6
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x001000000000df51
- (id)description;	// IMP=0x001000000000ded3
- (id)initWithTaskID:(id)arg1;	// IMP=0x001000000000ddd1
