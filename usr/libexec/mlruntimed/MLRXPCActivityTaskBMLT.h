...
- (void).cxx_destruct;	// IMP=0x002000000000218a
...
- (void)stop;	// IMP=0x0010000000002117
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002045
- (id)createTaskScheduler;	// IMP=0x0010000000002015
- (id)criteria;	// IMP=0x0010000000001edf
