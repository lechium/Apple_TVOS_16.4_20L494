...
- (void).cxx_destruct;	// IMP=0x002000000000be4b
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x001000000000bcde
- (id)description;	// IMP=0x001000000000bc60
- (id)initWithPluginID:(id)arg1;	// IMP=0x001000000000baf9
