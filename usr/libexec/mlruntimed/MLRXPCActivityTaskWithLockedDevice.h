...
- (void)stop;	// IMP=0x00100000000032be
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000031ba
- (id)createTaskScheduler;	// IMP=0x001000000000318a
- (id)criteria;	// IMP=0x0010000000003035
