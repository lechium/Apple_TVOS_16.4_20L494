...
- (void)updateWakeUpPeriodInSeconds;	// IMP=0x001000000000e17a
- (id)fetchAllPluginIDs;	// IMP=0x001000000000e123
- (id)description;	// IMP=0x001000000000e0b1
- (id)init;	// IMP=0x001000000000dff9
