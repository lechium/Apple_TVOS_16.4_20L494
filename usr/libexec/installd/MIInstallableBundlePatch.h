...
- (void).cxx_destruct;	// IMP=0x00200000000372ed
...
- (_Bool)applyPatchWithError:(id *)arg1;	// IMP=0x0010000000036f7e
- (_Bool)_applyDeltaPatchWithError:(id *)arg1;	// IMP=0x00100000000368bc
@property(readonly, nonatomic) NSString *patchTypeName; // @dynamic patchTypeName;
- (id)initWithBundle:(id)arg1 inStagingRoot:(id)arg2 packageFormat:(unsigned char)arg3 identity:(id)arg4 domain:(unsigned long long)arg5 userOptions:(id)arg6 manifestURL:(id)arg7 existingBundleContainer:(id)arg8 patchType:(unsigned char)arg9 error:(id *)arg10;	// IMP=0x0010000000036450
