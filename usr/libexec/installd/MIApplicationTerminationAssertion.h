...
- (void).cxx_destruct;	// IMP=0x00200000000421ab
...
- (void)assertionTargetProcessDidExit:(id)arg1;	// IMP=0x0010000000042140
- (void)dealloc;	// IMP=0x00100000000420ee
- (void)invalidate;	// IMP=0x0010000000042094
- (id)initWithBundleIdentifier:(id)arg1;	// IMP=0x0010000000041e1c
