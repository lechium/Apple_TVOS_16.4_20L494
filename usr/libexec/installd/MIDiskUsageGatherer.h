...
- (id)gatherUsageInfoWithError:(id *)arg1;	// IMP=0x0010000000029834
- (id)_gatherForIdentifier:(id)arg1;	// IMP=0x0010000000029236
- (id)initWithIdentifiers:(id)arg1 options:(id)arg2;	// IMP=0x00100000000290fe
