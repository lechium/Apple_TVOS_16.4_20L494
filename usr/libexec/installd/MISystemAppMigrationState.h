...
+ (id)defaultManager;	// IMP=0x00400000000415ad
- (void).cxx_destruct;	// IMP=0x0020000000041ba5
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x001000000004195e
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x001000000004146f
