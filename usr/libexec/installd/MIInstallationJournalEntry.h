...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003d9ed
+ (void)_attemptLSUpdateWithDiscoveredStateForIdentity:(id)arg1 domain:(unsigned long long)arg2;	// IMP=0x000000000003c021
+ (id)_registerUsingDiscoveredInfoForAppIdentity:(id)arg1 inDomain:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x001000000003bfef
- (void).cxx_destruct;	// IMP=0x0020000000040010
...
- (_Bool)finalizeWithError:(id *)arg1;	// IMP=0x001000000003fed0
- (_Bool)performLaunchServicesRegistrationWithError:(id *)arg1;	// IMP=0x001000000003fdd6
- (_Bool)finalizeContainersWithError:(id *)arg1;	// IMP=0x001000000003fcdc
- (_Bool)_performJournaledInstallAsReplay:(_Bool)arg1 withError:(id *)arg2;	// IMP=0x001000000003f58b
- (_Bool)_beginLaunchServicesRegistrationWithError:(id *)arg1;	// IMP=0x001000000003f4e8
- (_Bool)_gatherLaunchServicesRegistrationInfoWithError:(id *)arg1;	// IMP=0x001000000003f094
- (void)_updateContainerStatePostCommit;	// IMP=0x001000000003ee0c
- (_Bool)_commitContainersWithError:(id *)arg1;	// IMP=0x001000000003e558
- (_Bool)_updateReferencesWithError:(id *)arg1;	// IMP=0x001000000003e150
- (_Bool)_linkToParentApplication:(id *)arg1;	// IMP=0x001000000003e01d
- (_Bool)_refreshUUIDForContainer:(id)arg1 withError:(id *)arg2;	// IMP=0x001000000003dea4
- (_Bool)_updateJournalPhaseTo:(unsigned long long)arg1 withError:(id *)arg2;	// IMP=0x001000000003dd91
- (void)_purgeJournalEntry;	// IMP=0x001000000003dd43
- (_Bool)_writeJournalEntryWithError:(id *)arg1;	// IMP=0x001000000003dceb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003d30f
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003c552
- (_Bool)_findBundleContainerForToken:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003c433
- (_Bool)_populateSigningInfoWithError:(id *)arg1;	// IMP=0x001000000003c313
- (id)initWithIdentity:(id)arg1 bundleContainer:(id)arg2 existingBundleContainer:(id)arg3 installationDomain:(unsigned long long)arg4 operationType:(unsigned long long)arg5 installOptions:(id)arg6 bundleSigningInfo:(id)arg7;	// IMP=0x001000000003c15d
- (id)_registerInstalledInfo:(id)arg1 forIdentity:(id)arg2 inDomain:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x001000000003c008
- (id)_journalInstance;	// IMP=0x001000000003bfd6
- (id)_uninstalledAppList;	// IMP=0x001000000003bfbd
- (id)_containerProtectionManager;	// IMP=0x001000000003bfa4
- (id)_systemAppState;	// IMP=0x001000000003bf8b
- (id)_freeProfileValidatedAppTracker;	// IMP=0x001000000003bf72
- (id)_keychainAccessGroupTracker;	// IMP=0x001000000003bf59
- (id)_containerLinkManager;	// IMP=0x001000000003bf40
