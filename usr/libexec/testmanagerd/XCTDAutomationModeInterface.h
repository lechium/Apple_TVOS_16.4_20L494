...
+ (id)sharedInterface;	// IMP=0x002000000003c7e3
+ (void)provideCapabilitiesToBuilder:(id)arg1;	// IMP=0x001000000003c5b5
- (void).cxx_destruct;	// IMP=0x002000000003d22b
...
- (void)unregisterAutomationModeChangeHandlerWithToken:(id)arg1;	// IMP=0x001000000003d153
- (id)registerAutomationModeChangeHandlerOnQueue:(id)arg1 withBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000003d0cc
- (void)disableAutomationModeForClient:(id)arg1;	// IMP=0x001000000003cdc0
- (_Bool)enableAutomationModeForClient:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003cb85
@property(readonly) _Bool isAutomationModeEnabled;
- (void)dealloc;	// IMP=0x001000000003cadb
- (id)initForUnsupportedSystems;	// IMP=0x001000000003ca92
- (id)initWithAutomationModeFunctions:(CDStruct_6bdebbfa)arg1;	// IMP=0x001000000003c894
