...
- (void).cxx_destruct;	// IMP=0x002000000002ce26
...
- (id)initWithAccessibilitySystem:(id)arg1 timeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000002cc47
- (id)initWithApplicationLauncher:(id)arg1 siriInterface:(id)arg2 systemConfiguration:(id)arg3 axManager:(id)arg4 touchGesturePerformer:(id)arg5;	// IMP=0x001000000002caf7
- (_Bool)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000002c8cd
- (void)unloadAccessibility;	// IMP=0x001000000002c776
- (void)invalidate;	// IMP=0x001000000002c5d0
- (void)dealloc;	// IMP=0x001000000002c4a3
