...
+ (id)configurationForDisplayID:(unsigned int)arg1 error:(id *)arg2;	// IMP=0x002000000003ed3c
+ (id)sharedDisplayMonitor;	// IMP=0x001000000003ece7
- (void).cxx_destruct;	// IMP=0x002000000003f5b0
...
- (id)initWithDisplayID:(unsigned int)arg1;	// IMP=0x001000000003ed69
