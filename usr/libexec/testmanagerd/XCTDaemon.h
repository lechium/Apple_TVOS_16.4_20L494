...
- (void).cxx_destruct;	// IMP=0x00200000000346ed
...
- (void)setQueue:(id)arg1;	// IMP=0x00100000000345d5
- (id)queue;	// IMP=0x00100000000345c1
...
- (void)_queue_logStatus;	// IMP=0x0010000000033f54
- (void)_queue_closeTestSession:(id)arg1;	// IMP=0x0010000000033de0
- (void)closeTestSession:(id)arg1;	// IMP=0x0010000000033d11
- (void)closeIDESession:(id)arg1;	// IMP=0x0010000000033832
- (void)closeTargetBootstrapSession:(id)arg1;	// IMP=0x00100000000335d6
- (void)_queue_fulfillTestConnectionRequest:(CDUnknownBlockType)arg1 usingIDESession:(id)arg2;	// IMP=0x001000000003349b
- (void)_queue_fulfillLegacyTestConnectionRequest:(CDUnknownBlockType)arg1 usingIDESession:(id)arg2;	// IMP=0x0010000000033115
- (void)_queue_handleRequestForSessionWithIdentifier:(id)arg1;	// IMP=0x0010000000032f11
- (void)_queue_advertiseAvailabilityToTargetWithPID:(int)arg1;	// IMP=0x0010000000032c68
- (void)_queue_processTargetSessionRequests;	// IMP=0x001000000003280a
- (void)_queue_requestTargetBootstrapSessionForPID:(int)arg1 timeout:(double)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00100000000323c8
- (void)requestTargetBootstrapSessionForPID:(int)arg1 timeout:(double)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00100000000322dc
- (void)_queue_processPendingTransferObservationBlocks;	// IMP=0x0010000000031f26
- (void)setObserverForConnectionTransferToTargetWithPID:(int)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000031d33
- (void)connectionTransferToTargetWithPID:(int)arg1 completedWithSuccess:(_Bool)arg2 error:(id)arg3;	// IMP=0x0010000000031b13
- (void)requestSerializedTransportForSessionIdentifier:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000031921
- (void)requestLegacySocketForSessionIdentifier:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x001000000003172f
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000003140e
- (void)addTargetBootstrapSession:(id)arg1;	// IMP=0x00100000000310eb
- (void)setIDESession:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0010000000030da5
- (void)controlSession:(id)arg1 didAuthorizeProcessID:(int)arg2;	// IMP=0x0010000000030d0e
- (void)addControlSession:(id)arg1;	// IMP=0x0010000000030b28
- (void)remoteAutomationSessionDidClose:(id)arg1;	// IMP=0x00100000000309f1
- (void)serverDidHandleDisconnectForSocket:(int)arg1;	// IMP=0x00100000000309eb
- (void)serverReceivedConnectionForServiceType:(unsigned long long)arg1 overSocket:(int)arg2 effectiveUserIdentifier:(unsigned int)arg3 disconnectionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000306af
- (void)reportSelfDiagnosisIssue:(id)arg1 description:(id)arg2;	// IMP=0x00100000000305da
- (void)setupSignalHandlers;	// IMP=0x00100000000302a1
- (void)run;	// IMP=0x00100000000300b8
- (void)startAcceptingTargetConnectionsFromListener:(id)arg1;	// IMP=0x001000000002ff94
- (void)startAcceptingTestConnectionsFromListener:(id)arg1;	// IMP=0x001000000002fe70
- (id)init;	// IMP=0x001000000002fc8e
