...
- (void).cxx_destruct;	// IMP=0x002000000001c252
...
- (void)applicationDidUpdateState:(id)arg1;	// IMP=0x001000000001c17d
- (id)init;	// IMP=0x001000000001c105
- (id)initWithProcessMonitor:(id)arg1 processAssertionManager:(id)arg2;	// IMP=0x001000000001c06f
- (void)invalidate;	// IMP=0x001000000001bf2d
- (void)dealloc;	// IMP=0x001000000001be7b
