...
- (id)gestureNamesWaitForTimeInterval:(double *)arg1;	// IMP=0x0010000000009e5f
- (id)eventTypeNameWaitForTimeInterval:(double *)arg1;	// IMP=0x0010000000009d97
@property(readonly, getter=isHandEvent) _Bool handEvent;
- (id)init;	// IMP=0x0010000000009c84
