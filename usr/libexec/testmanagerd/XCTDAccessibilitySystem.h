...
+ (id)sharedSystem;	// IMP=0x002000000001c283
- (void).cxx_destruct;	// IMP=0x002000000001daf8
...
- (id)_queue_createAccessibilitySessionToken;	// IMP=0x001000000001d918
- (void)invalidateToken:(id)arg1;	// IMP=0x001000000001d70f
- (void)_queue_setAccelerometerEnabled:(_Bool)arg1;	// IMP=0x001000000001d58b
- (void)_queue_setPassiveListeningModeEnabled:(_Bool)arg1;	// IMP=0x001000000001d300
- (void)_queue_unloadAccessibility;	// IMP=0x001000000001d0d7
- (_Bool)_queue_setDisableOnTerminationWithError:(id *)arg1;	// IMP=0x001000000001cee0
- (_Bool)_queue_loadAccessibilityIfNeeded:(_Bool)arg1 andWaitForNotificationWithTimeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000001cb1f
- (id)_queue_loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001c7b2
- (id)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001c513
- (void)dealloc;	// IMP=0x001000000001c412
- (id)initWithAccessibilityFunctions:(CDStruct_f25c63ae)arg1;	// IMP=0x001000000001c32b
