...
- (void).cxx_destruct;	// IMP=0x0020000000014090
...
- (void)updateCurrentProgress:(double)arg1;	// IMP=0x0010000000013f89
- (id)initWithThresholdTimeInterval:(double)arg1;	// IMP=0x0010000000013ec2
