...
- (void).cxx_destruct;	// IMP=0x00200000000107b6
...
- (void)dealloc;	// IMP=0x00100000000103ed
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x001000000000f764
- (_Bool)_validateOutputSize;	// IMP=0x001000000000f5cf
- (_Bool)_validateOrientation;	// IMP=0x001000000000f4a6
- (_Bool)_validateMetadata;	// IMP=0x001000000000f31e
- (_Bool)_validateSource;	// IMP=0x001000000000f0ed
- (void)_validate;	// IMP=0x001000000000ef85
- (_Bool)validateSourceAndOptions;	// IMP=0x001000000000ef4c
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x001000000000edef
