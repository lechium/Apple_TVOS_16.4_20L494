...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x0020000000015072
+ (_Bool)supportsDeduplication;	// IMP=0x001000000001506a
- (void).cxx_destruct;	// IMP=0x0020000000014fba
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x0010000000014d15
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x0010000000014ca0
- (_Bool)isPassthroughConversion;	// IMP=0x0010000000014c2b
- (void)startProgressUpdateTimerAndMarkStartTime;	// IMP=0x0010000000014c25
- (void)cancel;	// IMP=0x0010000000014c1f
- (void)performConversion;	// IMP=0x0010000000014ba2
- (void)didEnqueue;	// IMP=0x0010000000014b40
- (_Bool)wantsResultAsData;	// IMP=0x0010000000014acb
- (void)updateResultTracker;	// IMP=0x0010000000014978
- (void)callCompletionHandler;	// IMP=0x001000000001467d
- (void)loadAsset;	// IMP=0x00100000000144f0
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x00100000000141f0
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x00100000000140a0
