...
- (void).cxx_destruct;	// IMP=0x002000000000acc5
...
- (_Bool)allRequestsAreBackground;	// IMP=0x001000000000aae6
- (_Bool)allRequestsAreOptional;	// IMP=0x001000000000aa47
- (_Bool)allRequestsHaveRequestPriority:(long long)arg1;	// IMP=0x001000000000a9a1
- (long long)compareProcessingOrderToEntry:(id)arg1;	// IMP=0x001000000000a7b2
@property(readonly) NSArray *clientRequestsSnapshot;
- (void)videoConversionTask:(id)arg1 didUpdateFractionCompleted:(double)arg2;	// IMP=0x001000000000a613
- (id)requestIdentifiersForConnectionIdentifier:(id)arg1;	// IMP=0x001000000000a535
- (id)anyDestinationURLCollection;	// IMP=0x001000000000a462
- (id)clientRequestForIdentifier:(id)arg1;	// IMP=0x001000000000a34e
- (id)removeAndReturnClientRequestWithIdentifier:(id)arg1 remainingRequestCount:(long long *)arg2;	// IMP=0x001000000000a111
- (_Bool)clientRequestIsDuplicate:(id)arg1 identicalDestination:(_Bool *)arg2;	// IMP=0x001000000000a024
- (void)didDequeueAndStartProcessingQueueEntry;	// IMP=0x001000000000a00b
- (void)withLockEnumerateClientRequests:(CDUnknownBlockType)arg1;	// IMP=0x0010000000009f5f
- (void)addClientRequest:(id)arg1;	// IMP=0x0010000000009e80
- (id)description;	// IMP=0x0010000000009daf
- (void)dealloc;	// IMP=0x0010000000009c86
- (id)initWithIdentifier:(id)arg1 initialConversionOptions:(id)arg2;	// IMP=0x0010000000009b52
