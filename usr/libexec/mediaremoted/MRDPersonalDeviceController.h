...
- (void).cxx_destruct;	// IMP=0x0020000000046879
...
- (void)_onQueue_beginTimerWithInterval:(double)arg1;	// IMP=0x001000000004658b
- (void)_onQueue_recalculateStateForReason:(id)arg1;	// IMP=0x0010000000045f9b
- (void)_onQueue_restoreState;	// IMP=0x0010000000045c19
- (void)_handlePersonalDeviceChangeNotification:(id)arg1;	// IMP=0x0010000000045bb1
- (id)init;	// IMP=0x00100000000459d9
