...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x0040000000045804
- (void).cxx_destruct;	// IMP=0x00200000000459c9
...
- (id)_extendedInfo;	// IMP=0x001000000004597e
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x0010000000045855
