...
// Error: Property attributes should begin with the type ('T') attribute, property name: lastNotPlayingDate
// Property attributes: (null)

@property(retain, nonatomic) NSDate *lastPlayingDate; // @synthesize lastPlayingDate=_lastPlayingDate;
@property(nonatomic) _Bool isPlaying; // @synthesize isPlaying=_isPlaying;
@property(readonly, nonatomic) NSDate *date;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000048e28
- (id)description;	// IMP=0x0010000000048d1f
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000048b33
