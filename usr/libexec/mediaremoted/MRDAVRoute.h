...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x004000000010aa59
- (void).cxx_destruct;	// IMP=0x002000000010ac24
...
- (unsigned long long)sampleRate;	// IMP=0x001000000010abb2
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x001000000010ab3b
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000010aaa9
