...
- (void).cxx_destruct;	// IMP=0x0020000000051f21
...
- (id)concatenatedTextForDocumentState:(id)arg1;	// IMP=0x0010000000051c82
- (void)_setCurrentSession:(id)arg1;	// IMP=0x0010000000051c6e
- (void)_killRemoteTextEditingSession;	// IMP=0x0010000000051be4
- (oneway void)endRemoteTextInputSessionWithID:(id)arg1;	// IMP=0x0010000000051aa7
- (oneway void)remoteTextInputSessionWithID:(id)arg1 documentTraitsDidChange:(id)arg2;	// IMP=0x00100000000519aa
- (oneway void)remoteTextInputSessionWithID:(id)arg1 documentDidChange:(id)arg2;	// IMP=0x0010000000051838
- (oneway void)beginRemoteTextInputSessionWithID:(id)arg1 documentTraits:(id)arg2 initialDocumentState:(id)arg3;	// IMP=0x0010000000050de0
@property(readonly, nonatomic) MRTextEditingSession *currentSession;
- (void)didInitializeWithConnection:(id)arg1;	// IMP=0x0010000000050cb9
