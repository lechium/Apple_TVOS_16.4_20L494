...
- (void).cxx_destruct;	// IMP=0x0020000000102419
...
- (void)_postNotification:(id)arg1;	// IMP=0x0010000000102174
- (void)_resumeConnection;	// IMP=0x0010000000101cb6
- (void)_wakeDevice:(_Bool)arg1 dismissScreenSaver:(_Bool)arg2 reason:(id)arg3;	// IMP=0x0010000000101add
- (id)_runAssertionName;	// IMP=0x0010000000101aa3
- (void)_invalidate;	// IMP=0x0010000000101a49
- (void)_handleXPCMessage:(id)arg1;	// IMP=0x00100000001019d7
- (void)connectionDidResume:(id)arg1;	// IMP=0x00100000001019c5
- (id)createNowPlayingClient;	// IMP=0x001000000010194a
- (void)_relayXPCMessage:(id)arg1 andReply:(_Bool)arg2 resultCallback:(CDUnknownBlockType)arg3;	// IMP=0x00100000001013ce
- (void)relayXPCMessage:(id)arg1 andReply:(_Bool)arg2 resultCallback:(CDUnknownBlockType)arg3;	// IMP=0x00100000001011cf
- (void)relayXPCMessage:(id)arg1 andReply:(_Bool)arg2;	// IMP=0x00100000001011ba
- (void)sendRemoteControlCommandWithoutRedirection:(id)arg1 withCompletionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000000ffcf1
- (void)sendRemoteControlCommand:(id)arg1 withCompletionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fea6d
- (_Bool)takeAssertionAndBlessForReason:(id)arg1;	// IMP=0x00100000000fe993
- (_Bool)takeAssertion:(long long)arg1 forReason:(id)arg2 duration:(double)arg3;	// IMP=0x00100000000fe26d
- (void)setWantsAssertionsForNotificationsWithPlayerPath:(id)arg1;	// IMP=0x00100000000fe1ae
- (_Bool)notificationRequiresTaskAssertionForPlayerPath:(id)arg1;	// IMP=0x00100000000fe0e1
- (void)postNotification:(id)arg1;	// IMP=0x00100000000fdf91
- (_Bool)isAllowedAccessToDataFromPlayerPath:(id)arg1;	// IMP=0x00100000000fdf89
- (void)flushPendingPlaybackSessionMigrateEvents:(CDUnknownBlockType)arg1;	// IMP=0x00100000000fdca6
- (_Bool)removePendingPlaybackSessionMigrateEvent:(id)arg1;	// IMP=0x00100000000fdb12
- (void)addPendingPlaybackSessionMigrateEvent:(id)arg1 playerPath:(id)arg2;	// IMP=0x00100000000fd9a7
- (_Bool)isEntitledFor:(unsigned long long)arg1;	// IMP=0x00100000000fd985
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000fd17f
...
- (id)initWithConnection:(id)arg1;	// IMP=0x00100000000fbff0
