...
- (void).cxx_destruct;	// IMP=0x002000000010bff2
...
- (void)releaseScreenMirroringQuickControlsAssertion;	// IMP=0x001000000010bf33
- (void)acquireScreenMirroringQuickControlsAssertion;	// IMP=0x001000000010bece
- (void)releaseQuickControlsAssertion;	// IMP=0x001000000010be5a
- (id)acquireQuickControlsAssertion;	// IMP=0x001000000010bd11
- (void)releaseLockScreenControlsAssertion;	// IMP=0x001000000010bc9d
- (void)acquireLockScreenControlsAssertion;	// IMP=0x001000000010bc26
- (id)synchronousServer;	// IMP=0x001000000010bada
@property(readonly, nonatomic) id <MRUIServerXPCProtocol> server;
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (_Bool)hasUIAssertions;	// IMP=0x001000000010b4b8
- (void)_updateTransaction;	// IMP=0x001000000010b3c8
- (void)dealloc;	// IMP=0x001000000010b15f
- (id)init;	// IMP=0x001000000010b092
