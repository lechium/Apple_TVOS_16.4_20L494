...
- (void).cxx_destruct;	// IMP=0x00200000000cd40a
...
// Error: Property attributes should begin with the type ('T') attribute, property name: hasLockScreenAssertion
// Property attributes: (null)

- (void)dealloc;	// IMP=0x00100000000cd34f
- (id)description;	// IMP=0x00100000000cd30e
- (id)initWithConnection:(id)arg1 bundleID:(id)arg2;	// IMP=0x00100000000cd26b
