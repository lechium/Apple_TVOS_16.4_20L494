...
- (void).cxx_destruct;	// IMP=0x00200000000787a9
...
- (id)_coealesceItems:(id)arg1;	// IMP=0x00100000000783c5
@property(readonly, nonatomic) MRNowPlayingState *state;
- (id)description;	// IMP=0x0010000000076b05
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0010000000076a9a
