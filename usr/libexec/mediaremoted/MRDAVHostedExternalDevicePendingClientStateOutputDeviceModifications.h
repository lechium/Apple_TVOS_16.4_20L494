...
- (void).cxx_destruct;	// IMP=0x0020000000022d10
...
- (void)removeOutputDevice:(id)arg1;	// IMP=0x0010000000022c0e
- (void)changeOutputDevice:(id)arg1;	// IMP=0x0010000000022b78
- (void)addOutputDevice:(id)arg1;	// IMP=0x0010000000022b00
- (id)description;	// IMP=0x00100000000229cf
