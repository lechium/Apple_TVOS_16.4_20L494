...
- (void).cxx_destruct;	// IMP=0x0020000000105a04
...
- (void)cancel;	// IMP=0x00100000001059e4
- (void)respondWithAuthorizationToken:(id)arg1;	// IMP=0x00100000001059d2
- (id)initWithRoute:(id)arg1 inputType:(long long)arg2 responseCallback:(CDUnknownBlockType)arg3 cancelCallback:(CDUnknownBlockType)arg4;	// IMP=0x00100000001058e5
