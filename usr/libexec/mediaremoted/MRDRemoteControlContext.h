...
- (void).cxx_destruct;	// IMP=0x0020000000012a67
...
- (void)clearRoutedCommands;	// IMP=0x00100000000129ee
- (void)addRoutedCommand:(id)arg1;	// IMP=0x00100000000127fb
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x00100000000125d1
