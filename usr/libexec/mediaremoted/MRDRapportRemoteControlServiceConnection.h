...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002ce30
- (void).cxx_destruct;	// IMP=0x002000000002d1ec
...
- (void)dealloc;	// IMP=0x001000000002d079
- (id)description;	// IMP=0x001000000002d031
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002cecd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002ce38
