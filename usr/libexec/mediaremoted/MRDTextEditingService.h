...
- (void).cxx_destruct;	// IMP=0x00200000000c285b
...
- (void)textEditingDidDieForConnection:(id)arg1;	// IMP=0x00100000000c2738
- (void)_textEditingDidEndForConnection:(id)arg1;	// IMP=0x00100000000c265f
- (void)textEditingDidEndForConnection:(id)arg1;	// IMP=0x00100000000c2513
- (void)textEditingConnection:(id)arg1 attributesDidChange:(id)arg2;	// IMP=0x00100000000c2367
- (void)textEditingConnection:(id)arg1 textDidChange:(id)arg2;	// IMP=0x00100000000c21bb
- (void)textEditingConnection:(id)arg1 didBeginEditingText:(id)arg2 withAttributes:(id)arg3;	// IMP=0x00100000000c1eaa
- (void)inputSystemService:(id)arg1 didCreateInputSession:(id)arg2;	// IMP=0x00100000000c1d91
...
- (_Bool)handleTextInputMessage:(id)arg1 withError:(id *)arg2;	// IMP=0x00100000000c196f
- (void)stop;	// IMP=0x00100000000c1930
- (void)start;	// IMP=0x00100000000c183e
@property(readonly, nonatomic, getter=isRunning) _Bool running;
- (void)dealloc;	// IMP=0x00100000000c179e
- (id)init;	// IMP=0x00100000000c1705
