...
- (void).cxx_destruct;	// IMP=0x002000000003af36
...
- (void)_maybeWakeClient;	// IMP=0x001000000003ac56
- (void)_resumeConnection;	// IMP=0x001000000003a830
- (void)_notifyAvailableEndpointsDidChange:(id)arg1;	// IMP=0x001000000003a5d3
- (void)_notifyAvailableOutputDevicesDidChange:(id)arg1;	// IMP=0x001000000003a376
- (void)_invalidate;	// IMP=0x001000000003a322
- (void)connectionDidResume:(id)arg1;	// IMP=0x001000000003a310
- (void)getAvailableOutputDevicesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003a2ae
- (void)getAvailableEndpointsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003a24c
- (void)setDiscoveryMode:(unsigned int)arg1 enableThrottling:(_Bool)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000003a196
- (void)getDiscoveryModeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003a183
- (void)getDevicePresenceDetectedWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003a134
- (void)hostedRoutingController:(id)arg1 outputDevicesDidChange:(id)arg2 forFeature:(unsigned int)arg3;	// IMP=0x0010000000039fcd
- (void)hostedRoutingController:(id)arg1 endpointsDidChange:(id)arg2;	// IMP=0x0010000000039e66
@property(readonly, copy) NSString *debugDescription;
- (void)dealloc;	// IMP=0x00100000000399ac
- (id)initWithConnection:(id)arg1 hostedRoutingController:(id)arg2;	// IMP=0x0010000000039527
