...
@class MISSING_TYPE, MRApplicationActivity, MRDCommandClientRestriction, MRDMediaRemoteClient, MRDRemoteControlService, MROrigin, MROutputContextDataSource, MRPlayerPath, NSArray, NSDate, NSDictionary, NSString, _MRAVAirPlaySecuritySettingsProtobuf;
...
@interface MRDDiagnostic : NSObject
{
    ...
    MISSING_TYPE *_batchedNowPlayingState;	// 208 = 0xd0
...
- (void).cxx_destruct;	// IMP=0x00200000000cc308
...
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4 usingDebugDescription:(_Bool)arg5;	// IMP=0x00100000000cbace
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4;	// IMP=0x00100000000cbaac
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x00100000000cba87
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 usingDebugDescription:(_Bool)arg4;	// IMP=0x00100000000cb9c7
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x00100000000cb9b2
- (void)_appendSubheader:(id)arg1 toString:(id)arg2;	// IMP=0x00100000000cb98e
- (id)createDiagnosticInfo;	// IMP=0x00100000000ca88d
- (id)init;	// IMP=0x00100000000ca837
