...
- (void).cxx_destruct;	// IMP=0x002000000010a4d8
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x001000000010a3d0
- (id)_optionsDictionary;	// IMP=0x001000000010a346
- (void)_setCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000010a319
- (CDUnknownBlockType)_completionHandler;	// IMP=0x001000000010a303
- (id)optionValueForKey:(struct __CFString *)arg1;	// IMP=0x001000000010a2a4
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000109ca4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000109c78
- (id)debugDescription;	// IMP=0x0010000000109b2d
- (id)description;	// IMP=0x0010000000109a16
- (id)initWithCommandType:(unsigned int)arg1 playerPath:(id)arg2 unresolvedPlayerPath:(id)arg3 senderAppDisplayID:(id)arg4 optionsData:(id)arg5;	// IMP=0x00100000001098a2
