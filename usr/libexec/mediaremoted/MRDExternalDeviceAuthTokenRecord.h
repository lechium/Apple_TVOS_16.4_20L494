...
- (void).cxx_destruct;	// IMP=0x002000000010c128
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x001000000010c079
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010c046
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010c01a
