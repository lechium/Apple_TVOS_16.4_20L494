...
- (void).cxx_destruct;	// IMP=0x00200000000f5c20
...
- (void)notifyDelegateOfWake;	// IMP=0x00100000000f5b59
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000f5abd
- (id)init;	// IMP=0x00100000000f57ec
