...
- (void).cxx_destruct;	// IMP=0x00200000000e16fc
...
- (void)_onCalloutQueue_notifyStatusDidChange:(unsigned long long)arg1;	// IMP=0x00100000000e11b9
- (void)_checkConnectionStatus;	// IMP=0x00100000000e0cec
- (_Bool)_canSendMessage;	// IMP=0x00100000000e0c06
- (void)canSendMessage:(CDUnknownBlockType)arg1;	// IMP=0x00100000000e0b4b
@property(readonly, nonatomic) NSString *label;
- (id)debugDescription;	// IMP=0x00100000000e0870
- (id)description;	// IMP=0x00100000000e07e5
- (id)_initWithLabel:(id)arg1;	// IMP=0x00100000000e0734
- (id)initWithXPCConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000e067a
- (id)initWithConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000e05af
