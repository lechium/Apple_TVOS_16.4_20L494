...
- (void).cxx_destruct;	// IMP=0x00200000000c9929
...
- (void)_onSyncSelf_maybeSetupPlaybackTimeoutTimerForEvent:(long long)arg1;	// IMP=0x00100000000c9510
- (id)_onSyncSelf_calculateElectedPlayerForOriginClient:(id)arg1 event:(long long)arg2 reason:(id *)arg3;	// IMP=0x00100000000c91ef
- (long long)_resolveChangeTypeWithOriginClient:(id)arg1 forEvent:(long long)arg2;	// IMP=0x00100000000c8e42
- (void)_onSyncSelf_reevaluateElectedPlayerForEvent:(long long)arg1 withReason:(id)arg2;	// IMP=0x00100000000c899a
- (void)_handleActiveSystemEndpointDidChangeNotification:(id)arg1;	// IMP=0x00100000000c839f
- (void)_handleNowPlayingApplicationDidForegroundNotification:(id)arg1;	// IMP=0x00100000000c824e
- (void)_handleNowPlayingApplicationDidChangeNotification:(id)arg1;	// IMP=0x00100000000c8135
- (void)_handleIsPlayingDidChangeNotification:(id)arg1;	// IMP=0x00100000000c7fb6
- (void)_handlePlaybackQueueChangedNotification:(id)arg1;	// IMP=0x00100000000c7eab
- (_Bool)_shouldUseNotification:(id)arg1;	// IMP=0x00100000000c7e11
@property(retain, nonatomic) NSString *activeSystemEndpointOutputDeviceUID;
- (void)setOriginClient:(id)arg1 withChangeType:(long long)arg2;	// IMP=0x00100000000c7cb1
- (id)initWithOriginClient:(id)arg1;	// IMP=0x00100000000c78ab
