...
- (void).cxx_destruct;	// IMP=0x00200000000cd1e7
...
- (id)_notifyDelegateWithConnection:(id)arg1;	// IMP=0x00100000000ccfb5
- (void)stop;	// IMP=0x00100000000ccf4f
- (void)start;	// IMP=0x00100000000ccee8
- (id)idsRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000cced3
- (id)idsCompanionRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000ccebe
- (void)rapportRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000ccea0
- (void)airPlayRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000cce82
- (void)bonjourRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000cce64
@property(readonly, copy) NSString *debugDescription;
- (void)_initializeIDSRemoteControlServiceWithRoutingDataSource:(id)arg1;	// IMP=0x00100000000cc82c
- (id)initWithRoutingDataSource:(id)arg1;	// IMP=0x00100000000cc55b
