...
- (void).cxx_destruct;	// IMP=0x0020000000024bd9
...
- (id)dictionaryRepresentation;	// IMP=0x0010000000024a2e
- (id)description;	// IMP=0x00100000000249de
- (id)initWithPID:(int)arg1 audioSessionID:(id)arg2 mxSessionIDs:(id)arg3;	// IMP=0x001000000002493b
