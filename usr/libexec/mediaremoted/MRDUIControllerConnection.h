...
+ (id)serviceInterface;	// IMP=0x00200000000529a1
- (void).cxx_destruct;	// IMP=0x0020000000052ae1
...
- (void)dealloc;	// IMP=0x00100000000521ac
- (id)initWithClientObject:(id)arg1 invalidationHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000052069
