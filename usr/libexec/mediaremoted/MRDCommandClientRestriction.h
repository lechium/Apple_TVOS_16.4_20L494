...
+ (id)restrictedTo:(id)arg1 by:(id)arg2;	// IMP=0x00200000000c28ad
- (void).cxx_destruct;	// IMP=0x00200000000c2d00
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c2b9b
- (id)description;	// IMP=0x00100000000c2970
