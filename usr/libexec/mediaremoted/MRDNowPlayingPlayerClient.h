...
- (void).cxx_destruct;	// IMP=0x001000000001d55b
...
- (void)_onQueue_popState;	// IMP=0x001000000001caeb
- (void)_onQueue_pushState;	// IMP=0x001000000001c9cc
- (void)_onQueue_playbackQueueContentItemsArtworkDidChange:(id)arg1;	// IMP=0x001000000001c918
- (void)_onQueue_playbackQueueContentItemsDidChange:(id)arg1;	// IMP=0x001000000001c864
- (void)_onQueue_playbackQueueCapabilitiesDidChange:(unsigned long long)arg1;	// IMP=0x001000000001c813
- (void)_onQueue_playbackQueueDidChange:(id)arg1 nowPlayingItemChanged:(_Bool)arg2;	// IMP=0x001000000001c782
- (void)_onQueue_supportedCommandsDidChange:(id)arg1;	// IMP=0x001000000001c6f7
- (void)_onQueue_playbackStateDidChanged:(id)arg1;	// IMP=0x001000000001c5ed
- (void)_onQueue_pictureInPictureEnabledDidChanged:(_Bool)arg1;	// IMP=0x001000000001c59c
- (void)_onQueue_isPlayingDidChange:(_Bool)arg1;	// IMP=0x001000000001c51b
- (void)_onQueue_canBeNowPlayingDidChange:(_Bool)arg1;	// IMP=0x001000000001c4ca
- (void)_handleNowPlayingAppDidChange:(id)arg1;	// IMP=0x001000000001c3d6
- (id)playbackQueueForRequest:(id)arg1 cachingPolicy:(unsigned int)arg2 playerPath:(id)arg3 partiallyCachedItems:(id *)arg4;	// IMP=0x001000000001c0c8
- (id)_sortSnapshots:(id)arg1;	// IMP=0x001000000001c094
@property(readonly, nonatomic) NSArray *snapshots;
- (id)snapshotForIsPlaying:(_Bool)arg1;	// IMP=0x001000000001bf18
- (id)snapshotsForIsPlaying:(_Bool)arg1;	// IMP=0x001000000001bcdc
- (id)snapshotForPlaybackState:(unsigned int)arg1;	// IMP=0x001000000001bba3
- (void)notifyArtworkChangedForContentItems:(id)arg1;	// IMP=0x001000000001bab9
- (void)_onQueue_updatePlaybackQueue:(id)arg1 fromRequest:(id)arg2;	// IMP=0x001000000001b4fe
- (void)updatePlaybackQueue:(id)arg1 fromRequest:(id)arg2;	// IMP=0x001000000001b425
- (void)updatePlaybackQueue:(id)arg1;	// IMP=0x001000000001b411
- (void)updatePlayer:(id)arg1;	// IMP=0x001000000001b311
- (void)updateClient:(id)arg1;	// IMP=0x001000000001b237
...
- (id)_onQueue_lastPlayingDate;	// IMP=0x001000000001b02e
...
- (_Bool)_onQueue_isPlaying;	// IMP=0x001000000001aa07
@property(readonly, nonatomic) _Bool isPlaying;
@property(nonatomic) unsigned long long playbackQueueCapabilities;
- (id)_onQueue_playbackState;	// IMP=0x001000000001a448
...
- (void)updateLastPlayingDate:(id)arg1;	// IMP=0x0010000000019e64
- (void)updatePlaybackState:(unsigned int)arg1 date:(id)arg2;	// IMP=0x0010000000019ba2
...
- (id)description;	// IMP=0x0010000000018529
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0010000000018321
- (id)activeContent;	// IMP=0x001000000001827e
- (_Bool)isActiveStream;	// IMP=0x001000000001826c
