...
- (void).cxx_destruct;	// IMP=0x002000000003a2f6
...
- (MISSING_TYPE *)localPBStatus;	// IMP=0x0010000000039871
- (id)statusString;	// IMP=0x0010000000039864
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x00100000000393cd
- (void)showProgressUI:(id)arg1;	// IMP=0x0010000000038853
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000037b69
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x0010000000036f93
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000351b9
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x001000000003505e
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x001000000003504c
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000032602
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000304d0
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000301c5
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x00100000000300d1
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x001000000002fe5e
- (void)clearLocalPasteboardInformation;	// IMP=0x001000000002fd91
- (void)localPasteboardTypesDidChange:(id)arg1 forGeneration:(unsigned long long)arg2;	// IMP=0x001000000002f6d4
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f606
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f594
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f475
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x001000000002f0cc
- (id)currentPasteboardActivityInfo;	// IMP=0x001000000002edaf
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x001000000002ec58
- (id)items;	// IMP=0x001000000002ec46
- (void)startConnection:(int)arg1;	// IMP=0x001000000002ebb1
...
- (id)uuid;	// IMP=0x001000000002e934
- (void)dealloc;	// IMP=0x001000000002e86c
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000002e19c
