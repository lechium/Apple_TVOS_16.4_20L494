...
- (void).cxx_destruct;	// IMP=0x0020000000013e04
...
- (id)statusString;	// IMP=0x0010000000013cb3
- (_Bool)terminate;	// IMP=0x0010000000013b50
- (_Bool)resume;	// IMP=0x0010000000013a31
- (_Bool)suspend;	// IMP=0x001000000001390c
@property _Bool suspended;
@property(readonly) _Bool active;
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000013683
