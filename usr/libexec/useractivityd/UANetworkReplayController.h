...
+ (_Bool)createConnection:(id)arg1 host:(id)arg2 port:(long long)arg3;	// IMP=0x0020000000078a06
- (void).cxx_destruct;	// IMP=0x0020000000078c41
...
- (_Bool)terminate;	// IMP=0x001000000007880b
- (id)statusString;	// IMP=0x00100000000786bf
- (_Bool)sendResponse:(id)arg1;	// IMP=0x00100000000783cf
- (_Bool)processCommand:(id)arg1;	// IMP=0x0010000000077793
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000076434
- (id)initWithManager:(id)arg1 service:(id)arg2;	// IMP=0x00100000000761a4
- (id)initWithManager:(id)arg1 inputStream:(id)arg2 outputStream:(id)arg3 name:(id)arg4;	// IMP=0x0010000000075f41
