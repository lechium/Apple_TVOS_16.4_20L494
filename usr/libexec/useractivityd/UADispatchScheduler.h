...
+ (id)dispatchScheduler:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x004000000002b75f
- (void).cxx_destruct;	// IMP=0x002000000002c74e
...
- (id)nextRunTimeString;	// IMP=0x001000000002c697
- (void)waitUntilComplete;	// IMP=0x001000000002c613
- (void)suspend;	// IMP=0x001000000002c59d
- (void)resume;	// IMP=0x001000000002c568
- (void)reset;	// IMP=0x001000000002c3a6
- (void)updateFrequency:(double)arg1;	// IMP=0x001000000002c1bd
- (void)_doIt;	// IMP=0x001000000002beeb
- (void)doIt;	// IMP=0x001000000002be64
- (_Bool)scheduleAt:(id)arg1;	// IMP=0x001000000002bdf5
- (_Bool)scheduleNext:(double)arg1;	// IMP=0x001000000002b814
- (id)init:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x001000000002b457
