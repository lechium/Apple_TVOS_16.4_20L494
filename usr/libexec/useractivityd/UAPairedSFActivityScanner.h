...
- (void).cxx_destruct;	// IMP=0x002000000004639b
...
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000461a5
- (void)receiveAdvertisement:(id)arg1 options:(id)arg2 fromPeer:(id)arg3;	// IMP=0x0010000000045f58
- (void)scanForTypes:(unsigned long long)arg1;	// IMP=0x0010000000045f52
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000045e7d
