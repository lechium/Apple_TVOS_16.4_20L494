...
- (void).cxx_destruct;	// IMP=0x00200000000450c8
...
- (_Bool)terminate;	// IMP=0x0010000000044a78
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000004490e
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000044908
- (_Bool)processCommands:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000004463f
- (_Bool)sendResponse:(id)arg1;	// IMP=0x0010000000044637
- (_Bool)processCommand:(id)arg1;	// IMP=0x0010000000042177
- (id)scanMockAdvertisement:(id)arg1;	// IMP=0x001000000004182e
- (void)doAdvertiseAdvertisementPayload:(id)arg1 options:(id)arg2;	// IMP=0x001000000004153d
- (id)sharingAdvertiser;	// IMP=0x001000000004135c
- (id)sharingReceiver;	// IMP=0x001000000004117b
- (void)dealloc;	// IMP=0x0010000000040eee
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000040950
