...
- (void).cxx_destruct;	// IMP=0x00200000000140b1
...
- (id)reportedActivityType;	// IMP=0x0010000000014004
- (id)eventPayload;	// IMP=0x0010000000013f07
- (id)eventName;	// IMP=0x0010000000013efa
