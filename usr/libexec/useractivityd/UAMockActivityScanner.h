...
- (void).cxx_destruct;	// IMP=0x0020000000069f79
...
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000069dc8
- (id)initWithController:(id)arg1;	// IMP=0x0010000000069d5d
