...
- (void).cxx_destruct;	// IMP=0x00200000000038b4
...
- (void)_provideItemAtURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003769
- (void)_provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000035bc
- (void)unlockWithError:(id)arg1;	// IMP=0x001000000000333d
- (id)initWithURL:(id)arg1;	// IMP=0x001000000000326e
