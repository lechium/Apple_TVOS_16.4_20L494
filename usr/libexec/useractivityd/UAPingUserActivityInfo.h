...
- (id)statusString;	// IMP=0x00100000000047de
- (id)initFromPing:(id)arg1;	// IMP=0x001000000000474b
- (id)initWithPayloadSize:(unsigned long long)arg1;	// IMP=0x001000000000463a
