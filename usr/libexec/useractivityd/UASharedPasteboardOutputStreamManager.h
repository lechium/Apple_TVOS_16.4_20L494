...
- (void).cxx_destruct;	// IMP=0x0020000000067dc5
...
- (void)shutdownStream;	// IMP=0x0010000000067b07
- (void)shutdownTimerFired:(id)arg1;	// IMP=0x0010000000067a44
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000000672b2
- (id)headerForData:(id)arg1;	// IMP=0x00100000000671ea
- (void)sendTypes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000066e60
- (id)initWithOutputStream:(id)arg1 inputStream:(id)arg2 pasteboard:(id)arg3;	// IMP=0x0010000000066cca
