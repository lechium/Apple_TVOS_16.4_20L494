...
+ (unsigned long long)setup:(id)arg1 interval:(double)arg2;	// IMP=0x0040000000003cbe
+ (id)idleTracker:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00100000000038e7
- (void).cxx_destruct;	// IMP=0x00200000000045fc
...
- (void)invalidate;	// IMP=0x0010000000004220
- (void)dealloc;	// IMP=0x0010000000003bd2
- (id)init:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000003989
