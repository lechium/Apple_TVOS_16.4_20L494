...
- (void).cxx_destruct;	// IMP=0x002000000001ade1
...
- (id)fetchDataForType:(id)arg1;	// IMP=0x001000000001a942
- (id)unpackMessage:(id)arg1;	// IMP=0x001000000001a8d2
- (id)packMessage:(id)arg1;	// IMP=0x001000000001a8ad
- (void)filePackagerError:(id)arg1;	// IMP=0x001000000001a7cb
- (void)packager:(id)arg1 gotData:(id)arg2 forPacket:(long long)arg3;	// IMP=0x001000000001a330
- (void)sendCompletedWithError:(id)arg1;	// IMP=0x001000000001a0d7
- (void)sendPasteboard:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000018c0d
- (void)calculateTimeRemaining;	// IMP=0x00100000000189eb
- (void)processPasteboardInfo:(id)arg1;	// IMP=0x001000000001834e
- (void)removeReceivedItems:(id)arg1;	// IMP=0x0010000000018094
- (void)completedReceivingPasteboardWithError:(id)arg1;	// IMP=0x0010000000017de4
- (void)receivedPasteboardInfo:(id)arg1 withError:(id)arg2;	// IMP=0x0010000000017b41
- (void)cancelReceive;	// IMP=0x0010000000017a86
- (void)receivePasteboardToFile:(id)arg1 withProgress:(id)arg2 infoReceivedHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4 returnInfoEarly:(_Bool)arg5;	// IMP=0x00100000000178a1
- (void)sendHeartbeat;	// IMP=0x001000000001779c
- (void)sendTotalSendSize;	// IMP=0x0010000000017682
- (void)sendPasteboardDataResponse;	// IMP=0x00100000000174da
- (void)sendFileArchiveRequest;	// IMP=0x0010000000016fd5
- (void)sendPasteboardDataRequest;	// IMP=0x0010000000016eea
- (void)sendPasteboardInfoResponse;	// IMP=0x0010000000016d43
- (void)sendPasteboardInfoRequest;	// IMP=0x0010000000016cb5
- (void)handleHeartbeat:(id)arg1;	// IMP=0x0010000000016c0a
- (void)handlePasteboardAuxInfoReceived:(id)arg1;	// IMP=0x0010000000016aaa
- (void)handlePasteboardFileResponse:(id)arg1;	// IMP=0x0010000000016302
- (void)handlePasteboardDataResponse:(id)arg1;	// IMP=0x0010000000015e9e
- (void)handlePasteboardInfoResponse:(id)arg1;	// IMP=0x0010000000015b80
- (void)handlePasteboardFileRequest:(id)arg1;	// IMP=0x0010000000015457
- (void)handlePasteboardDataRequest:(id)arg1;	// IMP=0x00100000000153d3
- (void)handlePasteboardInfoRequest:(id)arg1;	// IMP=0x001000000001534f
- (void)recvStop:(id)arg1;	// IMP=0x00100000000151b9
- (void)sendStopWithError:(long long)arg1;	// IMP=0x0010000000015031
- (void)streams:(id)arg1 didWriteMessageWithTag:(long long)arg2;	// IMP=0x0010000000014b5d
- (void)streams:(id)arg1 didReadMessage:(id)arg2 withTag:(long long)arg3;	// IMP=0x00100000000149d9
- (void)streamsDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000148ca
- (void)removeObject:(id)arg1;	// IMP=0x0010000000014818
- (void)storeObject:(id)arg1;	// IMP=0x0010000000014766
- (void)dealloc;	// IMP=0x0010000000014553
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x00100000000140e2
