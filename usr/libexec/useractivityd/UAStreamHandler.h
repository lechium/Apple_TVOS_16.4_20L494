...
- (void).cxx_destruct;	// IMP=0x002000000003cbf4
...
- (id)trimFirstBytes:(unsigned long long)arg1 ofData:(id)arg2;	// IMP=0x001000000003c8ef
- (long long)tryWriteMessage;	// IMP=0x001000000003c24a
- (long long)tryWriteRawData;	// IMP=0x001000000003bf34
- (long long)handleSpaceAvailable;	// IMP=0x001000000003bedb
- (void)handleMessageRead;	// IMP=0x001000000003bda0
- (_Bool)dataHasMessage:(id)arg1;	// IMP=0x001000000003bd2c
- (void)processHeader;	// IMP=0x001000000003bc1c
- (void)handleBytesAvailable;	// IMP=0x001000000003b845
- (void)handleOpenCompleted;	// IMP=0x001000000003b748
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000003b4ff
- (_Bool)writeMessage:(id)arg1 tag:(long long)arg2;	// IMP=0x001000000003b1dd
- (_Bool)writeRawData:(id)arg1;	// IMP=0x001000000003afde
- (void);	// IMP=0x001000000003adae
- (void)tryStop;	// IMP=0x001000000003ac64
- (void)stop;	// IMP=0x001000000003ab4c
- (void)start;	// IMP=0x001000000003a726
- (long long)queueCount;	// IMP=0x001000000003a6a7
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 delegate:(id)arg3;	// IMP=0x001000000003a4b0
