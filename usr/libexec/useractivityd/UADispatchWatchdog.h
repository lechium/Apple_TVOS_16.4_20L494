...
- (void).cxx_destruct;	// IMP=0x002000000001b730
...
- (void)_triggerWatchdog;	// IMP=0x001000000001b4fa
- (void)cancel;	// IMP=0x001000000001b406
- (void)poke;	// IMP=0x001000000001b379
- (void)start;	// IMP=0x001000000001b163
- (void)dealloc;	// IMP=0x001000000001b100
- (id)initWithName:(id)arg1 timeout:(double)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000001b03c
