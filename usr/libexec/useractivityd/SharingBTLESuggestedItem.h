...
+ (id)statusString;	// IMP=0x00400000000669d0
+ (id)cornerActionBTLEItemWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 scanner:(id)arg5 receiver:(id)arg6;	// IMP=0x00100000000611d7
+ (id)cornerActionBTLEItemWithSFAdvertisement:(id)arg1 optionBits:(unsigned int)arg2 scanner:(id)arg3 receiver:(id)arg4;	// IMP=0x00100000000610a8
...
- (id)description;	// IMP=0x0010000000066894
- (void)setWhen:(id)arg1;	// IMP=0x001000000006678e
- (id)when;	// IMP=0x00100000000666b7
- (id)statusString;	// IMP=0x001000000006612a
- (void)clearPayload;	// IMP=0x0010000000065f06
- (void)resignCurrent;	// IMP=0x0010000000065e96
- (_Bool)requestPayloadWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000063dc0
- (_Bool)updateFromSFAdvertisement:(id)arg1;	// IMP=0x0010000000063834
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11;	// IMP=0x0010000000062bf6
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11 dynamicIdentifier:(id)arg12;	// IMP=0x0010000000062b52
