...
+ (id)sharedActivityManagerServer;	// IMP=0x002000000001d06f
+ (id)cornerActionManager;	// IMP=0x001000000001d056
- (void).cxx_destruct;	// IMP=0x002000000002a0fb
...
- (void)removeHandler:(id)arg1;	// IMP=0x0010000000029bb7
- (void)addHandler:(id)arg1;	// IMP=0x0010000000029b06
@property(readonly, copy) NSSet *handlers;
- (void)removeActivityNotifier:(id)arg1;	// IMP=0x0010000000029a02
- (void)addActivityNotifier:(id)arg1;	// IMP=0x0010000000029941
@property(readonly, copy) NSSet *notifiers;
- (void)removeClient:(id)arg1;	// IMP=0x0010000000029821
- (void)addClient:(id)arg1;	// IMP=0x0010000000029748
@property(readonly, copy) NSSet *clients;
- (void)removeReceiver:(id)arg1;	// IMP=0x0010000000029654
- (void)addReceiver:(id)arg1;	// IMP=0x0010000000029583
@property(readonly, copy) NSSet *receivers;
- (void)removeAdvertiser:(id)arg1;	// IMP=0x00100000000293d5
- (void)addAdvertiser:(id)arg1;	// IMP=0x001000000002925a
@property(readonly, copy) NSSet *advertisers;
- (id)statusString;	// IMP=0x00100000000269f3
- (id)shortStatusString;	// IMP=0x001000000002604c
- (id)dynamicUserActivitiesString;	// IMP=0x0010000000025f7b
- (id)debuggingInfo;	// IMP=0x0010000000025dc1
- (id)dictionaryForCornerActionItem:(id)arg1;	// IMP=0x0010000000025db9
- (id)dictionaryForAdvertisableItem:(id)arg1;	// IMP=0x0010000000025db1
- (void)updateUIDeviceLockedState:(_Bool)arg1;	// IMP=0x0010000000025846
- (void)updateScreenDimStateState:(_Bool)arg1;	// IMP=0x00100000000252ca
- (void)updateUserActiveState:(_Bool)arg1;	// IMP=0x0010000000024823
@property _Bool userActive; // @synthesize userActive=_userActive;
- (void)terminate;	// IMP=0x00100000000247af
- (void)resume;	// IMP=0x0010000000023878
- (void)suspend;	// IMP=0x0010000000023104
@property _Bool suspended;
- (void)resumeListeningForBluetooth;	// IMP=0x0010000000022e47
- (void)suspendListeningForBluetooth;	// IMP=0x0010000000022d76
- (void)triggerAll;	// IMP=0x0010000000022d23
- (void)processWasRemoved;	// IMP=0x0010000000022bd8
- (_Bool)fetchMoreAppSuggestions;	// IMP=0x0010000000022a24
- (_Bool)haveBestAppChangeNotificationClients;	// IMP=0x00100000000229ba
- (void)_checkIfBestApplicationChangedThread;	// IMP=0x0010000000022668
- (_Bool)scheduleBestAppDetermination:(double)arg1;	// IMP=0x00100000000225fe
- (_Bool)scheduleBestAppDetermination;	// IMP=0x00100000000225e9
- (void)checkIfBestCornerItemChanged:(double)arg1;	// IMP=0x001000000002255a
@property(retain, nonatomic) UAUserActivityInfo *debugCornerItem;
- (id)bestCornerItem:(id)arg1;	// IMP=0x00100000000224df
- (id)bestCornerItem;	// IMP=0x001000000002247b
- (id)cornerActionItemForUUID:(id)arg1;	// IMP=0x0010000000022251
- (id)cornerActionItems;	// IMP=0x0010000000021e48
...
- (void)_determineWhenSystemGoesIdleThread;	// IMP=0x0010000000020a06
@property _Bool advertisingSuspended;
- (void)triggerUserIdleDetermination:(double)arg1;	// IMP=0x001000000002078c
- (void)triggerUserIdleDetermination;	// IMP=0x0010000000020777
- (_Bool)isBluetoothEnabled;	// IMP=0x001000000002076f
@property(readonly) _Bool activityReceivingAllowed;
@property(readonly) _Bool activityAdvertisingAllowed;
- (void)updateScreenSaverActive:(_Bool)arg1;	// IMP=0x00100000000206ab
- (void)_determineItemToAdvertiseForHandoffThread;	// IMP=0x001000000001ec0e
@property(readonly, copy) NSArray *itemsBeingAdvertised; // @synthesize itemsBeingAdvertised=_itemsBeingAdvertised;
- (_Bool)weAreAdvertisingAtLeastOneItem;	// IMP=0x001000000001e9b5
- (void)userActivityItemsChanged;	// IMP=0x001000000001e8ca
- (id)uaAdvertisableItemsInOrder:(_Bool)arg1;	// IMP=0x001000000001e2c7
- (id)uaAdvertisableItemsInOrder;	// IMP=0x001000000001e2b3
- (id)activeAdvertiseableItemsUUIDs;	// IMP=0x001000000001e06e
- (void)scheduleUpdatingAdvertisableItems:(double)arg1;	// IMP=0x001000000001e00b
- (void)scheduleUpdatingAdvertisableItems;	// IMP=0x001000000001dff1
- (_Bool)shouldItemBeAdvertised:(id)arg1;	// IMP=0x001000000001dbf4
- (id)advertiseableItems;	// IMP=0x001000000001d980
- (_Bool)weAreAdvertisingAnItem;	// IMP=0x001000000001d7fb
- (void)dealloc;	// IMP=0x001000000001d7cc
- (id)init;	// IMP=0x001000000001d0c4
