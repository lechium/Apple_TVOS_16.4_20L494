...
- (void).cxx_destruct;	// IMP=0x002000000002e074
...
- (void)requestRemotePasteboardData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002db5d
- (void)requestRemoteTypeInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000002cc7f
- (void)dealloc;	// IMP=0x001000000002cb3a
- (void)updateState:(unsigned long long)arg1;	// IMP=0x001000000002c9cd
- (id)stateAsString;	// IMP=0x001000000002c99b
- (id)initWithRequester:(id)arg1;	// IMP=0x001000000002c7de
