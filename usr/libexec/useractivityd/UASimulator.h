...
+ (id)simulatorWithController:(id)arg1 parentSimulatorPortName:(id)arg2;	// IMP=0x002000000008f378
+ (id)simulatorWithController:(id)arg1 pairedPort:(unsigned int)arg2 childSimPid:(int)arg3 childVersion:(unsigned long long)arg4;	// IMP=0x001000000008f370
- (void).cxx_destruct;	// IMP=0x0020000000090b86
...
- (id)statusString;	// IMP=0x00100000000909e2
- (_Bool)terminate;	// IMP=0x0010000000090711
- (_Bool)suspend;	// IMP=0x0010000000090622
- (_Bool)resume;	// IMP=0x0010000000090533
- (void)setSimulatorInFront:(_Bool)arg1;	// IMP=0x00100000000903a8
- (_Bool)active;	// IMP=0x0010000000090375
@property(copy) NSSet *notifiedItems;
@property(readonly) unsigned int pairedClientPort; // @dynamic pairedClientPort;
- (_Bool)reconnectToParentSimulator;	// IMP=0x001000000008f71b
- (void)dealloc;	// IMP=0x001000000008f650
- (id)initWithController:(id)arg1;	// IMP=0x001000000008ec50
