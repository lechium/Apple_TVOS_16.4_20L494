...
- (void).cxx_destruct;	// IMP=0x002000000003fbe2
...
- (id)reportedActivityType;	// IMP=0x001000000003fb35
- (void)sendEvent;	// IMP=0x001000000003fada
- (id)eventPayload;	// IMP=0x001000000003f9d8
- (id)eventName;	// IMP=0x001000000003f9cb
- (id)initWithAnalyticsInfo:(id)arg1;	// IMP=0x001000000003f8fe
