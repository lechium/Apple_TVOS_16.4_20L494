...
- (void).cxx_destruct;	// IMP=0x002000000004a322
@property(readonly, retain) UAUserActivityClientProcessesController *controller; // @synthesize controller=_controller;
- (id)statusString;	// IMP=0x001000000004a22b
- (id)receivedItems;	// IMP=0x0010000000049f34
- (_Bool)receiving;	// IMP=0x0010000000049eec
- (id)initWithManager:(id)arg1 controller:(id)arg2;	// IMP=0x0010000000049e6d
