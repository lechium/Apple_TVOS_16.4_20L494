...
- (void).cxx_destruct;	// IMP=0x0020000000003931
...
- (void)_tearDownLanguageChangeNotifications;	// IMP=0x001000000000381b
- (void)_registerForLanguageChangeNotifications;	// IMP=0x0010000000003698
- (void)_exitForLocalizationChange;	// IMP=0x001000000000359f
- (void)_purgePendingDatabaseValidations;	// IMP=0x00100000000033b7
- (_Bool)shouldValidateDatabaseForLibrary:(id)arg1;	// IMP=0x00100000000032f3
- (void)resumeValidations;	// IMP=0x00100000000032a8
- (void)clearValidatedPaths;	// IMP=0x0010000000003202
- (void)suspendValidations;	// IMP=0x00100000000031b7
- (_Bool)isValidatedPath:(id)arg1;	// IMP=0x00100000000030e9
- (void)validateMusicLibrary:(id)arg1 shouldTruncateDatabase:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000002cfd
- (void)dealloc;	// IMP=0x0010000000002cbf
- (id)init;	// IMP=0x0010000000002c0a
