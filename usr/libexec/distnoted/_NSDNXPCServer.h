...
- (id)createEndpoint;	// IMP=0x0020000000001893
- (id)allClients;	// IMP=0x0010000000001855
- (void)start;	// IMP=0x0010000000001674
- (void)addInvalidationHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000015fa
- (void)invalidate;	// IMP=0x00100000000014a8
- (id)__invalidate;	// IMP=0x0010000000001465
- (void)setPrivileged:(_Bool)arg1;	// IMP=0x0010000000001459
- (id)dispatchQueue;	// IMP=0x001000000000144f
...
- (void)dealloc;	// IMP=0x0010000000001268
- (id)initWithConfiguration:(struct distnoted_configuration *)arg1;	// IMP=0x00100000000011b3
