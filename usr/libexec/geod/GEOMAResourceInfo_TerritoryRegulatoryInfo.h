...
+ (id)_defaultQueryParameters;	// IMP=0x0020000000037de6
+ (id)_defaultQueryType;	// IMP=0x0010000000037dd9
+ (id)allExisitngInfos;	// IMP=0x0010000000037ba7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0020000000037ec2
@property(readonly) unsigned long long hash;
- (_Bool)shouldPrefetchResource:(id)arg1;	// IMP=0x0010000000037eb0
...
- (id)init;	// IMP=0x0010000000037aff
