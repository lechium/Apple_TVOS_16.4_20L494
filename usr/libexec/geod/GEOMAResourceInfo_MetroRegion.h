...
+ (id)_defaultQueryParameters;	// IMP=0x002000000003857f
+ (id)_defaultQueryType;	// IMP=0x0010000000038572
+ (id)allExisitngInfos;	// IMP=0x001000000003806a
- (void).cxx_destruct;	// IMP=0x0020000000038863
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000387f3
@property(readonly) unsigned long long hash;
- (_Bool)shouldPrefetchResource:(id)arg1;	// IMP=0x00100000000386c5
...
- (id)initWithOverrides:(id)arg1;	// IMP=0x0010000000037eec
