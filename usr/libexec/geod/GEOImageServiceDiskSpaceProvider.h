...
- (void).cxx_destruct;	// IMP=0x00200000000271f8
...
- (unsigned long long)freePurgableDiskSpace:(unsigned long long)arg1 urgency:(int)arg2;	// IMP=0x001000000002710a
- (unsigned long long)purgableDiskSpaceForUrgency:(int)arg1;	// IMP=0x0010000000027087
- (_Bool)_shouldPurgeForUrgency:(int)arg1;	// IMP=0x0010000000026f7f
- (int)minimumUregency;	// IMP=0x0010000000026f60
