...
- (void)preferredLanguageChangedForBundleID:(id)arg1;	// IMP=0x0010000000001e6b
- (void)removeSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000001df5
- (void)addSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000001d7f
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000001c31
- (id)init;	// IMP=0x0010000000001baa
