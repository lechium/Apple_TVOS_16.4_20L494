...
- (void).cxx_destruct;	// IMP=0x0020000000003d5d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000003bb7
- (unsigned long long)hash;	// IMP=0x0010000000003b73
@property(readonly) NSString *model;
@property(readonly) _Bool isReachable;
- (_Bool)_onQueue_isReachable;	// IMP=0x00100000000039ec
@property(readonly) _Bool supportsNewProtocol;
@property(readonly) _Bool supportsPCSKeySync;
@property(readonly) NSUUID *pairingID;
- (void)removeObserver:(id)arg1;	// IMP=0x00100000000038d1
- (void)addObserver:(id)arg1;	// IMP=0x00100000000037ce
- (id)init;	// IMP=0x0010000000003747
