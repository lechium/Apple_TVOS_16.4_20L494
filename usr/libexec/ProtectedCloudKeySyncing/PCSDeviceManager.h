...
+ (id)sharedManager;	// IMP=0x00200000000041b0
- (void).cxx_destruct;	// IMP=0x0020000000004f42
...
- (void)setSimulatedDevices:(id)arg1;	// IMP=0x0010000000004bc9
@property(readonly) NSArray *allDevices;
- (id)deviceForPairingID:(id)arg1;	// IMP=0x00100000000046c2
- (id)deviceForIDSIdentifier:(id)arg1;	// IMP=0x0010000000004426
- (id)currentActivePairedDevice;	// IMP=0x001000000000427c
- (id)init;	// IMP=0x0010000000004205
