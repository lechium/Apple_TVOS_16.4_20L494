...
- (void).cxx_destruct;	// IMP=0x002000000000c61a
...
- (void)trigger;	// IMP=0x001000000000c3cf
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x001000000000c345
- (void)run;	// IMP=0x001000000000c333
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x001000000000c301
- (id)initWithLabel:(id)arg1 delay:(unsigned long long)arg2 operationQueue:(id)arg3;	// IMP=0x001000000000befb
