...
- (void).cxx_destruct;	// IMP=0x00200000000dd1cc
...
- (void)triggerReportedFromFlxKwdSpotter:(id)arg1;	// IMP=0x00100000000dce1e
- (void)attSiriAudioSrcNodeLPCMRecordBufferAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000dce05
- (void)attSiriAudioSrcNodeDidStop:(id)arg1;	// IMP=0x00100000000dcddc
- (void)attSiriAudioSrcNodeDidStartRecording:(id)arg1 successfully:(_Bool)arg2 error:(id)arg3;	// IMP=0x00100000000dcd48
- (void)startWithContext:(id)arg1 audioStreamId:(unsigned long long)arg2;	// IMP=0x00100000000dcc13
- (void)stop;	// IMP=0x00100000000dcbfd
- (void)start;	// IMP=0x00100000000dcbf7
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000dcbf1
- (void)pause;	// IMP=0x00100000000dcbeb
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000dcbe5
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000dcae1
