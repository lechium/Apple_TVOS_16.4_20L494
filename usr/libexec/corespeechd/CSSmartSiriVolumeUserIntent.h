...
- (double)applyLowerAndUpperBoundsToVolumeOffset:(float)arg1;	// IMP=0x00100000000c4a4d
- (void)storeASVStateInformation;	// IMP=0x00100000000c49fa
- (float)decreaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000c49d9
- (float)increaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000c49b8
- (void)initWithStoredInformationAndAsset:(id)arg1;	// IMP=0x00100000000c486c
- (double)applyLowerAndUpperBoundsToVolume:(float)arg1;	// IMP=0x00100000000c4764
