...
+ (id)sharedInstance;	// IMP=0x00400000000c1afe
...
- (void)_stopMonitoring;	// IMP=0x00100000000c1b46
- (void)_startMonitoringWithQueue:(id)arg1;	// IMP=0x00100000000c1b40
- (id)init;	// IMP=0x00100000000c1b06
