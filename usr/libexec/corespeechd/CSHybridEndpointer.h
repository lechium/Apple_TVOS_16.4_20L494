...
@interface CSHybridEndpointer : NSObject
{
    ...
    MISSING_TYPE *_clientLagThresholdMs;	// 224 = 0xe0
...
- (void).cxx_destruct;	// IMP=0x00200000000a1b29
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x00100000000a1583
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x00100000000a14e5
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x00100000000a120b
- (void)endpointerAssetManagerDidUpdateOSDAsset:(id)arg1;	// IMP=0x00100000000a1205
- (void)endpointerAssetManagerDidUpdateAsset:(id)arg1;	// IMP=0x00100000000a103c
@property(readonly, nonatomic) double lastStartOfVoiceActivityTime;
- (double);	// IMP=0x00100000000a102a
- (void)reset;	// IMP=0x00100000000a1024
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x00100000000a0bf7
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x00100000000a0157
- (void)stopEndpointer;	// IMP=0x00100000000a00c1
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x00100000000a0019
- (void)terminateProcessing;	// IMP=0x001000000009ff8e
- (void)preheat;	// IMP=0x001000000009ff88
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x001000000009fc14
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x001000000009f4c1
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x001000000009f4b0
- (void)processOSDFeatures:(id)arg1 withFrameDurationMs:(double)arg2;	// IMP=0x001000000009d700
- (void)processFirstAudioPacketTimestamp:(id)arg1 firstAudioSampleSensorTimestamp:(unsigned long long)arg2;	// IMP=0x001000000009d589
- (void)logAnchorMachAbsTime:(unsigned long long)arg1 numSamplesProcessedBeforeAnchorTime:(unsigned long long)arg2 isAnchorTimeBuffered:(_Bool)arg3;	// IMP=0x001000000009d501
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000009ce14
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x001000000009ca97
- (void)processTaskString:(id)arg1;	// IMP=0x001000000009c711
- (void)processASRFeatures:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x001000000009c66a
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x001000000009c528
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x001000000009c331
- (void)_updateEndpointerDelayedTriggerByMhId:(id)arg1;	// IMP=0x001000000009c21a
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x001000000009c10f
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000009c109
- (id)init;	// IMP=0x001000000009b9e7
