...
+ (id)CSVoiceTriggerFirstPassMetricsWithFirstPassInfoGeneratedTime:(unsigned long long)arg1 firstPassInfoProcessedTime:(unsigned long long)arg2;	// IMP=0x0040000000088893
- (void).cxx_destruct;	// IMP=0x00200000000888e2
...
- (id)_initWithFirstPassInfoGeneratedTime:(unsigned long long)arg1 firstPassInfoProcessedTime:(unsigned long long)arg2;	// IMP=0x00100000000887e6
