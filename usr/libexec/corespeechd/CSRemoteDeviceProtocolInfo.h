...
+ (id)localDeviceProtocolInfo;	// IMP=0x00400000000611d6
+ (id)defaultProtocolInfo;	// IMP=0x001000000006118b
- (void).cxx_destruct;	// IMP=0x0020000000061667
...
- (id);	// IMP=0x00100000000615f3
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x001000000006131b
- (id)initWithProtocolVersion:(unsigned long long)arg1 buildVersion:(id)arg2 deviceProductVersion:(id)arg3 deviceProductType:(id)arg4 deviceCategory:(unsigned long long)arg5;	// IMP=0x00100000000610c0
