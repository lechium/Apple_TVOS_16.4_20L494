...
- (void).cxx_destruct;	// IMP=0x002000000001dbf6
...
- (id)getLeadingUtteranceLogger;	// IMP=0x001000000001d8b3
- (void)_logSpeakerFalseTriggerMitigationScore:(id)arg1 withSpeakerMatchScore:(float)arg2 withSpeakerScoreThreshold:(float)arg3 withAudioDuration:(double)arg4 withSuccess:(_Bool)arg5;	// IMP=0x001000000001d8ad
- (void)logSpeakerFalseTriggerMitigationScore:(unsigned long long)arg1;	// IMP=0x001000000001d662
- (void)updateCachedScoresForLogging:(unsigned long long)arg1;	// IMP=0x001000000001d3ee
- (void)attSiriAudioSrcNodeLPCMRecordBufferAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x001000000001d24e
- (void)attSiriAudioSrcNodeDidStop:(id)arg1;	// IMP=0x001000000001d16c
- (void)attSiriAudioSrcNodeDidStartRecording:(id)arg1 successfully:(_Bool)arg2 error:(id)arg3;	// IMP=0x001000000001d166
- (void)_stopProcessing;	// IMP=0x001000000001cd11
- (id)_mapScoresToSharedSiriId:(id)arg1;	// IMP=0x001000000001c3f3
- (id)_processSpeakerRecognitionResult:(id)arg1;	// IMP=0x001000000001bf93
- (void)speakerRecognitionFinishedProcessing:(id)arg1 withFinalSpeakerInfo:(id)arg2;	// IMP=0x001000000001b94f
- (void)CSLanguageCodeUpdateMonitor:(id)arg1 didReceiveLanguageCodeChanged:(id)arg2;	// IMP=0x001000000001b855
- (void)speakerRecognitionController:(id)arg1 hasSpeakerInfo:(id)arg2;	// IMP=0x001000000001b0b1
- (void)CSSpeakerRecognitionAssetDownloadMonitor:(id)arg1 didInstallNewAsset:(_Bool)arg2 assetProviderType:(unsigned long long)arg3;	// IMP=0x001000000001afb9
- (void)startXPCConnection;	// IMP=0x001000000001af3a
- (void)_refreshSpeakerRecognitionAssets;	// IMP=0x001000000001a890
- (void)_setupSpeakerRecognitionForProfiles:(id)arg1 WithVTEventInfo:(id)arg2 WithLocale:(id)arg3;	// IMP=0x001000000001a3aa
- (void)_setupLeadingUtteranceLogger;	// IMP=0x001000000001a0fb
- (void)_setupSSRControllerWithAudioContext:(id)arg1 withVoiceTriggerEventInfo:(id)arg2;	// IMP=0x0010000000019d23
- (id)getSharedUserIdWithHighestVoiceIdScore:(id)arg1;	// IMP=0x0010000000019923
- (void)cacheSharedUserInfos:(id)arg1;	// IMP=0x0010000000019818
- (id)filteredVoiceProfileArray:(id)arg1;	// IMP=0x0010000000019690
- (void)removeReceiver:(id)arg1;	// IMP=0x001000000001941e
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000192a6
- (void)stop;	// IMP=0x00100000000191ae
- (void)pause;	// IMP=0x00100000000191a8
- (void)resetForNewRequestWithRecordContext:(id)arg1 voiceTriggerInfo:(id)arg2;	// IMP=0x0010000000019050
- (void)start;	// IMP=0x001000000001904a
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x0010000000018e3d
