...
- (void).cxx_destruct;	// IMP=0x0020000000009613
...
- (id)dictionary;	// IMP=0x001000000000939f
- (id)description;	// IMP=0x00100000000092ee
- (id)initWithWordCount:(long long)arg1 trailingSilenceFrames:(long long)arg2 endOfSilenceLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6;	// IMP=0x00100000000092cb
- (id)initWithWordCount:(long long)arg1 trailingSilenceDuration:(long long)arg2 eosLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6 processedAudioDurationInMilliseconds:(long long)arg7;	// IMP=0x00100000000091f7
