...
- (void).cxx_destruct;	// IMP=0x0020000000080cdc
...
- (void)setAttSiriController:(id)arg1;	// IMP=0x0010000000080a53
- (id)attSiriController;	// IMP=0x0010000000080a3d
@property(nonatomic) _Bool isReady; // @synthesize isReady=_isReady;
@property(retain, nonatomic) NSArray *requiredNodes; // @synthesize requiredNodes=_requiredNodes;
@property(readonly, nonatomic) unsigned long long type; // @synthesize type=_type;
- (void)osdAnalyzer:(id)arg1 didDetectEndOfSpeechAt:(double)arg2;	// IMP=0x001000000008084e
- (void)osdAnalyzer:(id)arg1 didDetectStartOfSpeechAt:(double)arg2;	// IMP=0x0010000000080696
- (void)osdAnalyzer:(id)arg1 didUpdateOSDFeatures:(id)arg2;	// IMP=0x001000000008036e
- (void)endpointerAssetManagerDidUpdateAsset:(id)arg1;	// IMP=0x0010000000080368
- (void)endpointerAssetManagerDidUpdateOSDAsset:(id)arg1;	// IMP=0x00100000000802bd
- (unsigned long long)fetchLastKnownConsecutiveBoronStartSampleCount;	// IMP=0x0010000000080214
- (unsigned long long)audioStartSampleCount;	// IMP=0x0010000000080168
- (void)resetForNewRequestWithRecordContext:(id)arg1 endpointerSettings:(id)arg2 voiceTriggerInfo:(id)arg3 osdMode:(unsigned long long)arg4;	// IMP=0x001000000007fa85
- (void)resetForNewRequestWithRecordContext:(id)arg1 endpointerSettings:(id)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x001000000007fa70
- (void)attSiriAudioSrcNodeDidStop:(id)arg1;	// IMP=0x001000000007f8c6
- (void)checkConsecutiveBoronSignalWithAudioChunk:(id)arg1;	// IMP=0x001000000007f670
- (void)attSiriAudioSrcNodeLPCMRecordBufferAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x001000000007e94b
- (void)attSiriAudioSrcNodeDidStartRecording:(id)arg1 successfully:(_Bool)arg2 error:(id)arg3;	// IMP=0x001000000007e945
- (void)stop;	// IMP=0x001000000007e72d
- (void)pause;	// IMP=0x001000000007e727
- (void)start;	// IMP=0x001000000007e721
- (void)removeReceiver:(id)arg1;	// IMP=0x001000000007e5c0
- (void)addReceiver:(id)arg1;	// IMP=0x001000000007e3c9
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x001000000007df84
