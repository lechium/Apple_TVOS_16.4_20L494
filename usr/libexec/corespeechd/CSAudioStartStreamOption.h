...
+ (id)noAlertOption;	// IMP=0x00200000000220c4
- (void).cxx_destruct;	// IMP=0x0010000000022b34
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000226ab
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x0010000000022254
- (id)initTandemWithOption:(id)arg1;	// IMP=0x00100000000220fc
- (long long)_alertBehaviorTypeFromAVVCOberrideType:(long long)arg1;	// IMP=0x0010000000004ffe
- (long long)_avvcAlertOverrideType:(long long)arg1;	// IMP=0x0010000000004fe7
- (_Bool)isAlertBehaviorOverridedBeep;	// IMP=0x0010000000004f91
- (id)avvcAlertBehavior;	// IMP=0x0010000000004de9
- (void)setAVVCAlertBehavior:(id)arg1;	// IMP=0x0010000000004b8f
- (id)avvcStartRecordSettingsWithAudioStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000048c2
