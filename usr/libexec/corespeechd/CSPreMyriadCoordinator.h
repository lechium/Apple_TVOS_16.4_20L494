...
- (void).cxx_destruct;	// IMP=0x00200000000156d1
...
- (void)secondPassDidStartForClient:(unsigned long long)arg1 deviceId:(id)arg2 withFirstPassEstimate:(double)arg3;	// IMP=0x0010000000015280
- (void)secondPassDidStopForClient:(unsigned long long)arg1 deviceId:(id)arg2;	// IMP=0x0010000000015079
- (void)voiceTriggerDidRejected:(id)arg1 deviceId:(id)arg2;	// IMP=0x0010000000014fb1
- (void)raiseToSpeakDetected:(id)arg1;	// IMP=0x0010000000014f57
- (void)voiceTriggerGotSuperVector:(id)arg1;	// IMP=0x0010000000014efd
- (void)keywordDetectorDidDetectKeyword;	// IMP=0x0010000000014ecc
- (void)voiceTriggerDidDetectSpeakerReject:(id)arg1;	// IMP=0x0010000000014e72
- (void)voiceTriggerDidDetectNearMiss:(id)arg1 deviceId:(id)arg2;	// IMP=0x0010000000014daa
- (void)voiceTriggerDidDetectKeyword:(id)arg1 deviceId:(id)arg2;	// IMP=0x0010000000014c65
- (void)voiceTriggerDidDetectKeyword:(id)arg1 deviceId:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000014bbe
- (_Bool)_isRemoraSecondPassRunning;	// IMP=0x0010000000014abb
- (void)_getHighestRemoraFirstPassGoodnessScore:(CDUnknownBlockType)arg1;	// IMP=0x0010000000014884
- (_Bool)handlePendingBuiltInVoiceTriggerIfNeeded;	// IMP=0x001000000001458e
- (void)_clearPendingBuiltInVoiceTrigger;	// IMP=0x0010000000014491
- (_Bool)handlePendingRemoraVoiceTriggerIfNeeded;	// IMP=0x0010000000014043
- (void)_clearPendingRemoraVoiceTrigger;	// IMP=0x0010000000013f18
- (_Bool)isRemoraVoiceTriggerEvent:(id)arg1;	// IMP=0x0010000000013e0a
- (_Bool)isBultInVoiceTriggerEvent:(id)arg1;	// IMP=0x0010000000013cfc
- (id)initWithTargetQueue:(id)arg1;	// IMP=0x0010000000013c39
