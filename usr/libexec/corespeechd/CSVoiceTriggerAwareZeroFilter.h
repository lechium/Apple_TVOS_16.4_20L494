...
- (void).cxx_destruct;	// IMP=0x00200000000bbde5
...
- (id)metrics;	// IMP=0x00100000000bbd4f
- (void)flush;	// IMP=0x00100000000bbcc6
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2;	// IMP=0x00100000000bb9d8
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00100000000bb71b
- (id)init;	// IMP=0x00100000000bb6ec
