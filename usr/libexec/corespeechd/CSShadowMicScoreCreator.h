...
- (void).cxx_destruct;	// IMP=0x00200000000bdadf
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x00100000000bd7d3
- (void)_calculateSpeechVoicingLevel;	// IMP=0x00100000000bd538
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x00100000000bd4f3
- (void)calculateShadowMicScore;	// IMP=0x00100000000bd160
- (void)addDataToBuffer:(id)arg1;	// IMP=0x00100000000bd14a
- (id)init;	// IMP=0x00100000000bd0c3
