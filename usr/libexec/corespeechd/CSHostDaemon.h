...
+ (id)sharedDaemon;	// IMP=0x00400000000d3d53
- (void).cxx_destruct;	// IMP=0x00200000000d4696
...
- (void)_daemonWillShutdown;	// IMP=0x00100000000d4485
- (void)_setupDistnoteHandlers;	// IMP=0x00100000000d447f
- (void)_setupNotifyHandlers;	// IMP=0x00100000000d42ef
- (void)_daemonDidLaunch;	// IMP=0x00100000000d40bb
- (void)shutdown;	// IMP=0x00100000000d40a3
- (void)didLaunch;	// IMP=0x00100000000d4091
- (id)init;	// IMP=0x00100000000d3da8
