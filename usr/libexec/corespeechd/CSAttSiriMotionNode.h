...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000a6f1d
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000a6f17
- (void)stop;	// IMP=0x00100000000a6f11
- (void)pause;	// IMP=0x00100000000a6f0b
- (void)start;	// IMP=0x00100000000a6f05
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000a6ef7
