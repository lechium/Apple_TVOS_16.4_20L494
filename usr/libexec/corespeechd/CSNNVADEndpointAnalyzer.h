...
- (void).cxx_destruct;	// IMP=0x002000000004e177
...
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x001000000004dff0
- (void)stopEndpointer;	// IMP=0x001000000004df71
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x001000000004def2
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000004de73
- (void)reset;	// IMP=0x001000000004ddf4
- (void)preheat;	// IMP=0x001000000004dd75
- (id)init;	// IMP=0x001000000004dcbe
