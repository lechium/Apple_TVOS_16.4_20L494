...
+ (id)sharedMonitor;	// IMP=0x0040000000024d67
- (void).cxx_destruct;	// IMP=0x0020000000024f7f
@property(nonatomic) __weak id <CSVoiceTriggerAssetChangeDelegate> delegate; // @synthesize delegate=_delegate;
- (void)notifyVoiceTriggerAssetChanged;	// IMP=0x0010000000024f47
- (void)startMonitoring;	// IMP=0x0010000000024e1b
- (id)init;	// IMP=0x0010000000024dbc
