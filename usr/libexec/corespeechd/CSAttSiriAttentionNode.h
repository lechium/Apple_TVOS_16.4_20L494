...
+ (_Bool)supportAttentionLostAndGain;	// IMP=0x00200000000d16c7
- (void).cxx_destruct;	// IMP=0x00200000000d1759
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000d16f5
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000d16ef
- (void)stop;	// IMP=0x00100000000d16e9
- (void)pause;	// IMP=0x00100000000d16e3
- (void)start;	// IMP=0x00100000000d16dd
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000d16cf
