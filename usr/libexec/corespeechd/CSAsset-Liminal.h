...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x00100000000356eb
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x0010000000035679
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x001000000003560c
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x001000000003559a
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x0010000000032a7e
...
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0010000000037cb3
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x001000000003494a
- (id)_sha256:(id)arg1;	// IMP=0x001000000004f467
- (id)_sha1:(id)arg1;	// IMP=0x001000000004f376
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000004f1cd
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000004f199
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000004f180
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000004f167
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000004f14e
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004f131
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004f111
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x001000000004e8ed
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x001000000004e51f
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000004e4b9
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x001000000004e485
...
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000084eea
@property(readonly, nonatomic) _Bool containsSpeakerRecognitionCategory;
- (_Bool)isHSVoiceTrigger:(id)arg1;	// IMP=0x00100000000c2903
- (id)getCategoryKeyWithRecordCtx:(id)arg1;	// IMP=0x00100000000c289e
- (_Bool)shouldRunSpkrIdForCategory:(id)arg1;	// IMP=0x00100000000c287c
- (id)nldaConfigFileForCategory:(id)arg1;	// IMP=0x00100000000c27ca
- (id)mitigationConfigFileForCategory:(id)arg1;	// IMP=0x00100000000c2718
...
- (id)nldaConfigFile;	// IMP=0x00100000000c257b
@property(readonly, nonatomic) float mitigationModelDefaultAFTMScore;
- (id)mitigatonConfigFile;	// IMP=0x00100000000c2481
