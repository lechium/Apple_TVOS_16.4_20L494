...
- (void).cxx_destruct;	// IMP=0x0020000000021cb2
...
- (void)_startActivation;	// IMP=0x001000000002191a
- (void)attSiriNode:(id)arg1 didUpdateOSDFeatures:(id)arg2 withFrameDurationMs:(double)arg3;	// IMP=0x00100000000216cd
- (void)stop;	// IMP=0x0010000000021674
- (void)pause;	// IMP=0x001000000002166e
- (void)start;	// IMP=0x00100000000215fb
- (void)removeReceiver:(id)arg1;	// IMP=0x0010000000021541
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000214ac
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000213df
