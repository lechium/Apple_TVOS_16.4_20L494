...
- (void).cxx_destruct;	// IMP=0x0020000000018c5a
...
- (id)description;	// IMP=0x0010000000018bbd
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x0010000000018b1f
