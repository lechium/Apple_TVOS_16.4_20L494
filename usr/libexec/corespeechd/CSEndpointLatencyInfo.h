...
- (void).cxx_destruct;	// IMP=0x00200000000d4e47
...
- (void)_emitMHEndpointLatencyInfo:(id)arg1 withRequestMHUUID:(id)arg2;	// IMP=0x00100000000d4d9e
- (void)report;	// IMP=0x00100000000d4af6
- (void)addPktInfoWithTimestamp:(unsigned long long)arg1 arrivalTimestamp:(unsigned long long)arg2 currentMachTime:(unsigned long long)arg3;	// IMP=0x00100000000d4839
- (id)initWithRequestMHUUID:(id)arg1;	// IMP=0x00100000000d474e
