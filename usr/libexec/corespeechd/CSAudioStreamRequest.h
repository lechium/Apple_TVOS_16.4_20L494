...
+ (id)requestForSpeexRecordSettingsWithContext:(id)arg1;	// IMP=0x00200000000c38b5
+ (id)requestForOpusRecordSettingsWithContext:(id)arg1;	// IMP=0x00100000000c3747
+ (id)requestForLpcmRecordSettingsWithContext:(id)arg1;	// IMP=0x00100000000c35bc
+ (id)defaultRequestWithContext:(id)arg1;	// IMP=0x00100000000c3314
- (void).cxx_destruct;	// IMP=0x00200000000c4121
...
- (id)description;	// IMP=0x00100000000c3f51
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c3e70
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00100000000c3b83
- (id)initTandemWithRequest:(id)arg1;	// IMP=0x00100000000c3a14
