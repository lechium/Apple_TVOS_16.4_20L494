...
- (void).cxx_destruct;	// IMP=0x00200000000e369f
...
- (void)dealloc;	// IMP=0x00100000000e3627
- (void)acquireAssertionForIdleUser;	// IMP=0x00100000000e32fe
- (void)acquireAssertionForActiveUser;	// IMP=0x00100000000e31f9
- (void)acquireAssertion;	// IMP=0x00100000000e31a0
- (void)releasePreventSystemSleepAssertion;	// IMP=0x00100000000e316e
- (void)_acquirePreventSystemSleepAssertionWithTimeout:(id)arg1;	// IMP=0x00100000000e3057
- (id)initWithTimeout:(double)arg1;	// IMP=0x00100000000e3014
