...
- (void).cxx_destruct;	// IMP=0x00200000000d30e1
...
- (void)_handlePingPongMessage:(id)arg1 client:(id)arg2;	// IMP=0x00100000000d2ec9
- (void)_notifyXPCDisconnectionToProxy:(id)arg1;	// IMP=0x00100000000d2e6e
- (void)_notifyXPCDisconnectionToProxies;	// IMP=0x00100000000d2dc4
- (void)_handleClientError:(id)arg1 client:(id)arg2;	// IMP=0x00100000000d2c06
- (void)_handleSetXPCClientTypeMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000d2ad5
- (void)_handleAudioProvidingRequestTypeSwitchMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000d2990
- (void)_handleAudioProvidingMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000d2818
- (void)_handleClientMessage:(id)arg1 client:(id)arg2;	// IMP=0x00100000000d2598
- (void)_handleClientEvent:(id)arg1;	// IMP=0x00100000000d24d1
- (void)sendMessageToClient:(id)arg1;	// IMP=0x00100000000d2356
- (void)activateConnection;	// IMP=0x00100000000d224d
- (_Bool)_getAudioProvideWithContext:(id)arg1 streamClientType:(unsigned long long)arg2;	// IMP=0x00100000000d2007
- (id)initWithConnection:(id)arg1;	// IMP=0x00100000000d1de8
