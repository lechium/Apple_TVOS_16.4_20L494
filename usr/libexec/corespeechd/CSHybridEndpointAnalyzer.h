...
@interface CSHybridEndpointAnalyzer : NSObject
{
    ...
    MISSING_TYPE *_serverFeatureLatencies;	// 232 = 0xe8
...
- (void).cxx_destruct;	// IMP=0x002000000006d51f
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x001000000006cf44
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x001000000006cea6
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x000000000006cbcc
- (void)_updateAssetWithCurrentLanguage;	// IMP=0x001000000006cb56
- (void)_updateAssetWithLanguage:(id)arg1;	// IMP=0x001000000006c983
- (void)CSFirstUnlockMonitor:(id)arg1 didReceiveFirstUnlock:(_Bool)arg2;	// IMP=0x001000000006c8b9
- (void)CSAssetManagerDidDownloadNewAsset:(id)arg1;	// IMP=0x001000000006c823
- (void)CSLanguageCodeUpdateMonitor:(id)arg1 didReceiveLanguageCodeChanged:(id)arg2;	// IMP=0x001000000006c766
...
- (void)reset;	// IMP=0x001000000006c74e
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x001000000006c46a
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x001000000006b7c5
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x001000000006b7bd
- (void)setEndpointerOperationMode:(long long)arg1;	// IMP=0x001000000006b7b7
- (void)stopEndpointer;	// IMP=0x001000000006b721
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x001000000006b679
- (void)terminateProcessing;	// IMP=0x001000000006b606
- (void)preheat;	// IMP=0x001000000006b600
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x001000000006b28c
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x001000000006aa62
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x001000000006aa51
- (void)osdAnalyzer:(id)arg1 didUpdateOSDFeatures:(id)arg2;	// IMP=0x0010000000068ac8
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000683db
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x001000000006810d
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x0010000000068064
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x0010000000067fb7
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000006788d
- (void)_loadAndSetupEndpointerAssetIfNecessary;	// IMP=0x001000000006756b
- (id)init;	// IMP=0x0010000000066db9
