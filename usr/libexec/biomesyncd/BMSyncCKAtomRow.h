...
- (void).cxx_destruct;	// IMP=0x0010000000020591
...
- (id)description;	// IMP=0x001000000002040f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000020404
- (unsigned long long)hash;	// IMP=0x00100000000203c5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000020334
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 valueVersion:(long long)arg6 valueData:(id)arg7;	// IMP=0x001000000002012d
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 bookmark:(id)arg6;	// IMP=0x001000000001ff2e
- (id)initWithFMResultSet:(id)arg1;	// IMP=0x00100000000205e5
