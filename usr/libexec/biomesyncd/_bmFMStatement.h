...
- (void).cxx_destruct;	// IMP=0x0020000000047899
...
- (id)description;	// IMP=0x00100000000477b0
- (void)reset;	// IMP=0x001000000004778e
- (void)close;	// IMP=0x0010000000047764
- (void)dealloc;	// IMP=0x0010000000047726
