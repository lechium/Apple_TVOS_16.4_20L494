...
- (void).cxx_destruct;	// IMP=0x00200000000066c4
@property(nonatomic) _Bool moreComing; // @synthesize moreComing=_moreComing;
- (void)didAddAtomWithData:(id)arg1;	// IMP=0x001000000000669c
- (_Bool)canAddAtomWithData:(id)arg1;	// IMP=0x0010000000006686
- (id)initWithChunkerPolicy:(id)arg1;	// IMP=0x0010000000006613
