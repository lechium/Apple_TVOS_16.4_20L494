...
- (void).cxx_destruct;	// IMP=0x0020000000002fcd
...
- (unsigned long long)deltaDeliveryRequirements;	// IMP=0x0010000000002f75
- (id)mergeableDeltasForMetadata:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000002522
- (_Bool)mergeDeltas:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000020dd
- (id)stateVector;	// IMP=0x001000000000201c
- (id)initWithStreamCRDT:(id)arg1 locationRow:(id)arg2 database:(id)arg3 queue:(id)arg4 maxDeltaSize:(long long)arg5 sessionContext:(id)arg6;	// IMP=0x0010000000001f10
