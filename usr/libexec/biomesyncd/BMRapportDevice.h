...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001d487
- (void).cxx_destruct;	// IMP=0x002000000001d61f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001d51c
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001d48f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001d468
- (id)description;	// IMP=0x001000000001d351
- (unsigned long long)hash;	// IMP=0x001000000001d30d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001d260
- (void)handleInvalidationWithError:(id)arg1;	// IMP=0x001000000001cf6a
- (void)invalidateClientWithError:(id)arg1;	// IMP=0x001000000001ceb6
...
- (id)initWithRPCompanionLinkDevice:(id)arg1;	// IMP=0x001000000001cc83
