...
+ (id)fetchRequestWithAccountIdentifier:(id)arg1;	// IMP=0x0020000000051190
+ (id)fetchRequestWithIdentifier:(id)arg1;	// IMP=0x00100000000510e9
+ (id)fetchRequestWithDeviceChannel;	// IMP=0x0010000000051066
+ (id)fetchRequestWithBootstrapURI:(id)arg1 enrollmentType:(short)arg2;	// IMP=0x0010000000050fb1
+ (id)fetchRequestWithBootstrapURI:(id)arg1;	// IMP=0x0010000000050f0a
- (id)reportDetails;	// IMP=0x0020000000051237
- (void)awakeFromInsert;	// IMP=0x0010000000050e75
