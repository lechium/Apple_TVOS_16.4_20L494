...
- (void)markPending;	// IMP=0x0020000000021e37
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x0010000000021ae7
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x0010000000021774
- (void)markQueued;	// IMP=0x0010000000021711
