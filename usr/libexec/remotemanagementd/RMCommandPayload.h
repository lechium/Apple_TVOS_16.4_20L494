...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x0020000000020d8f
- (id)reportDetails;	// IMP=0x00200000000215db
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x0010000000021070
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x0010000000020dff
