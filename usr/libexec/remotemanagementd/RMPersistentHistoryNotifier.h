...
+ (id)sharedQueryQueue;	// IMP=0x004000000006020f
- (void).cxx_destruct;	// IMP=0x0020000000061b9d
...
- (void)_queryForTransactionsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000060a93
- (void)_delayedQuery;	// IMP=0x001000000006075a
- (void)_scheduleQueryForTransactions;	// IMP=0x0010000000060635
- (void)_managedObjectContextDidSave:(id)arg1;	// IMP=0x0010000000060551
- (void)start;	// IMP=0x00100000000602b6
- (void)dealloc;	// IMP=0x0010000000060167
- (id)initWithContext:(id)arg1;	// IMP=0x00100000000600c5
- (id)initWithPersistentHistoryToken:(id)arg1 context:(id)arg2;	// IMP=0x0010000000060024
