...
+ (id)fetchRequestWithKeyPaths:(id)arg1;	// IMP=0x002000000008d6fe
- (id)reportDetails;	// IMP=0x002000000008d7a5
- (void)_validateSetOncePropertiesWithErrors:(id)arg1;	// IMP=0x001000000008d390
- (void)_validateManagementSourceWithErrors:(id)arg1;	// IMP=0x001000000008d2f3
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x001000000008d0d9
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x001000000008cebf
- (void)awakeFromInsert;	// IMP=0x001000000008ce58
