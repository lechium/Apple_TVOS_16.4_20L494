...
- (id)reportDetails;	// IMP=0x001000000002256d
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x0010000000022c90
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000226c8
