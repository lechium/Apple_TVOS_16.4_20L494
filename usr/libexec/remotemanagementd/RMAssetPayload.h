...
- (id)reportDetails;	// IMP=0x00100000000098e0
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x0010000000009c5d
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000099b9
