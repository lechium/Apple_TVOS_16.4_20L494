...
- (void).cxx_destruct;	// IMP=0x002000000012df9d
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x001000000012dec4
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000012dc98
- (void)disableService:(id)arg1;	// IMP=0x001000000012dc0e
- (void)enableService:(id)arg1;	// IMP=0x001000000012db90
- (id)streamHandlerForService:(id)arg1;	// IMP=0x001000000012db2d
- (void)stop;	// IMP=0x001000000012d8be
- (void)start;	// IMP=0x001000000012d86b
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x001000000012d774
