...
+ (id)sharedManager;	// IMP=0x00200000000b09d9
- (void).cxx_destruct;	// IMP=0x00200000000b1c2e
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x00100000000b1a34
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00100000000b1a1e
- (void)appleAccountSignedOut;	// IMP=0x00100000000b19a6
- (void)appleAccountSignedIn;	// IMP=0x00100000000b192e
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00100000000b18a8
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000000b15f9
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b12b9
- (void)cleanUpConnections;	// IMP=0x00100000000b0f95
- (void)start;	// IMP=0x00100000000b0b7b
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00100000000b0a2e
