...
- (void).cxx_destruct;	// IMP=0x002000000018e4e2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000018e35a
- (unsigned long long)hash;	// IMP=0x001000000018e1a8
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000018e012
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018deec
- (void)copyTo:(id)arg1;	// IMP=0x001000000018de05
- (void)writeTo:(id)arg1;	// IMP=0x001000000018dd1d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000018dd10
- (id)dictionaryRepresentation;	// IMP=0x001000000018d7f9
- (id)description;	// IMP=0x001000000018d74a
