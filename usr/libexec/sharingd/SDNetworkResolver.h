...
- (void).cxx_destruct;	// IMP=0x002000000009ba49
...
- (void)stop;	// IMP=0x001000000009b98d
- (int)start;	// IMP=0x001000000009b653
- (void)mount;	// IMP=0x001000000009b64d
- (void)bonjourResolverDidChange:(id)arg1;	// IMP=0x001000000009b376
- (void)mountDiskImageAsync;	// IMP=0x001000000009b370
- (void)notifyClientAboutResolve:(int)arg1;	// IMP=0x001000000009b24f
- (void)dealloc;	// IMP=0x001000000009b215
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x001000000009b18f
