...
- (void).cxx_destruct;	// IMP=0x002000000002af91
...
- (void)invalidate;	// IMP=0x001000000002ad0b
- (int)closeNode:(struct __SFNode *)arg1;	// IMP=0x001000000002ac92
- (int)removeNode:(struct __SFNode *)arg1;	// IMP=0x001000000002ac3c
- (int)addNode:(struct __SFNode *)arg1;	// IMP=0x001000000002abe6
@property(copy) NSDictionary *options;
@property long long mode;
- (id)sidebarChildren;	// IMP=0x001000000002aab9
- (id)childrenForNode:(struct __SFNode *)arg1;	// IMP=0x001000000002aa54
- (struct __SFNode *)copyRootNode;	// IMP=0x001000000002aa3d
- (int)openNode:(struct __SFNode *)arg1 forProtocol:(id)arg2 flags:(unsigned long long)arg3;	// IMP=0x001000000002a8d8
- (void)nodeBrowser:(id)arg1 nodesChangedForParent:(struct __SFNode *)arg2 protocol:(id)arg3 error:(int)arg4;	// IMP=0x001000000002a868
- (void)dealloc;	// IMP=0x001000000002a80e
- (id)initWithKind:(id)arg1 rootNode:(struct __SFNode *)arg2;	// IMP=0x001000000002a731
