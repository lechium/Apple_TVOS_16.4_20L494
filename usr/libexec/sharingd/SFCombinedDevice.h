...
- (void).cxx_destruct;	// IMP=0x00200000000744b3
...
- (_Bool)stateIsNearby;	// IMP=0x00100000000740ca
- (_Bool)stateIsMedium;	// IMP=0x0010000000074099
- (_Bool)stateIsClose;	// IMP=0x0010000000074087
- (void)resetTicks;	// IMP=0x0000000000073ef0
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x0010000000073c19
- (_Bool)canTransition:(int)arg1;	// IMP=0x0010000000073b23
- (id)description;	// IMP=0x0010000000073818
