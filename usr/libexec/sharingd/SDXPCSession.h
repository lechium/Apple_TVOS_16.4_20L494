...
+ (id)sharedSession;	// IMP=0x00200000000a1eb5
- (void).cxx_destruct;	// IMP=0x00200000000a218a
...
- (void)connectionManagerDidInvalidate:(id)arg1;	// IMP=0x00100000000a212e
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000a2096
- (void)stop;	// IMP=0x00100000000a2047
- (void)start;	// IMP=0x00100000000a1f77
- (id)init;	// IMP=0x00100000000a1f0a
