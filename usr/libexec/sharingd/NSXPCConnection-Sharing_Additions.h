...
- (_Bool)sd_connectionCanShareURL:(id)arg1;	// IMP=0x0010000000003a38
- (_Bool)sd_connectionHasEntitlement:(id)arg1;	// IMP=0x00100000000039de
...
- (_Bool)_connectionHasEntitlement:(id)arg1;	// IMP=0x001000000008d449
@end
