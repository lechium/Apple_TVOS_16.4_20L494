...
- (void).cxx_destruct;	// IMP=0x00200000000994ad
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000009924f
- (unsigned long long)hash;	// IMP=0x0010000000098fea
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000098d37
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000098b79
- (void)copyTo:(id)arg1;	// IMP=0x0010000000098a0c
- (void)writeTo:(id)arg1;	// IMP=0x0010000000098885
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000098878
- (id)dictionaryRepresentation;	// IMP=0x0010000000097ece
- (id)description;	// IMP=0x0010000000097e1f
