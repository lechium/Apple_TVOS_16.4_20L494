...
- (void).cxx_destruct;	// IMP=0x0020000000193a54
...
- (void)cancel;	// IMP=0x00100000001938ff
- (void)resolve;	// IMP=0x0010000000193472
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x00100000001930c2
- (void)notifyClient:(int)arg1;	// IMP=0x001000000019306e
- (void)dealloc;	// IMP=0x0010000000193030
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x0010000000192efc
