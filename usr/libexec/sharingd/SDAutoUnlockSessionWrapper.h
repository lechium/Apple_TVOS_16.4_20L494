...
- (void).cxx_destruct;	// IMP=0x00200000000b5208
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000b4f62
- (unsigned long long)hash;	// IMP=0x00100000000b4de4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b4b4a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b4964
- (void)copyTo:(id)arg1;	// IMP=0x00100000000b47ec
- (void)writeTo:(id)arg1;	// IMP=0x00100000000b4671
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000b4664
- (id)dictionaryRepresentation;	// IMP=0x00100000000b3e7c
- (id)description;	// IMP=0x00100000000b3dcd
