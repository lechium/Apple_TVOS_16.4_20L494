...
- (void).cxx_destruct;	// IMP=0x0020000000132239
...
// Error: Property attributes should begin with the type ('T') attribute, property name: attemptError
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x0010000000131a18
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000013144f
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000131437
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x0010000000130d59
- (void)sendAWDLInfo;	// IMP=0x0010000000130d45
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000130ca8
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000130bbc
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000130baa
- (void)_start;	// IMP=0x0010000000130b98
- (void)start;	// IMP=0x0010000000130b11
- (id)getAppName;	// IMP=0x0010000000130b09
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000130b03
- (void)connectionActivated;	// IMP=0x0010000000130afd
- (void)invalidate;	// IMP=0x0010000000130a04
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000130968
