...
- (void).cxx_destruct;	// IMP=0x00200000000fd0bf
...
- (id)trimHeader:(id)arg1;	// IMP=0x00100000000fcd54
- (unsigned int)parseHeader:(id)arg1;	// IMP=0x00100000000fccb4
- (void)handleMessageWritten:(id)arg1;	// IMP=0x00100000000fcbcd
- (void)handleSpaceForMessage;	// IMP=0x00100000000fc6fe
- (void)resetReadState;	// IMP=0x00100000000fc6ba
- (void)handleMessageRead;	// IMP=0x00100000000fc645
- (void)handleHeaderRead;	// IMP=0x00100000000fc525
- (void)handleBytesForMessage;	// IMP=0x00100000000fc249
- (id)headerWithLength:(unsigned int)arg1;	// IMP=0x00100000000fc1e2
- (id)messageWithData:(id)arg1;	// IMP=0x00100000000fc161
- (void)sendMessage:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fbe54
- (void)sendMessage:(id)arg1 withErrorHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fbe13
- (void)handleSpaceForStream;	// IMP=0x00100000000fbb19
- (void)handleBytesForStream;	// IMP=0x00100000000fb843
- (void)writeToStreamWithData:(id)arg1;	// IMP=0x00100000000fb6c0
- (void)handleSpaceAvailable;	// IMP=0x00100000000fb5ad
- (void)handleBytesAvailable;	// IMP=0x00100000000fb49a
- (void)handleOpenedStream:(id)arg1;	// IMP=0x00100000000fb27f
- (void)setTCPProperties:(id)arg1;	// IMP=0x00100000000fb18c
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000000fb008
- (_Bool)evaluateCert;	// IMP=0x00100000000fad1c
- (void)applySSLSettings:(id)arg1;	// IMP=0x00100000000fa9bc
- (void)invalidateOpenTimer;	// IMP=0x00100000000fa92a
- (void)openTimerFired:(id)arg1;	// IMP=0x00100000000fa764
- (void)startOpenTimer;	// IMP=0x00100000000fa68d
- (void)logTransfer;	// IMP=0x00100000000fa4bb
@property _Bool shouldReadNetwork; // @synthesize shouldReadNetwork=_shouldReadNetwork;
- (void)_stop;	// IMP=0x00100000000fa197
- (void)stopIfReady;	// IMP=0x00100000000fa155
- (void)stop;	// IMP=0x00100000000fa115
- (void)start;	// IMP=0x00100000000f9e3a
- (void)dealloc;	// IMP=0x00100000000f9d7e
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 isClient:(_Bool)arg3;	// IMP=0x00100000000f9bd4
