...
- (void).cxx_destruct;	// IMP=0x00200000000f663c
...
- (unsigned long long)hash;	// IMP=0x00100000000f644c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f6386
- (id)description;	// IMP=0x00100000000f6289
- (void)dealloc;	// IMP=0x00100000000f61d2
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x00100000000f5fe9
