...
- (void).cxx_destruct;	// IMP=0x002000000000a330
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000009ead
- (void)handleConversionProgress:(id)arg1;	// IMP=0x0010000000009dd5
- (void)startProgress;	// IMP=0x0010000000009b2e
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x0010000000009b28
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x0010000000009344
- (void)removeClientAlerts;	// IMP=0x0010000000009213
- (void)dealloc;	// IMP=0x0010000000009192
- (void)stop;	// IMP=0x0010000000008f81
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x0010000000008bfe
- (void)serversChanged:(id)arg1;	// IMP=0x00100000000088c2
- (_Bool)send;	// IMP=0x0010000000008783
- (void)start;	// IMP=0x001000000000847c
- (void)releaseSandboxExtensions;	// IMP=0x0010000000008348
- (void)consumeSandboxExtensions;	// IMP=0x0010000000008072
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000008046
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x0010000000007e18
