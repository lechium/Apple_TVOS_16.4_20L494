...
- (void).cxx_destruct;	// IMP=0x002000000001548c
...
- (void)logAutoUnlockEnd;	// IMP=0x0010000000014fca
- (void)logAutoUnlockStart;	// IMP=0x0010000000014fc4
- (void)invalidateAssertionTimer;	// IMP=0x0010000000014eee
- (void)restartAssertionTimer;	// IMP=0x0010000000014cdf
- (void)releaseIdleSleepAssertion;	// IMP=0x0010000000014c40
- (void)declareSystemActivityAssertion;	// IMP=0x00100000000149ac
- (void)sendConfirmationACK;	// IMP=0x001000000001478a
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x0010000000014322
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000014024
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000013d29
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000013719
- (void)handleCleanUpAWDL;	// IMP=0x001000000001368b
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x001000000001323d
- (void)createAuthTokenIfReady;	// IMP=0x0010000000012a37
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x0010000000012810
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x0010000000012545
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x0010000000012055
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x0010000000011a98
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000011318
- (void)nq_handleWiFiRequestInvalidated;	// IMP=0x001000000001127b
- (void)nq_handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000111c3
- (void)nq_awdlNetworkStarted;	// IMP=0x0010000000010fe3
- (void)createWiFiRequest;	// IMP=0x0010000000010835
- (void)alertOfUnlock;	// IMP=0x0010000000010719
- (void)promptForApproval;	// IMP=0x0010000000010713
- (void)systemIsActive:(id)arg1;	// IMP=0x001000000001055f
- (void)deviceDisconnected:(id)arg1;	// IMP=0x0010000000010308
- (void)removeObservers;	// IMP=0x00100000000102b5
- (void)addObservers;	// IMP=0x00100000000101b8
- (void)postBeganUnlockingNotification;	// IMP=0x0010000000010125
- (void)beginAKSSession;	// IMP=0x001000000001011f
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x001000000000ff5b
- (void)keyCanUnlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ff55
- (_Bool)keyInState;	// IMP=0x001000000000fdb5
- (void)_invalidate;	// IMP=0x001000000000fb22
- (void)invalidateOnQueue;	// IMP=0x001000000000fae3
- (void)invalidate;	// IMP=0x001000000000fa62
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x001000000000f7bc
