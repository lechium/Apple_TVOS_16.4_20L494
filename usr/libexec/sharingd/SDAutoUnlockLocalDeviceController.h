...
- (void).cxx_destruct;	// IMP=0x002000000000a68f
...
- (void)handleBioLockoutStateChanged:(unsigned long long)arg1;	// IMP=0x001000000000a63b
- (_Bool)shouldPrewarmAttempt;	// IMP=0x001000000000a629
- (void)deviceUnlockedWithMask:(_Bool)arg1;	// IMP=0x001000000000a57d
- (void)lockDevice;	// IMP=0x001000000000a577
- (void)lockWithBioLockOut;	// IMP=0x001000000000a565
- (_Bool)supportsPeriocular;	// IMP=0x001000000000a55d
- (_Bool)faceIDEnabled;	// IMP=0x001000000000a555
- (id)initWithQueue:(id)arg1;	// IMP=0x001000000000a500
- (id)init;	// IMP=0x001000000000a4d0
