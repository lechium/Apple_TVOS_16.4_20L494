...
- (void).cxx_destruct;	// IMP=0x002000000001eaba
@property __weak id <SDAirDropPublisherDelegate> delegate; // @synthesize delegate=_delegate;
- (void)invalidate;	// IMP=0x001000000001ea50
- (void)stop;	// IMP=0x001000000001e92a
- (void)start;	// IMP=0x001000000001e8b5
- (void)publish;	// IMP=0x001000000001e63d
- (void)removeObservers;	// IMP=0x001000000001e5ea
- (void)addObservers;	// IMP=0x001000000001e521
- (void)somethingChanged:(id)arg1;	// IMP=0x001000000001e50f
- (void)updateTXTRecordAndNotify;	// IMP=0x001000000001e207
- (void)publishCallBack:(CDStruct_87dc826d *)arg1;	// IMP=0x001000000001dfa3
- (void)dealloc;	// IMP=0x001000000001df57
- (id)initWithPort:(id)arg1 identity:(struct __SecIdentity *)arg2;	// IMP=0x001000000001dd8c
