...
- (void).cxx_destruct;	// IMP=0x002000000000604c
...
- (void)cleanup;	// IMP=0x0010000000005b5c
- (void)finishOperationID:(id)arg1;	// IMP=0x00100000000057af
- (void)queueOperationID:(id)arg1 options:(id)arg2 clientOperationCallbackProxy:(id)arg3 withBlock:(CDUnknownBlockType)arg4;	// IMP=0x0010000000004a8f
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x001000000000453f
- (id)initWithDaemon:(id)arg1 group:(id)arg2 bundleID:(id)arg3 isSpringBoardApp:(_Bool)arg4 requiresPastBuddy:(_Bool)arg5 scheduleSendBarrierBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000000043b0
