...
- (void).cxx_destruct;	// IMP=0x0020000000003ddb
...
- (void)complete;	// IMP=0x0010000000003ab6
- (void)applicationNoLongerInForeground:(id)arg1;	// IMP=0x0010000000003805
- (void)applicationEnteredForeground:(id)arg1;	// IMP=0x0010000000003554
- (id)_schedulerTaskIdentifier;	// IMP=0x0010000000003472
- (void)dealloc;	// IMP=0x001000000000328f
- (id)initWithConnection:(id)arg1 operationID:(id)arg2 group:(id)arg3 bundleID:(id)arg4 isSpringBoardApp:(_Bool)arg5 requiresPastBuddy:(_Bool)arg6 options:(id)arg7 schedulerClass:(Class)arg8 startHandler:(CDUnknownBlockType)arg9 suspendHandler:(CDUnknownBlockType)arg10;	// IMP=0x0010000000002333
