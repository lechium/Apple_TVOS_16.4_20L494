...
+ (_Bool)validateClientIdentifier:(id)arg1;	// IMP=0x004000000000e8d1
- (void).cxx_destruct;	// IMP=0x002000000000e96a
...
- (id)_createMatcher;	// IMP=0x001000000000e89b
- (void)loadContext:(CDUnknownBlockType)arg1;	// IMP=0x001000000000e811
- (void)loadConfiguration:(CDUnknownBlockType)arg1;	// IMP=0x001000000000e742
- (id)_initWithConfiguration:(id)arg1 installationID:(id)arg2;	// IMP=0x001000000000e6e5
- (id)initWithClientIdentifier:(id)arg1 clientType:(long long)arg2 installationID:(id)arg3;	// IMP=0x001000000000e516
