...
- (void).cxx_destruct;	// IMP=0x002000000000ce4e
...
- (void)mediaItemForShazamID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000c510
- (id)initWithAttribution:(id)arg1 clientType:(long long)arg2 URLBuilder:(id)arg3 contextBuilder:(id)arg4 networkRequester:(id)arg5;	// IMP=0x001000000000c42d
- (id)initWithAttribution:(id)arg1 clientType:(long long)arg2;	// IMP=0x001000000000c343
