...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000041484
- (void).cxx_destruct;	// IMP=0x002000000004164b
...
- (void)updateProgress;	// IMP=0x001000000004148c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000413b2
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000411c3
@property(readonly, nonatomic) NSArray *allItemIdentifiers;
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)subdivideTaskIntoBatchesOfSize:(long long)arg1;	// IMP=0x00100000000407ab
- (id)_init;	// IMP=0x001000000004067f
- (id)initWithTracksToModify:(id)arg1 groupsToModify:(id)arg2;	// IMP=0x00100000000404f6
