...
- (void).cxx_destruct;	// IMP=0x002000000000bd78
...
- (void)deliverContentForMatchedMediaItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000ba8f
- (void)deliverContentForNoMatchWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000b8a4
- (id)initWithContentProvider:(id)arg1;	// IMP=0x001000000000b839
