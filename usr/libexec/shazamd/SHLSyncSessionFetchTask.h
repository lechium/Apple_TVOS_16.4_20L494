...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001f7c1
- (void).cxx_destruct;	// IMP=0x002000000001f867
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001f73c
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001f655
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)init;	// IMP=0x001000000001f572
