...
- (void).cxx_destruct;	// IMP=0x002000000000b811
...
- (void)close;	// IMP=0x001000000000b7c7
- (void)open;	// IMP=0x001000000000b7bd
- (id)initWithRecordingSource:(long long)arg1 client:(long long)arg2 bundleIdentifer:(id)arg3;	// IMP=0x001000000000b73c
