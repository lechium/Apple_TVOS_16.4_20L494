...
- (void).cxx_destruct;	// IMP=0x00200000000112b6
...
- (id)initWithType:(long long)arg1 scope:(long long)arg2 callingProcessIdentifier:(id)arg3 sessionIdentifier:(id)arg4;	// IMP=0x00100000000111dd
