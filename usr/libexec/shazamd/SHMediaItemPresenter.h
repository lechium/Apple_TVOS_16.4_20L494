...
- (void).cxx_destruct;	// IMP=0x002000000000af3d
...
- (void)stop;	// IMP=0x001000000000af23
- (id)initWithRemoteConfiguration:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x001000000000ae98
- (id)initBundleIdentifier:(id)arg1;	// IMP=0x001000000000ae03
