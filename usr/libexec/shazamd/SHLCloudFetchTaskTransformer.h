...
- (void).cxx_destruct;	// IMP=0x002000000003a63d
...
- (id)configurationsByRecordZoneIDUsingCache:(id)arg1;	// IMP=0x001000000003a24c
- (id)recordIDsFromCloudBackedZones:(id)arg1;	// IMP=0x001000000003a023
- (id)cloudBackedZoneChangesOperationFromFetchTask:(id)arg1 forChangedZones:(id)arg2 container:(id)arg3;	// IMP=0x0010000000038ec8
- (id)cloudBackedDatabaseChangesOperationFromFetchTask:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000037e73
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000037d9f
