...
- (id)allWorkersForService:(id)arg1;	// IMP=0x001000000000253f
- (void)unregisterAllWorkersForService:(id)arg1;	// IMP=0x0010000000002497
- (void)service:(id)arg1 unregisterWorker:(id)arg2;	// IMP=0x001000000000237b
- (void)service:(id)arg1 registerWorker:(id)arg2;	// IMP=0x00100000000020c8
- (id)initWithClientCredentials:(id)arg1;	// IMP=0x0010000000001f80
