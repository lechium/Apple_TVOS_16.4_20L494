...
- (void).cxx_destruct;	// IMP=0x002000000000e4ee
...
- (id)tapForSource:(long long)arg1;	// IMP=0x001000000000e29d
- (id)tapsForAvailableSources;	// IMP=0x001000000000e064
- (id)initWithAudioRecordingManager:(id)arg1 clientCredentials:(id)arg2;	// IMP=0x001000000000dfcb
