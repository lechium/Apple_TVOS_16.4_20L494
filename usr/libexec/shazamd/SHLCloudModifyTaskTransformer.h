...
- (void).cxx_destruct;	// IMP=0x0020000000029a54
...
- (id)recordIDsToDeleteFromModifyTask:(id)arg1;	// IMP=0x0010000000029576
- (id)recordsToSaveFromModifyTask:(id)arg1 container:(id)arg2;	// IMP=0x0010000000029064
- (id)cloudBackedOperationFromModifyTask:(id)arg1 container:(id)arg2;	// IMP=0x0010000000027d3a
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000027c9f
