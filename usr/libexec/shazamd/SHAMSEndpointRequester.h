...
- (void).cxx_destruct;	// IMP=0x002000000000add0
...
- (id)sessionConfiguration;	// IMP=0x001000000000ab01
- (void)performRequest:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x001000000000a7a2
- (_Bool)isTokenFailureError:(id)arg1;	// IMP=0x001000000000a713
- (void)handleResult:(id)arg1 callback:(CDUnknownBlockType)arg2 error:(id)arg3;	// IMP=0x001000000000a4e4
- (void)invalidate;	// IMP=0x001000000000a4a7
- (id)initWithClientIdentifier:(id)arg1 clientType:(long long)arg2;	// IMP=0x001000000000a3d7
