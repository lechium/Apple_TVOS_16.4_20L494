...
- (void).cxx_destruct;	// IMP=0x002000000003750f
@property(retain, nonatomic) NSDictionary *songItemDictionary; // @synthesize songItemDictionary=_songItemDictionary;
- (struct CGSize)targetArtworkImageSizeFromOriginalSize:(struct CGSize)arg1;	// IMP=0x001000000003748d
- (id)artworkURLFromDictionary:(id)arg1;	// IMP=0x00100000000373d8
- (id)extractIDsFromRelation:(id)arg1;	// IMP=0x0010000000037193
...
- (id)initWithSongItemDictionary:(id)arg1;	// IMP=0x0010000000036adc
