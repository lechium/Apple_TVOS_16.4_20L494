...
- (void).cxx_destruct;	// IMP=0x0020000000031eff
...
- (void)recorder:(id)arg1 producedAudioBuffer:(id)arg2 atTime:(id)arg3;	// IMP=0x0010000000031b07
- (_Bool)isAudioSourceSupported:(long long)arg1;	// IMP=0x00100000000319bb
@property(readonly, nonatomic) long long suggestedAudioRecordingSource;
@property(readonly, nonatomic) _Bool isRunning;
- (void)detachTap:(id)arg1;	// IMP=0x00100000000314a5
- (void)attachTap:(id)arg1;	// IMP=0x0010000000031375
- (void)stopRecordingForReason:(long long)arg1;	// IMP=0x0010000000030d5a
- (void)startRecording;	// IMP=0x001000000003075c
- (id)initWithRecorders:(id)arg1;	// IMP=0x0010000000030685
- (void)dealloc;	// IMP=0x00100000000305e6
