...
- (void).cxx_destruct;	// IMP=0x0020000000041e83
...
- (void)stopRecognitionForRequestID:(id)arg1;	// IMP=0x0010000000041be4
- (void)stopRecognition;	// IMP=0x0010000000041b75
- (void)stop;	// IMP=0x0010000000041b63
@property(readonly, nonatomic) NSUUID *workerID;
@property(readonly, nonatomic) double timeRequiredToPerformWork;
- (void)downstreamMatcher:(id)arg1 didProduceResponse:(id)arg2;	// IMP=0x00100000000418aa
- (void)matcher:(id)arg1 didProduceResponse:(id)arg2;	// IMP=0x001000000004180c
- (void)startRecognitionForRequest:(id)arg1;	// IMP=0x0010000000041793
- (id)initWithMatcher:(id)arg1 notificationScheduler:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000004169b
