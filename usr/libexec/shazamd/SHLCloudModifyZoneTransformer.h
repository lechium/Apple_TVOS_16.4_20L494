...
- (void).cxx_destruct;	// IMP=0x002000000003eebb
...
- (id)recordZonesFromCloudBackedZones:(id)arg1;	// IMP=0x001000000003ecac
- (id)cloudBackedOperationForZonesToSave:(id)arg1 container:(id)arg2;	// IMP=0x001000000003e692
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000003e60d
