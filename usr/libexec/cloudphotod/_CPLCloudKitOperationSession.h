...
- (void).cxx_destruct;	// IMP=0x00200000001346a4
- (_Bool)isOngoing;	// IMP=0x0010000000134687
- (id)status;	// IMP=0x0010000000133da6
- (id)statusObject;	// IMP=0x0010000000133a77
- (void)endTask:(id)arg1 withOperationClasses:(id)arg2 operationsAllowingCellular:(id)arg3;	// IMP=0x00100000001335d4
- (_Bool)beginTask:(id)arg1;	// IMP=0x001000000013350e
- (id)init;	// IMP=0x0010000000133440
