...
+ (id)variableGroupWithVariablesAndGroups:(id)arg1;	// IMP=0x0040000000051109
+ (id)variableGroupWithVariables:(id)arg1;	// IMP=0x00100000000510c0
- (void).cxx_destruct;	// IMP=0x0020000000051f56
...
- (id)injectionForUpdates:(id)arg1;	// IMP=0x0010000000051e6f
- (id)valuesInSet:(id)arg1;	// IMP=0x0010000000051e5b
- (id)valuesInSet:(id)arg1 startingAtIndex:(int)arg2;	// IMP=0x0010000000051c4d
@property(readonly, nonatomic) id <PQLInjecting> injectionForDefaultValues;
- (id)injectionForValues:(id)arg1;	// IMP=0x0010000000051b8d
- (id)_defaultValuesObject;	// IMP=0x001000000005191e
- (id)initWithVariables:(id)arg1;	// IMP=0x001000000005132e
