...
- (void).cxx_destruct;	// IMP=0x00200000000c2c28
...
- (void)_runOperationsWithCurrentUserID:(id)arg1;	// IMP=0x00100000000c1272
- (void)runOperations;	// IMP=0x00100000000c11f0
- (void)sendProgressBatch:(id)arg1 updatedCursor:(id)arg2;	// IMP=0x00100000000c1176
- (id)initWithController:(id)arg1 cursor:(id)arg2 class:(Class)arg3 scope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000c0fc5
