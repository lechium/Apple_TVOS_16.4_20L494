...
- (void)runOperations;	// IMP=0x00100000000b6c7f
- (id)initWithController:(id)arg1 messages:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b6ba3
