...
+ (void)resetNotificationForLibraryIdentifier:(id)arg1;	// IMP=0x004000000005d367
- (void).cxx_destruct;	// IMP=0x002000000005e03d
...
- (id)createRadarURL;	// IMP=0x001000000005dc1b
- (_Bool)shouldPreventWipeOnUpgradeCreateRadar:(_Bool)arg1;	// IMP=0x001000000005db5c
- (_Bool)_warnUserAndReturnIfShouldPreventWipeOnUpgradeCreateRadar:(_Bool)arg1;	// IMP=0x001000000005d63a
- (void)_save;	// IMP=0x001000000005d5b5
- (id)initWithLibraryIdentifier:(id)arg1 reason:(id)arg2;	// IMP=0x001000000005d453
