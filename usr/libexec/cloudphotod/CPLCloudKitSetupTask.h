...
- (void).cxx_destruct;	// IMP=0x00200000000c0e80
...
- (void)runOperations;	// IMP=0x00100000000c0e5e
- (void)fetchUserRecord;	// IMP=0x00100000000c0d9d
- (void)fetchDerivativesFilter;	// IMP=0x00100000000c0abf
- (void)fetchDisabledFeatures;	// IMP=0x00100000000c0654
- (id)initWithController:(id)arg1 updateDisabledFeatures:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000c05be
