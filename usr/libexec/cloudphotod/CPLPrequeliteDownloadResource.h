...
- (void).cxx_destruct;	// IMP=0x0020000000055e79
...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x0010000000055ca5
- (id)initWithResource:(id)arg1;	// IMP=0x0010000000055aae
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000055928
