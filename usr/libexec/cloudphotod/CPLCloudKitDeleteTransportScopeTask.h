...
- (void).cxx_destruct;	// IMP=0x00200000000c8d38
...
- (void)runOperations;	// IMP=0x00100000000c8160
- (void)_didFinishDeleteWithError:(id)arg1;	// IMP=0x00100000000c7e42
- (id)_errorForDeleteError:(id)arg1;	// IMP=0x00100000000c7ce6
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000c7c04
