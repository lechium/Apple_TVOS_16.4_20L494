...
- (void).cxx_destruct;	// IMP=0x00200000000bc600
...
- (id)startDateDescriptionWithNow:(id)arg1;	// IMP=0x00100000000bc253
- (id)operationDescription;	// IMP=0x00100000000bc24b
- (id)extendedStatusDescriptionStrings;	// IMP=0x00100000000bc243
