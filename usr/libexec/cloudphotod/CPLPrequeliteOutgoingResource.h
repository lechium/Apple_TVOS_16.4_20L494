...
- (void).cxx_destruct;	// IMP=0x0020000000045d49
...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x0010000000045ba4
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x0010000000045a99
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x001000000004579c
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000045648
