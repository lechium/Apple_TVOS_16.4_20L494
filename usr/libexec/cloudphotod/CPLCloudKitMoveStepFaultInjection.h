...
+ (id)moveStepFaultInjectionWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x00400000000bb0c5
...
- (id)initWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x00100000000bb0fe
