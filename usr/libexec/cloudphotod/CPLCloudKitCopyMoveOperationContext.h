...
- (void).cxx_destruct;	// IMP=0x00200000000be1eb
...
- (id)extendedStatusDescriptionStrings;	// IMP=0x00100000000bdf20
- (id)operationDescription;	// IMP=0x00100000000bde72
- (void)addCopyMoveFromRecordID:(id)arg1 toRecordID:(id)arg2;	// IMP=0x00100000000bdda3
- (id)initFromZoneID:(id)arg1 toZoneID:(id)arg2;	// IMP=0x00100000000bdd01
