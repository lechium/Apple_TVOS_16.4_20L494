...
- (void).cxx_destruct;	// IMP=0x0020000000074d93
...
- (void)resetVersionHasChanged;	// IMP=0x0010000000074a02
...
- (void)noteDatabaseWasUpgradedToVersion:(long long)arg1 fromVersion:(long long)arg2;	// IMP=0x00100000000746b1
- (id)_valueForKey:(id)arg1 class:(Class)arg2;	// IMP=0x0010000000074656
- (id)initWithLibraryIdentifier:(id)arg1;	// IMP=0x0010000000073d49
- (void)_save;	// IMP=0x0010000000073bf5
- (id)_defaultsKey;	// IMP=0x0010000000073bd8
