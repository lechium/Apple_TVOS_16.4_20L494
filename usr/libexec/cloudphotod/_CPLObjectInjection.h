...
- (void).cxx_destruct;	// IMP=0x0020000000052365
...
- (id)bindValuesToKeepAlive;	// IMP=0x0010000000052339
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x0010000000052061
- (id)initWithVariables:(id)arg1 object:(id)arg2 sql:(id)arg3;	// IMP=0x0010000000051faa
