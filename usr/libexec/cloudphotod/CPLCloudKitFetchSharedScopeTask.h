...
- (void).cxx_destruct;	// IMP=0x00200000000fdf64
- (id)_scopeChangeFromShareMetadata:(id)arg1 currentUserID:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000fd961
- (void)_fetchSharedScopeWithCurrentUserID:(id)arg1;	// IMP=0x00100000000fceb1
- (void)runOperations;	// IMP=0x00100000000fce30
- (id)initWithController:(id)arg1 shareURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000fcd73
