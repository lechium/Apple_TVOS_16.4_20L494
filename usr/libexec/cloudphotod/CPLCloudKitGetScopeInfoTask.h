...
- (void).cxx_destruct;	// IMP=0x00200000001425f1
...
- (void)_determineScopeTypeAndFetchLibraryInfoWithCurrentUserID:(id)arg1;	// IMP=0x0010000000141f75
- (void)getScopeInfoWithCurrentUserID:(id)arg1;	// IMP=0x0010000000141929
- (void)runOperations;	// IMP=0x0010000000141894
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 previousScopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000014176f
