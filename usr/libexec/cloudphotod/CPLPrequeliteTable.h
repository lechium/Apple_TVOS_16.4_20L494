...
+ (id)tableWithName:(id)arg1;	// IMP=0x002000000005031e
- (void).cxx_destruct;	// IMP=0x002000000005051d
@property(readonly, nonatomic) NSString *tableName; // @synthesize tableName=_tableName;
- (id)redactedDescription;	// IMP=0x00100000000504ea
@property(readonly, copy) NSString *description;
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x00100000000504ab
@property(readonly, nonatomic) NSString *injectedTableName;
@property(readonly, nonatomic) NSData *sql;
- (id)initWithName:(id)arg1;	// IMP=0x0010000000050367
