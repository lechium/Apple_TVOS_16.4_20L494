...
- (void).cxx_destruct;	// IMP=0x00200000000ebcf6
- (void)runOperations;	// IMP=0x00100000000eb590
- (_Bool)_shouldSkipRampingRequest;	// IMP=0x00100000000eb514
- (double)timeoutIntervalForRequest;	// IMP=0x00100000000eb506
- (id)initWithController:(id)arg1 resourceType:(unsigned long long)arg2 numRequested:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000eb44b
