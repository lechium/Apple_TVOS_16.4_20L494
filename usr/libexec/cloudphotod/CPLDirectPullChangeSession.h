...
+ (id)selfCrashResetReason;	// IMP=0x00200000000a6017
- (void).cxx_destruct;	// IMP=0x00200000000a60e3
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000a5306
- (void)acknowledgeChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000a41bd
- (void)getChangeBatchWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000a2f83
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000a2702
- (id)clientWorkDescription;	// IMP=0x00100000000a26f5
