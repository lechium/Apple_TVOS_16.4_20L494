...
+ (id)variableWithName:(id)arg1 forTable:(id)arg2 type:(id)arg3;	// IMP=0x0020000000050c6d
+ (id)variableWithName:(id)arg1 type:(id)arg2;	// IMP=0x0010000000050c56
+ (id)indexVariableForVariableWithName:(id)arg1 forTable:(id)arg2;	// IMP=0x0010000000050688
+ (id)variableWithName:(id)arg1 defaultValue:(id)arg2 forTable:(id)arg3 type:(id)arg4;	// IMP=0x00100000000505de
+ (id)variableWithName:(id)arg1 defaultValue:(id)arg2 type:(id)arg3;	// IMP=0x0010000000050550
- (void).cxx_destruct;	// IMP=0x0020000000050f77
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000050e84
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000050e63
- (id)columnDefinitionWithDefaultValue:(id)arg1;	// IMP=0x0010000000050c9b
@property(readonly, nonatomic) id <PQLInjecting> columnDefinition;
- (id)valueFromSet:(id)arg1 atIndex:(int)arg2;	// IMP=0x0010000000050bb9
- (id)bindableValueForValue:(id)arg1;	// IMP=0x0010000000050b22
- (void)discardCachedValue;	// IMP=0x0010000000050ae9
- (void)setCachedValue:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0010000000050a76
- (id)cachedValueForIdentifier:(id)arg1;	// IMP=0x0010000000050a17
- (_Bool)hasCachedValueForIdentifier:(id)arg1;	// IMP=0x00100000000509cc
- (id)redactedDescription;	// IMP=0x0010000000050983
@property(readonly, copy) NSString *description;
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x0010000000050909
@property(readonly, nonatomic) NSData *sql;
- (id)initWithName:(id)arg1 defaultValue:(id)arg2 table:(id)arg3 type:(id)arg4;	// IMP=0x0010000000050742
