...
- (void).cxx_destruct;	// IMP=0x0020000000123bc3
...
- (void)runOperations;	// IMP=0x0010000000123b3d
- (id)initWithController:(id)arg1 scopedIdentifiers:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000123a2f
