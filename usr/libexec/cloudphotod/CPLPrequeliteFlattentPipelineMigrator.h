...
- (void).cxx_destruct;	// IMP=0x0020000000064992
@property(readonly, nonatomic) CPLPrequeliteStore *store; // @synthesize store=_store;
- (_Bool)migrate;	// IMP=0x0010000000064714
- (_Bool)_migratePushQueue:(id)arg1;	// IMP=0x0010000000064063
- (_Bool)_discardResourceForUpload:(id)arg1;	// IMP=0x0010000000063ee2
- (_Bool)_enqueueResourcesForChange:(id)arg1 inOutgoingResourcesWithUploadIdentifier:(id)arg2;	// IMP=0x00100000000639fe
- (unsigned long long)_availabilityOfResource:(id)arg1;	// IMP=0x00100000000637c4
@property(readonly, nonatomic) NSError *lastError; // @synthesize lastError=_lastError;
- (void)_setLastError:(id)arg1;	// IMP=0x0010000000063718
- (id)initWithStore:(id)arg1;	// IMP=0x001000000006357f
