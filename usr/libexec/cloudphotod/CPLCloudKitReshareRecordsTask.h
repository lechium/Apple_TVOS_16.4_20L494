...
- (void).cxx_destruct;	// IMP=0x00200000000e6c78
...
- (id)finalizedDestinationCKRecordFromProposedCKRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000e6ab0
- (id)recordNameInDestinationCKRecordFromRecordName:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000e6a0b
- (_Bool)shouldCopyCKRecordKeyToDestinationCKRecord:(id)arg1;	// IMP=0x00100000000e695e
- (id)baseDestinationCKRecordForSourceCKRecord:(id)arg1 destinationCKRecordID:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000e62f9
- (void)prepareCopyForCKRecordID:(id)arg1 fromCKRecord:(id)arg2;	// IMP=0x00100000000e6107
- (_Bool)shouldCopyForCKRecordID:(id)arg1 fromCKRecord:(id)arg2;	// IMP=0x00100000000e60ff
- (id)rejectedScopedIdentifierForRejectedCKRecordID:(id)arg1;	// IMP=0x00100000000e600a
- (void)runOperations;	// IMP=0x00100000000e5866
- (void)_deleteSourceRecordIDs:(id)arg1;	// IMP=0x00100000000e52ea
- (id)initWithController:(id)arg1 records:(id)arg2 sourceScope:(id)arg3 destinationScope:(id)arg4 transportScopeMapping:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00100000000e51ac
