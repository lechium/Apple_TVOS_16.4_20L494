...
- (void).cxx_destruct;	// IMP=0x002000000006002e
...
- (id)resource;	// IMP=0x001000000005fe48
- (id)initWithResource:(id)arg1;	// IMP=0x001000000005fc62
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000005fae7
