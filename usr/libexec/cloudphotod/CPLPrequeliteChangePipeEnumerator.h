...
- (void).cxx_destruct;	// IMP=0x0020000000037bb7
...
- (void)enumerateChangesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000037a2d
@property(readonly, nonatomic) _Bool hasChanges;
- (id)initWithStore:(id)arg1 table:(id)arg2;	// IMP=0x00100000000378eb
