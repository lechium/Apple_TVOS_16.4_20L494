...
+ (id)simulateOverQuotaPhases;	// IMP=0x002000000011a646
- (void).cxx_destruct;	// IMP=0x002000000011f43b
...
- (void)_executeUnsharePlanFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000011f0ae
- (void)_executeSharePlanFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000011ed80
- (void)_uploadSharedBatchFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000011ea0c
- (void)_uploadBatchFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000011e56d
- (void)_uploadRecords:(id)arg1 deleteRecordIDs:(id)arg2 identification:(id)arg3 fromPlanner:(id)arg4 uploadContext:(id)arg5 updateProgress:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x001000000011d2f4
- (void)_fetchPrivateRecordsFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000011cd8b
- (void)_fetchSharedRecordsFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000011c7f6
- (void)_runModernOperationsWithCurrentUserID:(id)arg1;	// IMP=0x001000000011b589
- (void)runOperations;	// IMP=0x001000000011b507
- (id)initWithController:(id)arg1 scope:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 progressHandler:(CDUnknownBlockType)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x001000000011a6d9
