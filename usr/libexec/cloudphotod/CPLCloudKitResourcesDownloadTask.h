...
- (void).cxx_destruct;	// IMP=0x002000000010d86c
@property(readonly, copy, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(copy, nonatomic) NSArray *downloadTasks; // @synthesize downloadTasks=_downloadTasks;
- (void)runOperations;	// IMP=0x001000000010d2f0
- (void)_downloadNextGroup;	// IMP=0x001000000010cd11
- (void)_downloadNextOperationType;	// IMP=0x001000000010cc0f
- (void)_downloadCurrentGroup;	// IMP=0x001000000010b7f9
- (id)_recordIDForResourcesWithItemScopedIdentifier:(id)arg1;	// IMP=0x001000000010b5ab
- (id)_cloudKitScopeForTask:(id)arg1;	// IMP=0x001000000010b2de
- (id)_downloadOperationWithRecordIDsAndTasks:(id)arg1 keys:(id)arg2 perRecordProgressBlock:(CDUnknownBlockType)arg3 perRecordCompletionBlock:(CDUnknownBlockType)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x001000000010abf0
- (void)_finishRemainingTasksWithError:(id)arg1;	// IMP=0x001000000010a9b2
- (void)cancelDownloadTask:(id)arg1;	// IMP=0x001000000010a79c
- (id)initWithController:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000010a11a
