...
- (void).cxx_destruct;	// IMP=0x0020000000135c61
- (void)queryUserDetailsWithCurrentUserID:(id)arg1;	// IMP=0x0010000000135350
- (void)runOperations;	// IMP=0x00100000001352cf
- (id)initWithController:(id)arg1 participants:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000135212
