...
- (void).cxx_destruct;	// IMP=0x002000000001ab1a
...
- (_Bool)matchesParameters:(id)arg1;	// IMP=0x001000000001a944
- (id)redactedDescription;	// IMP=0x001000000001a890
- (id)description;	// IMP=0x001000000001a7dc
@property(readonly, nonatomic) id asPlist;
- (id)initWithPlist:(id)arg1;	// IMP=0x001000000001a40a
- (id)initWithClientLibraryBaseURL:(id)arg1 cloudLibraryStateStorageURL:(id)arg2 cloudLibraryResourceStorageURL:(id)arg3 libraryIdentifier:(id)arg4 options:(unsigned long long)arg5;	// IMP=0x001000000001a2f5
