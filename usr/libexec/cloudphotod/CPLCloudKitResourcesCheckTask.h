...
- (void).cxx_destruct;	// IMP=0x0000000000147329
- (_Bool)_checkResource:(id)arg1 record:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000146fc6
- (void)runOperations;	// IMP=0x0010000000146542
- (id)initWithController:(id)arg1 resources:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000146413
