...
+ (unsigned long long)resourceTypeForFieldName:(id)arg1;	// IMP=0x004000000010fd49
+ (id)resourceKeysForResourceType:(unsigned long long)arg1;	// IMP=0x001000000010fcf4
- (void).cxx_destruct;	// IMP=0x00200000001101fd
...
- (id)redactedDescription;	// IMP=0x0010000000110055
- (id)description;	// IMP=0x001000000010ffd8
- (id)initWithPrefix:(id)arg1 resourceType:(unsigned long long)arg2;	// IMP=0x001000000010fddd
