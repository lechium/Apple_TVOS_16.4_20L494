...
- (void)fireAlarm:(id)arg1 error:(int)arg2;	// IMP=0x00100000003a69a3
- (void)onNotification:(int)arg1 withData:(id)arg2;	// IMP=0x00100000003a699d
- (id)initWithMotionAlarmSubscription:(void *)arg1;	// IMP=0x00100000003a6960
