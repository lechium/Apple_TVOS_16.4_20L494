...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000719bbe
- (unsigned long long)hash;	// IMP=0x0010000000719aaa
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000719921
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000007197fc
- (void)copyTo:(id)arg1;	// IMP=0x0010000000719715
- (void)writeTo:(id)arg1;	// IMP=0x00100000007195c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000007195bc
- (id)dictionaryRepresentation;	// IMP=0x0010000000718c74
- (id)description;	// IMP=0x0010000000718bfd
