...
- (void)deregisterCallback;	// IMP=0x001000000047deec
- (void)registerCallback;	// IMP=0x001000000047dcd3
- (void)removeAllClients;	// IMP=0x001000000047dbae
- (void)removeClient:(id)arg1;	// IMP=0x001000000047db3d
- (void)addClient:(id)arg1;	// IMP=0x001000000047dacb
- (void)dealloc;	// IMP=0x001000000047da58
- (id)init;	// IMP=0x001000000047d9f0
