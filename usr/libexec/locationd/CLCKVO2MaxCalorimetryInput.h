...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000005fe5ae
- (unsigned long long)hash;	// IMP=0x00100000005fdd16
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000005fda10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000005fd82d
- (void)copyTo:(id)arg1;	// IMP=0x00100000005fd688
- (void)writeTo:(id)arg1;	// IMP=0x00100000005fd47d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000005fd470
- (id)dictionaryRepresentation;	// IMP=0x00100000005fc8d6
- (id)description;	// IMP=0x00100000005fc85f
