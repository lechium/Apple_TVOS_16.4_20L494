...
- (id)description;	// IMP=0x001000000097d861
- (id)jsonObject;	// IMP=0x001000000097d7fd
@property(readonly) NSURLRequest *URLRequest;
- (id)initWithPayload:(id)arg1;	// IMP=0x001000000097d5d6
- (id)initWithArchive:(id)arg1;	// IMP=0x001000000097d586
- (id)initWithRequest:(id)arg1 endpoint:(id)arg2 headers:(id)arg3;	// IMP=0x001000000097d4ec
- (void)dealloc;	// IMP=0x001000000097d494
- (id)initWithPayload:(id)arg1 requestTypeCode:(unsigned int)arg2 endpoint:(id)arg3 headers:(id)arg4;	// IMP=0x001000000097d40e
