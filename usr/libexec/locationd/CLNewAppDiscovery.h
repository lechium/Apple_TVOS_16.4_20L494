...
+ (id)getSilo;	// IMP=0x0010000000568ced
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000568cd4
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000568c77
+ (_Bool)isSupported;	// IMP=0x0010000000568ad0
- (id).cxx_construct;	// IMP=0x002000000056b8d5
- (void).cxx_destruct;	// IMP=0x001000000056b881
...
- (void)onRegionChangeNotification;	// IMP=0x001000000056b697
- (_Bool)isServiceEnabledViaGeoCountryOverrides;	// IMP=0x001000000056b4f4
- (_Bool)isUsableLocation:(id)arg1;	// IMP=0x001000000056b4a9
- (void)onLocation:(id)arg1;	// IMP=0x001000000056991a
- (void)endService;	// IMP=0x0010000000569877
- (void)beginService;	// IMP=0x0010000000568d86
- (id)init;	// IMP=0x0010000000568d49
