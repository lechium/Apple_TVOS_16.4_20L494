...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000015ae23
- (unsigned long long)hash;	// IMP=0x001000000015ac05
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015ab45
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000015aa9a
- (void)copyTo:(id)arg1;	// IMP=0x001000000015aa2d
- (void)writeTo:(id)arg1;	// IMP=0x001000000015a989
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000015a97c
- (id)dictionaryRepresentation;	// IMP=0x001000000015a510
- (id)description;	// IMP=0x001000000015a499
