...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000f82c0
- (unsigned long long)hash;	// IMP=0x00100000000f7b0c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f793d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f77fd
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f76fb
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f7575
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f7568
- (id)dictionaryRepresentation;	// IMP=0x00100000000f6bad
- (id)description;	// IMP=0x00100000000f6b36
