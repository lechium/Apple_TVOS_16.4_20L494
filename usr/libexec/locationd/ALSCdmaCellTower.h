...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000006fb805
- (unsigned long long)hash;	// IMP=0x00100000006fb6ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000006fb51c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006fb3c4
- (void)copyTo:(id)arg1;	// IMP=0x00100000006fb2aa
- (void)writeTo:(id)arg1;	// IMP=0x00100000006fb169
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000006fb15c
- (id)dictionaryRepresentation;	// IMP=0x00100000006fa8a6
- (id)description;	// IMP=0x00100000006fa82f
...
- (void)dealloc;	// IMP=0x00100000006fa58c
