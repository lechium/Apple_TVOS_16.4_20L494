...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001dd8ad
...
- (id)description;	// IMP=0x00100000001dddd6
- (id)jsonObject;	// IMP=0x00100000001ddbdf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001ddb04
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001dd9f1
- (void)dealloc;	// IMP=0x00100000001dd9b6
- (id)initWithAccessPoint:(struct AccessPoint)arg1;	// IMP=0x00100000001dd8b5
