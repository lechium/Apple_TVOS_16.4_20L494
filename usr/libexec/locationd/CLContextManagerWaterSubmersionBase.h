...
- (id).cxx_construct;	// IMP=0x002000000047953b
- (void).cxx_destruct;	// IMP=0x00100000004794da
...
- (void)notificationAcknowledged:(unsigned long long)arg1;	// IMP=0x00100000004791d6
- (void)startSubmersionPowerAssertion;	// IMP=0x0010000000479065
- (void)retrieveCachedSubmersionState;	// IMP=0x0010000000478d6a
- (void)saveCachedSubmersionState:(shared_ptr_85043445)arg1;	// IMP=0x0010000000478bfa
- (void)onNotSubmerged;	// IMP=0x0010000000478bae
- (void)onDeepSubmersion:(double)arg1 withStateChanged:(_Bool)arg2;	// IMP=0x0010000000478b4b
- (void)onShallowSubmersion:(_Bool)arg1;	// IMP=0x0010000000478afa
- (void)updateSubmersionStateFromMeasurement:(id)arg1;	// IMP=0x00100000004787b2
- (void)updateSubmersionStateFromAOPState:(shared_ptr_85043445)arg1;	// IMP=0x0010000000478458
- (void)updateClientsSubmersionState:(id)arg1;	// IMP=0x00100000004782bd
- (void)updateClientsSubmersionMeasurement:(id)arg1;	// IMP=0x0010000000477bf4
- (void)clientConnected:(id)arg1 withNotification:(unsigned long long)arg2;	// IMP=0x00100000004779fc
- (void)notifyHKUpdates:(id)arg1;	// IMP=0x001000000047799e
- (void)stopHKCollector;	// IMP=0x001000000047787a
- (void)startHKCollector:(double)arg1;	// IMP=0x00100000004776fa
- (void)dealloc;	// IMP=0x0010000000477610
- (id)initWithUniverse:(id)arg1 delegate:(id)arg2 withBuffer:(void *)arg3 withSourceAggregator:(id)arg4;	// IMP=0x0010000000477170
