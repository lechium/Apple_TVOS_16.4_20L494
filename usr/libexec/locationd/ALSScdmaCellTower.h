...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000009d70f3
- (unsigned long long)hash;	// IMP=0x00100000009d7025
- (_Bool);	// IMP=0x00100000009d6f20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009d6e33
- (void)copyTo:(id)arg1;	// IMP=0x00100000009d6d90
- (void)writeTo:(id)arg1;	// IMP=0x00100000009d6cad
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000009d6ca0
- (id)dictionaryRepresentation;	// IMP=0x00100000009d65fa
- (id)description;	// IMP=0x00100000009d6583
@property(nonatomic) _Bool hasPsc;
@property(nonatomic) _Bool hasArfcn;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x00100000009d64a0
