...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000007245b1
- (unsigned long long)hash;	// IMP=0x00100000007244b1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000724346
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000724224
- (void)copyTo:(id)arg1;	// IMP=0x0010000000724140
- (void)writeTo:(id)arg1;	// IMP=0x001000000072403d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000724030
- (id)dictionaryRepresentation;	// IMP=0x0010000000723912
- (id)description;	// IMP=0x001000000072389b
...
- (void)dealloc;	// IMP=0x001000000072368c
