...
- (void)_clearBuffers;	// IMP=0x001000000080698d
- (unsigned long long)_removeAdditionalInconsistentSpeedPedometerEntries;	// IMP=0x0010000000806745
- (void)_closeCurrentTrack;	// IMP=0x0010000000805dcb
- (void)_closeTrackCheckPedometer;	// IMP=0x0010000000805587
- (void)_closeTrackCheckGpsOdometer;	// IMP=0x0010000000804e63
- (void)_closeTrackCheckGpsLocationFiltered;	// IMP=0x0010000000804ace
- (void)_closeTrackCheckGpsLocation;	// IMP=0x00100000008048f3
- (void)_calculateTimeStartEndDistanceGpsPed;	// IMP=0x0010000000803e04
- (double)_extremaRemovedMean:(double [5])arg1;	// IMP=0x0010000000803da0
- (id)_filterGpsLocationBuffer;	// IMP=0x001000000080383c
- (void)updatePedometerBuffer:(struct CLExtendedStepCountEntry)arg1;	// IMP=0x00100000008036f2
- (void)updateGpsOdometerBuffer:(struct CLOdometerEntry)arg1;	// IMP=0x0010000000803480
- (void)_updateGpsLocationBufferFiltered:(id)arg1;	// IMP=0x00100000008033a7
- (void)updateGpsLocationBuffer:(id)arg1 gpsSource:(int)arg2;	// IMP=0x0010000000802d3e
- (void)stop;	// IMP=0x0010000000802c72
- (void)dealloc;	// IMP=0x0010000000802bf7
- (id)init;	// IMP=0x0010000000802a66
