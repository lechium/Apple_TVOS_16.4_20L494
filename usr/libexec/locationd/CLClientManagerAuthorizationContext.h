...
@interface CLClientManagerAuthorizationContext : NSObject
{
    ...
    MISSING_TYPE *_staticServiceMask;	// 24 = 0x18
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000007a3878
- (_Bool)inUseLevelIsAtLeast:(int)arg1;	// IMP=0x00100000007a386c
- (_Bool)isAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x00100000007a384d
- (_Bool)isAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x00100000007a3806
- (_Bool)isNonProvisionallyAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x00100000007a37e7
- (_Bool)isNonProvisionallyAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x00100000007a37c1
- (id)description;	// IMP=0x00100000007a3780
- (id)authorizationContextByANDingServiceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg1;	// IMP=0x00100000007a36f7
- (id)initWithInUseLevel:(int)arg1 registrationResult:(int)arg2 transientAwareRegistrationResult:(int)arg3 serviceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg4 authorizedForWidgetUpdates:(_Bool)arg5;	// IMP=0x00100000007a3690
