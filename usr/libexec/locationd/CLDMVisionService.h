...
+ (_Bool)isSupported;	// IMP=0x0020000000611074
+ (id)getSilo;	// IMP=0x0010000000611018
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000610fff
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000610fa2
- (id).cxx_construct;	// IMP=0x002000000061116e
- (void).cxx_destruct;	// IMP=0x00100000006110f2
- (id)init;	// IMP=0x00100000006110a1
