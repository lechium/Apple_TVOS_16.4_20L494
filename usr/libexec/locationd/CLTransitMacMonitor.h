...
+ (_Bool)isSupported;	// IMP=0x00200000009e13f5
+ (id)getSilo;	// IMP=0x00100000009e135c
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x00100000009e1343
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x00100000009e12e6
- (id).cxx_construct;	// IMP=0x00200000009e3558
- (void).cxx_destruct;	// IMP=0x00100000009e3506
...
- (void)onLocationNotification:(int)arg1 data:(struct NotificationData)arg2;	// IMP=0x00100000009e3304
- (void)onWifiServiceNotification:(int)arg1 data:(struct NotificationData)arg2;	// IMP=0x00100000009e2a76
- (void)processNewAccessPoints:(const void *)arg1 transitTileResults:(id)arg2;	// IMP=0x00100000009e1daf
- (void)stopMonitoringTransitStateForClient:(byref id)arg1;	// IMP=0x00100000009e1a8c
- (void)startMonitoringTransitStateForClient:(byref id)arg1;	// IMP=0x00100000009e197e
- (void)endService;	// IMP=0x00100000009e1811
- (void)beginService;	// IMP=0x00100000009e13fd
- (id)init;	// IMP=0x00100000009e13b8
