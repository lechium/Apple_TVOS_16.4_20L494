...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001326b3
- (unsigned long long)hash;	// IMP=0x001000000013261c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000132528
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013245e
- (void)copyTo:(id)arg1;	// IMP=0x00100000001323d2
- (void)writeTo:(id)arg1;	// IMP=0x0010000000132309
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001322fc
- (id)dictionaryRepresentation;	// IMP=0x0010000000131d18
- (id)description;	// IMP=0x0010000000131ca1
