...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000002c7d9f
- (unsigned long long)hash;	// IMP=0x00100000002c701b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002c6b96
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002c68cc
- (void)copyTo:(id)arg1;	// IMP=0x00100000002c6640
- (void)writeTo:(id)arg1;	// IMP=0x00100000002c6331
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002c6324
- (id)dictionaryRepresentation;	// IMP=0x00100000002c4db2
- (id)description;	// IMP=0x00100000002c4d3b
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x00100000002c4ba1
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x00100000002c4b66
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000002c405c
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000002c3c94
