...
- (void)findCandidateServersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000f1e6f
- (id)deviceWithEffectiveID:(id)arg1;	// IMP=0x00100000000f1c54
- (void)invalidate;	// IMP=0x00100000000f1b28
- (void)dealloc;	// IMP=0x00100000000f1aea
- (id)initOnQueue:(id)arg1;	// IMP=0x00100000000f151e
