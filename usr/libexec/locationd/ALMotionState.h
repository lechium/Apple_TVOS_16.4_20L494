...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000f3f31
- (unsigned long long)hash;	// IMP=0x00100000000f3dcb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f3ce0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f3c0b
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f3b8c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f3af9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f3aec
- (id)dictionaryRepresentation;	// IMP=0x00100000000f36aa
- (id)description;	// IMP=0x00100000000f3633
@property(readonly, nonatomic) _Bool hasNatalieFeatures;
@property(nonatomic) _Bool hasTimestamp;
- (void)dealloc;	// IMP=0x00100000000f3580
