...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000015c25d
- (unsigned long long)hash;	// IMP=0x001000000015c04f
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015be6b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000015bcf9
- (void)copyTo:(id)arg1;	// IMP=0x001000000015bbcb
- (void)writeTo:(id)arg1;	// IMP=0x001000000015ba89
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000015ba7c
- (id)dictionaryRepresentation;	// IMP=0x001000000015b22c
- (id)description;	// IMP=0x001000000015b1b5
...
- (void)dealloc;	// IMP=0x001000000015aee4
