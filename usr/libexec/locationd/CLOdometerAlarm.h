...
- (void)fire:(double)arg1 withError:(id)arg2;	// IMP=0x00100000007cf6ee
- (void)invalidate;	// IMP=0x00100000007cf685
- (void)dealloc;	// IMP=0x00100000007cf62e
- (id)initWithDistance:(double)arg1 inUniverse:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00100000007cf52b
- (id)init;	// IMP=0x00100000007cf4fc
