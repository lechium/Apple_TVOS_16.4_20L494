...
- (id)debugDescription;	// IMP=0x001000000082a26a
- (id)description;	// IMP=0x001000000082a201
- (void)dealloc;	// IMP=0x001000000082a1bf
- (id)initWithArchive:(id)arg1 index:(unsigned int)arg2 score:(float)arg3 unslammedAPCount:(unsigned int)arg4 macsNotInALSDatabase:(id)arg5;	// IMP=0x001000000082a133
