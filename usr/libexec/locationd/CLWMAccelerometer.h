...
- (id).cxx_construct;	// IMP=0x0020000000c097fc
- (void).cxx_destruct;	// IMP=0x0010000000c097b9
- (int)getSampleCount;	// IMP=0x0010000000c097a9
- (void)setWriter:(shared_ptr_da0ccc6f)arg1;	// IMP=0x0010000000c09795
- (void)onAccelerometerData:(const struct Sample *)arg1;	// IMP=0x0010000000c09550
- (id)metadata;	// IMP=0x0010000000c0952b
- (void)dealloc;	// IMP=0x0010000000c094dd
- (void)teardownListeners;	// IMP=0x0010000000c09488
- (void)setupListener;	// IMP=0x0010000000c09163
- (id)initWithDelegate:(id)arg1 universeCopy:(id)arg2 settings:(struct SettingStructure)arg3;	// IMP=0x0010000000c090ac
