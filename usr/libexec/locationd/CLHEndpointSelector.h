...
- (id)description;	// IMP=0x00100000009fa08a
- (id)jsonObject;	// IMP=0x00100000009f9f10
- (void)updateEndpoint:(id *)arg1 withKey:(id)arg2;	// IMP=0x00100000009f9da1
- (void)refresh;	// IMP=0x00100000009f9cb5
- (void)dealloc;	// IMP=0x00100000009f9c33
- (id)init;	// IMP=0x00100000009f9a90
