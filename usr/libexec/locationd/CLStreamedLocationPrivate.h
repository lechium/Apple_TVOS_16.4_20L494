...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000838cd5
- (unsigned long long)hash;	// IMP=0x00100000008384be
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000838264
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000008380d3
- (void)copyTo:(id)arg1;	// IMP=0x0010000000837f80
- (void)writeTo:(id)arg1;	// IMP=0x0010000000837ddd
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000837dd0
- (id)dictionaryRepresentation;	// IMP=0x00100000008374a6
- (id)description;	// IMP=0x001000000083742f
@property(nonatomic) _Bool hasTropicalSavannaTreeId;
@property(nonatomic) _Bool hasTropicalSavannaBranchCount;
- (int)StringAsTropicalSavannaProximity:(id)arg1;	// IMP=0x00100000008372cc
- (id)tropicalSavannaProximityAsString:(int)arg1;	// IMP=0x0010000000837293
...
- (struct CLDaemonLocationPrivate)daemonLocationPrivate;	// IMP=0x001000000080abbe
- (id)initWithDaemonLocationPrivate:(const void *)arg1;	// IMP=0x001000000080a6a4
