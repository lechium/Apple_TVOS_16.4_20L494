...
- (unsigned long long)hash;	// IMP=0x00100000002d1694
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002d1519
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002d1409
- (void)copyTo:(id)arg1;	// IMP=0x00100000002d1337
- (void)writeTo:(id)arg1;	// IMP=0x00100000002d1209
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002d11fc
- (id)dictionaryRepresentation;	// IMP=0x00100000002d066a
- (id)description;	// IMP=0x00100000002d05f3
@property(nonatomic) _Bool hasMetsFM;
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
- (void);	// IMP=0x00100000002d0514
- (int)StringAsTruthMetsSource:(id)arg1;	// IMP=0x00100000002d0470
- (id)truthMetsSourceAsString:(int)arg1;	// IMP=0x00100000002d0437
...
- (int)StringAsUserMetsSource:(id)arg1;	// IMP=0x00100000002d0329
- (id)userMetsSourceAsString:(int)arg1;	// IMP=0x00100000002d02f0
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000002cfd58
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000002cf990
