...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000a73ee6
- (unsigned long long)hash;	// IMP=0x0010000000a73dfd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a73cbd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000a73bb6
- (void)copyTo:(id)arg1;	// IMP=0x0010000000a73aed
- (void)writeTo:(id)arg1;	// IMP=0x0010000000a73a09
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000a739fc
- (id)dictionaryRepresentation;	// IMP=0x0010000000a733a0
- (id)description;	// IMP=0x0010000000a73329
...
- (void)dealloc;	// IMP=0x0010000000a73164
