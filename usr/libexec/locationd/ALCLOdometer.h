...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000a7583b
- (unsigned long long)hash;	// IMP=0x0010000000a750c4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a74ef8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000a74db9
- (void)copyTo:(id)arg1;	// IMP=0x0010000000a74cb8
- (void)writeTo:(id)arg1;	// IMP=0x0010000000a74b6d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000a74b60
- (id)dictionaryRepresentation;	// IMP=0x0010000000a743ed
- (id)description;	// IMP=0x0010000000a74376
- (int)StringAsQuality:(id)arg1;	// IMP=0x0010000000a742f0
- (id)qualityAsString:(int)arg1;	// IMP=0x0010000000a742b7
