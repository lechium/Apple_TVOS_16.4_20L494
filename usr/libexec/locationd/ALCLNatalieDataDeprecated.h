...
- (double)duration;	// IMP=0x0010000000808fd9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000808e2b
- (unsigned long long)hash;	// IMP=0x00100000008089b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000080880b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000008086e4
- (void)copyTo:(id)arg1;	// IMP=0x00100000008085ef
- (void)writeTo:(id)arg1;	// IMP=0x00100000008084ad
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000008084a0
- (id)dictionaryRepresentation;	// IMP=0x0010000000807815
- (id)description;	// IMP=0x001000000080779e
@property(nonatomic) _Bool hasDuration;
- (void)setDuration:(double)arg1;	// IMP=0x0010000000807753
@property(nonatomic) _Bool hasTimestamp;
@property(nonatomic) _Bool hasBasalNatalies;
@property(nonatomic) _Bool hasBasalMETs;
@property(nonatomic) _Bool hasMets;
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000008070f8
- (id)activityTypeAsString:(int)arg1;	// IMP=0x0010000000806d33
