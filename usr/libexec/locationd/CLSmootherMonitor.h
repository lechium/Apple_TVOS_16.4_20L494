...
+ (id)getSilo;	// IMP=0x0020000000a75a70
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000a75a57
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000a759fa
...
- (void)smoothLocations:(id)arg1 workoutActivity:(int)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000a76687
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000a75db9
- (void)dealloc;	// IMP=0x0010000000a75d8a
- (void)endService;	// IMP=0x0010000000a75c74
- (void)beginService;	// IMP=0x0010000000a75b09
- (id)init;	// IMP=0x0010000000a75acc
