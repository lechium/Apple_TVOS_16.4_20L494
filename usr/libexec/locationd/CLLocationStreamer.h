...
+ (_Bool)isSupported;	// IMP=0x0020000000368bd2
+ (id)getSilo;	// IMP=0x0010000000368b76
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000368b5d
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000368b00
- (id).cxx_construct;	// IMP=0x002000000036b891
- (void).cxx_destruct;	// IMP=0x001000000036b800
...
- (void)pairedDeviceIsNearby:(_Bool)arg1;	// IMP=0x001000000036b589
- (void)successfullySentMessage:(id)arg1;	// IMP=0x001000000036b4a3
- (void)failedToSendMessage:(id)arg1 withError:(id)arg2 isFatal:(_Bool)arg3;	// IMP=0x001000000036b397
- (void)receivedMessageOfType:(id)arg1 withPayload:(id)arg2;	// IMP=0x001000000036af88
- (void)onMotionStateNotification:(const int *)arg1 withData:(const union NotificationData *)arg2;	// IMP=0x001000000036ac9d
- (void)sendMotionState;	// IMP=0x001000000036aaf2
- (MISSING_TYPE *)stopMotionAlarm;	// IMP=0x001000000036a9c5
- (void)startMotionAlarm;	// IMP=0x001000000036a8a0
- (void)reevaluateMotionSubscription;	// IMP=0x001000000036a6c3
- (void)onLocationNotification:(const int *)arg1 withData:(const void *)arg2;	// IMP=0x001000000036a179
- (void)startUpdatingLocationWithGranularity:(int)arg1 includeMotion:(_Bool)arg2 inFitnessSession:(_Bool)arg3 inAirborneSession:(_Bool)arg4 emergencyEnablementAssertionActive:(_Bool)arg5 hasMapMatching:(_Bool)arg6;	// IMP=0x0010000000369e2c
- (void)stopLocation;	// IMP=0x001000000036983c
- (void)unregisterAllLocationNotifications;	// IMP=0x00100000003697b6
- (void)sendAliveAgainMessage;	// IMP=0x0010000000369624
- (void)endService;	// IMP=0x00100000003694ff
- (void)beginService;	// IMP=0x0010000000368c77
- (id)init;	// IMP=0x0010000000368c3a
