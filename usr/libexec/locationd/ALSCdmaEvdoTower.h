...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000070440f
- (unsigned long long)hash;	// IMP=0x001000000070435a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000704253
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000070415a
- (void)copyTo:(id)arg1;	// IMP=0x00100000007040ac
- (void)writeTo:(id)arg1;	// IMP=0x0010000000703fe9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000703fdc
- (id)dictionaryRepresentation;	// IMP=0x0010000000703ab1
- (id)description;	// IMP=0x0010000000703a3a
...
- (void)dealloc;	// IMP=0x00100000007038e0
