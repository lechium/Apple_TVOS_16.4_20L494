...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000d711
- (void).cxx_destruct;	// IMP=0x002000000000e228
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000dc31
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000daa5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000d914
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000d719
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x001000000000d5c0
