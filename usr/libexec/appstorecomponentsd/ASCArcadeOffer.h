...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000006cec
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000007506
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000071e9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000071de
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000007006
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000006cf4
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x0010000000006b47
