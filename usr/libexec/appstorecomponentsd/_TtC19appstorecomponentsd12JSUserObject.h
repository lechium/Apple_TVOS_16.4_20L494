...
- (void).cxx_destruct;	// IMP=0x004000000008d1a0
- (id)init;	// IMP=0x001000000008d140
- (id)cookieForUrlWithName:(id)arg1:(id)arg2;	// IMP=0x001000000008d0b0
- (id)cookiesForUrl:(id)arg1;	// IMP=0x001000000008cdd0
