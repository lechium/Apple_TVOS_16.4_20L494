...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000002141
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000002a76
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000026b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000026ae
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000246e
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000002149
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x0010000000001f70
