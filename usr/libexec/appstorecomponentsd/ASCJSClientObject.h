...
- (void).cxx_destruct;	// IMP=0x002000000000bb18
@property(retain) ACAccount *activeiTunesAccount; // @synthesize activeiTunesAccount=_activeiTunesAccount;
@property(readonly, nonatomic) ACAccountStore *accountStore; // @synthesize accountStore=_accountStore;
- (_Bool)isAutomaticDownloadingEnabled;	// IMP=0x001000000000ba71
- (_Bool)deletableSystemAppCanBeInstalledOnWatchWithBundleID:(id)arg1;	// IMP=0x001000000000ba69
- (id)isPairedSystemVersionAtLeast:(id)arg1;	// IMP=0x001000000000b9d7
- (_Bool)isActivePairedWatchSystemVersionAtLeastMajorVersion:(id)arg1 minorVersion:(id)arg2 patchVersion:(id)arg3;	// IMP=0x001000000000b9cf
- (_Bool)deviceHasCapabilities:(id)arg1;	// IMP=0x001000000000b9ad
...
- (void)accountStoreDidChange:(id)arg1;	// IMP=0x001000000000b775
- (void)dealloc;	// IMP=0x001000000000b700
- (id)initWithAccountStore:(id)arg1;	// IMP=0x001000000000b615
