...
+ (id)daemonDefaults;	// IMP=0x00200000000096e7
- (void).cxx_destruct;	// IMP=0x002000000000a2ca
@property(readonly, copy, nonatomic) NSString *bundleID; // @synthesize bundleID=_bundleID;
- (id)description;	// IMP=0x001000000000a222
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000a11c
- (unsigned long long)hash;	// IMP=0x001000000000a0a1
...
- (id)objectForKey:(id)arg1;	// IMP=0x0010000000009846
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x00100000000097c6
- (id)initWithBundleID:(id)arg1;	// IMP=0x0010000000009753
