...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000007e17
- (void).cxx_destruct;	// IMP=0x0020000000008b29
...
- (id)makeURLWithSubstitutions:(id)arg1;	// IMP=0x0010000000008959
- (id)description;	// IMP=0x00100000000087ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000843a
- (unsigned long long)hash;	// IMP=0x00100000000082f1
@property(readonly, copy, nonatomic) NSString *URLTemplate;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000008232
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000080d9
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000007e1f
- (id)initWithURLTemplate:(id)arg1 width:(double)arg2 height:(double)arg3 decoration:(id)arg4 preferredCrop:(id)arg5 preferredFormat:(id)arg6;	// IMP=0x0010000000007ce4
