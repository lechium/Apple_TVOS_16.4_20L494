...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001b767
- (void).cxx_destruct;	// IMP=0x002000000001c5fb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001bf23
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001bc31
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001bc26
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001ba5e
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001b76f
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x001000000001b5fa
