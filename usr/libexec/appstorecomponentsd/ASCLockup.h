...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000bd9f
- (void).cxx_destruct;	// IMP=0x001000000000d506
...
- (id)lockupWithOffer:(id)arg1;	// IMP=0x001000000000d2f1
- (id)lockupByAddingFeature:(id)arg1;	// IMP=0x001000000000d02b
- (id)featureWithClass:(Class)arg1;	// IMP=0x001000000000cede
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000c501
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000c2c0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000c070
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000bda7
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9;	// IMP=0x001000000000bd5e
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9 features:(id)arg10;	// IMP=0x001000000000bb51
- (id)initWithID:(id)arg1 kind:(id)arg2 icon:(id)arg3 heading:(id)arg4 title:(id)arg5 subtitle:(id)arg6 ageRating:(id)arg7 offer:(id)arg8;	// IMP=0x001000000000d586
...
- (id)lockupWithSignpostTags:(id)arg1;	// IMP=0x001000000000fcae
