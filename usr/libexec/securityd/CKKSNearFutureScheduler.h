...
- (void).cxx_destruct;	// IMP=0x00200000000afd7b
...
- (void)cancel;	// IMP=0x00100000000afb41
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00100000000af587
- (void)trigger;	// IMP=0x00100000000af4c2
- (void)_onqueueTimerTick;	// IMP=0x00100000000af17d
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x00100000000af0ad
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x00100000000af031
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00100000000aee52
- (MISSING_TYPE *)makeOperationDependency;	// IMP=0x00100000000aed85
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x00100000000aecfe
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 exponentialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x00100000000aeb22
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00100000000aeac7
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x00100000000aeaa3
