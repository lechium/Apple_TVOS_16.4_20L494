...
+ (id)trust;	// IMP=0x0040000000217136
- (void).cxx_destruct;	// IMP=0x0020000000217103
...
- (void)dealloc;	// IMP=0x0010000000216ed8
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x0010000000216df9
- (id)init;	// IMP=0x0010000000216d0e
