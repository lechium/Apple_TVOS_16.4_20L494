...
- (void).cxx_destruct;	// IMP=0x00200000000256b4
...
- (void)performWithStatus:(int)arg1;	// IMP=0x0010000000025378
- (void)groupStart;	// IMP=0x0010000000025333
- (id)initWithDependencies:(id)arg1 intendedViewStatus:(int)arg2 intendedState:(id)arg3 peerMissingState:(id)arg4 errorState:(id)arg5;	// IMP=0x0010000000025233
