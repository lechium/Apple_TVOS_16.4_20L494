...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001c2269
- (void).cxx_destruct;	// IMP=0x00200000001c222b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001c1fcc
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001c1bf5
- (id)description;	// IMP=0x00100000001c1b62
- (id)initWithEgoPeerID:(id)arg1 egoPeerMachineID:(id)arg2 status:(unsigned long long)arg3 viablePeerCountsByModelID:(id)arg4 peerCountsByMachineID:(id)arg5 isExcluded:(_Bool)arg6 isLocked:(_Bool)arg7;	// IMP=0x00100000001c18ff
