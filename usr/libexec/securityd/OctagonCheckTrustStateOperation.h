...
- (void).cxx_destruct;	// IMP=0x00200000001731f3
...
- (void)afterTPHTrustState:(id)arg1 trustedPeers:(id)arg2;	// IMP=0x00100000001720b1
- (void)groupStart;	// IMP=0x0010000000171f0e
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0010000000171e48
