...
- (void).cxx_destruct;	// IMP=0x00200000000f46ee
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f44ec
- (void)dealloc;	// IMP=0x00100000000f43f6
- (void)setCallback:(CDUnknownBlockType)arg1;	// IMP=0x00100000000f434a
- (void)callCallback:(_Bool)arg1;	// IMP=0x00100000000f42fe
- (id)initWithEngine:(struct __OpaqueSOSEngine *)arg1 peer:(struct __OpaqueSOSPeer *)arg2 localManifest:(struct __OpaqueSOSManifest *)arg3 proposedManifest:(struct __OpaqueSOSManifest *)arg4 confirmedManifest:(struct __OpaqueSOSManifest *)arg5 andMessage:(struct __OpaqueSOSMessage *)arg6;	// IMP=0x00100000000f41d2
