...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003add1
- (void).cxx_destruct;	// IMP=0x002000000003ad9e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003acdf
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003aaa2
- (id)initWithCiphertext:(id)arg1 wrappedKeyData:(id)arg2 refKeyBlob:(id)arg3;	// IMP=0x001000000003a9c1
