...
+ (Class)tlkSharesForVouchedIdentityType;	// IMP=0x0020000000029c9a
+ (id)loadFromKeychainForContainer:(id)arg1 contextID:(id)arg2 personaAdapter:(id)arg3 personaUniqueString:(id)arg4 error:(id *)arg5;	// IMP=0x00100000000a6c54
+ (_Bool)deleteFromKeychainForContainer:(id)arg1 contextID:(id)arg2 personaAdapter:(id)arg3 personaUniqueString:(id)arg4 error:(id *)arg5;	// IMP=0x00100000000a69f1
- (void).cxx_destruct;	// IMP=0x0020000000029c14
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000029798
- (unsigned long long)hash;	// IMP=0x0010000000029582
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000029200
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000028de2
- (void)copyTo:(id)arg1;	// IMP=0x0010000000028b51
- (void)writeTo:(id)arg1;	// IMP=0x001000000002882c
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000002807f
- (id)dictionaryRepresentation;	// IMP=0x0010000000027ba1
- (id)description;	// IMP=0x0010000000027af2
...
- (id)tlkSharesForVouchedIdentityAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000279db
- (unsigned long long)tlkSharesForVouchedIdentitysCount;	// IMP=0x00100000000279be
- (void)addTlkSharesForVouchedIdentity:(id)arg1;	// IMP=0x0010000000027954
- (void)clearTlkSharesForVouchedIdentitys;	// IMP=0x0010000000027937
...
- (int)StringAsCdpState:(id)arg1;	// IMP=0x0010000000027866
- (id)cdpStateAsString:(int)arg1;	// IMP=0x001000000002781d
@property(nonatomic) _Bool hasCdpState;
@property(nonatomic) int cdpState; // @synthesize cdpState=_cdpState;
- (int)StringAsAttemptedJoin:(id)arg1;	// IMP=0x0010000000027722
- (id)attemptedJoinAsString:(int)arg1;	// IMP=0x00100000000276d9
...
- (int)StringAsTrustState:(id)arg1;	// IMP=0x0010000000027594
- (id)trustStateAsString:(int)arg1;	// IMP=0x001000000002754b
...
- (int)StringAsIcloudAccountState:(id)arg1;	// IMP=0x00100000000273d5
- (id)icloudAccountStateAsString:(int)arg1;	// IMP=0x001000000002738c
...
- (id)parsedSecureElementIdentity;	// IMP=0x00100000000a62cc
- (void)setOctagonSecureElementIdentity:(id)arg1;	// IMP=0x00100000000a61e7
- (id)getTLKSharesPairedWithVoucher;	// IMP=0x00100000000a5fd2
- (void)setTLKSharesPairedWithVoucher:(id)arg1;	// IMP=0x00100000000a5d8d
- (id)getTPSyncingPolicy;	// IMP=0x00100000000a5ced
- (void)setTPSyncingPolicy:(id)arg1;	// IMP=0x00100000000a5c2d
- (_Bool)saveToKeychainForContainer:(id)arg1 contextID:(id)arg2 personaAdapter:(id)arg3 personaUniqueString:(id)arg4 error:(id *)arg5;	// IMP=0x00100000000a5a8f
