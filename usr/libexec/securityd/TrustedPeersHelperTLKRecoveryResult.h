...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001c2686
- (void).cxx_destruct;	// IMP=0x00200000001c265e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001c2532
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001c2394
- (id)description;	// IMP=0x00100000001c2316
- (id)initWithSuccessfulKeyUUIDs:(id)arg1 totalTLKSharesRecovered:(long long)arg2 tlkRecoveryErrors:(id)arg3;	// IMP=0x00100000001c2271
