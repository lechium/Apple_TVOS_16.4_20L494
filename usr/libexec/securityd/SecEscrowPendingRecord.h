...
+ (id)loadAllFromKeychain:(id *)arg1;	// IMP=0x00200000001578c4
+ (id)loadFromKeychain:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001575aa
- (void).cxx_destruct;	// IMP=0x00200000001d248b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001d223c
- (unsigned long long)hash;	// IMP=0x00100000001d20e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d1e82
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001d1ce4
- (void)copyTo:(id)arg1;	// IMP=0x00100000001d1b8d
- (void)writeTo:(id)arg1;	// IMP=0x00100000001d1a28
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001d14e1
- (id)dictionaryRepresentation;	// IMP=0x00100000001d11f6
- (id)description;	// IMP=0x00100000001d1147
...
- (_Bool)deleteFromKeychain:(id *)arg1;	// IMP=0x00100000001572de
- (_Bool)saveToKeychain:(id *)arg1;	// IMP=0x0010000000156cbb
- (_Bool)escrowAttemptedWithinLastSeconds:(double)arg1;	// IMP=0x00100000001574f1
