...
{
    MISSING_TYPE *_firstLaunch;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x00200000001dc7b7
...
- (id)eventsByTime;	// IMP=0x00100000001dc301
- (id)eventsRelativeTime;	// IMP=0x00100000001dc134
- (void)launch;	// IMP=0x00100000001dbf85
- (void)reportMetric;	// IMP=0x00100000001dbcc7
- (void)addEvent:(id)arg1;	// IMP=0x00100000001dbb13
- (void)addAttribute:(id)arg1 value:(id)arg2;	// IMP=0x00100000001db9b8
- (void)addDependantLaunch:(id)arg1 child:(id)arg2;	// IMP=0x00100000001db821
@property _Bool firstLaunch;
- (id)initWithRocketName:(id)arg1;	// IMP=0x00100000001db665
