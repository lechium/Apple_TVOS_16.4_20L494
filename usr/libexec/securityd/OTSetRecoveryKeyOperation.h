...
- (void).cxx_destruct;	// IMP=0x00200000000b2bcc
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x00100000000b2932
- (void)groupStart;	// IMP=0x00100000000b2571
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x00100000000b24cf
