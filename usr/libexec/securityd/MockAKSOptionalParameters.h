...
- (void).cxx_destruct;	// IMP=0x002000000000f734
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000f642
- (unsigned long long)hash;	// IMP=0x001000000000f5d5
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000f4dd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000f419
- (void)copyTo:(id)arg1;	// IMP=0x001000000000f396
- (void)writeTo:(id)arg1;	// IMP=0x001000000000f31c
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000f1ae
- (id)dictionaryRepresentation;	// IMP=0x001000000000f104
- (id)description;	// IMP=0x001000000000f055
