...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001c0c65
- (void).cxx_destruct;	// IMP=0x00200000001c0c27
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001c09a4
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001c07fe
- (id)description;	// IMP=0x00100000001c0680
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6 walrus:(id)arg7 webAccess:(id)arg8;	// IMP=0x00100000001c0584
