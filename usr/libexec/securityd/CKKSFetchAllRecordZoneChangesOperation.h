...
@class CKContainer, CKDatabaseOperation, CKKSResultOperation, CKOperationGroup, MISSING_TYPE, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet;
...
@interface CKKSFetchAllRecordZoneChangesOperation
{
    ...
    MISSING_TYPE *_fetchRecordZoneChangesOperation;	// 80 = 0x50
...
- (void).cxx_destruct;	// IMP=0x00200000000c87ec
...
- (void)cancel;	// IMP=0x00100000000c84b2
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00100000000c80a2
- (void)performFetch;	// IMP=0x00100000000c7366
- (void)groupStart;	// IMP=0x00100000000c715c
- (void)queryClientsForChangeTokens;	// IMP=0x00100000000c6bd5
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clientMap:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x00100000000c6995
- (id)init;	// IMP=0x00100000000c6987
