...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001c0313
- (void).cxx_destruct;	// IMP=0x00200000001c02e0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001c013c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001c0034
- (id)description;	// IMP=0x00100000001bff5f
- (id)initWithTLK:(id)arg1 classA:(id)arg2 classC:(id)arg3 newUpload:(_Bool)arg4;	// IMP=0x00100000001bfe9d
