...
+ (id)filterTrustedPeers:(id)arg1 missingTLKSharesFor:(id)arg2 databaseProvider:(id)arg3 error:(id *)arg4;	// IMP=0x00200000001a7c62
+ (id)createMissingKeyShares:(id)arg1 peers:(id)arg2 databaseProvider:(id)arg3 error:(id *)arg4;	// IMP=0x00100000001a7282
+ (id)createMissingKeyShares:(id)arg1 trustStates:(id)arg2 databaseProvider:(id)arg3 error:(id *)arg4;	// IMP=0x00100000001a6e82
- (void).cxx_destruct;	// IMP=0x00200000001a635e
...
- (_Bool)areNewSharesSufficient:(id)arg1 trustStates:(id)arg2 error:(id *)arg3;	// IMP=0x00100000001a5dbf
- (void)checkAndHealTLKShares:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x00100000001a449d
- (void)groupStart;	// IMP=0x00100000001a3e0b
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x00100000001a3d22
- (id)init;	// IMP=0x00100000001a3d14
