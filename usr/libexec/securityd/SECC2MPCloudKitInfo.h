...
+ (Class)clientOperationType;	// IMP=0x002000000016a116
+ (Class)operationGroupType;	// IMP=0x001000000016a105
- (void).cxx_destruct;	// IMP=0x0020000000169a7d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001695e8
- (unsigned long long)hash;	// IMP=0x0010000000169475
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001691ef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000168dac
- (void)copyTo:(id)arg1;	// IMP=0x0010000000168b3e
- (void)writeTo:(id)arg1;	// IMP=0x00100000001687fc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001687ef
- (id)dictionaryRepresentation;	// IMP=0x0010000000168191
- (id)description;	// IMP=0x00100000001680e2
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000168035
- (unsigned long long)clientOperationsCount;	// IMP=0x0010000000168018
- (void)addClientOperation:(id)arg1;	// IMP=0x0010000000167fae
- (void)clearClientOperations;	// IMP=0x0010000000167f91
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000167edc
- (unsigned long long)operationGroupsCount;	// IMP=0x0010000000167ebf
- (void)addOperationGroup:(id)arg1;	// IMP=0x0010000000167e55
- (void)clearOperationGroups;	// IMP=0x0010000000167e38
