...
- (void).cxx_destruct;	// IMP=0x00200000000bbf45
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000bbe13
- (_Bool)matchesCKRecord:(id)arg1;	// IMP=0x00100000000bbd2b
- (void)setFromCKRecord:(id)arg1;	// IMP=0x00100000000bbc43
- (id)updateCKRecord:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000000bbb4e
- (id)CKRecordName;	// IMP=0x00100000000bba75
- (id)CKRecordWithZoneID:(id)arg1;	// IMP=0x00100000000bb8e7
...
- (id)initWithCKRecordType:(id)arg1 encodedCKRecord:(id)arg2 contextID:(id)arg3 zoneID:(id)arg4;	// IMP=0x00100000000bb303
- (id)initWithCKRecord:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000bb202
