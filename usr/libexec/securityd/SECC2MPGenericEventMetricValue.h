...
- (void).cxx_destruct;	// IMP=0x002000000008aef5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000008adc9
- (unsigned long long)hash;	// IMP=0x001000000008ac5d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008ab3c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000008aa59
- (void)copyTo:(id)arg1;	// IMP=0x001000000008a9b4
- (void)writeTo:(id)arg1;	// IMP=0x001000000008a906
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000008a8f9
- (id)dictionaryRepresentation;	// IMP=0x001000000008a78c
- (id)description;	// IMP=0x001000000008a6dd
