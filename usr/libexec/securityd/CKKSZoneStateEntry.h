...
+ (id)fromDatabaseRow:(id)arg1;	// IMP=0x0000000000088d31
+ (id)sqlColumns;	// IMP=0x0010000000088d24
+ (id)sqlTable;	// IMP=0x0010000000088d17
+ (id)tryFromDatabase:(id)arg1 zoneName:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000088b89
+ (id)fromDatabase:(id)arg1 zoneName:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000889fb
+ (id)contextID:(id)arg1 zoneName:(id)arg2;	// IMP=0x001000000008887c
- (void).cxx_destruct;	// IMP=0x0020000000088807
...
- (id)sqlValues;	// IMP=0x001000000008818f
- (id)whereClauseToFindSelf;	// IMP=0x0010000000088073
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000087648
- (id)description;	// IMP=0x0010000000087537
- (id)initWithContextID:(id)arg1 zoneName:(id)arg2 zoneCreated:(_Bool)arg3 zoneSubscribed:(_Bool)arg4 changeToken:(id)arg5 moreRecordsInCloudKit:(_Bool)arg6 lastFetch:(id)arg7 lastScan:(id)arg8 lastFixup:(unsigned long long)arg9 encodedRateLimiter:(id)arg10;	// IMP=0x00100000000873bb
