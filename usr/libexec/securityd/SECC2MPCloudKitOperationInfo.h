...
- (void).cxx_destruct;	// IMP=0x002000000015e7e2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000015e6d8
- (unsigned long long)hash;	// IMP=0x001000000015e63d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015e517
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000015e43c
- (void)copyTo:(id)arg1;	// IMP=0x001000000015e39c
- (void)writeTo:(id)arg1;	// IMP=0x001000000015e2f0
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000015e2e3
- (id)dictionaryRepresentation;	// IMP=0x001000000015e19d
- (id)description;	// IMP=0x001000000015e0ee
