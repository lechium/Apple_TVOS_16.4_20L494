...
+ (id)loadForZone:(id)arg1 contextID:(id)arg2;	// IMP=0x00400000000aa5ca
- (void).cxx_destruct;	// IMP=0x00200000000aa54a
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x00100000000aa1c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a9ecf
- (id)description;	// IMP=0x00100000000a9c37
- (id)initWithZoneID:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000a9b9e
