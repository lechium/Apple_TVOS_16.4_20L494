...
- (void).cxx_destruct;	// IMP=0x0020000000095c0a
...
- (_Bool)ensureKeyPresent:(id)arg1 viewState:(id)arg2;	// IMP=0x00100000000955c9
- (void)attemptToHealView:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x0010000000095469
- (void)groupStart;	// IMP=0x0010000000094f88
- (id)initWithDependencies:(id)arg1 allowFullRefetchResult:(_Bool)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x0010000000094e72
- (id)init;	// IMP=0x0010000000094e64
