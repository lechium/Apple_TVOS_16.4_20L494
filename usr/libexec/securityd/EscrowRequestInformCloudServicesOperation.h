...
+ (id)triggerCloudServicesPasscodeRequest:(id)arg1 serializedReason:(id)arg2 error:(id *)arg3;	// IMP=0x00200000001db207
- (void).cxx_destruct;	// IMP=0x00200000001db1c5
...
- (void)main;	// IMP=0x00100000001da88a
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 lockStateTracker:(id)arg3;	// IMP=0x00100000001da7c4
