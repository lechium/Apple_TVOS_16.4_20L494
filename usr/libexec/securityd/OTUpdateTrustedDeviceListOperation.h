...
- (void).cxx_destruct;	// IMP=0x0020000000089c7a
...
- (void)afterAuthKitFetch:(id)arg1 accountIsDemo:(_Bool)arg2;	// IMP=0x0010000000089980
- (void)groupStart;	// IMP=0x00100000000894a4
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 listUpdatesState:(id)arg3 authenticationErrorState:(id)arg4 errorState:(id)arg5 retryFlag:(id)arg6;	// IMP=0x0010000000089364
