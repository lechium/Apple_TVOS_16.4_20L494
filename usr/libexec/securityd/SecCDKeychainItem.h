...
- (void).cxx_destruct;	// IMP=0x0020000000041e7e
...
- (id)secretsFromEncryptedData:(id)arg1 withKeybag:(int)arg2 error:(id *)arg3;	// IMP=0x00100000000418fc
- (id)encryptedSecretDataWithAttributeData:(id)arg1 keybag:(int)arg2 error:(id *)arg3;	// IMP=0x00100000000411c9
- (id)primaryKeyStringRepresentationWithError:(id *)arg1;	// IMP=0x0010000000040d4e
- (id)primaryKeys;	// IMP=0x0010000000040d38
...
- (id)description;	// IMP=0x0010000000040b64
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000040a93
- (id)initWithManagedItem:(id)arg1 keychain:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000040726
- (id)initItemType:(id)arg1 withPersistentID:(id)arg2 attributes:(id)arg3 lookupAttributes:(id)arg4 secrets:(id)arg5 owner:(id)arg6 keyclass:(int)arg7;	// IMP=0x00100000000405d5
