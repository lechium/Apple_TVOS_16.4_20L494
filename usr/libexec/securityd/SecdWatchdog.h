...
+ (_Bool)triggerOSFaults;	// IMP=0x0040000000002f76
+ (_Bool)watchdogrusage:(struct rusage_info_v6 *)arg1;	// IMP=0x0010000000002f4d
+ (id)watchdog;	// IMP=0x0010000000002eea
- (void).cxx_destruct;	// IMP=0x0020000000002bdc
@property(readonly) _Bool diskUsageHigh; // @synthesize diskUsageHigh=_diskUsageHigh;
- (_Bool)setWatchdogParameters:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000002950
- (id)watchdogParameters;	// IMP=0x00100000000027ba
- (void)activateTimer;	// IMP=0x0010000000002600
- (void)runWatchdog;	// IMP=0x0010000000002316
- (unsigned long long)secondsFromMachTime:(unsigned long long)arg1;	// IMP=0x00100000000022c4
- (id)init;	// IMP=0x001000000000224e
