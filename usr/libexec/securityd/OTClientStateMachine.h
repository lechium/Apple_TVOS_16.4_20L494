...
- (void).cxx_destruct;	// IMP=0x00200000001c3e6a
...
- (void)rpcVoucher:(id)arg1 peerID:(id)arg2 permanentInfo:(id)arg3 permanentInfoSig:(id)arg4 stableInfo:(id)arg5 stableInfoSig:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x00100000001c39c1
- (void)rpcEpoch:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000001c36be
- (id)_onqueueNextClientStateMachineTransition:(id)arg1;	// IMP=0x00100000001c31db
- (_Bool)isAcceptorWaitingForFirstMessage;	// IMP=0x00100000001c3144
- (void)handleExternalClientStateMachineRequest:(id)arg1 client:(id)arg2;	// IMP=0x00100000001c3067
- (void)_onqueueStartNextClientStateMachineOperation:(id)arg1;	// IMP=0x00100000001c2e36
- (void)_onqueuePokeClientStateMachine:(id)arg1;	// IMP=0x00100000001c2d98
- (id)createOperationToFinishAttemptForClient:(id)arg1 clientName:(id)arg2;	// IMP=0x00100000001c2c14
- (void)startOctagonStateMachine;	// IMP=0x00100000001c2ba3
@property(retain) NSString<OctagonStateString> *currentState;
- (void)dealloc;	// IMP=0x00100000001c2a3a
- (id)initWithContainerName:(id)arg1 contextID:(id)arg2 clientName:(id)arg3 cuttlefish:(id)arg4;	// IMP=0x00100000001c2730
