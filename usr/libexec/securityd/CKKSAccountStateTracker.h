...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x00200000000384c3
+ (id)getCircleStatus;	// IMP=0x001000000003839f
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x0010000000038300
- (void).cxx_destruct;	// IMP=0x002000000003607f
...
- (void)setHSA2iCloudAccountStatus:(long long)arg1;	// IMP=0x0010000000035d08
- (void)triggerOctagonStatusFetch;	// IMP=0x0010000000035b0c
- (id)checkForAllDeliveries;	// IMP=0x00100000000359ec
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x00100000000359ae
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x0010000000035995
- (_Bool)notifyCKAccountStatusChangeAndWait:(unsigned long long)arg1;	// IMP=0x0010000000035944
- (void)recheckCKAccountStatus;	// IMP=0x0010000000035898
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x0010000000035750
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x00100000000355c3
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x001000000003519f
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x0010000000035010
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x0010000000034e26
- (id)notifyCircleChange:(id)arg1;	// IMP=0x0010000000034d26
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x0010000000034ba1
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x00100000000348df
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x00100000000347f1
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x0010000000034655
- (void)dealloc;	// IMP=0x00100000000345da
- (void)performInitialDispatches;	// IMP=0x0010000000034550
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x00100000000340a4
