...
- (void).cxx_destruct;	// IMP=0x0020000000176915
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001767c6
- (unsigned long long)hash;	// IMP=0x0010000000176711
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001765b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001764b0
- (void)copyTo:(id)arg1;	// IMP=0x00100000001763f0
- (void)writeTo:(id)arg1;	// IMP=0x0010000000176328
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000176047
- (id)dictionaryRepresentation;	// IMP=0x0010000000175edb
- (id)description;	// IMP=0x0010000000175e2c
