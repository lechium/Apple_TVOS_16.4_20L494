...
- (void).cxx_destruct;	// IMP=0x002000000016ef16
...
- (void)cancel;	// IMP=0x001000000016ee24
- (void)groupStart;	// IMP=0x001000000016e874
- (id)initWithDependencies:(id)arg1 rollTLKIfPresent:(_Bool)arg2 preexistingPendingKeySets:(id)arg3 intendedState:(id)arg4 errorState:(id)arg5;	// IMP=0x001000000016e543
- (id)init;	// IMP=0x001000000016e535
