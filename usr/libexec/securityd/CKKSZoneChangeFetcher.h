...
- (void).cxx_destruct;	// IMP=0x00200000001ca6ac
...
- (void)halt;	// IMP=0x00100000001ca2a6
- (void)cancel;	// IMP=0x00100000001ca269
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x00100000001ca257
- (id)createSuccesfulFetchDependency;	// IMP=0x00100000001ca1ec
- (void)_onqueueCreateNewFetch;	// IMP=0x00100000001c9a5c
- (void)maybeCreateNewFetch;	// IMP=0x00100000001c99eb
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x00100000001c97e9
- (id)inflightFetch;	// IMP=0x00100000001c96f2
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x00100000001c95b5
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x00100000001c9209
- (void)notifyZoneChange:(id)arg1;	// IMP=0x00100000001c912e
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x00100000001c90c8
- (id)strongClientMap;	// IMP=0x00100000001c8e40
- (void)registerClient:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000001c8d74
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x00100000001c88f0
