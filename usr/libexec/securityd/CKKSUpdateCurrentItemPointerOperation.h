...
@interface CKKSUpdateCurrentItemPointerOperation
{
    ...
    CKModifyRecordsOperation *;	// 32 = 0x20
...
- (void).cxx_destruct;	// IMP=0x002000000016ad7d
...
- (struct SecDbItem *)_onqueueFindSecDbItemWithQuery:(id)arg1 error:(id *)arg2;	// IMP=0x001000000016a7b9
- (struct SecDbItem *)_onqueueFindSecDbItemWithUUID:(id)arg1 accessGroup:(id)arg2 error:(id *)arg3;	// IMP=0x001000000016a5b6
- (struct SecDbItem *)_onqueueFindSecDbItem:(id)arg1 accessGroup:(id)arg2 error:(id *)arg3;	// IMP=0x001000000016a4bb
- (void)groupStart;	// IMP=0x001000000016a35f
- (void)dealloc;	// IMP=0x001000000016a2ef
- (id)initWithCKKSOperationDependencies:(id)arg1 viewState:(id)arg2 newItem:(id)arg3 hash:(id)arg4 accessGroup:(id)arg5 identifier:(id)arg6 replacing:(id)arg7 hash:(id)arg8 ckoperationGroup:(id)arg9;	// IMP=0x001000000016a127
