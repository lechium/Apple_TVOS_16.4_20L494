...
- (void).cxx_destruct;	// IMP=0x0020000000135398
@property _Bool cachedFeatureAllowed; // @synthesize cachedFeatureAllowed=_cachedFeatureAllowed;
// Error: Property attributes should begin with the type ('T') attribute, property name: retryAfter
...
- (_Bool)checkRampStateWithError:(id *)arg1;	// IMP=0x001000000013452e
- (void)fetchRampRecord:(unsigned long long)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x001000000013425f
- (id)initWithRecordName:(id)arg1 localSettingName:(id)arg2 container:(id)arg3 database:(id)arg4 zoneID:(id)arg5 accountTracker:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8 fetchRecordRecordsOperationClass:(Class)arg9;	// IMP=0x0010000000134095
