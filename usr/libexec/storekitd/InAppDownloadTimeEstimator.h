...
- (void).cxx_destruct;	// IMP=0x00200000000063ef
- (void)_updateStatisticsFromSnapshots;	// IMP=0x00100000000061fa
- (void)setCurrentValue:(unsigned long long)arg1;	// IMP=0x0010000000006012
@property(readonly, nonatomic) double estimatedTimeRemaining;
- (id)initWithMaxValue:(unsigned long long)arg1;	// IMP=0x0010000000005ea7
