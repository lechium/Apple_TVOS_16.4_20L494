...
- (void).cxx_destruct;	// IMP=0x0020000000020455
...
- (void)_latestTransactionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000001f966
- (void)_cacheLegacyTransaction;	// IMP=0x001000000001f57b
- (id)_processPurchaseResult:(id)arg1 authorizationResult:(id)arg2;	// IMP=0x001000000001e760
- (void)purchase:(id)arg1 handleEngagementRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001e29a
- (void)purchase:(id)arg1 handleDialogRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001dfa8
- (void)purchase:(id)arg1 handleAuthenticateRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001dcb6
- (id)_authenticateWithAccountInfo:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001d572
- (void)clearTransactionCache;	// IMP=0x001000000001d520
- (id)_buyParams;	// IMP=0x001000000001c44f
- (void)main;	// IMP=0x001000000001a240
- (id)initWithProductIdentifier:(id)arg1 quantity:(unsigned long long)arg2 client:(id)arg3 apiVersion:(long long)arg4;	// IMP=0x001000000001a12d
- (id)initWithBuyParams:(id)arg1 client:(id)arg2 apiVersion:(long long)arg3;	// IMP=0x001000000001a02c
