...
- (void).cxx_destruct;	// IMP=0x002000000007509a
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000074ba8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000074b96
- (id)init;	// IMP=0x0010000000074b23
