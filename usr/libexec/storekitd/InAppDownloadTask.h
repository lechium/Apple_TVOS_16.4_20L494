...
- (void).cxx_destruct;	// IMP=0x00200000000918a9
...
- (id)_bomInstallFromPath:(id)arg1 withError:(id *)arg2;	// IMP=0x001000000009115f
- (void)_bomInstall;	// IMP=0x0010000000090b06
- (void)_updateDownloadStatus:(id)arg1;	// IMP=0x0010000000090a7f
- (void)_sendDownloadStatus;	// IMP=0x00100000000909be
- (void)_install;	// IMP=0x00100000000909ac
- (void)_finalizeTaskWithError:(id)arg1;	// IMP=0x00100000000905ff
- (void)_downloadedBytes:(long long)arg1 expectedBytes:(long long)arg2;	// IMP=0x00100000000904f8
- (void)pause;	// IMP=0x0010000000090387
- (void)cancel;	// IMP=0x0010000000090198
- (void)main;	// IMP=0x001000000008f2ba
- (id)initWithDownloadID:(id)arg1 info:(id)arg2 bundleID:(id)arg3 containerID:(id)arg4;	// IMP=0x001000000008f149
