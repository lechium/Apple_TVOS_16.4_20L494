...
- (void).cxx_destruct;	// IMP=0x002000000000403c
@property(readonly) SQLiteConnection *connection; // @synthesize connection=_connection;
- (id)promotionInfoForProductIdentifiers:(id)arg1 bundleID:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000003b47
- (id)initWithConnection:(id)arg1;	// IMP=0x0010000000003adc
