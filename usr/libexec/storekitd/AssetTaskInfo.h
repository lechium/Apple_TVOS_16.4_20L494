...
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x004000000009212f
+ (void)removeTaskInfo:(id)arg1;	// IMP=0x00100000000920ab
+ (void)removeAllTaskInfo;	// IMP=0x0010000000092070
+ (void)recordTaskInfo:(id)arg1 forTask:(id)arg2;	// IMP=0x0010000000091f08
+ (void)exchangeTaskForTaskInfo:(id)arg1 withTask:(id)arg2;	// IMP=0x0010000000091ef6
+ (id)newTaskInfoForTask:(id)arg1;	// IMP=0x0010000000091df7
- (void).cxx_destruct;	// IMP=0x00200000000923a1
...
- (id)initWithTask:(id)arg1;	// IMP=0x0010000000091e62
