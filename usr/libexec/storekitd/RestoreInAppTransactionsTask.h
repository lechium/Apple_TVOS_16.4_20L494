...
- (id)_authenticateAccount:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000051d80
- (id)_runRequestWithError:(id *)arg1;	// IMP=0x0010000000051a2e
- (void)main;	// IMP=0x00100000000514fe
- (id)initWithClient:(id)arg1;	// IMP=0x001000000005145f
