...
+ (id)_titleForProtectionSpace:(id)arg1;	// IMP=0x00400000000341df
+ (id)_messageForProtectionSpace:(id)arg1;	// IMP=0x0010000000033fa6
- (void).cxx_destruct;	// IMP=0x0020000000034254
...
- (id)initWithAuthenticationChallenge:(id)arg1;	// IMP=0x0010000000033e6a
