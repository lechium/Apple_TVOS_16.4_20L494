...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x004000000009279f
- (void).cxx_destruct;	// IMP=0x0020000000092f8d
...
- (id)description;	// IMP=0x001000000009271d
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x0010000000092443
