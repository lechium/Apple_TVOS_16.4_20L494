...
- (void).cxx_destruct;	// IMP=0x0020000000007bc3
...
- (void)main;	// IMP=0x0010000000006afd
- (id)initWithLocalRevision:(id)arg1 reason:(long long)arg2 client:(id)arg3;	// IMP=0x0010000000006a0c
