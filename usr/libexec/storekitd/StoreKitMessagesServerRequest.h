...
- (void).cxx_destruct;	// IMP=0x0020000000004d88
...
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000044b6
- (id)initWithClient:(id)arg1 status:(id)arg2 logKey:(id)arg3;	// IMP=0x00100000000043ff
