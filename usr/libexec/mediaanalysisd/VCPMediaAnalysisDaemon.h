...
- (void).cxx_destruct;	// IMP=0x00200000000036da
- (int)run:(int)arg1 argv:(const char **)arg2;	// IMP=0x00100000000034c0
- (void)registerClient:(id)arg1 forPhotoLibraryURL:(id)arg2 withReply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000003173
- (void)storeAnalysis:(id)arg1 forAsset:(id)arg2 fromPhotoLibraryURL:(id)arg3 withReply:(CDUnknownBlockType)arg4;	// IMP=0x0010000000002c9c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000002756
- (id)init;	// IMP=0x0010000000002610
