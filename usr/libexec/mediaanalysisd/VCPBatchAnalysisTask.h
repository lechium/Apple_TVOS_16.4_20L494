...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x004000000006a770
- (void).cxx_destruct;	// IMP=0x002000000006b667
...
- (int)mainInternal;	// IMP=0x001000000006ae6c
- (_Bool)containsAsset:(id)arg1;	// IMP=0x001000000006abf1
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x001000000006ab54
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x001000000006a7d5
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x001000000006a6a1
