...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x00400000000661cb
- (void).cxx_destruct;	// IMP=0x0020000000066e03
- (int)persist;	// IMP=0x00100000000666a1
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x00100000000663ed
- (void)dealloc;	// IMP=0x001000000006613f
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000656e0
