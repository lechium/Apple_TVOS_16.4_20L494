...
+ (id)assetWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x004000000001c8c3
- (void).cxx_destruct;	// IMP=0x002000000001ca93
...
- (_Bool)isDegraded;	// IMP=0x001000000001ca0e
- (_Bool)isDeletePending;	// IMP=0x001000000001ca00
- (void)updateLocalIdentifier:(id)arg1;	// IMP=0x001000000001c9ef
- (id)initWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x001000000001c740
