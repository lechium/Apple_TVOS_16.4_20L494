...
@class MISSING_TYPE, NSData, NSURL, PHAsset, PHAssetResource;
...
@interface MADOCRAssetEntry : NSObject
{
    ...
    MISSING_TYPE *_downloadResource;	// 48 = 0x30
    NSURL *_downloadURL;	// 56 = 0x38
}

+ (id)entryWithAsset:(id)arg1 andPreviousStatus:(unsigned long long)arg2;	// IMP=0x0040000000055731
- (void).cxx_destruct;	// IMP=0x0020000000055849
...
- (id)initWithAsset:(id)arg1 andPreviousStatus:(unsigned long long)arg2;	// IMP=0x00100000000556a0
