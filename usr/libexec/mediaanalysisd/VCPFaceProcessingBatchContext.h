...
+ (id)batchContextWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x004000000007b97b
- (void).cxx_destruct;	// IMP=0x002000000007c1ce
...
- (_Bool)downloadTimedout;	// IMP=0x001000000007bf63
- (void)updateLastestDownloadTimestamp;	// IMP=0x001000000007be3f
- (void)storeResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5 forLocalIdentifier:(id)arg6;	// IMP=0x001000000007bbc3
- (id)resourceForLocalIdentifier:(id)arg1;	// IMP=0x001000000007ba26
- (id)initWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x001000000007b76d
