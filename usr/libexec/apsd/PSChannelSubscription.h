...
+ (Class)attributesType;	// IMP=0x0020000000074030
- (void).cxx_destruct;	// IMP=0x002000000007523d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000074fdc
- (unsigned long long)hash;	// IMP=0x0010000000074f18
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000074dbf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000074b75
- (void)copyTo:(id)arg1;	// IMP=0x0010000000074a37
- (void)writeTo:(id)arg1;	// IMP=0x001000000007488d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000074880
- (id)dictionaryRepresentation;	// IMP=0x00100000000740f0
- (id)description;	// IMP=0x0010000000074041
- (id)attributesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000074013
- (unsigned long long)attributesCount;	// IMP=0x0010000000073ff6
- (void)addAttributes:(id)arg1;	// IMP=0x0010000000073f8c
- (void)clearAttributes;	// IMP=0x0010000000073f6f
- (void)clearOneofValuesForSubscriptionInfo;	// IMP=0x0010000000073f30
- (int)StringAsSubscriptionInfo:(id)arg1;	// IMP=0x0010000000073e9e
- (id)subscriptionInfoAsString:(int)arg1;	// IMP=0x0010000000073e55
