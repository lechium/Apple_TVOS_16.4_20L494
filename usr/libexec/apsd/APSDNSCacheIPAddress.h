...
- (void).cxx_destruct;	// IMP=0x002000000006883e
...
- (void)updateExpirationTime:(double)arg1;	// IMP=0x00100000000687c9
- (id)initWithIPAddress:(id)arg1 addressFamily:(unsigned long long)arg2 timeToLive:(double)arg3;	// IMP=0x0010000000068739
