...
- (void).cxx_destruct;	// IMP=0x0020000000043a6b
...
- (void)_clearState;	// IMP=0x0010000000043923
- (void)_fireMetricIfNeeded;	// IMP=0x00100000000437f9
- (void)_timerFired:(id)arg1;	// IMP=0x00100000000437c8
- (void)noteReceivedLiveMessage;	// IMP=0x00100000000437b6
- (void)noteSystemWillSleep;	// IMP=0x00100000000437a4
- (void)noteReceivedStoredMessage;	// IMP=0x0010000000043754
- (void)noteDidConnect;	// IMP=0x00100000000436e4
- (void)noteSystemDidFullWakeWhileConnected:(_Bool)arg1;	// IMP=0x001000000004362f
- (id)initWithOnConnectedInterval:(double)arg1 onDisconnectedInterval:(double)arg2 metricSubmissionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000043529
- (id)init;	// IMP=0x00100000000433ad
