...
- (void).cxx_destruct;	// IMP=0x002000000000292e
...
- (id)initWithDNSTask:(id)arg1 messageId:(unsigned long long)arg2 taskId:(unsigned long long)arg3 taskStatus:(unsigned long long)arg4;	// IMP=0x0010000000002821
- (id)initWithDNSTask:(id)arg1;	// IMP=0x00100000000027ae
