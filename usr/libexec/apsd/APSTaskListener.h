...
- (void).cxx_destruct;	// IMP=0x0020000000070b19
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000070657
- (void)_cleanupConnection:(id)arg1;	// IMP=0x00100000000704b6
- (void)dealloc;	// IMP=0x0010000000070424
- (id)initWithQueue:(id)arg1 apsDaemon:(id)arg2;	// IMP=0x001000000007027a
