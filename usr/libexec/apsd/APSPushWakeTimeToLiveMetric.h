...
- (void).cxx_destruct;	// IMP=0x00200000000043e1
...
- (id)initWithGuid:(id)arg1 connectedOnWake:(_Bool)arg2 everConnected:(_Bool)arg3 timeToFullyConnect:(id)arg4 timeToLastFromStorage:(id)arg5;	// IMP=0x00100000000040e7
