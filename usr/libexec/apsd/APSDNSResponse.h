...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001bc9b
- (void).cxx_destruct;	// IMP=0x002000000001beea
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001be49
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001bca3
- (id)initResponseForHostname:(id)arg1 ipv4Address:(id)arg2 ipv6Address:(id)arg3;	// IMP=0x001000000001bb90
