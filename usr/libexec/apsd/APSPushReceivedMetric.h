...
- (void).cxx_destruct;	// IMP=0x0020000000014936
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 dualChannelState:(unsigned int)arg4 receiveOffset:(id)arg5 payloadSize:(id)arg6 isFromStorage:(id)arg7 topic:(id)arg8 wakeStatus:(id)arg9;	// IMP=0x0010000000014491
