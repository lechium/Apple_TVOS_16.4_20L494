...
+ (void)_saveCachedProperties;	// IMP=0x002000000006bc86
+ (void)_loadCachedProperties;	// IMP=0x001000000006b738
+ (id)environmentForName:(id)arg1;	// IMP=0x001000000006b71f
+ (void)initialize;	// IMP=0x001000000006b13a
- (void).cxx_destruct;	// IMP=0x002000000006c147
...
- (void)setLoadBalanced:(_Bool)arg1;	// IMP=0x001000000006c0fd
- (_Bool)isLoadBalanced;	// IMP=0x001000000006c0f4
...
- (id)description;	// IMP=0x001000000006c028
@property(readonly, nonatomic) unsigned long long priority;
- (unsigned long long)hash;	// IMP=0x001000000006bfd2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006bfc7
