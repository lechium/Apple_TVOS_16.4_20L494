...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000011bd4
- (void).cxx_destruct;	// IMP=0x00200000000138b5
...
- (id)description;	// IMP=0x00100000000136bf
- (id)infoPlistContent;	// IMP=0x001000000001335d
- (void)setRequiredDeviceCapabilitiesWithArray:(id)arg1;	// IMP=0x0010000000013116
- (id)initWithInfoPlistDictionary:(id)arg1;	// IMP=0x001000000001298c
- (id)initWithInfoPlistFromBundle:(struct __CFBundle *)arg1 error:(id *)arg2;	// IMP=0x00100000000128f5
- (id)initWithInfoPlistFromBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000012840
- (id)_plistKeys;	// IMP=0x001000000001278e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000012506
- (unsigned long long)hash;	// IMP=0x001000000001225f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000011bdc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000118d5
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000011582
- (id)init;	// IMP=0x0010000000011553
