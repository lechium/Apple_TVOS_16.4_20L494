...
- (void).cxx_destruct;	// IMP=0x0020000000039ae9
...
- (CDUnknownBlockType)actionForButtonAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000039718
- (void)addButtonDefinition:(id)arg1 forAction:(CDUnknownBlockType)arg2;	// IMP=0x001000000003963d
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x0010000000039544
