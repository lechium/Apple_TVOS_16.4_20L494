...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003cb9c
- (void).cxx_destruct;	// IMP=0x002000000003cecf
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003cd1b
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003cba4
