...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000e329
- (void).cxx_destruct;	// IMP=0x002000000000e4a4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000e331
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000e1b5
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000e036
