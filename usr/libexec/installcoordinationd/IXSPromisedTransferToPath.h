...
- (oneway void)_remote_setTryDeltaCopy:(_Bool)arg1;	// IMP=0x00100000000315d6
- (oneway void)_remote_setShouldCopy:(_Bool)arg1;	// IMP=0x00100000000314bf
- (oneway void)_remote_setTransferPath:(id)arg1;	// IMP=0x0010000000031382
