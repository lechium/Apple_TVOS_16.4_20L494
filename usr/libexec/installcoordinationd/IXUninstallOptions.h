...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000544c
...
- (id)description;	// IMP=0x0010000000005b0a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000056bf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000055e4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000005508
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000005454
- (id)init;	// IMP=0x00100000000053ba
