...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000034f0d
- (void).cxx_destruct;	// IMP=0x00200000000350a2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000034f15
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000034da1
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000034bd2
