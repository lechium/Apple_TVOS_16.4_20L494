...
+ (id)stringForCFOptionFlag:(unsigned long long)arg1;	// IMP=0x004000000003b7c6
- (void).cxx_destruct;	// IMP=0x002000000003b85c
...
- (void)dealloc;	// IMP=0x001000000003b77f
- (_Bool)isMDMRestrictedWithOrganizationName:(id *)arg1;	// IMP=0x001000000003b610
- (id)localizedStringForKey:(id)arg1 withFormatHint:(id)arg2;	// IMP=0x001000000003b52b
- (void)otherButtonActionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003b519
- (void)displayAlertWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003aefa
- (void)_configureOptionalButtonForConfiguration:(id)arg1;	// IMP=0x001000000003abc0
- (void)_onMainQueue_displayAlertWithCompletion:(CDUnknownBlockType)arg1 uninstallAlertConfiguration:(id)arg2;	// IMP=0x001000000003a679
- (void)_processUserNotification:(struct __CFUserNotification *)arg1 withConfiguration:(id)arg2 response:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000039ee3
- (_Bool)_onMainQueue_deleteButtonActionWithDisposition:(unsigned long long *)arg1 error:(id *)arg2;	// IMP=0x0010000000039d6b
...
- (id)initWithAppRecord:(id)arg1 bundleIdentifier:(id)arg2 isRemovable:(_Bool)arg3;	// IMP=0x0010000000039b27
