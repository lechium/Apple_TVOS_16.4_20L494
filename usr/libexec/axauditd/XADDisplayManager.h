...
+ (id)sharedManager;	// IMP=0x0020000000008a8e
- (void).cxx_destruct;	// IMP=0x002000000000972d
...
- (void)setCursorFrameForElement:(id)arg1;	// IMP=0x0010000000009262
- (void)hideVisualsSynchronously;	// IMP=0x00100000000090e1
- (void)setCursorFrame:(struct CGRect)arg1 withPath:(struct CGPath *)arg2 withContextId:(unsigned int)arg3 element:(id)arg4 forceRefresh:(_Bool)arg5;	// IMP=0x0010000000008cd8
- (void)setCursorStyle:(unsigned long long)arg1;	// IMP=0x0010000000008bd7
- (struct CGRect)_adjustFrameToFitScreen:(struct CGRect)arg1;	// IMP=0x0010000000008bbf
- (id)init;	// IMP=0x0010000000008b13
