...
- (void).cxx_destruct;	// IMP=0x004000000005e8b0
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x001000000005e820
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x001000000005e7f0
- (id)initToMemory;	// IMP=0x001000000005e7c0
- (void)close;	// IMP=0x001000000005e790
- (void)open;	// IMP=0x001000000005e460
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x001000000005e2f0
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x001000000005de10
- (id)init;	// IMP=0x001000000005dd70
