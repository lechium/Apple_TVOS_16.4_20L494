...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000055398
- (void).cxx_destruct;	// IMP=0x00200000000558a8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000055784
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000554be
- (id)initWithOperationId:(id)arg1 activityId:(id)arg2 activityLabel:(id)arg3 recordId:(id)arg4 type:(unsigned long long)arg5 context:(id)arg6;	// IMP=0x00100000000553a0
