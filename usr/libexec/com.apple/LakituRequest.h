...
- (void).cxx_destruct;	// IMP=0x00200000000456b4
...
- (void)performRequestWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000044ebc
- (id)sessionConfig;	// IMP=0x0010000000044d88
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000044a30
@property(readonly, nonatomic) NSMutableURLRequest *urlRequest;
- (id)protectionSpace;	// IMP=0x0010000000044974
- (id)credential;	// IMP=0x001000000004496c
- (id)validateInput;	// IMP=0x0010000000044822
- (id)additionalHeaders;	// IMP=0x0010000000044815
- (id)authorizationHeader;	// IMP=0x001000000004480d
- (id)bodyDictionary;	// IMP=0x0010000000044805
