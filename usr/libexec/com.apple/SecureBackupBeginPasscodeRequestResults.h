...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000102ab
- (void).cxx_destruct;	// IMP=0x0020000000010571
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000103cb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000102b3
- (id)description;	// IMP=0x0010000000010181
- (id)initWithStoredCertificate:(id)arg1 uuid:(id)arg2;	// IMP=0x001000000001005d
