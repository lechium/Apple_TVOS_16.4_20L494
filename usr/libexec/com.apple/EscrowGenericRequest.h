...
@interface EscrowGenericRequest
{
    ...
    MISSING_TYPE *_metadata;	// 72 = 0x48
...
- (void).cxx_destruct;	// IMP=0x002000000001ca2b
...
- (id)_filteredMetadataForDoubleEnrollment:(id)arg1;	// IMP=0x001000000001c62b
- (id)urlString;	// IMP=0x001000000001c57b
- (id)urlRequest;	// IMP=0x001000000001c441
- (id)authorizationHeader;	// IMP=0x001000000001c331
- (id)authorizationHeaderWithUser:(id)arg1 password:(id)arg2 authType:(id)arg3;	// IMP=0x001000000001c134
- (id)bodyDictionary;	// IMP=0x001000000001be13
- (id)validateInput;	// IMP=0x001000000001bac4
...
- (id)currentAccount;	// IMP=0x001000000001b645
@property(readonly, copy, nonatomic) NSString *recoveryPassphrase; // @synthesize recoveryPassphrase=_recoveryPassphrase;
- (id)loggingDescription;	// IMP=0x001000000001b471
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000001afa1
