...
- (void).cxx_destruct;	// IMP=0x0020000000019c7e
...
- (id)initWithURLResponse:(id)arg1 data:(id)arg2;	// IMP=0x0010000000019656
- (id)_parsePlistFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000019488
