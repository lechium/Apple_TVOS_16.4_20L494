...
- (void).cxx_destruct;	// IMP=0x00200000001472a8
...
- (void)performBlockAfterFirstUnlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000146fc8
- (void)_handleDeviceFirstUnlockNotification;	// IMP=0x0010000000146df8
- (void)_refreshHasBeenUnlocked;	// IMP=0x0010000000146cac
- (id)initWithQueue:(id)arg1;	// IMP=0x0010000000146c95
- (id)initWithNotifyObserver:(id)arg1 queue:(id)arg2;	// IMP=0x0010000000146ae6
