...
+ (Class)endpointIDSDestinationURIsType;	// IMP=0x002000000007224e
+ (Class)routesType;	// IMP=0x0010000000072167
+ (Class)remoteParticipantHandlesType;	// IMP=0x00100000000718ad
+ (Class)providersType;	// IMP=0x001000000007164a
+ (Class)otherUniqueProxyIdentifiersType;	// IMP=0x00100000000714ff
+ (Class)protoCallType;	// IMP=0x00100000000709aa
- (void).cxx_destruct;	// IMP=0x0010000000079f28
...
- (_Bool)protoFailureExpected;	// IMP=0x0010000000079f08
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000078c8a
- (unsigned long long)hash;	// IMP=0x00100000000781e7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000775c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000766d8
- (void)copyTo:(id)arg1;	// IMP=0x0010000000075d3c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000751b1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000751a4
- (id)dictionaryRepresentation;	// IMP=0x0010000000072455
- (id)description;	// IMP=0x00100000000723a6
@property(nonatomic) _Bool hasProtoSupportsEmergencyFallback;
- (void);	// IMP=0x0010000000072359
@property(nonatomic) _Bool hasProtoFailureExpected;
- (void)setProtoFailureExpected:(_Bool)arg1;	// IMP=0x001000000007230a
...
- (id)endpointIDSDestinationURIsAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000072231
- (unsigned long long)endpointIDSDestinationURIsCount;	// IMP=0x0010000000072214
- (void)addEndpointIDSDestinationURIs:(id)arg1;	// IMP=0x00100000000721aa
- (void)clearEndpointIDSDestinationURIs;	// IMP=0x001000000007218d
@property(readonly, nonatomic) _Bool hasRoute;
- (id)routesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000007214a
- (unsigned long long)routesCount;	// IMP=0x001000000007212d
- (void)addRoutes:(id)arg1;	// IMP=0x00100000000720c3
- (void)clearRoutes;	// IMP=0x00100000000720a6
- (int)StringAsRequestActionType:(id)arg1;	// IMP=0x0010000000071a25
- (id)requestActionTypeAsString:(int)arg1;	// IMP=0x00100000000719dc
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000071890
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x0010000000071873
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x0010000000071809
- (void)clearRemoteParticipantHandles;	// IMP=0x00100000000717ec
...
- (id)providersAtIndex:(unsigned long long)arg1;	// IMP=0x001000000007162d
- (unsigned long long)providersCount;	// IMP=0x0010000000071610
- (void)addProviders:(id)arg1;	// IMP=0x00100000000715a6
- (void)clearProviders;	// IMP=0x0010000000071589
...
- (id)otherUniqueProxyIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000714e2
- (unsigned long long)otherUniqueProxyIdentifiersCount;	// IMP=0x00100000000714c5
- (void)addOtherUniqueProxyIdentifiers:(id)arg1;	// IMP=0x001000000007145b
- (void)clearOtherUniqueProxyIdentifiers;	// IMP=0x001000000007143e
...
- (int)StringAsReceivedMessageType:(id)arg1;	// IMP=0x0010000000070ad1
- (id)receivedMessageTypeAsString:(int)arg1;	// IMP=0x0010000000070a88
...
- (id)protoCallAtIndex:(unsigned long long)arg1;	// IMP=0x001000000007098d
- (unsigned long long)protoCallsCount;	// IMP=0x0010000000070970
- (void)addProtoCall:(id)arg1;	// IMP=0x0010000000070906
- (void)clearProtoCalls;	// IMP=0x00100000000708e9
...
- (int)StringAsType:(id)arg1;	// IMP=0x0010000000070054
- (id)typeAsString:(int)arg1;	// IMP=0x001000000007000b
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x0010000000047f1b
...
- (void)addCall:(id)arg1;	// IMP=0x00100000000476cc
...
- (void)customizeForProtocolVersion:(int)arg1;	// IMP=0x0010000000046715
- (void)addProtocolVersion;	// IMP=0x00100000000466fe
...
- (void)setService:(int)arg1;	// IMP=0x0010000000046427
- (int)service;	// IMP=0x0010000000046415
...
- (id)initWithType:(int)arg1 uniqueProxyIdentifier:(id)arg2;	// IMP=0x0010000000045ed9
- (id)initWithType:(int)arg1;	// IMP=0x0010000000045dfa
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000045b5a
