...
- (void).cxx_destruct;	// IMP=0x0010000000195de3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000195bc3
- (unsigned long long)hash;	// IMP=0x0010000000195aeb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000195923
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001957ba
- (void)copyTo:(id)arg1;	// IMP=0x00100000001956b7
- (void)writeTo:(id)arg1;	// IMP=0x00100000001955c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001955bc
- (id)dictionaryRepresentation;	// IMP=0x00100000001951b2
- (id)description;	// IMP=0x0010000000195103
...
- (id)initWithTUSenderIdentity:(id)arg1;	// IMP=0x0010000000194ace
