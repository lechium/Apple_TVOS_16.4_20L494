...
+ (id)mockCallWithNotificationCenter:(id)arg1 fromBlock:(CDUnknownBlockType)arg2;	// IMP=0x004000000018d967
+ (id)mockCallFromBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000018d8da
+ (id)mockCallWithNotificationCenter:(id)arg1;	// IMP=0x001000000018d8c6
+ (id)mockCall;	// IMP=0x001000000018d85e
- (void).cxx_destruct;	// IMP=0x002000000018eade
...
- (void)setSharingScreen:(_Bool)arg1 attributes:(id)arg2;	// IMP=0x001000000018e287
- (void)disconnectWithReason:(int)arg1;	// IMP=0x001000000018e22c
- (void)dialWithRequest:(id)arg1 displayContext:(id)arg2;	// IMP=0x001000000018e0b0
- (void)answerWithRequest:(id)arg1;	// IMP=0x001000000018dfdf
- (void)unhold;	// IMP=0x001000000018dfc8
- (void)hold;	// IMP=0x001000000018dfb1
- (void)setEndpointOnCurrentDevice:(_Bool)arg1;	// IMP=0x001000000018df9f
- (void)updateWithCall:(id)arg1;	// IMP=0x001000000018dac4
- (id)initWithUniqueProxyIdentifier:(id)arg1 endpointOnCurrentDevice:(_Bool)arg2 notificationCenter:(id)arg3;	// IMP=0x001000000018d9df
