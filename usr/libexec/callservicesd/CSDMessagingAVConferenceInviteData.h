...
- (void).cxx_destruct;	// IMP=0x001000000008f45b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000008f369
- (unsigned long long)hash;	// IMP=0x001000000008f2fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008f204
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000008f140
- (void)copyTo:(id)arg1;	// IMP=0x001000000008f0bd
- (void)writeTo:(id)arg1;	// IMP=0x001000000008f043
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000008f036
- (id)dictionaryRepresentation;	// IMP=0x001000000008ee04
- (id)description;	// IMP=0x001000000008ed55
...
- (id)initWithFaceTimeInviteDictionary:(id)arg1;	// IMP=0x0010000000088cc8
- (id)initWithRelayInviteDictionary:(id)arg1;	// IMP=0x0010000000088bfa
