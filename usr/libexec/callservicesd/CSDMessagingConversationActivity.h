...
@class CSDMessagingConversationActivityContext, CSDMessagingConversationActivityMetadata, CSDMessagingHandle, MISSING_TYPE, NSData, NSString, TUConversationActivity;
...
+ (id)activityWithCSDConversationActivity:(id)arg1 handle:(id)arg2;	// IMP=0x0010000000096a62
+ (id)activityWithCSDConversationActivity:(id)arg1 fromConversation:(id)arg2 forStorage:(_Bool)arg3;	// IMP=0x00100000000963c5
- (void).cxx_destruct;	// IMP=0x001000000011edc5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000011e9ec
- (unsigned long long)hash;	// IMP=0x001000000011e6b1
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000011e3aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011e166
- (void)copyTo:(id)arg1;	// IMP=0x001000000011df9b
- (void)writeTo:(id)arg1;	// IMP=0x001000000011dde5
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000011ddd8
- (MISSING_TYPE *)dictionaryRepresentation;	// IMP=0x001000000011d59a
- (id)description;	// IMP=0x001000000011d4eb
