...
- (void).cxx_destruct;	// IMP=0x00200000000a59c0
...
- (void)_parsePauseDigitsFromDestinationID:(id)arg1;	// IMP=0x00100000000a55ba
- (id)dequeueAllPauseDigits;	// IMP=0x00100000000a54bf
- (id)dequeueNextPauseDigits;	// IMP=0x00100000000a5410
@property(readonly, nonatomic) _Bool hasQueuedHardPauseDigits;
@property(readonly, nonatomic) CSDPauseDigits *nextPauseDigits;
- (id)description;	// IMP=0x00100000000a5128
- (id)initWithDestinationID:(id)arg1;	// IMP=0x00100000000a5091
- (id)init;	// IMP=0x00100000000a5007
