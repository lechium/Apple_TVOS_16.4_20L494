...
- (void).cxx_destruct;	// IMP=0x002000000008adb1
...
- (void)propertiesDidChangeForConfiguration:(id)arg1;	// IMP=0x001000000008ab2d
- (void)_setUpSandbox;	// IMP=0x001000000008ab12
- (id)_setUpTemporaryDirectory;	// IMP=0x001000000008a9a6
- (void)_setUpLanguageChangeListener;	// IMP=0x001000000008a8ea
@property(readonly, copy) NSString *debugDescription;
- (void)_observeSignal:(int)arg1 usingHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000008a620
- (void)dealloc;	// IMP=0x001000000008a49e
- (id)init;	// IMP=0x0010000000088f96
