...
- (void).cxx_destruct;	// IMP=0x002000000014af9e
...
- (id)callsForDataSource:(id)arg1 identifier:(id)arg2;	// IMP=0x001000000014ae99
- (void)addCalls:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x001000000014ab6c
@property(readonly, copy, nonatomic) NSArray *dataSources;
- (id)init;	// IMP=0x001000000014aabf
