...
- (void).cxx_destruct;	// IMP=0x002000000014d172
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000014cf78
- (unsigned long long)hash;	// IMP=0x001000000014ce77
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000014cca7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000014cb51
- (void)copyTo:(id)arg1;	// IMP=0x001000000014ca4a
- (void);	// IMP=0x001000000014c949
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000014c93c
- (id)dictionaryRepresentation;	// IMP=0x001000000014c3b6
- (id)description;	// IMP=0x001000000014c307
