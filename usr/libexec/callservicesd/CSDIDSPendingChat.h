...
- (void).cxx_destruct;	// IMP=0x00400000002b5840
- (id)init;	// IMP=0x00100000002b5800
- (id)initWithUUID:(id)arg1 isVideo:(_Bool)arg2 handle:(id)arg3;	// IMP=0x00100000002b5720
