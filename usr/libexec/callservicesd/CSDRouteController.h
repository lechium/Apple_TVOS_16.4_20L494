...
+ (id)makePairedHostDeviceRouteController;	// IMP=0x00200000002a2980
+ (id)makeLocalRouteController;	// IMP=0x00100000002a2960
- (void).cxx_destruct;	// IMP=0x00400000002a47d0
- (id)init;	// IMP=0x00100000002a4770
- (void)handleUpdatedPairedHostDeviceRoutes:(id)arg1;	// IMP=0x00100000002a4380
- (void)clearState;	// IMP=0x00100000002a3e70
- (void)pickRouteWithUniqueIdentifier:(id)arg1 shouldWaitUntilAvailable:(_Bool)arg2;	// IMP=0x00100000002a3b20
