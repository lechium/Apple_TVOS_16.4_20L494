...
- (void).cxx_destruct;	// IMP=0x00200000000a4fd4
...
- (void)unregisterClient:(id)arg1;	// IMP=0x00100000000a4eb4
- (void)registerClient:(id)arg1;	// IMP=0x00100000000a4db2
- (oneway void)updateOutgoingLocalParticipantUUID:(id)arg1 forCallsWithOutgoingLocalParticipantUUID:(id)arg2;	// IMP=0x00100000000a4c14
- (void)invalidate;	// IMP=0x00100000000a4b62
- (id)initWithManager:(id)arg1;	// IMP=0x00100000000a46eb
