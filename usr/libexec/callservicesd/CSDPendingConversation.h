...
- (void).cxx_destruct;	// IMP=0x0020000000058393
...
- (id)groupUUID;	// IMP=0x0010000000057de7
- (id)UUID;	// IMP=0x0010000000057dd5
@property(readonly, nonatomic) long long state;
- (id)description;	// IMP=0x0010000000057b69
- (id)initWithConversationLink:(id)arg1 localMember:(id)arg2 queue:(id)arg3;	// IMP=0x0010000000057a43
