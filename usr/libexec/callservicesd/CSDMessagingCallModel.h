...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000041df9
- (unsigned long long)hash;	// IMP=0x0010000000041d23
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000041b49
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000041a4f
- (void)copyTo:(id)arg1;	// IMP=0x0010000000041978
- (void)writeTo:(id)arg1;	// IMP=0x0010000000041865
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000041858
- (id)dictionaryRepresentation;	// IMP=0x001000000004105c
- (id)description;	// IMP=0x0010000000040fad
