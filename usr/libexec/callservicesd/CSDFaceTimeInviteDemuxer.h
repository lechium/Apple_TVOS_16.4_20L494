...
- (void).cxx_destruct;	// IMP=0x00400000002d57f0
- (_Bool)destinationIDsCanUseV2Blobs:(id)arg1;	// IMP=0x00100000002d4d00
- (void)idsPeersForHandle:(id)arg1 video:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000002d4c00
- (id)init;	// IMP=0x00100000002d3980
