...
- (void).cxx_destruct;	// IMP=0x00400000001d6f70
- (id)init;	// IMP=0x00100000001d6f10
- (_Bool)validateUserIntentForCallSource:(id)arg1;	// IMP=0x00100000001d6eb0
- (void)donateUserIntentForCallProviderIdentifier:(id)arg1;	// IMP=0x00100000001d67c0
- (id)initWithQueue:(id)arg1;	// IMP=0x00100000001d6780
