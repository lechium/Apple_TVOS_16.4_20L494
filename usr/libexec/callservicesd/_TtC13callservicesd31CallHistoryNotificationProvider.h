...
@interface _TtC13callservicesd31CallHistoryNotificationProvider : NSObject
{
    ...
    MISSING_TYPE *openURL;	// 3980396 = 0x3cbc6c
    ...
    MISSING_TYPE *updateBadgeValue;	// 3980412 = 0x3cbc7c
}

- (void).cxx_destruct;	// IMP=0x0040000000287c00
- (id)init;	// IMP=0x00100000002826c0
