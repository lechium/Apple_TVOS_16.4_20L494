...
+ (id)callCapabilitiesForCallManagementStateInfo:(id)arg1;	// IMP=0x004000000006f975
+ (id)callCapabilitiesForCTCallCapabilities:(id)arg1;	// IMP=0x001000000006f897
...
- (id)debugDescription;	// IMP=0x001000000006fbe6
- (id)description;	// IMP=0x001000000006fbd4
