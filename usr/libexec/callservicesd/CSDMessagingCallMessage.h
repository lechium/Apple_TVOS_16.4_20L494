...
- (void).cxx_destruct;	// IMP=0x001000000011c59a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000011c3a6
- (unsigned long long)hash;	// IMP=0x001000000011c272
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000011c042
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011bedc
- (void)copyTo:(id)arg1;	// IMP=0x001000000011bdac
- (void)writeTo:(id)arg1;	// IMP=0x001000000011bc61
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000011bc54
- (id)dictionaryRepresentation;	// IMP=0x001000000011b2f4
- (id)description;	// IMP=0x001000000011b245
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000011afcd
- (id)typeAsString:(int)arg1;	// IMP=0x001000000011af84
@property(nonatomic) _Bool hasType;
@property(nonatomic) int type; // @synthesize type=_type;
- (void)addProtocolVersion;	// IMP=0x0010000000013cfe
...
- (void)setWantsVideo:(_Bool)arg1;	// IMP=0x0010000000013bc8
- (_Bool)wantsVideo;	// IMP=0x0010000000013bb6
