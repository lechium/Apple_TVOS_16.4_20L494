...
+ (Class)invitedHandlesType;	// IMP=0x0020000000006840
+ (id)linkWithTUConversationLink:(id)arg1 includeGroupUUID:(_Bool)arg2;	// IMP=0x001000000000635f
- (void).cxx_destruct;	// IMP=0x0010000000008834
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000083f0
- (unsigned long long)hash;	// IMP=0x00100000000080a6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000007dbf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000007a1e
- (void)copyTo:(id)arg1;	// IMP=0x0010000000007800
- (void)writeTo:(id)arg1;	// IMP=0x001000000000756d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000007560
- (id)dictionaryRepresentation;	// IMP=0x0010000000006b52
- (id)description;	// IMP=0x0010000000006aa3
- (int)StringAsLinkLifetimeScope:(id)arg1;	// IMP=0x0010000000006a41
- (id)linkLifetimeScopeAsString:(int)arg1;	// IMP=0x00100000000069ec
...
- (id)invitedHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000006823
- (unsigned long long)invitedHandlesCount;	// IMP=0x0010000000006806
- (void)addInvitedHandles:(id)arg1;	// IMP=0x001000000000679c
- (void)clearInvitedHandles;	// IMP=0x001000000000677f
