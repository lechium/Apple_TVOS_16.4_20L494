...
+ (id)participantWithCSDConversationParticipant:(id)arg1;	// IMP=0x001000000017890b
+ (id)participantWithCSDConversationJoinContext:(id)arg1;	// IMP=0x0010000000178708
- (void).cxx_destruct;	// IMP=0x00100000000139a3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000013592
- (unsigned long long)hash;	// IMP=0x00100000000132d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000012e51
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000012b90
- (void)copyTo:(id)arg1;	// IMP=0x0010000000012928
- (void)writeTo:(id)arg1;	// IMP=0x001000000001268d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000012680
- (id)dictionaryRepresentation;	// IMP=0x00100000000114e9
- (id)description;	// IMP=0x001000000001143a
...
- (int)StringAsAvMode:(id)arg1;	// IMP=0x00100000000112f3
- (id)avModeAsString:(int)arg1;	// IMP=0x00100000000112aa
