...
+ (id)activityContextWithTUActivityContext:(id)arg1;	// IMP=0x0010000000049d07
- (void).cxx_destruct;	// IMP=0x001000000006ecb6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000006eb7f
- (unsigned long long)hash;	// IMP=0x001000000006eafb
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000006e9cf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006e8e5
- (void)copyTo:(id)arg1;	// IMP=0x001000000006e842
- (void)writeTo:(id)arg1;	// IMP=0x001000000006e7ab
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000006e79e
- (id)dictionaryRepresentation;	// IMP=0x001000000006e545
- (id)description;	// IMP=0x001000000006e496
