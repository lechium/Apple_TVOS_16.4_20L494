...
+ (Class)contactIdentifiersType;	// IMP=0x0020000000126646
- (void).cxx_destruct;	// IMP=0x0010000000127fe9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000127ad2
- (unsigned long long)hash;	// IMP=0x001000000012793b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000127607
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000127233
- (void)copyTo:(id)arg1;	// IMP=0x0010000000126fd1
- (void)writeTo:(id)arg1;	// IMP=0x0010000000126d29
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000126d1c
- (id)dictionaryRepresentation;	// IMP=0x0010000000126706
- (id)description;	// IMP=0x0010000000126657
- (id)contactIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000126629
- (unsigned long long)contactIdentifiersCount;	// IMP=0x001000000012660c
- (void)addContactIdentifiers:(id)arg1;	// IMP=0x00100000001265a2
- (void)clearContactIdentifiers;	// IMP=0x0010000000126585
...
- (id)initWithCallDisplayContext:(id)arg1;	// IMP=0x00100000001472e6
