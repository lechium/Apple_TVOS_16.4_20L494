...
- (void).cxx_destruct;	// IMP=0x00200000001ceece
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001ced02
- (unsigned long long)hash;	// IMP=0x00100000001cebec
- (_Bool)isEqualToTransport:(id)arg1;	// IMP=0x00100000001ce9eb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001ce98e
- (id)description;	// IMP=0x00100000001ce761
- (id)initWithDestination:(id)arg1;	// IMP=0x00100000001ce6e8
- (id)initWithSocket:(int)arg1;	// IMP=0x00100000001ce6a6
