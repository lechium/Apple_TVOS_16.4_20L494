...
+ (Class)remoteParticipantHandlesType;	// IMP=0x002000000009ce94
- (void).cxx_destruct;	// IMP=0x00100000000a1091
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000a0851
- (unsigned long long)hash;	// IMP=0x00100000000a02d5
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000009fb7c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009f583
- (void)copyTo:(id)arg1;	// IMP=0x001000000009f114
- (void)writeTo:(id)arg1;	// IMP=0x001000000009ebf9
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000009ebec
- (id)dictionaryRepresentation;	// IMP=0x001000000009d0f9
- (id)description;	// IMP=0x001000000009d04a
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000009ce77
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x001000000009ce5a
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x001000000009cdf0
- (void)clearRemoteParticipantHandles;	// IMP=0x001000000009cdd3
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x0010000000121ed8
...
- (_Bool)isEqualToCall:(id)arg1;	// IMP=0x0010000000121075
- (void)updateRelayCall:(id)arg1;	// IMP=0x0010000000120b70
...
- (void)setService:(int)arg1;	// IMP=0x0010000000120638
- (int)service;	// IMP=0x0010000000120626
@property(nonatomic, getter=isConferenced) _Bool conferenced;
@property(nonatomic) int status;
- (id)initWithCall:(id)arg1;	// IMP=0x0010000000120132
