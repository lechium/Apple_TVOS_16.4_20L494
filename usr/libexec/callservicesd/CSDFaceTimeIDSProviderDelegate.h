...
- (void).cxx_destruct;	// IMP=0x00200000000962ec
...
- (void)service:(id)arg1 activeAccountsChanged:(id)arg2;	// IMP=0x0010000000096082
- (void)providerDidBegin:(id)arg1;	// IMP=0x0010000000095fc5
- (void)updateProviderConfigurationWithAccounts:(id)arg1 senderIdentities:(id)arg2;	// IMP=0x0010000000095a73
- (void)updateProviderConfigurationWithSenderIdentities:(id)arg1;	// IMP=0x00100000000959d4
- (void)updateProviderConfigurationWithAccounts:(id)arg1;	// IMP=0x0010000000095935
- (_Bool)isMomentsAvailableForChat:(id)arg1;	// IMP=0x00100000000958f1
- (void)chatEnded:(id)arg1;	// IMP=0x00100000000956e8
- (void)chatStartedConnecting:(id)arg1;	// IMP=0x0010000000095553
- (_Bool)isMediaAllowedForChat:(id)arg1;	// IMP=0x00100000000953e6
- (void)endCallWithUUIDAsDeclinedElsewhere:(id)arg1;	// IMP=0x001000000009529a
- (void)endCallWithUUIDAsLocalHangup:(id)arg1;	// IMP=0x001000000009507f
- (void)endCallWithUUID:(id)arg1;	// IMP=0x0010000000094f33
- (void)endCallWithUUIDAsAnsweredElsewhere:(id)arg1;	// IMP=0x0010000000094de7
- (_Bool)hasCallStartedConnectingWithUUID:(id)arg1;	// IMP=0x0010000000094d84
- (id)upgradeSessionUUIDForCallWithUUID:(id)arg1;	// IMP=0x0010000000094d34
- (void)upgradeChatIfNecessary:(id)arg1;	// IMP=0x0010000000094b28
- (_Bool)canUpgradeChat:(id)arg1;	// IMP=0x0010000000094933
- (_Bool)isUpgradingCallWithUUID:(id)arg1;	// IMP=0x00100000000948b2
- (_Bool)isManagingCallWithUUID:(id)arg1;	// IMP=0x001000000009487f
- (id)ISOCountryCodeForChat:(id)arg1;	// IMP=0x0010000000094754
- (id)ISOCountryCodeForCallWithUUID:(id)arg1;	// IMP=0x00100000000946f5
- (void)provider:(id)arg1 performJoinCallAction:(id)arg2;	// IMP=0x00100000000945b7
- (id)callForConversation:(id)arg1 withSessionToken:(id)arg2;	// IMP=0x0010000000094207
- (id)upgradeCallForConversation:(id)arg1 withSessionToken:(id)arg2;	// IMP=0x00100000000940ff
- (id)callUpdateForChat:(id)arg1;	// IMP=0x0010000000094065
- (void)inviteIDSPeersWithAction:(id)arg1 destinations:(id)arg2 joinCallActionToFulfill:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x001000000009324b
- (id)accountWithUUID:(id)arg1 service:(id)arg2;	// IMP=0x0000000000092da6
- (id)initWithCapabilities:(id)arg1 queue:(id)arg2;	// IMP=0x0010000000092960
- (id)initWithQueue:(id)arg1;	// IMP=0x00100000000928fc
- (id)init;	// IMP=0x0010000000092872
