...
- (void).cxx_destruct;	// IMP=0x001000000014c1c5
...
- (id)valueForEntitlement:(id)arg1;	// IMP=0x001000000014c11c
- (_Bool)isEntitledForCapability:(id)arg1;	// IMP=0x001000000014c114
...
- (void)performBlockAfterCoalescing:(CDUnknownBlockType)arg1;	// IMP=0x001000000014c008
@property(readonly, nonatomic) id objectForBlock;
- (void)performBlock:(CDUnknownBlockType)arg1 coalescedByIdentifier:(id)arg2;	// IMP=0x001000000014bd5c
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000014bcee
@property(readonly, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x001000000014bb8d
- (id)initWithObject:(id)arg1 queue:(id)arg2;	// IMP=0x001000000014ba9e
