...
- (void).cxx_destruct;	// IMP=0x0040000000208730
- (id)init;	// IMP=0x0010000000208680
- (unsigned long long)handoffUPlusOneLeaveDelay;	// IMP=0x0010000000208600
@property(nonatomic, readonly) unsigned long long handoffUPlusOneLeaveTimeout;
- (_Bool)gftaasPseudonymsEnabled:(id)arg1;	// IMP=0x0010000000208500
- (_Bool)isGuestModeSupported;	// IMP=0x0010000000208480
@property(nonatomic, readonly) double neighborhoodActivityConduitTimeout;
- (_Bool)isUPlusNDowngradeAvailable;	// IMP=0x0010000000208400
@property(nonatomic, readonly) unsigned long long maxRemoteMirageParticipants;
- (_Bool)isGFTDowngradeToOneToOneAvailable;	// IMP=0x00100000002083c0
- (_Bool)isExpanseConduitProxyEnabled;	// IMP=0x00100000002083a0
...
- (id)stableBundleIdentifierForLocalBundleIdentifier:(id)arg1;	// IMP=0x00100000002082d0
@property(nonatomic, readonly) unsigned long long handoffAudioDeviceTimeout;
- (id)localBundleIDForActivityIdentifier:(id)arg1;	// IMP=0x00100000002080d0
...
- (_Bool)isSharePlayVersionCheckEnabled;	// IMP=0x0010000000207ee0
- (_Bool)isModernGFTEnabled;	// IMP=0x0010000000207ec0
- (_Bool)isAutomaticUpgradingEnabled;	// IMP=0x0010000000207ea0
