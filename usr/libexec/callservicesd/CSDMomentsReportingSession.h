...
+ (unsigned long long)bucketedInteger:(unsigned long long)arg1;	// IMP=0x004000000016f6e4
+ (double)meanFromDoubleNumbers:(id)arg1;	// IMP=0x001000000016f53a
+ (id)medianFromNumbers:(id)arg1;	// IMP=0x001000000016f3fa
- (void).cxx_destruct;	// IMP=0x002000000016f7e3
...
- (double)meanRequestDuration;	// IMP=0x001000000016f398
- (id)medianRequestDuration;	// IMP=0x001000000016f32e
- (unsigned long long)fuzzyPhotoRequestSuccessCount;	// IMP=0x001000000016f2e9
- (unsigned long long)fuzzyPhotoRequestFailureCount;	// IMP=0x001000000016f2a4
- (void)reportDataCollectionCompleteIfNecessary;	// IMP=0x001000000016f0be
- (void)didCleanUp;	// IMP=0x001000000016f015
- (void)didReceiveResultsWithTransactionID:(id)arg1;	// IMP=0x001000000016ec66
- (void)didStartRequestWithTransactionID:(id)arg1;	// IMP=0x001000000016e8ff
- (void)registeredStreamWithAvailability:(int)arg1;	// IMP=0x001000000016e873
- (id)init;	// IMP=0x001000000016e7e9
- (id)initWithStreamToken:(long long)arg1;	// IMP=0x001000000016e700
