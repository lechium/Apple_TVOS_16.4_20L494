...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001200b8
- (unsigned long long)hash;	// IMP=0x0010000000120072
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000011ffa4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011ff27
- (void)copyTo:(id)arg1;	// IMP=0x001000000011fecd
- (void)writeTo:(id)arg1;	// IMP=0x001000000011fe5a
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000011fe4d
- (id)dictionaryRepresentation;	// IMP=0x001000000011fac1
- (id)description;	// IMP=0x001000000011fa12
...
- (id)initWithCallCapabilitiesState:(id)arg1;	// IMP=0x001000000011c5cb
