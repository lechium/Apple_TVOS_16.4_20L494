...
+ (id)taskWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0020000000001cb0
...
- (_Bool)_deferIfNeeded;	// IMP=0x0010000000002760
- (id)_restorationExitStatusForResult:(unsigned long long)arg1;	// IMP=0x00100000000026c0
- (void)_completeWithResult:(unsigned long long)arg1;	// IMP=0x00100000000021e0
@property(readonly, copy) NSString *description;
- (id)initWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000001dc0
