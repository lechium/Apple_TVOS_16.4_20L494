...
+ (id)withAnonymousInvokation:(id)arg1;	// IMP=0x0020000000013eb0
+ (id)withFirstBootType;	// IMP=0x0010000000013e40
+ (id)withNotificationName:(id)arg1;	// IMP=0x0010000000013d90
+ (id)withLaunchActivityId:(id)arg1;	// IMP=0x0010000000013ce0
- (void).cxx_destruct;	// IMP=0x0020000000014200
...
- (id)description;	// IMP=0x0010000000014050
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000013f60
