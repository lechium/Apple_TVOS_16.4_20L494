...
+ (void)populateReplyMessageToDeny:(id)arg1 withError:(id)arg2;	// IMP=0x004000000003616b
- (void).cxx_destruct;	// IMP=0x0020000000036bf5
...
- (void)populateReplyMessage:(id)arg1;	// IMP=0x0010000000036729
- (id)description;	// IMP=0x0010000000036715
- (id)descriptionWithRespectToService:(id)arg1;	// IMP=0x001000000003646d
- (void)denyAuthorizationWithErrorCode:(long long)arg1 format:(id)arg2;	// IMP=0x00100000000362ad
- (id)init;	// IMP=0x001000000003625c
