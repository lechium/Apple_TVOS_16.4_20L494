...
- (void).cxx_destruct;	// IMP=0x002000000003cdeb
...
- (id)attributedBundleUsingOutermostBundle:(_Bool)arg1 computedStaticCodeRef:(const void **)arg2 computedNonIdentifiableBundleURL:(id *)arg3;	// IMP=0x001000000003ca8f
...
- (id)description;	// IMP=0x001000000003c88c
- (id)initWithMessage:(id)arg1 evaluateResponsibility:(_Bool)arg2 processInfo:(id)arg3;	// IMP=0x001000000003c287
- (id)createProcessFromAuditToken:(CDStruct_4c969caf)arg1 processInfo:(id)arg2;	// IMP=0x001000000003c243
- (void)getAuditToken:(CDStruct_4c969caf *)arg1 fromMessage:(id)arg2;	// IMP=0x001000000003c233
- (id)initWithMessage:(id)arg1 evaluateResponsibility:(_Bool)arg2;	// IMP=0x001000000003c21e
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000003c207
