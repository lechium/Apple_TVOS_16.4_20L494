...
+ (void)cacheAccessIdentity:(id)arg1 forAccessorAuditToken:(CDStruct_4c969caf *)arg2 responsibleAuditToken:(CDStruct_4c969caf *)arg3 isSpecificIdentity:(_Bool)arg4;	// IMP=0x004000000000f773
+ (id)cachedAccessIdentityForAccessorAuditToken:(CDStruct_4c969caf *)arg1 responsibleAuditToken:(CDStruct_4c969caf *)arg2 isSpecificIdentity:(_Bool)arg3;	// IMP=0x001000000000f6ac
+ (void)clearCache;	// IMP=0x001000000000f62c
+ (id)_createCacheKeyWithAccessorAuditToken:(CDStruct_4c969caf *)arg1 responsibleAuditToken:(CDStruct_4c969caf *)arg2 isSpecificIdentity:(_Bool)arg3;	// IMP=0x001000000000f22f
+ (void)_initIdentityCache;	// IMP=0x001000000000f18b
- (void).cxx_destruct;	// IMP=0x0020000000012abf
...
- (_Bool)isPlugInWithExtensionPointIdentifier:(id)arg1;	// IMP=0x00100000000128be
- (_Bool)getSDKVersion:(unsigned int *)arg1 platformType:(unsigned int *)arg2;	// IMP=0x0010000000011eb0
@property(readonly) NSString *attributionPath;
- (id)displayName;	// IMP=0x0010000000011e64
- (id)description;	// IMP=0x0010000000011e22
- (void)_updateFromAccessIdentity:(id)arg1;	// IMP=0x0010000000011d37
- (id)_initWithAccessIdentity:(id)arg1;	// IMP=0x0010000000011cc9
- (id)initWithIdentifier:(id)arg1 type:(int)arg2 executableURL:(id)arg3 SDKVersion:(unsigned int)arg4 platformType:(unsigned int)arg5;	// IMP=0x001000000001177c
- (id)initWithBundleIdentifier:(id)arg1 isWK2Proxy:(_Bool)arg2;	// IMP=0x00100000000115c5
- (id)initWithMessage:(id)arg1;	// IMP=0x0010000000011173
- (id)initWithAttributionChain:(id)arg1 preferMostSpecificIdentifier:(_Bool)arg2;	// IMP=0x0010000000010ee5
- (_Bool)_deriveIdentityFromAttributionChain:(id)arg1 preferMostSpecificIdentifier:(_Bool)arg2;	// IMP=0x001000000000fe3c
- (void)_makeDisplayNameBlockForURL:(id)arg1;	// IMP=0x001000000000fd2b
- (_Bool)isEqualToCachedIdentity:(id)arg1;	// IMP=0x001000000000f328
