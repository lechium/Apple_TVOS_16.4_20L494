...
- (void).cxx_destruct;	// IMP=0x00200000000242d9
...
- (void)_loadAllImages;	// IMP=0x0010000000024217
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x0010000000023f69
- (id)_idiomSuffix;	// IMP=0x0010000000023f5c
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x0010000000023c18
- (id)allImages;	// IMP=0x0010000000023be9
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x0010000000023bd7
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x0010000000023aa8
