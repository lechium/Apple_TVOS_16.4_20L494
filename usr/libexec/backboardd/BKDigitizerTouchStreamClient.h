...
- (void).cxx_destruct;	// IMP=0x002000000006bc43
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000006bbea
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x001000000006ba45
- (id)init;	// IMP=0x001000000006b9f5
