...
+ (id)sharedInstance;	// IMP=0x004000000004303b
- (void).cxx_destruct;	// IMP=0x002000000004298e
@property(getter=isSecureModeEnabled) _Bool secureModeEnabled; // @synthesize secureModeEnabled=_secureModeEnabled;
- (void)reportAndKillInsecureProcesses;	// IMP=0x00100000000424c6
- (void)startMonitoringSecureDrawing;	// IMP=0x0010000000042473
- (id)init;	// IMP=0x00100000000423be
