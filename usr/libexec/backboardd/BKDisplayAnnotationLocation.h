...
+ (id)relativeToBottomMiddleOfSuper:(struct CGPoint)arg1;	// IMP=0x002000000006dcb2
+ (id)relativeToBottomLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x001000000006dc18
+ (id)relativeToTopLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x001000000006db83
+ (id)centerAtPoint:(struct CGPoint)arg1;	// IMP=0x001000000006dafb
+ (id)controlledBySupernode;	// IMP=0x001000000006dacb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000006d953
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006d915
