...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000022c23
+ (id)classesRequiredToDecode;	// IMP=0x0010000000022b9d
- (void).cxx_destruct;	// IMP=0x0020000000022b75
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000229cf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002285f
- (void)dealloc;	// IMP=0x00100000000227d5
- (id)_initWithDescriptor:(id)arg1 overlayType:(long long)arg2 imageData:(id)arg3 level:(float)arg4 frozen:(_Bool)arg5;	// IMP=0x00100000000226e2
