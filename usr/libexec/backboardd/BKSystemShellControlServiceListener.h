...
- (void).cxx_destruct;	// IMP=0x0020000000074844
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x00100000000745f8
- (void)activate;	// IMP=0x00000000000745e2
- (id)initWithSentinel:(id)arg1;	// IMP=0x001000000007447e
