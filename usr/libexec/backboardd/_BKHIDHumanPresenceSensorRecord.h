...
- (void).cxx_destruct;	// IMP=0x0020000000065430
...
- (void)removeService:(id)arg1;	// IMP=0x00100000000653bb
- (void)addService:(id)arg1;	// IMP=0x0010000000065347
- (void)_resetServiceStatus;	// IMP=0x0010000000065180
- (id)description;	// IMP=0x0010000000065092
