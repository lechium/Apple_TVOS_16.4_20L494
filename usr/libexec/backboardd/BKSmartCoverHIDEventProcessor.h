...
+ (_Bool)isSmartCoverSupported;	// IMP=0x00200000000527af
- (void).cxx_destruct;	// IMP=0x002000000005254c
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x00100000000522d4
- (id)addSmartCoverObserver:(id)arg1;	// IMP=0x0010000000052214
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x0010000000051a75
@property(readonly, nonatomic, getter=isSmartCoverClosed) _Bool smartCoverClosed;
- (int)_smartCoverSensorsDidDisengage:(unsigned long long)arg1;	// IMP=0x00100000000519ec
- (int)_smartCoverSensorsDidEngage:(unsigned long long)arg1;	// IMP=0x00100000000519b7
- (id)initWithContext:(id)arg1;	// IMP=0x0010000000051774
- (unsigned long long)_currentMaskForUsage:(unsigned int)arg1 HIDSystem:(id)arg2 mask:(unsigned long long *)arg3 maskIfEngaged:(unsigned long long *)arg4;	// IMP=0x001000000005164a
- (id)initWithSupportedHES:(unsigned long long)arg1 disengagedHES:(unsigned long long)arg2 attached:(_Bool)arg3 unknownState:(_Bool)arg4;	// IMP=0x001000000005131b
