...
- (void).cxx_destruct;	// IMP=0x002000000001f691
@property(copy, nonatomic) CDUnknownBlockType displayChangedHandler; // @synthesize displayChangedHandler=_displayChangedHandler;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000001f54d
@property(readonly, nonatomic) BKSHIDEventDisplay *display;
- (id)init;	// IMP=0x001000000001f40d
