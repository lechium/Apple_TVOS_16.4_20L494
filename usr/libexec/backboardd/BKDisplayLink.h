...
- (void)_thread_startRunLoop;	// IMP=0x0010000000002009
- (void)_thread_displayLinkFired;	// IMP=0x0010000000001feb
- (void)invalidate;	// IMP=0x0010000000001f94
- (id)initWithDisplayLinkClass:(Class)arg1 display:(id)arg2 target:(id)arg3 action:(SEL)arg4;	// IMP=0x0010000000001d2c
