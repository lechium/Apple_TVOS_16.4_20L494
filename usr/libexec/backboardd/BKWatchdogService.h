...
- (void).cxx_destruct;	// IMP=0x002000000002241a
...
- (_Bool)isAlive;	// IMP=0x00100000000223ce
- (void)registerClientsForMonitoring;	// IMP=0x00100000000223b8
- (id)init;	// IMP=0x001000000002231b
