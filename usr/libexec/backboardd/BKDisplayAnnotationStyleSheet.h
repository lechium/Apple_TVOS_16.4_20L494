...
- (void).cxx_destruct;	// IMP=0x00200000000191f5
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x001000000001900f
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x0010000000018f5f
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x0010000000018ee1
