...
- (void).cxx_destruct;	// IMP=0x002000000006deb4
- (void)main;	// IMP=0x00100000000690a0
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000688cf
