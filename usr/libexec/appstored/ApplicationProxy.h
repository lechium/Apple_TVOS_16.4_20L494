...
+ (void)enumerateApplicationsOfType:(unsigned long long)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00400000001b4d17
+ (id)proxyForBundleURL:(id)arg1;	// IMP=0x00100000001b37e0
+ (id)proxyForItemID:(id)arg1;	// IMP=0x00100000001b35d8
+ (id)proxyForBundleID:(id)arg1;	// IMP=0x00100000001b358b
+ (id)proxyForBundle:(id)arg1;	// IMP=0x00100000001b353e
+ (id)proxyMatchingBundleID:(id)arg1 orItemID:(id)arg2;	// IMP=0x00100000001b2c2c
- (void).cxx_destruct;	// IMP=0x00200000001b531a
...
- (id)description;	// IMP=0x00100000001b5004
- (id)validLocationProxy;	// IMP=0x00100000001b4ffb
...
- (id)initWithBundleURL:(id)arg1;	// IMP=0x00100000001b3ca3
- (id)initWithBundlePath:(id)arg1;	// IMP=0x00100000001b3c49
- (id)initWithBundleID:(id)arg1;	// IMP=0x00100000001b3a36
- (id)initWithBundle:(id)arg1;	// IMP=0x00100000001b39e0
- (id)initWithItemID:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001b33b6
- (id)initWithBundleURL:(id)arg1 allowPlaceholder:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00100000001b3223
- (_Bool)validateEligibilityForUpdatesWithLogKey:(id)arg1;	// IMP=0x00100000001b2fc8
- (id)initWithBundleID:(id)arg1 allowPlaceholder:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00100000001b2dc2
