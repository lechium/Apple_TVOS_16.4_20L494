...
- (void).cxx_destruct;	// IMP=0x002000000012f489
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x001000000012eec5
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000012eb97
- (void)close;	// IMP=0x001000000012eb35
- (void)open;	// IMP=0x001000000012eae9
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x001000000012e92d
