...
- (void).cxx_destruct;	// IMP=0x0020000000128f48
- (unsigned long long)hash;	// IMP=0x0010000000128b10
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000128429
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000127dd1
- (void)writeTo:(id)arg1;	// IMP=0x00100000001278f1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001278e4
- (id)dictionaryRepresentation;	// IMP=0x00100000001266d9
- (id)description;	// IMP=0x001000000012662a
