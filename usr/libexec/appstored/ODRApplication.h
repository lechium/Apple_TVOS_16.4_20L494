...
@interface ODRApplication : NSObject
{
    ...
    MISSING_TYPE *_externalVersionID;	// 64 = 0x40
...
- (void).cxx_destruct;	// IMP=0x002000000019a97a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000019a253
- (unsigned long long)hash;	// IMP=0x001000000019a134
- (id)description;	// IMP=0x0010000000199fe3
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000199f07
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000199cfe
