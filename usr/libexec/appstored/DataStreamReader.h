...
- (void).cxx_destruct;	// IMP=0x00200000001697d3
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x001000000016970a
- (void)close;	// IMP=0x00100000001696c0
