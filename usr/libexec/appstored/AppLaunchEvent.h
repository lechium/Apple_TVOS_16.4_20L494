...
@class MISSING_TYPE, NSDate, NSNumber, NSString, NSURL;
...
- (void).cxx_destruct;	// IMP=0x002000000016da9b
- (id)description;	// IMP=0x001000000016d6ff
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000016d4d6
