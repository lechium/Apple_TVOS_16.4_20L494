...
+ (id)defaultProperties;	// IMP=0x00200000000eaf74
+ (Class)databaseEntityClass;	// IMP=0x00100000000eaf63
- (void).cxx_destruct;	// IMP=0x00100000000eb066
...
- (id)purchaseInfoForUpdateUserInitiated:(_Bool)arg1;	// IMP=0x00100000000eb032
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000eaf34
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) long long softwarePlatform;
- (void)setUpdateState:(long long)arg1;	// IMP=0x00100000000eadb0
@property(nonatomic, getter=isPerDevice) _Bool perDevice;
- (void)setMetricsData:(id)arg1;	// IMP=0x00100000000ead3d
...
- (id)rawUpdateDictionary;	// IMP=0x00100000000eabfd
...
- (id)initWithUpdateDictionary:(id)arg1;	// IMP=0x00100000000e9b2e
- (id)init;	// IMP=0x00100000000e9aff
- (id)purchase_purchaseInfoForUpdateUserInitiated:(_Bool)arg1;	// IMP=0x001000000015342a
