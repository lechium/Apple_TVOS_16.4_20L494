...
- (void).cxx_destruct;	// IMP=0x002000000003c555
- (void)close;	// IMP=0x001000000003c50b
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x001000000003c468
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x000000000003c307
