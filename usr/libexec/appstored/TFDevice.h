...
- (void).cxx_destruct;	// IMP=0x002000000018e54a
- (unsigned long long)hash;	// IMP=0x001000000018e3b1
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000018e0d7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018dea2
- (void)writeTo:(id)arg1;	// IMP=0x001000000018dc05
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000018dbf8
- (id)dictionaryRepresentation;	// IMP=0x001000000018d307
- (id)description;	// IMP=0x001000000018d258
