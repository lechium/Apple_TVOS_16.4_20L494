...
- (void).cxx_destruct;	// IMP=0x0020000000104fd6
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x001000000010492c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010483a
- (id)initWithEntityClass:(Class)arg1;	// IMP=0x001000000010479b
