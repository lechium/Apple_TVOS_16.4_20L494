...
- (void).cxx_destruct;	// IMP=0x00200000000a3ba0
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000000a37c4
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000000a34e6
- (void)open;	// IMP=0x00100000000a349a
- (void)close;	// IMP=0x00100000000a3438
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x00100000000a3181
