...
- (void).cxx_destruct;	// IMP=0x002000000015a22a
...
- (void)updateLogKey;	// IMP=0x001000000015a045
@property(readonly, getter=isUserInitiated) _Bool userInitiated;
- (void)updateGeneratedProperties;	// IMP=0x0010000000159ca1
- (id)init;	// IMP=0x0010000000159c39
