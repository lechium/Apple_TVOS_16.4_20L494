...
- (void).cxx_destruct;	// IMP=0x0020000000002f02
...
- (void)run;	// IMP=0x00100000000028e2
- (void)ensureSlotWatcherIsRunning;	// IMP=0x001000000000285d
- (id)initWithArgc:(int)arg1 argv:(const char **)arg2;	// IMP=0x001000000000261b
...
- (void)initializeSandBox;	// IMP=0x0010000000002501
