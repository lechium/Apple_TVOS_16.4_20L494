...
+ (_Bool)handleConnection:(id)arg1 server:(id)arg2;	// IMP=0x002000000000b9d5
- (void).cxx_destruct;	// IMP=0x002000000000bf8d
...
- (void)addSlotWithEndpoint:(id)arg1 name:(id)arg2 type:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x001000000000ba9f
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x001000000000b943
