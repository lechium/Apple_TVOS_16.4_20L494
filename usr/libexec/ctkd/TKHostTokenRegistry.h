...
+ (id)bundleIdentifierFromAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x002000000000345e
...
- (void)registerClassIDs:(id)arg1;	// IMP=0x00100000000060d3
- (id)reloadTokenClassesFromStore;	// IMP=0x0010000000005494
- (void)loadTokensFromStore:(id)arg1;	// IMP=0x00100000000046d5
- (id)createTokenWithTokenID:(id)arg1 persistent:(_Bool)arg2;	// IMP=0x00100000000044b7
- (void)notifyTokenReinsertion:(id)arg1;	// IMP=0x00100000000043a8
- (void)removeTokenWithTokenID:(id)arg1;	// IMP=0x001000000000415a
- (id)tokenWithTokenID:(id)arg1;	// IMP=0x0010000000004091
- (void)commitTransaction;	// IMP=0x0010000000003b8a
- (void)markModified;	// IMP=0x0000000000003b58
@property(readonly, nonatomic) NSDictionary *tokenExtensions;
- (id)beginTransaction;	// IMP=0x0010000000003a31
@property(readonly, nonatomic) NSArray *tokens;
- (void)dealloc;	// IMP=0x001000000000398b
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003801
- (id)initWithDriverCache:(id)arg1 listener:(id)arg2 keychain:(id)arg3;	// IMP=0x00100000000032d6
