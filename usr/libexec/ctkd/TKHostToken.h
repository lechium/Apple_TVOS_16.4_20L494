...
+ (id)keychainItemClasses;	// IMP=0x0020000000002045
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000017c7
- (void).cxx_destruct;	// IMP=0x0020000000002499
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000022b4
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000217b
- (id)connectionWithError:(id *)arg1;	// IMP=0x00100000000019c0
- (id)description;	// IMP=0x00100000000018e9
- (id)initWithTokenID:(id)arg1 persistent:(_Bool)arg2;	// IMP=0x00100000000017cf
