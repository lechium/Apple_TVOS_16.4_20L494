...
- (void).cxx_destruct;	// IMP=0x002000000000ffbf
...
- (id)pairingNotification:(id *)arg1;	// IMP=0x001000000000ff6c
- (void)stop;	// IMP=0x001000000000fe0c
- (void)start;	// IMP=0x001000000000fd07
- (void)dealloc;	// IMP=0x001000000000fca2
- (id)initWithTokenServer:(id)arg1 tokenRegistry:(id)arg2;	// IMP=0x001000000000faef
- (void)hostTokenRegistry:(id)arg1 removedToken:(id)arg2;	// IMP=0x001000000000f7e4
- (void)hostTokenRegistry:(id)arg1 addedToken:(id)arg2;	// IMP=0x001000000000f1cf
- (void)getEndpoint:(CDUnknownBlockType)arg1;	// IMP=0x001000000000f162
- (void)startWatchingWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ead1
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000000e846
