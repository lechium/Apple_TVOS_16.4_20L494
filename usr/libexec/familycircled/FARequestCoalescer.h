...
+ (id)sharedInstance;	// IMP=0x0040000000014e09
- (void).cxx_destruct;	// IMP=0x0020000000015450
...
- (id)performBlockForKey:(id)arg1 force:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0010000000014ef7
- (id)init;	// IMP=0x0010000000014e5e
