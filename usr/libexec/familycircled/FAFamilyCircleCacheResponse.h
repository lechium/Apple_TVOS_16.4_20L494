...
- (void).cxx_destruct;	// IMP=0x0020000000015790
...
- (_Bool)_isFamilyCircleFresh:(id)arg1;	// IMP=0x00100000000156ac
@property(readonly, nonatomic) NSDate *expiration;
- (_Bool)isFamilyCircleFresh;	// IMP=0x00100000000155e9
- (id)familyCircleValidatingAgeWithDate:(id)arg1;	// IMP=0x00100000000155a5
- (id)familyCircleIfFresh;	// IMP=0x001000000001553f
- (id)initWithFamilyCircle:(id)arg1 serverTag:(id)arg2 cacheDate:(id)arg3 maxAge:(double)arg4;	// IMP=0x0010000000015478
