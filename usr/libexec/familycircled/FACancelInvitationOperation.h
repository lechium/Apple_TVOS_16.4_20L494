...
- (void).cxx_destruct;	// IMP=0x0020000000010776
...
- (id)cancelInvitation;	// IMP=0x001000000001052a
- (id)initWithNetworkService:(id)arg1 email:(id)arg2 familyID:(id)arg3;	// IMP=0x0010000000010480
