...
- (void).cxx_destruct;	// IMP=0x002000000001042d
...
- (void)_addBodyToRequest:(id)arg1;	// IMP=0x001000000001018e
- (void)_addHeadersToRequest:(id)arg1;	// IMP=0x001000000000ff5f
- (id)updateMemberFlags;	// IMP=0x001000000000fab6
- (id)initWithNetworkService:(id)arg1 grandSlamSigner:(id)arg2 familyGrandSlamSigner:(id)arg3 memberDSID:(id)arg4 flags:(id)arg5;	// IMP=0x001000000000f9c0
