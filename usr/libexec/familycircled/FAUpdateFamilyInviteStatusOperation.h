...
- (id)updateInviteStatus;	// IMP=0x0010000000004c9f
- (id)initWithNetworkService:(id)arg1 inviteCode:(id)arg2 inviteStatus:(long long)arg3 requestUrl:(id)arg4;	// IMP=0x0010000000004be4
