...
- (void).cxx_destruct;	// IMP=0x0020000000001fc6
...
- (id)removeMember;	// IMP=0x0010000000001dc2
- (id)initWithNetworkService:(id)arg1 dsidOfMemberToRemove:(id)arg2;	// IMP=0x0010000000001d4a
