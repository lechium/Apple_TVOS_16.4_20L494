...
+ (id)errorWithCachedFamilyCircle:(id)arg1 underlyingError:(id)arg2;	// IMP=0x004000000000a122
- (void).cxx_destruct;	// IMP=0x002000000000a2bd
...
- (id)initWithCachedFamilyCircle:(id)arg1 underlyingError:(id)arg2;	// IMP=0x001000000000a192
