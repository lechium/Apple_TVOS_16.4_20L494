...
- (void).cxx_destruct;	// IMP=0x002000000001a9b8
@property(copy, nonatomic) NSString *pushTopic; // @synthesize pushTopic=_pushTopic;
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001a928
- (_Bool)_booleanValueOfObject:(id)arg1;	// IMP=0x001000000001a8b6
- (id)description;	// IMP=0x001000000001a821
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x001000000001a3ff
