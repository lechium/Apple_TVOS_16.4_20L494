...
- (void).cxx_destruct;	// IMP=0x002000000000bc4f
...
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000000b998
- (id)initWithMessage:(id)arg1 accountStore:(id)arg2;	// IMP=0x001000000000b7d6
