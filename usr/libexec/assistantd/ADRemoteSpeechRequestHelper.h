...
- (void).cxx_destruct;	// IMP=0x002000000011b6a5
...
- (void)reset;	// IMP=0x001000000011b643
- (id)setSpeechRequestOptions:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000011b584
