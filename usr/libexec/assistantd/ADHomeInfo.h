...
- (void).cxx_destruct;	// IMP=0x00200000001a774d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a7673
- (unsigned long long)hash;	// IMP=0x00100000001a75c2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a751d
- (id)description;	// IMP=0x00100000001a743f
