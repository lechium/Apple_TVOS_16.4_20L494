...
- (void).cxx_destruct;	// IMP=0x002000000021b619
...
- (id)dictionaryRepresentation;	// IMP=0x001000000021b555
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 RSSI:(id)arg3 state:(id)arg4;	// IMP=0x001000000021b473
