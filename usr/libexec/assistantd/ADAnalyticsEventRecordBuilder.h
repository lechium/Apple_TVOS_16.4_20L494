...
- (void).cxx_destruct;	// IMP=0x002000000010fd69
- (id)build;	// IMP=0x001000000010fb40
- (void)setValue:(id)arg1 forColumnName:(id)arg2;	// IMP=0x001000000010f9cd
- (void)reset;	// IMP=0x001000000010f947
