...
- (void).cxx_destruct;	// IMP=0x00200000000afb36
- (void)setIncrementalChanges:(id)arg1;	// IMP=0x00100000000afb16
- (id)getIncrementalChanges;	// IMP=0x00100000000afade
- (_Bool)isDirty;	// IMP=0x00100000000afad3
- (id)initWithBase:(id)arg1;	// IMP=0x00100000000afa68
