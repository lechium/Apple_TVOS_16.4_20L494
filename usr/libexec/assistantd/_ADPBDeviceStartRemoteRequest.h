...
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000a3fdb
- (void).cxx_destruct;	// IMP=0x00100000001b4cb6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001b4b0a
- (unsigned long long)hash;	// IMP=0x00100000001b4a33
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001b4897
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001b475d
- (void)copyTo:(id)arg1;	// IMP=0x00100000001b467a
- (void)writeTo:(id)arg1;	// IMP=0x00100000001b45a1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001b4594
- (id)dictionaryRepresentation;	// IMP=0x00100000001b4195
- (id)description;	// IMP=0x00100000001b40e6
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c0ff5
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000012ed95
