...
- (void).cxx_destruct;	// IMP=0x00200000001fa9a4
- (void)setSnapshot:(id)arg1;	// IMP=0x00100000001fa984
- (id)getSnapshot;	// IMP=0x00100000001fa94c
- (_Bool)isDirty;	// IMP=0x00100000001fa941
- (id)initWithBase:(id)arg1;	// IMP=0x00100000001fa8d6
