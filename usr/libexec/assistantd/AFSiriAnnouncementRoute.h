...
- (void).cxx_destruct;	// IMP=0x0020000000095ba2
...
- (long long)_announcementPlatform;	// IMP=0x0010000000095ae7
- (_Bool)_isHearingAidsRoute;	// IMP=0x0010000000095adf
- (_Bool)_isBuiltInSpeakerRoute;	// IMP=0x0010000000095ad7
- (unsigned long long)_getRouteCapabilities;	// IMP=0x0010000000095acf
- (void)_initializeInternalState;	// IMP=0x0010000000095ac9
- (id)initWithRouteDescription:(id)arg1 hearingAidsAnnounceEnabled:(_Bool)arg2 builtInSpeakerAnnounceEnabled:(_Bool)arg3;	// IMP=0x0010000000095a9a
