...
+ (id)sharedDiagnostics;	// IMP=0x00400000001b2032
- (void).cxx_destruct;	// IMP=0x00200000001b39ad
...
- (unsigned long long)_AWDTimestampTruncatedToHourPrecision;	// IMP=0x00100000001b38c0
- (double)_currentTime;	// IMP=0x00100000001b3869
- (void)_submitMetricWithIdentifier:(unsigned int)arg1 hotShipIdentifier:(unsigned int)arg2 hotShipTimestamp:(unsigned long long)arg3 generation:(CDUnknownBlockType)arg4;	// IMP=0x00100000001b371b
- (void)_submitMetricWithIdentifier:(unsigned int)arg1 generation:(CDUnknownBlockType)arg2;	// IMP=0x00100000001b3628
...
- (unsigned long long)_durationInMillisecondsFromTime:(double)arg1 toTime:(double)arg2;	// IMP=0x00100000001b35db
- (void)logSpeechRecognized;	// IMP=0x00100000001b32ff
- (void)logNetworkAnalyzeRunWithResults:(id)arg1;	// IMP=0x00100000001b3129
- (void)logVoiceSendEnd;	// IMP=0x00100000001b2e9a
- (void)logVoiceSendStart;	// IMP=0x00100000001b2ce3
- (void)logVoiceRecordingEnd;	// IMP=0x00100000001b2a54
- (void)logVoiceRecordingStart;	// IMP=0x00100000001b289d
- (void)logConnectionFailedWithError:(id)arg1 connectionType:(long long)arg2;	// IMP=0x00100000001b262a
- (void)logConnectionOpenWithConnectionType:(long long)arg1;	// IMP=0x00100000001b23c8
- (void)logConnectionStart;	// IMP=0x00100000001b2211
- (void)flush;	// IMP=0x00100000001b21cf
- (id)init;	// IMP=0x00100000001b2087
