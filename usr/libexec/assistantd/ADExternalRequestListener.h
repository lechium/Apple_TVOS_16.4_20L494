...
- (void).cxx_destruct;	// IMP=0x00200000000f9296
- (void)listen;	// IMP=0x00100000000f9075
- (id)initWithInstanceContext:(id)arg1;	// IMP=0x00100000000f8fe6
- (id)init;	// IMP=0x00100000000f8f8c
