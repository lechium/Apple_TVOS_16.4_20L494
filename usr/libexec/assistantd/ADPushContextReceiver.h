...
- (void).cxx_destruct;	// IMP=0x002000000025a931
- (oneway void)sendContext:(id)arg1;	// IMP=0x001000000025a81f
- (id)initWithCollector:(id)arg1 pid:(int)arg2 connection:(id)arg3;	// IMP=0x001000000025a782
