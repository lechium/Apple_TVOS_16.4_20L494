...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x00200000000f27d8
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000a3fd0
- (void).cxx_destruct;	// IMP=0x00100000000f586c
...
- (void)setAssistantId:(id)arg1;	// IMP=0x00100000000f5583
- (id)assistantId;	// IMP=0x00100000000f5572
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000f5041
- (unsigned long long)hash;	// IMP=0x00100000000f4cba
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f4694
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f40ce
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f3ce5
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f3891
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f3884
- (id)dictionaryRepresentation;	// IMP=0x00100000000f29b5
- (id)description;	// IMP=0x00100000000f2906
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000f27bb
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x00100000000f279e
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x00100000000f2734
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x00100000000f2717
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c10cc
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000012eb89
