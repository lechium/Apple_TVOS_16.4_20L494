...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000149cab
- (void).cxx_destruct;	// IMP=0x0020000000149f30
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000149d61
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000149cb3
