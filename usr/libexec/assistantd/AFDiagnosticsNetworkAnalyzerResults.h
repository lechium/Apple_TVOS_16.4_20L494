...
- (void).cxx_destruct;	// IMP=0x00200000001b3b1e
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00100000001b3f71
- (id)metricValue;	// IMP=0x00100000001b3b88
