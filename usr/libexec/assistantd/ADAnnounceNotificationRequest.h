...
- (long long)_announceNotificationRequestTypeForNotification:(id)arg1 appID:(id)arg2 platform:(long long)arg3;	// IMP=0x0010000000086619
- (id)initWithNotification:(id)arg1 appID:(id)arg2 platform:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000086525
