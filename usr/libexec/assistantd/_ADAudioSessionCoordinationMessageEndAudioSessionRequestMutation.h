...
- (void).cxx_destruct;	// IMP=0x00200000000ae7a1
- (void)setEffectiveDate:(id)arg1;	// IMP=0x00100000000ae781
- (id)getEffectiveDate;	// IMP=0x00100000000ae749
- (_Bool)isDirty;	// IMP=0x00100000000ae73e
- (id)initWithBase:(id)arg1;	// IMP=0x00100000000ae6d3
