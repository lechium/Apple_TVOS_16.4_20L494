...
- (void).cxx_destruct;	// IMP=0x00200000000afe96
...
- (void)dealloc;	// IMP=0x00100000000afd98
- (void)completeRequestWithSuccess:(_Bool)arg1 forReason:(long long)arg2 shouldEmitInstrumentationEvent:(_Bool)arg3;	// IMP=0x00100000000afd40
- (id)initWithAnnouncementRequestType:(unsigned long long)arg1 platform:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000afc63
