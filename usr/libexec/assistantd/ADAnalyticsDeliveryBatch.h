...
- (void).cxx_destruct;	// IMP=0x00200000001e3412
...
- (id)analyticsDictionary;	// IMP=0x00100000001e3123
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x00100000001e3115
- (void)markSucceeded;	// IMP=0x00100000001e310b
- (void)markEndTime;	// IMP=0x00100000001e30d2
- (void)markStartTime;	// IMP=0x00100000001e3099
- (_Bool)hasFailureType;	// IMP=0x00100000001e308b
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x00100000001e300c
