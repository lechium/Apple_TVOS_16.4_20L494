...
- (void).cxx_destruct;	// IMP=0x00200000000d81d8
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00100000000d7e9d
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00100000000d7ba8
- (void)dealloc;	// IMP=0x00100000000d78e0
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00100000000d77d5
- (id)init;	// IMP=0x00100000000d77c7
