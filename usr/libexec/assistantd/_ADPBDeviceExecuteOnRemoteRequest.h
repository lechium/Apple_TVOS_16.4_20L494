...
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00200000000a3fe6
- (void).cxx_destruct;	// IMP=0x00100000000f8580
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000f8449
- (unsigned long long)hash;	// IMP=0x00100000000f83c5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f8299
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f81af
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f810c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f8075
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f8068
- (id)dictionaryRepresentation;	// IMP=0x00100000000f7daf
- (id)description;	// IMP=0x00100000000f7d00
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c1160
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000012eeab
