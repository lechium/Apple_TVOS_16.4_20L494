...
- (void).cxx_destruct;	// IMP=0x00200000000896b2
- (void)setDataType:(id)arg1;	// IMP=0x0010000000089692
- (id)getDataType;	// IMP=0x001000000008965a
- (_Bool)isDirty;	// IMP=0x001000000008964f
- (id)initWithBase:(id)arg1;	// IMP=0x00100000000895e4
