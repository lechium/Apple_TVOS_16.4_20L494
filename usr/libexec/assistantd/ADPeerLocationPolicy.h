...
- (void).cxx_destruct;	// IMP=0x00200000001bb83f
...
- (void)_resetTimer;	// IMP=0x00100000001bb69d
- (void)_cancelTimer;	// IMP=0x00100000001bb667
- (void)locationPeerDidChange;	// IMP=0x00100000001bb5c6
- (void)locationDataWasRecievedFromPeer;	// IMP=0x00100000001bb565
- (id)init;	// IMP=0x00100000001bb4ce
