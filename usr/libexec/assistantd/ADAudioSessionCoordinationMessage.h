...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000002b4fdd
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00100000002b488a
- (void).cxx_destruct;	// IMP=0x00100000002b5a04
...
- (id)buildDictionaryRepresentation;	// IMP=0x00100000002b577b
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000002b5360
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000002b5223
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000002b4fe5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002b4fd2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002b4d3b
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x00100000002b4b57
@property(readonly, copy) NSString *description;
- (id)initWithHostTime:(unsigned long long)arg1 type:(long long)arg2 payloadBeginAudioSessionRequest:(id)arg3 payloadBeginAudioSessionResponse:(id)arg4 payloadKeepAudioSessionAliveRequest:(id)arg5 payloadKeepAudioSessionAliveResponse:(id)arg6 payloadEndAudioSessionRequest:(id)arg7 payloadEndAudioSessionResponse:(id)arg8;	// IMP=0x00100000002b48eb
- (id);	// IMP=0x00100000002b48d7
- (id)initWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00100000002b461c
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x00100000002b5d9f
