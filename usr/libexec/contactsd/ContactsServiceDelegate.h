...
+ (id)os_log;	// IMP=0x002000000000977f
- (void).cxx_destruct;	// IMP=0x0020000000009d73
...
- (_Bool)isClientAuthorizedAccessWithAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x0010000000009b25
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000099cf
- (id)initWithServiceProvider:(CDUnknownBlockType)arg1 schedulerProvider:(id)arg2 tccServices:(id)arg3;	// IMP=0x00100000000098d9
