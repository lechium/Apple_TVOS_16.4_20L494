...
- (void).cxx_destruct;	// IMP=0x002000000004b27b
...
- (id)eventStatusesByPayloadIdentifierSinceStartDate:(id)arg1 organizationIdentifier:(id)arg2;	// IMP=0x001000000004b015
- (_Bool)setEventSubscriptionRegistrations:(id)arg1 error:(id *)arg2;	// IMP=0x001000000004aa07
- (id)init;	// IMP=0x001000000004a9b1
