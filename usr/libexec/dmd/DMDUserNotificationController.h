...
+ (id)sharedController;	// IMP=0x002000000007202a
- (void).cxx_destruct;	// IMP=0x002000000007305c
...
- (void)_notificationRef:(struct __CFUserNotification *)arg1 wasDismissedWithFlags:(unsigned long long)arg2;	// IMP=0x0010000000072d5c
- (void)_completeNotification:(id)arg1 response:(unsigned long long)arg2;	// IMP=0x0010000000072baf
- (void)_showNextNotification;	// IMP=0x00100000000727dd
- (id)_dictFromNotification:(id)arg1;	// IMP=0x00100000000725fe
- (void)showNotification:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000072179
- (id)initPrivate;	// IMP=0x00100000000720bf
