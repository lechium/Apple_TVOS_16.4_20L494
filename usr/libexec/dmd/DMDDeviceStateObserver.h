...
- (void)networkDidChange;	// IMP=0x001000000003b656
- (void)keybagLockStateDidChange;	// IMP=0x001000000003b61e
- (void)stopObservingChanges;	// IMP=0x001000000003b5e6
- (void)startObservingChanges;	// IMP=0x001000000003b44f
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x001000000003b36f
