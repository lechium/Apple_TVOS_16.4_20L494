...
- (void).cxx_destruct;	// IMP=0x002000000000e129
...
- (id)calendarForIdentifier:(id)arg1;	// IMP=0x001000000000de38
- (void)reportActivationPredicateObserverDidTrigger;	// IMP=0x001000000000dd66
- (id)metadata;	// IMP=0x001000000000dc4f
- (void)invalidate;	// IMP=0x001000000000dc3b
- (void)updateObserverRegistration;	// IMP=0x001000000000dc35
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000dc2d
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 predicate:(id)arg3;	// IMP=0x001000000000db2b
