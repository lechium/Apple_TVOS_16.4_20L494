...
+ (id)sharedServer;	// IMP=0x0020000000068f41
- (void).cxx_destruct;	// IMP=0x00200000000691d2
...
- (void)invalidate;	// IMP=0x00100000000690a9
- (void)run;	// IMP=0x0010000000068f96
- (id)init;	// IMP=0x0010000000068c4f
