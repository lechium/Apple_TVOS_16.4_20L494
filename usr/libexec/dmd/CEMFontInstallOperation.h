...
- (void).cxx_destruct;	// IMP=0x00200000000059c9
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000005935
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x001000000000562f
...
- (void)main;	// IMP=0x001000000000546a
- (_Bool)isAsynchronous;	// IMP=0x0010000000005462
- (id)initWithFontDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x00100000000053c0
