...
- (void).cxx_destruct;	// IMP=0x002000000004a693
...
- (id);	// IMP=0x001000000004a675
- (void)_dispatchToListenerForKey:(id)arg1 inMap:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000004a46b
- (void)_registerListener:(id)arg1 forKeys:(id)arg2 inMap:(id)arg3;	// IMP=0x001000000004a204
- (void)_registerEventStreamHandlers;	// IMP=0x0010000000049a61
- (id)initWithListeners:(id)arg1;	// IMP=0x0010000000049700
