...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000669d8
- (void).cxx_destruct;	// IMP=0x0020000000066c43
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000066b2b
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000669e0
