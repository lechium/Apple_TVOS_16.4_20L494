...
- (void).cxx_destruct;	// IMP=0x00200000000496b7
...
- (void)startWithScheduleElapsedHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000049482
- (unsigned long long)hash;	// IMP=0x0010000000049349
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000490f8
- (id)description;	// IMP=0x0010000000049045
- (void)dealloc;	// IMP=0x0010000000049003
- (id)initWithScheduleRegistration:(id)arg1;	// IMP=0x0010000000048d28
