...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000006a496
- (void).cxx_destruct;	// IMP=0x002000000006aa12
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000006a76a
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000006a49e
