...
- (void).cxx_destruct;	// IMP=0x0020000000071fd6
...
- (id);	// IMP=0x0010000000071f63
@property(copy, nonatomic) NSString *message; // @synthesize message=_message;
@property(copy, nonatomic) NSString *header; // @synthesize header=_header;
@property(readonly, copy, nonatomic) NSUUID *identifier; // @synthesize identifier=_identifier;
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x0010000000071eed
- (struct __CFUserNotification *)notificationRef;	// IMP=0x0010000000071ee3
- (void)dealloc;	// IMP=0x0010000000071ea4
- (id)init;	// IMP=0x0010000000071e42
