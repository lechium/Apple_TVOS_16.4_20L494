...
- (void).cxx_destruct;	// IMP=0x002000000000b08a
...
- (id)_nextDateAfter:(id)arg1 matchingWeekday:(long long)arg2 hour:(long long)arg3 minute:(long long)arg4 second:(long long)arg5 inCalendar:(id)arg6;	// IMP=0x001000000000adf9
- (id)_datesForNextCurfewBoundary;	// IMP=0x001000000000a919
- (void)_registerPredicateObserver;	// IMP=0x001000000000a45c
- (_Bool)_extractComponentsFromPredicate:(id)arg1;	// IMP=0x0010000000009b23
- (id)metadata;	// IMP=0x00100000000099f2
- (void)updateObserverRegistration;	// IMP=0x00100000000099e0
- (void)invalidate;	// IMP=0x0010000000009824
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x0010000000009287
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 curfewPredicate:(id)arg3;	// IMP=0x0010000000009196
