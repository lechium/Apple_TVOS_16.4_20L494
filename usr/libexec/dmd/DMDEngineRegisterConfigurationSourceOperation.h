...
- (void).cxx_destruct;	// IMP=0x0020000000047146
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x0010000000046fa2
- (void)main;	// IMP=0x0010000000046739
