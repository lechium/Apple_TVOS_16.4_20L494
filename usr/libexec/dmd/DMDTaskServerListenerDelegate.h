...
- (void).cxx_destruct;	// IMP=0x002000000006ff0f
@property(readonly, nonatomic) CATTaskServer *taskServer; // @synthesize taskServer=_taskServer;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000006fe0b
- (id)initWithTaskServer:(id)arg1;	// IMP=0x001000000006fda0
