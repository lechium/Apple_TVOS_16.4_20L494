...
- (void).cxx_destruct;	// IMP=0x002000000004a97e
...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x001000000004a833
- (id)description;	// IMP=0x001000000004a796
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x001000000004a6c6
