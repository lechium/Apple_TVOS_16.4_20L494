...
- (void).cxx_destruct;	// IMP=0x002000000000671d
...
- (void)main;	// IMP=0x00100000000065aa
- (id)initWithImageDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0010000000006508
