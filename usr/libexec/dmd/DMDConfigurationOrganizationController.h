...
- (void).cxx_destruct;	// IMP=0x0020000000033e5a
...
- (void)resolveAssetWithContext:(id)arg1;	// IMP=0x0010000000033cb1
- (void)configurationSourceController:(id)arg1 fetchEventsWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000033af4
- (void)configurationSourceController:(id)arg1 fetchStatusUpdatesWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000033937
- (void)unregisterConfigurationSource:(id)arg1;	// IMP=0x00100000000338a7
- (id)registerConfigurationSource:(id)arg1;	// IMP=0x00100000000336bf
- (id)configurationSourceWithIdentifier:(id)arg1;	// IMP=0x00100000000335ef
...
- (void)updateWithOrganization:(id)arg1;	// IMP=0x0010000000032b04
- (id)initWithOrganization:(id)arg1 delegate:(id)arg2;	// IMP=0x0010000000032a0e
