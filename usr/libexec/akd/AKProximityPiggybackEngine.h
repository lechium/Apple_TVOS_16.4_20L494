...
- (void).cxx_destruct;	// IMP=0x00200000000674c0
...
- (void)invalidate;	// IMP=0x0010000000067442
- (void)activate;	// IMP=0x00100000000673f6
- (void)prepareWithController:(id)arg1 queue:(id)arg2;	// IMP=0x00100000000673b6
- (void)dealloc;	// IMP=0x001000000006733d
- (id)initWithPresenceSID:(id)arg1;	// IMP=0x00100000000672d2
