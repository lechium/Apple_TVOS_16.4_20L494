...
@interface AKAuthenticationServerResponse : NSObject
{
    ...
    NSNumber *_canBeBeneficiary;	// 320 = 0x140
    NSString *_beneficiaryIdentifier;	// 328 = 0x148
    MISSING_TYPE *_beneficiaryWrappedKey;	// 336 = 0x150
...
+ (id)decodedConfigurationInfo:(id)arg1;	// IMP=0x004000000000b832
- (void).cxx_destruct;	// IMP=0x002000000000f16c
...
- (id)_numberFormatter;	// IMP=0x001000000000edaa
- (id)_decodeBase64String:(id)arg1;	// IMP=0x001000000000ed21
- (void)_updateDSIDWithRawValue:(id)arg1;	// IMP=0x001000000000ec20
- (_Bool)updateWithSecondaryAuthenticationResponse:(id)arg1 shouldUpdateDSID:(_Bool)arg2;	// IMP=0x001000000000dda8
- (_Bool)updateWithSecondaryAuthenticationResponse:(id)arg1;	// IMP=0x001000000000dd94
- (void)_updateAccountInformationWithResultsDictionary:(id)arg1;	// IMP=0x001000000000d91e
- (void)updateWithSecondaryAuthenticationBody:(id)arg1;	// IMP=0x001000000000d86b
@property(readonly, nonatomic) _Bool isUpdateable;
- (void)_setHeartbeatToken:(id)arg1;	// IMP=0x001000000000d840
@property(readonly, nonatomic) AKToken *inheritanceBeneficiarySetupToken;
@property(readonly, nonatomic) AKToken *heartbeatToken;
- (void)_setPasswordEquivalentToken:(id)arg1;	// IMP=0x000000000000d7e9
@property(readonly, nonatomic) AKToken *passwordEquivalentToken;
- (void)_harvestManagedAppleIDInfoFromDictionary:(id)arg1;	// IMP=0x001000000000d4bc
- (void)_harvestCommonFieldsFromBody:(id)arg1;	// IMP=0x001000000000cf60
- (void)_harvestCommonFieldsFromResponse:(id)arg1;	// IMP=0x001000000000ccb9
- (id)initWithServerResponse:(id)arg1 responseBody:(id)arg2;	// IMP=0x001000000000cc01
- (id)initWithServerResponse:(id)arg1 forAppleID:(id)arg2;	// IMP=0x001000000000cb4e
- (id)_federatedPayloadFromInfo:(id)arg1;	// IMP=0x001000000000ca73
- (id)initWithSRPContext:(id)arg1;	// IMP=0x001000000000ba0f
