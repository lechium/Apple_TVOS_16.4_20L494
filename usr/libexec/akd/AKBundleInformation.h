...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000669d0
- (void).cxx_destruct;	// IMP=0x0020000000066a0a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006692d
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000066749
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000006666e
- (id)initWithBundleIdentifier:(id)arg1 bundleName:(id)arg2 bundleDescription:(id)arg3 bundleType:(unsigned long long)arg4 otherInfo:(id)arg5;	// IMP=0x001000000006658b
