...
+ (id)queryWithString:(id)arg1;	// IMP=0x004000000009b780
- (void).cxx_destruct;	// IMP=0x002000000009bd9b
...
- (CDUnknownBlockType);	// IMP=0x001000000009bd69
@property(nonatomic) _Bool bindingFailure; // @synthesize bindingFailure=_bindingFailure;
@property(copy, nonatomic) NSString *queryString; // @synthesize queryString=_queryString;
- (_Bool)_bindStatement:(struct sqlite3_stmt *)arg1 withParameter:(id)arg2 atPosition:(int)arg3;	// IMP=0x001000000009bc49
- (void)bindParameters:(id)arg1 error:(id *)arg2;	// IMP=0x001000000009b9c7
- (void)bindParameter:(id)arg1 error:(id *)arg2;	// IMP=0x001000000009b7d6
