...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000038f78
- (void).cxx_destruct;	// IMP=0x00200000000390fe
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000038f80
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000038f05
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000038e66
