...
- (void)_decrementQueueSize;	// IMP=0x001000000001b648
- (_Bool)_incrementQueueSize;	// IMP=0x001000000001b627
- (void)_incrementCounter;	// IMP=0x001000000001b610
@property(readonly, copy) NSString *debugDescription;
- (id)nextCalculation;	// IMP=0x001000000001b3ed
- (id)initWithBase:(double)arg1 maxQueueSize:(unsigned long long)arg2;	// IMP=0x001000000001b3a1
