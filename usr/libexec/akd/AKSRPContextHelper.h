...
- (void).cxx_destruct;	// IMP=0x00200000000a6503
...
- (_Bool)eligibleForContinuationKeyAuthentication;	// IMP=0x00100000000a6362
@property(readonly, nonatomic) NSString *passwordResetToken;
@property(readonly, nonatomic) NSString *continuationToken;
- (void)clearContinuationTokenIfSupported;	// IMP=0x00100000000a5e73
- (void)_addExperimentalFeaturesInfoToClientProvidedData:(id)arg1;	// IMP=0x00100000000a5ce3
- (void)authenticationParametersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000a4229
@property(readonly, nonatomic, getter=isContextSecretValidForSRP) _Bool contextSecretValidForSRP;
- (id)initWithContext:(id)arg1;	// IMP=0x00100000000a417b
