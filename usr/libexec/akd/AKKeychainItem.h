...
- (void).cxx_destruct;	// IMP=0x002000000001be0e
...
- (id)itemAttributes;	// IMP=0x001000000001bd24
- (id)initWithAttributes:(id)arg1;	// IMP=0x001000000001bc68
- (id)initWithDescriptor:(id)arg1 value:(id)arg2;	// IMP=0x001000000001bbcf
