...
- (void)_handleFoundDevice:(id)arg1;	// IMP=0x0010000000057d41
- (void)authorizationEndorserRapportClientDidFinish:(id)arg1;	// IMP=0x0010000000057d2f
- (void)deactivate;	// IMP=0x0010000000057ca1
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x0010000000057c29
- (id)initWithClient:(id)arg1;	// IMP=0x0010000000057bbe
