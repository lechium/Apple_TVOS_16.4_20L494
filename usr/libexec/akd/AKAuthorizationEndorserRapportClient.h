...
- (void).cxx_destruct;	// IMP=0x0020000000074c36
...
- (void)_sendDidStartServerAuthorizationEvent;	// IMP=0x00100000000748a6
- (void)_sendAuthorizationDidFinishRequestWithError:(id)arg1;	// IMP=0x001000000007441e
- (void)_sendAuthorizationDidFinishRequestWithAuthorization:(id)arg1;	// IMP=0x0010000000073fe8
- (void)_handleStartAuthorizationWithResponse:(id)arg1;	// IMP=0x0010000000073bf6
- (void)_sendStartAuthorizationRequest;	// IMP=0x0010000000073855
- (void)_deactivate;	// IMP=0x00100000000737df
- (void)authorizationDaemonServiceWillProcessUserResponse:(id)arg1;	// IMP=0x00100000000737cd
- (void)startAuthorizationWithCompanionLinkClient:(id)arg1;	// IMP=0x00100000000735b4
- (void)startAuthorization;	// IMP=0x0010000000073569
- (id)initWithDeviceID:(id)arg1;	// IMP=0x00100000000734cd
