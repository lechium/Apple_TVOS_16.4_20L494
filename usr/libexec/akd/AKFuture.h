...
- (id)value;	// IMP=0x001000000005fe92
- (void)setValue:(id)arg1;	// IMP=0x001000000005fe0e
- (id)initWithMaxWait:(double)arg1 description:(id)arg2;	// IMP=0x001000000005fd20
- (id)init;	// IMP=0x001000000005fd09
