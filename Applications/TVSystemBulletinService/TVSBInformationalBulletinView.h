...
+ (unsigned long long)_footerLayoutForItem:(id)arg1;	// IMP=0x0020000000013e50
+ (unsigned long long)_contentLayoutForItem:(id)arg1;	// IMP=0x0010000000013e00
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000013320
