...
- (void)_updateEffect;	// IMP=0x0010000000019d90
- (void)_updateCameraViewConstraints;	// IMP=0x00100000000194a0
- (void)_updateAudioStream:(_Bool)arg1;	// IMP=0x00100000000191a0
- (_Bool)_shouldDisplayErrorContent;	// IMP=0x0010000000019030
- (_Bool)_shouldDisplayAccessModeErrorContent;	// IMP=0x0010000000018eb0
- (void)_updateContentViews;	// IMP=0x0010000000018a10
- (void)_updateCameraNameLabels;	// IMP=0x0010000000018480
- (void)cameraUserSettingsDidUpdate:(id)arg1;	// IMP=0x0010000000018430
- (void)cameraStreamControl:(id)arg1 didStopStreamWithError:(id)arg2;	// IMP=0x0010000000018090
- (void)cameraStreamControlDidStartStream:(id)arg1;	// IMP=0x0010000000017a00
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000017920
- (void)stopStream;	// IMP=0x00100000000178d0
- (void)startStreamIfNecessary;	// IMP=0x00100000000177b0
- (void)setLiveBadgeViewHidden:(_Bool)arg1;	// IMP=0x0010000000017760
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000014140
