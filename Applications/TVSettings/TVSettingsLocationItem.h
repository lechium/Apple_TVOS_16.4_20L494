...
+ (id)allowedSystemServices;	// IMP=0x004000000007d216
- (void).cxx_destruct;	// IMP=0x002000000007dbd8
...
- (id)initWithInfo:(id)arg1 identifier:(id)arg2;	// IMP=0x001000000007d2f1
- (id)init;	// IMP=0x001000000007d2db
