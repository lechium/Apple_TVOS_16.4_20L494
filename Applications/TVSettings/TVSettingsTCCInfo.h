...
+ (_Bool)automaticallyNotifiesObserversOfAllowAccess;	// IMP=0x00400000000996dd
+ (id)infoWithFacade:(id)arg1 identifier:(id)arg2 allowed:(_Bool)arg3;	// IMP=0x0010000000099524
- (void).cxx_destruct;	// IMP=0x0020000000099718
