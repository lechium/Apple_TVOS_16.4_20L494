...
- (void).cxx_destruct;	// IMP=0x0020000000097d31
...
- (void)signInFlowController:(id)arg1 presentGenericTermsUIForAccount:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000095d24
- (void)suggestedUserProfileManagerDidUpdate:(id)arg1;	// IMP=0x0010000000095c80
- (void)userProfileManagerDidUpdate:(id)arg1;	// IMP=0x0010000000095bdc
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000000958be
- (void)suppressSuggestedUserWithIdentifier:(id)arg1;	// IMP=0x00100000000957f9
- (void)switchSelectedUserToUser:(id)arg1;	// IMP=0x00100000000953b8
- (void)addGuestUserManuallyWithPresentingViewController:(id)arg1;	// IMP=0x0010000000094b10
- (void)addPrimaryUserManuallyWithPresentingViewController:(id)arg1;	// IMP=0x001000000009474b
...
- (void)dealloc;	// IMP=0x00100000000945aa
- (id)init;	// IMP=0x0010000000094596
- (id)initWithFollowUpController:(id)arg1;	// IMP=0x0010000000093bf6
