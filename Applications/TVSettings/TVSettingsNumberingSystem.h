...
- (void).cxx_destruct;	// IMP=0x00200000000c32ff
...
- (unsigned long long)hash;	// IMP=0x00100000000c3275
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c3171
- (id)initWithLocaleIdentifier:(id)arg1 displayName:(id)arg2 shortDisplayName:(id)arg3 isSelected:(_Bool)arg4;	// IMP=0x00100000000c3081
