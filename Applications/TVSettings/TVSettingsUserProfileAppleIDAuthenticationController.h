...
- (void).cxx_destruct;	// IMP=0x002000000007e28b
...
- (void)authenticateWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000007dc9b
- (id)initWithUserProfileAuthenticationType:(long long)arg1;	// IMP=0x001000000007dc2c
