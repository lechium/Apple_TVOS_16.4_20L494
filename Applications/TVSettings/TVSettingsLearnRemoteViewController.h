...
@interface TVSettingsLearnRemoteViewController : UIViewController
{
    ...
    MISSING_TYPE *_instructionLabel;	// 40 = 0x28
...
- (void).cxx_destruct;	// IMP=0x00200000000a0e8a
...
- (void)_setAppearanceFor:(id)arg1 selected:(_Bool)arg2;	// IMP=0x00100000000a09a7
- (id)_buildActionImageViews;	// IMP=0x001000000009ff64
- (void)_configureButtonStackForAction:(int)arg1;	// IMP=0x001000000009fd52
- (void)_learnNextAction:(id)arg1;	// IMP=0x001000000009fcb0
- (void)_learnPreviousAction:(id)arg1;	// IMP=0x001000000009fc0e
- (void)_updateProgressViewWithProgress:(double)arg1 animated:(_Bool)arg2;	// IMP=0x001000000009fb78
- (void)_hideProgressView;	// IMP=0x001000000009faed
- (void)irLearningManager:(id)arg1 didFinishLearningAction:(int)arg2;	// IMP=0x001000000009f6b7
- (void)irLearningManager:(id)arg1 didCompleteLearningAction:(int)arg2 withResult:(_Bool)arg3 error:(id)arg4;	// IMP=0x001000000009f247
- (void)irLearningManager:(id)arg1 didLearnAction:(int)arg2 withProgress:(double)arg3;	// IMP=0x001000000009f13b
- (void)irLearningManager:(id)arg1 willStartLearningAction:(int)arg2;	// IMP=0x001000000009eedb
- (void)irLearningManagerDidCancel:(id)arg1;	// IMP=0x001000000009eed5
- (void)irLearningManager:(id)arg1 didSaveLearnedActions:(id)arg2 forDeviceWithUUID:(id)arg3;	// IMP=0x001000000009ec3a
- (void)irLearningManager:(id)arg1 didFailToStartLearningWithError:(id)arg2;	// IMP=0x001000000009ea2e
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x001000000009e894
- (id)preferredFocusEnvironments;	// IMP=0x001000000009e81b
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x001000000009e6b8
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000009e4d9
- (void)viewDidLoad;	// IMP=0x001000000009d0e9
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x001000000009d029
