...
- (void).cxx_destruct;	// IMP=0x00200000000a64c6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000a5f57
- (unsigned long long)hash;	// IMP=0x00100000000a5f3d
- (id)initWithPhotoCollections:(id)arg1;	// IMP=0x00100000000a5eca
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00100000000a5e57
- (id)initWithName:(id)arg1;	// IMP=0x00100000000a5de4
