...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000009308d
+ (id)sharedInstance;	// IMP=0x001000000008fe62
- (void).cxx_destruct;	// IMP=0x002000000009349b
...
- (void)displayState:(id)arg1 didChangeWithConnection:(long long)arg2;	// IMP=0x0010000000092e6c
- (void)_reloadDataFromCache;	// IMP=0x0010000000092c7a
- (id)_sortedDisplayModesForUserPresentation:(id)arg1;	// IMP=0x0010000000092013
- (void)presentCableCheckDisplayAssistant;	// IMP=0x0010000000091f8f
- (void)presentUpgradeAttemptDisplayAssistant;	// IMP=0x0010000000091ef9
- (void)resetVideoSettingsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000091ddf
- (void)updateDisplayManagerWithDisplayMode:(id)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000091da9
- (void)updateDisplayManagerWithDisplayMode:(id)arg1 reason:(id)arg2 requestConfiguration:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000091bc1
- (void)_enumerateValidColorModesFromSortedModes:(id)arg1 existingFiltering:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000009160b
@property(readonly, nonatomic) TVSettingsDisplayAssistantActionInfo *displayAssistantActionInfo;
- (_Bool)shouldShowDisplayAssistant;	// IMP=0x0010000000091412
...
- (id)_recalculatedUnverifiedModes;	// IMP=0x0010000000090b3b
- (id)_recalculatedUserVisibleHDRChromaModes;	// IMP=0x0010000000090852
- (id)_recalculatedUserVisibleSDRChromaModes;	// IMP=0x001000000009054d
- (id)_recalculatedUserVisibleSDRColorMappingModes;	// IMP=0x00100000000900c8
- (void)dealloc;	// IMP=0x0010000000090037
- (id)init;	// IMP=0x001000000008fee7
