...
+ (id)sharedInstance;	// IMP=0x00400000000050d8
+ (id)keyPathsForValuesAffectingLocalizedAllowAccessShortDescription;	// IMP=0x00100000000050ac
+ (id)keyPathsForValuesAffectingRequireCodeEveryTime;	// IMP=0x0010000000005080
+ (id)keyPathsForValuesAffectingSecurityMode;	// IMP=0x0010000000005054
+ (id)keyPathsForValuesAffectingAccessMode;	// IMP=0x0010000000005028
- (void).cxx_destruct;	// IMP=0x0020000000005ece
