...
- (id)description;	// IMP=0x001000000003bbfc
- (id)init;	// IMP=0x001000000003bbe3
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x001000000003bb23
