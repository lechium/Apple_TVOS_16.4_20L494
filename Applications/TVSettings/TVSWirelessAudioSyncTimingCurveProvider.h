...
- (void).cxx_destruct;	// IMP=0x00200000000ea7ab
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ea72d
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000ea69f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000ea60f
- (id)initWithTimingCurveProviderType:(unsigned long long)arg1;	// IMP=0x00100000000ea518
