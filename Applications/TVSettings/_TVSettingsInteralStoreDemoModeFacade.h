...
- (void).cxx_destruct;	// IMP=0x002000000004950a
...
- (_Bool)applyChanges;	// IMP=0x0010000000049159
@property(readonly, getter=isDirty) _Bool dirty;
- (unsigned long long)modeTypeEnum;	// IMP=0x0010000000048ee3
- (unsigned long long)modeTypeIndexToEnum:(long long)arg1;	// IMP=0x0010000000048ecc
- (id)availableModeTypes;	// IMP=0x0010000000048ebf
...
- (void)restoreDefaults;	// IMP=0x0010000000048c70
- (id)init;	// IMP=0x0010000000048c24
