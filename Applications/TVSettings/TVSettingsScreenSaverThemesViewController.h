...
- (void).cxx_destruct;	// IMP=0x00200000000a7598
...
- (void)_didSelectThemeItem:(id)arg1;	// IMP=0x00100000000a74c8
- (id)_themes;	// IMP=0x00100000000a7103
- (id)previewForItemAtIndexPath:(id)arg1;	// IMP=0x00100000000a6ed2
- (id)loadSettingGroups;	// IMP=0x00100000000a6e47
- (id)initWithFacade:(id)arg1;	// IMP=0x00100000000a6da6
