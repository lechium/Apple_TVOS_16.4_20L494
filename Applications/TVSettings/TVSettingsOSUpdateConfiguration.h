...
- (void).cxx_destruct;	// IMP=0x00200000000599cc
...
- (unsigned long long)hash;	// IMP=0x001000000005983a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000005965a
...
- (id)description;	// IMP=0x0010000000059176
