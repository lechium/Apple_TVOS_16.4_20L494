...
- (void).cxx_destruct;	// IMP=0x00200000000afce1
...
- (void)viewDidLayoutSubviews;	// IMP=0x00100000000af7ed
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000000af62b
- (void)loadView;	// IMP=0x00100000000af383
- (void)dealloc;	// IMP=0x00100000000af327
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000af2de
