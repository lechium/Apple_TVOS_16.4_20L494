...
- (void).cxx_destruct;	// IMP=0x00200000000118cb
...
- (void)_menuButtonAction;	// IMP=0x001000000001170a
- (void)_playStereoVideo;	// IMP=0x001000000001163f
- (void)_playSpatialVideo;	// IMP=0x0010000000011574
- (void)_toggleMode:(id)arg1;	// IMP=0x001000000001142a
- (void)_setupAVPlayerForVideoNamed:(id)arg1 playerView:(id)arg2;	// IMP=0x001000000001113b
- (void)willEnterForeground;	// IMP=0x0010000000011119
- (void)didEnterBackground;	// IMP=0x00100000000110fa
- (void)viewDidLoad;	// IMP=0x001000000000fcbc
- (void)dealloc;	// IMP=0x001000000000fbf0
- (id)initWithBluetoothDevice:(id)arg1;	// IMP=0x001000000000faac
