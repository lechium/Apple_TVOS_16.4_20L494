...
+ (Class)layerClass;	// IMP=0x00400000000cb5d9
- (void).cxx_destruct;	// IMP=0x00200000000cc2c4
...
- (void)_removeBoundaryTimeObservers;	// IMP=0x00100000000cc1bc
- (void)_addBoundaryTimeObservers;	// IMP=0x00100000000cba80
- (void)playInLoopWithRate:(float)arg1 crossfadeDuration:(double)arg2;	// IMP=0x00100000000cb8c1
- (void)dealloc;	// IMP=0x00100000000cb5ea
