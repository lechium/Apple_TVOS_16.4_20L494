...
+ (id)keyPathsForValuesAffectingAsnFreeSetting;	// IMP=0x0020000000086118
+ (id)keyPathsForValuesAffectingAsnPaidSetting;	// IMP=0x00100000000860bc
- (void).cxx_destruct;	// IMP=0x00200000000871d7
...
- (void)_setPaidSettingValue:(unsigned long long)arg1 freeSettingValue:(unsigned long long)arg2;	// IMP=0x0010000000086f32
- (void)_syncPasswordPaidSetting:(unsigned long long)arg1 freeSetting:(unsigned long long)arg2;	// IMP=0x00100000000868f1
- (void)_updatePaidSetting:(unsigned long long)arg1 freeSetting:(unsigned long long)arg2;	// IMP=0x0010000000086888
- (void)_refreshAccount;	// IMP=0x00100000000866fd
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x001000000008660c
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleDialogRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000086468
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleAuthenticateRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000086294
- (void)setAsnFreeSetting:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x0010000000086244
- (void)setAsnPaidSetting:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x00100000000861f4
- (void)setAsnFreeSetting:(id)arg1;	// IMP=0x00100000000861b4
- (void)setAsnPaidSetting:(id)arg1;	// IMP=0x0010000000086174
- (void)dealloc;	// IMP=0x0010000000086039
- (id)initWithAccount:(id)arg1 amsBag:(id)arg2;	// IMP=0x0010000000085f1a
