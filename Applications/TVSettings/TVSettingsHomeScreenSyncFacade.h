...
+ (id)sharedInstance;	// IMP=0x0020000000060f4e
- (void).cxx_destruct;	// IMP=0x00200000000616d2
...
- (void)_clearLastKnownDeviceSyncState;	// IMP=0x0010000000061646
- (void)iCloudAccountManager:(id)arg1 didModifyActiveAccount:(id)arg2;	// IMP=0x0010000000061502
- (void)clearAccountPrefsForAutoAppDownloads;	// IMP=0x00100000000614e3
- (_Bool)isAutoAppDownloadsEnabledForAccountIdentifier:(id)arg1;	// IMP=0x00100000000613f3
- (void)setAutoAppDownloadsEnabled:(_Bool)arg1 accountIdentifier:(id)arg2;	// IMP=0x00100000000612b8
- (id)init;	// IMP=0x0010000000060fa3
