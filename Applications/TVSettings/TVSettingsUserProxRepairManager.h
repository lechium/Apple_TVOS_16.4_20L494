...
- (void).cxx_destruct;	// IMP=0x0020000000065149
...
- (void)_cancelIfNotConnectedYet;	// IMP=0x0010000000064f08
- (void)_cleanUp;	// IMP=0x0010000000064d77
- (void)_finishWithError:(id)arg1;	// IMP=0x00100000000646bb
- (void)_finish;	// IMP=0x0010000000063bf5
- (void)_restorePersona;	// IMP=0x0010000000063a5a
- (void)_adoptPersona;	// IMP=0x00100000000636a0
- (void)_handleAuthServiceProgressEvent:(unsigned int)arg1 info:(id)arg2;	// IMP=0x0010000000062b53
- (void)authenticateAccountsService:(id)arg1 didFinishAuthentication:(id)arg2;	// IMP=0x0010000000062a3e
- (void)authenticateAccountsService:(id)arg1 didAttemptSignInWithAccountType:(unsigned int)arg2;	// IMP=0x0010000000062997
- (void)authenticateAccountsService:(id)arg1 willAttemptSignInWithAccountType:(unsigned int)arg2;	// IMP=0x00100000000628f0
- (_Bool)authenticateAccountsService:(id)arg1 shouldSignInAccounts:(id)arg2;	// IMP=0x00100000000623d7
- (void)stop;	// IMP=0x00100000000621fe
- (void)dealloc;	// IMP=0x00100000000621c0
- (void)startWithUser:(id)arg1 needsCDPRepair:(_Bool)arg2;	// IMP=0x001000000006177d
- (id)init;	// IMP=0x0010000000061708
