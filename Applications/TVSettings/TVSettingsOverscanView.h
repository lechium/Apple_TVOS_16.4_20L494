...
- (void).cxx_destruct;	// IMP=0x0020000000098bf6
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00100000000987eb
- (void)layoutSubviews;	// IMP=0x001000000009839f
@property(copy, nonatomic) NSString *instructionText;
@property(copy, nonatomic) NSString *titleText;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000097e1a
