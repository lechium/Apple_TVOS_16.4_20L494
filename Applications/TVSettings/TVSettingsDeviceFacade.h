...
+ (_Bool)automaticallyNotifiesObserversOfCurrentLocale;	// IMP=0x004000000002c11a
+ (id)sharedInstance;	// IMP=0x001000000002bc2f
- (void).cxx_destruct;	// IMP=0x002000000002d1a5
...
- (void)_updateSleepTimeoutValue;	// IMP=0x001000000002cdfe
- (void)_updateLocaleForces24HourTime;	// IMP=0x001000000002cd2b
@property(nonatomic) _Bool use24HourTime;
- (id)cityNameForCityID:(id)arg1;	// IMP=0x001000000002cbc7
@property(copy, nonatomic) NSString *timeZoneCityID;
- (void)_updateAutomaticTimeZoneEnabled:(_Bool)arg1;	// IMP=0x001000000002c89f
@property(nonatomic) long long preferredKeyboardType;
@property(readonly, copy, nonatomic) NSArray *availableLocales;
- (void)_updateCurrentLocale;	// IMP=0x001000000002c68b
...
- (id)internetConfigurationSummary;	// IMP=0x001000000002c3ee
...
- (id)init;	// IMP=0x001000000002bddb
