...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x00200000000431b0
- (void).cxx_destruct;	// IMP=0x0020000000047770
...
- (id)_preloadArtwork;	// IMP=0x00100000000472b0
- (id)_placeholderArtwork;	// IMP=0x00100000000471b0
- (void)_updateState;	// IMP=0x0010000000046f50
- (void)_updateAutomaticResponseLoading;	// IMP=0x0010000000046e60
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0010000000046810
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0010000000046650
- (void)_updateMetadata;	// IMP=0x00100000000444d0
- (void)_createRequestController;	// IMP=0x0010000000043e40
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0010000000043b70
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0010000000043920
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0010000000043430
- (void)playPause;	// IMP=0x0010000000043400
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0010000000043370
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000043290
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0010000000043110
- (id)playerPath;	// IMP=0x0010000000043020
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0010000000042e30
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0010000000042a90
