...
+ (id)_remoteViewControllerInterface;	// IMP=0x0020000000041840
+ (id)_exportedInterface;	// IMP=0x0010000000041700
- (void).cxx_destruct;	// IMP=0x0020000000041ab0
...
- (void)_menuPressed:(id)arg1;	// IMP=0x00100000000418b0
- (void)viewServiceEndPresentationWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000041210
- (void)viewServiceBeginPresentationWithOptions:(id)arg1;	// IMP=0x0010000000040800
- (void)viewDidLoad;	// IMP=0x0010000000040730
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000040620
