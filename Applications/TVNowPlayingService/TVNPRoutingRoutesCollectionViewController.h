...
- (void).cxx_destruct;	// IMP=0x0020000000038600
...
- (id)_gradientMask;	// IMP=0x0010000000036f20
- (void)routeCellDidSelectAccessoryView:(id)arg1;	// IMP=0x0010000000036e10
- (void)routeCellDidSelectRouteView:(id)arg1;	// IMP=0x0010000000036520
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x00100000000364b0
- (void)shareAudioSelected;	// IMP=0x0010000000036410
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x0010000000036100
- (void)longPressSelect:(id)arg1;	// IMP=0x0010000000036000
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x0010000000035ea0
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0010000000035cd0
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0010000000035b00
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x0010000000035a60
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00100000000356d0
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0010000000035490
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000035360
- (void)handleVolumeDown;	// IMP=0x0010000000034d30
- (void)handleVolumeUp;	// IMP=0x00100000000346a0
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x00100000000333f0
- (void)viewDidLayoutSubviews;	// IMP=0x0010000000033060
- (void)viewDidLoad;	// IMP=0x0010000000032120
- (void)dealloc;	// IMP=0x00100000000320d0
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x0010000000031f80
