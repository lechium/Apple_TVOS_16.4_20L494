...
- (void).cxx_destruct;	// IMP=0x002000000000ba90
...
- (id)_indexPathForCurrentDestination;	// IMP=0x001000000000b560
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x001000000000b3c0
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x001000000000b250
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x001000000000b1e0
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x001000000000a980
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x001000000000a2f0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000009bb0
- (_Bool)_ignoreVolumeChangesWhilePendingSelection;	// IMP=0x0010000000009930
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)arg1;	// IMP=0x0010000000009680
- (void)updateCollectionViewWithDestinations:(id)arg1;	// IMP=0x0010000000008f50
- (void)viewDidLayoutSubviews;	// IMP=0x0010000000008810
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000008760
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0010000000008630
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000007f80
- (void)viewDidLoad;	// IMP=0x00100000000079e0
- (void)dealloc;	// IMP=0x0010000000007910
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x0010000000007690
