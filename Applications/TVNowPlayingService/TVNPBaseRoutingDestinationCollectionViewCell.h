...
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x004000000003c8e0
- (void).cxx_destruct;	// IMP=0x002000000003ec00
...
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000003df50
- (unsigned long long)_controlStateForCell;	// IMP=0x001000000003de80
- (void)_addInitialConstraints;	// IMP=0x001000000003ca90
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x001000000003c0d0
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x001000000003bfa0
- (void)setSelected:(_Bool)arg1;	// IMP=0x001000000003bf80
- (void)updateConstraints;	// IMP=0x001000000003b540
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000003b430
- (void)useFocusedAppearance;	// IMP=0x001000000003b400
- (void)layoutSubviews;	// IMP=0x001000000003b010
- (void)prepareForReuse;	// IMP=0x001000000003afb0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000003a200
