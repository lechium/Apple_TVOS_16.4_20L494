...
- (void).cxx_destruct;	// IMP=0x002000000001a000
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0010000000019b00
- (void)connectAndPair;	// IMP=0x0010000000019af0
- (void)togglePlayPause;	// IMP=0x0010000000019ae0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0010000000019a40
- (id)init;	// IMP=0x0010000000019a10
