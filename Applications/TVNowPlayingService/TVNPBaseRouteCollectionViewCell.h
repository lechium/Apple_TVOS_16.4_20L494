...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x0020000000023cf0
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0010000000021850
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x001000000001d7e0
+ (_Bool)allowsSelection;	// IMP=0x001000000001d7c0
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x0010000000023ae0
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000022c40
- (unsigned long long)_controlStateForCell;	// IMP=0x0010000000022b70
- (void)_addInitialConstraints;	// IMP=0x0010000000021a00
- (void)accessoryViewSelected;	// IMP=0x0010000000021840
- (void)routeViewSelected;	// IMP=0x0010000000021830
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x00100000000217f0
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0010000000020dd0
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x0010000000020ca0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000020b90
- (void)updateConstraints;	// IMP=0x001000000001ed50
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x001000000001ec20
- (void)setSelected:(_Bool)arg1;	// IMP=0x001000000001ec00
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000001eac0
- (void)prepareForReuse;	// IMP=0x001000000001ea20
- (id)preferredFocusEnvironments;	// IMP=0x001000000001e8a0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000001d800
