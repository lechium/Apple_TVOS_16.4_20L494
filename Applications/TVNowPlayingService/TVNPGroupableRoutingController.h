...
- (void).cxx_destruct;	// IMP=0x00200000000188b0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x0010000000018230
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000017e10
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x0010000000016860
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x00100000000127e0
...
- (_Bool);	// IMP=0x0010000000011530
- (void)targetDestination:(id)arg1;	// IMP=0x0010000000011370
- (void)presentEARCUpsell;	// IMP=0x0010000000010f10
