...
- (void).cxx_destruct;	// IMP=0x002000000002eec0
...
- (id)_imageForHomePodVariant:(unsigned long long)arg1;	// IMP=0x001000000002ec00
- (void)dismissPrompt;	// IMP=0x001000000002eba0
- (void)_handleSkipButton;	// IMP=0x001000000002ea30
- (void)_handleAcceptButton;	// IMP=0x001000000002dbf0
- (void)_configureButtonsAndLabels;	// IMP=0x001000000002d430
- (long long)overrideUserInterfaceStyle;	// IMP=0x001000000002d410
- (id)preferredFocusEnvironments;	// IMP=0x001000000002d2a0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x001000000002d220
- (void)viewDidLoad;	// IMP=0x001000000002a990
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000002a8b0
