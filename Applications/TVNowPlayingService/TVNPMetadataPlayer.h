...
- (void).cxx_destruct;	// IMP=0x002000000001c780
...
- (void)_callElapsedTimeObserversDueToTimeJump:(_Bool)arg1;	// IMP=0x001000000001bb30
- (void)_fireElapsedTimeUpdate:(id)arg1;	// IMP=0x001000000001bad0
- (void)_updateElapsedTimeTimer;	// IMP=0x001000000001b9d0
@property(readonly, nonatomic) double elapsedTime;
- (float)_rateForState:(id)arg1;	// IMP=0x001000000001b310
...
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x001000000001af80
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x001000000001af30
- (void)updateSubtitleOptions;	// IMP=0x001000000001af20
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x001000000001aee0
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000001ae70
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000001ae00
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x001000000001ad70
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x001000000001ac60
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x001000000001abd0
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x001000000001ab90
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2;	// IMP=0x001000000001ab50
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x001000000001ab10
- (void)setElapsedTime:(double)arg1;	// IMP=0x001000000001aa00
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x001000000001a9d0
- (void)stop;	// IMP=0x001000000001a930
- (void)scanWithRate:(double)arg1;	// IMP=0x001000000001a750
- (void)togglePlayPause;	// IMP=0x001000000001a6f0
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x001000000001a6c0
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x001000000001a690
- (void)pause;	// IMP=0x001000000001a630
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x001000000001a600
- (void)play;	// IMP=0x001000000001a4f0
- (void)continueLoadingCurrentItem;	// IMP=0x001000000001a4e0
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x001000000001a410
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x001000000001a3d0
- (void)setLastElapsedTime:(double)arg1 atTimestamp:(id)arg2;	// IMP=0x001000000001a2d0
- (void)invalidate;	// IMP=0x001000000001a290
- (id)initWithName:(id)arg1;	// IMP=0x001000000001a130
- (id)init;	// IMP=0x001000000001a0d0
