...
- (void).cxx_destruct;	// IMP=0x0020000000004520
...
- (id)_unfocusedProgressColor;	// IMP=0x0010000000004240
- (id)_focusedProgressColor;	// IMP=0x0010000000004160
- (void)_rightPressed:(id)arg1;	// IMP=0x0010000000004070
- (void)_leftPressed:(id)arg1;	// IMP=0x0010000000003f90
- (void)_panUpdated:(id)arg1;	// IMP=0x00100000000039f0
- (void)_menuPressed;	// IMP=0x00100000000039e0
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0010000000003970
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0010000000003900
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0010000000003890
- (_Bool)shouldTrack;	// IMP=0x0010000000003870
- (double)maxBarWidth;	// IMP=0x0010000000003850
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x00100000000037e0
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000003480
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00100000000033a0
- (struct CGSize)intrinsicContentSize;	// IMP=0x0010000000003360
- (void)layoutSubviews;	// IMP=0x0010000000002d20
- (_Bool)canBecomeFocused;	// IMP=0x0010000000002d00
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000002330
