...
@interface TVNPGroupableRoutingController : NSObject
{
    ...
    MISSING_TYPE *_updateQueue;	// 248 = 0xf8
    unsigned long long _numberOfUpdates;	// 256 = 0x100
}

+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000000d6d0
- (void).cxx_destruct;	// IMP=0x00200000000183e0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x0010000000017d20
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000017900
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x0010000000016350
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x00100000000122d0
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0010000000011e40
- (void)_updateAvailableRoutes;	// IMP=0x00100000000112f0
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0010000000011130
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x00100000000110b0
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000011060
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0010000000010e60
- (void)presentEARCUpsell;	// IMP=0x00100000000109e0
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x00100000000103c0
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000fef0
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000ea20
- (void)_updateAllowsDestinationSelection;	// IMP=0x001000000000e940
- (void)dealloc;	// IMP=0x001000000000e390
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000000d880
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x001000000000d7e0
- (id)init;	// IMP=0x001000000000d780
