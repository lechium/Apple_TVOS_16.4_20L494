...
- (void).cxx_destruct;	// IMP=0x00200000000031c0
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0010000000002cc0
- (void)connectAndPair;	// IMP=0x0010000000002cb0
- (void)togglePlayPause;	// IMP=0x0010000000002ca0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0010000000002c00
- (id)init;	// IMP=0x0010000000002bd0
