...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0020000000003a20
- (void).cxx_destruct;	// IMP=0x00200000000081e0
...
- (id)_preloadArtwork;	// IMP=0x0010000000007d20
- (id)_placeholderArtwork;	// IMP=0x0010000000007c20
- (void)_updateState;	// IMP=0x00100000000079c0
- (void)_updateAutomaticResponseLoading;	// IMP=0x00100000000078d0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0010000000007190
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0010000000006fd0
- (void)_updateMetadata;	// IMP=0x0010000000004de0
- (void)_createRequestController;	// IMP=0x0010000000004750
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0010000000004480
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0010000000004190
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0010000000003ca0
- (void)playPause;	// IMP=0x0010000000003c70
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0010000000003be0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003b00
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0010000000003980
- (id)playerPath;	// IMP=0x0010000000003890
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x00100000000036a0
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0010000000003290
