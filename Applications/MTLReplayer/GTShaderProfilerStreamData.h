...
+ (id)steamDataFromData:(id)arg1;	// IMP=0x0020000000023b01
+ (id)dataFromArchivedDataURL:(id)arg1;	// IMP=0x0010000000023a2c
+ (id)streamDataClasses;	// IMP=0x0010000000023901
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000238f9
- (void).cxx_destruct;	// IMP=0x00200000000237da
...
- (void)patchObjectIds:(id)arg1;	// IMP=0x0010000000023194
- (void)debugDump:(id)arg1;	// IMP=0x001000000002307c
...
- (void)enumerateUnarchivedBatchIdFilteredCounterData:(CDUnknownBlockType)arg1;	// IMP=0x0010000000022c6a
...
- (void)enumerateUnarchivedGPUTimelineData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002216b
...
- (void)enumerateUnarchivedShaderProfilerData:(CDUnknownBlockType)arg1;	// IMP=0x0010000000021dce
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002188c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000021462
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000020e91
- (id)init;	// IMP=0x0010000000020e55
