...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000052684
- (void).cxx_destruct;	// IMP=0x0020000000052646
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000524fa
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000052370
- (id)init;	// IMP=0x0010000000052236
