...
+ (id)hardwareUUID;	// IMP=0x0020000000050c5d
+ (id)bootSessionUUID;	// IMP=0x0010000000050bbd
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000050bb5
- (void).cxx_destruct;	// IMP=0x00200000000509f7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000005067b
- (id)initForEmbeddedSystem;	// IMP=0x001000000005026f
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000004ff26
- (id)initWithXPCObject:(id)arg1;	// IMP=0x001000000004fb2a
- (id)init;	// IMP=0x001000000004fac0
