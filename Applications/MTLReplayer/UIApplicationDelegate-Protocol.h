...
@class CKShareMetadata, INIntent, MISSING_TYPE, NSArray, NSCoder, NSData, NSDictionary, NSError, NSSet, NSString, NSURL, NSUserActivity, UIApplication, UILocalNotification, UISceneConfiguration, UISceneConnectionOptions, UISceneSession, UIUserNotificationSettings, UIViewController, UIWindow;
...
- (MISSING_TYPE *)application:performActionForShortcutItem:completionHandler: /* Error: Ran out of types for this method. */;
