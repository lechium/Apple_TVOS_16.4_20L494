...
- (void).cxx_destruct;	// IMP=0x0020000000064479
...
- (void)speechSynthesizer:(id)arg1 didFinishSynthesisRequest:(id)arg2 withInstrumentMetrics:(id)arg3 error:(id)arg4;	// IMP=0x0010000000064167
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x001000000006351a
- (id)init;	// IMP=0x0010000000062a91
