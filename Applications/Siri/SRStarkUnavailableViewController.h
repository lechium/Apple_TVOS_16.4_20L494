...
- (void).cxx_destruct;	// IMP=0x002000000001d7ec
@property(nonatomic) __weak id <SRStarkItemControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (unsigned long long)autoDismissalReason;	// IMP=0x001000000001d7a5
- (long long)autoDismissalStrategy;	// IMP=0x001000000001d77c
- (void)viewDidLoad;	// IMP=0x001000000001d5f1
- (void)loadView;	// IMP=0x001000000001d57c
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 shouldSynthesizeTitles:(_Bool)arg3;	// IMP=0x001000000001d499
