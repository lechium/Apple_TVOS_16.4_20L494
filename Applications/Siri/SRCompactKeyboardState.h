...
- (void).cxx_destruct;	// IMP=0x002000000002e2c4
@property(readonly, copy, nonatomic) SRCompactKeyboardAnimation *animation; // @synthesize animation=_animation;
@property(readonly, nonatomic) struct CGRect frame; // @synthesize frame=_frame;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002e297
@property(readonly, nonatomic) struct CGRect frameForAnimation;
- (id)initWithKeyboardNotification:(id)arg1;	// IMP=0x001000000002de95
- (id)initWithFrame:(struct CGRect)arg1 animation:(id)arg2;	// IMP=0x001000000002de17
