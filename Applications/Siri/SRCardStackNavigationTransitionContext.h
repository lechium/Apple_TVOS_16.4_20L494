...
- (void)completeTransition:(_Bool)arg1;	// IMP=0x0010000000058716
@property(readonly, nonatomic) long long semanticContentAttribute;
- (id)init;	// IMP=0x001000000005867b
- (id)initWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000058608
