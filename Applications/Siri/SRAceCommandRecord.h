...
- (void).cxx_destruct;	// IMP=0x0020000000072c4a
...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x0010000000072b80
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x0010000000072699
- (void)incrementNumberOfStoppedActions;	// IMP=0x0010000000072667
- (void)incrementNumberOfStartedActions;	// IMP=0x0010000000072635
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000007250b
