...
+ (id)configuration;	// IMP=0x0040000000064b4b
+ (id)new;	// IMP=0x0010000000064b43
- (void).cxx_destruct;	// IMP=0x0020000000064ca9
...
- (id)identifierForService:(long long)arg1;	// IMP=0x0010000000064be9
- (id)domainForService:(long long)arg1;	// IMP=0x0010000000064bb0
- (id)init;	// IMP=0x0010000000064b35
- (id)_init;	// IMP=0x0010000000064a87
