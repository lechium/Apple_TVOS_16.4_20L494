...
- (void).cxx_destruct;	// IMP=0x0020000000004800
...
- (id)preferredFocusEnvironments;	// IMP=0x0010000000004530
- (void)viewDidLoad;	// IMP=0x00100000000032d0
- (id)initWithMap:(id)arg1 allProfiles:(id)arg2 allUsers:(id)arg3 appName:(id)arg4;	// IMP=0x0010000000002e70
