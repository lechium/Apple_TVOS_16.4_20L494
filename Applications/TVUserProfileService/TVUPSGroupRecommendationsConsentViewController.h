...
- (void)groupRecommendationsConsentViewControllerDidCancel:(id)arg1;	// IMP=0x0010000000003830
- (void)groupRecommendationsConsentViewController:(id)arg1 didUpdateConsentWithAuthorized:(_Bool)arg2;	// IMP=0x0010000000002fe0
- (void)_dimissWithConsentGiven:(_Bool)arg1;	// IMP=0x0010000000002e00
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0010000000002cc0
- (void)viewDidLoad;	// IMP=0x0010000000002bd0
- (id)initWithUserProfileIdentifier:(id)arg1;	// IMP=0x0010000000002840
