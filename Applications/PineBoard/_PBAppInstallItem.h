...
- (void).cxx_destruct;	// IMP=0x002000000009b8b9
...
- (id)description;	// IMP=0x001000000009b806
- (id)initWithBundleIdentifier:(id)arg1;	// IMP=0x001000000009b75f
- (id)init;	// IMP=0x001000000009b734
