...
+ (id)_allAudioMediaTypes;	// IMP=0x00200000001935ed
+ (id)_bulletinInfoForNowPlayingInfo:(id)arg1;	// IMP=0x001000000019327d
+ (id)sharedInstance;	// IMP=0x00100000001901b0
+ (id)dependencyDescription;	// IMP=0x0010000000190121
- (void).cxx_destruct;	// IMP=0x002000000019370a
...
- (void)_updatePictureInPictureStateWithActivePlayerPath:(id)arg1;	// IMP=0x00100000001930d3
- (void)_updateSupportedPlaybackRates:(id)arg1;	// IMP=0x0010000000192fbb
- (void)_updateWithNowPlayingInfoDictionary:(id)arg1 playbackState:(unsigned int)arg2 nowPlayingPID:(int)arg3 nowPlayingPlayerPath:(id)arg4;	// IMP=0x0010000000192232
- (void)_performPictureInPicturePlayerStateUpdate;	// IMP=0x0010000000191d88
- (void)_performSupportedCommandsUpdateWithPlayerPath:(void *)arg1;	// IMP=0x001000000019181d
- (void)_performMetadataUpdate;	// IMP=0x00100000001911e0
- (void)_setNeedsMetadataUpdate;	// IMP=0x0010000000191078
- (void)_presentTrackChangeBulletinWithInfo:(id)arg1;	// IMP=0x0010000000190e3c
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x0010000000190db1
- (void)_pictureInPictureStateDidChange:(id)arg1;	// IMP=0x0010000000190cf5
- (void)_nowPlayingAppDidChange:(id)arg1;	// IMP=0x0010000000190bb9
- (void)_nowPlayingAppPlaybackStateDidChange:(id)arg1;	// IMP=0x0010000000190a5a
- (void)_nowPlayingInfoDidChange:(id)arg1;	// IMP=0x001000000019099e
- (void)_remotePlayerPlaybackStateDidChange:(id)arg1;	// IMP=0x00100000001908b9
...
- (_Bool)nowPlayingMediaTypeAudioOnly;	// IMP=0x0010000000190486
- (void)stopObserving;	// IMP=0x001000000019042d
- (void)startObserving;	// IMP=0x00100000001902ad
- (void)dealloc;	// IMP=0x001000000019026f
- (id)init;	// IMP=0x0010000000190237
