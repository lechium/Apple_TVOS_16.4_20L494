...
- (void).cxx_destruct;	// IMP=0x0020000000197bfe
...
- (void)invalidateImage;	// IMP=0x0010000000197b76
- (id)fetchImage;	// IMP=0x00100000001974e6
- (id)initWithSnapshotPredicate:(id)arg1 sceneID:(id)arg2 bundleIdentifier:(id)arg3 scaleFactor:(double)arg4;	// IMP=0x0010000000197395
- (id)init;	// IMP=0x0010000000197387
