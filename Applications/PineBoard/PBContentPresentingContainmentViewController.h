...
- (void).cxx_destruct;	// IMP=0x002000000016e196
...
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000016e068
- (void);	// IMP=0x001000000016dee7
- (id)preferredFocusEnvironments;	// IMP=0x001000000016de6d
...
- (id)initWithChildViewController:(id)arg1 allowsInteraction:(_Bool)arg2 expectsEventForwarding:(_Bool)arg3;	// IMP=0x001000000016ddc3
