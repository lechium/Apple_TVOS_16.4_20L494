...
- (void).cxx_destruct;	// IMP=0x002000000006658e
@property(nonatomic) __weak id <PBSiriDataSharingOptInOfferViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_didNotCompleteOptIn;	// IMP=0x0010000000066512
- (void)_optOut;	// IMP=0x00100000000664c3
- (void)_optIn;	// IMP=0x0010000000066471
- (void)_handleHomeButton:(id)arg1;	// IMP=0x001000000006641e
- (void)_handleMenuButton:(id)arg1;	// IMP=0x00100000000663cb
- (void)viewDidLoad;	// IMP=0x0010000000065be9
