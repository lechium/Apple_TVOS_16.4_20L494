...
+ (_Bool)_isDeviceNameAppleTV:(id)arg1;	// IMP=0x00400000001bad79
+ (_Bool)_isDeviceName:(id)arg1 roomNameInAccessory:(id)arg2;	// IMP=0x00100000001baa9d
+ (_Bool)_isAccessoryInDefaultRoom:(id)arg1;	// IMP=0x00100000001ba96a
+ (id)sharedInstance;	// IMP=0x00100000001b92c4
- (void).cxx_destruct;	// IMP=0x00200000001bda00
...
- (void)_disableARCIfNecessary;	// IMP=0x00100000001bd86b
- (void)_notifyOdeonChangedIfNecessaryWithDestination:(id)arg1;	// IMP=0x00100000001bd5f4
- (void)_updateHomeModuleAvailability;	// IMP=0x00100000001bd123
...
- (void)_moveOrAddLocalAccessoryToRoom:(id)arg1 inHome:(id)arg2;	// IMP=0x00100000001bbae5
- (void)_moveOrAddLocalAccessoryToRoomWithName:(id)arg1 inHome:(id)arg2;	// IMP=0x00100000001bb7c9
- (void)_configureLocalAccessory;	// IMP=0x00100000001bb21a
- (void)removeObserver:(id)arg1;	// IMP=0x00100000001ba743
- (void)addObserver:(id)arg1;	// IMP=0x00100000001ba694
@property(readonly, nonatomic, getter=isOdeonConfigured) _Bool odeonConfigured;
- (void)setupAssistantDidFinish;	// IMP=0x00100000001ba641
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000001ba3cb
- (void)_initializeStateMachine;	// IMP=0x00100000001b9637
- (id)_init;	// IMP=0x00100000001b936c
- (id)init;	// IMP=0x00100000001b932b
