...
- (void).cxx_destruct;	// IMP=0x0020000000160a04
...
- (void)_didNotCompleteOptIn;	// IMP=0x0010000000160978
- (void)_optOut;	// IMP=0x0010000000160929
- (void)_optIn;	// IMP=0x00100000001608d7
- (void)_handleHomeButton:(id)arg1;	// IMP=0x0010000000160884
- (void)_handleMenuButton:(id)arg1;	// IMP=0x0010000000160831
- (void)viewDidLoad;	// IMP=0x001000000015ff68
- (id)initWithOfferDictationOnly:(_Bool)arg1;	// IMP=0x001000000015ff22
