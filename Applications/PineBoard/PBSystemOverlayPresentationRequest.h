...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000dcd28
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000dcd1c
- (id)initWithRequest:(id)arg1;	// IMP=0x00100000000dcbac
