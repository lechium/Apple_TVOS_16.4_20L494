...
- (id)description;	// IMP=0x00100000000e195a
- (unsigned long long)hash;	// IMP=0x00100000000e15ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000e1243
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e1051
