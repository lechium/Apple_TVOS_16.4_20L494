...
- (void).cxx_destruct;	// IMP=0x002000000009cf4e
...
- (void)_postLargeGameInstalledBulletinWithAppInfo:(id)arg1;	// IMP=0x001000000009c8a8
- (double)_largeGameInstallTimeThreshold;	// IMP=0x001000000009c839
- (void)_handleGameAppInfoControllerUpdate:(id)arg1;	// IMP=0x001000000009be53
@property(readonly, nonatomic) PBBulletinService *bulletinService; // @synthesize bulletinService=_bulletinService;
- (void)_activate;	// IMP=0x001000000009bc9f
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x001000000009bab0
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x001000000009b9e1
- (void)activate;	// IMP=0x000000000009b959
- (id)init;	// IMP=0x001000000009b8e2
