...
- (void).cxx_destruct;	// IMP=0x002000000002390a
...
- (id)description;	// IMP=0x00100000000237b9
- (unsigned long long)hash;	// IMP=0x00100000000237a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000236a1
- (id)initWithToken:(id)arg1 requestType:(unsigned long long)arg2;	// IMP=0x001000000002362b
- (id)initWithToken:(id)arg1;	// IMP=0x0010000000023616
- (id)init;	// IMP=0x0010000000023608
