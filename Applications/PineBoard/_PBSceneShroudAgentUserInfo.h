...
- (void).cxx_destruct;	// IMP=0x002000000010f2e4
...
- (void)invalidate;	// IMP=0x001000000010f202
- (void)dealloc;	// IMP=0x001000000010f1c4
- (id)initWithBundleID:(id)arg1;	// IMP=0x001000000010f149
