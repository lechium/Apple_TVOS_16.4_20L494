...
+ (id)sharedInstance;	// IMP=0x004000000014d014
- (void).cxx_destruct;	// IMP=0x002000000014deb9
...
- (void)_callUpdateHandlerForNotificationName:(id)arg1 notification:(id)arg2;	// IMP=0x001000000014dd8e
- (void)_updateAirplayDisplayActiveFromNotification:(id)arg1;	// IMP=0x001000000014daf2
- (void)_rebuildCache;	// IMP=0x001000000014d8f8
- (void)_initializeCache;	// IMP=0x001000000014d5eb
- (void)_handleSystemControllerMetadataDidChangeNotification:(id)arg1;	// IMP=0x001000000014d345
- (void)_handleSystemControllerServerConnectionDied:(id)arg1;	// IMP=0x001000000014d189
...
- (void)dealloc;	// IMP=0x001000000014cf9f
- (id)initWithDataProviderInitializer:(CDUnknownBlockType)arg1;	// IMP=0x000000000014ce0e
