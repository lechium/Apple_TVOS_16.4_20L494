...
- (void).cxx_destruct;	// IMP=0x00200000001f16b0
...
- (void)_begin;	// IMP=0x00100000001f13f3
- (_Bool)_canBeInterrupted;	// IMP=0x00100000001f13eb
- (id)initWithRequest:(id)arg1 viewController:(id)arg2 layoutLevel:(long long)arg3 deactivationReasons:(unsigned long long)arg4 presentationDelegate:(id)arg5;	// IMP=0x00100000001f1300
- (id)init;	// IMP=0x00100000001f12f2
