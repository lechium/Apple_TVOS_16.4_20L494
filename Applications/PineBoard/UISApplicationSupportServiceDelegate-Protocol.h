...
@class BSAuditToken, BSProcessHandle, MISSING_TYPE, NSArray, UISApplicationInitializationContext, UISApplicationSupportService;
...
- (MISSING_TYPE *)service:initializeClient:withParameters: /* Error: Ran out of types for this method. */;
