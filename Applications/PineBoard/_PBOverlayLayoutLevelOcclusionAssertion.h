...
@interface _PBOverlayLayoutLevelOcclusionAssertion : NSObject
{
    ...
    id <_PBOverlayLayoutLevelOcclusionController>;	// 16 = 0x10
    long long _layoutLevel;	// 24 = 0x18
    NSString *_reason;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x00200000000b56a9
...
- (id)stateDumpBuilder;	// IMP=0x00100000000b55ff
@property(readonly, copy) NSString *description;
- (void)invalidateWithTransitionContext:(id)arg1;	// IMP=0x00100000000b54be
- (void)invalidate;	// IMP=0x00100000000b54a9
- (void)dealloc;	// IMP=0x00100000000b52f1
- (id)initWithController:(id)arg1 layoutLevel:(long long)arg2 reason:(id)arg3;	// IMP=0x00100000000b523b
