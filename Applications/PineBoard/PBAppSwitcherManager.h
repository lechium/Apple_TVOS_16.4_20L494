...
+ (id)defaultManager;	// IMP=0x00400000000ac506
- (void).cxx_destruct;	// IMP=0x00200000000adb1a
...
- (_Bool)_shouldPresentAppSwitcherForGestureActivation;	// IMP=0x00100000000ad8e2
- (_Bool)dismissAppSwitcherToBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000ad2c5
- (void)presentAppSwitcherWithFocusedBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000aca50
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (_Bool)shouldActivateForProcessWithIdentifier:(id)arg1;	// IMP=0x00100000000ac916
- (void)dealloc;	// IMP=0x00100000000ac8bb
- (id)_init;	// IMP=0x00100000000ac5ab
- (id)init;	// IMP=0x00100000000ac59d
