...
- (void).cxx_destruct;	// IMP=0x002000000016bd37
...
- (void)_performReducedMotionAnimation;	// IMP=0x001000000016b853
- (void)_performDefaultAnimation;	// IMP=0x001000000016b6b9
- (void)startAnimation;	// IMP=0x001000000016b684
- (id)initWithContext:(unsigned long long)arg1 layout:(id)arg2 targetSize:(struct CGSize)arg3 quadrant:(long long)arg4 pipInsets:(struct UIEdgeInsets)arg5;	// IMP=0x001000000016b569
