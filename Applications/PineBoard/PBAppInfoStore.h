...
@interface PBAppInfoStore : NSObject
{
    ...
    id <PBAppInfoStorePolicyProviding>;	// 16 = 0x10
...
- (void).cxx_destruct;	// IMP=0x002000000001c9d0
...
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 applicationInfo:(id)arg4;	// IMP=0x001000000001c495
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 placeholder:(id)arg4;	// IMP=0x001000000001c28c
- (void)queue_processUpdates:(id)arg1;	// IMP=0x001000000001a96f
- (void)languageDidChange;	// IMP=0x001000000001a6df
- (void)applicationIconDidChange:(id)arg1;	// IMP=0x001000000001a384
- (void)placeholderDidChangeSignificantly:(id)arg1;	// IMP=0x001000000001a276
- (void)placeholderProgressDidUpdate:(id)arg1;	// IMP=0x001000000001a168
- (void)handleDynamicStateChanged:(id)arg1;	// IMP=0x001000000001a114
- (void)handlePolicyChanged:(id)arg1;	// IMP=0x001000000001a0c0
- (id)appInfoControllerWithEnabledApps;	// IMP=0x001000000001a04d
- (id)appInfoControllerWithEnabledAndVisibleApps;	// IMP=0x0010000000019fda
- (id)appInfoControllerWithEnabledAndVisibleAppsAndPlaceholders;	// IMP=0x0010000000019f67
- (id)appInfoControllerWithEverything;	// IMP=0x0010000000019f2b
- (void)_enqueueUpdate:(id)arg1;	// IMP=0x0010000000019dcc
- (void)removeObserver:(id)arg1;	// IMP=0x0010000000019d22
- (id)addObserver:(id)arg1;	// IMP=0x0010000000019b58
- (id)configuration;	// IMP=0x0010000000019a7c
- (id)appInfos;	// IMP=0x0010000000019961
- (void)dealloc;	// IMP=0x00100000000197ab
- (id)initWithApplicationLibrary:(id)arg1 policy:(id)arg2 dynamicStateDataSource:(id)arg3;	// IMP=0x0010000000018a04
