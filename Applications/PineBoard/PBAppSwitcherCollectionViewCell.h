...
- (void).cxx_destruct;	// IMP=0x002000000013be95
...
- (id)_accessibilitySemanticContextForElement:(id)arg1;	// IMP=0x001000000013bd39
- (void)_setShadowRadius:(double)arg1 alpha:(double)arg2;	// IMP=0x001000000013bbcf
- (void)_setDimingAlpha:(double)arg1;	// IMP=0x001000000013bb72
- (void)_setContentAlpha:(double)arg1;	// IMP=0x001000000013bb20
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000013b959
- (void)layoutSubviews;	// IMP=0x001000000013b4b2
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x001000000013b160
- (void)dealloc;	// IMP=0x001000000013b120
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000013ac09
