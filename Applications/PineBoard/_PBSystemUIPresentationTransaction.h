...
- (void).cxx_destruct;	// IMP=0x0020000000160dca
...
- (_Bool)_canBeInterrupted;	// IMP=0x0010000000160d7f
- (void)_begin;	// IMP=0x0010000000160b01
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x0010000000160a16
