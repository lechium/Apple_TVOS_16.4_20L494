...
- (void).cxx_destruct;	// IMP=0x00200000001d6932
...
- (void)_updateIconImage;	// IMP=0x00100000001d6760
- (void)_updateDisplayName;	// IMP=0x00100000001d6687
- (void)_updateForProgressChange;	// IMP=0x00100000001d6674
- (id)description;	// IMP=0x00100000001d663a
- (id)initWithType:(long long)arg1 bundleIdentifier:(id)arg2 appInfo:(id)arg3 dataSource:(id)arg4 live:(_Bool)arg5;	// IMP=0x00100000001d63a5
