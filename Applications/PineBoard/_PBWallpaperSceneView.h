...
+ (_Bool)isWallpaperRequired;	// IMP=0x00200000001ca9c3
- (void).cxx_destruct;	// IMP=0x00200000001cb250
...
- (id)_newWallpaperView;	// IMP=0x00100000001cb0f5
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000001cacd8
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x00100000001cab86
- (id)initWithBundleIdentifier:(id)arg1 allowsGroupOpacity:(_Bool)arg2;	// IMP=0x00100000001ca9cb
