...
+ (double)_transitionDuration;	// IMP=0x002000000002649e
- (void).cxx_destruct;	// IMP=0x0020000000026601
...
- (void)_transitionWithAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000264bd
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000026214
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000025ec5
...
- (id)initWithChildViewController:(id)arg1;	// IMP=0x0010000000025e43
