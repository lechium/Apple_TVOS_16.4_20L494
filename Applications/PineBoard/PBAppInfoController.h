...
+ (CDUnknownBlockType)enabledAppsFilter;	// IMP=0x002000000016a368
+ (CDUnknownBlockType)enabledAndVisibleAppsFilter;	// IMP=0x001000000016a2e0
+ (CDUnknownBlockType)enabledAndVisibleAppsAndPlaceholdersFilter;	// IMP=0x001000000016a283
- (void).cxx_destruct;	// IMP=0x001000000016b4f5
...
- (id)_filteredAppInfoFromAppInfo:(id)arg1;	// IMP=0x001000000016b3f2
- (id)_handleDidAddInfos:(id)arg1 removeInfos:(id)arg2 updateInfos:(id)arg3 updatedConfiguration:(id)arg4;	// IMP=0x001000000016a95e
- (void)appInfoStoreEndUpdates:(id)arg1;	// IMP=0x001000000016a87c
- (void)appInfoStore:(id)arg1 beginUpdatesWithAddedInfos:(id)arg2 removedInfos:(id)arg3 updatedInfos:(id)arg4 updatedConfiguration:(id)arg5;	// IMP=0x001000000016a839
...
- (void)dealloc;	// IMP=0x001000000016a54e
- (id)initWithInfoStore:(id)arg1 filter:(CDUnknownBlockType)arg2 delegate:(id)arg3;	// IMP=0x001000000016a3d3
- (id)init;	// IMP=0x001000000016a3c5
- (id)appInfoForSceneIdentity:(id)arg1;	// IMP=0x0010000000023ae3
- (id)appInfoForSceneIdentifier:(id)arg1;	// IMP=0x0010000000023a35
- (id)appInfoForScene:(id)arg1;	// IMP=0x0010000000023954
