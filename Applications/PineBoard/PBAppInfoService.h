...
- (void).cxx_destruct;	// IMP=0x0020000000067589
...
- (void)appInfoUpdatesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0010000000066e62
- (void)setServiceDelegate:(id)arg1;	// IMP=0x0010000000066e09
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x0010000000066915
- (void)invalidate;	// IMP=0x001000000006690f
- (id)initWithInfoStore:(id)arg1 remoteConnection:(id)arg2;	// IMP=0x00100000000665ae
- (id)init;	// IMP=0x00100000000665a0
