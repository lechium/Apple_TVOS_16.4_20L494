...
- (void).cxx_destruct;	// IMP=0x00200000001431ba
...
- (id)_messageStringAttributes;	// IMP=0x0010000000142e7c
- (id)_titleStringAttributes;	// IMP=0x0010000000142d01
- (void)_menuButtonPressed:(id)arg1;	// IMP=0x0010000000142c24
- (void)textEntryControllerDidFinish:(id)arg1;	// IMP=0x0010000000142b64
- (void)buttonView:(id)arg1 didSelectButton:(id)arg2 atIndex:(long long)arg3;	// IMP=0x0010000000142a7b
- (void)_synchronizeEnteredValues;	// IMP=0x0010000000142a15
- (id)textField;	// IMP=0x0010000000142996
- (void)_showChildViewController:(id)arg1;	// IMP=0x00100000001427d9
- (id)_buttonsForTextField:(long long)arg1 defaultButtonIndex:(long long *)arg2;	// IMP=0x001000000014257c
- (void)_showTextEntryViewControllerForTextField:(long long)arg1;	// IMP=0x001000000014206c
- (void)_configureStateMachine;	// IMP=0x0010000000141b6e
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000141ae4
- (void)viewDidLoad;	// IMP=0x0010000000141aa3
- (void)loadView;	// IMP=0x00100000001419db
- (unsigned long long)addButtonWithTitle:(id)arg1;	// IMP=0x001000000014196d
- (void)setAlternateTitle:(id)arg1 message:(id)arg2 forTextFieldAtIndex:(unsigned long long)arg3;	// IMP=0x00100000001418b0
- (unsigned long long)addTextFieldWithInitialText:(id)arg1 placeholder:(id)arg2 keyboardType:(long long)arg3;	// IMP=0x0010000000141781
- (id)init;	// IMP=0x001000000014176a
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x001000000014166d
